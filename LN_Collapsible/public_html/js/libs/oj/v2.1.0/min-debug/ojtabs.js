...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojconveyorbelt", "ojs/ojmenu", "jqueryui-amd/sortable", "ojs/ojtouchproxy"], function($oj$$53$$, $$$$48$$) {
  (function() {
    ...
    $oj$$53$$.$__registerWidget$("oj.ojTabs", $$$$48$$.oj.baseComponent, {widgetEventPrefix:"oj", delay:300, options:{selected:0, disabledTabs:null, truncation:"auto", selectOn:"click", orientation:"horizontal", edge:"top", removable:!1, reorderable:!1, beforeSelect:null, select:null, beforeDeselect:null, deselect:null, beforeRemove:null, remove:null, beforeReorder:null, reorder:null, optionChange:null}, _ComponentCreate:function() {
      ...
      if (!this.$_handlePageNav$($event$$518$$)) {
        ...
        if (!$event$$518$$.ctrlKey) {
          ...
          this.$activating$ = this._delay(function() {
            $self$$166$$ && $self$$166$$.$tabs$ && $self$$166$$.$_activate$($selTab$$, $event$$518$$);
          }, this.delay);
        }
      }
    ...
    }, $_isTabDisabled$:function($index$$226$$) {
      return 0 <= $index$$226$$ && $index$$226$$ < this.$tabs$.length ? $$$$48$$(this.$tabs$[$index$$226$$]).hasClass("oj-disabled") : !1;
    }, $_focusNextTab$:function($index$$227$$, $goingForward$$) {
      var $enabledTabs$$1_selTab$$1$$ = this.$_getEnabledTabs$(), $currentIndex$$3$$ = $enabledTabs$$1_selTab$$1$$.index(this.$tabs$[$index$$227$$]), $length$$19$$ = $enabledTabs$$1_selTab$$1$$.length, $enabledTabs$$1_selTab$$1$$ = $$$$48$$($enabledTabs$$1_selTab$$1$$[$goingForward$$ ? ($currentIndex$$3$$ + 1) % $length$$19$$ : ((0 == $currentIndex$$3$$ ? $length$$19$$ : $currentIndex$$3$$) - 1) % $length$$19$$]);
      $enabledTabs$$1_selTab$$1$$.focus();
      return $enabledTabs$$1_selTab$$1$$;
    }, $_getNextEnabledTab$:function($index$$228$$) {
      for (var $next$$8$$ = $index$$228$$ + 1, $lastTabIndex$$ = this.$tabs$.length - 1;$next$$8$$ <= $lastTabIndex$$;) {
        if (!this.$_isTabDisabled$($next$$8$$)) {
          return $next$$8$$;
        }
        $next$$8$$++;
      }
      for ($next$$8$$ = $index$$228$$ - 1;0 <= $next$$8$$;) {
        if (!this.$_isTabDisabled$($next$$8$$)) {
          return $next$$8$$;
        }
        $next$$8$$--;
      ...
      var $self$$167$$ = this, $edge$$14$$ = this.options.edge;
      this.$_destroyTabBar$();
      this.$_createTabbar$();
      ...
      this.$tablist$.children("li").each(function() {
        ...
        $self$$167$$.$tabs$ = $self$$167$$.$tabs$.add($tab$$1$$);
        var $anchor$$3_anchorId_div$$3$$ = $anchor$$3_anchorId_div$$3$$.uniqueId().attr("id"), $panelId$$ = $tab$$1$$.attr("data-content"), $panel$$2$$ = $self$$167$$.element.find($self$$167$$.$_sanitizeSelector$("#" + $panelId$$));
        $tab$$1$$.attr({"aria-controls":$panelId$$, "aria-labelledby":$anchor$$3_anchorId_div$$3$$});
        $self$$167$$.$panels$ = $self$$167$$.$panels$.add($panel$$2$$);
        $panel$$2$$.attr("aria-labelledby", $anchor$$3_anchorId_div$$3$$).attr("role", "tabpanel");
      });
      "start" != $edge$$14$$ && "end" != $edge$$14$$ || $self$$167$$.$tablist$.addClass("oj-tabs-nav-root");
      ...
      if ($enabledTabs$$2_event$$521$$) {
        var $self$$168$$ = this;
        $$$$48$$.each($enabledTabs$$2_event$$521$$.split(" "), function($index$$230$$, $eventName$$2$$) {
          "click" == $eventName$$2$$ && ($selectOnClick$$ = !0);
          $oj$$53$$.$DomUtils$.$isValidIdentifier$($eventName$$2$$) && ($events$$13$$[$eventName$$2$$] = $self$$168$$.$_eventHandler$);
        });
      }
      ...
      if (this.options.removable) {
        var $revents$$ = {click:this.$_removeTabHandler$}, $closeIcons$$ = this.$_getCloseIcons$($enabledTabs$$2_event$$521$$);
        this._on($closeIcons$$, $revents$$);
        this._hoverable($closeIcons$$);
        this.$_activeable$($closeIcons$$);
      }
      ...
      if (this.options.removable && this.$_isHorizontal$()) {
        ...
        this.$_getEnabledTabs$().each(function($index$$231_rmId$$) {
          var $div$$4$$ = $$$$48$$(this).find("\x3e :first-child");
          $div$$4$$.addClass("oj-removable");
          $index$$231_rmId$$ = "ojtabs-id_rm_" + $index$$231_rmId$$;
          $$$$48$$(this).attr("aria-describedby", $index$$231_rmId$$);
          $$$$48$$("\x3ca href\x3d'#'\x3e").addClass("oj-tabs-icon oj-component-icon oj-clickable-icon-nocontext oj-tabs-close-icon").attr({id:$index$$231_rmId$$, tabIndex:"-1", "aria-label":$removeCueText$$, role:"presentation"}).appendTo($div$$4$$);
        });
      }
      ...
      var $self$$170$$ = this, $tab$$3$$, $div$$5$$, $anchor$$5$$, $header$$13$$;
      this.$tabs$.each(function($index$$232$$) {
        $tab$$3$$ = $$$$48$$(this);
        ...
        $self$$170$$.$_isOldMarkup$ ? $header$$13$$.prependTo($self$$170$$.$panels$.get($index$$232$$)) : $div$$5$$.hasClass("oj-tabs-gen-div") && $anchor$$5$$.hasClass("oj-tabs-gen-a") ? ($header$$13$$.prependTo($tab$$3$$), $div$$5$$.remove()) : $anchor$$5$$.hasClass("oj-tabs-gen-a") ? ($header$$13$$.prependTo($div$$5$$), $anchor$$5$$.remove()) : $div$$5$$.hasClass("oj-tabs-gen-div") && ($anchor$$5$$.prependTo($tab$$3$$), $div$$5$$.remove());
      });
      ...
      var $tab$$6$$, $content$$36$$, $index$$234_tabAfter$$ = -1;
      $contentAfter_navRoot$$1_newTab_tabbar$$2$$.tab && $contentAfter_navRoot$$1_newTab_tabbar$$2$$.content ? ($content$$36$$ = $contentAfter_navRoot$$1_newTab_tabbar$$2$$.content, $tab$$6$$ = this.$_wrapLi$($contentAfter_navRoot$$1_newTab_tabbar$$2$$.tab, this.$_getUniqueId$($content$$36$$)), void 0 !== $contentAfter_navRoot$$1_newTab_tabbar$$2$$.index && ($index$$234_tabAfter$$ = $contentAfter_navRoot$$1_newTab_tabbar$$2$$.index)) : ($content$$36$$ = $contentAfter_navRoot$$1_newTab_tabbar$$2$$, 
      ...
      0 <= $index$$234_tabAfter$$ && $index$$234_tabAfter$$ < $contentAfter_navRoot$$1_newTab_tabbar$$2$$.children().length ? ($index$$234_tabAfter$$ = $contentAfter_navRoot$$1_newTab_tabbar$$2$$.children(":eq(" + $index$$234_tabAfter$$ + ")"), $contentAfter_navRoot$$1_newTab_tabbar$$2$$ = this.element.children("#" + $index$$234_tabAfter$$.attr("aria-controls")), $index$$234_tabAfter$$.before($tab$$6$$), $contentAfter_navRoot$$1_newTab_tabbar$$2$$.before($content$$36$$)) : ($tab$$6$$.appendTo($contentAfter_navRoot$$1_newTab_tabbar$$2$$), 
      $content$$36$$.appendTo(this.element));
      this.refresh();
      0 == this.$active$.length && this.$_fireSelectEvents$(0);
      var $self$$171$$ = this;
      window.setTimeout(function() {
        $self$$171$$.$tabs$ && $tab$$6$$[0].scrollIntoView(!1);
      }, 0);
      ...
      if (this.options.reorderable) {
        ...
        this.$tablist$.sortable({axis:$self$$172$$.$_isHorizontal$() ? "x" : "y", stop:function($event$$525$$, $ui$$39$$) {
          var $mvTab$$ = $ui$$39$$.item;
          $self$$172$$.$_doReorder$($event$$525$$, $mvTab$$, $mvTab$$.prev()) || $self$$172$$.$tablist$.sortable("cancel");
        }});
        this.$_sortable$ = !0;
      } else {
    ...
    }, getNodeBySubId:function($index$$235_locator$$55$$) {
      if (null == $index$$235_locator$$55$$) {
        return this.element ? this.element[0] : null;
      }
      var $subId$$59$$ = $index$$235_locator$$55$$.subId;
      $index$$235_locator$$55$$ = $index$$235_locator$$55$$.index;
      if ("oj-conveyorbelt" != $subId$$59$$ && ("number" !== typeof $index$$235_locator$$55$$ || 0 > $index$$235_locator$$55$$ || $index$$235_locator$$55$$ >= this.$panels$.length)) {
        return null;
      }
      switch($subId$$59$$) {
        ...
        case "oj-tabs-panel":
          return this.$_getPanelForTab$(this.$tabs$[$index$$235_locator$$55$$])[0];
        case "oj-tabs-tab":
          return this.$tabs$[$index$$235_locator$$55$$];
        case "oj-tabs-title":
          return $$$$48$$(this.$tabs$[$index$$235_locator$$55$$]).find(".oj-tabs-title")[0];
        case "oj-tabs-close-icon":
        ;
        case "oj-tabs-close":
          return $$$$48$$(this.$tabs$[$index$$235_locator$$55$$]).find(".oj-tabs-close-icon")[0];
      }
      return null;
      ...
      var $id$$49$$ = $ui$$40$$ ? $ui$$40$$.item.attr("id") : void 0;
      ...
      if ($$menuContainer$$ || this.options.reorderable || this.options.removable) {
        ...
        $$menuContainer$$.find("[data-oj-command]").each(function() {
          if (0 === $$$$48$$(this).children("a").length) {
            ...
            $$$$48$$(this).replaceWith($self$$173$$.$_buildContextMenuItem$($command$$13$$));
      ...
      return $id$$50$$;
    }, $_getTab$:function($idOrIndex$$1_index$$238$$) {
      $idOrIndex$$1_index$$238$$ = this.$_getIndexByTabOrContentId$($idOrIndex$$1_index$$238$$);
      if (-1 !== $idOrIndex$$1_index$$238$$) {
        return $$$$48$$(this.$tabs$[$idOrIndex$$1_index$$238$$]);
      }
    }, $_getIndexByTabOrContentId$:function($idOrIndex$$2_selector$$37_tabOrContent$$) {
      var $index$$239$$ = -1;
      "number" === typeof $idOrIndex$$2_selector$$37_tabOrContent$$ ? 0 <= $idOrIndex$$2_selector$$37_tabOrContent$$ && $idOrIndex$$2_selector$$37_tabOrContent$$ < this.$tabs$.length && ($index$$239$$ = $idOrIndex$$2_selector$$37_tabOrContent$$) : "string" === typeof $idOrIndex$$2_selector$$37_tabOrContent$$ && ($idOrIndex$$2_selector$$37_tabOrContent$$ = this.$_sanitizeSelector$($idOrIndex$$2_selector$$37_tabOrContent$$), $oj$$53$$.$DomUtils$.$isValidIdentifier$($idOrIndex$$2_selector$$37_tabOrContent$$) && 
      ($idOrIndex$$2_selector$$37_tabOrContent$$ = this.element.find("#" + $idOrIndex$$2_selector$$37_tabOrContent$$), $idOrIndex$$2_selector$$37_tabOrContent$$.length && ($index$$239$$ = this.$tabs$.index($idOrIndex$$2_selector$$37_tabOrContent$$), -1 == $index$$239$$ && ($index$$239$$ = this.$panels$.index($idOrIndex$$2_selector$$37_tabOrContent$$)))));
      return $index$$239$$;
      ...
      if (!$arr$$24$$) {
        ...
        this.$tablist$.children().each(function() {
          var $tab$$10$$ = $$$$48$$(this);
          $tab$$10$$.hasClass("oj-disabled") && $arr$$24$$.push($self$$174$$.$_getTabIdOrIndex$($tab$$10$$));
        });
      }
      ...
      var $contentIds$$ = this.$_getContentIds$(), $self$$175$$ = this, $tabbar$$5$$ = this.element.children("ul");
      0 < $tabbar$$5$$.length && $tabbar$$5$$.children("li").each(function($index$$241$$) {
        $self$$175$$.$_wrapLi$($$$$48$$(this), $contentIds$$[$index$$241$$]);
      });
    }, $_createTabbarFromOldMarkup$:function() {
      var $tabbar$$6$$ = this.element.children("ul");
      if (0 == $tabbar$$6$$.length) {
        var $self$$176$$ = this, $contentIds$$1$$ = this.$_getContentIds$(), $tabbar$$6$$ = $$$$48$$("\x3cul\x3e");
        this.element.children().each(function($index$$242$$) {
          $self$$176$$.$_wrapLi$($$$$48$$(this).find("\x3e :first-child"), $contentIds$$1$$[$index$$242$$]).appendTo($tabbar$$6$$);
        });
        $tabbar$$6$$.prependTo(this.element);
      }
    }, $_addFacets$:function() {
      var $navRoot$$3$$ = this.element.children(".oj-tabs-nav-root"), $self$$177$$ = this, $tabbarWrapper$$ = $navRoot$$3$$.children(".oj-tabs-conveyorbelt-wrapper");
      $navRoot$$3$$.index();
      this.element.children(".oj-tabs-facet").each(function() {
        var $facet$$1$$ = $$$$48$$(this), $facetId$$ = $self$$177$$.$_getUniqueId$($facet$$1$$);
