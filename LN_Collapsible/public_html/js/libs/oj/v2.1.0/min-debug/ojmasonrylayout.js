...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojdnd"], function($oj$$66$$, $$$$61$$) {
  function $MasonryLayoutCommon$$($elem$$80$$, $rtl$$4_sizeDivWrapper$$, $automationEnabled_style$$9$$, $selectors$$8_sizeDiv$$, $styles$$2$$, $callbackInfo$$) {
    ...
    this.$_handleTransitionEndFunc$ = function $this$$_handleTransitionEndFunc$$($event$$583$$) {
      $self$$202$$.$_handleTransitionEnd$($event$$583$$);
    };
    ...
    this.$_handleHideTransitionEndFunc$ = function $this$$_handleHideTransitionEndFunc$$($event$$584$$) {
      $self$$202$$.$_handleHideTransitionEnd$($event$$584$$);
    };
    this.$_handleShowTransitionEndFunc$ = function $this$$_handleShowTransitionEndFunc$$($event$$585$$) {
      $self$$202$$.$_handleShowTransitionEnd$($event$$585$$);
    };
  }
  (function() {
    ...
    $oj$$66$$.$__registerWidget$("oj.ojMasonryLayout", $$$$61$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{reorderHandle:null, beforeInsert:null, insert:null, beforeRemove:null, remove:null, beforeResize:null, resize:null, beforeReorder:null, reorder:null}, _ComponentCreate:function() {
    ...
    }, insertTile:function($selector$$40$$, $index$$270$$) {
      var $mlCommon$$2$$ = this.$_mlCommon$;
      $mlCommon$$2$$.$isInLayoutCycle$() && $mlCommon$$2$$.$finishLayoutCycle$();
      isNaN($index$$270$$) && ($index$$270$$ = -1);
      var $jqElem$$2_style$$10$$ = $$$$61$$($selector$$40$$), $elem$$88$$ = $jqElem$$2_style$$10$$[0];
      !1 !== this._trigger("beforeInsert", null, {tile:$jqElem$$2_style$$10$$, index:$index$$270$$}) && ($elem$$88$$.$_jetDataTileInsertIndex$ = $index$$270$$, $mlCommon$$2$$.$isAnimationEnabled$() && $jqElem$$2_style$$10$$.addClass($_OJ_MASONRYLAYOUT_TILE_TRANSITION_SHOW_FROM_CLASS$$), $jqElem$$2_style$$10$$ = $elem$$88$$.style, $jqElem$$2_style$$10$$.top = "-1px", this.$_bRTL$ ? $jqElem$$2_style$$10$$.right = "-1px" : $jqElem$$2_style$$10$$.left = "-1px", this.$_insertTileOriginalOrder$($elem$$88$$, 
      $index$$270$$), $mlCommon$$2$$.$insertTileDomElem$($elem$$88$$, $index$$270$$), $oj$$66$$.Components.$subtreeAttached$($elem$$88$$), this.$_arTilesToInsert$ || (this.$_arTilesToInsert$ = []), this.$_arTilesToInsert$.push($selector$$40$$));
    }, removeTile:function($selector$$41$$) {
      var $mlCommon$$3$$ = this.$_mlCommon$;
      $mlCommon$$3$$.$isInLayoutCycle$() && $mlCommon$$3$$.$finishLayoutCycle$();
      var $jqInfolet$$ = $$$$61$$($selector$$41$$), $index$$271_infolet$$ = $jqInfolet$$[0];
      if ($oj$$66$$.$FocusUtils$.$containsFocus$($index$$271_infolet$$)) {
        var $children$$16$$ = this.$_getTileElements$(!0), $index$$271_infolet$$ = $children$$16$$.indexOf($index$$271_infolet$$);
        0 < $index$$271_infolet$$ && (this.$_deletingTileWithFocusPrev$ = $children$$16$$[$index$$271_infolet$$ - 1]);
      }
      ...
      var $jqElem$$3$$ = $$$$61$$($elem$$89$$), $index$$272$$ = $elem$$89$$.$_jetDataTileInsertIndex$;
      delete $elem$$89$$.$_jetDataTileInsertIndex$;
      this.options.reorderHandle && this.$_setupReorderHandlesForElem$($jqElem$$3$$);
      this._trigger("insert", null, {tile:$jqElem$$3$$, index:$index$$272$$});
      ...
      if (this.$_layoutStartActiveDomElem$) {
        ...
        if (this.$_deletingTileWithFocusPrev$) {
          if ($layoutStartActiveDomElem_tile$$ = this.$_deletingTileWithFocusPrev$, this.$_deletingTileWithFocusPrev$ = null, $layoutStartActiveDomElem_tile$$ && $oj$$66$$.$DomUtils$.$isAncestor$($children$$17_elem$$92$$, $layoutStartActiveDomElem_tile$$)) {
            var $children$$17_elem$$92$$ = this.$_getTileElements$($children$$17_elem$$92$$, !0), $index$$273$$ = $children$$17_elem$$92$$.indexOf($layoutStartActiveDomElem_tile$$);
            0 <= $index$$273$$ && $index$$273$$ < $children$$17_elem$$92$$.length - 1 ? $oj$$66$$.$FocusUtils$.$focusFirstTabStop$($children$$17_elem$$92$$[$index$$273$$ + 1]) : $oj$$66$$.$FocusUtils$.$focusFirstTabStop$($layoutStartActiveDomElem_tile$$);
          }
        } else {
    ...
    }, $_insertTileOriginalOrder$:function($insertedTile$$, $index$$274$$) {
      var $arTiles$$2$$ = this.$_getTileElements$();
      0 > $index$$274$$ && ($index$$274$$ = $arTiles$$2$$.length);
      if ($arTiles$$2$$) {
        for (var $i$$428$$ = 0;$i$$428$$ < $arTiles$$2$$.length;$i$$428$$++) {
          var $tile$$3$$ = $arTiles$$2$$[$i$$428$$];
          $tile$$3$$.$_jetDataMasonryOriginalOrder$ && $tile$$3$$.$_jetDataMasonryOriginalOrder$ >= $index$$274$$ + 1 && $tile$$3$$.$_jetDataMasonryOriginalOrder$++;
        }
      }
      $insertedTile$$.$_jetDataMasonryOriginalOrder$ = $index$$274$$ + 1;
      ...
      if (this.$_menu$ && this.$_menu$.$usermenu$ && this.options.reorderHandle) {
        var $$menuContainer$$2$$ = this.$_menu$.$$container$, $self$$204$$ = this;
        ...
        $$menuContainer$$2$$.find("[data-oj-command]").each(function() {
          if (0 === $$$$61$$(this).children("a").length) {
            ...
            $$$$61$$(this).replaceWith($self$$204$$.$_buildContextMenuItem$($command$$14$$));
      ...
      var $id$$63$$ = $ui$$48$$ ? $ui$$48$$.item.attr("id") : void 0;
      ...
      if (this.options.reorderHandle && !this.$_bDragging$) {
        ...
        if ($tile$$7$$) {
          var $eventData$$28_index$$275$$ = this.$_getTileIndex$($tile$$7$$);
          $tile$$7$$.$_jetDataMasonryDragSourceIndex$ = $eventData$$28_index$$275$$;
          $eventData$$28_index$$275$$ = {tile:$$$$61$$($tile$$7$$), fromIndex:$eventData$$28_index$$275$$};
          !1 !== this._trigger("beforeReorder", null, $eventData$$28_index$$275$$) && ($event$$593_originalEvent$$5$$ = $event$$593_originalEvent$$5$$.originalEvent, this.$_dragStart$($tile$$7$$, $event$$593_originalEvent$$5$$.pageX, $event$$593_originalEvent$$5$$.pageY, $event$$593_originalEvent$$5$$.dataTransfer));
        }
      }
      ...
      var $elem$$103$$ = this.element[0], $offset$$26_sizeClass_style$$13$$ = $_getSizeStyleClassName$$($tile$$8$$), $dropSite$$1$$ = this.$_dropSite$ = document.createElement("div");
      ...
      $offset$$26_sizeClass_style$$13$$ = $$$$61$$($tile$$8$$).offset();
      ...
      this.$_dragStartHideTileTimeout$ = setTimeout(function() {
        $self$$205$$.$_bDragStartTileHidden$ = !0;
        $tileStyle$$.display = $_NONE$$;
        $$$$61$$($tile$$8$$).removeClass("oj-drag");
        $self$$205$$.$_dragStartHideTileTimeout$ = null;
      ...
      if (this.$_bDragStartTileHidden$ && !this.$_bDragMoveTransition$) {
        ...
        if (($clientX$$2_elemUnderPoint$$2_tileUnderPoint$$ = $_findContainingTile$$($clientX$$2_elemUnderPoint$$2_tileUnderPoint$$, $elem$$104$$)) && $clientX$$2_elemUnderPoint$$2_tileUnderPoint$$ !== this.$_dropSite$ && $clientX$$2_elemUnderPoint$$2_tileUnderPoint$$ !== this.$_draggedTile$) {
          var $offset$$27$$ = $$$$61$$($elem$$104$$).offset();
      ...
      var $offset$$28$$ = $$$$61$$($elem$$105$$).offset(), $dragOffset$$1$$ = this.$_dragOffset$;
      $dropSite$$2_style$$14$$.top = $pageY$$2$$ - $dragOffset$$1$$.top - $offset$$28$$.top + $_PX$$;
      $newLeft_pageX$$3$$ = $newLeft_pageX$$3$$ - $dragOffset$$1$$.left - $offset$$28$$.left;
  ...
  $MasonryLayoutCommon$$.prototype.$insertTileDomElem$ = function $$MasonryLayoutCommon$$$$$insertTileDomElem$$($tileDomElem$$, $index$$276$$) {
    ...
    0 <= $index$$276$$ && $index$$276$$ < $arChildren$$1$$.length && ($currChildAtIndex$$ = $arChildren$$1$$[$index$$276$$]);
  ...
  $MasonryLayoutCommon$$.$_addBubbleEventListener$ = function $$MasonryLayoutCommon$$$$_addBubbleEventListener$$($node$$163$$, $type$$104$$, $listener$$40$$) {
    $node$$163$$.addEventListener ? $node$$163$$.addEventListener($type$$104$$, $listener$$40$$, !1) : $node$$163$$.attachEvent && $node$$163$$.attachEvent("on" + $type$$104$$, $listener$$40$$);
  };
  $MasonryLayoutCommon$$.$_removeBubbleEventListener$ = function $$MasonryLayoutCommon$$$$_removeBubbleEventListener$$($node$$164$$, $type$$105$$, $listener$$41$$) {
    $node$$164$$.removeEventListener ? $node$$164$$.removeEventListener($type$$105$$, $listener$$41$$, !1) : $node$$164$$.detachEvent && $node$$164$$.detachEvent("on" + $type$$105$$, $listener$$41$$);
  };
  $MasonryLayoutCommon$$.$_arrayIndexOf$ = function $$MasonryLayoutCommon$$$$_arrayIndexOf$$($array$$17$$, $item$$121$$) {
    if ($array$$17$$) {
      for (var $i$$433$$ = 0;$i$$433$$ < $array$$17$$.length;$i$$433$$++) {
        if ($array$$17$$[$i$$433$$] == $item$$121$$) {
          return $i$$433$$;
        }
      }
    }
    ...
    if (this.$_arInfoletsToHide$ && this.$isAnimationEnabled$()) {
      ...
      this.$_hideTilesInternalTimeout$ = setTimeout(function() {
        for (var $i$$443$$ = 0;$i$$443$$ < $arInfoletsToHide$$1$$.length;$i$$443$$++) {
          ...
          $self$$207$$.$_removeStyleClassNameFunc$($infolet$$6$$, $self$$207$$.$_transitionHideFromStyleClass$);
          $self$$207$$.$_addStyleClassNameFunc$($infolet$$6$$, $self$$207$$.$_transitionHideToStyleClass$);
        }
      }, 0);
    } else {
