...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtDiagram"], function($oj$$80$$, $$$$74$$, $comp$$17$$, $base$$15$$, $dvt$$12$$) {
  $oj$$80$$.$__registerWidget$("oj.ojDiagram", $$$$74$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null}, $_Render$:function($isResize$$1$$) {
    ...
    var $thisRef$$4$$ = this;
    return function($parentElement$$9$$, $rootElement$$21$$, $data$$181$$, $state$$14$$, $previousState$$1$$) {
      return{component:$oj$$80$$.Components.$getWidgetConstructor$($thisRef$$4$$.element), parentElement:$parentElement$$9$$, rootElement:$rootElement$$21$$, data:$data$$181$$, state:$state$$14$$, previousState:$previousState$$1$$, id:$data$$181$$.id, type:"node", label:$data$$181$$.label};
    };
