  ...
  (function() {
    $oj$$79$$.$__registerWidget$("oj.ojMenu", $$$$73$$.oj.baseComponent, {defaultElement:"\x3cul\x3e", delay:300, role:"menu", widgetEventPrefix:"oj", options:{menuSelector:"ul", openOptions:{initialFocus:"menu", launcher:null, position:{my:"start top", at:"start bottom", collision:"flipfit"}}, submenuOpenOptions:{position:{my:"start top", at:"end top", collision:"flipfit"}}, beforeOpen:null, select:null}, _ComponentCreate:function() {
      ...
      this._on({"mousedown .oj-menu-item \x3e a":function($event$$656$$) {
        ...
        if (!$keepActiveItem$$) {
          var $item$$124$$ = this.$active$ || this.element.children(".oj-menu-item").eq(0);
          this.$_focus$($event$$664$$, $item$$124$$);
        }
      ...
      if (("focus" === $event$$666$$.type || "mousedown" === $event$$666$$.type || "touchstart" === $event$$666$$.type || 93 == $event$$666$$.which || 121 == $event$$666$$.which && $event$$666$$.shiftKey || 93 == $event$$666$$.keyCode) && ("mousedown" !== $event$$666$$.type || !$_contextMenuPressHoldJustEnded$$)) {
        ...
        $$$$73$$.each($openPopupMenus$$, function($index$$301$$, $menu$$26$$) {
      ...
      switch($event$$667$$.keyCode) {
        ...
        case $$$$73$$.ui.keyCode.SPACE:
          ...
          var $self$$228$$ = this;
          setTimeout(function() {
            $self$$228$$.$__spaceEnterDownInMenu$ = !1;
          }, 100);
          break;
      ...
      if ($element$$145$$.is(":visible")) {
        var $position$$51$$ = $element$$145$$.data("oj-menu-position");
        $position$$51$$ && $element$$145$$.position($position$$51$$);
        $element$$145$$.find(".oj-menu").each(function() {
          var $menu$$27$$ = $$$$73$$(this);
          $menu$$27$$.is(":visible") && ($position$$51$$ = $menu$$27$$.data("oj-menu-position")) && $menu$$27$$.position($position$$51$$);
        });
      }
    }, $_setup$:function() {
      ...
      var $self$$229$$ = this, $submenus$$ = this.element.find(this.options.menuSelector), $menus$$ = $submenus$$.add(this.element), $children$$33$$ = $menus$$.children();
      ...
      $children$$33$$.filter(":not(.oj-menu-item)").each(function() {
        var $item$$125$$ = $$$$73$$(this);
        /[^\-\u2014\u2013\s]/.test($item$$125$$.text()) || $item$$125$$.addClass("oj-menu-divider").attr("role", "separator");
      });
      ...
      $submenus$$.filter(":not(.oj-menu)").addClass("oj-menu oj-menu-submenu").hide().attr({role:this.role, "aria-hidden":"true"}).each(function() {
        var $menu$$28$$ = $$$$73$$(this), $item$$126_itemId$$1$$ = $self$$229$$.$_getSubmenuAnchor$($menu$$28$$), $submenuIcon$$ = $$$$73$$("\x3cspan\x3e");
        $submenuIcon$$.addClass("oj-menu-submenu-icon oj-component-icon").data("oj-ojMenu-submenu-icon", !0);
        $item$$126_itemId$$1$$.attr("aria-haspopup", "true").attr("aria-expanded", "false").append($submenuIcon$$);
        $item$$126_itemId$$1$$ = $item$$126_itemId$$1$$.attr("id");
        $menu$$28$$.attr("aria-labelledby", $item$$126_itemId$$1$$);
      });
      $menus$$.each(function() {
    ...
    }, $_focus$:function($event$$669$$, $item$$127$$) {
      $event$$669$$ && "focus" === $event$$669$$.type || clearTimeout(this.$timer$);
      $item$$127$$ = $item$$127$$.first();
      this.$_makeActive$($item$$127$$, $event$$669$$);
      var $nested$$1_parentMenuItem$$ = $item$$127$$.parent().closest(".oj-menu-item");
      ...
      $nested$$1_parentMenuItem$$ = $item$$127$$.children(".oj-menu");
      ...
      this.$activeMenu$ = $item$$127$$.parent();
    }, $_makeActive$:function($item$$128$$, $event$$670$$) {
      if (!$item$$128$$.is(this.$active$)) {
        var $previousItem$$2$$ = this.$active$ ? this.$active$ : $$$$73$$(), $anchor$$8$$ = $item$$128$$.children("a");
        this.$active$ = $item$$128$$;
        this.element.attr("aria-activedescendant", $anchor$$8$$.attr("id"));
        this.$_addDividers$($previousItem$$2$$).removeClass("oj-focus");
        this.$_addDividers$($item$$128$$).addClass("oj-focus");
        this._trigger("_activeItem", $event$$670$$, {previousItem:$previousItem$$2$$, item:$item$$128$$, privateNotice:"The _activeItem event is private.  Do not use."});
      }
    ...
    }, $_focusLauncherAndDismiss$:function($event$$673$$) {
      this.$_launcher$.focus();
      this.$__dismiss$($event$$673$$);
    }, $__dismiss$:function($event$$674$$) {
      var $psOptions$$8$$ = {};
      ...
      this._trigger("__dismiss", $event$$674$$, {});
      0 <= $_openPopupMenus$$.indexOf(this) && $_openPopupMenus$$.splice($_openPopupMenus$$.indexOf(this), 1);
    }, open:function($event$$675$$, $initialFocus$$2_openOptions$$7$$, $psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$) {
      this.element.is(":visible") && this.$__dismiss$();
      ...
      if (this._trigger("beforeOpen", $event$$675$$, {openOptions:$initialFocus$$2_openOptions$$7$$})) {
        ...
        if (($launcher$$25$$ = "string" === $$$$73$$.type($launcher$$25$$) ? $$$$73$$($launcher$$25$$) : $launcher$$25$$) && $launcher$$25$$.length) {
          var $focusFirstItem_position$$52$$ = $oj$$79$$.$PositionUtils$.$normalizeHorizontalAlignment$($initialFocus$$2_openOptions$$7$$.position, this.$isRtl$);
          $focusFirstItem_position$$52$$.of = $oj$$79$$.$PositionUtils$.$normalizePositionOf$($focusFirstItem_position$$52$$.of, $launcher$$25$$, $event$$675$$);
          if (null == $focusFirstItem_position$$52$$.of) {
            ...
            $$$$73$$.each($openPopupMenus$$1$$, function($index$$302$$, $menu$$30$$) {
            ...
            $$$$73$$.isFunction($focusFirstItem_position$$52$$.using) && $focusFirstItem_position$$52$$.using !== $psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$ && ($focusFirstItem_position$$52$$.origUsing = $focusFirstItem_position$$52$$.using);
            $focusFirstItem_position$$52$$.using = $psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$;
            ...
            $psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$[$oj$$79$$.$PopupService$.$OPTION$.$POSITION$] = $focusFirstItem_position$$52$$;
            ...
            this.element.data("oj-menu-position", $focusFirstItem_position$$52$$);
            $initialFocus$$2_openOptions$$7$$ = $initialFocus$$2_openOptions$$7$$.initialFocus;
            (($focusFirstItem_position$$52$$ = "firstItem" === $initialFocus$$2_openOptions$$7$$) || "menu" === $initialFocus$$2_openOptions$$7$$) && this.element.focus();
            $focusFirstItem_position$$52$$ ? this.$_focus$($event$$675$$, this.element.children().first()) : this.$_blur$($event$$675$$);
      ...
      var $position$$53$$ = $$$$73$$.extend({of:this.$active$}, this.$_submenuPosition$);
      clearTimeout(this.$timer$);
      this.element.find(".oj-menu").not($submenu$$2$$.parents(".oj-menu")).hide().attr("aria-hidden", "true").removeData("oj-menu-position");
      $submenu$$2$$.show().removeAttr("aria-hidden").position($position$$53$$).data("oj-menu-position", $position$$53$$);
      ...
      function $collapseMenu$$() {
        delete $self$$230$$.$timer$;
        var $currentMenu$$1$$ = $all$$1$$ ? $self$$230$$.element : $$$$73$$($event$$676$$ && $event$$676$$.target).closest($self$$230$$.element.find(".oj-menu"));
        $currentMenu$$1$$.length || ($currentMenu$$1$$ = $self$$230$$.element);
        $self$$230$$.$_close$($currentMenu$$1$$);
        $self$$230$$.$_blur$($event$$676$$);
        $self$$230$$.$activeMenu$ = $currentMenu$$1$$;
      }
      clearTimeout(this.$timer$);
      var $self$$230$$ = this;
      ...
      if (!this.$active$ && $event$$682$$ && $event$$682$$.target) {
        var $menuItem$$3_ui$$49$$ = $$$$73$$($event$$682$$.target).closest(".oj-menu-item");
        $menuItem$$3_ui$$49$$.closest(this.element).length && this.$_makeActive$($menuItem$$3_ui$$49$$, $event$$682$$);
      }
      this.$active$ ? this.$active$.has(".oj-menu").length || this.$active$.is(".oj-disabled") ? $oj$$79$$.$Logger$.warn("Selecting a disabled menu item or parent menu item is not allowed.") : ($menuItem$$3_ui$$49$$ = {item:this.$active$}, this.$__collapseAll$($event$$682$$, !0), this.$_launcher$ && this.$_focusLauncherAndDismiss$($event$$682$$), this._trigger("select", $event$$682$$, $menuItem$$3_ui$$49$$)) : $oj$$79$$.$Logger$.warn("Menu._select() called when no menu item is focused and no menu item can be inferred from event param.");
      ...
      var $origUsing$$1_position$$54_rootMenu$$ = $props$$26$$.element.element;
      $origUsing$$1_position$$54_rootMenu$$.css($pos$$19$$);
      ($origUsing$$1_position$$54_rootMenu$$ = $origUsing$$1_position$$54_rootMenu$$.data("oj-menu-position")) && ($origUsing$$1_position$$54_rootMenu$$ = $origUsing$$1_position$$54_rootMenu$$.origUsing) && $origUsing$$1_position$$54_rootMenu$$($pos$$19$$, $props$$26$$);
