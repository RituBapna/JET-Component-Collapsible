...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtSunburst"], function($oj$$33$$, $$$$30$$, $comp$$8$$, $base$$7$$, $dvt$$4$$) {
  $oj$$33$$.$__registerWidget$("oj.ojSunburst", $$$$30$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null, rotateInput:null}, $_CreateDvtComponent$:function($context$$121$$, $callback$$109$$, $callbackObj$$6$$) {
    ...
    var $type$$89$$ = $event$$404$$ && $event$$404$$.getType ? $event$$404$$.getType() : null;
    $type$$89$$ === $dvt$$4$$.DvtSelectionEvent.TYPE ? this.$_UserOptionChange$("selection", $event$$404$$.getSelection()) : $type$$89$$ === $dvt$$4$$.DvtSunburstRotationEvent.TYPE ? this.$_UserOptionChange$("startAngle", $event$$404$$.getStartAngle()) : $type$$89$$ === $dvt$$4$$.DvtSunburstRotationEvent.TYPE_INPUT ? this._trigger("rotateInput", null, {value:$event$$404$$.getStartAngle()}) : this._super($event$$404$$);
