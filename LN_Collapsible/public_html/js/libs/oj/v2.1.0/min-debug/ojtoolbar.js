...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$67$$, $$$$62$$) {
  (function() {
    $oj$$67$$.$__registerWidget$("oj.ojToolbar", $$$$62$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{chroming:"half"}, $_InitOptions$:function($originalDefaults$$19$$, $constructorOptions$$21$$) {
      ...
      return $$button$$3$$.map(function($index$$278$$, $elem$$123$$) {
        if ("radio" != $elem$$123$$.type || $elem$$123$$.checked || "" == $elem$$123$$.name) {
          return $elem$$123$$;
        }
        var $$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$ = $elem$$123$$.name;
        $$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$ ? ($$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$ = $$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$.replace(/'/g, "\\'"), $$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$ = $$enabledButtons$$2$$.filter(":radio[name\x3d'" + $$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$ + "']:oj-button")) : $$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$ = $$enabledButtons$$2$$.filter($elem$$123$$).filter(":oj-button");
        $$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$ = $$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$.filter(":checked");
        return $$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$.length ? $$checkedRadio$$1_$radios$$inline_1043_name$$inline_1042$$[0] : $elem$$123$$;
      });
