...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$64$$, $$$$59$$) {
  $oj$$64$$.$CollectionTableDataSource$ = function $$oj$$64$$$$CollectionTableDataSource$$($data$$163$$, $options$$346$$) {
    this.data = {};
    if (!($data$$163$$ instanceof $oj$$64$$.$Collection$)) {
    ...
    $oj$$64$$.$CollectionTableDataSource$.$superclass$.constructor.call(this, $data$$163$$, $options$$346$$);
    this.$_collection$ = $data$$163$$;
  ...
  $oj$$64$$.$CollectionTableDataSource$.prototype.at = function $$oj$$64$$$$CollectionTableDataSource$$$at$($index$$269$$, $options$$347$$) {
    $options$$347$$ = $options$$347$$ || {};
    $options$$347$$.deferred = !0;
    var $model$$92$$ = this.$_collection$.at($index$$269$$, $options$$347$$), $self$$197$$ = this;
    $self$$197$$.$_isFetchingForAt$ = !0;
    var $row$$42$$;
    return new Promise(function($resolve$$54$$, $reject$$51$$) {
      null != $model$$92$$ ? $model$$92$$.then(function($resolvedModel$$) {
        $self$$197$$.$_isFetchingForAt$ = !1;
        $row$$42$$ = {data:$resolvedModel$$.attributes, index:$index$$269$$, key:$resolvedModel$$.id};
        $resolve$$54$$($row$$42$$);
      }, function($e$$104$$) {
        $self$$197$$.$_isFetchingForAt$ = !1;
        $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call($self$$197$$, $oj$$64$$.$TableDataSource$.$EventType$.ERROR, $e$$104$$);
        $reject$$51$$($e$$104$$);
      }) : $resolve$$54$$(null);
    });
  };
  ...
  $oj$$64$$.$CollectionTableDataSource$.prototype.get = function $$oj$$64$$$$CollectionTableDataSource$$$get$($id$$56$$, $options$$349$$) {
    ...
    var $model$$93$$ = this.$_collection$.get($id$$56$$, $options$$349$$), $self$$198$$ = this, $row$$43$$;
    return new Promise(function($resolve$$55$$, $reject$$52$$) {
      null != $model$$93$$ ? $model$$93$$.then(function($resolvedModel$$1$$) {
        ...
        $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call($self$$198$$, $oj$$64$$.$TableDataSource$.$EventType$.ERROR, $e$$105$$);
        $reject$$52$$($e$$105$$);
      }) : $resolve$$55$$(null);
    });
  };
  ...
  $oj$$64$$.$CollectionTableDataSource$.prototype.sort = function $$oj$$64$$$$CollectionTableDataSource$$$sort$($criteria$$6$$) {
    ...
    return new Promise(function($resolve$$56$$) {
      $self$$199$$.$_setComparator$($criteria$$6$$);
      $self$$199$$.$_collection$.sort(null);
      $resolve$$56$$({header:$criteria$$6$$.key, direction:$criteria$$6$$.direction});
    });
  };
  ...
  $oj$$64$$.$CollectionTableDataSource$.prototype.$_addCollectionEventListeners$ = function $$oj$$64$$$$CollectionTableDataSource$$$$_addCollectionEventListeners$$() {
    ...
    this.$_collection$.on($oj$$64$$.$Events$.$EventType$.SYNC, function($event$$553_result$$70$$) {
      if ($event$$553_result$$70$$ instanceof $oj$$64$$.$Collection$ && !$self$$200$$.$_isFetchingForAt$ && !$self$$200$$.$_isFetching$) {
        var $startIndex$$29$$ = $event$$553_result$$70$$.offset, $pageSize$$7$$ = $event$$553_result$$70$$.lastFetchCount;
        0 < $pageSize$$7$$ ? ($self$$200$$.$_startIndex$ = $startIndex$$29$$, $self$$200$$.$_pageSize$ = $pageSize$$7$$, $self$$200$$.$_isFetchingForAt$ = !0, $event$$553_result$$70$$.$IterativeAt$($startIndex$$29$$, $startIndex$$29$$ + $pageSize$$7$$).then(function($modelArray$$2$$) {
          $self$$200$$.$_isFetchingForAt$ = !1;
          ...
          $self$$200$$.$_endFetch$.call($self$$200$$, {silent:!1}, {data:$rowArray$$9$$, keys:$keyArray$$1$$, startIndex:$startIndex$$29$$}, null);
        })) : ($event$$553_result$$70$$ = $self$$200$$.$_getRowArray$(), $self$$200$$.$_endFetch$.call($self$$200$$, {silent:!1}, $event$$553_result$$70$$, null));
      }
    });
    this.$_collection$.on($oj$$64$$.$Events$.$EventType$.ALLADDED, function($event$$554$$, $modelArray$$3$$) {
      ...
      $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call($self$$200$$, $oj$$64$$.$TableDataSource$.$EventType$.ADD, {data:$rowArray$$10$$, keys:$keyArray$$2$$, indexes:$indexArray$$3$$});
    });
    this.$_collection$.on($oj$$64$$.$Events$.$EventType$.ALLREMOVED, function($event$$555$$, $modelArray$$4$$) {
      ...
      $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call($self$$200$$, $oj$$64$$.$TableDataSource$.$EventType$.REMOVE, {data:$rowArray$$11$$, keys:$keyArray$$3$$, indexes:$indexArray$$4$$});
    });
    this.$_collection$.on($oj$$64$$.$Events$.$EventType$.RESET, function($event$$556$$) {
      $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call($self$$200$$, $oj$$64$$.$TableDataSource$.$EventType$.RESET, $event$$556$$);
    });
    this.$_collection$.on($oj$$64$$.$Events$.$EventType$.SORT, function($event$$557$$, $eventOpts$$2$$) {
      null != $eventOpts$$2$$ && $eventOpts$$2$$.add || $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call($self$$200$$, $oj$$64$$.$TableDataSource$.$EventType$.SORT, $event$$557$$);
    });
    this.$_collection$.on($oj$$64$$.$Events$.$EventType$.CHANGE, function($event$$558$$) {
      $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call($self$$200$$, $oj$$64$$.$TableDataSource$.$EventType$.CHANGE, {data:[$event$$558$$.attributes], keys:[$event$$558$$.id], indexes:[$event$$558$$.index]});
    });
    this.$_collection$.on($oj$$64$$.$Events$.$EventType$.DESTROY, function($event$$559$$) {
      $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call($self$$200$$, $oj$$64$$.$TableDataSource$.$EventType$.DESTROY, $event$$559$$);
    });
    this.$_collection$.on($oj$$64$$.$Events$.$EventType$.REFRESH, function($event$$560$$) {
      $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call($self$$200$$, $oj$$64$$.$TableDataSource$.$EventType$.REFRESH, $event$$560$$);
    });
    this.$_collection$.on($oj$$64$$.$Events$.$EventType$.ERROR, function($collection$$58$$, $xhr$$21$$, $options$$350$$) {
      $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call($self$$200$$, $oj$$64$$.$TableDataSource$.$EventType$.ERROR, $collection$$58$$, $xhr$$21$$, $options$$350$$);
    });
  };
  $oj$$64$$.$CollectionTableDataSource$.prototype.$_fetchInternal$ = function $$oj$$64$$$$CollectionTableDataSource$$$$_fetchInternal$$($options$$351$$) {
    ...
    return new Promise(function($resolve$$57$$, $reject$$54$$) {
      if ($self$$201$$.$_isPaged$) {
        $self$$201$$.$_collection$.$setRangeLocal$($self$$201$$.$_startIndex$, $self$$201$$.$_pageSize$).then(function($actual$$6$$) {
          var $result$$73_rowArray$$12$$ = [], $keyArray$$4$$ = [], $i$$387$$;
          for ($i$$387$$ = 0;$i$$387$$ < $actual$$6$$.models.length;$i$$387$$++) {
            $result$$73_rowArray$$12$$[$i$$387$$] = $actual$$6$$.models[$i$$387$$].attributes, $keyArray$$4$$[$i$$387$$] = $actual$$6$$.models[$i$$387$$].id;
          }
          $result$$73_rowArray$$12$$ = {data:$result$$73_rowArray$$12$$, keys:$keyArray$$4$$, startIndex:$self$$201$$.$_startIndex$};
          $actual$$6$$.models.length < $self$$201$$.$_pageSize$ ? 0 > $self$$201$$.totalSize() && ($self$$201$$.$_fetchResultSize$ = $self$$201$$.$_startIndex$ + $actual$$6$$.models.length) : $self$$201$$.$_fetchResultSize$ = null;
          $self$$201$$.$_endFetch$.call($self$$201$$, $options$$351$$, $result$$73_rowArray$$12$$, null);
          $resolve$$57$$($result$$73_rowArray$$12$$);
        }, function($error$$45$$) {
          $self$$201$$.$_endFetch$.call($self$$201$$, $options$$351$$, null, $error$$45$$);
          $reject$$54$$($error$$45$$);
        });
      } else {
        if (0 < $self$$201$$.$_collection$.size()) {
          var $result$$72$$ = $self$$201$$.$_getRowArray$();
          $self$$201$$.$_endFetch$.call($self$$201$$, $options$$351$$, $result$$72$$, null);
          $resolve$$57$$($result$$72$$);
        } else {
          $self$$201$$.$_collection$.fetch({success:function($collection$$59_result$$74$$) {
            $self$$201$$.$_collection$ = $collection$$59_result$$74$$;
            $collection$$59_result$$74$$ = $self$$201$$.$_getRowArray$();
            $self$$201$$.$_endFetch$.call($self$$201$$, $options$$351$$, $collection$$59_result$$74$$, null);
            $resolve$$57$$($collection$$59_result$$74$$);
          }, error:function($collection$$60$$, $e$$106$$) {
            $self$$201$$.$_collection$ = $collection$$60$$;
            $self$$201$$.$_endFetch$.call($self$$201$$, $options$$351$$, null, $e$$106$$);
            $reject$$54$$($e$$106$$);
          }});
        }
      }
  ...
  $oj$$64$$.$CollectionTableDataSource$.prototype.$_endFetch$ = function $$oj$$64$$$$CollectionTableDataSource$$$$_endFetch$$($options$$353$$, $result$$75$$, $error$$46$$) {
    this.$_isFetching$ = !1;
    null != $error$$46$$ ? $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call(this, $oj$$64$$.$TableDataSource$.$EventType$.ERROR, $error$$46$$) : $options$$353$$.silent || $oj$$64$$.$TableDataSource$.$superclass$.handleEvent.call(this, $oj$$64$$.$TableDataSource$.$EventType$.SYNC, $result$$75$$);
  };
  $oj$$64$$.$CollectionTableDataSource$.prototype.$_setComparator$ = function $$oj$$64$$$$CollectionTableDataSource$$$$_setComparator$$($criteria$$7_direction$$13$$) {
    if (null == $criteria$$7_direction$$13$$) {
      ...
      this.$_collection$.$IsVirtual$() ? (this.$_collection$.comparator = $key$$169$$, this.$_collection$.sortDirection = "ascending" === $criteria$$7_direction$$13$$ ? 1 : -1) : ("ascending" == $criteria$$7_direction$$13$$ ? $comparator$$15$$ = function $$comparator$$15$$$($row$$44$$) {
        ...
        var $a$$118$$, $b$$74$$;
        $$$$59$$.isFunction($rowA$$1$$.get) ? ($a$$118$$ = $rowA$$1$$.get($key$$169$$), $b$$74$$ = $rowB$$1$$.get($key$$169$$)) : ($a$$118$$ = $rowA$$1$$[$key$$169$$](), $b$$74$$ = $rowB$$1$$[$key$$169$$]());
        return $a$$118$$ === $b$$74$$ ? 0 : $a$$118$$ > $b$$74$$ ? -1 : 1;
