...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtPictoChart"], function($oj$$50$$, $$$$45$$, $comp$$12$$, $base$$11$$, $dvt$$8$$) {
  $oj$$50$$.$__registerWidget$("oj.ojPictoChart", $$$$45$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null, drill:null}, $_CreateDvtComponent$:function($context$$148$$, $callback$$115$$, $callbackObj$$10$$) {
    ...
    var $type$$95$$ = $event$$515$$ && $event$$515$$.getType ? $event$$515$$.getType() : null;
    $type$$95$$ === $dvt$$8$$.DvtSelectionEvent.TYPE ? this.$_UserOptionChange$("selection", $event$$515$$.getSelection()) : $type$$95$$ === $dvt$$8$$.DvtCategoryRolloverEvent.TYPE_OVER || $type$$95$$ === $dvt$$8$$.DvtCategoryRolloverEvent.TYPE_OUT ? this.$_UserOptionChange$("highlightedCategories", $event$$515$$.categories) : $type$$95$$ === $dvt$$8$$.DvtDrillEvent.TYPE ? this._trigger("drill", null, {id:$event$$515$$.getId()}) : this._super($event$$515$$);
  }, getItem:function($index$$225$$) {
    return this.$_component$.getAutomation().getItem($index$$225$$);
