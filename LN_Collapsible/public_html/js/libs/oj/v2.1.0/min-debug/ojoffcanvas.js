...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$35$$, $$$$32$$, $Hammer$$5$$) {
  ...
  $oj$$35$$.$OffcanvasUtils$.$_registerCloseHandler$ = function $$oj$$35$$$$OffcanvasUtils$$$_registerCloseHandler$$($offcanvas$$8$$) {
    ...
    if ($oj$$35$$.$OffcanvasUtils$.$_isAutoDismiss$($offcanvas$$8$$)) {
      var $drawer$$6$$ = $oj$$35$$.$OffcanvasUtils$.$_getDrawer$($offcanvas$$8$$), $dismisHandler$$ = $offcanvas$$8$$[$oj$$35$$.$OffcanvasUtils$.$DISMISS_HANDLER_KEY$] = function $$offcanvas$$8$$$$oj$$35$$$$OffcanvasUtils$$$DISMISS_HANDLER_KEY$$($event$$416$$) {
        var $target$$92$$ = $event$$416$$.target;
        $oj$$35$$.$DomUtils$.$isChromeEvent$($event$$416$$) || "focus" === $event$$416$$.type && !$$$$32$$($target$$92$$).is(":focusable") || $oj$$35$$.$DomUtils$.$isLogicalAncestorOrSelf$($drawer$$6$$[0], $target$$92$$) || $oj$$35$$.$OffcanvasUtils$.close($offcanvas$$8$$);
  ...
  $oj$$35$$.$OffcanvasUtils$.$_registerSwipeHandler$ = function $$oj$$35$$$$OffcanvasUtils$$$_registerSwipeHandler$$($offcanvas$$10$$) {
    if ($oj$$35$$.$DomUtils$.$isTouchSupported$()) {
      var $selector$$32$$ = $offcanvas$$10$$[$oj$$35$$.$OffcanvasUtils$.$SELECTOR_KEY$], $drawer$$7_drawerHammer$$ = $$$$32$$($selector$$32$$), $edge$$6$$ = $oj$$35$$.$OffcanvasUtils$.$_getEdge$($drawer$$7_drawerHammer$$), $swipeEvent$$, $options$$307$$;
      ...
      $drawer$$7_drawerHammer$$ = $drawer$$7_drawerHammer$$.$ojHammer$($options$$307$$).on($swipeEvent$$, function($event$$417$$) {
  ...
  $oj$$35$$.$OffcanvasUtils$.$_unregisterSwipeHandler$ = function $$oj$$35$$$$OffcanvasUtils$$$_unregisterSwipeHandler$$($dHammer_drawer$$8_offcanvas$$11$$) {
    ...
    ($dHammer_drawer$$8_offcanvas$$11$$ = $$$$32$$.data($dHammer_drawer$$8_offcanvas$$11$$[0], $oj$$35$$.$OffcanvasUtils$.$_DATA_HAMMER_KEY$)) && $dHammer_drawer$$8_offcanvas$$11$$.hammer.off($dHammer_drawer$$8_offcanvas$$11$$.event);
  };
  ...
  $oj$$35$$.$OffcanvasUtils$.$setupResponsive$ = function $$oj$$35$$$$OffcanvasUtils$$$setupResponsive$$($mqListener_offcanvas$$13$$) {
    ...
    if (null !== $mqs_query$$11$$) {
      ...
      $mqListener_offcanvas$$13$$ = function $$mqListener_offcanvas$$13$$$($event$$418$$) {
  ...
  $oj$$35$$.$OffcanvasUtils$.open = function $$oj$$35$$$$OffcanvasUtils$$open$($offcanvas$$15$$) {
    ...
    var $oldOffcanvas_promise$$7$$ = new Promise(function($resolve$$38$$, $reject$$35$$) {
      $oj$$35$$.$Assert$.$assertPrototype$($drawer$$12$$, jQuery);
      var $edge$$10$$ = $oj$$35$$.$OffcanvasUtils$.$_saveEdge$($offcanvas$$15$$), $displayMode$$2_event$$419$$ = $$$$32$$.Event("ojbeforeopen");
      $drawer$$12$$.trigger($displayMode$$2_event$$419$$, $offcanvas$$15$$);
      if (!1 === $displayMode$$2_event$$419$$.result) {
        $reject$$35$$("ojbeforeopen veto");
      } else {
        var $size$$24$$, $displayMode$$2_event$$419$$ = $oj$$35$$.$OffcanvasUtils$.$_getDisplayMode$($offcanvas$$15$$), $myOffcanvas$$ = $$$$32$$.extend({}, $offcanvas$$15$$);
        ...
        $edge$$10$$ === $oj$$35$$.$OffcanvasUtils$.$EDGE_START$ || $edge$$10$$ === $oj$$35$$.$OffcanvasUtils$.$EDGE_END$ ? ($size$$24$$ = void 0 === $size$$24$$ ? $drawer$$12$$.outerWidth(!0) + "px" : $size$$24$$, $displayMode$$2_event$$419$$ === $oj$$35$$.$OffcanvasUtils$.$DISPLAY_MODE_PUSH$ && $oj$$35$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$8$$, $edge$$10$$, $size$$24$$)) : ($size$$24$$ = void 0 === $size$$24$$ ? $drawer$$12$$.outerHeight(!0) + "px" : $size$$24$$, $displayMode$$2_event$$419$$ === 
  ...
  $oj$$35$$.$OffcanvasUtils$.$_close$ = function $$oj$$35$$$$OffcanvasUtils$$$_close$$($selector$$35$$, $animation$$2$$) {
    ...
    var $promise$$8$$ = new Promise(function($resolve$$39$$, $reject$$36$$) {
      if ($oj$$35$$.$OffcanvasUtils$.$_isOpen$($drawer$$13$$)) {
        $selector$$35$$ != $offcanvas$$17$$[$oj$$35$$.$OffcanvasUtils$.$SELECTOR_KEY$] && $resolve$$39$$(!0);
        ...
        $outerWrapper$$1$$.hasClass($edge$$11_shiftSelector$$) || $resolve$$39$$(!0);
        var $event$$420_wrapper$$9$$ = $$$$32$$.Event("ojbeforeclose");
        $drawer$$13$$.trigger($event$$420_wrapper$$9$$, $offcanvas$$17$$);
        if (!1 === $event$$420_wrapper$$9$$.result) {
          $reject$$36$$("beforeClose veto");
        } else {
          $event$$420_wrapper$$9$$ = $oj$$35$$.$OffcanvasUtils$.$_getAnimateWrapper$($offcanvas$$17$$);
          if ($animation$$2$$) {
          ...
          $animation$$2$$ ? $event$$420_wrapper$$9$$.addClass($oj$$35$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$) : ($oj$$35$$.$OffcanvasUtils$.$_afterCloseHandler$($offcanvas$$17$$), $resolve$$39$$(!0));
        }
      } else {
        $resolve$$39$$(!0);
      }
  ...
  $oj$$35$$.$OffcanvasUtils$.$setupPanToReveal$ = function $$oj$$35$$$$OffcanvasUtils$$$setupPanToReveal$$($offcanvas$$23$$) {
    var $drawer$$20$$, $size$$25$$, $outerWrapper$$2$$, $wrapper$$10$$, $mOptions$$, $proceed$$, $direction$$7$$, $ui$$22$$, $evt$$26$$, $delta$$6$$, $edge$$12$$, $listener$$39$$;
    null == $$$$32$$($offcanvas$$23$$).attr("oj-data-pansetup") && ($$$$32$$($offcanvas$$23$$).attr("oj-data-pansetup", "true"), $offcanvas$$23$$.displayMode = "push", $drawer$$20$$ = $oj$$35$$.$OffcanvasUtils$.$_getDrawer$($offcanvas$$23$$), $size$$25$$ = $offcanvas$$23$$.size, null == $size$$25$$ && ($size$$25$$ = $drawer$$20$$.outerWidth()), $outerWrapper$$2$$ = $oj$$35$$.$OffcanvasUtils$.$_getOuterWrapper$($drawer$$20$$), $wrapper$$10$$ = $oj$$35$$.$OffcanvasUtils$.$_getAnimateWrapper$($offcanvas$$23$$), 
    $mOptions$$ = {recognizers:[[$Hammer$$5$$.Pan, {direction:$Hammer$$5$$.DIRECTION_HORIZONTAL}]]}, $proceed$$ = !1, $$$$32$$($outerWrapper$$2$$).$ojHammer$($mOptions$$).on("panstart", function($event$$422$$) {
      ...
      null != $direction$$7$$ && ($ui$$22$$ = {direction:$direction$$7$$, distance:Math.abs($event$$422$$.gesture.deltaX)}, $evt$$26$$ = $$$$32$$.Event("ojpanstart"), $drawer$$20$$.trigger($evt$$26$$, $ui$$22$$), $evt$$26$$.isDefaultPrevented() || ($offcanvas$$23$$._closePromise = null, $oj$$35$$.$OffcanvasUtils$.$_toggleClass$($offcanvas$$23$$, $wrapper$$10$$, !0), $proceed$$ = !0, $event$$422$$.stopPropagation()));
    }).on("panmove", function($event$$423$$) {
      $proceed$$ && ($delta$$6$$ = Math.abs($event$$423$$.gesture.deltaX), $drawer$$20$$.css("width", $delta$$6$$), $wrapper$$10$$.removeClass($oj$$35$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$), $oj$$35$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$10$$, "start", $event$$423$$.gesture.deltaX + "px"), $ui$$22$$ = {direction:$direction$$7$$, distance:$delta$$6$$}, $evt$$26$$ = $$$$32$$.Event("ojpanmove"), $drawer$$20$$.trigger($evt$$26$$, $ui$$22$$), $event$$423$$.stopPropagation());
    }).on("panend", function($event$$424$$) {
      $proceed$$ && ($proceed$$ = !1, $delta$$6$$ = Math.abs($event$$424$$.gesture.deltaX), $ui$$22$$ = {distance:$delta$$6$$}, $evt$$26$$ = $$$$32$$.Event("ojpanend"), $drawer$$20$$.trigger($evt$$26$$, $ui$$22$$), $event$$424$$.stopPropagation(), $evt$$26$$.isDefaultPrevented() ? ($listener$$39$$ = function $$listener$$39$$$() {
      ...
      }, $wrapper$$10$$.on("transitionend webkitTransitionEnd otransitionend oTransitionEnd", $listener$$39$$), $wrapper$$10$$.addClass($oj$$35$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$), $oj$$35$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$10$$, "start", "0px")) : ($wrapper$$10$$.addClass($oj$$35$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$), $drawer$$20$$.css("width", $size$$25$$ + "px"), $edge$$12$$ = $offcanvas$$23$$.edge, null == $edge$$12$$ && ($edge$$12$$ = $drawer$$20$$.hasClass("oj-offcanvas-start") ? 
      "start" : "end"), $oj$$35$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$10$$, $edge$$12$$, $size$$25$$ + "px"), $$$$32$$.data($drawer$$20$$[0], $oj$$35$$.$OffcanvasUtils$.$_DATA_OFFCANVAS_KEY$, $offcanvas$$23$$), $$$$32$$.data($drawer$$20$$[0], $oj$$35$$.$OffcanvasUtils$.$_DATA_EDGE_KEY$, $edge$$12$$), $oj$$35$$.$OffcanvasUtils$.$_registerCloseHandler$($offcanvas$$23$$)));
    }));
  };
