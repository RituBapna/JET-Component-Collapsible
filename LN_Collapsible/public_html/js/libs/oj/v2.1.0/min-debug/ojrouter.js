...
define(["ojs/ojcore", "knockout", "signals", "promise"], function($oj$$17$$, $ko$$3$$, $signals$$1$$) {
  (function() {
    ...
    function $addStateParam$$($url$$22$$, $extraState$$1$$) {
      if ($extraState$$1$$ && 0 < Object.getOwnPropertyNames($extraState$$1$$).length) {
        ...
        var $JSCompiler_temp_const$$10$$ = $url$$22$$, $compressedState$$inline_733_jsonState$$inline_731$$ = JSON.stringify($extraState$$1$$), $encodedState$$inline_732$$ = encodeURIComponent($compressedState$$inline_733_jsonState$$inline_731$$), $compressedState$$inline_733_jsonState$$inline_731$$ = $oj$$17$$.$LZString$.$compressToEncodedURIComponent$($compressedState$$inline_733_jsonState$$inline_731$$), $useCompressed$$inline_734$$ = !1, $param$$inline_735$$ = "oj_Router\x3d";
        $compressedState$$inline_733_jsonState$$inline_731$$.length <= $encodedState$$inline_732$$.length && ($useCompressed$$inline_734$$ = !0);
        $param$$inline_735$$ = $useCompressed$$inline_734$$ ? $param$$inline_735$$ + ("1" + $compressedState$$inline_733_jsonState$$inline_731$$) : $param$$inline_735$$ + ("0" + $encodedState$$inline_732$$);
        if (1024 < $param$$inline_735$$.length) {
          throw Error("Size of bookmarkable data is too big.");
        }
        $url$$22$$ = $JSCompiler_temp_const$$10$$ + ($sep$$1$$ + $param$$inline_735$$);
      }
      return $url$$22$$;
    }
    ...
    function $_executeTransition$$($transition$$) {
      ...
      return "undefined" !== typeof $transition$$.url ? "sync" === $transition$$.origin ? $parseAndUpdate$$($transition$$.url) : $_canExit$$($transition$$.$router$).then(function($canExit$$2$$) {
    ...
    $oj$$17$$.$Router$.prototype.$store$ = function $$oj$$17$$$$Router$$$$store$$($data$$119_extraState$$2$$) {
      this.$_extra$ = $data$$119_extraState$$2$$;
      $data$$119_extraState$$2$$ = {};
      for (var $router$$10$$ = this;$router$$10$$;) {
        $router$$10$$.$_extra$ && ($data$$119_extraState$$2$$[$router$$10$$.$_name$] = $router$$10$$.$_extra$), $router$$10$$ = $router$$10$$.$_parentRouter$;
      }
      for (var $router$$10$$ = this, $nextLevel_url$$26$$, $i$$255$$, $sr$$4$$;$router$$10$$;) {
        for ($i$$255$$ = 0;$i$$255$$ < $router$$10$$.$_childRouters$.length;$i$$255$$++) {
          if ($sr$$4$$ = $router$$10$$.$_childRouters$[$i$$255$$], $router$$10$$.$_stateId$() && $router$$10$$.$_stateId$() === $sr$$4$$.$_parentState$) {
            $sr$$4$$.$_extra$ && ($data$$119_extraState$$2$$[$sr$$4$$.$_name$] = $sr$$4$$.$_extra$);
      ...
      $nextLevel_url$$26$$ = $addStateParam$$($nextLevel_url$$26$$, $data$$119_extraState$$2$$);
    ...
    $oj$$17$$.$Router$.$sync$ = function $$oj$$17$$$$Router$$$sync$$() {
      ...
      if ($oj$$17$$.$Router$.$_updating$) {
        return $oj$$17$$.$Logger$.info("Sync called while updating, waiting for updates to end."), new Promise(function($resolve$$28$$) {
          $oj$$17$$.$Router$.$_transitionedToState$.addOnce(function($result$$45$$) {
            $oj$$17$$.$Logger$.info("Sync updates done.");
            $resolve$$28$$($result$$45$$);
          });
        });
      }
  ...
  (function() {
    ...
    function $_decompress$$($length$$16$$, $getNextValue$$) {
      for (var $dictionary$$ = [], $enlargeIn$$ = 4, $dictSize$$ = 4, $numBits$$ = 3, $bits_entry$$4$$ = "", $i$$259_result$$46$$ = "", $w$$5$$, $resb$$, $maxpower$$, $power$$, $c$$39$$, $data$$120$$ = {val:$getNextValue$$(0), position:32, index:1}, $i$$259_result$$46$$ = 0;3 > $i$$259_result$$46$$;$i$$259_result$$46$$ += 1) {
        $dictionary$$[$i$$259_result$$46$$] = $i$$259_result$$46$$;
      }
      $bits_entry$$4$$ = 0;
      $maxpower$$ = Math.pow(2, 2);
      for ($power$$ = 1;$power$$ != $maxpower$$;) {
        $resb$$ = $data$$120$$.val & $data$$120$$.position, $data$$120$$.position >>= 1, 0 == $data$$120$$.position && ($data$$120$$.position = 32, $data$$120$$.val = $getNextValue$$($data$$120$$.index++)), $bits_entry$$4$$ |= (0 < $resb$$ ? 1 : 0) * $power$$, $power$$ <<= 1;
      }
      switch($bits_entry$$4$$) {
        case 0:
          $bits_entry$$4$$ = 0;
    ...
    $oj$$17$$.$LZString$ = {$compressToEncodedURIComponent$:function $$oj$$17$$$$LZString$$$compressToEncodedURIComponent$$($input$$6$$) {
      return null === $input$$6$$ ? "" : $_compress$$($input$$6$$, function($a$$101$$) {
        return $_keyStrUriSafe$$.charAt($a$$101$$);
      });
    }, $decompressFromEncodedURIComponent$:function $$oj$$17$$$$LZString$$$decompressFromEncodedURIComponent$$($input$$7$$) {
      return null === $input$$7$$ ? "" : "" === $input$$7$$ ? null : $_decompress$$($input$$7$$.length, function($character$$inline_766_index$$112$$) {
        var $alphabet$$inline_765$$ = $_keyStrUriSafe$$;
        $character$$inline_766_index$$112$$ = $input$$7$$.charAt($character$$inline_766_index$$112$$);
        var $i$$inline_767$$;
        $_baseReverseDic$$ || ($_baseReverseDic$$ = {});
        if (!$_baseReverseDic$$[$alphabet$$inline_765$$]) {
          for ($_baseReverseDic$$[$alphabet$$inline_765$$] = {}, $i$$inline_767$$ = 0;$i$$inline_767$$ < $alphabet$$inline_765$$.length;$i$$inline_767$$++) {
            $_baseReverseDic$$[$alphabet$$inline_765$$][$alphabet$$inline_765$$[$i$$inline_767$$]] = $i$$inline_767$$;
          }
        }
        return $_baseReverseDic$$[$alphabet$$inline_765$$][$character$$inline_766_index$$112$$];
      });
    }};
