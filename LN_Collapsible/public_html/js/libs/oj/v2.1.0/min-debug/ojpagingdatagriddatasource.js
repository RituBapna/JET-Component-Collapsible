...
define(["ojs/ojcore", "jquery", "ojs/ojpagingtabledatasource"], function($oj$$70$$) {
  ...
  $oj$$70$$.$PagingHeaderSet$.prototype.getData = function $$oj$$70$$$$PagingHeaderSet$$$getData$($index$$283$$, $level$$43$$) {
    return this.$m_headerSet$.getData($index$$283$$ + this.$m_startIndex$, $level$$43$$);
  };
  $oj$$70$$.$Object$.$exportPrototypeSymbol$("PagingHeaderSet.prototype.getData", {getData:$oj$$70$$.$PagingHeaderSet$.prototype.getData});
  $oj$$70$$.$PagingHeaderSet$.prototype.getMetadata = function $$oj$$70$$$$PagingHeaderSet$$$getMetadata$($index$$284$$, $level$$44$$) {
    return this.$m_headerSet$.getMetadata($index$$284$$ + this.$m_startIndex$, $level$$44$$);
  };
  ...
  $oj$$70$$.$PagingHeaderSet$.prototype.$getExtent$ = function $$oj$$70$$$$PagingHeaderSet$$$$getExtent$$($index$$285$$, $level$$45$$) {
    return this.$m_headerSet$.$getExtent$($index$$285$$ + this.$m_startIndex$, $level$$45$$);
  };
  ...
  $oj$$70$$.$PagingHeaderSet$.prototype.$getDepth$ = function $$oj$$70$$$$PagingHeaderSet$$$$getDepth$$($index$$286$$, $level$$46$$) {
    return this.$m_headerSet$.$getDepth$($index$$286$$ + this.$m_startIndex$, $level$$46$$);
  };
  ...
  $oj$$70$$.$PagingDataGridDataSource$.prototype.setPage = function $$oj$$70$$$$PagingDataGridDataSource$$$setPage$($value$$292$$, $options$$365$$) {
    ...
    return new Promise(function($resolve$$60$$, $reject$$57$$) {
      $self$$209$$.$_fetchInternal$($options$$365$$).then(function() {
        $resolve$$60$$(null);
      }, function() {
        $self$$209$$.$_page$ = $previousPage$$3$$;
        $self$$209$$.$_startIndex$ = $self$$209$$.$_page$ * $self$$209$$.$_pageSize$;
        $reject$$57$$(null);
      });
    });
  };
  ...
  $oj$$70$$.$PagingDataGridDataSource$.prototype.$_fetchInternal$ = function $$oj$$70$$$$PagingDataGridDataSource$$$$_fetchInternal$$($options$$366$$) {
    ...
    return new Promise(function($resolve$$61$$) {
      $self$$210$$.handleEvent("change", {operation:"sync", pageSize:$self$$210$$.$_pageSize$});
      $resolve$$61$$(void 0);
    });
  };
  ...
  $oj$$70$$.$PagingDataGridDataSource$.prototype.$moveOK$ = function $$oj$$70$$$$PagingDataGridDataSource$$$$moveOK$$($rowToMove$$9$$, $referenceRow$$9$$, $position$$42$$) {
    return this.$dataSource$.$moveOK$($rowToMove$$9$$, $referenceRow$$9$$, $position$$42$$);
  };
  ...
  $oj$$70$$.$PagingDataGridDataSource$.prototype.move = function $$oj$$70$$$$PagingDataGridDataSource$$$move$($moveKey$$2$$, $atKey$$2$$, $position$$43$$, $callbacks$$55$$, $callbackObjects$$31$$) {
    this.$dataSource$.move($moveKey$$2$$, $atKey$$2$$, $position$$43$$, $callbacks$$55$$, $callbackObjects$$31$$);
  };
