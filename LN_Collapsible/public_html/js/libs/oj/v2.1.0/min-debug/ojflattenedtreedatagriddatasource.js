...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojrowexpander"], function($oj$$68$$) {
  ...
  $oj$$68$$.$FlattenedTreeHeaderSet$.prototype.getData = function $$oj$$68$$$$FlattenedTreeHeaderSet$$$getData$($index$$279$$, $level$$39$$) {
    var $rowData$$5$$;
    ...
    return null != this.$m_rowHeader$ && null != this.$m_nodeSet$ ? ($rowData$$5$$ = this.$m_nodeSet$.getData($index$$279$$ - this.$m_start$ + this.$m_nodeSet$.$getStart$()), null != $rowData$$5$$ ? $rowData$$5$$.get ? $rowData$$5$$.get(this.$m_rowHeader$) : $rowData$$5$$[this.$m_rowHeader$] : null) : this.$m_headers$[$index$$279$$];
  };
  ...
  $oj$$68$$.$FlattenedTreeHeaderSet$.prototype.getMetadata = function $$oj$$68$$$$FlattenedTreeHeaderSet$$$getMetadata$($index$$280$$, $level$$40$$) {
    ...
    return null != this.$m_rowHeader$ && null != this.$m_nodeSet$ ? this.$m_nodeSet$.getMetadata($index$$280$$ - this.$m_start$ + this.$m_nodeSet$.$getStart$()) : {key:this.getData($index$$280$$)};
  };
  ...
  $oj$$68$$.$FlattenedTreeHeaderSet$.prototype.$getExtent$ = function $$oj$$68$$$$FlattenedTreeHeaderSet$$$$getExtent$$($index$$281$$, $level$$41$$) {
    $oj$$68$$.$Assert$.assert($index$$281$$ <= this.$m_end$ && $index$$281$$ >= this.$m_start$, "index out of bounds");
  ...
  $oj$$68$$.$FlattenedTreeHeaderSet$.prototype.$getDepth$ = function $$oj$$68$$$$FlattenedTreeHeaderSet$$$$getDepth$$($index$$282$$, $level$$42$$) {
    $oj$$68$$.$Assert$.assert($index$$282$$ <= this.$m_end$ && $index$$282$$ >= this.$m_start$, "index out of bounds");
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.keys = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$keys$($indexes$$19$$) {
    ...
    return new Promise(function($resolve$$58$$) {
      $rowIndex$$12$$ > $oj$$68$$.$FlattenedTreeDataGridDataSource$.$superclass$.$getFetchedRange$.call(this).end || $colIndex$$ > this.$m_columns$.length ? $resolve$$58$$(null) : $resolve$$58$$({row:$oj$$68$$.$FlattenedTreeDataGridDataSource$.$superclass$.getKey.call(this, $rowIndex$$12$$), column:this.$m_columns$[$colIndex$$]});
    }.bind(this));
  };
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.$indexes$ = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$$indexes$$($keys$$41$$) {
    ...
    return new Promise(function($resolve$$59$$) {
      ...
      0 <= $rowIndex$$13$$ || 0 <= $colIndex$$1$$ ? $resolve$$59$$({row:$rowIndex$$13$$, column:$colIndex$$1$$}) : $resolve$$59$$(null);
    }.bind(this));
  };
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.move = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$move$($rowToMove$$8$$, $referenceRow$$8$$, $position$$41$$, $callbacks$$47$$) {
    $oj$$68$$.$FlattenedTreeDataGridDataSource$.$superclass$.getWrappedDataSource.call(this).move($rowToMove$$8$$, $referenceRow$$8$$, $position$$41$$, $callbacks$$47$$);
  };
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.$insertMetadata$ = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$$insertMetadata$$($key$$180$$, $metadata$$15$$) {
    $oj$$68$$.$FlattenedTreeDataGridDataSource$.$superclass$.$insertMetadata$.call(this, $key$$180$$, $metadata$$15$$);
  };
