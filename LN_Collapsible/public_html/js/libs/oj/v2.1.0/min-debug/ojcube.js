...
define(["ojs/ojcore", "jquery", "promise", "ojs/ojdatasource-common"], function($oj$$18$$, $$$$17$$) {
  ...
  $oj$$18$$.$Cube$.prototype.$_normalizeIndices$ = function $$oj$$18$$$$Cube$$$$_normalizeIndices$$($indices$$3$$) {
    ...
    for (var $numAxes$$ = Math.min($indices$$3$$.length, this.$_axes$.length), $a$$102$$ = 0;$a$$102$$ < $numAxes$$;$a$$102$$++) {
      var $index$$113$$ = $indices$$3$$[$a$$102$$];
      $index$$113$$ instanceof Object && ($index$$113$$.hasOwnProperty("start") || $index$$113$$.hasOwnProperty("count")) ? $index$$113$$.hasOwnProperty("start") ? $index$$113$$.hasOwnProperty("count") ? $ind$$1$$.push(this.$_generateIndex$($index$$113$$.start, $index$$113$$.count, $a$$102$$)) : $ind$$1$$.push(this.$_generateIndex$($index$$113$$.start, 1, $a$$102$$)) : $ind$$1$$.push(this.$_generateIndex$(0, $index$$113$$.count, $a$$102$$)) : $ind$$1$$.push(this.$_generateIndex$($index$$113$$, 1, 
      $a$$102$$));
    }
    return $ind$$1$$;
  };
  ...
  $oj$$18$$.$Cube$.prototype.$_getHashFromPin$ = function $$oj$$18$$$$Cube$$$$_getHashFromPin$$($pin$$1$$) {
    ...
    if ($pin$$1$$ && 0 < $pin$$1$$.length) {
      $pin$$1$$.sort(function($a$$103$$, $b$$63$$) {
        return $a$$103$$.axis - $b$$63$$.axis;
      });
  ...
  $oj$$18$$.$Cube$.prototype.$_createCubeKeys$ = function $$oj$$18$$$$Cube$$$$_createCubeKeys$$($indices$$5$$) {
    for (var $axes$$2$$ = this.$getAxes$(), $keys$$13$$ = new $oj$$18$$.$CubeKeys$, $a$$104$$ = 0;$a$$104$$ < $indices$$5$$.length;$a$$104$$++) {
      $keys$$13$$ = $axes$$2$$[$a$$104$$].$GetCubeKeys$($indices$$5$$[$a$$104$$], $keys$$13$$);
    }
    return $keys$$13$$;
  };
