...
define(["ojs/ojcore", "jquery", "knockout", "ojs/ojdatasource-common", "ojs/ojmodel", "ojs/ojknockout-model"], function($oj$$63$$, $$$$58$$, $ko$$6$$) {
  ...
  $oj$$63$$.$CollectionPagingDataSource$.prototype.$_refreshDataWindow$ = function $$oj$$63$$$$CollectionPagingDataSource$$$$_refreshDataWindow$$() {
    ...
    return this.$collection$.$IterativeAt$(this.current, this.current + this.$dataWindow$.length).then(function($array$$16$$) {
      for (var $i$$382$$ = 0;$i$$382$$ < $array$$16$$.length;$i$$382$$++) {
        $self$$193$$.$dataWindow$[$i$$382$$] = $array$$16$$[$i$$382$$];
      }
      $self$$193$$.$_refreshObservableDataWindow$();
      $self$$193$$.$_endIndex$ = $self$$193$$.$_startIndex$ + $self$$193$$.$dataWindow$.length - 1;
    });
  };
  ...
  $oj$$63$$.$CollectionPagingDataSource$.prototype.setPage = function $$oj$$63$$$$CollectionPagingDataSource$$$setPage$($value$$286$$, $options$$342$$) {
    ...
    var $self$$194$$ = this;
    return new Promise(function($resolve$$52$$, $reject$$49$$) {
      $self$$194$$.$_fetchInternal$($options$$342$$).then(function() {
        $oj$$63$$.$CollectionPagingDataSource$.$superclass$.handleEvent.call($self$$194$$, $oj$$63$$.$PagingModel$.$EventType$.PAGE, {page:$self$$194$$.$_page$, previousPage:$previousPage$$2$$});
        $resolve$$52$$(null);
      }, function() {
        $self$$194$$.$_page$ = $previousPage$$2$$;
        $self$$194$$.$_startIndex$ = $self$$194$$.$_page$ * $self$$194$$.pageSize;
        $reject$$49$$(null);
      });
    });
  };
  ...
  $oj$$63$$.$CollectionPagingDataSource$.prototype.$_fetchInternal$ = function $$oj$$63$$$$CollectionPagingDataSource$$$$_fetchInternal$$($options$$344$$) {
    ...
    return new Promise(function($resolve$$53$$) {
      try {
        $self$$196$$.$collection$.fetch({success:function() {
          $self$$196$$.$_refreshDataWindow$().then(function() {
            $self$$196$$.$_processSuccess$($opts$$34$$);
            $resolve$$53$$({data:$self$$196$$.$getWindow$(), startIndex:$self$$196$$.current});
          });
        }});
      } catch ($e$$103$$) {
        $self$$196$$.$_refreshDataWindow$().then(function() {
