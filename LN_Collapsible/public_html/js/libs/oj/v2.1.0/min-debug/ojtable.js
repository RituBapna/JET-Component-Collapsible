...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "promise", "ojdnd", "ojs/ojdomscroller", "ojs/ojeditablevalue", "ojs/ojmenu", "ojs/ojdatasource-common", "ojs/ojpagingtabledatasource", "ojs/ojflattenedtreetabledatasource"], function($oj$$14$$, $$$$14$$) {
  (function() {
    ...
    $_KEYBOARD_CODE_ENTER$:13, $_KEYBOARD_CODE_UP$:38, $_KEYBOARD_CODE_DOWN$:40, $_KEYBOARD_CODE_LEFT$:37, $_KEYBOARD_CODE_RIGHT$:39, $_KEYBOARD_CODE_HOME$:36, $_KEYBOARD_CODE_END$:35, $_KEYBOARD_CODE_TAB$:9, $_KEYBOARD_CODE_ESC$:27, $_KEYBOARD_MODIFIER_SHIFT$:"shiftKey"}, getContextByNode:function($node$$55$$) {
      ...
      var $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$ = $columnIdx_locator$$18_tableHeaderColumn$$.subId;
      if ("oj-table-cell" === $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$) {
        return $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$ = parseInt($columnIdx_locator$$18_tableHeaderColumn$$.rowIndex, 10), $columnIdx_locator$$18_tableHeaderColumn$$ = parseInt($columnIdx_locator$$18_tableHeaderColumn$$.columnIndex, 10), this.$_getTableDomUtils$().$getTableBodyLogicalCells$($rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$)[$columnIdx_locator$$18_tableHeaderColumn$$];
      }
      if ("oj-table-header" === $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$ || "oj-table-sort-ascending" === $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$ || "oj-table-sort-descending" === $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$) {
        if ($columnIdx_locator$$18_tableHeaderColumn$$ = $columnIdx_locator$$18_tableHeaderColumn$$.index, $columnIdx_locator$$18_tableHeaderColumn$$ = $$$$14$$(this.$_getTableDomUtils$().$getTableHeaderLogicalColumns$()[$columnIdx_locator$$18_tableHeaderColumn$$]), null != $columnIdx_locator$$18_tableHeaderColumn$$) {
          ...
          if (0 < $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$.length) {
            return $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$[0];
          }
        }
      } else {
        if ("oj-table-footer" === $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$ && ($columnIdx_locator$$18_tableHeaderColumn$$ = $columnIdx_locator$$18_tableHeaderColumn$$.index, $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$ = this.$_getTableDomUtils$().$getTableFooterLogicalCells$()[$columnIdx_locator$$18_tableHeaderColumn$$], null != $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$)) {
          return $rowIdx$$1_subId$$19_tableFooterCell_tableHeaderColumnSortAsc_tableHeaderColumnSortDsc$$;
        }
      }
      return null;
      ...
      if (0 < $cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$.length) {
        return{subId:"oj-table-cell", rowIndex:this.$_getTableDomUtils$().$getElementRowIdx$($cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$), columnIndex:this.$_getTableDomUtils$().$getElementColumnIdx$($cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$)};
      }
      ...
      var $data$$101_errSummary$$9$$ = this.$_getData$();
      if (!$data$$101_errSummary$$9$$) {
        return!1;
      }
      ...
      if (isNaN($rowIdx$$2$$) || 0 > $rowIdx$$2$$ || null != $errDetail$$2_rowKey_tableBodyRows$$ && $rowIdx$$2$$ >= $errDetail$$2_rowKey_tableBodyRows$$.length) {
        throw $data$$101_errSummary$$9$$ = this.$_LOGGER_MSG$.$_ERR_REFRESHROW_INVALID_INDEX_SUMMARY$, $errDetail$$2_rowKey_tableBodyRows$$ = $oj$$14$$.$Translations$.$applyParameters$(this.$_LOGGER_MSG$.$_ERR_REFRESHROW_INVALID_INDEX_DETAIL$, {rowIdx:$rowIdx$$2$$.toString()}), new RangeError($data$$101_errSummary$$9$$ + "\n" + $errDetail$$2_rowKey_tableBodyRows$$);
      }
      var $errDetail$$2_rowKey_tableBodyRows$$ = this.$_getRowKeyForRowIdx$($rowIdx$$2$$), $row$$4$$ = $data$$101_errSummary$$9$$.get($errDetail$$2_rowKey_tableBodyRows$$);
      if (null == $row$$4$$) {
        return!1;
      }
      var $self$$93$$ = this;
      return this.$_queueTask$(function() {
        return $row$$4$$.then(function($row$$5$$) {
          $self$$93$$.$_refreshTableBodyRow$($rowIdx$$2$$, $row$$5$$);
        }).then(function() {
          return!0;
        });
      });
      ...
      var $self$$94$$ = this;
      setTimeout(function() {
        $self$$94$$.$_checkRowOrHeaderColumnFocus$($event$$150$$);
      }, 0);
    ...
    }, "mousedown .oj-table-body":function($event$$155$$) {
      this.$_mouseDownRowIdx$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$155$$.target));
      if (null != this.$_mouseDownRowIdx$) {
        var $tableBodyRow$$2$$ = this.$_getTableDomUtils$().$getTableBodyRow$(this.$_mouseDownRowIdx$);
        null != $tableBodyRow$$2$$ && $tableBodyRow$$2$$.prop("draggable") ? this.$_mouseDownRowIdx$ = null : null == this.$_mouseDownRowIdx$ || $event$$155$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$] || $oj$$14$$.$DomUtils$.$isMetaKeyPressed$($event$$155$$) || this.$_getRowSelection$(this.$_mouseDownRowIdx$) && 1 == this.$_getSelectedRowIdxs$().length || this.$_clearSelectedRows$();
      }
      ...
      if (!$$$$14$$($event$$169$$.target).data(this.$_FOCUS_CALLED$)) {
        var $focused$$2_lastSelectedRowIdx_rowSelected$$1$$ = this.$_setRowFocus$($rowIdx$$5$$, !0, !0, $event$$169$$.currentTarget, $event$$169$$);
      ...
      if ($event$$169$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$]) {
        ...
        $oj$$14$$.$DomUtils$.$isMetaKeyPressed$($event$$169$$) ? this.$_setRowSelection$($rowIdx$$5$$, !this.$_getRowSelection$($rowIdx$$5$$), $event$$169$$.currentTarget, $event$$169$$, !0) : 0 == this.$_getKeyboardKeys$().length && ($focused$$2_lastSelectedRowIdx_rowSelected$$1$$ = this.$_getRowSelection$($rowIdx$$5$$), this.$_setRowSelection$($rowIdx$$5$$, !$focused$$2_lastSelectedRowIdx_rowSelected$$1$$, $event$$169$$.currentTarget, $event$$169$$, !0), this.$_isTouchDevice$() && this.$_getRowSelectionMode$() == 
      ...
      this.$_queueTask$(function() {
        return $self$$95$$.$_invokeDataFetchRows$($startIndex$$14$$);
      });
      ...
      this.$_queueTask$(function() {
        ...
        if (1 < $rows$$.length) {
          ...
          if ($isContiguous_tableBodyDocFrag$$) {
            $batchAdd_tableBody$$ = $self$$96$$.$_getTableDomUtils$().$getTableBody$();
            $isContiguous_tableBodyDocFrag$$ = $$$$14$$(document.createDocumentFragment());
            $rowsCount$$ = $rows$$.length;
            for ($i$$181_tableBodyRowBefore$$ = 0;$i$$181_tableBodyRowBefore$$ < $rowsCount$$;$i$$181_tableBodyRowBefore$$++) {
              $self$$96$$.$_addSingleTableBodyRow$($rows$$[$i$$181_tableBodyRowBefore$$].$rowIdx$, $rows$$[$i$$181_tableBodyRowBefore$$].row, $isContiguous_tableBodyDocFrag$$, $rows$$[0].$rowIdx$);
            }
            0 == $rows$$[0].$rowIdx$ ? $batchAdd_tableBody$$.prepend($isContiguous_tableBodyDocFrag$$) : ($i$$181_tableBodyRowBefore$$ = $self$$96$$.$_getTableDomUtils$().$getTableBodyRow$($rows$$[0].$rowIdx$), null != $i$$181_tableBodyRowBefore$$ ? $batchAdd_tableBody$$[0].insertBefore($isContiguous_tableBodyDocFrag$$[0], $i$$181_tableBodyRowBefore$$[0]) : $batchAdd_tableBody$$[0].insertBefore($isContiguous_tableBodyDocFrag$$[0], null));
            $self$$96$$.$_getTableDomUtils$().$clearCachedDomRowData$();
        ...
        if (!$batchAdd_tableBody$$) {
          for ($rowsCount$$ = $rows$$.length, $i$$181_tableBodyRowBefore$$ = 0;$i$$181_tableBodyRowBefore$$ < $rowsCount$$;$i$$181_tableBodyRowBefore$$++) {
            $self$$96$$.$_addSingleTableBodyRow$($rows$$[$i$$181_tableBodyRowBefore$$].$rowIdx$, $rows$$[$i$$181_tableBodyRowBefore$$].row);
          }
        }
        $self$$96$$.$_getTableDomUtils$().$clearCachedDomRowData$();
      ...
      this.$_queueTask$(function() {
        ...
        for ($i$$182$$ = 0;$i$$182$$ < $rowsCount$$1$$;$i$$182$$++) {
          $self$$97$$.$_refreshTableBodyRow$($rows$$1$$[$i$$182$$].$rowIdx$, $rows$$1$$[$i$$182$$].row);
        }
        $self$$97$$.$_refreshTableFooter$();
      });
    }, $_executeTableBodyRowsRemove$:function($rows$$2$$) {
      var $self$$98$$ = this, $currentRow$$ = this.$_getCurrentRow$(), $currentRowKey$$ = null != $currentRow$$ ? $currentRow$$.rowKey : null;
      this.$_queueTask$(function() {
        ...
        for ($i$$183_tableBodyRows$$1$$ = 0;$i$$183_tableBodyRows$$1$$ < $rowsCount$$2$$;$i$$183_tableBodyRows$$1$$++) {
          $self$$98$$.$_getTableDomUtils$().$removeTableBodyRow$($rows$$2$$[$i$$183_tableBodyRows$$1$$].$rowIdx$), null != $currentRowKey$$ && ($rowKey$$2$$ = $rows$$2$$[$i$$183_tableBodyRows$$1$$].row[$self$$98$$.$_FIELD_ID$], $oj$$14$$.$Object$.$compareValues$($rowKey$$2$$, $currentRowKey$$) && ($self$$98$$.$_setCurrentRow$(null, null), $currentRowKey$$ = null));
        }
        $self$$98$$.$_refreshTableFooter$();
        $i$$183_tableBodyRows$$1$$ = $self$$98$$.$_getTableDomUtils$().$getTableBodyRows$();
      ...
      var $defaultedColumns_sortSupportedData$$ = [], $data$$103_i$$184$$, $columnsCount$$ = $columns_columnsSortedArray$$.length;
      for ($data$$103_i$$184$$ = 0;$data$$103_i$$184$$ < $columnsCount$$;$data$$103_i$$184$$++) {
        $defaultedColumns_sortSupportedData$$[$data$$103_i$$184$$] = $$$$14$$.extend({}, $columnsDefault_defaultedColumnsCount$$, $columns_columnsSortedArray$$[$data$$103_i$$184$$]);
      }
      $columns_columnsSortedArray$$ = [];
      $columnsDefault_defaultedColumnsCount$$ = $defaultedColumns_sortSupportedData$$.length;
      for ($data$$103_i$$184$$ = 0;$data$$103_i$$184$$ < $columnsDefault_defaultedColumnsCount$$;$data$$103_i$$184$$++) {
        $columns_columnsSortedArray$$.push($defaultedColumns_sortSupportedData$$[$data$$103_i$$184$$]);
      }
      $data$$103_i$$184$$ = this.$_getData$();
      $defaultedColumns_sortSupportedData$$ = !1;
      null != $data$$103_i$$184$$ && "full" == $data$$103_i$$184$$.getCapability("sort") && ($defaultedColumns_sortSupportedData$$ = !0);
      for ($data$$103_i$$184$$ = 0;$data$$103_i$$184$$ < $columnsDefault_defaultedColumnsCount$$;$data$$103_i$$184$$++) {
        null == $columns_columnsSortedArray$$[$data$$103_i$$184$$][this.$_FIELD_ID$] && ($columns_columnsSortedArray$$[$data$$103_i$$184$$][this.$_FIELD_ID$] = this.$_COLUMN_HEADER_ID_PREFIX$ + $data$$103_i$$184$$), null != $columns_columnsSortedArray$$[$data$$103_i$$184$$].sortable && $columns_columnsSortedArray$$[$data$$103_i$$184$$].sortable != this.$_OPTION_AUTO$ || !$defaultedColumns_sortSupportedData$$ || ($columns_columnsSortedArray$$[$data$$103_i$$184$$].sortable = this.$_OPTION_ENABLED$)
        ;
      }
      ...
      if (!this.$_data$ && null != this.options.data) {
        var $data$$105$$ = this.options.data;
        if ($data$$105$$ instanceof $oj$$14$$.$TableDataSource$ || $data$$105$$ instanceof $oj$$14$$.$PagingTableDataSource$) {
          this.$_data$ = $data$$105$$;
        } else {
      ...
      return null;
    }, $_getDataSourceRowIndexForRowKey$:function($data$$106_rowKey$$4$$) {
      ...
      if (null != $startIndex$$17_tableBodyRows$$3$$ && 0 < $startIndex$$17_tableBodyRows$$3$$.length) {
        ...
        for ($i$$189$$ = 0;$i$$189$$ < $tableBodyRowsCount$$1$$;$i$$189$$++) {
          if ($oj$$14$$.$Object$.$compareValues$($$$$14$$($startIndex$$17_tableBodyRows$$3$$[$i$$189$$]).data("rowKey"), $data$$106_rowKey$$4$$)) {
            return $data$$106_rowKey$$4$$ = this.$_getData$(), $startIndex$$17_tableBodyRows$$3$$ = 0, $data$$106_rowKey$$4$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($startIndex$$17_tableBodyRows$$3$$ = $data$$106_rowKey$$4$$.getStartItemIndex()), $i$$189$$ + $startIndex$$17_tableBodyRows$$3$$;
          }
        }
      }
      return null;
      ...
      if (null != $tableBodyRows$$4$$ && 0 < $tableBodyRows$$4$$.length) {
        var $data$$107_i$$191$$ = this.$_getData$(), $startIndex$$18$$ = 0;
        $data$$107_i$$191$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($startIndex$$18$$ = $data$$107_i$$191$$.getStartItemIndex());
        for (var $tableBodyRowsCount$$2$$ = $tableBodyRows$$4$$.length, $data$$107_i$$191$$ = 0;$data$$107_i$$191$$ < $tableBodyRowsCount$$2$$;$data$$107_i$$191$$++) {
          if ($startIndex$$18$$ + $data$$107_i$$191$$ == $rowIndex$$3$$) {
            return $$$$14$$($tableBodyRows$$4$$[$data$$107_i$$191$$]).data("rowKey");
          }
        }
      }
      return null;
      ...
      try {
        var $self$$99$$ = this;
        this.$_queueTask$(function() {
          var $offset$$20$$ = 0, $data$$108_indexArray$$ = $self$$99$$.$_getData$();
          $data$$108_indexArray$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($offset$$20$$ = $data$$108_indexArray$$.getStartItemIndex());
          var $data$$108_indexArray$$ = [], $i$$194$$, $eventDataCount$$ = $event$$193$$[$self$$99$$.$_CONST_DATA$].length;
          for ($i$$194$$ = 0;$i$$194$$ < $eventDataCount$$;$i$$194$$++) {
            $data$$108_indexArray$$[$i$$194$$] = $i$$194$$ + $offset$$20$$ + $event$$193$$[$self$$99$$.$_CONST_STARTINDEX$];
          }
          $self$$99$$.$_refreshAll$({data:$event$$193$$[$self$$99$$.$_CONST_DATA$], keys:$event$$193$$[$self$$99$$.$_CONST_KEYS$], indexes:$data$$108_indexArray$$}, $event$$193$$[$self$$99$$.$_CONST_STARTINDEX$]);
        });
      } catch ($e$$83$$) {
      ...
      try {
        var $fetchPromise$$ = this.$_invokeDataFetchRows$(), $self$$100$$ = this;
        this.$_queueTask$(function() {
      ...
      try {
        var $data$$109_rowArray$$ = this.$_getData$(), $eventData$$5$$ = $event$$196_startIndex$$19$$[this.$_CONST_DATA$], $eventIndexes$$ = $event$$196_startIndex$$19$$[this.$_CONST_INDEXES$], $eventKeys$$ = $event$$196_startIndex$$19$$[this.$_CONST_KEYS$];
        $eventData$$5$$ instanceof Array || ($eventData$$5$$ = [$eventData$$5$$]);
        $event$$196_startIndex$$19$$ = 0;
        $data$$109_rowArray$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($event$$196_startIndex$$19$$ = $data$$109_rowArray$$.getStartItemIndex());
        var $data$$109_rowArray$$ = [], $i$$195$$, $eventDataCount$$1$$ = $eventData$$5$$.length;
        for ($i$$195$$ = 0;$i$$195$$ < $eventDataCount$$1$$;$i$$195$$++) {
          var $rowIdx$$11$$ = $eventIndexes$$[$i$$195$$] - $event$$196_startIndex$$19$$;
          void 0 !== $rowIdx$$11$$ && $data$$109_rowArray$$.push({row:{data:$eventData$$5$$[$i$$195$$], key:$eventKeys$$[$i$$195$$], index:$eventIndexes$$[$i$$195$$]}, $rowIdx$:$rowIdx$$11$$});
        }
        0 < $data$$109_rowArray$$.length && this.$_executeTableBodyRowsAdd$($data$$109_rowArray$$);
      } catch ($e$$86$$) {
      ...
      try {
        var $data$$110_rowArray$$1$$ = this.$_getData$(), $eventData$$6$$ = $event$$197_startIndex$$20$$[this.$_CONST_DATA$], $eventIndexes$$1$$ = $event$$197_startIndex$$20$$[this.$_CONST_INDEXES$], $eventKeys$$1$$ = $event$$197_startIndex$$20$$[this.$_CONST_KEYS$];
        $eventData$$6$$ instanceof Array || ($eventData$$6$$ = [$eventData$$6$$]);
        $event$$197_startIndex$$20$$ = 0;
        $data$$110_rowArray$$1$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($event$$197_startIndex$$20$$ = $data$$110_rowArray$$1$$.getStartItemIndex());
        var $data$$110_rowArray$$1$$ = [], $i$$196$$, $eventDataCount$$2$$ = $eventData$$6$$.length;
        for ($i$$196$$ = 0;$i$$196$$ < $eventDataCount$$2$$;$i$$196$$++) {
          var $rowIdx$$12$$ = $eventIndexes$$1$$[$i$$196$$] - $event$$197_startIndex$$20$$;
          void 0 !== $rowIdx$$12$$ && $data$$110_rowArray$$1$$.push({row:{data:$eventData$$6$$[$i$$196$$], key:$eventKeys$$1$$[$i$$196$$], index:$eventIndexes$$1$$[$i$$196$$]}, $rowIdx$:$rowIdx$$12$$});
        }
        0 < $data$$110_rowArray$$1$$.length && this.$_executeTableBodyRowsChange$($data$$110_rowArray$$1$$);
      } catch ($e$$87$$) {
      ...
      try {
        var $data$$111_rowArray$$2$$ = this.$_getData$(), $eventData$$7$$ = $event$$198_startIndex$$21$$[this.$_CONST_DATA$], $eventIndexes$$2$$ = $event$$198_startIndex$$21$$[this.$_CONST_INDEXES$], $eventKeys$$2$$ = $event$$198_startIndex$$21$$[this.$_CONST_KEYS$];
        $eventData$$7$$ instanceof Array || ($eventData$$7$$ = [$eventData$$7$$]);
        $event$$198_startIndex$$21$$ = 0;
        $data$$111_rowArray$$2$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($event$$198_startIndex$$21$$ = $data$$111_rowArray$$2$$.getStartItemIndex());
        var $data$$111_rowArray$$2$$ = [], $i$$197$$;
        for ($i$$197$$ = $eventData$$7$$.length - 1;0 <= $i$$197$$;$i$$197$$--) {
          var $rowIdx$$13$$ = $eventIndexes$$2$$[$i$$197$$] - $event$$198_startIndex$$21$$;
          void 0 !== $rowIdx$$13$$ && $data$$111_rowArray$$2$$.push({row:{data:$eventData$$7$$[$i$$197$$], key:$eventKeys$$2$$[$i$$197$$], index:$eventIndexes$$2$$[$i$$197$$]}, $rowIdx$:$rowIdx$$13$$});
        }
        0 < $data$$111_rowArray$$2$$.length && this.$_executeTableBodyRowsRemove$($data$$111_rowArray$$2$$);
      } catch ($e$$88$$) {
      ...
      try {
        ...
        var $self$$102$$ = this;
        this.$_queueTask$(function() {
          return $self$$102$$.$_invokeDataFetchRows$(null);
        }).then(function() {
          null != $columnIdx$$19$$ && setTimeout(function() {
            $self$$102$$.$_scrollColumnIntoViewport$($columnIdx$$19$$);
          }, 0);
        });
      } catch ($e$$89$$) {
      ...
      var $self$$103$$ = this, $data$$112$$ = this.$_getData$();
      null != $data$$112$$ && $data$$112$$ instanceof $oj$$14$$.$TableDataSource$ && !($data$$112$$ instanceof $oj$$14$$.$PagingTableDataSource$) ? (this.$_getTableDomUtils$().$getScroller$()[0].scrollTop = 0, this.$_queueTask$(function() {
        return $self$$103$$.$_invokeDataFetchRows$(0, {fetchType:"init"});
      })) : null == $data$$112$$ && this.$_queueTask$(function() {
      ...
      var $initFetch$$1$$ = "init" == $options$$238$$.fetchType ? !0 : !1, $data$$113$$ = this.$_getData$(), $self$$104$$ = this;
      return new Promise(function($resolve$$26$$, $reject$$26$$) {
        null != $data$$113$$ ? ($self$$104$$.$_setDataWaitingState$(), $data$$113$$.fetch($options$$238$$).then(function($result$$36$$) {
          if (null != $result$$36$$ && null != $result$$36$$[$self$$104$$.$_CONST_DATA$]) {
            var $offset$$21$$ = 0;
            $data$$113$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($offset$$21$$ = $data$$113$$.getStartItemIndex());
            var $indexArray$$1$$ = [], $i$$201$$, $resultDataCount$$ = $result$$36$$[$self$$104$$.$_CONST_DATA$].length;
            for ($i$$201$$ = 0;$i$$201$$ < $resultDataCount$$;$i$$201$$++) {
              $indexArray$$1$$[$i$$201$$] = $i$$201$$ + $offset$$21$$ + $result$$36$$[$self$$104$$.$_CONST_STARTINDEX$];
            }
            $self$$104$$.$_refreshAll$({data:$result$$36$$[$self$$104$$.$_CONST_DATA$], keys:$result$$36$$[$self$$104$$.$_CONST_KEYS$], indexes:$indexArray$$1$$}, $result$$36$$[$self$$104$$.$_CONST_STARTINDEX$], $initFetch$$1$$, $initFetch$$1$$);
          }
          $self$$104$$.$_clearDataWaitingState$();
          $resolve$$26$$(null);
        }, function($error$$30$$) {
          $self$$104$$.$_clearDataWaitingState$();
          $reject$$26$$($error$$30$$);
    ...
    }, $_isNodeType$:function($node$$60$$, $type$$79$$) {
      ...
      if (null != $data$$115$$) {
        ...
        for ($i$$212$$ = 0;$i$$212$$ < $dataSourceEventHandlersCount$$;$i$$212$$++) {
          ($ev$$1$$ = $data$$115$$.on(this.$_dataSourceEventHandlers$[$i$$212$$].eventType, this.$_dataSourceEventHandlers$[$i$$212$$].eventHandler)) && (this.$_dataSourceEventHandlers$[$i$$212$$].eventHandler = $ev$$1$$);
        }
      }
      ...
      this.$_domScrollerMaxCountFunc$ = function $this$$_domScrollerMaxCountFunc$$($result$$37$$) {
        null != $result$$37$$ && $result$$37$$.maxCountLimit && $self$$105$$.$_handleScrollerMaxRowCount$();
      };
      ...
      if (!this.$_resizeListener$) {
        ...
        this.$_resizeListener$ = function $this$$_resizeListener$$() {
          var $tableContainerHeight$$ = $self$$106$$.$_getTableDomUtils$().$getTableContainer$().outerHeight(), $tableContainerWidth$$ = $self$$106$$.$_getTableDomUtils$().$getTableContainer$().outerWidth();
          $self$$106$$.$_getTableDomUtils$().$refreshTableDimensions$($tableContainerWidth$$, $tableContainerHeight$$);
        };
      }
      ...
      var $currentRowChanged_data$$116$$ = this.$_getData$(), $rowIndex$$4$$ = $currentRow$$1_errSummary$$13$$.rowIndex, $rowKey$$5$$ = $currentRow$$1_errSummary$$13$$.rowKey;
      ...
      if (-1 != $errDetail$$6_rowIdx$$18$$ && (!$currentRowChanged_data$$116$$ || 0 == $currentRowChanged_data$$116$$.totalSize() || -1 > $errDetail$$6_rowIdx$$18$$ || null === $errDetail$$6_rowIdx$$18$$ || null === $rowKey$$5$$)) {
      ...
      if ($currentRowChanged_data$$116$$ = !$oj$$14$$.$Object$.$compareValues$(this.$_currentRow$, $currentRow$$1_errSummary$$13$$)) {
        try {
      ...
      ($currentRowChanged_data$$116$$ || $currentFocusedRowIdx_optionChange$$ != $currentRow$$1_errSummary$$13$$.rowIndex) && null == $event$$213$$ && this.$_setRowFocus$($errDetail$$6_rowIdx$$18$$, !0, !1, null, $event$$213$$);
      return!0;
      ...
      $parent$$10$$.find("*").each(function() {
        $self$$107$$.$_UnregisterChildNode$(this);
      });
    }, $_unregisterDataSourceEventListeners$:function() {
      var $data$$117$$ = this.$_getData$();
      if (null != this.$_dataSourceEventHandlers$ && null != $data$$117$$) {
        ...
        for ($i$$217$$ = 0;$i$$217$$ < $dataSourceEventHandlersCount$$1$$;$i$$217$$++) {
          $data$$117$$.off(this.$_dataSourceEventHandlers$[$i$$217$$].eventType, this.$_dataSourceEventHandlers$[$i$$217$$].eventHandler);
        }
      }
      ...
      return this.$_pendingTasks$ = this.$_pendingTasks$.then(function() {
        if (!$self$$108$$.$_componentDestroyed$) {
          return $task$$1$$.bind($self$$108$$)();
        }
      }).then(function($value$$211$$) {
        $self$$108$$.$_taskCount$--;
        0 != $self$$108$$.$_taskCount$ || $self$$108$$.$_componentDestroyed$ || ($self$$108$$.$_pendingTasks$ = void 0, $self$$108$$.$_finalTask$ && $self$$108$$.$_finalTask$(), $self$$108$$._trigger("ready"));
        return $value$$211$$;
      }, function($error$$31$$) {
        $self$$108$$.$_taskCount$--;
        0 == $self$$108$$.$_taskCount$ && ($self$$108$$.$_pendingTasks$ = void 0, $oj$$14$$.$Logger$.error($error$$31$$));
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_getOverRowIndex$ = function $$oj$$14$$$$TableDndContext$$$$_getOverRowIndex$$($context$$64_event$$221$$) {
    ...
    $newRowIndex_overRow_tableBodyRows$$17$$ = $$$$14$$($context$$64_event$$221$$.target).closest("tr");
    $newRowIndex_overRow_tableBodyRows$$17$$ = ($context$$64_event$$221$$ = this.$component$.getContextByNode($context$$64_event$$221$$.target)) && "oj-table-cell" == $context$$64_event$$221$$.subId ? $context$$64_event$$221$$.rowIndex : $newRowIndex_overRow_tableBodyRows$$17$$ && $newRowIndex_overRow_tableBodyRows$$17$$.hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_DRAG_INDICATOR_BEFORE_CLASS$) ? this.$_dropRowIndex$ : ($newRowIndex_overRow_tableBodyRows$$17$$ = this.$_getTableDomUtils$().$getTableBodyRows$()) ? 
  ...
  $oj$$14$$.$TableRendererUtils$.$tableBodyCellDefaultRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$tableBodyCellDefaultRenderer$$($rowIdx$$39$$, $columnIdx$$62$$, $row$$16$$, $rowHashCode$$5$$, $context$$69_tableBodyRow$$28$$) {
    ...
    var $cellColumnContent_data$$118$$ = null;
    null != $cellRenderer$$2_column$$20$$.field && ($cellColumnContent_data$$118$$ = $row$$16$$.data[$cellRenderer$$2_column$$20$$.field]);
    if ($cellRenderer$$2_column$$20$$ = $component$$21$$.$_getColumnRenderer$($columnIdx$$62$$, "cell")) {
      var $cellContext$$ = this.$getRendererContextObject$($component$$21$$, $row$$16$$, $tableBodyCell$$13$$[0]), $cellColumnContent_data$$118$$ = $cellRenderer$$2_column$$20$$({cellContext:$cellContext$$, columnIndex:$columnIdx$$62$$, data:$cellColumnContent_data$$118$$, row:$$$$14$$.extend({}, $row$$16$$.data)});
      null != $cellColumnContent_data$$118$$ ? $tableBodyCell$$13$$.append($cellColumnContent_data$$118$$) : ($tableBodyCell$$13$$ = $$$$14$$($context$$69_tableBodyRow$$28$$.children(":not(." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_CELL_ACC_SELECT_CLASS$ + ")")[$columnIdx$$62$$]), $component$$21$$.$_getTableDomUtils$().$setTableBodyCellAttributes$($rowIdx$$39$$, $row$$16$$.key, $rowHashCode$$5$$, $columnIdx$$62$$, $tableBodyCell$$13$$), $component$$21$$.$_getTableDomUtils$().$styleTableBodyCell$($columnIdx$$62$$, 
      $tableBodyCell$$13$$, !1));
    } else {
      $tableBodyCell$$13$$.text($cellColumnContent_data$$118$$);
    }
  };
