...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojvalidation", "ojs/internal-deps/dvt/DvtToolkit", "promise"], function($oj$$15$$, $$$$15$$, $comp$$5$$, $val$$39$$, $dvt$$1$$) {
  ...
  $oj$$15$$.$__registerWidget$("oj.dvtBaseComponent", $$$$15$$.oj.baseComponent, {_ComponentCreate:function() {
    ...
    $event$$245$$.value, $event$$245$$.optionMetadata) : this.options.contextMenu && $type$$80$$ === $dvt$$1$$.DvtComponentTouchEvent.TOUCH_HOVER_END_TYPE ? this.$_OpenContextMenu$($$$$15$$.Event($event$$245$$.getNativeEvent()), "touch") : "ready" === $type$$80$$ && 0 === this.$_numDeferredObjs$ && (this.$_promiseResolve$ && this.$_promiseResolve$(!0), this.$_ready$ = !0, this.$_promise$ = this.$_promiseResolve$ = null);
    ...
    if (this.$_optionsCopy$) {
      ...
      for ($path$$11$$ in $paths$$) {
        $subpaths$$ = $paths$$[$path$$11$$], $subpaths$$.forEach(function($subpath$$) {
          var $promise$$;
          if ("root" === $path$$11$$) {
            ($promise$$ = $self$$111$$.$_getPromise$($self$$111$$.$_optionsCopy$, $subpath$$)) && $deferredData$$1$$.push($promise$$);
          } else {
            var $suboptions$$1$$ = $self$$111$$.$_optionsCopy$[$path$$11$$];
            if ($suboptions$$1$$) {
              for (var $j$$36$$ = 0;$j$$36$$ < $suboptions$$1$$.length;$j$$36$$++) {
                ($promise$$ = $self$$111$$.$_getPromise$($suboptions$$1$$[$j$$36$$], $subpath$$)) && $deferredData$$1$$.push($promise$$);
              }
            }
          }
        });
    ...
    if ($optionValue$$3$$ && $optionValue$$3$$ instanceof Promise) {
      ...
      var $renderCount$$ = this.$_renderCount$, $self$$112$$ = this;
      $optionValue$$3$$.then(function($value$$218$$) {
        $self$$112$$.$_renderDeferredData$($renderCount$$, $optionPath$$, $value$$218$$);
      }, function() {
        $self$$112$$.$_renderDeferredData$($renderCount$$, $optionPath$$, []);
      });
    ...
    if (!this.$_promise$) {
      var $self$$113$$ = this;
      this.$_promise$ = new Promise(function($resolve$$27$$) {
        $self$$113$$.$_promiseResolve$ = $resolve$$27$$;
      });
    }
