...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtTreemap"], function($oj$$41$$, $$$$38$$, $comp$$11$$, $base$$10$$, $dvt$$7$$) {
  $oj$$41$$.$__registerWidget$("oj.ojTreemap", $$$$38$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null}, $_CreateDvtComponent$:function($context$$127$$, $callback$$112$$, $callbackObj$$9$$) {
    ...
    var $isolatedNodes_type$$93$$ = $event$$466_isolatedNode$$ && $event$$466_isolatedNode$$.getType ? $event$$466_isolatedNode$$.getType() : null;
    $isolatedNodes_type$$93$$ === $dvt$$7$$.DvtSelectionEvent.TYPE ? this.$_UserOptionChange$("selection", $event$$466_isolatedNode$$.getSelection()) : $isolatedNodes_type$$93$$ === $dvt$$7$$.DvtTreemapIsolateEvent.TYPE ? ($isolatedNodes_type$$93$$ = this.options.$_isolatedNodes$, $isolatedNodes_type$$93$$ || (this.options.$_isolatedNodes$ = [], $isolatedNodes_type$$93$$ = this.options.$_isolatedNodes$), ($event$$466_isolatedNode$$ = $event$$466_isolatedNode$$.getId()) ? ($isolatedNodes_type$$93$$.push($event$$466_isolatedNode$$), 
    this.$_UserOptionChange$("isolatedNode", $event$$466_isolatedNode$$)) : ($isolatedNodes_type$$93$$.pop(), this.$_UserOptionChange$("isolatedNode", 0 < $isolatedNodes_type$$93$$.length ? $isolatedNodes_type$$93$$[$isolatedNodes_type$$93$$.length] : null))) : this._super($event$$466_isolatedNode$$);
