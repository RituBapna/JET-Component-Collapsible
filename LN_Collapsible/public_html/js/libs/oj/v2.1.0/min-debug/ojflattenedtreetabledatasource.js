...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$78$$) {
  $oj$$78$$.$FlattenedTreeTableDataSource$ = function $$oj$$78$$$$FlattenedTreeTableDataSource$$($data$$180$$, $options$$404$$) {
    $options$$404$$ = $options$$404$$ || {};
    if (!($data$$180$$ instanceof $oj$$78$$.$FlattenedTreeDataSource$)) {
    ...
    this.$_data$.$insertRows$ = function $this$$_data$$$insertRows$$($insertAtIndex$$2$$, $i$$482_insertAtKey$$1$$, $nodeSet$$35$$) {
      ...
      for ($i$$482_insertAtKey$$1$$ = 0;$i$$482_insertAtKey$$1$$ < $nodeSet$$35$$.$getCount$();$i$$482_insertAtKey$$1$$++) {
        $row$$51$$ = $nodeSet$$35$$.getData($i$$482_insertAtKey$$1$$), $rowKey$$41$$ = $nodeSet$$35$$.getMetadata($i$$482_insertAtKey$$1$$).key, $rowIdx$$41$$ = $insertAtIndex$$2$$ + $i$$482_insertAtKey$$1$$, $self$$224$$.$_nodeSetList$[$rowIdx$$41$$] = {}, $self$$224$$.$_nodeSetList$[$rowIdx$$41$$].nodeSet = $nodeSet$$35$$, $self$$224$$.$_nodeSetList$[$rowIdx$$41$$].startIndex = $insertAtIndex$$2$$, $rowArray$$14$$.push($row$$51$$), $keyArray$$6$$.push($rowKey$$41$$), $indexArray$$5$$.push($rowIdx$$41$$), 
        $self$$224$$.$_rows$.data.splice($rowIdx$$41$$, 0, $row$$51$$), $self$$224$$.$_rows$.keys.splice($rowIdx$$41$$, 0, $rowKey$$41$$), $self$$224$$.$_rows$.indexes.splice($rowIdx$$41$$, 0, $rowIdx$$41$$);
      }
      $self$$224$$.$_pageSize$ || $oj$$78$$.$TableDataSource$.$superclass$.handleEvent.call($self$$224$$, $oj$$78$$.$TableDataSource$.$EventType$.ADD, {data:$rowArray$$14$$, keys:$keyArray$$6$$, indexes:$indexArray$$5$$});
      $self$$224$$.$_realignRowIndices$();
      $self$$224$$.$_pageSize$ && setTimeout(function() {
        $self$$224$$.fetch();
      }, 0);
    };
    this.$_data$.$removeRows$ = function $this$$_data$$$removeRows$$($rowKeys$$2$$) {
      ...
      for ($i$$483$$ = 0;$i$$483$$ < $rowKeys$$2$$.length;$i$$483$$++) {
        $rowIdx$$42$$ = $rowKeys$$2$$[$i$$483$$].index - $i$$483$$, $rowArray$$15$$.push(""), $keyArray$$7$$.push(""), $indexArray$$6$$.push($rowIdx$$42$$), $self$$224$$.$_rows$.data.splice($rowIdx$$42$$, 1), $self$$224$$.$_rows$.keys.splice($rowIdx$$42$$, 1), $self$$224$$.$_rows$.indexes.splice($rowIdx$$42$$, 1);
      }
      $self$$224$$.$_pageSize$ || $oj$$78$$.$TableDataSource$.$superclass$.handleEvent.call($self$$224$$, $oj$$78$$.$TableDataSource$.$EventType$.REMOVE, {data:$rowArray$$15$$, keys:$keyArray$$7$$, indexes:$indexArray$$6$$});
      $self$$224$$.$_realignRowIndices$();
      $self$$224$$.$_pageSize$ && setTimeout(function() {
        $self$$224$$.fetch();
      }, 0);
  ...
  $oj$$78$$.$FlattenedTreeTableDataSource$.prototype.at = function $$oj$$78$$$$FlattenedTreeTableDataSource$$$at$($index$$299$$) {
    var $row$$53$$;
    $row$$53$$ = 0 > $index$$299$$ || $index$$299$$ >= this.$_rows$.length ? null : {data:this.$_rows$.data[$index$$299$$], index:$index$$299$$, key:this.$_rows$.keys[$index$$299$$]};
  ...
  $oj$$78$$.$FlattenedTreeTableDataSource$.prototype.sort = function $$oj$$78$$$$FlattenedTreeTableDataSource$$$sort$($criteria$$12$$) {
    ...
    return new Promise(function($resolve$$65$$, $reject$$62$$) {
      $self$$226$$.$_data$.getWrappedDataSource().sort($criteria$$12$$, {success:function() {
        setTimeout(function() {
          $self$$226$$.$_data$.refresh();
          $self$$226$$.$_rows$ = null;
          var $result$$80$$ = {header:$criteria$$12$$.key, direction:$criteria$$12$$.direction};
          $oj$$78$$.$TableDataSource$.$superclass$.handleEvent.call($self$$226$$, $oj$$78$$.$TableDataSource$.$EventType$.SORT, $result$$80$$);
          $resolve$$65$$($result$$80$$);
        }, 0);
  ...
  $oj$$78$$.$FlattenedTreeTableDataSource$.prototype.$_getMetadata$ = function $$oj$$78$$$$FlattenedTreeTableDataSource$$$$_getMetadata$$($index$$300$$) {
    return this.$_nodeSetList$[$index$$300$$].nodeSet.getMetadata($index$$300$$ - this.$_nodeSetList$[$index$$300$$].startIndex);
  };
    ...
    if (null != this.$_rows$) {
      if (null != this.$_pageSize$) {
        ...
        if (this.$_startIndex$ + this.$_pageSize$ - 1 <= $endIndex$$8_result$$81$$) {
          var $endIndex$$8_result$$81$$ = $oj$$78$$.$FlattenedTreeTableDataSource$.$_getEndIndex$(this.$_rows$, this.$_startIndex$, this.$_pageSize$), $rangeCount$$1_rowArray$$16$$ = [], $keyArray$$8_startIndex$$32$$ = [], $i$$484$$;
          for ($i$$484$$ = this.$_startIndex$;$i$$484$$ <= $endIndex$$8_result$$81$$;$i$$484$$++) {
            $rangeCount$$1_rowArray$$16$$[$i$$484$$ - this.$_startIndex$] = this.$_rows$.data[$i$$484$$], $keyArray$$8_startIndex$$32$$[$i$$484$$ - this.$_startIndex$] = "";
          }
          $endIndex$$8_result$$81$$ = {data:$rangeCount$$1_rowArray$$16$$, keys:$keyArray$$8_startIndex$$32$$, startIndex:this.$_startIndex$};
          this.$_endFetch$($options$$408$$, $endIndex$$8_result$$81$$, null);
          return Promise.resolve($endIndex$$8_result$$81$$);
        }
        this.$_startIndex$ <= $endIndex$$8_result$$81$$ && ($keyArray$$8_startIndex$$32$$ = $endIndex$$8_result$$81$$ + 1);
      } else {
        this.$_data$.refresh(), this.$_rows$ = null;
      }
    }
    var $rangeOption$$ = {start:$keyArray$$8_startIndex$$32$$, count:$rangeCount$$1_rowArray$$16$$}, $self$$227$$ = this;
    return new Promise(function($resolve$$66$$, $reject$$63$$) {
      $self$$227$$.$_data$.$fetchRows$($rangeOption$$, {success:function($nodeSet$$37_result$$82$$) {
        $self$$227$$.$_handleFetchRowsSuccess$($nodeSet$$37_result$$82$$);
        $options$$408$$.refresh = !0;
        var $endIndex$$9$$ = $oj$$78$$.$FlattenedTreeTableDataSource$.$_getEndIndex$($self$$227$$.$_rows$, $self$$227$$.$_startIndex$, $self$$227$$.$_pageSize$), $rowArray$$17$$ = [], $keyArray$$9$$ = [], $i$$485$$;
        for ($i$$485$$ = $self$$227$$.$_startIndex$;$i$$485$$ <= $endIndex$$9$$;$i$$485$$++) {
          $rowArray$$17$$[$i$$485$$ - $self$$227$$.$_startIndex$] = $self$$227$$.$_rows$.data[$i$$485$$], $keyArray$$9$$[$i$$485$$ - $self$$227$$.$_startIndex$] = $nodeSet$$37_result$$82$$.getMetadata($i$$485$$).key;
        }
        $nodeSet$$37_result$$82$$ = {data:$rowArray$$17$$, keys:$keyArray$$9$$, startIndex:$self$$227$$.$_startIndex$};
        $self$$227$$.$_endFetch$($options$$408$$, $nodeSet$$37_result$$82$$, null);
        $resolve$$66$$($nodeSet$$37_result$$82$$);
      }.bind(this), error:function($error$$51$$) {
        $self$$227$$.$_endFetch$($options$$408$$, null, $error$$51$$);
        $reject$$63$$($error$$51$$);
      }.bind(this)});
    });
  };
  ...
  $oj$$78$$.$FlattenedTreeTableDataSource$.prototype.$_endFetch$ = function $$oj$$78$$$$FlattenedTreeTableDataSource$$$$_endFetch$$($options$$410$$, $result$$83$$, $error$$52$$) {
    null != $error$$52$$ ? $oj$$78$$.$TableDataSource$.$superclass$.handleEvent.call(this, $oj$$78$$.$TableDataSource$.$EventType$.ERROR, $error$$52$$) : $options$$410$$.silent || $oj$$78$$.$TableDataSource$.$superclass$.handleEvent.call(this, $oj$$78$$.$TableDataSource$.$EventType$.SYNC, $result$$83$$);
  };
