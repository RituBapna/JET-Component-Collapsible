...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$61$$) {
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.setPage = function $$oj$$61$$$$PagingTableDataSource$$$setPage$($value$$284$$, $options$$337$$) {
    ...
    return new Promise(function($resolve$$50$$, $reject$$47$$) {
      0 < $self$$189$$.$_pageSize$ ? $self$$189$$.$dataSource$.fetch($options$$337$$).then(function($result$$66$$) {
        $result$$66$$.startIndex = 0;
        $self$$189$$.$_updateEndIndex$();
        $oj$$61$$.$PagingTableDataSource$.$superclass$.handleEvent.call($self$$189$$, $oj$$61$$.$PagingModel$.$EventType$.PAGE, {page:$self$$189$$.$_getPageFromStartIndex$(), previousPage:$previousPage$$1$$});
        $resolve$$50$$(null);
      }, function() {
        $self$$189$$.$_startIndex$ = $previousPage$$1$$ * $self$$189$$.$_pageSize$;
        $reject$$47$$(null);
      }) : $resolve$$50$$(null);
    });
  };
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.at = function $$oj$$61$$$$PagingTableDataSource$$$at$($index$$268$$, $options$$338$$) {
    return this.$dataSource$.at($index$$268$$, $options$$338$$);
  };
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.fetch = function $$oj$$61$$$$PagingTableDataSource$$$fetch$($options$$339$$) {
    ...
    var $self$$190$$ = this;
    return new Promise(function($resolve$$51$$, $reject$$48$$) {
      0 < $pageSize$$6$$ ? $self$$190$$.$dataSource$.fetch($options$$339$$).then(function($result$$67$$) {
        $self$$190$$.$_updateEndIndex$();
        $resolve$$51$$($result$$67$$);
      }, function($e$$102$$) {
        $reject$$48$$($e$$102$$);
      }) : $resolve$$51$$(null);
    });
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.get = function $$oj$$61$$$$PagingTableDataSource$$$get$($id$$55$$, $options$$340$$) {
    return this.$dataSource$.get($id$$55$$, $options$$340$$);
  };
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.on = function $$oj$$61$$$$PagingTableDataSource$$$on$($eventType$$47$$, $eventHandler$$3$$) {
    var $self$$191$$ = this, $dataSource$$4$$ = this.$dataSource$;
    if ($eventType$$47$$ == $oj$$61$$.$TableDataSource$.$EventType$.SYNC) {
      var $ev$$4$$ = function $$ev$$4$$$($event$$546$$) {
        $self$$191$$.$_handleSyncEvent$($event$$546$$, $eventHandler$$3$$);
      };
    ...
    if ($eventType$$47$$ == $oj$$61$$.$TableDataSource$.$EventType$.ADD || $eventType$$47$$ == $oj$$61$$.$TableDataSource$.$EventType$.REMOVE || $eventType$$47$$ == $oj$$61$$.$TableDataSource$.$EventType$.CHANGE) {
      return $ev$$4$$ = function $$ev$$4$$$($event$$547$$) {
        $self$$191$$.$_handleRowEvent$($event$$547$$, $eventHandler$$3$$);
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.$_handleRowEvent$ = function $$oj$$61$$$$PagingTableDataSource$$$$_handleRowEvent$$($event$$549$$, $eventHandler$$5$$) {
    ...
    for ($i$$381$$ = 0;$i$$381$$ < $event$$549$$.indexes.length;$i$$381$$++) {
      var $rowIdx$$40$$ = $event$$549$$.indexes[$i$$381$$];
    ...
    if (0 < $ignoreRows$$.length) {
      for ($ignoreRows$$.sort(function($a$$117$$, $b$$73$$) {
        return $a$$117$$ - $b$$73$$;
      }), $i$$381$$ = $ignoreRows$$.length - 1;0 <= $i$$381$$;$i$$381$$--) {
        $event$$549$$.data.splice($ignoreRows$$[$i$$381$$], 1), $event$$549$$.indexes.splice($ignoreRows$$[$i$$381$$], 1), $event$$549$$.keys.splice($ignoreRows$$[$i$$381$$], 1);
      }
    }
