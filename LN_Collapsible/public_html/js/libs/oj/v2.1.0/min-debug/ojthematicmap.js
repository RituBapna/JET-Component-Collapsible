...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtThematicMap"], function($oj$$55$$, $$$$50$$, $comp$$14$$, $base$$13$$, $dvt$$10$$) {
  $oj$$55$$.$__registerWidget$("oj.ojThematicMap", $$$$50$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{load:null, optionChange:null}, $_currentLocale$:"", $_loadedBasemaps$:[], $_supportedLocales$:{ar:"ar", cs:"cs", da:"da", de:"de", el:"el", es:"es", fi:"fi", fr:"fr", "fr-ca":"fr_CA", he:"iw", hu:"hu", it:"it", ja:"ja", ko:"ko", nl:"nl", no:"no", pl:"pl", pt:"pt_BR", "pt-pt":"pt", ro:"ro", ru:"ru", sk:"sk", sv:"sv", th:"th", tr:"tr", "zh-hans":"zh_CN", "zh-hant":"zh_TW"}, _ComponentCreate:function() {
    ...
    var $thisRef$$1$$ = this;
    return function($parentElement$$8$$, $rootElement$$2$$, $data$$152$$, $state$$12$$, $previousState$$) {
      return{component:$oj$$55$$.Components.$getWidgetConstructor$($thisRef$$1$$.element), parentElement:$parentElement$$8$$, rootElement:$rootElement$$2$$, data:$data$$152$$, state:$state$$12$$, previousState:$previousState$$, id:$data$$152$$.id, label:$data$$152$$.label, color:$data$$152$$.color, location:$data$$152$$.location, x:$data$$152$$.x, y:$data$$152$$.y};
    };
  ...
  }, getArea:function($dataLayerId$$1$$, $index$$243$$) {
    var $ret$$57$$ = this.$_component$.getAutomation().getData($dataLayerId$$1$$, "area", $index$$243$$);
    this.$_AddAutomationGetters$($ret$$57$$);
    return $ret$$57$$;
  }, getMarker:function($dataLayerId$$2$$, $index$$244$$) {
    var $ret$$58$$ = this.$_component$.getAutomation().getData($dataLayerId$$2$$, "marker", $index$$244$$);
