...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojdnd"], function($oj$$65$$, $$$$60$$) {
  ...
  $oj$$65$$.$TreeDndContext$.prototype.$_dragStart$ = function $$oj$$65$$$$TreeDndContext$$$$_dragStart$$($e$$107$$) {
    var $dnd$$5$$, $$nodes_vars$$1$$, $$node$$ = $$$$60$$($e$$107$$.target).closest("li"), $dt$$ = $e$$107$$.originalEvent.dataTransfer, $ret$$62$$;
    $dnd$$5$$ = this.$_dnd$;
    ...
    if (!$dnd$$5$$.reorder && !$dnd$$5$$.$dragFromEnabled$ || $$node$$.hasClass($TreeUtils$$.$_OJ_DISABLED$) || this.$component$.$_data$.$core$.locked) {
      ...
      if ($dnd$$5$$.$dragStartCallback$) {
        $ret$$62$$ = $dnd$$5$$.$dragStartCallback$($e$$107$$, {item:void 0});
        if ($e$$107$$.isDefaultPrevented() || "boolean" === typeof $ret$$62$$ && !$ret$$62$$) {
          return $ret$$62$$;
        }
        if (!$dnd$$5$$.$dragDataTypes$ && !this.$_checkAddedDataTypes$($dt$$) && !$dnd$$5$$.reorder) {
          return $e$$107$$.preventDefault(), !1;
        }
      }
      "uninitialized" === $dt$$.effectAllowed && ($dt$$.effectAllowed = $dnd$$5$$.$pureReorder$ ? "move" : $oj$$65$$.$DomUtils$.$isMetaKeyPressed$($e$$107$$) ? "copy" : "move");
      this.$_dndStartDrag$($$nodes_vars$$1$$, $$node$$, $e$$107$$);
    }
  };
  $oj$$65$$.$TreeDndContext$.prototype.$_drag$ = function $$oj$$65$$$$TreeDndContext$$$$_drag$$($e$$108$$) {
    var $dnd$$6$$ = this.$_dnd$;
    $dnd$$6$$.$dragDragCallback$ && $dnd$$6$$.$dragDragCallback$($e$$108$$);
  };
  $oj$$65$$.$TreeDndContext$.prototype.$_dragEnter$ = function $$oj$$65$$$$TreeDndContext$$$$_dragEnter$$($e$$109$$) {
    this.$component$.$_$container_ul$[0].firstChild || this.$_addInternalNode$();
    var $$targ$$1$$ = $$$$60$$($e$$109$$.target), $$node$$1$$ = this.$component$.$_getNode$($$targ$$1$$), $dnd$$7$$ = this.$_dnd$, $vars$$2$$ = $dnd$$7$$.$vars$, $bNode$$ = $$node$$1$$ && 0 < $$node$$1$$.length && $$node$$1$$.hasClass("oj-tree-node"), $dt$$1$$ = $e$$109$$.originalEvent.dataTransfer, $cons$$4$$ = $oj$$65$$.$TreeDndContext$, $bForeignTree$$ = !1, $bClean$$ = !1, $ret$$63$$;
    $bNode$$ && $$node$$1$$.hasClass($TreeUtils$$.$_OJ_TEMPNODE$) && ($dnd$$7$$.$bInternalNode$ = !0);
    if (!$bNode$$ || "UL" != $e$$109$$.target.tagName || "group" != $e$$109$$.target.getAttribute("role")) {
      if ($dnd$$7$$.$foreign$ = !$dnd$$7$$.$dragStarted$, !$dnd$$7$$.$foreign$ && !$dnd$$7$$.reorder || $dnd$$7$$.$foreign$ && this.$_isDtType$($dt$$1$$, $cons$$4$$.$_DND_INTERNAL_DT_REORDER$)) {
        ...
        if (!$$node$$1$$ || !$$node$$1$$.length || $$node$$1$$.attr("id") != $dnd$$7$$.$nodeDraggedId$) {
          ...
          this.$_dndPlacement$($e$$109$$, $$node$$1$$);
          if (this.$_dndEnter$()) {
            $vars$$2$$.$r$.removeClass($cons$$4$$.$_OJ_INVALID_DROP$).addClass($cons$$4$$.$_OJ_VALID_DROP$).addClass($cons$$4$$.$_OJ_ACTIVE_DROP$);
            $dnd$$7$$.$dropDragEnterCallback$ && ($ret$$63$$ = $dnd$$7$$.$dropDragEnterCallback$($e$$109$$, {item:$dnd$$7$$.$bInternalNode$ ? null : $$node$$1$$, position:$dnd$$7$$.$bInternalNode$ ? "first" : $dnd$$7$$.$place$, reference:$dnd$$7$$.$bInternalNode$ ? null : $vars$$2$$.$r$}));
            if (void 0 === $ret$$63$$) {
              this.$_isDtAcceptDataTypes$($dt$$1$$) ? ($e$$109$$.preventDefault(), $e$$109$$.stopPropagation()) : $bClean$$ = $dnd$$7$$.$foreign$ || !$dnd$$7$$.reorder;
            } else {
  ...
  $oj$$65$$.$TreeDndContext$.prototype.$_dragOver$ = function $$oj$$65$$$$TreeDndContext$$$$_dragOver$$($e$$110$$) {
    var $dnd$$8$$ = this.$_dnd$, $vars$$3$$ = $dnd$$8$$.$vars$, $dt$$2$$ = $e$$110$$.originalEvent.dataTransfer, $bClean$$1$$ = !1, $elemId$$1$$, $$node$$2$$, $ret$$64$$;
    if ($vars$$3$$.$r$ && $vars$$3$$.$r$.length && ($$node$$2$$ = $vars$$3$$.$r$, $$node$$2$$.hasClass("oj-tree-node") && ($elemId$$1$$ = $$node$$2$$.attr("id"), $elemId$$1$$ != $dnd$$8$$.$nodeDraggedId$ && (this.$_dndPlacement$($e$$110$$, $$node$$2$$), this.$_dndPrepare$())))) {
      $dnd$$8$$.$dropDragOverCallback$ && ($ret$$64$$ = $dnd$$8$$.$dropDragOverCallback$($e$$110$$, {item:$dnd$$8$$.$bInternalNode$ ? null : $$node$$2$$, reference:$dnd$$8$$.$bInternalNode$ ? null : $vars$$3$$.$r$, position:$dnd$$8$$.$bInternalNode$ ? "first" : $vars$$3$$.$last_pos$}));
      if (void 0 === $ret$$64$$) {
        this.$_isDtAcceptDataTypes$($dt$$2$$) ? ($e$$110$$.preventDefault(), $e$$110$$.stopPropagation()) : $bClean$$1$$ = $dnd$$8$$.$foreign$ || !$dnd$$8$$.reorder;
      } else {
  ...
  $oj$$65$$.$TreeDndContext$.prototype.$_dragDrop$ = function $$oj$$65$$$$TreeDndContext$$$$_dragDrop$$($e$$111$$) {
    var $dnd$$9$$ = this.$_dnd$, $vars$$4$$ = $dnd$$9$$.$vars$, $veto$$ = !1, $ret$$65$$;
    if ($vars$$4$$.$r$) {
      if ($dnd$$9$$.$dropDropCallback$) {
        $ret$$65$$ = $dnd$$9$$.$dropDropCallback$($e$$111$$, {reference:$dnd$$9$$.$bInternalNode$ ? null : $vars$$4$$.$r$, position:$dnd$$9$$.$bInternalNode$ ? "first" : $vars$$4$$.$last_pos$, reorder:!$dnd$$9$$.$foreign$ && $dnd$$9$$.reorder});
      } else {
        if ($dnd$$9$$.$foreign$ || !$dnd$$9$$.reorder) {
          $veto$$ = !0;
        }
      }
      $veto$$ || $ret$$65$$ && !$e$$111$$.isDefaultPrevented() || this.$_dndFinishReorder$($e$$111$$);
    }
    $dnd$$9$$.$foreign$ && this.$_dndClean$();
    $veto$$ || ($e$$111$$.preventDefault(), $e$$111$$.stopPropagation());
    $dnd$$9$$.$nodeLastLeft$ = null;
    return $ret$$65$$;
  };
  $oj$$65$$.$TreeDndContext$.prototype.$_dragEnd$ = function $$oj$$65$$$$TreeDndContext$$$$_dragEnd$$($e$$112$$) {
    var $dnd$$10$$ = this.$_dnd$, $vars$$5$$ = $dnd$$10$$.$vars$;
    $dnd$$10$$.$dragEndCallback$ && $dnd$$10$$.$dragEndCallback$($e$$112$$, {reorder:$dnd$$10$$.reorder && !1 === $vars$$5$$.$o$});
    this.$_dndStopDrag$();
    this.$_dndClean$();
  };
  ...
  $oj$$65$$.$TreeDndContext$.prototype.$_dragLeave$ = function $$oj$$65$$$$TreeDndContext$$$$_dragLeave$$($e$$113$$) {
    var $dnd$$11$$ = this.$_dnd$, $vars$$6$$ = $dnd$$11$$.$vars$, $$targ$$2$$ = $$$$60$$($e$$113$$.target), $$node$$3$$ = $$targ$$2$$.closest("li"), $bNode$$1$$ = $$node$$3$$ && 0 < $$node$$3$$.length && $$node$$3$$.hasClass("oj-tree-node");
    $$node$$3$$.attr("id");
    var $dt$$4$$ = $e$$113$$.originalEvent.dataTransfer;
    $dnd$$11$$.$dropDragLeaveCallback$ && $dnd$$11$$.$dropDragLeaveCallback$($e$$113$$, {item:$dnd$$11$$.$bInternalNode$ ? null : $$node$$3$$});
    $$targ$$2$$.hasClass("oj-tree") || !$bNode$$1$$ || "none" == $dt$$4$$.dropEffect ? this.$_dndLeave$($e$$113$$) : $dnd$$11$$.$nodeLastLeft$ = $$node$$3$$;
  ...
  $oj$$65$$.$TreeDndContext$.prototype.$_dndFinishReorder$ = function $$oj$$65$$$$TreeDndContext$$$$_dndFinishReorder$$($e$$114$$) {
    var $dnd$$14$$ = this.$_dnd$, $vars$$9$$ = $dnd$$14$$.$vars$;
    $dnd$$14$$.$dragStarted$ && $dnd$$14$$.reorder && "object" == typeof $vars$$9$$.$o$ && 0 < $vars$$9$$.$o$.length && (this.$component$.$_moveNode$($vars$$9$$.$o$, $vars$$9$$.$r$, $vars$$9$$.$last_pos$, $oj$$65$$.$DomUtils$.$isMetaKeyPressed$($e$$114$$)), $vars$$9$$.$o$ = !1);
  };
  ...
  $oj$$65$$.$TreeDndContext$.prototype.$_dndPlacement$ = function $$oj$$65$$$$TreeDndContext$$$$_dndPlacement$$($e$$115$$, $$node$$4$$) {
    var $dnd$$15$$ = this.$_dnd$;
    $$node$$4$$ && ($$node$$4$$.hasClass($TreeUtils$$.$_OJ_TEMPNODE$) ? $dnd$$15$$.$place$ = "after" : ($e$$115$$ = $e$$115$$.originalEvent, $dnd$$15$$.off = $$node$$4$$.offset(), $dnd$$15$$.$place$ = $e$$115$$.pageY - ($dnd$$15$$.off.top || 0), $dnd$$15$$.$place$ = $dnd$$15$$.$place$ >= this.$component$.$_data$.$core$.$li_height$ ? "after" : 0 > $dnd$$15$$.$place$ ? "before" : "inside", "after" === $dnd$$15$$.$place$ && $$node$$4$$.hasClass($TreeUtils$$.$_OJ_EXPANDED$) && ($dnd$$15$$.$place$ = "first")));
  };
  $oj$$65$$.$TreeDndContext$.prototype.$_dndLeave$ = function $$oj$$65$$$$TreeDndContext$$$$_dndLeave$$($e$$116$$) {
    ...
    this.$_dndHideMarker$();
    $vars$$10$$.$r$ && $vars$$10$$.$r$[0] === $e$$116$$.target.parentNode && $dnd$$16$$.$openTimerId$ && (clearTimeout($dnd$$16$$.$openTimerId$), $dnd$$16$$.$openTimerId$ = !1);
  };
  ...
  $oj$$65$$.$TreeDndContext$.prototype.$_dndStartDrag$ = function $$oj$$65$$$$TreeDndContext$$$$_dndStartDrag$$($$cnt_$nodes$$1$$, $$node$$5$$, $e$$117$$) {
    ...
    try {
      $e$$117$$.currentTarget.unselectable = "on", $e$$117$$.currentTarget.onselectstart = function $$e$$117$$$currentTarget$onselectstart$() {
        return!1;
      }, $e$$117$$.currentTarget.style && ($e$$117$$.currentTarget.style.MozUserSelect = "none");
    } catch ($err$$25$$) {
    }
  ...
  $oj$$65$$.$TreeDndContext$.prototype.$_setDataTypes$ = function $$oj$$65$$$$TreeDndContext$$$$_setDataTypes$$($dt$$5$$, $$nodes$$2$$) {
    var $dnd$$23$$ = this.$_dnd$, $cons$$11$$ = $oj$$65$$.$TreeDndContext$, $adata$$1_i$$392$$, $data$$165$$;
    ($adata$$1_i$$392$$ = this.$component$.$__getJson$($$nodes$$2$$)) && ($data$$165$$ = JSON.stringify($adata$$1_i$$392$$));
    if ($dnd$$23$$.$dragDataTypes$) {
      for ($adata$$1_i$$392$$ = 0;$adata$$1_i$$392$$ < $dnd$$23$$.$dragDataTypes$.length;$adata$$1_i$$392$$++) {
        $dt$$5$$.setData($dnd$$23$$.$dragDataTypes$[$adata$$1_i$$392$$], $data$$165$$);
      }
    }
  ...
  (function() {
    ...
    function $_KeyFilterHandler$$($e$$118$$) {
      var $s$$10$$ = "";
      $oj$$65$$.$DomUtils$.$isMetaKeyPressed$($e$$118$$) ? $s$$10$$ += "ctrl+" : $e$$118$$.shiftKey && ($s$$10$$ += "shift+");
      var $key$$170$$ = $e$$118$$.which;
      switch($key$$170$$) {
        case 32:
          $s$$10$$ += "space";
          break;
      ...
      $$$$60$$.each($_aKeyHandlerStack$$, function($i$$396$$, $obj$$60$$) {
        if ($obj$$60$$.$_this$.$_data$.ui.$focused$) {
          return $obj$$60$$.$_this$.$_data$.ui.$touchEvent$ = !1, "shift+f10" == $s$$10$$ ? $obj$$60$$.$_this$.$_data$.menu.$activenode$ = $obj$$60$$.$_this$.$_data$.ui.$hovered$ : $obj$$60$$.$_handler$[$s$$10$$] && ($e$$118$$.preventDefault(), $retHandler$$ = $obj$$60$$.$_handler$[$s$$10$$].call($obj$$60$$.$_this$, $e$$118$$)), !1;
        }
      });
      if (null != $retHandler$$) {
        return $retHandler$$;
    ...
    expandAll:null, hover:null, loaded:null, move:null, optionChange:null, paste:null, refresh:null, rename:null}, collapse:function($node$$113$$, $skipAnim$$) {
      ...
      return $h$$7$$ + 10;
    }, $_transitionEndHandler$:function($$ul$$3_e$$119$$) {
      $$ul$$3_e$$119$$ = $$$$60$$($$ul$$3_e$$119$$.target);
      var $node$$115$$ = $$ul$$3_e$$119$$.closest("li");
      this.$_isSafari$ ? $$ul$$3_e$$119$$[0].removeEventListener("webkitTransitionEnd", this.$_proxyTransitionEndHandler$) : $$ul$$3_e$$119$$[0].removeEventListener("transitionend", this.$_proxyTransitionEndHandler$);
      $$ul$$3_e$$119$$.removeClass("oj-tree-transition");
      this.$_transitionEnd$($$ul$$3_e$$119$$, $node$$115$$);
      ...
      if ($nodes$$5$$ && "array" === $$$$60$$.type($nodes$$5$$)) {
        ...
        $$$$60$$.each($nodes$$5$$, function($i$$398$$, $val$$64$$) {
      ...
      return $r$$2$$;
    }, create:function($refnode$$, $position$$35$$, $data$$166$$) {
      var $node$$128$$, $ar$$1$$, $i$$399$$;
      $ar$$1$$ = $$$$60$$.isArray($data$$166$$);
      if (!$ar$$1$$ || 1 == $data$$166$$.length) {
        return $node$$128$$ = this.$_createNode$($refnode$$, $position$$35$$, $ar$$1$$ ? $data$$166$$[0] : $data$$166$$), this.$_getDndContext$().$_dndFinishSelection$($node$$128$$), $node$$128$$;
      }
      $ar$$1$$ = [];
      if ("before" != $position$$35$$) {
        for ($i$$399$$ = $data$$166$$.length - 1;0 <= $i$$399$$;$i$$399$$--) {
          $node$$128$$ = this.$_createNode$($refnode$$, $position$$35$$, $data$$166$$[$i$$399$$]), $ar$$1$$.unshift($node$$128$$[0]), this.$_getDndContext$().$_dndFinishSelection$($node$$128$$);
        }
      } else {
        for ($i$$399$$ = 0;$i$$399$$ < $data$$166$$.length;$i$$399$$++) {
          $node$$128$$ = this.$_createNode$($refnode$$, $position$$35$$, $data$$166$$[$i$$399$$]), $ar$$1$$.push($node$$128$$[0]), this.$_getDndContext$().$_dndFinishSelection$($node$$128$$);
        }
      }
      return $$$$60$$($ar$$1$$);
    ...
    }, move:function($node$$135$$, $refnode$$1$$, $position$$36$$, $iscopy$$) {
      this.$_moveNode$($node$$135$$, $refnode$$1$$, $position$$36$$, $iscopy$$);
    ...
    }, $_moveNode$:function($obj$$69$$, $d$$8_o$$19_ref$$3$$, $position$$37$$, $is_copy$$, $is_prepared$$, $skip_check$$) {
      $is_prepared$$ || ($obj$$69$$ = this.$_getNode$($obj$$69$$));
      if (!($obj$$69$$.hasClass && $obj$$69$$.hasClass($TreeUtils$$.$_OJ_DISABLED$) || this.$_data$.$core$.locked)) {
        if (!$is_prepared$$) {
          return this.$_prepare_move$($obj$$69$$, $d$$8_o$$19_ref$$3$$, $position$$37$$, function($p$$11$$) {
      ...
      var $v$$2$$ = !1, $ty$$ = this.$_getType$($obj$$70$$), $s$$12$$ = this.$_getOptions$().types, $data$$167$$ = !1;
      if (-1 === $obj$$70$$) {
        if ($s$$12$$[$rule$$3$$]) {
          $v$$2$$ = $s$$12$$[$rule$$3$$];
        } else {
        ...
        ($data$$167$$ = this.$_data$.types.$defaults$.useData ? $obj$$70$$.data("oj-tree") : !1) && $data$$167$$.types && "undefined" !== typeof $data$$167$$.types[$rule$$3$$] ? $v$$2$$ = $data$$167$$.types[$rule$$3$$] : $s$$12$$.types[$ty$$] && "undefined" !== typeof $s$$12$$.types[$ty$$][$rule$$3$$] ? $v$$2$$ = $s$$12$$.types[$ty$$][$rule$$3$$] : $s$$12$$.types["default"] && "undefined" !== typeof $s$$12$$.types["default"][$rule$$3$$] && ($v$$2$$ = $s$$12$$.types["default"][$rule$$3$$]);
      }
    ...
    }, $_createNode$:function($obj$$72$$, $position$$38$$, $js$$, $callback$$123$$, $d$$10_is_loaded$$) {
      $obj$$72$$ = $obj$$72$$ || -1;
      ...
      var $tmp$$4$$;
      $position$$38$$ = "undefined" === typeof $position$$38$$ ? "last" : $position$$38$$;
      if (!$d$$10_is_loaded$$ && !this.$_is_loaded$($obj$$72$$)) {
        return this.$_load_node$($obj$$72$$, function() {
          this.$_createNode$($obj$$72$$, $position$$38$$, $js$$, $callback$$123$$, !0);
        }), null;
      }
      this.$__rollback$();
      ...
      -1 === $obj$$72$$ && ($obj$$72$$ = this.$_$container$, "before" === $position$$38$$ && ($position$$38$$ = "first"), "after" === $position$$38$$ && ($position$$38$$ = "last"));
      switch($position$$38$$) {
        case "before":
        ...
        case "last":
          ...
          break;
        default:
          $obj$$72$$.children("ul").length || $obj$$72$$.append("\x3cul /\x3e"), $position$$38$$ || ($position$$38$$ = 0), $tmp$$4$$ = $obj$$72$$.children("ul").children("li").eq($position$$38$$), $tmp$$4$$.length ? $tmp$$4$$.before($d$$10_is_loaded$$) : $obj$$72$$.children("ul").append($d$$10_is_loaded$$), $tmp$$4$$ = $obj$$72$$;
      }
    ...
    }, $_select$:function($node$$153$$, $bRet_check$$, $e$$121$$) {
      ...
      $e$$121$$ && "touchend" == $e$$121$$.type || ($ui$$41$$.$touchEvent$ = !1);
      ...
      if ($bRet_check$$) {
        ...
        switch(!0) {
          case $isRange_selRangeMod$$:
            ...
            $node$$153$$ = $node$$153$$[$node$$153$$.index() < $ui$$41$$.$lastSelected$.index() ? "nextUntil" : "prevUntil"](".oj-tree-last-selected").addBack();
            -1 == $selectMode$$ || $node$$153$$.length < $selectMode$$ ? ($ui$$41$$.$lastSelected$.removeClass("oj-tree-last-selected"), $ui$$41$$.selected.each(function() {
          ...
          case $isSelected$$ && !$isMultiple_selMultMod$$:
            ...
            break;
          case !$isSelected$$ && !$isMultiple_selMultMod$$:
            $e$$121$$ ? $ui$$41$$.selected && 1 == $ui$$41$$.selected.length ? this.$_deselect$($ui$$41$$.selected) : this.$_deselectAll$($ui$$41$$.selected) : 1 === $selectMode$$ ? this.$_deselect$($ui$$41$$.selected) : 1 < $selectMode$$ && this.$_deselectAll$();
            $proceed$$1$$ = !0;
            break;
          case $isSelected$$ && $isMultiple_selMultMod$$:
      ...
      $bRet_check$$ = !1;
      $proceed$$1$$ && !$isSelected$$ && ($isRange_selRangeMod$$ || ($ui$$41$$.$lastSelected$ = $node$$153$$), $node$$153$$.children("a").addClass($TreeUtils$$.$_OJ_SELECTED$), $node$$153$$.attr("aria-selected", "true"), $bRet_check$$ = !0, $s$$14$$.selectedParentExpand && $node$$153$$.parents(".oj-collapsed").each(function() {
        $t$$8$$.$_expand$(this, !1, !0);
      }), $ui$$41$$.selected = $ui$$41$$.selected.add($node$$153$$), this.$_fix_scroll$($node$$153$$.eq(0)), $core$$.$suppressSelectEvent$ || this.$_fireOptionChangeEvent$("selection", $prevSelections$$2_rslt$$5$$, null, $e$$121$$));
      return $bRet_check$$;
    ...
    }, $_setSelected$:function($nodes$$7$$, $e$$122$$) {
      if (this.$_data$.$core$.locked) {
        return null;
      }
      if ($nodes$$7$$ && 0 < $nodes$$7$$.length) {
        var $_this$$9$$ = this;
        $$$$60$$.each($nodes$$7$$, function($i$$404$$, $val$$68$$) {
          $val$$68$$ && $_this$$9$$.$_select$($val$$68$$, !0, $e$$122$$);
        });
      }
      ...
      var $s$$16$$ = this.options.data, $data$$168$$ = null, $ajax$$ = null;
      $s$$16$$ && ($data$$168$$ = $s$$16$$.data || null, $ajax$$ = $s$$16$$.ajax || null);
      $obj$$86$$ = this.$_getNode$($obj$$86$$);
      return-1 == $obj$$86$$ || !$obj$$86$$ || !$ajax$$ && !$$$$60$$.isFunction($data$$168$$) || $obj$$86$$.is(".oj-expanded, .oj-tree-leaf") || 0 < $obj$$86$$.children("ul").children("li").size();
    }, reselect:function() {
      ...
      0 < $cc$$ && ($range$$18$$.count = $cc$$, $ds$$.$fetchChildren$($parentKey$$9$$, $range$$18$$, {success:$$$$60$$.proxy(function($jns$$) {
        for (var $c$$49$$ = $jns$$.$getCount$(), $attr$$18_n$$33_r$$5$$, $i$$408$$ = 0;$i$$408$$ < $c$$49$$;$i$$408$$++) {
          ...
          var $key$$172$$ = $node$$157$$.attr.id;
          $attr$$18_n$$33_r$$5$$ = $ds$$.$getChildCount$($key$$172$$);
          0 < $attr$$18_n$$33_r$$5$$ && ($attr$$18_n$$33_r$$5$$ = this.$_JsonDSToJson$($key$$172$$, $node$$157$$), $node$$157$$.children = $attr$$18_n$$33_r$$5$$.$js$);
      ...
      var $d$$12_s$$20$$ = this.$_getOptions$().data, $data$$169$$ = $d$$12_s$$20$$ && $d$$12_s$$20$$.data || null, $ajax$$1$$ = $d$$12_s$$20$$ && $d$$12_s$$20$$.ajax || null;
      !$d$$12_s$$20$$ || $data$$169$$ || $ajax$$1$$ || ($data$$169$$ = $d$$12_s$$20$$);
      if (($obj$$89$$ = this.$_getNode$($obj$$89$$)) && -1 !== $obj$$89$$ && (this.$_data$.$ds$.$progressiveRender$ || this.$_data$.$ds$.$progressiveUnload$) && !$obj$$89$$.is(".oj-expanded, .oj-tree-leaf") && 0 === $obj$$89$$.children("ul").children("li").length && $obj$$89$$.data("oj-tree-children")) {
        ...
        switch(!0) {
          case !$data$$169$$ && !$ajax$$1$$:
            throw "ojTree - neither data nor ajax settings supplied.";;
          case $$$$60$$.isFunction($data$$169$$):
            $data$$169$$.call(this, $obj$$89$$, $$$$60$$.proxy(function($d$$13$$) {
            ...
            break;
          case !!$data$$169$$ && !$ajax$$1$$ || !!$data$$169$$ && !!$ajax$$1$$ && (!$obj$$89$$ || -1 === $obj$$89$$):
            $obj$$89$$ && -1 != $obj$$89$$ || (($d$$12_s$$20$$ = this.$_parseJson$($data$$169$$, $obj$$89$$)) ? (this.$_$container_ul$.empty().append($d$$12_s$$20$$.children()), this.$_cleanNode$()) : this.$_data$.$ds$.$correctState$ && this.$_$container_ul$.empty());
            $s_call$$4$$ && $s_call$$4$$.call(this);
            break;
          case !$data$$169$$ && !!$ajax$$1$$ || !!$data$$169$$ && !!$ajax$$1$$ && $obj$$89$$ && -1 !== $obj$$89$$:
            $error_func$$ = function $$error_func$$$($x$$56$$, $status$$28$$, $e$$123$$) {
              var $ef$$ = this.$_getOptions$().data.ajax.error;
              $ef$$ && $ef$$.call(this, $status$$28$$, $e$$123$$, $x$$56$$);
      ...
      if ($$$$60$$.isArray($js$$1$$)) {
        ...
        $d$$15$$.append($tmp$$5$$);
        $d$$15$$.prepend("\x3cins class\x3d'oj-tree-icon oj-tree-disclosure-icon oj-component-icon oj-clickable-icon-nocontext oj-default'\x3e\x26#160;\x3c/ins\x3e");
      ...
      var $result$$76$$ = [], $s$$21$$ = this.options, $_this$$17$$ = this, $tmp1$$, $tmp2$$, $val$$72$$, $li$$3$$, $a$$119$$, $t$$9$$, $sAttr$$, $title$$13$$;
      ...
      $obj$$92$$.find("ins:first-child").removeClass("oj-tree-icon oj-tree-disclosure-icon oj-component-icon oj-clickable-icon-nocontext oj-default").addClass("oj-tree-icon");
      ...
      var $d$$16_s$$22$$ = this.$_getOptions$().data, $data$$170$$ = $d$$16_s$$22$$ && $d$$16_s$$22$$.data || null, $ajax$$2$$ = $d$$16_s$$22$$ && $d$$16_s$$22$$.ajax || null;
      ...
      switch(!0) {
        case !$data$$170$$ && !$ajax$$2$$ && $d$$16_s$$22$$ && "string" === typeof $d$$16_s$$22$$:
          this.$_loadHtmlString$($d$$16_s$$22$$, $obj$$93$$, $s_call$$5$$, $e_call$$5$$);
          break;
        case $$$$60$$.isFunction($data$$170$$):
          $data$$170$$.call(this, $obj$$93$$, $$$$60$$.proxy(function($d$$17$$) {
            this.$_loadHtmlString$($d$$17$$, $obj$$93$$, $s_call$$5$$, $e_call$$5$$);
          }, this));
          break;
        case !$data$$170$$ && !$ajax$$2$$:
          ...
          break;
        case !!$data$$170$$ && !$ajax$$2$$ || !!$data$$170$$ && !!$ajax$$2$$ && (!$obj$$93$$ || -1 === $obj$$93$$):
          $obj$$93$$ && -1 != $obj$$93$$ || ($d$$16_s$$22$$ = $$$$60$$($data$$170$$), $d$$16_s$$22$$.is("ul") || ($d$$16_s$$22$$ = $$$$60$$("\x3cul /\x3e").append($d$$16_s$$22$$)), this.$_$container_ul$.empty().append($d$$16_s$$22$$.children()).find("li, a").filter(function() {
            return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName;
          ...
          break;
        case !$data$$170$$ && !!$ajax$$2$$ || !!$data$$170$$ && !!$ajax$$2$$ && $obj$$93$$ && -1 !== $obj$$93$$:
          $obj$$93$$ = this.$_getNode$($obj$$93$$), $error_func$$1$$ = function $$error_func$$1$$$($x$$58$$, $t$$10$$, $e$$124$$) {
            var $ef$$1$$ = this.$_getOptions$().data.ajax.error;
            $ef$$1$$ && $ef$$1$$.call(this, $x$$58$$, $t$$10$$, $e$$124$$);
          ...
          }, $success_func$$1$$ = function $$success_func$$1$$$($d$$18_parent$$45$$, $nodes$$8_t$$11$$, $x$$59$$) {
            var $sf$$1$$ = this.$_getOptions$().data.ajax.success;
            $sf$$1$$ && ($d$$18_parent$$45$$ = $sf$$1$$.call(this, $d$$18_parent$$45$$, $nodes$$8_t$$11$$, $x$$59$$) || $d$$18_parent$$45$$);
            if ("" === $d$$18_parent$$45$$ || $d$$18_parent$$45$$ && $d$$18_parent$$45$$.toString && "" === $d$$18_parent$$45$$.toString().replace(/^[\s\n]+$/, "")) {
              return $error_func$$1$$.call(this, $x$$59$$, $nodes$$8_t$$11$$, "");
            }
            if ($d$$18_parent$$45$$) {
              ...
              -1 != $obj$$93$$ && $obj$$93$$ ? ($obj$$93$$.children("a.oj-tree-loading").removeClass("oj-tree-loading"), this.$_removeEmptyUL$($obj$$93$$), $obj$$93$$.append($d$$18_parent$$45$$).children("ul").find("li, a").filter(function() {
                return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName;
              }).prepend("\x3cins class\x3d'oj-tree-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-node-icon").addClass("oj-tree-node-icon").addClass("oj-tree-icon"), $obj$$93$$.removeData("oj-tree-is-loading"), $obj$$93$$.find("li.oj-tree-leaf ins:first-child").removeClass("oj-tree-icon oj-tree-disclosure-icon oj-component-icon oj-clickable-icon-nocontext oj-default").removeClass("oj-tree-node-icon").addClass("oj-tree-icon"), $d$$18_parent$$45$$ = $obj$$93$$) : 
              (this.$_$container_ul$.empty().append($d$$18_parent$$45$$.children()).find("li, a").filter(function() {
                return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName;
              }).prepend("\x3cins class\x3d'oj-tree-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-node-icon").addClass("oj-tree-node-icon").addClass("oj-tree-icon"), this.$_$container_ul$.find("li.oj-tree-leaf ins:first-child").removeClass("oj-tree-icon oj-tree-disclosure-icon oj-component-icon oj-clickable-icon-nocontext oj-default").removeClass("oj-tree-node-icon").addClass("oj-tree-icon"), $d$$18_parent$$45$$ = this.$_$container_ul$);
              this.$_handleHtmlParentNoChildren$($d$$18_parent$$45$$);
              this.$_insertHtmlTextSpan$($d$$18_parent$$45$$);
              $nodes$$8_t$$11$$ = $d$$18_parent$$45$$.children("UL");
    ...
    }, $_loadHtmlString$:function($nodes$$9_parent$$48_s$$23$$, $obj$$94$$, $s_call$$6$$) {
      if ($nodes$$9_parent$$48_s$$23$$ && "" !== $nodes$$9_parent$$48_s$$23$$ && $nodes$$9_parent$$48_s$$23$$.toString && "" !== $nodes$$9_parent$$48_s$$23$$.toString().replace(/^[\s\n]+$/, "")) {
        $nodes$$9_parent$$48_s$$23$$ = $$$$60$$($nodes$$9_parent$$48_s$$23$$);
        $nodes$$9_parent$$48_s$$23$$.is("ul") || ($nodes$$9_parent$$48_s$$23$$ = $$$$60$$("\x3cul /\x3e").append($nodes$$9_parent$$48_s$$23$$));
        -1 != $obj$$94$$ && $obj$$94$$ ? ($obj$$94$$.children("a.oj-tree-loading").removeClass("oj-tree-loading"), $obj$$94$$.append($nodes$$9_parent$$48_s$$23$$).children("ul").find("li, a").filter(function() {
          return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName;
        }).prepend("\x3cins class\x3d'oj-tree-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-node-icon").addClass("oj-tree-node-icon").addClass("oj-tree-icon"), $obj$$94$$.removeData("oj-tree-is-loading"), $nodes$$9_parent$$48_s$$23$$ = $obj$$94$$, this.$_addDefType$(this.$obj$)) : (this.$_$container_ul$.empty().append($nodes$$9_parent$$48_s$$23$$.children()).find("li, a").filter(function() {
          return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName;
        }).prepend("\x3cins class\x3d'oj-tree-icon oj-tree-disclosure-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-node-icon").addClass("oj-tree-node-icon").addClass("oj-tree-icon"), this.$_$container_ul$.find("li.oj-tree-leaf ins:first-child").removeClass("oj-tree-icon oj-tree-disclosure-icon oj-component-icon oj-clickable-icon-nocontext oj-default").removeClass("oj-tree-node-icon").addClass("oj-tree-icon"), $nodes$$9_parent$$48_s$$23$$ = this.$_$container_ul$, 
        this.$_addDefType$(this.$_$container_ul$));
        $nodes$$9_parent$$48_s$$23$$ && this.$_insertHtmlTextSpan$($nodes$$9_parent$$48_s$$23$$);
        $nodes$$9_parent$$48_s$$23$$ = $nodes$$9_parent$$48_s$$23$$.children("UL");
        if (1 <= $nodes$$9_parent$$48_s$$23$$.length) {
          $nodes$$9_parent$$48_s$$23$$ = $nodes$$9_parent$$48_s$$23$$.first().find("span.oj-tree-title");
          var $_this$$19$$ = this;
          $$$$60$$.each($nodes$$9_parent$$48_s$$23$$, function() {
      ...
      this.$_data$.$core$.$toExpand$.length && (this.$_data$.$core$.$toLoad$ = this.$_data$.$core$.$toLoad$.concat(this.$_data$.$core$.$toExpand$), this.$_data$.$core$.$toLoad$ = this.$_data$.$core$.$toLoad$.reduce(function($a$$120$$, $b$$75$$) {
        0 > $a$$120$$.indexOf($b$$75$$) && $a$$120$$.push($b$$75$$);
        return $a$$120$$;
      }, []));
      ...
      this.$_initMenu$();
    }, $_emitEvent$:function($data$$171$$, $evname$$, $bInternal$$) {
      if ($evname$$ && "string" === $$$$60$$.type($evname$$) && (!0 !== this.$_data$.$core$.locked || "unlock" === $evname$$ || "isLocked" === $evname$$ || "lock" === $evname$$)) {
        ...
        var $eventdata$$ = {};
        $eventdata$$.item = $data$$171$$ ? $data$$171$$.obj : void 0;
        $eventdata$$.inst = $func$$11_inst$$;
        $isBefore$$ ? ($func$$11_inst$$ = $data$$171$$.func, $eventdata$$.func = $func$$11_inst$$, $eventdata$$.args = $args$$22_bContinue$$, "rename" === $func$$11_inst$$ && ($eventdata$$.title = $data$$171$$.title, $eventdata$$.prevTitle = $data$$171$$.prevTitle)) : $isPublic$$ && ("move" == $evname$$ ? ($eventdata$$.position = $data$$171$$.$p$, $eventdata$$.reference = $data$$171$$.$r$, $eventdata$$.data = $data$$171$$) : "rename" == $evname$$ ? ($eventdata$$.title = $data$$171$$.title, $eventdata$$.prevTitle = 
        $data$$171$$.prevTitle) : "remove" == $evname$$ ? ($eventdata$$.parent = $data$$171$$.parent, $eventdata$$.prev = $data$$171$$.prev) : "delete" == $evname$$ ? ($eventdata$$.prev = $data$$171$$.prev, $eventdata$$.parent = $data$$171$$.parent) : "expandAll" === $evname$$ || "collapseAll" === $evname$$ || "deselectAll" === $evname$$ ? $eventdata$$.targ = $data$$171$$.targ : "loaded" === $evname$$ && ($eventdata$$.item = -1));
        if ($isPublic$$) {
      ...
      $a$$121$$ && "array" === $$$$60$$.type($a$$121$$) && 0 < $a$$121$$.length && (this.$_data$.ui.$to_select$ = $a$$121$$, this.options.selection = []);
      ...
      this.$_$container$.delegate(".oj-tree-list a", "click.ojtree", $$$$60$$.proxy(function($event$$568$$) {
        ...
        this.dehover();
        this.saveSelected();
      }, this)).bind("ojcollapse", $$$$60$$.proxy(function($event$$573$$, $ui$$43$$) {
      ...
      }, this)).bind("ojremove", $$$$60$$.proxy(function($event$$574$$, $ui$$44$$) {
      ...
      }, this)).bind("ojmove", $$$$60$$.proxy(function($event$$575$$, $ui$$45$$) {
        var $data$$172$$ = $ui$$45$$.data, $copy$$1_p$$12$$ = $data$$172$$.$cy$;
        $copy$$1_p$$12$$ && $data$$172$$.$oc$ && ($data$$172$$.$oc$.find("a.oj-selected").removeClass($TreeUtils$$.$_OJ_SELECTED$), $data$$172$$.$oc$.removeAttr("aria-selected"));
        $data$$172$$.$ot$ === $data$$172$$.$rt$ || $copy$$1_p$$12$$ || ($copy$$1_p$$12$$ = $data$$172$$.$ot$.$_data$.ui, $copy$$1_p$$12$$.$lastHovered$ && ($data$$172$$.$o$.attr("id") == $copy$$1_p$$12$$.$lastHovered$.attr("id") && ($copy$$1_p$$12$$.$lastHovered$ = null), $copy$$1_p$$12$$.$lastSelected$ && $data$$172$$.$o$.attr("id") == $copy$$1_p$$12$$.$lastSelected$.attr("id") && ($copy$$1_p$$12$$.$lastSelected$ = null)));
      }, this));
      ...
      3 === this.$_data$.$ds$.type && (this.$_data$.$ds$.$progressiveUnload$ && this.$_$container$.bind("_treeafter_close", function($e$$127$$, $ui$$46$$) {
      ...
      }, this)).bind("ojbefore", $$$$60$$.proxy(function($e$$128$$, $data$$173$$) {
        var $d$$19_o$$20_s$$28$$, $ty$$1$$, $func$$12$$ = $data$$173$$.func, $item$$120$$ = $data$$173$$.item;
        if (($d$$19_o$$20_s$$28$$ = ($d$$19_o$$20_s$$28$$ = this.$_data$.types.$defaults$.useData ? this.$_getNode$($item$$120$$) : !1) && -1 !== $d$$19_o$$20_s$$28$$ && $d$$19_o$$20_s$$28$$.length ? $d$$19_o$$20_s$$28$$.data("oj-tree") : !1) && $d$$19_o$$20_s$$28$$.types && !1 === $d$$19_o$$20_s$$28$$[$func$$12$$] || -1 !== $$$$60$$.inArray($func$$12$$, this.$_data$.types.$attachTo$) && $data$$173$$.item && ($data$$173$$.item.tagName || $data$$173$$.item.jquery) && ($d$$19_o$$20_s$$28$$ = this.options.types.types, 
        $ty$$1$$ = this.$_getType$($item$$120$$), ($d$$19_o$$20_s$$28$$[$ty$$1$$] && "undefined" !== typeof $d$$19_o$$20_s$$28$$[$ty$$1$$][$func$$12$$] || $d$$19_o$$20_s$$28$$["default"] && "undefined" !== typeof $d$$19_o$$20_s$$28$$["default"][$func$$12$$]) && !1 === this.$_check$($func$$12$$, $item$$120$$))) {
      ...
      if (!$ui$$47$$.inst && this.$_data$.menu.$treeDivId$ == this.$_elemId$.substr(1)) {
        var $id$$60$$ = $ui$$47$$ ? $ui$$47$$.item.attr("id") : void 0;
      ...
      $data$$174$$.$core$ = {$initLoaded$:[], $selectMode$:1, $load_open$:!1, $li_height$:0, $toExpand$:!1, $toLoad$:!1, $prepMoveBlk$:{}, $suppressSelectEvent$:!1, $strings$:{}};
      $data$$174$$.ui = {selected:$$$$60$$(), $lastSelected$:!1, $hovered$:null, $lastHovered$:null, $disclosureClick$:!1, $to_select$:null, opacity:1, $spacebar$:!1, $focused$:!1, $animDurDiv$:null, $touchEvent$:!1};
      ...
      if ($hover$$1$$) {
        ...
        $hover$$1$$ = $hover$$1$$[0];
        $$$$60$$.each($nodes$$10$$, function($i$$418$$, $node$$158$$) {
      ...
      this.$_emitEvent$({obj:$obj$$101$$, nodes:$nodes$$11$$}, "paste");
    }, $_crrm_move_node$:function($obj$$102$$, $ref$$4$$, $position$$39$$, $is_copy$$1$$, $is_prepared$$1$$, $skip_check$$1$$) {
      var $s$$30$$ = this.$_data$.$crrm$.$defaults$.move;
      if (!$is_prepared$$1$$) {
        return "undefined" === typeof $position$$39$$ && ($position$$39$$ = $s$$30$$.defaultPosition), "inside" !== $position$$39$$ || $s$$30$$.defaultPosition.match(/^(before|after)$/) || ($position$$39$$ = $s$$30$$.defaultPosition), this.$_moveNode$($obj$$102$$, $ref$$4$$, $position$$39$$, $is_copy$$1$$, !1, $skip_check$$1$$);
      }
      if (!0 === $s$$30$$.alwaysCopy || "multitree" === $s$$30$$.alwaysCopy && $obj$$102$$.$rt$.$_getIndex$() !== $obj$$102$$.$ot$.$_getIndex$()) {
        $is_copy$$1$$ = !0;
      }
      this.$_moveNode$($obj$$102$$, $ref$$4$$, $position$$39$$, $is_copy$$1$$, !0, $skip_check$$1$$);
      ...
      }, this), keyup:function($event$$581_key$$175$$) {
        $event$$581_key$$175$$ = $event$$581_key$$175$$.keyCode || $event$$581_key$$175$$.which;
        if (!$_this$$28$$.$_done$) {
          return $_this$$28$$.$_done$ = !0, !1;
        }
        27 == $event$$581_key$$175$$ ? ($_this$$28$$.$_done$ = !1, this.value = $t$$15$$, this.blur()) : 13 == $event$$581_key$$175$$ ? ($_this$$28$$.$_done$ = !1, this.blur()) : $h2$$.width(Math.min($h1$$.text("pW" + this.value).width(), $w$$8$$));
    ...
    }, $_crrm_create$:function($obj$$107$$, $position$$40$$, $js$$2$$, $callback$$126$$, $skip_rename$$) {
      var $_this$$29$$ = this;
      ($obj$$107$$ = this.$_getNode$($obj$$107$$)) || ($obj$$107$$ = -1);
      this.$__rollback$();
      return this.$_createNode$($obj$$107$$, $position$$40$$, $js$$2$$, function($t$$17$$) {
      ...
      var $c$$51_i$$421_subId$$66$$, $node$$160$$, $a$$123_sKey$$;
      $a$$123_sKey$$ = null;
      var $ret$$76$$;
      ...
      $a$$123_sKey$$ = $c$$51_i$$421_subId$$66$$.split("[");
      if (3 === $a$$123_sKey$$.length && ($a$$123_sKey$$[0] = $a$$123_sKey$$[0].trim(), "oj-tree-node" === $a$$123_sKey$$[0] && ($a$$123_sKey$$[1] = $a$$123_sKey$$[1].trim(), $c$$51_i$$421_subId$$66$$ = $a$$123_sKey$$[1].charAt(0), $c$$51_i$$421_subId$$66$$ = $a$$123_sKey$$[1].indexOf($c$$51_i$$421_subId$$66$$, 1), 0 <= $c$$51_i$$421_subId$$66$$ && ($locator$$62_sNode$$ = $a$$123_sKey$$[1].substring(1, $c$$51_i$$421_subId$$66$$).trim(), $a$$123_sKey$$[2] = $a$$123_sKey$$[2].trim(), $c$$51_i$$421_subId$$66$$ = 
      $a$$123_sKey$$[2].charAt(0), $c$$51_i$$421_subId$$66$$ = $a$$123_sKey$$[2].indexOf($c$$51_i$$421_subId$$66$$, 1), 0 <= $c$$51_i$$421_subId$$66$$)))) {
        $a$$123_sKey$$ = $a$$123_sKey$$[2].substring(1, $c$$51_i$$421_subId$$66$$).trim();
        try {
          $node$$160$$ = this.$_getNode$($locator$$62_sNode$$);
        } catch ($e$$132$$) {
          $node$$160$$ = null;
        }
        if ($a$$123_sKey$$ && $node$$160$$ && -1 !== $node$$160$$) {
          switch($a$$123_sKey$$) {
            case "icon":
      ...
      var $node$$161_type$$103$$ = $elem$$79$$ ? this.$_getNode$($elem$$79$$) : null, $parent$$49_parentType$$, $subid$$ = null;
      $node$$161_type$$103$$ && -1 != $node$$161_type$$103$$ && $node$$161_type$$103$$.length && $node$$161_type$$103$$.hasClass("oj-tree-node") && $elem$$79$$.tagName && $elem$$79$$.parentNode && ($node$$161_type$$103$$ = $elem$$79$$.tagName, $parent$$49_parentType$$ = $elem$$79$$.parentNode, $parent$$49_parentType$$ = $parent$$49_parentType$$.tagName, "SPAN" === $node$$161_type$$103$$ ? $subid$$ = "title" : "A" === $node$$161_type$$103$$ ? $subid$$ = "link" : "INS" === $node$$161_type$$103$$ && 
