...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojinputtext", "ojs/ojvalidation", "ojs/ojpopup", "ojs/ojbutton"], function($oj$$13$$, $$$$13$$) {
  ...
  stepMonths:"numberOfMonths", stepBigMonths:12, weekDisplay:"none", yearRange:"c-10:c+10"}, converter:$oj$$13$$.$Validation$.$converterFactory$($oj$$13$$.$ConverterFactory$.CONVERTER_TYPE_DATETIME).createConverter({day:"2-digit", month:"2-digit", year:"2-digit"}), max:void 0, min:void 0, dayFormatter:null}, $_InitBase$:function __InitBase() {
    ...
    if (this.$_isInLine$) {
      ...
      this.$_popUpDpDiv$ = this.$_dpDiv$.ojPopup({initialFocus:"none", modality:"modeless", open:function() {
        $self$$87$$.$_dpDiv$.find(".oj-datepicker-calendar").focus();
    ...
    $showOn_triggerCalendar$$.on("click", function() {
      $self$$88$$.$_datepickerShowing$() ? $self$$88$$.hide() : $self$$88$$.show();
      return!1;
    });
    ...
    this.$_dpDiv$.find("[data-handler]").map(function() {
      $$$$13$$(this).bind(this.getAttribute("data-event"), {prev:function($evt$$21$$) {
        ...
        if ("keyup" === $evt$$23$$.type && 13 === $evt$$23$$.keyCode || "click" === $evt$$23$$.type) {
          $self$$89$$.$_gotoToday$(), $evt$$23$$.preventDefault(), $evt$$23$$.stopPropagation();
        }
      }, selectDay:function($evt$$24$$) {
        $self$$89$$.$_selectDay$(+this.getAttribute("data-month"), +this.getAttribute("data-year"), this, $evt$$24$$);
        return!1;
      }, selectMonth:function() {
        $self$$89$$.$_selectMonthYear$(this, "M");
        return!1;
      }, selectYear:function() {
        $self$$89$$.$_selectMonthYear$(this, "Y");
        return!1;
      }, calendarKey:function($evt$$25$$) {
        $self$$89$$.$_doCalendarKeyDown$($evt$$25$$);
    ...
    if (1 < $footerLayoutButtons_footerLayoutDisplay_weekDisplay$$.length) {
      ...
      for ($footerLayoutButtons_footerLayoutDisplay_weekDisplay$$.sort(function($a$$100$$, $b$$62$$) {
        return $a$$100$$.index - $b$$62$$.index;
  ...
  options:{converter:$oj$$13$$.$Validation$.$converterFactory$($oj$$13$$.$ConverterFactory$.CONVERTER_TYPE_DATETIME).createConverter({hour:"2-digit", hour12:!0, minute:"2-digit"}), max:void 0, min:void 0, datePickerComp:null, timePicker:{timeIncrement:"00:30:00:00"}}, $_InitOptions$:function($originalDefaults$$9$$, $constructorOptions$$11$$) {
    ...
    this.$_popUpTimePickerDisplay$ = this.$_timePickerDisplay$.ojPopup({initialFocus:"none", rootAttributes:{"class":"datetimepicker-dropdown"}, chrome:"none", modality:"modeless", open:function() {
      var $selected$$13$$ = $$$$13$$("[aria-selected]", $self$$90$$.$_timePickerDisplay$);
      1 === $selected$$13$$.length && $self$$90$$.$_checkScrollTop$($selected$$13$$.parent(), !0);
      $$$$13$$("ul", $self$$90$$.$_timePickerDisplay$).focus();
    }, beforeClose:function() {
      $self$$90$$.$_timeListBoxScrollTop$ = $$$$13$$("ul", $self$$90$$.$_timePickerDisplay$).scrollTop();
    }});
    ...
    $triggerTime$$.on("click", function() {
      $self$$91$$.$_timepickerShowing$() ? $self$$91$$.hide() : $self$$91$$.show();
    });
    ...
    $timeNode$$.on("click", function($event$$137$$) {
      ...
      $target$$80$$.hasClass("oj-disabled") || void 0 !== $target$$80$$.attr("aria-disabled") || ($self$$92$$.$_processTimeSelection$($event$$137$$), $self$$92$$.hide());
    }).on("keydown", function($event$$138$$) {
      $self$$92$$.$_timeNodeKeyDown$($event$$138$$);
    });
