...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$77$$, $$$$71$$) {
  ...
  $ConveyorBeltCommon$$.prototype.$setup$ = function $$ConveyorBeltCommon$$$$$setup$$($bInit$$1$$) {
    ...
    if ($bInit$$1$$) {
      ...
      this.$_mouseWheelListener$ = function $this$$_mouseWheelListener$$($event$$635$$) {
        $self$$218$$.$_handleMouseWheel$($event$$635$$);
      };
      ...
      this.$_touchStartListener$ = function $this$$_touchStartListener$$($event$$636$$) {
        $self$$218$$.$_handleTouchStart$($event$$636$$);
      };
      ...
      this.$_touchMoveListener$ = function $this$$_touchMoveListener$$($event$$637$$) {
        $self$$218$$.$_handleTouchMove$($event$$637$$);
      };
      ...
      this.$_touchEndListener$ = function $this$$_touchEndListener$$($event$$638$$) {
        $self$$218$$.$_handleTouchEnd$($event$$638$$);
      };
  ...
  $ConveyorBeltCommon$$.$_addBubbleEventListener$ = function $$ConveyorBeltCommon$$$$_addBubbleEventListener$$($node$$170$$, $type$$106$$, $listener$$42$$) {
    $node$$170$$.addEventListener ? $node$$170$$.addEventListener($type$$106$$, $listener$$42$$, !1) : $node$$170$$.attachEvent && $node$$170$$.attachEvent("on" + $type$$106$$, $listener$$42$$);
  };
  $ConveyorBeltCommon$$.$_removeBubbleEventListener$ = function $$ConveyorBeltCommon$$$$_removeBubbleEventListener$$($node$$171$$, $type$$107$$, $listener$$43$$) {
    $node$$171$$.removeEventListener ? $node$$171$$.removeEventListener($type$$107$$, $listener$$43$$, !1) : $node$$171$$.detachEvent && $node$$171$$.detachEvent("on" + $type$$107$$, $listener$$43$$);
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_createInnerContainers$ = function $$ConveyorBeltCommon$$$$$_createInnerContainers$$() {
    var $self$$219$$ = this, $bHoriz$$3_overflowHeight$$ = this.$_isHorizontal$(), $overflowContainer$$ = document.createElement("div");
  ...
  $ConveyorBeltCommon$$.prototype.$_createPrevButton$ = function $$ConveyorBeltCommon$$$$$_createPrevButton$$($buttonId_prevButtonStyle$$1$$, $bHoriz$$4_buttonStyleClass$$, $icon$$14$$) {
    var $self$$220$$ = this, $prevButton$$1$$ = document.createElement("div");
  ...
  $ConveyorBeltCommon$$.prototype.$_createNextButton$ = function $$ConveyorBeltCommon$$$$$_createNextButton$$($buttonId$$1_nextButtonStyle$$1$$, $bHoriz$$5_buttonStyleClass$$1$$, $icon$$15$$) {
    var $self$$221$$ = this, $nextButton$$2$$ = document.createElement("div");
    ...
    if (!this.$_isEmpty$()) {
      ...
      if ($bImmediate$$3$$ || !$scrollFunc$$ || $scroll$$5$$ === this.$_getCurrScroll$()) {
        ...
        $scrollFunc$$.call(this.$_callbackObj$, this.$_overflowContainer$, this.$_convertScrollLogicalToBrowser$($scroll$$5$$), Math.abs(this.$_getCurrScroll$() - $scroll$$5$$) / $ConveyorBeltCommon$$.$_SCROLL_SPEED$, function() {
          $self$$222$$.$_onScrollAnimEnd$($scroll$$5$$);
        });
      }
    }
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_setExternalScrollTimeout$ = function $$ConveyorBeltCommon$$$$$_setExternalScrollTimeout$$() {
    ...
    window.setTimeout(function() {
      $self$$223$$ && ($self$$223$$.$_bExternalScroll$ = !0);
    }, 0);
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_calcStartScroll$ = function $$ConveyorBeltCommon$$$$$_calcStartScroll$$($index$$297$$) {
    return this.$_getSizes$()[$index$$297$$].start;
  };
  $ConveyorBeltCommon$$.prototype.$_calcEndScroll$ = function $$ConveyorBeltCommon$$$$$_calcEndScroll$$($index$$298$$) {
    return this.$_getSizes$()[$index$$298$$].end - this.$_getCurrViewportSize$() + 1;
  };
