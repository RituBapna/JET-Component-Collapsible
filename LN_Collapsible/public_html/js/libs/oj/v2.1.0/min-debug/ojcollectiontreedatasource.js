...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$60$$) {
  ...
  $oj$$60$$.$CollectionNodeSet$.prototype.$_fetchDescendants$ = function $$oj$$60$$$$CollectionNodeSet$$$$_fetchDescendants$$($nodeSet$$22$$) {
    return new Promise(function($resolve$$47$$) {
      function $nextNode$$($index$$256$$) {
        $index$$256$$ < $count$$54$$ ? $nodeSet$$22$$.$FetchChildNodeSet$($index$$256$$, {success:function($childNodeSet$$1$$) {
          null !== $childNodeSet$$1$$ ? $nodeSet$$22$$.$_fetchDescendants$($childNodeSet$$1$$).then(function() {
            $nextNode$$($index$$256$$ + 1);
          }) : $nextNode$$($index$$256$$ + 1);
        }}) : $resolve$$47$$(void 0);
      }
  ...
  $oj$$60$$.$CollectionNodeSet$.prototype.$FetchChildNodeSet$ = function $$oj$$60$$$$CollectionNodeSet$$$$FetchChildNodeSet$$($index$$257$$, $callbacks$$36$$) {
    var $model$$78_parentKey$$7$$ = this.$collection$.at($index$$257$$);
    if (this.$treeDataSource$.$parseMetadata$($model$$78_parentKey$$7$$).leaf) {
      this.$childNodeSet$[$index$$257$$] = null, $callbacks$$36$$.success(null);
    } else {
      var $collection$$36$$ = this.$treeDataSource$.$GetChildCollection$($model$$78_parentKey$$7$$), $model$$78_parentKey$$7$$ = this.$treeDataSource$.$parseMetadata$($model$$78_parentKey$$7$$).key, $self$$183$$ = this;
      this.$treeDataSource$.$FetchCollection$($collection$$36$$, 0, -1, {success:function($nodeSet$$23$$) {
        $self$$183$$.$childNodeSet$[$index$$257$$] = $nodeSet$$23$$;
  ...
  $oj$$60$$.$CollectionNodeSet$.prototype.getData = function $$oj$$60$$$$CollectionNodeSet$$$getData$($index$$258$$) {
    this.$_checkRange$($index$$258$$);
    return this.$collection$.at($index$$258$$).attributes;
  };
  $oj$$60$$.$Object$.$exportPrototypeSymbol$("CollectionNodeSet.prototype.getData", {getData:$oj$$60$$.$CollectionNodeSet$.prototype.getData});
  $oj$$60$$.$CollectionNodeSet$.prototype.$_checkRange$ = function $$oj$$60$$$$CollectionNodeSet$$$$_checkRange$$($index$$259$$) {
    if ($index$$259$$ < this.start || $index$$259$$ > this.start + this.count) {
      throw "Out of range";
    }
  };
  $oj$$60$$.$CollectionNodeSet$.prototype.getMetadata = function $$oj$$60$$$$CollectionNodeSet$$$getMetadata$($index$$260_model$$79_parse$$6$$) {
    this.$_checkRange$($index$$260_model$$79_parse$$6$$);
    var $metadata$$13$$ = {};
    $index$$260_model$$79_parse$$6$$ = this.$collection$.at($index$$260_model$$79_parse$$6$$);
    $index$$260_model$$79_parse$$6$$ = this.$treeDataSource$.$parseMetadata$($index$$260_model$$79_parse$$6$$);
    $metadata$$13$$.key = $index$$260_model$$79_parse$$6$$.key;
    $metadata$$13$$.leaf = $index$$260_model$$79_parse$$6$$.leaf;
    $metadata$$13$$.depth = $index$$260_model$$79_parse$$6$$.depth;
    return $metadata$$13$$;
  };
  ...
  $oj$$60$$.$CollectionNodeSet$.prototype.$getChildNodeSet$ = function $$oj$$60$$$$CollectionNodeSet$$$$getChildNodeSet$$($index$$261$$) {
    this.$_checkRange$($index$$261$$);
    return this.$childNodeSet$[$index$$261$$];
  };
    ...
    if (null === $parent$$35$$) {
      ...
      this.$_getModelForId$(this.$rootCollection$, $parent$$35$$, 0).then(function($collection$$37_parentModel$$) {
        if ($collection$$37_parentModel$$) {
          $collection$$37_parentModel$$ = $self$$184$$.$GetChildCollection$($collection$$37_parentModel$$.$model$);
          try {
            $self$$184$$.$FetchCollection$($collection$$37_parentModel$$, $start$$54$$, $count$$55$$, $callbacks$$38$$, $parent$$35$$);
          } catch ($error$$42$$) {
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$ModelAdded$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$ModelAdded$$($event$$542_model$$81$$, $collection$$38_parents$$5$$, $options$$331$$) {
    var $index$$262$$ = 0;
    $options$$331$$ && $options$$331$$.at && ($index$$262$$ = $options$$331$$.at);
    $collection$$38_parents$$5$$ = this.$_getParentChain$($collection$$38_parents$$5$$);
    $event$$542_model$$81$$ = this.$_createEvent$(this, "insert", $index$$262$$, $collection$$38_parents$$5$$, this.$_putModelInNodeSet$(null != $collection$$38_parents$$5$$ && 0 < $collection$$38_parents$$5$$.length ? $collection$$38_parents$$5$$[$collection$$38_parents$$5$$.length - 1] : null, $event$$542_model$$81$$));
    this.handleEvent("change", $event$$542_model$$81$$);
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$ModelRemoved$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$ModelRemoved$$($event$$543_model$$82$$, $collection$$39$$, $options$$332$$) {
    var $index$$263$$ = 0;
    $options$$332$$ && $options$$332$$.index && ($index$$263$$ = $options$$332$$.index);
    this.$_removeCollectionFromCache$($event$$543_model$$82$$);
    $event$$543_model$$82$$ = this.$_createEvent$(this, "delete", $index$$263$$, this.$_getParentChain$($collection$$39$$), null);
    this.handleEvent("change", $event$$543_model$$82$$);
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$ModelUpdated$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$ModelUpdated$$($event$$544_model$$83$$) {
    var $collectionForModel$$ = this.$_getCollectionForModel$($event$$544_model$$83$$), $index$$264$$ = null, $parents$$6$$ = null;
    $collectionForModel$$ && ($index$$264$$ = $collectionForModel$$.index, $parents$$6$$ = this.$_getParentChain$($collectionForModel$$.$collection$));
    $event$$544_model$$83$$ = this.$_createEvent$(this, "update", $index$$264$$, $parents$$6$$, this.$_putModelInNodeSet$(null != $parents$$6$$ && 0 < $parents$$6$$.length ? $parents$$6$$[$parents$$6$$.length - 1] : null, $event$$544_model$$83$$));
    this.handleEvent("change", $event$$544_model$$83$$);
  };
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_putModelInNodeSet$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_putModelInNodeSet$$($parent$$38$$, $model$$84$$) {
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_createEvent$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_createEvent$$($source$$11$$, $operation$$6$$, $index$$265$$, $parent$$40$$, $data$$162$$) {
    return{source:$source$$11$$, operation:$operation$$6$$, index:$index$$265$$, parent:$parent$$40$$, data:$data$$162$$};
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$FetchCollection$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$FetchCollection$$($collection$$49$$, $start$$55$$, $count$$57$$, $callbacks$$39$$, $parent$$41$$) {
    var $self$$185$$ = this;
    null === $collection$$49$$ && (($collection$$49$$ = this.$__getParentsChildCollectionFromCache$(null)) ? $collection$$49$$ = {$collection$:$collection$$49$$, $cached$:!0} : ($collection$$49$$ = {$collection$:$self$$185$$.$rootCollection$, $cached$:!1}, $self$$185$$.$_setCollectionInCache$(null, this.$rootCollection$)));
    $collection$$49$$ && $self$$185$$.$_fetch$($collection$$49$$, function($coll$$5$$) {
      $callbacks$$39$$.success && $callbacks$$39$$.success($self$$185$$.$_getNodeSet$($coll$$5$$, $parent$$41$$, $start$$55$$, $count$$57$$));
    }, $callbacks$$39$$.error);
  };
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_scanForKey$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_scanForKey$$($collection$$51$$, $key$$165$$) {
    ...
    return new Promise(function($resolve$$48$$) {
      function $checkNext$$($index$$266$$, $collection$$52$$, $key$$166$$) {
        $index$$266$$ < $collection$$52$$.length ? $collection$$52$$.at($index$$266$$, {deferred:!0}).then(function($model$$90$$) {
          if ($model$$90$$) {
            var $parse$$7$$ = $self$$186$$.$parseMetadata$($model$$90$$);
          ...
          $index$$266$$++;
          $checkNext$$($index$$266$$, $collection$$52$$, $key$$166$$);
        }) : $resolve$$48$$(null);
      }
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_getModelForId$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_getModelForId$$($collection$$53$$, $key$$167$$, $depth$$25$$) {
    ...
    return new Promise(function($resolve$$49$$) {
      $self$$187$$.$_scanForKey$($collection$$53$$, $key$$167$$).then(function($model$$91$$) {
        function $getNextCollection$$($index$$267$$, $tds$$) {
          if ($index$$267$$ < $max$$9$$) {
            var $childColl$$1$$ = $tds$$.$GetChildCollection$($collection$$53$$.at($index$$267$$));
            $childColl$$1$$.$collection$ ? $tds$$.$_fetch$($childColl$$1$$, function($fetchColl$$) {
              $tds$$.$_getModelForId$($fetchColl$$, $key$$167$$, $depth$$25$$ + 1).then(function($childModel$$) {
                $childModel$$ ? $resolve$$49$$($childModel$$) : ($index$$267$$++, $getNextCollection$$($index$$267$$, $tds$$));
              });
            }, null) : ($index$$267$$++, $getNextCollection$$($index$$267$$, $tds$$));
          } else {
            $resolve$$49$$(null);
          }
        }
        if ($model$$91$$) {
          $resolve$$49$$({$model$:$model$$91$$, depth:$depth$$25$$});
        } else {
          var $max$$9$$ = $collection$$53$$.length;
          $getNextCollection$$(0, $self$$187$$);
        }
      });
    });
  };
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$fetchDescendants$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$fetchDescendants$$($parent$$43$$, $callbacks$$40$$) {
    ...
    null === $parent$$43$$ ? this.$FetchCollection$(null, 0, -1, {success:function($nodeSet$$25$$) {
      ...
      $collection$$54_parentModel$$2$$ && ($collection$$54_parentModel$$2$$ = $self$$188$$.$GetChildCollection$($collection$$54_parentModel$$2$$.$model$), $self$$188$$.$FetchCollection$($collection$$54_parentModel$$2$$, 0, -1, {success:function($nodeSet$$26$$) {
