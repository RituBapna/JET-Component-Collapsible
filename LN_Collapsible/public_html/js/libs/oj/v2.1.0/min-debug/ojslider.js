...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "jqueryui-amd/draggable", "ojs/ojtouchproxy"], function($oj$$45$$, $$$$41$$) {
  (function() {
    $oj$$45$$.$__registerWidget$("oj.ojSlider", $$$$41$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", version:"1.0.1", widgetEventPrefix:"oj", options:{distance:0, max:100, min:0, orientation:"horizontal", readOnly:!1, disabled:!1, step:1, type:"fromMin", value:0, rawValue:void 0}, $_numPages$:5, $_sliderDisplayValue$:null, $_isRTL$:function() {
    ...
    }, $_getThumbId$:function($index$$208$$) {
      return this.$_getElementId$() + "-thumb" + $index$$208$$;
      ...
      var $normValue$$, $distance$$1$$, $index$$212$$, $that$$14$$ = this, $o$$11$$ = this.options;
      $index$$212$$ = 0;
      ...
      this.$_multipleThumbs$ && this.$_thumbs$.each(function($i$$358$$) {
        ...
        if ($distance$$1$$ > $thisDistance$$ || $distance$$1$$ === $thisDistance$$ && ($i$$358$$ === $that$$14$$.$_lastChangedValueIndex$ || $that$$14$$.$_getMultiValues$($i$$358$$) === $o$$11$$.min)) {
          $distance$$1$$ = $thisDistance$$, this.$_closestThumb$ = $$$$41$$(this), $index$$212$$ = $i$$358$$;
        }
      });
      this.$_thumbIndex$ = $index$$212$$;
      if (this.$_closestThumb$) {
        return this.$_thumbs$.hasClass("ui-state-hover") || this.$_slide$($event$$478$$, $index$$212$$, $normValue$$), this.$_getActiveThumb$().addClass("oj-active").focus(), this.$_range$.addClass("oj-active"), !0;
      }
    ...
    }, $_getOtherThumbValue$:function($index$$213$$) {
      return this.$_getMultiValues$($index$$213$$ ? 0 : 1);
    }, $_getNewThumbValueLimited$:function($index$$214$$, $newVal$$, $otherVal$$) {
      return 2 === this.options.value.length && (0 === $index$$214$$ && $newVal$$ > $otherVal$$ || 1 === $index$$214$$ && $newVal$$ < $otherVal$$) ? $otherVal$$ : $newVal$$;
    }, $_slide$:function($event$$482$$, $index$$215$$, $newVal$$1$$, $rawOnly$$) {
      var $otherVal$$1$$;
      this.$_multipleThumbs$ ? ($otherVal$$1$$ = this.$_getOtherThumbValue$($index$$215$$), $newVal$$1$$ = this.$_getNewThumbValueLimited$($index$$215$$, $newVal$$1$$, $otherVal$$1$$), $newVal$$1$$ !== this.$_getMultiValues$($index$$215$$) && this.$_setMultiValue$($event$$482$$, $index$$215$$, $newVal$$1$$, $rawOnly$$)) : $newVal$$1$$ !== this.$_getSingleValue$() && (this.$_setSingleValue$($event$$482$$, $newVal$$1$$, $rawOnly$$), $rawOnly$$ || this.$_inputtag$ && this.element.val($newVal$$1$$));
    ...
    }, $_change$:function($event$$484$$, $index$$216$$, $rawOnly$$2$$) {
      this.$_multipleThumbs$ ? (this.$_lastChangedValues$ = this.$_getNewValues$($index$$216$$, this.$_newMultiValue$[$index$$216$$]), this.$_SetRawValue$(this.$_lastChangedValues$, $event$$484$$), $rawOnly$$2$$ || this.$_SetValue$(this.$_lastChangedValues$, $event$$484$$)) : (this.$_SetRawValue$(this.$_newValue$, $event$$484$$), $rawOnly$$2$$ || this.$_SetValue$(this.$_newValue$, $event$$484$$));
      this.$_lastChangedValueIndex$ = $index$$216$$;
    }, $_getNewValues$:function($index$$217$$, $newValue$$21$$) {
      var $vals$$, $i$$359$$;
      $vals$$ = this.options.value.slice();
      for ($i$$359$$ = 0;$i$$359$$ < $vals$$.length;$i$$359$$ += 1) {
        $vals$$[$i$$359$$] = this.$_trimAlignValue$($vals$$[$i$$359$$]);
      }
      $index$$217$$ === this.$_thumbIndex$ && ($vals$$[$index$$217$$] = $newValue$$21$$);
      return $vals$$;
    }, $_getSingleValue$:function() {
      return this.$_getValueAligned$();
    }, $_getMultiValues$:function($index$$218$$) {
      return this.$_getValuesAligned$($index$$218$$);
    }, $_setMultiValue$:function($event$$485$$, $index$$219$$, $newValue$$22$$, $rawOnly$$3$$) {
      this.$_newMultiValue$[$index$$219$$] = this.$_trimAlignValue$($newValue$$22$$);
      this.$_change$($event$$485$$, $index$$219$$, $rawOnly$$3$$);
    ...
    }, $_getValuesAligned$:function($index$$220$$) {
      return this.$_trimAlignValue$(this.options.value[$index$$220$$]);
    ...
    }, $_getThumbsValueFrac$:function($index$$221$$) {
      return(this.$_getMultiValues$($index$$221$$) - this.$_valueMin$()) / (this.$_valueMax$() - this.$_valueMin$());
    }, $_updateUI$:function() {
    ...
    }, $_setRangeMultiThumb$:function($val$$57$$, $index$$222$$) {
      ...
      var $curVal_tempVal$$, $newVal$$2$$, $step$$2$$, $index$$223$$ = $$$$41$$($event$$486$$.target).data("oj-slider-thumb-index");
      this.$_thumbIndex$ = $index$$223$$;
      ...
      $curVal_tempVal$$ = this.$_multipleThumbs$ ? $newVal$$2$$ = this.$_getMultiValues$($index$$223$$) : $newVal$$2$$ = this.$_getSingleValue$();
      switch($event$$486$$.keyCode) {
        case $$$$41$$.ui.keyCode.HOME:
      ...
      this.$_slide$($event$$486$$, $index$$223$$, $newVal$$2$$);
    }, keyup:function($event$$487$$) {
      var $index$$224$$ = $$$$41$$($event$$487$$.target).data("oj-slider-thumb-index");
      this.$_thumbIndex$ = $index$$224$$;
      this.$_change$($event$$487$$, $index$$224$$, !1);
      $$$$41$$($event$$487$$.target).removeClass("oj-active");
      this.$_thumbIndex$ = null;
    }}, $_InitOptions$:function($originalDefaults$$13$$, $constructorOptions$$15$$) {
      var $opts$$30$$ = this.options, $self$$161$$ = this;
      ...
      $oj$$45$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"value"}, {$attribute$:"title"}, {$attribute$:"min"}, {$attribute$:"max"}, {$attribute$:"step"}], $constructorOptions$$15$$, this, function($initializedOptions$$1$$) {
        for (var $toParse$$ = ["value", "step", "min", "max"], $i$$362$$ = 0;$i$$362$$ < $toParse$$.length;$i$$362$$++) {
          ...
          null != $value$$268$$ && ("step" === $opt$$20$$ ? $initializedOptions$$1$$[$opt$$20$$] = $self$$161$$.$_parseStep$($value$$268$$) : "min" === $opt$$20$$ || "max" === $opt$$20$$ ? $initializedOptions$$1$$[$opt$$20$$] = $self$$161$$.$_parse$($opt$$20$$, $value$$268$$) : "value" === $opt$$20$$ && (Array.isArray($value$$268$$) ? $initializedOptions$$1$$[$opt$$20$$] = $value$$268$$ : $initializedOptions$$1$$[$opt$$20$$] = $self$$161$$.$_parse$($opt$$20$$, $value$$268$$)));
        }
      });
