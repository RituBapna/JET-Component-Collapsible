...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojpopupcore", "jqueryui-amd/draggable", "jqueryui-amd/mouse"], function($oj$$38$$, $$$$35$$) {
  (function() {
    $oj$$38$$.$__registerWidget$("oj.ojResizable", $$$$35$$.oj.baseComponent, {version:"1.0.0", widgetEventPrefix:"oj", options:{cancel:"input,textarea,button,select,option", distance:1, delay:0, maxHeight:null, maxWidth:null, minHeight:10, minWidth:10, alsoResize:!1, animate:!1, animateDuration:"slow", animateEasing:"swing", containment:!1, ghost:!1, grid:!1, handles:"e,s,se", helper:!1, resize:null, start:null, stop:null}, $_num$:function($value$$259$$) {
    ...
    }, $_hasScroll$:function($el$$10$$, $a$$109$$) {
      if ("hidden" === $$$$35$$($el$$10$$).css("overflow")) {
        return!1;
      }
      var $scroll$$1$$ = $a$$109$$ && "left" === $a$$109$$ ? "scrollLeft" : "scrollTop", $has$$ = !1;
      if (0 < $el$$10$$[$scroll$$1$$]) {
        return!0;
      }
      $el$$10$$[$scroll$$1$$] = 1;
      ...
      var $data$$143_dx$$4$$, $el$$12$$ = this.helper, $props$$17$$ = {}, $dy$$4_smp$$ = this.$originalMousePosition$;
      $data$$143_dx$$4$$ = $event$$433$$.pageX - $dy$$4_smp$$.left || 0;
      ...
      $data$$143_dx$$4$$ = $trigger$$4$$.apply(this, [$event$$433$$, $data$$143_dx$$4$$, $dy$$4_smp$$]);
      this.$_updateVirtualBoundaries$($event$$433$$.shiftKey);
      $event$$433$$.shiftKey && ($data$$143_dx$$4$$ = this.$_updateRatio$($data$$143_dx$$4$$, $event$$433$$));
      $data$$143_dx$$4$$ = this.$_respectSize$($data$$143_dx$$4$$, $event$$433$$);
      ...
      "sw" === $a$$111$$ && ($data$$145$$.left = $cpos$$.left + ($csize$$.width - $data$$145$$.width), $data$$145$$.top = null);
      "nw" === $a$$111$$ && ($data$$145$$.top = $cpos$$.top + ($csize$$.height - $data$$145$$.height), $data$$145$$.left = $cpos$$.left + ($csize$$.width - $data$$145$$.width));
      return $data$$145$$;
    }, $_respectSize$:function($data$$146$$) {
      var $o$$4$$ = this.$_vBoundaries$, $a$$112_ch$$2$$ = this.axis, $ismaxw$$ = this.$_isNumber$($data$$146$$.width) && $o$$4$$.maxWidth && $o$$4$$.maxWidth < $data$$146$$.width, $ismaxh$$ = this.$_isNumber$($data$$146$$.height) && $o$$4$$.maxHeight && $o$$4$$.maxHeight < $data$$146$$.height, $isminw$$ = this.$_isNumber$($data$$146$$.width) && $o$$4$$.minWidth && $o$$4$$.minWidth > $data$$146$$.width, $isminh$$ = this.$_isNumber$($data$$146$$.height) && $o$$4$$.minHeight && $o$$4$$.minHeight > 
      $data$$146$$.height, $dw$$ = this.$originalPosition$.left + this.$originalSize$.width, $dh$$ = this.position.top + this.size.height, $cw$$ = /sw|nw|w/.test($a$$112_ch$$2$$), $a$$112_ch$$2$$ = /nw|ne|n/.test($a$$112_ch$$2$$);
      ...
      $isminh$$ && $a$$112_ch$$2$$ && ($data$$146$$.top = $dh$$ - $o$$4$$.minHeight);
      $ismaxh$$ && $a$$112_ch$$2$$ && ($data$$146$$.top = $dh$$ - $o$$4$$.maxHeight);
    ...
    }, $_alsoresize_resize$:function($event$$444$$, $ui$$23$$) {
    ...
    }, $_containment_resize$:function($event$$445$$, $ui$$24$$) {
  ...
  (function() {
    $oj$$38$$.$__registerWidget$("oj.ojDialog", $$$$35$$.oj.baseComponent, {version:"1.0.0", widgetEventPrefix:"oj", options:{cancelBehavior:"icon", dragAffordance:"title-bar", initialVisibility:"hide", modality:"modal", position:{my:"center", at:"center", of:window, collision:"fit", $using$:function($pos$$9$$) {
      ...
      return this.$_isOpen$;
    }, open:function($event$$447_isRtl$$3_position$$23$$) {
      if (!1 !== this._trigger("beforeOpen", $event$$447_isRtl$$3_position$$23$$)) {
        if (!this.isOpen()) {
          this.$_isOpen$ = !0;
          this.opener = $$$$35$$(this.document[0].activeElement);
          "resizable" === this.options.resizeBehavior && this.$_makeResizable$();
          $event$$447_isRtl$$3_position$$23$$ = "rtl" === this.$_GetReadingDirection$();
          $event$$447_isRtl$$3_position$$23$$ = $oj$$38$$.$PositionUtils$.$normalizeHorizontalAlignment$(this.options.position, $event$$447_isRtl$$3_position$$23$$);
          var $psOptions$$3$$ = {};
          $psOptions$$3$$[$oj$$38$$.$PopupService$.$OPTION$.$POPUP$] = this.$uiDialog$;
          $psOptions$$3$$[$oj$$38$$.$PopupService$.$OPTION$.$LAUNCHER$] = this.opener;
          $psOptions$$3$$[$oj$$38$$.$PopupService$.$OPTION$.$POSITION$] = $event$$447_isRtl$$3_position$$23$$;
    ...
    }, _keepFocus:function($activeElement$$inline_921_event$$448$$) {
      $activeElement$$inline_921_event$$448$$.preventDefault();
      $activeElement$$inline_921_event$$448$$ = this.document[0].activeElement;
      this.$uiDialog$[0] === $activeElement$$inline_921_event$$448$$ || $$$$35$$.contains(this.$uiDialog$[0], $activeElement$$inline_921_event$$448$$) || this.$_focusTabbable$();
      ...
      this._on(this.$uiDialog$, {keyup:function() {
        ...
        if ("none" != this.options.cancelBehavior && !$event$$450$$.isDefaultPrevented() && $event$$450$$.keyCode && $event$$450$$.keyCode === $$$$35$$.ui.keyCode.ESCAPE) {
          ...
          if ($event$$450$$.keyCode === $$$$35$$.ui.keyCode.TAB) {
      ...
      this.$uiDialog$.draggable({$addClasses$:!1, cancel:".oj-dialog-content, .oj-dialog-header-close", handle:".oj-dialog-header", containment:"document", start:function($event$$458$$, $ui$$26$$) {
        $$$$35$$(this).addClass("oj-dialog-dragging");
        $that$$9$$.$_blockFrames$();
        $that$$9$$.$_positionDescendents$();
        $that$$9$$._trigger("dragStart", $event$$458$$, $filteredUi$$($ui$$26$$));
      }, drag:function($event$$459$$, $ui$$27$$) {
        $that$$9$$.$_positionDescendents$();
        $that$$9$$._trigger("drag", $event$$459$$, $filteredUi$$($ui$$27$$));
      }, stop:function($event$$460$$, $ui$$28$$) {
        ...
        $that$$9$$.$_positionDescendents$();
        $that$$9$$._trigger("dragStop", $event$$460$$, $filteredUi$$($ui$$28$$));
      }});
      ...
      this.$_resizableComponent$({cancel:".oj-dialog-content", containment:"document", handles:"n,e,s,w,se,sw,ne,nw", start:function($event$$461$$, $ui$$30$$) {
        $that$$10$$.$_isResizing$ = !0;
        $$$$35$$(this).addClass("oj-dialog-resizing");
        $that$$10$$.$_blockFrames$();
        $that$$10$$._trigger("resizeStart", $event$$461$$, $filteredUi$$1$$($ui$$30$$));
      }, resize:function($event$$462$$, $ui$$31$$) {
        $that$$10$$._trigger("resize", $event$$462$$, $filteredUi$$1$$($ui$$31$$));
      }, stop:function($event$$463$$, $ui$$32$$) {
        $that$$10$$.$_isResizing$ = !1;
        $$$$35$$(this).removeClass("oj-dialog-resizing");
        $that$$10$$.$_unblockFrames$();
        $that$$10$$._trigger("resizeStop", $event$$463$$, $filteredUi$$1$$($ui$$32$$));
      }});
    }, $_position$:function() {
