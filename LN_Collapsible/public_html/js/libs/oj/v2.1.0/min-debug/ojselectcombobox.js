...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$12$$, $$$$12$$) {
  var $_ComboUtils$$ = {$GENERATED_OPTIONS_SELECTOR$:"oj-select-options-generated", $KEY$:{TAB:9, ENTER:13, $ESC$:27, SPACE:32, LEFT:37, UP:38, RIGHT:39, DOWN:40, $SHIFT$:16, $CTRL$:17, $ALT$:18, PAGE_UP:33, PAGE_DOWN:34, HOME:36, END:35, $BACKSPACE$:8, $DELETE$:46, $isControl$:function($e$$51$$) {
    ...
    return function($query$$7$$) {
      ...
      $options$$224$$($context$$53$$).then(function($data$$77$$) {
    ...
    var $self$$71$$ = this;
    return function() {
      $func$$8$$.apply($self$$71$$, arguments);
    };
    ...
    $search$$1$$.on("focus", function() {
      ...
      "oj-select" !== $className$$6$$ && $self$$72$$.$container$.addClass("oj-focus");
    });
    $search$$1$$.on("blur", function() {
      $search$$1$$.removeClass($className$$6$$ + "-focused");
      "oj-select" !== $className$$6$$ && $self$$72$$.$container$.removeClass("oj-focus");
    });
    ...
    !$$$$12$$($event$$109$$.target).closest($dropdown_self$$73$$).length && !$$$$12$$($event$$109$$.target).closest("#" + $dropdown_self$$73$$.attr("data-oj-containerid")).length && 0 < $dropdown_self$$73$$.length && ($dropdown_self$$73$$ = $dropdown_self$$73$$.data("ojlistbox"), $dropdown_self$$73$$.close($event$$109$$));
    ...
    $opts$$12$$ = $$$$12$$.extend({}, {$populateResults$:function($container$$8$$, $results$$1$$, $query$$9$$, $showPlaceholder$$) {
      ...
      $populate$$2$$ = function $$populate$$2$$$($resultsParent$$, $results$$2$$, $container$$9$$, $depth$$7$$, $l$$6_showPlaceholder$$1$$) {
        ...
        $placeholder_result$$30$$ = $self$$74$$.$_getPlaceholder$();
        $l$$6_showPlaceholder$$1$$ && null !== $placeholder_result$$30$$ && !$query$$9$$.$term$ && 0 >= $container$$9$$.find(".oj-listbox-placeholder").length && ("select" !== $tagName$$2$$ || !$self$$74$$.$ojContext$.$_IsRequired$()) && ($placeholder_result$$30$$ = {value:"", label:$placeholder_result$$30$$}, $node$$37$$ = $$$$12$$("\x3cli\x3e\x3c/li\x3e"), $node$$37$$.addClass("oj-listbox-placeholder oj-listbox-results-depth-0 oj-listbox-result oj-listbox-result-selectable"), $node$$37$$.attr("role", 
        "presentation"), $label$$8_selectable$$ = $$$$12$$(document.createElement("div")), $label$$8_selectable$$.addClass("oj-listbox-result-label"), $label$$8_selectable$$.attr("id", "oj-listbox-result-label-" + $_ComboUtils$$.$nextUid$()), $label$$8_selectable$$.attr("role", "option"), $formatted$$ = $opts$$12$$.$formatResult$($placeholder_result$$30$$), void 0 !== $formatted$$ && $label$$8_selectable$$.text($formatted$$), $node$$37$$.append($label$$8_selectable$$), $node$$37$$.data($self$$74$$.$_elemNm$, 
        $placeholder_result$$30$$), $container$$9$$.prepend($node$$37$$));
        $i$$147$$ = 0;
        for ($l$$6_showPlaceholder$$1$$ = $results$$2$$.length;$i$$147$$ < $l$$6_showPlaceholder$$1$$;$i$$147$$ += 1) {
          ...
          "true"), $isList$$ || ($createLabelContent$$($label$$8_selectable$$, $placeholder_result$$30$$), $node$$37$$.append($label$$8_selectable$$)), $placeholder_result$$30$$.children && 0 < $placeholder_result$$30$$.children.length && $processChildren$$($node$$37$$, $placeholder_result$$30$$), $node$$37$$.data($self$$74$$.$_elemNm$, $placeholder_result$$30$$), $isList$$ ? ($$$$12$$($placeholder_result$$30$$.element[0]).contents().filter(function() {
    ...
    $datalist$$ ? $opts$$12$$.$query$ = this.$_bind$(function($query$$10$$) {
      ...
      $process$$ = function $$process$$$($element$$74$$, $collection$$30$$) {
        ...
        if ($element$$74$$.is("option") || $element$$74$$.is("li") && !$nestedLi$$) {
          $query$$10$$.$matcher$($term$$1$$, $element$$74$$.text(), $element$$74$$) && $collection$$30$$.push($self$$74$$.$_optionToData$($element$$74$$));
        } else {
          if ($element$$74$$.is("optgroup") || $element$$74$$.is("li") && $nestedLi$$) {
            $group$$1$$ = $self$$74$$.$_optionToData$($element$$74$$), $_ComboUtils$$.$each2$($element$$74$$.is("optgroup") ? $element$$74$$.children() : $element$$74$$.children("ul").children(), function($i$$149$$, $elm$$1$$) {
    ...
    var $self$$75$$ = this, $term$$2$$ = this.search.val(), $lastTerm$$ = $$$$12$$.data(this.$container$, this.$_classNm$ + "-last-term");
    if (!0 === $initial$$ || !$lastTerm$$ || $term$$2$$ !== $lastTerm$$) {
      if ($lastTerm$$ || $term$$2$$ || !$initial$$ || "input" !== $initial$$.type) {
        $$$$12$$.data(this.$container$, this.$_classNm$ + "-last-term", $term$$2$$), $term$$2$$.length >= (this.$opts$.minLength || 0) ? (clearTimeout(this.$queryTimer$), $initial$$ && !0 !== $initial$$ ? this.$queryTimer$ = setTimeout(function() {
          $self$$75$$.$_queryResults$($initial$$);
        }, $_ComboUtils$$.$DEFAULT_QUERY_DELAY$) : this.$_queryResults$($initial$$)) : this.close();
      }
    }
  }, $_queryResults$:function($initial$$1$$) {
    function $postRender$$() {
      $self$$76$$.$_positionDropdown$();
      if ($self$$76$$.header && $self$$76$$.$headerItems$.length) {
        var $highlightableChoices_highlightableOptions$$ = $self$$76$$.$_findHighlightableChoices$(), $totalOptions$$ = $self$$76$$.$headerItems$.length + $highlightableChoices_highlightableOptions$$.length;
        $self$$76$$.$headerItems$.attr("aria-setsize", $totalOptions$$);
        $highlightableChoices_highlightableOptions$$.length && ($highlightableChoices_highlightableOptions$$ = $highlightableChoices_highlightableOptions$$.children("[role\x3d'option']"), $highlightableChoices_highlightableOptions$$.attr("aria-setsize", $totalOptions$$), $highlightableChoices_highlightableOptions$$.first().attr("aria-posinset", $self$$76$$.$headerItems$.length + 1));
      }
    }
    var $search$$3$$ = this.search, $results$$4$$ = this.$results$, $opts$$13$$ = this.$opts$, $self$$76$$ = this, $input$$2_term$$3$$;
    ...
    page:this.$resultsPage$, context:null, $matcher$:$opts$$13$$.$matcher$, $callback$:this.$_bind$(function($data$$82_li$$1$$) {
      $queryNumber$$ === this.$queryCount$ && this.$_opened$() && (this.context = $data$$82_li$$1$$ && void 0 !== $data$$82_li$$1$$.context ? $data$$82_li$$1$$.context : null, $data$$82_li$$1$$ && 0 !== $data$$82_li$$1$$.$results$.length || !$_ComboUtils$$.$checkFormatter$($self$$76$$.$ojContext$, $opts$$13$$.$formatNoMatches$, "formatNoMatches") ? ($_ComboUtils$$.$saveLastQueryResult$(this, $data$$82_li$$1$$.$results$), this.$_showDropDown$(), this.$_preprocessResults$($results$$4$$), $self$$76$$.$opts$.$populateResults$.call(this, 
      $results$$4$$, $data$$82_li$$1$$.$results$, {$term$:$search$$3$$.val(), page:this.$resultsPage$, context:null, $initial$:$initial$$1$$}, this.$_showPlaceholder$()), this.$_postprocessResults$($data$$82_li$$1$$, $initial$$1$$), $postRender$$()) : "oj-select" === this.$_classNm$ && !0 !== this.$opts$.multiple || this.header ? ($data$$82_li$$1$$ = $$$$12$$("\x3cli\x3e"), $data$$82_li$$1$$.addClass("oj-listbox-no-results"), $data$$82_li$$1$$.text($opts$$13$$.$formatNoMatches$($self$$76$$.$ojContext$, 
    ...
    var $attrs$$inline_704_style$$inline_703_width$$15$$;
    a: {
      var $attr$$inline_708_matches$$inline_705$$, $i$$inline_706$$, $l$$inline_707$$;
      $attrs$$inline_704_style$$inline_703_width$$15$$ = this.$opts$.element.attr("style");
      if (void 0 !== $attrs$$inline_704_style$$inline_703_width$$15$$) {
        for ($attrs$$inline_704_style$$inline_703_width$$15$$ = $attrs$$inline_704_style$$inline_703_width$$15$$.split(";"), $i$$inline_706$$ = 0, $l$$inline_707$$ = $attrs$$inline_704_style$$inline_703_width$$15$$.length;$i$$inline_706$$ < $l$$inline_707$$;$i$$inline_706$$ += 1) {
          if ($attr$$inline_708_matches$$inline_705$$ = $attrs$$inline_704_style$$inline_703_width$$15$$[$i$$inline_706$$].replace(/\s/g, ""), $attr$$inline_708_matches$$inline_705$$ = $attr$$inline_708_matches$$inline_705$$.match(/^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i), null !== $attr$$inline_708_matches$$inline_705$$ && 1 <= $attr$$inline_708_matches$$inline_705$$.length) {
            $attrs$$inline_704_style$$inline_703_width$$15$$ = $attr$$inline_708_matches$$inline_705$$[1];
            break a;
          }
        }
      }
      $attrs$$inline_704_style$$inline_703_width$$15$$ = void 0;
    }
    null !== $attrs$$inline_704_style$$inline_703_width$$15$$ && this.$container$.css("width", $attrs$$inline_704_style$$inline_703_width$$15$$);
  }, $getVal$:function() {
    return this.$ojContext$.option("value");
  }, $setVal$:function($val$$29$$, $event$$114$$, $context$$57$$) {
        ...
        if (void 0 !== this.search.val() && 0 >= this.$results$.find(".oj-hover").length) {
          if (this.$opts$.manageNewEntry) {
            ...
            if (!$data$$85_selectionData$$ && "" !== this.search.val() || $data$$85_selectionData$$ && ($data$$85_selectionData$$.label !== this.search.val() || !this.$ojContext$.isValid())) {
              $data$$85_selectionData$$ = this.$opts$.manageNewEntry(this.search.val()), this.$_onSelect$($data$$85_selectionData$$, {trigger:"blur" === $e$$69_formatted$$1$$.type ? $_ComboUtils$$.$ValueChangeTriggerTypes$.$BLUR$ : $_ComboUtils$$.$ValueChangeTriggerTypes$.$ENTER_PRESSED$}, $e$$69_formatted$$1$$);
            }
          } else {
            null == this.$opts$.manageNewEntry && (($data$$85_selectionData$$ = this.selection.data(this.$_elemNm$), "" == this.search.val()) ? this.$_clear$($e$$69_formatted$$1$$) : $data$$85_selectionData$$ || "" === this.search.val() ? "oj-select" !== this.$_classNm$ && ($e$$69_formatted$$1$$ = this.$opts$.$formatSelection$($data$$85_selectionData$$), void 0 !== $e$$69_formatted$$1$$ && this.search.val($e$$69_formatted$$1$$)) : this.$_clearSearch$());
          }
        }
    ...
    var $opts$$14$$ = $_AbstractSingleChoice$$.$superclass$.$_prepareOpts$.apply(this, arguments), $self$$78$$ = this, $tagName$$3$$ = $opts$$14$$.element.get(0).tagName.toLowerCase();
    if ("input" === $tagName$$3$$ && $opts$$14$$.element.attr("list") || "select" === $tagName$$3$$ && 0 < $opts$$14$$.element.children().length || $opts$$14$$.list) {
      ...
      $opts$$14$$.$initSelection$ = function $$opts$$14$$$$initSelection$$($element$$76$$, $callback$$85$$) {
        var $selected$$1$$, $value$$184$$ = $self$$78$$.$getVal$();
        Array.isArray($value$$184$$) && ($value$$184$$ = $value$$184$$[0]);
        void 0 !== $value$$184$$ && null !== $value$$184$$ && ($selected$$1$$ = $self$$78$$.$_optionToData$($element$$76$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
        ...
        })), "select" === $tagName$$3$$ && void 0 === $selected$$1$$ && ($value$$184$$ = null));
        if (void 0 === $value$$184$$ || null === $value$$184$$) {
          $selected$$1$$ = $self$$78$$.$_optionToData$($element$$76$$.find($eleName$$).filter(function() {
            if ("li" == $eleName$$) {
      ...
      $opts$$14$$.validate = function $$opts$$14$$$validate$($element$$77$$, $value$$185$$) {
        var $selected$$2$$;
        void 0 !== $value$$185$$ && null !== $value$$185$$ && ($selected$$2$$ = $self$$78$$.$_optionToData$($element$$77$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
      ...
      if ("options" in $opts$$14$$ || this.$getVal$() && 0 < this.$getVal$().length) {
        $$$$12$$.isFunction($opts$$14$$.options) ? $opts$$14$$.$initSelection$ = function $$opts$$14$$$$initSelection$$($element$$78$$, $callback$$86$$) {
          ...
          var $id$$17$$ = "";
          $self$$78$$.$getVal$() && $self$$78$$.$getVal$().length && ($id$$17$$ = $self$$78$$.$getVal$()[0]);
          var $match$$17$$ = null;
          if ($id$$17$$) {
            var $currentItem$$2_queryResult$$3$$ = $_ComboUtils$$.$getLastQueryResult$($self$$78$$);
            $currentItem$$2_queryResult$$3$$ && ($match$$17$$ = $findOption$$($currentItem$$2_queryResult$$3$$, $id$$17$$));
            $match$$17$$ || ($currentItem$$2_queryResult$$3$$ = $self$$78$$.currentItem) && $currentItem$$2_queryResult$$3$$.length && $id$$17$$ === $opts$$14$$.id($currentItem$$2_queryResult$$3$$[0]) && ($match$$17$$ = $currentItem$$2_queryResult$$3$$[0]);
            $match$$17$$ || $self$$78$$.$valueChangeTrigger$ ? $callback$$86$$($match$$17$$) : $opts$$14$$.$query$({value:[$id$$17$$], $callback$:$$$$12$$.isFunction($callback$$86$$) ? function($queryResult$$4$$) {
          ...
          var $id$$18$$ = "";
          $self$$78$$.$getVal$() && $self$$78$$.$getVal$().length && ($id$$18$$ = $self$$78$$.$getVal$()[0]);
          var $first$$4$$ = "select" == $tagName$$3$$ && $self$$78$$.$ojContext$.$_HasPlaceholderSet$() && !$self$$78$$.$ojContext$.$_IsRequired$() ? $self$$78$$.$_getPlaceholder$() : null, $match$$18$$ = null;
    ...
    $_ComboUtils$$.$each2$($data$$86_highlightableChoices$$1$$, function($i$$155$$, $elm$$3$$) {
      if ($self$$79$$.$getVal$() && $self$$79$$.$getVal$()[0] === $self$$79$$.id($elm$$3$$.data($self$$79$$.$_elemNm$))) {
    ...
    if (this.$_triggerSelect$($data$$87$$)) {
      ...
      this.$setVal$(0 === this.id($data$$87$$).length ? [] : this.id($data$$87$$), $event$$116$$, $context$$58$$);
      this.$_focusSearch$();
    }
  }, $_clearSearch$:function() {
    this.search.val("");
  ...
  }, $setVal$:function($val$$31$$, $event$$121$$, $context$$59$$) {
    $_OjSingleSelect$$.$superclass$.$setVal$.call(this, $val$$31$$, $event$$121$$, $context$$59$$);
    ...
    var $opts$$15$$ = $_AbstractMultiChoice$$.$superclass$.$_prepareOpts$.apply(this, arguments), $self$$82$$ = this, $tagName$$4$$ = $opts$$15$$.element.get(0).tagName.toLowerCase();
    if ("input" === $tagName$$4$$ && $opts$$15$$.element.attr("list") || "select" === $tagName$$4$$ && 0 < $opts$$15$$.element.children().length || $opts$$15$$.list) {
      ...
      $opts$$15$$.$initSelection$ = function $$opts$$15$$$$initSelection$$($element$$81$$, $callback$$88$$) {
        var $data$$91$$ = [];
        if ($self$$82$$.$getVal$()) {
          for (var $selected$$6$$, $ids$$ = $self$$82$$.$getVal$(), $i$$156$$ = 0;$i$$156$$ < $ids$$.length;$i$$156$$++) {
            var $id$$20$$ = $ids$$[$i$$156$$];
            ...
            })) && $selected$$6$$.length ? $data$$91$$.push($self$$82$$.$_optionToData$($selected$$6$$)) : $data$$91$$.push({value:$id$$20$$, label:$id$$20$$});
          }
        } else {
          "select" !== $tagName$$4$$ && ($selected$$6$$ = $element$$81$$.find($eleName$$1$$).filter(function() {
            ...
            $data$$91$$.push($self$$82$$.$_optionToData$($elm$$4$$));
          }));
        }
        $callback$$88$$($data$$91$$);
      };
      ...
      "options" in $opts$$15$$ && ($opts$$15$$.$initSelection$ = $$$$12$$.isFunction($opts$$15$$.options) ? function($element$$82$$, $callback$$89$$) {
        function $reorderOptions$$() {
          for (var $ordered$$ = [], $i$$159$$ = 0;$i$$159$$ < $ids$$1$$.length;$i$$159$$++) {
            ...
            if (!$found$$5$$) {
              if (($currentItem$$3_j$$20$$ = $self$$82$$.currentItem) && $currentItem$$3_j$$20$$.length) {
        ...
        var $ids$$1$$ = $self$$82$$.$getVal$(), $matches$$3$$ = [], $queryResult$$5$$ = $_ComboUtils$$.$getLastQueryResult$($self$$82$$);
        $queryResult$$5$$ && ($matches$$3$$ = $findOptions$$($queryResult$$5$$, $ids$$1$$));
        $self$$82$$.$valueChangeTrigger$ ? $reorderOptions$$() : $opts$$15$$.$query$({value:$ids$$1$$, $callback$:function($queryResult$$6_results$$8$$) {
        ...
        var $ids$$2$$ = $self$$82$$.$getVal$(), $matches$$4$$ = [];
    ...
    this.search.on("blur keyup", this.$_bind$(function($e$$78$$) {
      if ("keyup" !== $e$$78$$.type || 10 === $e$$78$$.keyCode || 13 === $e$$78$$.keyCode) {
        if (this.$opts$.manageNewEntry && this.search.val() && 0 >= this.$results$.find(".oj-hover").length) {
          ...
          this.$_onSelect$($data$$92$$, {trigger:"blur" === $e$$78$$.type ? $_ComboUtils$$.$ValueChangeTriggerTypes$.$BLUR$ : $_ComboUtils$$.$ValueChangeTriggerTypes$.$ENTER_PRESSED$}, $e$$78$$);
        }
        this.search.removeClass(this.$_classNm$ + "-focused");
        this.$container$.removeClass("oj-focus");
        this.$_selectChoice$(null);
    ...
    if (this.$datalist$ || null !== this.$getVal$() && this.$getVal$().length) {
      ...
      this.$opts$.$initSelection$.call(null, this.$datalist$ ? this.$datalist$ : this.$opts$.element, function($data$$94$$) {
        void 0 !== $data$$94$$ && null !== $data$$94$$ && 0 !== $data$$94$$.length && ($self$$83$$.$_updateSelection$($data$$94$$), $self$$83$$.close(), $self$$83$$.$_clearSearch$());
      });
    }
  }, $_clearSearch$:function() {
    ...
    if (this.$_triggerSelect$($data$$96$$)) {
      ...
      this.$setVal$($val$$32$$, $event$$125$$, $context$$60$$);
    ...
    var $val$$34$$ = this.$getVal$() && (this.$opts$.element.val() || this.$ojContext$.isValid()) ? this.$getVal$() : [], $choices$$3$$ = this.$results$.find(".oj-listbox-result"), $compound$$ = this.$results$.find(".oj-listbox-result-with-children"), $self$$85$$ = this;
    $_ComboUtils$$.$each2$($choices$$3$$, function($i$$161$$, $choice$$4$$) {
      var $id$$26$$ = $self$$85$$.id($choice$$4$$.data($self$$85$$.$_elemNm$));
  ...
  }, $setVal$:function($options$$231_val$$35$$, $event$$128$$, $context$$61$$) {
    var $unique$$;
    $unique$$ = [];
  ...
  $oj$$12$$.$__registerWidget$("oj.ojSelect", $$$$12$$.oj.editableValue, {defaultElement:"\x3cselect\x3e", widgetEventPrefix:"oj", options:{minimumResultsForSearch:10, placeholder:null, list:void 0, multiple:!1, options:null, optionsKeys:null, beforeExpand:null, renderMode:"jet"}, widget:function() {
    ...
    if (this.$_isNative$() && null != $value$$193$$) {
      ...
      $placeholder$$4$$ && "" === $placeholder$$4$$.attr("value") ? ($placeholder$$4$$.text(this.options.placeholder), $placeholder$$4$$.attr("value", "")) : ($placeholder$$4$$ = $_ComboUtils$$.$createOptionTag$(0, "", $value$$193$$, this.$_formatValue$.bind(this)), $placeholder$$4$$.addClass("oj-listbox-placeholder"), this.$_hidePlaceholder$($placeholder$$4$$, this.$_IsRequired$()), $placeholder$$4$$.prependTo(this.element));
    }
    ...
    return $narr$$;
  }, _setOption:function($key$$61_placeholder$$5$$, $value$$196$$, $flags$$18$$) {
    if ("value" === $key$$61_placeholder$$5$$) {
      if (this.$_HasPlaceholderSet$() && $value$$196$$ && 0 == $value$$196$$.length) {
        this._super($key$$61_placeholder$$5$$, $value$$196$$, $flags$$18$$);
      } else {
        ...
        (0 < $newArr$$.length || this.options.multiple) && this._super($key$$61_placeholder$$5$$, $newArr$$, $flags$$18$$);
      }
    } else {
      "placeholder" === $key$$61_placeholder$$5$$ ? this.select ? (this.select.$opts$.placeholder = $value$$196$$, this.select.$_setPlaceholder$()) : ($element$$87_selected$$10$$ = this.options.value, $element$$87_selected$$10$$ && 0 !== $element$$87_selected$$10$$.length && $element$$87_selected$$10$$[0] || (this.element[0].selectedIndex = 0)) : "minimumResultsForSearch" === $key$$61_placeholder$$5$$ ? this.select && (this.select.$opts$.minimumResultsForSearch = $value$$196$$) : "renderMode" === 
      $key$$61_placeholder$$5$$ && (this.$_cleanup$(), this.options.renderMode = $value$$196$$, this.refresh()), this._super($key$$61_placeholder$$5$$, $value$$196$$, $flags$$18$$), "disabled" === $key$$61_placeholder$$5$$ ? this.select ? $value$$196$$ ? this.select.$_disable$() : this.select.$_enable$() : this.$_nativeSetDisabled$($value$$196$$) : "options" === $key$$61_placeholder$$5$$ ? this.select ? (this.select.$opts$.options = $value$$196$$, this.select.$opts$ = this.select.$_prepareOpts$(this.select.$opts$), 
      this._super("value", this.select.$getVal$())) : this.$_nativeSetOptions$($value$$196$$) : "required" === $key$$61_placeholder$$5$$ && this.$_isNative$() && ($key$$61_placeholder$$5$$ = $$$$12$$(this.element.find(".oj-listbox-placeholder"))) && "" === $key$$61_placeholder$$5$$.attr("value") && this.$_hidePlaceholder$($key$$61_placeholder$$5$$, $value$$196$$);
    }
  }, $_getDropdown$:function() {
    ...
    return null;
  }, $_hidePlaceholder$:function($placeholder$$6$$, $hide$$) {
    $hide$$ ? ($placeholder$$6$$.attr("disabled", ""), $placeholder$$6$$.attr("hidden", "")) : ($placeholder$$6$$.removeAttr("disabled"), $placeholder$$6$$.removeAttr("hidden"));
  }, $_isNative$:function() {
  ...
  var $_OjInputSeachContainer$$ = $_ComboUtils$$.$clazz$($_OjSingleCombobox$$, {$_elemNm$:"ojinputsearch", $_classNm$:"oj-inputsearch", $_createContainer$:function() {
    ...
    $trigger$$3$$.on("click", function($event$$130$$) {
      if ($self$$86$$.$_isInterfaceEnabled$()) {
        if ($self$$86$$.$opts$.manageNewEntry) {
          var $data$$100$$ = $self$$86$$.$opts$.manageNewEntry($self$$86$$.search.val());
          $self$$86$$.$_onSelect$($data$$100$$, {trigger:$_ComboUtils$$.$ValueChangeTriggerTypes$.$SEARCH_ICON_CLICKED$}, $event$$130$$);
        }
        return!1;
      }
