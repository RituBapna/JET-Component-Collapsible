...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$47$$) {
  (function() {
    $oj$$47$$.$__registerWidget$("oj.ojSwitch", $.oj.editableValue, {version:"1.1.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{disabled:!1, readOnly:!1, required:!1, title:"", value:!1}, refresh:function() {
      ...
      var $node$$100$$, $rootElement$$ = this.widget();
      $node$$100$$ = null == $locator$$48_subId$$51$$ || null == $locator$$48_subId$$51$$.subId ? $rootElement$$ : null;
      return $node$$100$$ || ($locator$$48_subId$$51$$ = $locator$$48_subId$$51$$.subId, "oj-switch-thumb" !== $locator$$48_subId$$51$$ && "oj-switch-track" !== $locator$$48_subId$$51$$) ? $node$$100$$ || null : $rootElement$$.find("." + $locator$$48_subId$$51$$)[0];
    }, getSubIdByNode:function($node$$101$$) {
      var $originalId$$ = $(this.element).attr("id"), $nodeId$$1$$, $result$$63$$ = null;
      null != $node$$101$$ && ($($node$$101$$).hasClass("oj-switch-track") || $($node$$101$$).hasClass("oj-switch-thumb")) && ($nodeId$$1$$ = $($node$$101$$).parents("div.oj-switch").find("input.oj-component-initnode").attr("id"), $originalId$$ === $nodeId$$1$$ && $($node$$101$$).hasClass("oj-switch-track") ? $result$$63$$ = {subId:"oj-switch-track"} : $originalId$$ === $nodeId$$1$$ && $($node$$101$$).hasClass("oj-switch-thumb") && ($result$$63$$ = {subId:"oj-switch-thumb"}));
      return $result$$63$$;
      ...
      var $id$$47_switchLabel$$ = $elem$$73$$.prop("id"), $ariaLabelledBy$$ = $elem$$73$$.attr("aria-labelledby"), $ariaLabel$$ = $elem$$73$$.attr("aria-label");
