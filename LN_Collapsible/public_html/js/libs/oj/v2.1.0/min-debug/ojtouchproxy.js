...
define(["ojs/ojcore", "jquery"], function($oj$$22$$, $$$$21$$) {
  ...
  $oj$$22$$.$_TouchProxy$.prototype.$_touchHandler$ = function $$oj$$22$$$$_TouchProxy$$$$_touchHandler$$($event$$344$$, $simulatedType$$) {
    if (!(1 < $event$$344$$.originalEvent.touches.length)) {
      "touchstart" != $event$$344$$.type && "touchend" != $event$$344$$.type && $event$$344$$.preventDefault();
      var $touch$$ = $event$$344$$.originalEvent.changedTouches[0], $simulatedEvent$$ = document.createEvent("MouseEvent");
  ...
  $oj$$22$$.$_TouchProxy$.prototype.$_touchStart$ = function $$oj$$22$$$$_TouchProxy$$$$_touchStart$$($event$$345$$) {
    this.$_touchHandled$ || (this.$_touchHandled$ = !0, this.$_touchMoved$ = !1, this.$_touchHandler$($event$$345$$, "mouseover"), this.$_touchHandler$($event$$345$$, "mousemove"), this.$_touchHandler$($event$$345$$, "mousedown"));
  };
  $oj$$22$$.$_TouchProxy$.prototype.$_touchMove$ = function $$oj$$22$$$$_TouchProxy$$$$_touchMove$$($event$$346$$) {
    this.$_touchHandled$ && (this.$_touchMoved$ = !0, this.$_touchHandler$($event$$346$$, "mousemove"));
  };
  $oj$$22$$.$_TouchProxy$.prototype.$_touchEnd$ = function $$oj$$22$$$$_TouchProxy$$$$_touchEnd$$($event$$347$$) {
    this.$_touchHandled$ && (this.$_touchHandler$($event$$347$$, "mouseup"), this.$_touchHandler$($event$$347$$, "mouseout"), this.$_touchMoved$ || "touchend" != $event$$347$$.type || this.$_touchHandler$($event$$347$$, "click"), this.$_touchHandled$ = !1);
  };
