...
define(["ojs/ojcore", "jquery", "promise"], function($oj$$1$$, $$$$1$$) {
  ...
  $oj$$1$$.$Model$.prototype.save = function $$oj$$1$$$$Model$$$save$($attributes$$5$$, $options$$34$$) {
    ...
    if (!$argResults_forceNew$$ && !this.$isNew$()) {
      return $success$$9$$ = $opts$$3$$.success, $opts$$3$$.success = function $$opts$$3$$$success$($resp$$) {
        ...
        $resp$$ && !$oj$$1$$.$Object$.$isEmpty$($resp$$) ? ($attrs$$4$$ = $$$$1$$.isFunction($self$$3$$.parse) ? $self$$3$$.parse($resp$$) : $resp$$, $self$$3$$.attributes = $$$$1$$.extend(!0, $self$$3$$.attributes, $attrs$$4$$), $self$$3$$.$SetupId$(), $oj$$1$$.$Model$.$_fireSyncEvent$($self$$3$$, $attrs$$4$$, $opts$$3$$), $opts$$3$$.wait && $self$$3$$.set($attrs$$4$$)) : ($oj$$1$$.$Model$.$_fireSyncEvent$($self$$3$$, $resp$$, $opts$$3$$), $opts$$3$$.wait && $self$$3$$.set($attrArgs$$));
    ...
    $opts$$3$$.success = function $$opts$$3$$$success$($resp$$1$$) {
      ...
      if ($resp$$1$$ && !$oj$$1$$.$Object$.$isEmpty$($resp$$1$$)) {
        ...
        $self$$3$$.$SetupId$();
        $oj$$1$$.$Model$.$_fireSyncEvent$($self$$3$$, $attrs$$5$$, $opts$$3$$);
        $opts$$3$$.wait && $self$$3$$.set($attrs$$5$$);
      } else {
        $opts$$3$$.wait && $self$$3$$.set($attrArgs$$), $oj$$1$$.$Model$.$_fireSyncEvent$($self$$3$$, $resp$$1$$, $opts$$3$$);
      }
  ...
  $oj$$1$$.$Collection$.prototype.$_setChangeAt$ = function $$oj$$1$$$$Collection$$$$_setChangeAt$$($start$$6$$, $count$$8$$) {
    for (var $at$$ = $start$$6$$;$at$$ < $start$$6$$ + $count$$8$$;$at$$++) {
      -1 === this.changes.indexOf($at$$) && (this.changes.push($at$$), this.changes.sort(function($a$$90$$, $b$$49$$) {
        return $a$$90$$ - $b$$49$$;
      }));
    }
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_cloneInternal$ = function $$oj$$1$$$$Collection$$$$_cloneInternal$$($i$$41_withProperties$$) {
    ...
    if ($i$$41_withProperties$$) {
      ...
      $indices$$.sort(function($a$$91$$, $b$$50$$) {
        return $a$$91$$ - $b$$50$$;
      });
      var $index$$56$$;
  ...
  $oj$$1$$.$Collection$.prototype.sort = function $$oj$$1$$$$Collection$$$sort$($options$$68$$) {
    ...
    $self$$7$$ = this;
    this.$_getModels$().sort(function($a$$92$$, $b$$51$$) {
      return $oj$$1$$.$Collection$.$SortFunc$($a$$92$$, $b$$51$$, $comparator$$2$$, $self$$7$$, $self$$7$$);
    });
  ...
  $oj$$1$$.$Collection$.$SortFunc$ = function $$oj$$1$$$$Collection$$$SortFunc$$($a$$93$$, $b$$52$$, $attrs$$12_comparator$$3$$, $collection$$13$$, $self$$8$$) {
    var $attrs1_keyA$$, $keyB_retVal$$2$$, $i$$45$$;
    if ($$$$1$$.isFunction($attrs$$12_comparator$$3$$)) {
      if (1 === $attrs$$12_comparator$$3$$.length) {
        $attrs1_keyA$$ = $attrs$$12_comparator$$3$$.call($self$$8$$, $a$$93$$);
      ...
      return $attrs$$12_comparator$$3$$.call($self$$8$$, $a$$93$$, $b$$52$$);
    }
    if ($oj$$1$$.$StringUtils$.$isString$($attrs$$12_comparator$$3$$)) {
      for ($attrs$$12_comparator$$3$$ = $attrs$$12_comparator$$3$$.split(","), $i$$45$$ = 0;$i$$45$$ < $attrs$$12_comparator$$3$$.length;$i$$45$$++) {
        if ($attrs1_keyA$$ = $oj$$1$$.$Collection$.$_getKey$($a$$93$$, $attrs$$12_comparator$$3$$[$i$$45$$]), $keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_getKey$($b$$52$$, $attrs$$12_comparator$$3$$[$i$$45$$]), $keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_compareKeys$($attrs1_keyA$$, $keyB_retVal$$2$$, $collection$$13$$.sortDirection), 0 !== $keyB_retVal$$2$$) {
          return $keyB_retVal$$2$$;
        }
      }
    }
  ...
  $oj$$1$$.$Collection$.prototype.$sortedIndex$ = function $$oj$$1$$$$Collection$$$$sortedIndex$$($model$$23$$, $comparator$$4$$) {
    ...
    $self$$9$$ = this;
    return $oj$$1$$.$Collection$.$_find$(this.$_getModels$(), $model$$23$$, function($a$$94$$, $b$$53$$) {
      var $attrs1$$1_keyA$$1$$, $attrs2$$1_keyB$$1$$;
      if ($$$$1$$.isFunction($comp$$)) {
        if (1 === $comp$$.length) {
          $attrs1$$1_keyA$$1$$ = $comp$$.call($self$$9$$, $a$$94$$);
        ...
        return $comp$$.call($self$$9$$, $a$$94$$, $b$$53$$);
      }
      return $oj$$1$$.$StringUtils$.$isString$($comp$$) ? ($attrs1$$1_keyA$$1$$ = $a$$94$$.get($comp$$), $attrs2$$1_keyB$$1$$ = $b$$53$$.get($comp$$), $oj$$1$$.$Collection$.$_compareKeys$($attrs1$$1_keyA$$1$$, $attrs2$$1_keyB$$1$$, $self$$9$$.sortDirection)) : 0;
    });
  };
  ...
  $oj$$1$$.$Collection$.prototype.$sortBy$ = function $$oj$$1$$$$Collection$$$$sortBy$$($iterator$$2$$, $context$$25$$) {
    ...
    $self$$29$$ = this;
    $retArr$$2$$.sort(function($a$$95$$, $b$$54$$) {
      var $keyA$$3$$, $keyB$$3$$;
      if ($$$$1$$.isFunction($iterator$$2$$)) {
        return $keyA$$3$$ = $iterator$$2$$.call($context$$25$$ || $self$$29$$, $a$$95$$), $keyB$$3$$ = $iterator$$2$$.call($context$$25$$ || $self$$29$$, $b$$54$$), $oj$$1$$.$Collection$.$_compareKeys$($keyA$$3$$, $keyB$$3$$, $self$$29$$.sortDirection);
      }
      $keyA$$3$$ = $a$$95$$.get($iterator$$2$$);
