...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "promise"], function($oj$$72$$, $$$$67$$) {
  ...
  $oj$$72$$.$FilmStripPagingModel$.prototype.setPage = function $$oj$$72$$$$FilmStripPagingModel$$$setPage$($page$$8$$, $options$$373$$) {
    ...
    try {
      ...
      var $pageCount$$1$$ = this.getPageCount(), $self$$212$$ = this;
      return new Promise(function($resolve$$63$$) {
        $prevPageCount$$ != $pageCount$$1$$ && $self$$212$$.handleEvent("pageCount", {pageCount:$pageCount$$1$$, previousPageCount:$prevPageCount$$});
        $bFiredBeforePageEvent$$ && $self$$212$$.handleEvent("page", {page:$page$$8$$, previousPage:$prevPage$$});
        $resolve$$63$$(null);
      });
    } catch ($e$$136$$) {
  ...
  (function() {
    ...
    $oj$$72$$.$__registerWidget$("oj.ojFilmStrip", $$$$67$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{maxItemsPerPage:0, orientation:"horizontal", currentItem:0, arrowPlacement:"adjacent", arrowVisibility:"auto"}, _ComponentCreate:function() {
      ...
      if (!this.$_bHandlingResize$) {
        ...
        if (!this.$_queuedHandleResize$) {
          ...
          this.$_queuedHandleResize$ = setTimeout(function() {
            $self$$214$$.$_queuedHandleResize$ = null;
      ...
      var $elem$$133_label$$16$$ = $_escapeHtml$$(this.$getTranslatedString$("labelAccArrowPreviousPage")), $tooltip$$ = $_escapeHtml$$(this.$getTranslatedString$("tipArrowPreviousPage")), $locationMarker_navArrow$$ = this.$_createNavigationArrow$($container$$31$$, $locationMarker_navArrow$$, $elem$$133_label$$16$$, $tooltip$$), $self$$215$$ = this;
      ...
      var $elem$$134_label$$17$$ = $_escapeHtml$$(this.$getTranslatedString$("labelAccArrowNextPage")), $tooltip$$1$$ = $_escapeHtml$$(this.$getTranslatedString$("tipArrowNextPage")), $locationMarker$$1_navArrow$$1$$ = this.$_createNavigationArrow$($container$$32$$, $locationMarker$$1_navArrow$$1$$, $elem$$134_label$$17$$, $tooltip$$1$$), $self$$216$$ = this;
    ...
    }, $_getItemIndex$:function($item$$122$$) {
      var $itemIndex$$2$$ = -1, $items$$12$$ = this.$_getItems$();
      if ("number" === typeof $item$$122$$) {
        0 <= $item$$122$$ && $item$$122$$ < $items$$12$$.length && ($itemIndex$$2$$ = $item$$122$$);
      } else {
        if ("string" === typeof $item$$122$$ && $oj$$72$$.$DomUtils$.$isValidIdentifier$($item$$122$$)) {
          for (var $i$$460$$ = 0;$i$$460$$ < $items$$12$$.length;$i$$460$$++) {
            var $itemId$$ = $items$$12$$[$i$$460$$].id;
            if ($itemId$$ && 0 < $itemId$$.length && $itemId$$ === $item$$122$$) {
              $itemIndex$$2$$ = $i$$460$$;
              break;
            }
          }
      ...
      return $itemIndex$$2$$;
    }, $_findPage$:function($item$$123$$, $itemsPerPage$$1$$) {
      var $itemIndex$$3$$ = this.$_getItemIndex$($item$$123$$), $pageIndex$$4$$ = -1;
