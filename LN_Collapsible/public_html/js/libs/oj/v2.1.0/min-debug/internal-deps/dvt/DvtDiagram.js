...
D.$DvtDiagramLayoutContext$$.prototype.Init = function $$DvtDiagramLayoutContext$$$$Init$($context$$78$$) {
  ...
  this.$_arLinks$ = [];
  if($context$$78$$) {
    for(var $i$$241$$ = 0;$i$$241$$ < this.$_nodeCount$;$i$$241$$++) {
      var $linkCopy_nodeCopy$$ = new D.$DvtDiagramLayoutContextNode$$($context$$78$$.$_arNodes$[$i$$241$$]);
    ...
    for($i$$241$$ = 0;$i$$241$$ < this.$_linkCount$;$i$$241$$++) {
      $linkCopy_nodeCopy$$ = new D.$DvtDiagramLayoutContextLink$$($context$$78$$.$_arLinks$[$i$$241$$]), this.$_arLinks$.push($linkCopy_nodeCopy$$), this.$_links$[$linkCopy_nodeCopy$$.getId()] = $linkCopy_nodeCopy$$
    }
...
D.$DvtDiagramLayoutContext$$.prototype.$getNodeByIndex$ = function $$DvtDiagramLayoutContext$$$$$getNodeByIndex$$($index$$145$$) {
  return this.$_arNodes$[$index$$145$$]
};
...
D.$DvtDiagramLayoutContext$$.prototype.$getLinkByIndex$ = function $$DvtDiagramLayoutContext$$$$$getLinkByIndex$$($index$$146$$) {
  return this.$_arLinks$[$index$$146$$]
};
...
D.$DvtDiagramLayoutContext$$.prototype.$localToGlobal$ = function $$DvtDiagramLayoutContext$$$$$localToGlobal$$($point$$9$$, $node$$47$$) {
  for(var $containerId$$inline_2830_node$$inline_2828$$ = $node$$47$$, $offset$$inline_2829$$ = new D.$DvtDiagramPoint$$(0, 0);$containerId$$inline_2830_node$$inline_2828$$;) {
    if($offset$$inline_2829$$.x += $containerId$$inline_2830_node$$inline_2828$$.$ContentOffset$.x + $containerId$$inline_2830_node$$inline_2828$$.$getPosition$().x, $offset$$inline_2829$$.y += $containerId$$inline_2830_node$$inline_2828$$.$ContentOffset$.y + $containerId$$inline_2830_node$$inline_2828$$.$getPosition$().y, $containerId$$inline_2830_node$$inline_2828$$ = $containerId$$inline_2830_node$$inline_2828$$.$_containerId$) {
      if(($containerId$$inline_2830_node$$inline_2828$$ = this.$getNodeById$($containerId$$inline_2830_node$$inline_2828$$)) && $containerId$$inline_2830_node$$inline_2828$$.$isDisclosed$()) {
        var $containerPadding$$inline_2831$$ = $containerId$$inline_2830_node$$inline_2828$$.$getContainerPadding$();
        $containerPadding$$inline_2831$$ && ($offset$$inline_2829$$.x += $containerPadding$$inline_2831$$.left, $offset$$inline_2829$$.y += $containerPadding$$inline_2831$$.top)
      }
    }else {
      $containerId$$inline_2830_node$$inline_2828$$ = D.$JSCompiler_alias_NULL$$
    }
  }
  return new D.$DvtDiagramPoint$$($point$$9$$.x + $offset$$inline_2829$$.x, $point$$9$$.y + $offset$$inline_2829$$.y)
};
...
D.$DvtDiagramLayoutContextNode$$.prototype.Init = function $$DvtDiagramLayoutContextNode$$$$Init$($node$$50$$) {
  this.$_id$ = $node$$50$$ ? $node$$50$$.$_id$ : D.$JSCompiler_alias_NULL$$;
  this.$_bounds$ = $node$$50$$ ? $node$$50$$.$_bounds$ : D.$JSCompiler_alias_NULL$$;
  this.$_contentBounds$ = $node$$50$$ ? $node$$50$$.$_contentBounds$ : D.$JSCompiler_alias_NULL$$;
  this.$_position$ = $node$$50$$ ? $node$$50$$.$_position$ : D.$JSCompiler_alias_NULL$$;
  this.$_labelPosition$ = $node$$50$$ ? $node$$50$$.$_labelPosition$ : D.$JSCompiler_alias_NULL$$;
  this.$_labelBounds$ = $node$$50$$ ? $node$$50$$.$_labelBounds$ : D.$JSCompiler_alias_NULL$$;
  this.$_layoutAttrs$ = $node$$50$$ ? $node$$50$$.$_layoutAttrs$ : D.$JSCompiler_alias_NULL$$;
  this.$_bReadOnly$ = $node$$50$$ ? $node$$50$$.$_bReadOnly$ : D.$JSCompiler_alias_FALSE$$;
  this.$_containerId$ = $node$$50$$ ? $node$$50$$.$_containerId$ : D.$JSCompiler_alias_NULL$$;
  this.$_selected$ = $node$$50$$ ? $node$$50$$.$_selected$ : D.$JSCompiler_alias_FALSE$$;
  this.$_labelRotAngle$ = $node$$50$$ ? $node$$50$$.$_labelRotAngle$ : D.$JSCompiler_alias_NULL$$;
  this.$_labelRotPoint$ = $node$$50$$ ? $node$$50$$.$_labelRotPoint$ : D.$JSCompiler_alias_NULL$$;
  this.$_containerPadding$ = $node$$50$$ ? $node$$50$$.$_containerPadding$ : D.$JSCompiler_alias_NULL$$;
  this.$_origBounds$ = $node$$50$$ ? $node$$50$$.$_origBounds$ : D.$JSCompiler_alias_NULL$$;
  this.$_origContentBounds$ = $node$$50$$ ? $node$$50$$.$_origContentBounds$ : D.$JSCompiler_alias_NULL$$;
  this.$_bDisclosed$ = $node$$50$$ ? $node$$50$$.$_bDisclosed$ : D.$JSCompiler_alias_FALSE$$;
  this.$Component$ = $node$$50$$ ? $node$$50$$.$GetDiagram$() : D.$JSCompiler_alias_NULL$$;
  this.$IsRendered$ = D.$JSCompiler_alias_TRUE$$;
...
D.$JSCompiler_StaticMethods__updateParentNodes$$ = function $$JSCompiler_StaticMethods__updateParentNodes$$$($JSCompiler_StaticMethods__updateParentNodes$self$$, $node$$51$$) {
  ...
  $parent$$24$$ && $parent$$24$$.$IsRendered$ && ($parent$$24$$.$IsRendered$ = D.$JSCompiler_alias_FALSE$$, (0,D.$JSCompiler_StaticMethods__updateParentNodes$$)($JSCompiler_StaticMethods__updateParentNodes$self$$, $parent$$24$$))
};
...
D.$JSCompiler_StaticMethods_CreateEmptyLayoutContext$$ = function $$JSCompiler_StaticMethods_CreateEmptyLayoutContext$$$($JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2527$$) {
  var $layoutContext$$ = new D.$DvtDiagramLayoutContext$$, $bR2L$$inline_2524$$ = (0,D.$DvtAgent$isRightToLeft$$)($JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2527$$.$getCtx$());
  $layoutContext$$.$_bLocaleR2L$ = $bR2L$$inline_2524$$;
  $JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2527$$ = new D.$DvtDiagramRectangle$$(0, 0, $JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2527$$.getWidth(), $JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2527$$.getHeight());
  $layoutContext$$.$_componentSize$ = $JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2527$$;
  return $layoutContext$$
};
D.$DvtBaseDiagram$$.prototype.$CreateLayoutContextNode$ = function $$DvtBaseDiagram$$$$$CreateLayoutContextNode$$($node$$24$$, $layout$$1_obj$$inline_2533$$, $bRenderAfter$$) {
  ...
  var $bounds$$inline_2530$$ = D.$DvtDiagramLayoutUtils$$.$convertRectToDiagramRect$($node$$24$$.$getContentBounds$());
  $nc$$.$_contentBounds$ = $bounds$$inline_2530$$;
  $nc$$.$_origContentBounds$ = $bounds$$inline_2530$$;
  $nc$$.$setLayoutAttributes$($node$$24$$.$getLayoutAttributes$($layout$$1_obj$$inline_2533$$));
  ...
  if($node$$24$$.$isDisclosed$() && ($nc$$.$setDisclosed$(D.$JSCompiler_alias_TRUE$$), $layout$$1_obj$$inline_2533$$ = (0,D.$DvtBaseDiagram$getLayoutContainerPadding$$)($node$$24$$.$getContainerPadding$()), $nc$$.$isDisclosed$() && ($nc$$.$_containerPadding$ = $layout$$1_obj$$inline_2533$$))) {
    $nc$$.$_origBounds$ && ($nc$$.$_origBounds$ = new D.$DvtDiagramRectangle$$($nc$$.$_origBounds$.x, $nc$$.$_origBounds$.y, $nc$$.$_origBounds$.w - ($layout$$1_obj$$inline_2533$$.left + $layout$$1_obj$$inline_2533$$.right), $nc$$.$_origBounds$.h - ($layout$$1_obj$$inline_2533$$.top + $layout$$1_obj$$inline_2533$$.bottom))), $nc$$.$_origContentBounds$ && ($nc$$.$_origContentBounds$ = new D.$DvtDiagramRectangle$$($nc$$.$_origContentBounds$.x, $nc$$.$_origContentBounds$.y, $nc$$.$_origContentBounds$.w - 
    ($layout$$1_obj$$inline_2533$$.left + $layout$$1_obj$$inline_2533$$.right), $nc$$.$_origContentBounds$.h - ($layout$$1_obj$$inline_2533$$.top + $layout$$1_obj$$inline_2533$$.bottom)))
  }
...
D.$DvtBaseDiagram$$.prototype.$CreateLayoutContextLink$ = function $$DvtBaseDiagram$$$$$CreateLayoutContextLink$$($link$$, $offset$$inline_2536_offset$$inline_2539_startId$$, $endId$$, $layout$$2$$) {
  var $lc$$ = new D.$DvtDiagramLayoutContextLink$$;
  $lc$$.setId($link$$.getId ? $link$$.getId() : $link$$.getData().getId());
  $lc$$.$setStartId$($offset$$inline_2536_offset$$inline_2539_startId$$ ? $offset$$inline_2536_offset$$inline_2539_startId$$ : $link$$.getData().$getStartId$());
  ...
  $offset$$inline_2536_offset$$inline_2539_startId$$ = $link$$.$getStartConnectorOffset$();
  $lc$$.$_startConnectorOffset$ = $offset$$inline_2536_offset$$inline_2539_startId$$;
  $offset$$inline_2536_offset$$inline_2539_startId$$ = $link$$.$getEndConnectorOffset$();
  $lc$$.$_endConnectorOffset$ = $offset$$inline_2536_offset$$inline_2539_startId$$;
...
D.$DvtBaseDiagram$$.prototype.$ApplyLayoutContext$ = function $$DvtBaseDiagram$$$$$ApplyLayoutContext$$($layoutContext$$1$$, $animator$$2_layoutViewport$$, $bSaveOffset$$) {
  ...
  for(var $containerId_containerNode_lopt_miny_ty$$1$$ = $minx_topContainerPadding_tx$$1$$ = window.Number.MAX_VALUE, $li_ni$$ = 0;$li_ni$$ < $layoutContext$$1$$.$getNodeCount$();$li_ni$$++) {
    var $containerPadding_lc$$1_nc$$1_translatedPos$$ = $layoutContext$$1$$.$getNodeByIndex$($li_ni$$), $i$$231_labelBounds_node$$25_obj$$67$$ = this.$getNodeById$($containerPadding_lc$$1_nc$$1_translatedPos$$.getId()), $controlPoints_labelPos_points$$14_pos$$14$$ = $containerPadding_lc$$1_nc$$1_translatedPos$$.$getPosition$();
    ...
    $i$$231_labelBounds_node$$25_obj$$67$$ = $containerPadding_lc$$1_nc$$1_translatedPos$$.$getLabelBounds$();
    $controlPoints_labelPos_points$$14_pos$$14$$ = $containerPadding_lc$$1_nc$$1_translatedPos$$.$getLabelPosition$();
    $i$$231_labelBounds_node$$25_obj$$67$$ && $controlPoints_labelPos_points$$14_pos$$14$$ && ($minx_topContainerPadding_tx$$1$$ = window.Math.min($minx_topContainerPadding_tx$$1$$, $controlPoints_labelPos_points$$14_pos$$14$$.x + $i$$231_labelBounds_node$$25_obj$$67$$.x), $containerId_containerNode_lopt_miny_ty$$1$$ = window.Math.min($containerId_containerNode_lopt_miny_ty$$1$$, $controlPoints_labelPos_points$$14_pos$$14$$.y + $i$$231_labelBounds_node$$25_obj$$67$$.y))
  }
  for($li_ni$$ = 0;$li_ni$$ < $layoutContext$$1$$.$getLinkCount$();$li_ni$$++) {
    ...
    if($controlPoints_labelPos_points$$14_pos$$14$$ = $containerPadding_lc$$1_nc$$1_translatedPos$$.$getPoints$()) {
      ...
      for($i$$231_labelBounds_node$$25_obj$$67$$ = 0;$i$$231_labelBounds_node$$25_obj$$67$$ < $controlPoints_labelPos_points$$14_pos$$14$$.length;$i$$231_labelBounds_node$$25_obj$$67$$++) {
        var $controlPoint_labelRotAngle_nodeLabelPos$$ = $controlPoints_labelPos_points$$14_pos$$14$$[$i$$231_labelBounds_node$$25_obj$$67$$], $minx_topContainerPadding_tx$$1$$ = window.Math.min($minx_topContainerPadding_tx$$1$$, $controlPoint_labelRotAngle_nodeLabelPos$$.x), $containerId_containerNode_lopt_miny_ty$$1$$ = window.Math.min($containerId_containerNode_lopt_miny_ty$$1$$, $controlPoint_labelRotAngle_nodeLabelPos$$.y)
      }
    }
    $i$$231_labelBounds_node$$25_obj$$67$$ = $containerPadding_lc$$1_nc$$1_translatedPos$$.$getLabelBounds$();
    $controlPoints_labelPos_points$$14_pos$$14$$ = $containerPadding_lc$$1_nc$$1_translatedPos$$.$getLabelPosition$();
  ...
  for($li_ni$$ = 0;$li_ni$$ < $layoutContext$$1$$.$getNodeCount$();$li_ni$$++) {
    ...
    $i$$231_labelBounds_node$$25_obj$$67$$ = this.$getNodeById$($containerPadding_lc$$1_nc$$1_translatedPos$$.getId());
    ($controlPoints_labelPos_points$$14_pos$$14$$ = $containerPadding_lc$$1_nc$$1_translatedPos$$.$getPosition$()) && $i$$231_labelBounds_node$$25_obj$$67$$.$SetPosition$($controlPoints_labelPos_points$$14_pos$$14$$.x + $minx_topContainerPadding_tx$$1$$, $controlPoints_labelPos_points$$14_pos$$14$$.y + $containerId_containerNode_lopt_miny_ty$$1$$, $animator$$2_layoutViewport$$);
    ...
    if($nodeLabelBounds$$ && $controlPoint_labelRotAngle_nodeLabelPos$$) {
      ...
      $animator$$2_layoutViewport$$ ? ((0,D.$JSCompiler_StaticMethods_addProp$$)($animator$$2_layoutViewport$$, "typeRectangle", $i$$231_labelBounds_node$$25_obj$$67$$, $i$$231_labelBounds_node$$25_obj$$67$$.$getLabelBounds$, $i$$231_labelBounds_node$$25_obj$$67$$.$setLabelBounds$, $nodeLabelBounds$$), $i$$231_labelBounds_node$$25_obj$$67$$.$getLabelPosition$() ? (0,D.$JSCompiler_StaticMethods_addProp$$)($animator$$2_layoutViewport$$, "typePoint", $i$$231_labelBounds_node$$25_obj$$67$$, $i$$231_labelBounds_node$$25_obj$$67$$.$getLabelPosition$, 
      $i$$231_labelBounds_node$$25_obj$$67$$.$setLabelPosition$, $controlPoints_labelPos_points$$14_pos$$14$$) : $i$$231_labelBounds_node$$25_obj$$67$$.$setLabelPosition$($controlPoints_labelPos_points$$14_pos$$14$$), $controlPoint_labelRotAngle_nodeLabelPos$$ != D.$JSCompiler_alias_NULL$$ && (0,D.$JSCompiler_StaticMethods_addProp$$)($animator$$2_layoutViewport$$, "typeNumber", $i$$231_labelBounds_node$$25_obj$$67$$, $i$$231_labelBounds_node$$25_obj$$67$$.$getLabelRotationAngle$, $i$$231_labelBounds_node$$25_obj$$67$$.$setLabelRotationAngle$, 
      $controlPoint_labelRotAngle_nodeLabelPos$$), $labelRotPoint$$ && ($i$$231_labelBounds_node$$25_obj$$67$$.$_labelRotPoint$ ? (0,D.$JSCompiler_StaticMethods_addProp$$)($animator$$2_layoutViewport$$, "typePoint", $i$$231_labelBounds_node$$25_obj$$67$$, $i$$231_labelBounds_node$$25_obj$$67$$.$getLabelRotationPoint$, $i$$231_labelBounds_node$$25_obj$$67$$.$setLabelRotationPoint$, $labelRotPoint$$) : $i$$231_labelBounds_node$$25_obj$$67$$.$setLabelRotationPoint$($labelRotPoint$$))) : ($i$$231_labelBounds_node$$25_obj$$67$$.$setLabelBounds$($nodeLabelBounds$$), 
      $i$$231_labelBounds_node$$25_obj$$67$$.$setLabelPosition$($controlPoints_labelPos_points$$14_pos$$14$$), $controlPoint_labelRotAngle_nodeLabelPos$$ != D.$JSCompiler_alias_NULL$$ && $i$$231_labelBounds_node$$25_obj$$67$$.$setLabelRotationAngle$($controlPoint_labelRotAngle_nodeLabelPos$$), $labelRotPoint$$ && $i$$231_labelBounds_node$$25_obj$$67$$.$setLabelRotationPoint$($labelRotPoint$$))
    }
    $i$$231_labelBounds_node$$25_obj$$67$$.$isDisclosed$() && ($containerPadding_lc$$1_nc$$1_translatedPos$$ = $containerPadding_lc$$1_nc$$1_translatedPos$$.$getContainerPadding$()) && $i$$231_labelBounds_node$$25_obj$$67$$.$setContainerPadding$((0,D.$DvtBaseDiagram$getContainerPadding$$)($containerPadding_lc$$1_nc$$1_translatedPos$$), $animator$$2_layoutViewport$$)
  }
  if(!this.$_bCrossedZoomThreshold$) {
    for($li_ni$$ = 0;$li_ni$$ < $layoutContext$$1$$.$getLinkCount$();$li_ni$$++) {
      ...
      if($controlPoints_labelPos_points$$14_pos$$14$$ = $containerPadding_lc$$1_nc$$1_translatedPos$$.$getPoints$()) {
        ...
        for(var $translatedPoints$$ = [], $i$$231_labelBounds_node$$25_obj$$67$$ = 0;$i$$231_labelBounds_node$$25_obj$$67$$ < $controlPoints_labelPos_points$$14_pos$$14$$.length;) {
          (0,window.isNaN)($controlPoints_labelPos_points$$14_pos$$14$$[$i$$231_labelBounds_node$$25_obj$$67$$]) ? ($translatedPoints$$.push($controlPoints_labelPos_points$$14_pos$$14$$[$i$$231_labelBounds_node$$25_obj$$67$$]), $i$$231_labelBounds_node$$25_obj$$67$$++) : ($translatedPoints$$.push($controlPoints_labelPos_points$$14_pos$$14$$[$i$$231_labelBounds_node$$25_obj$$67$$] + $minx_topContainerPadding_tx$$1$$), $translatedPoints$$.push($controlPoints_labelPos_points$$14_pos$$14$$[$i$$231_labelBounds_node$$25_obj$$67$$ + 
          1] + $containerId_containerNode_lopt_miny_ty$$1$$), $i$$231_labelBounds_node$$25_obj$$67$$ += 2)
        }
        $animator$$2_layoutViewport$$ && $link$$1$$.$getPoints$() ? 0 < $translatedPoints$$.length && (0,window.isNaN)($translatedPoints$$[0]) ? ($i$$231_labelBounds_node$$25_obj$$67$$ = D.$DvtShapeAnimationUtils$$.$getAssimilatedPaths$($link$$1$$.$getPoints$(), $translatedPoints$$), $link$$1$$.$setPoints$($i$$231_labelBounds_node$$25_obj$$67$$.$updatedOldPath$), (0,D.$JSCompiler_StaticMethods_addProp$$)($animator$$2_layoutViewport$$, "typePath", $link$$1$$, $link$$1$$.$getPoints$, $link$$1$$.$setPoints$, 
        $i$$231_labelBounds_node$$25_obj$$67$$.$updatedNewPath$), (0,D.$DvtPlayable$appendOnEnd$$)($animator$$2_layoutViewport$$, function() {
      ...
      $i$$231_labelBounds_node$$25_obj$$67$$ = D.$DvtDiagramLayoutUtils$$.$convertDiagramRectToRect$($containerPadding_lc$$1_nc$$1_translatedPos$$.$getLabelBounds$());
      $controlPoints_labelPos_points$$14_pos$$14$$ = $containerPadding_lc$$1_nc$$1_translatedPos$$.$getLabelPosition$();
...
D.$JSCompiler_StaticMethods_CalcViewBounds$$ = function $$JSCompiler_StaticMethods_CalcViewBounds$$$($JSCompiler_StaticMethods_CalcViewBounds$self$$, $animator$$6$$, $arNodeIds$$1_link$$2_linkId_linkParent$$, $arLinkIds$$1$$) {
  var $bounds$$11$$ = D.$JSCompiler_alias_NULL$$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$, $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$, $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, $contentPane$$ = $JSCompiler_StaticMethods_CalcViewBounds$self$$.$_panZoomCanvas$.$_contentPane$;
  ...
  for(var $i$$232$$ = 0;$i$$232$$ < $arNodeIds$$1_link$$2_linkId_linkParent$$.length;$i$$232$$++) {
    if($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$ = $arNodeIds$$1_link$$2_linkId_linkParent$$[$i$$232$$], ($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ = $JSCompiler_StaticMethods_CalcViewBounds$self$$.$getNodeById$($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$)) && $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$_bVisible$ && 
    !$JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$_bHiddenAncestor$) {
      var $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, $animator$$inline_2542_j$$inline_2560$$ = $animator$$6$$;
      $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.$getLayoutBounds$();
      $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = new D.$DvtRectangle$$($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$);
      $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = D.$JSCompiler_alias_NULL$$;
      $animator$$inline_2542_j$$inline_2560$$ && ($bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = (0,D.$JSCompiler_StaticMethods_getDestVal$$)($animator$$inline_2542_j$$inline_2560$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.$getLabelPosition$));
      $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ || ($bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.$getLabelPosition$());
      var $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ = D.$JSCompiler_alias_NULL$$, $labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ = D.$JSCompiler_alias_NULL$$;
      $animator$$inline_2542_j$$inline_2560$$ && ($labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ = (0,D.$JSCompiler_StaticMethods_getDestVal$$)($animator$$inline_2542_j$$inline_2560$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.$getLabelRotationAngle$), $labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ = 
      (0,D.$JSCompiler_StaticMethods_getDestVal$$)($animator$$inline_2542_j$$inline_2560$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.$getLabelRotationPoint$));
      $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ == D.$JSCompiler_alias_NULL$$ && ($labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.$_labelRotAngle$);
      $labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ || ($labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.$_labelRotPoint$);
      $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.$getLabelBounds$();
      $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ && $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$ && ($labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ != D.$JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$ = (0,D.$DvtBaseDiagram$RotateBounds$$)($JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$, 
      $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$, $labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$)), $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$.x = window.Math.min($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.x + $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.x), 
      $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$.y = window.Math.min($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.y + $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.y), $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$.$w$ = 
      window.Math.max($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.x + $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.x + $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.$w$) - 
      $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$.x, $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$.$h$ = window.Math.max($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.y + $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.y + 
      $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$.$h$) - $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$.y);
      $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$ = $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$;
      $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = D.$JSCompiler_alias_NULL$$;
      $animator$$6$$ && ($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = (0,D.$JSCompiler_StaticMethods_getDestVal$$)($animator$$6$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getTranslateX$), $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = 
      (0,D.$JSCompiler_StaticMethods_getDestVal$$)($animator$$6$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getTranslateY$));
      $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ == D.$JSCompiler_alias_NULL$$ && ($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getTranslateX$());
      $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ == D.$JSCompiler_alias_NULL$$ && ($bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getTranslateY$());
      $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x += $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$;
      $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y += $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$;
      if($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.getData().$getGroupId$ ? $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.getData().$_groupId$ : D.$JSCompiler_alias_NULL$$) {
        $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.getParent(), $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ = (0,D.$JSCompiler_StaticMethods_LocalToStage$$)(new D.$DvtPoint$$($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y), 
        $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$, $animator$$6$$), $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ = (0,D.$JSCompiler_StaticMethods_StageToLocal$$)($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, $contentPane$$, $animator$$6$$), $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = 
        (0,D.$JSCompiler_StaticMethods_LocalToStage$$)(new D.$DvtPoint$$($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$), $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$, $animator$$6$$), $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = 
        (0,D.$JSCompiler_StaticMethods_StageToLocal$$)($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$, $contentPane$$, $animator$$6$$), $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.x, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.y, 
        $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$ = $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$.x - $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.x, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$ = $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$.y - $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.y
      }
      $bounds$$11$$ ? ($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ = $bounds$$11$$.x, $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = $bounds$$11$$.y, $bounds$$11$$.x = window.Math.min($bounds$$11$$.x, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x), $bounds$$11$$.y = window.Math.min($bounds$$11$$.y, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y), 
      $bounds$$11$$.$w$ = window.Math.max($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ + $bounds$$11$$.$w$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$) - $bounds$$11$$.x, $bounds$$11$$.$h$ = window.Math.max($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ + $bounds$$11$$.$h$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y + 
      $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$) - $bounds$$11$$.y) : $bounds$$11$$ = $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$
    }
  }
  $arLinkIds$$1$$ || ($arLinkIds$$1$$ = $JSCompiler_StaticMethods_CalcViewBounds$self$$.$GetAllLinks$());
  for($i$$232$$ = 0;$i$$232$$ < $arLinkIds$$1$$.length;$i$$232$$++) {
    if($arNodeIds$$1_link$$2_linkId_linkParent$$ = $arLinkIds$$1$$[$i$$232$$], ($arNodeIds$$1_link$$2_linkId_linkParent$$ = $JSCompiler_StaticMethods_CalcViewBounds$self$$.$getLinkById$($arNodeIds$$1_link$$2_linkId_linkParent$$)) && $arNodeIds$$1_link$$2_linkId_linkParent$$.$_bVisible$) {
      $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ = $arNodeIds$$1_link$$2_linkId_linkParent$$;
      $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = $animator$$6$$;
      $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$ = new D.$DvtRectangle$$(window.Number.MAX_VALUE, window.Number.MAX_VALUE, -window.Number.MAX_VALUE, -window.Number.MAX_VALUE);
      $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = D.$JSCompiler_alias_NULL$$;
      $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ && ($bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = (0,D.$JSCompiler_StaticMethods_getDestVal$$)($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getPoints$));
      $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ || ($bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getPoints$());
      if($bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$) {
        $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = D.$DvtDiagramLinkUtils$$.$GetControlPoints$($bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$);
        for(var $controlPoint$$inline_2555_minY$$inline_2559$$ = D.$JSCompiler_alias_VOID$$, $controlPoint$$inline_2555_minY$$inline_2559$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$ = $labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ = $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ = D.$JSCompiler_alias_VOID$$, $animator$$inline_2542_j$$inline_2560$$ = 0;$animator$$inline_2542_j$$inline_2560$$ < 
        $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.length;$animator$$inline_2542_j$$inline_2560$$++) {
          $controlPoint$$inline_2555_minY$$inline_2559$$ = $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$[$animator$$inline_2542_j$$inline_2560$$], $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ = window.Math.max($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$, $controlPoint$$inline_2555_minY$$inline_2559$$.x), $labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ = 
          window.Math.max($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$, $controlPoint$$inline_2555_minY$$inline_2559$$.y), $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$ = window.Math.min($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x, $controlPoint$$inline_2555_minY$$inline_2559$$.x), $controlPoint$$inline_2555_minY$$inline_2559$$ = 
          window.Math.min($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y, $controlPoint$$inline_2555_minY$$inline_2559$$.y), $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y = $controlPoint$$inline_2555_minY$$inline_2559$$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$ = 
          $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ - $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$ = $labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ - $controlPoint$$inline_2555_minY$$inline_2559$$
        }
      }
      $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$ = new D.$DvtRectangle$$($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$);
      $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ = D.$JSCompiler_alias_NULL$$;
      $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ && ($labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ = (0,D.$JSCompiler_StaticMethods_getDestVal$$)($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getLabelPosition$));
      $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ == D.$JSCompiler_alias_NULL$$ && ($labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getLabelPosition$());
      $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$ = $labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ = D.$JSCompiler_alias_NULL$$;
      $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ && ($labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ = (0,D.$JSCompiler_StaticMethods_getDestVal$$)($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getLabelRotationAngle$), 
      $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$ = (0,D.$JSCompiler_StaticMethods_getDestVal$$)($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getLabelRotationPoint$));
      $labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ == D.$JSCompiler_alias_NULL$$ && ($labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$_labelRotAngle$);
      $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$ || ($JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$_labelRotPoint$);
      $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$getLabelBounds$();
      $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$ && $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ && ($labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$ != D.$JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ = (0,D.$DvtBaseDiagram$RotateBounds$$)($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, 
      $labelRotAngle$$inline_2563_labelRotPoint$$inline_2547_maxY$$inline_2557$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2541_labelBounds$$inline_2548_labelRotPoint$$inline_2564_minX$$inline_2558$$)), $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.x = window.Math.min($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.x + 
      $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$.x), $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.y = window.Math.min($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.y + $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$.y), $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.$w$ = 
      window.Math.max($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.x + $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$.x + $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$w$) - $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.x, 
      $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.$h$ = window.Math.max($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.y + $labelPos$$inline_2562_labelRotAngle$$inline_2546_maxX$$inline_2556$$.y + $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.$h$) - 
      $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$.y);
      $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$ = $bounds$$inline_2561_controlPoints$$inline_2554_labelPos$$inline_2545_points$$inline_2553_ty$$3$$;
      if($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = $arNodeIds$$1_link$$2_linkId_linkParent$$.getData().$getGroupId$ ? $arNodeIds$$1_link$$2_linkId_linkParent$$.getData().$_groupId$ : D.$JSCompiler_alias_NULL$$) {
        $arNodeIds$$1_link$$2_linkId_linkParent$$ = $arNodeIds$$1_link$$2_linkId_linkParent$$.getParent(), $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ = (0,D.$JSCompiler_StaticMethods_LocalToStage$$)(new D.$DvtPoint$$($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y), $arNodeIds$$1_link$$2_linkId_linkParent$$, $animator$$6$$), $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ = 
        (0,D.$JSCompiler_StaticMethods_StageToLocal$$)($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$, $contentPane$$, $animator$$6$$), $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = (0,D.$JSCompiler_StaticMethods_LocalToStage$$)(new D.$DvtPoint$$($dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$, 
        $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$), $arNodeIds$$1_link$$2_linkId_linkParent$$, $animator$$6$$), $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = (0,D.$JSCompiler_StaticMethods_StageToLocal$$)($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$, $contentPane$$, $animator$$6$$), $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x = 
        $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.x, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.y, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$ = $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$.x - $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.x, 
        $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$ = $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$.y - $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$.y
      }
      $bounds$$11$$ ? ($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ = $bounds$$11$$.x, $animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ = $bounds$$11$$.y, $bounds$$11$$.x = window.Math.min($bounds$$11$$.x, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x), $bounds$$11$$.y = window.Math.min($bounds$$11$$.y, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y), 
      $bounds$$11$$.$w$ = window.Math.max($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2550_bx_labelBounds$$inline_2565_localPoint1_node$$27_stagePoint1$$ + $bounds$$11$$.$w$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.x + $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$w$) - $bounds$$11$$.x, $bounds$$11$$.$h$ = window.Math.max($animator$$inline_2551_bounds$$inline_2544_by_groupId_localPoint2_nodeParent_stagePoint2_tx$$3$$ + $bounds$$11$$.$h$, $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.y + 
      $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$.$h$) - $bounds$$11$$.y) : $bounds$$11$$ = $dims$$9_linkBounds$$inline_2552_nodeBounds$$inline_2543_nodeId$$
...
D.$JSCompiler_StaticMethods_StageToLocal$$ = function $$JSCompiler_StaticMethods_StageToLocal$$$($mat$$3_point$$5$$, $displayable$$12$$, $animator$$7$$) {
  for(var $pathToStage$$ = (0,D.$JSCompiler_StaticMethods_getPathToStage$$)($displayable$$12$$), $retPoint$$ = $mat$$3_point$$5$$, $i$$233$$ = $pathToStage$$.length - 1;0 <= $i$$233$$;$i$$233$$--) {
    $displayable$$12$$ = $pathToStage$$[$i$$233$$];
...
D.$JSCompiler_StaticMethods_LocalToStage$$ = function $$JSCompiler_StaticMethods_LocalToStage$$$($mat$$4_point$$6$$, $displayable$$13$$, $animator$$8$$) {
  for(var $pathToStage$$1$$ = (0,D.$JSCompiler_StaticMethods_getPathToStage$$)($displayable$$13$$), $retPoint$$1$$ = $mat$$4_point$$6$$, $i$$234$$ = 0;$i$$234$$ < $pathToStage$$1$$.length;$i$$234$$++) {
    $displayable$$13$$ = $pathToStage$$1$$[$i$$234$$];
...
D.$JSCompiler_StaticMethods_UpdateNodeLayoutContext$$ = function $$JSCompiler_StaticMethods_UpdateNodeLayoutContext$$$($nodeContext$$1$$, $node$$28$$) {
  ...
  var $bounds$$inline_2580$$ = D.$DvtDiagramLayoutUtils$$.$convertRectToDiagramRect$($node$$28$$.$getContentBounds$());
  $nodeContext$$1$$.$_contentBounds$ = $bounds$$inline_2580$$;
  $nodeContext$$1$$.$_origContentBounds$ = $bounds$$inline_2580$$;
  $nodeContext$$1$$.$setLabelBounds$(D.$DvtDiagramLayoutUtils$$.$convertRectToDiagramRect$($node$$28$$.$getLabelBounds$()));
  $nodeContext$$1$$.$IsRendered$ = D.$JSCompiler_alias_TRUE$$
};
...
D.$JSCompiler_prototypeAlias$$.$getFirstNavigableLink$ = function $$JSCompiler_prototypeAlias$$$$getFirstNavigableLink$$($node$$29_nodeBB_nodeCenterX$$, $direction$$17_event$$149$$, $listOfLinks$$) {
  ...
  for(var $i$$235$$ = 0;$i$$235$$ < $listOfLinks$$.length;$i$$235$$++) {
    var $object$$5$$ = $listOfLinks$$[$i$$235$$], $linkBB_linkCenterX$$ = $object$$5$$.$getKeyboardBoundingBox$(), $linkBB_linkCenterX$$ = $linkBB_linkCenterX$$.x + $linkBB_linkCenterX$$.$w$ / 2;
...
D.$JSCompiler_prototypeAlias$$.$getNextNavigableLink$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigableLink$$($i$$inline_2589_index$$142_node$$30$$, $currentLink$$, $bForward$$7_event$$150$$, $listOfLinks$$1$$) {
  if(!$listOfLinks$$1$$) {
    return D.$JSCompiler_alias_NULL$$
  }
  if(!$currentLink$$) {
  ...
  if(!$i$$inline_2589_index$$142_node$$30$$) {
    return $currentLink$$
  }
  for(var $i$$236_i$$inline_2585_link$$inline_2590$$ = 0;$i$$236_i$$inline_2585_link$$inline_2590$$ < $listOfLinks$$1$$.length;$i$$236_i$$inline_2585_link$$inline_2590$$++) {
    var $link$$inline_2586$$ = $listOfLinks$$1$$[$i$$236_i$$inline_2585_link$$inline_2590$$], $JSCompiler_temp_const$$9382_JSCompiler_temp_const$$9405$$ = $link$$inline_2586$$, $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$ = $i$$inline_2589_index$$142_node$$30$$, $endNode$$inline_9886_link$$inline_9884$$ = $link$$inline_2586$$, $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$ = 
    this.$GetVisibleNode$($endNode$$inline_9886_link$$inline_9884$$.$getStartId$ ? $endNode$$inline_9886_link$$inline_9884$$.$getStartId$() : $endNode$$inline_9886_link$$inline_9884$$.getData().$getStartId$()), $endNode$$inline_9886_link$$inline_9884$$ = this.$GetVisibleNode$($endNode$$inline_9886_link$$inline_9884$$.$getEndId$ ? $endNode$$inline_9886_link$$inline_9884$$.$getEndId$() : $endNode$$inline_9886_link$$inline_9884$$.getData().$getEndId$()), $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$ = 
    $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$ == $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$ ? $endNode$$inline_9886_link$$inline_9884$$ : $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$, $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$ = (0,D.$JSCompiler_StaticMethods__getNodeCenter$$)($angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$), 
    $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$ = (0,D.$JSCompiler_StaticMethods__getNodeCenter$$)($endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$), $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$ = window.Math.atan2($endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$.y - 
    $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$.y, $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$.x - $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$.x), $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$ = 0 > $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$ ? 
    $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$ + 2 * window.Math.PI : $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$;
    $JSCompiler_temp_const$$9382_JSCompiler_temp_const$$9405$$.$__angle$ = $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$;
    $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$ = $JSCompiler_temp_const$$9382_JSCompiler_temp_const$$9405$$ = $link$$inline_2586$$;
    $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$ = this.$GetVisibleNode$($endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$.$getStartId$ ? $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$.$getStartId$() : $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$.getData().$getStartId$());
    $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$ = this.$GetVisibleNode$($endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$.$getEndId$ ? $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$.$getEndId$() : $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$.getData().$getEndId$());
    $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$ = (0,D.$JSCompiler_StaticMethods__getNodeCenter$$)($angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$);
    $endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$ = (0,D.$JSCompiler_StaticMethods__getNodeCenter$$)($endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$);
    $JSCompiler_temp_const$$9382_JSCompiler_temp_const$$9405$$.$__distance$ = window.Math.sqrt(window.Math.pow($endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$.x - $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$.x, 2) + window.Math.pow($endNode$$inline_9895_link$$inline_9893_oppositeNode$$inline_9887_p2$$inline_9889_p2$$inline_9897_startNode$$inline_9885$$.y - $angle$$inline_9890_node$$inline_9883_p1$$inline_9888_p1$$inline_9896_startNode$$inline_9894$$.y, 
    2));
    $link$$inline_2586$$.$__direction$ = $i$$inline_2589_index$$142_node$$30$$ == this.$GetVisibleNode$($link$$inline_2586$$.$getEndId$ ? $link$$inline_2586$$.$getEndId$() : $link$$inline_2586$$.getData().$getEndId$()) ? 1 : 0
  }
  $listOfLinks$$1$$.sort(function($i$$inline_2589_index$$142_node$$30$$, $currentLink$$) {
    var $bForward$$7_event$$150$$ = $i$$inline_2589_index$$142_node$$30$$.$__angle$, $listOfLinks$$1$$ = $currentLink$$.$__angle$, $i$$236_i$$inline_2585_link$$inline_2590$$ = -1;
    !(0,D.$DvtBaseDiagramKeyboardHandler$_anglesAreEqualWithinTolerance$$)($bForward$$7_event$$150$$, $listOfLinks$$1$$) && $bForward$$7_event$$150$$ > $listOfLinks$$1$$ ? $i$$236_i$$inline_2585_link$$inline_2590$$ = 1 : (0,D.$DvtBaseDiagramKeyboardHandler$_anglesAreEqualWithinTolerance$$)($bForward$$7_event$$150$$, $listOfLinks$$1$$) && ($i$$inline_2589_index$$142_node$$30$$.$__distance$ > $currentLink$$.$__distance$ ? $i$$236_i$$inline_2585_link$$inline_2590$$ = 1 : $currentLink$$.$__distance$ == 
    $i$$inline_2589_index$$142_node$$30$$.$__distance$ && $i$$inline_2589_index$$142_node$$30$$.$__direction$ > $currentLink$$.$__direction$ ? $i$$236_i$$inline_2585_link$$inline_2590$$ = 1 : $currentLink$$.$__distance$ == $i$$inline_2589_index$$142_node$$30$$.$__distance$ && $i$$inline_2589_index$$142_node$$30$$.$__direction$ == $currentLink$$.$__direction$ && ($i$$236_i$$inline_2585_link$$inline_2590$$ = 0));
    return $i$$236_i$$inline_2585_link$$inline_2590$$
  });
  for($i$$inline_2589_index$$142_node$$30$$ = 0;$i$$inline_2589_index$$142_node$$30$$ < $listOfLinks$$1$$.length;$i$$inline_2589_index$$142_node$$30$$++) {
    $i$$236_i$$inline_2585_link$$inline_2590$$ = $listOfLinks$$1$$[$i$$inline_2589_index$$142_node$$30$$], $i$$236_i$$inline_2585_link$$inline_2590$$.$__angle$ = D.$JSCompiler_alias_VOID$$, $i$$236_i$$inline_2585_link$$inline_2590$$.$__distance$ = D.$JSCompiler_alias_VOID$$, $i$$236_i$$inline_2585_link$$inline_2590$$.$__direction$ = D.$JSCompiler_alias_VOID$$
  }
  $bForward$$7_event$$150$$ = 40 == $bForward$$7_event$$150$$.keyCode ? D.$JSCompiler_alias_TRUE$$ : D.$JSCompiler_alias_FALSE$$;
  for($i$$236_i$$inline_2585_link$$inline_2590$$ = $i$$inline_2589_index$$142_node$$30$$ = 0;$i$$236_i$$inline_2585_link$$inline_2590$$ < $listOfLinks$$1$$.length;$i$$236_i$$inline_2585_link$$inline_2590$$++) {
    if($listOfLinks$$1$$[$i$$236_i$$inline_2585_link$$inline_2590$$] === $currentLink$$) {
      $i$$inline_2589_index$$142_node$$30$$ = $bForward$$7_event$$150$$ ? $i$$236_i$$inline_2585_link$$inline_2590$$ == $listOfLinks$$1$$.length - 1 ? 0 : $i$$236_i$$inline_2585_link$$inline_2590$$ + 1 : 0 == $i$$236_i$$inline_2585_link$$inline_2590$$ ? $listOfLinks$$1$$.length - 1 : $i$$236_i$$inline_2585_link$$inline_2590$$ - 1;
      break
    }
  }
  return $listOfLinks$$1$$[$i$$inline_2589_index$$142_node$$30$$]
};
...
D.$JSCompiler_prototypeAlias$$.$setLabelRotationAngle$ = function $$JSCompiler_prototypeAlias$$$$setLabelRotationAngle$$($angle$$18_mat$$inline_2597$$) {
  this.$_labelRotAngle$ = $angle$$18_mat$$inline_2597$$;
  var $label$$inline_2592$$ = this.$_labelObj$, $pos$$inline_2593$$ = this.$getLabelPosition$();
  this.$getLabelBounds$();
  $label$$inline_2592$$ && ($angle$$18_mat$$inline_2597$$ = (0,D.$DvtBaseDiagramLink$CalcLabelMatrix$$)($pos$$inline_2593$$, $angle$$18_mat$$inline_2597$$, this.$_labelRotPoint$), $label$$inline_2592$$.$setMatrix$($angle$$18_mat$$inline_2597$$))
};
D.$JSCompiler_prototypeAlias$$.$getLabelRotationAngle$ = (0,D.$JSCompiler_get$$)("$_labelRotAngle$");
D.$JSCompiler_prototypeAlias$$.$setLabelRotationPoint$ = function $$JSCompiler_prototypeAlias$$$$setLabelRotationPoint$$($mat$$inline_2604_point$$7$$) {
  this.$_labelRotPoint$ = $mat$$inline_2604_point$$7$$;
  var $label$$inline_2599$$ = this.$_labelObj$, $pos$$inline_2600$$ = this.$getLabelPosition$();
  this.$getLabelBounds$();
  $label$$inline_2599$$ && ($mat$$inline_2604_point$$7$$ = (0,D.$DvtBaseDiagramLink$CalcLabelMatrix$$)($pos$$inline_2600$$, this.$_labelRotAngle$, $mat$$inline_2604_point$$7$$), $label$$inline_2599$$.$setMatrix$($mat$$inline_2604_point$$7$$))
};
...
D.$JSCompiler_prototypeAlias$$.$setLabelPosition$ = function $$JSCompiler_prototypeAlias$$$$setLabelPosition$$($mat$$inline_2611_pos$$15$$) {
  if($mat$$inline_2611_pos$$15$$) {
    this.$_labelPos$ = $mat$$inline_2611_pos$$15$$;
    var $label$$inline_2606$$ = this.$_labelObj$;
    this.$getLabelBounds$();
    $label$$inline_2606$$ && ($mat$$inline_2611_pos$$15$$ = (0,D.$DvtBaseDiagramLink$CalcLabelMatrix$$)($mat$$inline_2611_pos$$15$$, this.$_labelRotAngle$, this.$_labelRotPoint$), $label$$inline_2606$$.$setMatrix$($mat$$inline_2611_pos$$15$$))
  }
};
...
D.$JSCompiler_StaticMethods_CreateFeedbackUnderlay$$ = function $$JSCompiler_StaticMethods_CreateFeedbackUnderlay$$$($JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$, $feedbackUnderlay_strokeColor$$1$$, $connectorType$$inline_2618_connectorType$$inline_2625_strokeAlpha$$1$$, $connectorUnderlay$$inline_2621_strokeWidthOffset$$1$$) {
  $feedbackUnderlay_strokeColor$$1$$ = $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$CreateUnderlay$($feedbackUnderlay_strokeColor$$1$$, $connectorType$$inline_2618_connectorType$$inline_2625_strokeAlpha$$1$$, $connectorUnderlay$$inline_2621_strokeWidthOffset$$1$$);
  $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$_startConnector$ && $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$getStartConnectorType$() && ($connectorType$$inline_2618_connectorType$$inline_2625_strokeAlpha$$1$$ = $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$getStartConnectorType$(), $connectorUnderlay$$inline_2621_strokeWidthOffset$$1$$ = (0,D.$JSCompiler_StaticMethods_CreateConnectorUnderlay$$)($feedbackUnderlay_strokeColor$$1$$, 
  $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$_points$, $connectorType$$inline_2618_connectorType$$inline_2625_strokeAlpha$$1$$, $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$getConnectorTemplate$(D.$DvtDiagramLinkConnectorUtils$$.$START_CONNECTOR$), $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$, 0), $feedbackUnderlay_strokeColor$$1$$.$_underlayStart$ && $feedbackUnderlay_strokeColor$$1$$.removeChild($feedbackUnderlay_strokeColor$$1$$.$_underlayStart$), 
  $feedbackUnderlay_strokeColor$$1$$.$_underlayStart$ = $connectorUnderlay$$inline_2621_strokeWidthOffset$$1$$, $feedbackUnderlay_strokeColor$$1$$.$_underlayStartType$ = $connectorType$$inline_2618_connectorType$$inline_2625_strokeAlpha$$1$$, $feedbackUnderlay_strokeColor$$1$$.$addChild$($feedbackUnderlay_strokeColor$$1$$.$_underlayStart$));
  $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$_endConnector$ && $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$getEndConnectorType$() && ($connectorType$$inline_2618_connectorType$$inline_2625_strokeAlpha$$1$$ = $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$getEndConnectorType$(), $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$ = (0,D.$JSCompiler_StaticMethods_CreateConnectorUnderlay$$)($feedbackUnderlay_strokeColor$$1$$, 
  $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$_points$, $connectorType$$inline_2618_connectorType$$inline_2625_strokeAlpha$$1$$, $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$.$getConnectorTemplate$(D.$DvtDiagramLinkConnectorUtils$$.$END_CONNECTOR$), $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$, 1), $feedbackUnderlay_strokeColor$$1$$.$_underlayEnd$ && $feedbackUnderlay_strokeColor$$1$$.removeChild($feedbackUnderlay_strokeColor$$1$$.$_underlayEnd$), 
  $feedbackUnderlay_strokeColor$$1$$.$_underlayEnd$ = $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2628$$, $feedbackUnderlay_strokeColor$$1$$.$_underlayEndType$ = $connectorType$$inline_2618_connectorType$$inline_2625_strokeAlpha$$1$$, $feedbackUnderlay_strokeColor$$1$$.$addChild$($feedbackUnderlay_strokeColor$$1$$.$_underlayEnd$));
...
D.$JSCompiler_prototypeAlias$$.$setLabelPosition$ = function $$JSCompiler_prototypeAlias$$$$setLabelPosition$$($mat$$inline_2635_pos$$18$$) {
  if($mat$$inline_2635_pos$$18$$) {
    this.$_labelPos$ = $mat$$inline_2635_pos$$18$$;
    var $label$$inline_2630$$ = this.$_labelObj$;
    this.$getLabelBounds$();
    $label$$inline_2630$$ && ($mat$$inline_2635_pos$$18$$ = (0,D.$DvtBaseDiagramNode$CalcLabelMatrix$$)($mat$$inline_2635_pos$$18$$, this.$_labelRotAngle$, this.$_labelRotPoint$), $label$$inline_2630$$.$setMatrix$($mat$$inline_2635_pos$$18$$))
  }
};
D.$JSCompiler_prototypeAlias$$.$getLabelPosition$ = (0,D.$JSCompiler_get$$)("$_labelPos$");
D.$JSCompiler_prototypeAlias$$.$getLabelBounds$ = (0,D.$JSCompiler_returnArg$$)(D.$JSCompiler_alias_NULL$$);
...
D.$JSCompiler_prototypeAlias$$.$setLabelRotationAngle$ = function $$JSCompiler_prototypeAlias$$$$setLabelRotationAngle$$($angle$$19_mat$$inline_2642$$) {
  this.$_labelRotAngle$ = $angle$$19_mat$$inline_2642$$;
  var $label$$inline_2637$$ = this.$_labelObj$, $pos$$inline_2638$$ = this.$getLabelPosition$();
  this.$getLabelBounds$();
  $label$$inline_2637$$ && ($angle$$19_mat$$inline_2642$$ = (0,D.$DvtBaseDiagramNode$CalcLabelMatrix$$)($pos$$inline_2638$$, $angle$$19_mat$$inline_2642$$, this.$_labelRotPoint$), $label$$inline_2637$$.$setMatrix$($angle$$19_mat$$inline_2642$$))
};
D.$JSCompiler_prototypeAlias$$.$getLabelRotationAngle$ = (0,D.$JSCompiler_get$$)("$_labelRotAngle$");
D.$JSCompiler_prototypeAlias$$.$setLabelRotationPoint$ = function $$JSCompiler_prototypeAlias$$$$setLabelRotationPoint$$($mat$$inline_2649_point$$8$$) {
  this.$_labelRotPoint$ = $mat$$inline_2649_point$$8$$;
  var $label$$inline_2644$$ = this.$_labelObj$, $pos$$inline_2645$$ = this.$getLabelPosition$();
  this.$getLabelBounds$();
  $label$$inline_2644$$ && ($mat$$inline_2649_point$$8$$ = (0,D.$DvtBaseDiagramNode$CalcLabelMatrix$$)($pos$$inline_2645$$, this.$_labelRotAngle$, $mat$$inline_2649_point$$8$$), $label$$inline_2644$$.$setMatrix$($mat$$inline_2649_point$$8$$))
};
D.$JSCompiler_prototypeAlias$$.$getLabelRotationPoint$ = (0,D.$JSCompiler_get$$)("$_labelRotPoint$");
...
D.$JSCompiler_prototypeAlias$$.$_onAnimationEnd$ = function $$JSCompiler_prototypeAlias$$$$_onAnimationEnd$$() {
  ...
  this.$_animation$ && (this.$_animation$ = D.$JSCompiler_alias_NULL$$, this.$getEventManager$().$addListeners$(this))
};
...
D.$JSCompiler_prototypeAlias$$.$RenderComponentInternal$ = function $$JSCompiler_prototypeAlias$$$$RenderComponentInternal$$($animator$$15$$) {
  ...
  if(!this.$_bRendered$ && !this.$_isResize$) {
    var $keys$$14_linksData$$inline_2672_nodesData$$inline_2665$$ = this.$getOptions$().nodes;
    if($keys$$14_linksData$$inline_2672_nodesData$$inline_2665$$) {
      for(var $i$$inline_2666_i$$inline_2673$$ = 0;$i$$inline_2666_i$$inline_2673$$ < $keys$$14_linksData$$inline_2672_nodesData$$inline_2665$$.length;$i$$inline_2666_i$$inline_2673$$++) {
        var $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$ = $keys$$14_linksData$$inline_2672_nodesData$$inline_2665$$[$i$$inline_2666_i$$inline_2673$$], $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$ = D.$DvtJSONUtils$$.$merge$($linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$, this.$getOptions$().styleDefaults.nodeDefaults), $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$ = 
        new D.$DvtDiagramNode$$(this.$getCtx$(), this, $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$), $nodeId$$inline_2669_startNode$$inline_2677$$ = $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$.getId();
        $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$.$isHidden$() ? this.$_arNodeIds$.push($nodeId$$inline_2669_startNode$$inline_2677$$) : ($linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$.$render$(this.$_nodesPane$), this.$_arNodeIds$.push($nodeId$$inline_2669_startNode$$inline_2677$$), this.$_nodes$[$nodeId$$inline_2669_startNode$$inline_2677$$] = $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$)
      }
    }
    if($keys$$14_linksData$$inline_2672_nodesData$$inline_2665$$ = this.$getOptions$().links) {
      for($i$$inline_2666_i$$inline_2673$$ = 0;$i$$inline_2666_i$$inline_2673$$ < $keys$$14_linksData$$inline_2672_nodesData$$inline_2665$$.length;$i$$inline_2666_i$$inline_2673$$++) {
        var $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$ = $keys$$14_linksData$$inline_2672_nodesData$$inline_2665$$[$i$$inline_2666_i$$inline_2673$$], $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$ = D.$DvtJSONUtils$$.$merge$($linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$, this.$getOptions$().styleDefaults.linkDefaults), $endNode$$inline_2678_link$$inline_2675$$ = new D.$DvtDiagramLink$$(this.$getCtx$(), 
        this, $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$), $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$ = $endNode$$inline_2678_link$$inline_2675$$.getId();
        $endNode$$inline_2678_link$$inline_2675$$.$isHidden$() ? this.$_arLinkIds$.push($linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$) : ($endNode$$inline_2678_link$$inline_2675$$.$render$(this.$_linksPane$), this.$_arLinkIds$.push($linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$), this.$_links$[$linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$] = $endNode$$inline_2678_link$$inline_2675$$, 
        $nodeId$$inline_2669_startNode$$inline_2677$$ = this.$getNodeById$($endNode$$inline_2678_link$$inline_2675$$.$getStartId$()), $endNode$$inline_2678_link$$inline_2675$$ = this.$getNodeById$($endNode$$inline_2678_link$$inline_2675$$.$getEndId$()), (0,D.$JSCompiler_StaticMethods_addOutLinkId$$)($nodeId$$inline_2669_startNode$$inline_2677$$, $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$), (0,D.$JSCompiler_StaticMethods_addInLinkId$$)($endNode$$inline_2678_link$$inline_2675$$, 
        $linkData$$inline_2674_linkId$$inline_2676_node$$inline_2668_nodeData$$inline_2667$$))
      }
    }
    var $keys$$14_linksData$$inline_2672_nodesData$$inline_2665$$ = [], $key$$54$$;
    for($key$$54$$ in this.$_nodes$) {
      $keys$$14_linksData$$inline_2672_nodesData$$inline_2665$$.push($key$$54$$)
    }
    $emptyDiagram$$1$$ = 0 === $keys$$14_linksData$$inline_2672_nodesData$$inline_2665$$.length;
...
D.$JSCompiler_StaticMethods__processContent$$ = function $$JSCompiler_StaticMethods__processContent$$$($JSCompiler_StaticMethods__processContent$self$$, $animator$$16_zoom$$1$$, $bEmptyDiagram_contentDim$$) {
  ...
  if(!$bEmptyDiagram_contentDim$$) {
    ...
    var $ah$$1_pzc$$inline_2682$$ = $JSCompiler_StaticMethods__processContent$self$$.$_panZoomCanvas$;
    if($JSCompiler_StaticMethods__processContent$self$$.$_bRendered$) {
      if($JSCompiler_StaticMethods__processContent$self$$.$_isResize$) {
        var $fitBounds$$inline_2685_viewBounds$$inline_2683$$ = $JSCompiler_StaticMethods__processContent$self$$.$AdjustMinZoom$($animator$$16_zoom$$1$$, $JSCompiler_StaticMethods__processContent$self$$.$_cachedViewBounds$), $fitBounds$$inline_2685_viewBounds$$inline_2683$$ = $bLayoutViewport$$inline_2684$$ ? (0,D.$JSCompiler_StaticMethods_GetLayoutViewport$$)($JSCompiler_StaticMethods__processContent$self$$) : $fitBounds$$inline_2685_viewBounds$$inline_2683$$ ? $fitBounds$$inline_2685_viewBounds$$inline_2683$$ : 
        $JSCompiler_StaticMethods__processContent$self$$.$_cachedViewBounds$;
        $ah$$1_pzc$$inline_2682$$.$_bZoomToFitEnabled$ = D.$JSCompiler_alias_TRUE$$;
        $ah$$1_pzc$$inline_2682$$.$zoomToFit$(D.$JSCompiler_alias_NULL$$, $fitBounds$$inline_2685_viewBounds$$inline_2683$$);
        $ah$$1_pzc$$inline_2682$$.$_bZoomToFitEnabled$ = $JSCompiler_StaticMethods__processContent$self$$.$_zoomingEnabled$
      }
    }else {
      ...
      if(!$JSCompiler_StaticMethods__processContent$self$$.$_isResize$) {
        var $bLayoutViewport$$inline_2684$$ = $JSCompiler_StaticMethods__processContent$self$$.$_layoutViewport$ ? D.$JSCompiler_alias_TRUE$$ : D.$JSCompiler_alias_FALSE$$, $fitBounds$$inline_2685_viewBounds$$inline_2683$$ = $bLayoutViewport$$inline_2684$$ ? (0,D.$JSCompiler_StaticMethods_GetLayoutViewport$$)($JSCompiler_StaticMethods__processContent$self$$) : $JSCompiler_StaticMethods__processContent$self$$.$_cachedViewBounds$;
        $bLayoutViewport$$inline_2684$$ && ($ah$$1_pzc$$inline_2682$$.$_zoomToFitPadding$ = 0);
        $ah$$1_pzc$$inline_2682$$.$zoomToFit$(D.$JSCompiler_alias_NULL$$, $fitBounds$$inline_2685_viewBounds$$inline_2683$$)
      }
      $ah$$1_pzc$$inline_2682$$.$_bPanningEnabled$ = $JSCompiler_StaticMethods__processContent$self$$.$_panningEnabled$;
      $ah$$1_pzc$$inline_2682$$.$_bZoomingEnabled$ = $JSCompiler_StaticMethods__processContent$self$$.$_zoomingEnabled$;
      $ah$$1_pzc$$inline_2682$$.$_bZoomToFitEnabled$ = $JSCompiler_StaticMethods__processContent$self$$.$_zoomingEnabled$
    }
  }
  ...
  "Delete Container"), $JSCompiler_StaticMethods__processContent$self$$.$addChild$($JSCompiler_StaticMethods__processContent$self$$.$_deleteContainer$), $ah$$1_pzc$$inline_2682$$ = new D.$DvtDiagramDataAnimationHandler$$($JSCompiler_StaticMethods__processContent$self$$.$getCtx$(), $JSCompiler_StaticMethods__processContent$self$$.$_deleteContainer$, $JSCompiler_StaticMethods__processContent$self$$.$_oldDataAnimState$, $JSCompiler_StaticMethods__processContent$self$$), (0,D.$JSCompiler_StaticMethods_constructAnimation$$)($ah$$1_pzc$$inline_2682$$, 
  [$JSCompiler_StaticMethods__processContent$self$$.$_oldDataAnimState$], [$JSCompiler_StaticMethods__processContent$self$$]), $JSCompiler_StaticMethods__processContent$self$$.$_animation$ = $ah$$1_pzc$$inline_2682$$.$getAnimation$()), $JSCompiler_StaticMethods__processContent$self$$.$_animation$ ? ($JSCompiler_StaticMethods__processContent$self$$.$getEventManager$().$hideTooltip$(), $JSCompiler_StaticMethods__processContent$self$$.$getEventManager$().$removeListeners$($JSCompiler_StaticMethods__processContent$self$$), 
...
D.$JSCompiler_prototypeAlias$$.$processEvent$ = function $$JSCompiler_prototypeAlias$$$$processEvent$$($event$$153$$) {
  var $type$$113$$ = $event$$153$$.$getType$();
  ("categoryRollOver" == $type$$113$$ || "categoryRollOut" == $type$$113$$) && this.$_processHighlighting$();
  ...
  switch($event$$154$$.$getSubType$()) {
    case "adjustPanConstraints":
      if(this.$_panningEnabled$) {
        var $nodeId$$7_zoom$$2$$ = $event$$154$$.$_newZoom$, $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$ = this.$_cachedViewBounds$ ? this.$_cachedViewBounds$ : (0,D.$JSCompiler_StaticMethods_CalcViewBounds$$)(this, $event$$154$$.$_animator$, D.$JSCompiler_alias_VOID$$, D.$JSCompiler_alias_VOID$$);
        this.$ConstrainPanning$($JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$.x, $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$.y, $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$.$w$, $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$.$h$, $nodeId$$7_zoom$$2$$)
      }
      break;
    case "zoomToFitCalcBounds":
      this.$_layoutViewport$ || ($JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$ = this.$_cachedViewBounds$ ? this.$_cachedViewBounds$ : (0,D.$JSCompiler_StaticMethods_CalcViewBounds$$)(this, $event$$154$$.$_animator$, D.$JSCompiler_alias_VOID$$, D.$JSCompiler_alias_VOID$$), $event$$154$$.$_zoomToFitBounds$ = $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$);
      break;
    case "zoomed":
      if(this.$getOptions$().zoomRenderer && $event$$154$$.$_oldZoom$ !== $event$$154$$.$_newZoom$) {
        for($nodeId$$7_zoom$$2$$ in this.$_nodes$) {
          var $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$ = this.$getNodeById$($nodeId$$7_zoom$$2$$), $event$$inline_2726_state$$inline_2728$$ = $event$$154$$;
          if($JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$.$_diagram$.$getOptions$().zoomRenderer) {
            var $prevState$$inline_2727$$ = $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$.$_getState$($event$$inline_2726_state$$inline_2728$$.$_oldZoom$), $event$$inline_2726_state$$inline_2728$$ = $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$.$_getState$($event$$inline_2726_state$$inline_2728$$.$_newZoom$);
            (0,D.$JSCompiler_StaticMethods__applyCustomNodeContent$$)($JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$, $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_2725_contentDim$$1$$.$_diagram$.$getOptions$().zoomRenderer, $event$$inline_2726_state$$inline_2728$$, $prevState$$inline_2727$$)
          }
        }
      }
  }
...
D.$JSCompiler_prototypeAlias$$.$_processHighlighting$ = function $$JSCompiler_prototypeAlias$$$$_processHighlighting$$() {
  ...
  if($categories$$7$$) {
    ...
    var $highlightedLinks_highlightedNodes$$ = [], $link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$;
    for($link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$ in this.$_nodes$) {
      var $highlightedLinks$$inline_2735_node$$38$$ = this.$getNodeById$($link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$), $incoming$$inline_2733_match$$4$$ = $bAnyMatched$$ ? D.$DvtArrayUtils$$.$hasAnyItem$($highlightedLinks$$inline_2735_node$$38$$.$getCategories$(), $categories$$7$$) : D.$DvtArrayUtils$$.$hasAllItems$($highlightedLinks$$inline_2735_node$$38$$.$getCategories$(), $categories$$7$$);
      $incoming$$inline_2733_match$$4$$ && (this.$_highlightedObjects$[$highlightedLinks$$inline_2735_node$$38$$.getId()] = $highlightedLinks$$inline_2735_node$$38$$, $highlightedLinks_highlightedNodes$$.push($highlightedLinks$$inline_2735_node$$38$$))
    }
    $link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$ = this.$Options$.nodeHighlightMode;
    if("node" != $link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$) {
      $incoming$$inline_2733_match$$4$$ = "nodeAndIncomingLinks" == $link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$ || "nodeAndLinks" == $link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$;
      $link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$ = "nodeAndOutgoingLinks" == $link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$ || "nodeAndLinks" == $link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$;
      for(var $highlightedLinks$$inline_2735_node$$38$$ = [], $nodeIdx$$inline_2736$$ = 0;$nodeIdx$$inline_2736$$ < $highlightedLinks_highlightedNodes$$.length;$nodeIdx$$inline_2736$$++) {
        for(var $idx$$inline_2739_node$$inline_2737$$ = $highlightedLinks_highlightedNodes$$[$nodeIdx$$inline_2736$$], $links$$inline_2738$$ = $incoming$$inline_2733_match$$4$$ && $idx$$inline_2739_node$$inline_2737$$.$_inLinkIds$ ? $idx$$inline_2739_node$$inline_2737$$.$_inLinkIds$ : [], $links$$inline_2738$$ = $link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$ && $idx$$inline_2739_node$$inline_2737$$.$_outLinkIds$ ? $links$$inline_2738$$.concat($idx$$inline_2739_node$$inline_2737$$.$_outLinkIds$) : 
        $links$$inline_2738$$, $idx$$inline_2739_node$$inline_2737$$ = 0;$idx$$inline_2739_node$$inline_2737$$ < $links$$inline_2738$$.length;$idx$$inline_2739_node$$inline_2737$$++) {
          var $linkId$$inline_2740$$ = $links$$inline_2738$$[$idx$$inline_2739_node$$inline_2737$$];
          this.$_highlightedObjects$[$linkId$$inline_2740$$] = this.$getLinkById$($linkId$$inline_2740$$);
          $highlightedLinks$$inline_2735_node$$38$$.push(this.$getLinkById$($linkId$$inline_2740$$))
        }
      }
      (0,D.$JSCompiler_StaticMethods__processLinkConnections$$)(this, $highlightedLinks$$inline_2735_node$$38$$)
    }
    var $highlightedLinks_highlightedNodes$$ = [], $linkId$$8$$;
    for($linkId$$8$$ in this.$_links$) {
      if($link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$ = this.$getLinkById$($linkId$$8$$), $incoming$$inline_2733_match$$4$$ = $bAnyMatched$$ ? D.$DvtArrayUtils$$.$hasAnyItem$($link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$.$getCategories$(), $categories$$7$$) : D.$DvtArrayUtils$$.$hasAllItems$($link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$.$getCategories$(), $categories$$7$$)) {
        this.$_highlightedObjects$[$link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$.getId()] = $link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$, $highlightedLinks_highlightedNodes$$.push($link$$13_nodeHighlightMode$$inline_2732_nodeId$$10_outgoing$$inline_2734$$)
      }
    }
...
D.$JSCompiler_prototypeAlias$$.$ProcessRolloverEvent$ = function $$JSCompiler_prototypeAlias$$$$ProcessRolloverEvent$$($event$$157_options$$112$$, $categories$$9_hoverBehaviorDelay$$1_obj$$71$$, $bOver$$1_rolloverEvent$$1$$) {
  ...
  "dim" == $event$$157_options$$112$$.hoverBehavior && ($categories$$9_hoverBehaviorDelay$$1_obj$$71$$ = $categories$$9_hoverBehaviorDelay$$1_obj$$71$$.$getCategories$ ? $categories$$9_hoverBehaviorDelay$$1_obj$$71$$.$getCategories$() : [], $event$$157_options$$112$$.highlightedCategories = $bOver$$1_rolloverEvent$$1$$ ? $categories$$9_hoverBehaviorDelay$$1_obj$$71$$.slice() : D.$JSCompiler_alias_NULL$$, $bOver$$1_rolloverEvent$$1$$ = new D.$DvtCategoryRolloverEvent$$($bOver$$1_rolloverEvent$$1$$ ? 
  "categoryRollOver" : "categoryRollOut", $event$$157_options$$112$$.highlightedCategories), $categories$$9_hoverBehaviorDelay$$1_obj$$71$$ = (0,D.$DvtStyleUtils$getTimeMilliseconds$$)($event$$157_options$$112$$.styleDefaults.hoverBehaviorDelay), this.$RolloverHandler$.$processEvent$($bOver$$1_rolloverEvent$$1$$, (0,D.$JSCompiler_StaticMethods_GetAllNodeObjects$$)(this.$_diagram$), $categories$$9_hoverBehaviorDelay$$1_obj$$71$$, "any" == $event$$157_options$$112$$.highlightMatch))
};
...
D.$JSCompiler_prototypeAlias$$.$StoreInfoByEventType$ = function $$JSCompiler_prototypeAlias$$$$StoreInfoByEventType$$($key$$55$$) {
  return"panned" == $key$$55$$ ? D.$JSCompiler_alias_FALSE$$ : D.$DvtDiagramEventManager$$.$superclass$.$StoreInfoByEventType$.call(this, $key$$55$$)
};
...
D.$DvtDiagramLayoutUtils$$.$centerNodeAndLabel$ = function $$DvtDiagramLayoutUtils$$$$centerNodeAndLabel$$($node$$54$$, $x$$95$$, $y$$74$$) {
  var $bounds$$27$$ = $node$$54$$.$getContentBounds$();
  $node$$54$$.$setPosition$(new D.$DvtDiagramPoint$$($x$$95$$ - $bounds$$27$$.x - 0.5 * $bounds$$27$$.w, $y$$74$$ - $bounds$$27$$.y - 0.5 * $bounds$$27$$.h));
...
D.$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($container$$68$$) {
  var $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$ = this.getData(), $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$ = this.$_pathCmds$;
  $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$ || ($labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$ = ["M", 0, 0, "L", 0, 0]);
  var $halign$$inline_3035_id$$inline_3024$$ = $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.id, $linkColor$$inline_3025$$ = $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.color, $linkWidth$$inline_3026$$ = $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.width, $linkStyle$$inline_3027_strokeType$$inline_3029_style$$inline_9957$$ = $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.style;
  this.$_hitDetectionUnderlay$ = this.$CreateUnderlay$("#000000", 0, $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$._hitDetectionOffset);
  this.$addChild$(this.$_hitDetectionUnderlay$);
  $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$ = new D.$DvtSolidStroke$$($linkColor$$inline_3025$$, 1, $linkWidth$$inline_3026$$);
  (0,D.$DvtAgent$isTouchDevice$$)() && ((0,D.$DvtAgent$isBrowserSafari$$)() && 1 == (0,D.$DvtAgent$getDevicePixelRatio$$)()) && ($diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.$_bFixedWidth$ = D.$JSCompiler_alias_TRUE$$);
  $linkStyle$$inline_3027_strokeType$$inline_3029_style$$inline_9957$$ = D.$DvtDiagramLinkUtils$$.$ConvertLinkStyleToStrokeType$($linkStyle$$inline_3027_strokeType$$inline_3029_style$$inline_9957$$);
  $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.$setType$($linkStyle$$inline_3027_strokeType$$inline_3029_style$$inline_9957$$, D.$DvtDiagramLinkUtils$$.$GetStrokeDash$($linkStyle$$inline_3027_strokeType$$inline_3029_style$$inline_9957$$), D.$DvtDiagramLinkUtils$$.$GetStrokeDashOffset$($linkStyle$$inline_3027_strokeType$$inline_3029_style$$inline_9957$$));
  $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$ = new D.$DvtPath$$(this.$getCtx$(), $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$, $halign$$inline_3035_id$$inline_3024$$);
  $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$.$setFill$(D.$JSCompiler_alias_NULL$$);
  $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$.$setStroke$($diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$);
  this.$setShape$($labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$);
  this.$addChild$($labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$);
  $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$ = this.$_diagram$;
  $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$ = this.getData();
  $halign$$inline_3035_id$$inline_3024$$ = (0,D.$DvtAgent$isRightToLeft$$)($diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.$getCtx$()) ? "right" : "left";
  $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$.label && ($linkStyle$$inline_3027_strokeType$$inline_3029_style$$inline_9957$$ = $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$.labelStyle, $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$ = new D.$DvtOutputText$$($diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.$getCtx$(), $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$.label, 
  0, 0), $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.$setCSSStyle$(new D.$DvtCSSStyle$$($linkStyle$$inline_3027_strokeType$$inline_3029_style$$inline_9957$$)), $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.$setHorizAlignment$($halign$$inline_3035_id$$inline_3024$$), $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$.$setVertAlignment$("top"), $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$ = 
  (0,D.$DvtCSSStyle$toNumber$$)((new D.$DvtCSSStyle$$($labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$.labelStyle)).getWidth()), 0 < $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$ && D.$DvtTextUtils$$.$fitText$($diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$, $labelWidth$$inline_3037_linkData$$inline_3033_points$$inline_3023_shape$$inline_3030$$, window.Infinity, this) || this.$addChild$($diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$), 
  this.$_labelObj$ = $diagram$$inline_3032_linkData$$inline_3021_stroke$$inline_3028_text$$inline_9959$$);
...
D.$DvtDiagramLinkConnectorUtils$$.$CreateCustomConnector$ = function $$DvtDiagramLinkConnectorUtils$$$$CreateCustomConnector$$($connectorTemplate$$4$$, $parentLink$$1$$) {
  var $afContext$$33$$ = (0,D.$JSCompiler_StaticMethods_createAfContext$$)($parentLink$$1$$.$GetDiagram$()), $array$$inline_3051_elContext$$inline_3048$$ = $parentLink$$1$$.getData().$_elAttributes$;
  $afContext$$33$$.$_elContext$ = $array$$inline_3051_elContext$$inline_3048$$;
  $afContext$$33$$.$setContextCallback$($parentLink$$1$$, $parentLink$$1$$.$eventContextCallback$);
  $array$$inline_3051_elContext$$inline_3048$$ = $parentLink$$1$$.$getTabStopsArray$();
  $afContext$$33$$.$_tabStopsArray$ = $array$$inline_3051_elContext$$inline_3048$$;
...
D.$DvtDiagramLinkUtils$$.$ConvertToPath$ = function $$DvtDiagramLinkUtils$$$$ConvertToPath$$($points$$30$$) {
  var $pathCmds$$ = [];
  if($points$$30$$) {
    for(var $i$$242$$ = 0;$i$$242$$ < $points$$30$$.length;$i$$242$$ += 2) {
      0 == $i$$242$$ ? $pathCmds$$.push("M") : $pathCmds$$.push("L"), $pathCmds$$.push($points$$30$$[$i$$242$$]), $pathCmds$$.push($points$$30$$[$i$$242$$ + 1])
    }
  }
  return $pathCmds$$
};
D.$DvtDiagramLinkUtils$$.$ConvertToPoints$ = function $$DvtDiagramLinkUtils$$$$ConvertToPoints$$($pathCmds$$1$$) {
  var $points$$31$$ = [];
  if($pathCmds$$1$$) {
    for(var $i$$243$$ = 0;$i$$243$$ < $pathCmds$$1$$.length;$i$$243$$++) {
      (0,window.isNaN)($pathCmds$$1$$[$i$$243$$]) || $points$$31$$.push($pathCmds$$1$$[$i$$243$$])
    }
  }
  return $points$$31$$
};
...
D.$DvtDiagramLinkUtils$$.$GetControlPoints$ = function $$DvtDiagramLinkUtils$$$$GetControlPoints$$($coords$$23_points$$33$$) {
  ...
  for(var $i$$244$$ = 0;$i$$244$$ < $coords$$23_points$$33$$.length;$i$$244$$ += 2) {
    $controlPoints$$2$$.push(new D.$DvtPoint$$($coords$$23_points$$33$$[$i$$244$$], $coords$$23_points$$33$$[$i$$244$$ + 1]))
  }
...
D.$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($container$$71_dims$$inline_3091$$) {
  if(this.$_diagram$.$getOptions$().renderer) {
    ...
    var $bbox$$inline_3092_nodeData$$2$$ = this.getData(), $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$ = this.$_diagram$, $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$ = new D.$DvtCSSStyle$$($bbox$$inline_3092_nodeData$$2$$.backgroundStyle);
    if(!(0,D.$JSCompiler_StaticMethods_isEmpty$$)($backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$)) {
      var $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$ = (0,D.$DvtCSSStyle$toNumber$$)($backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$.$getStyle$("width")), $height$$inline_3067_iconHeight$$inline_9969$$ = (0,D.$DvtCSSStyle$toNumber$$)($backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$.$getStyle$("height")), $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$ = 
      $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$.$getStyle$("background-color"), $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$ = $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$.$getStyle$("border-color"), $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$ = (0,D.$DvtCSSStyle$toNumber$$)($backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$.$getStyle$("border-width")), 
      $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$ = (0,D.$DvtCSSStyle$toNumber$$)($backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$.$getStyle$("border-radius")), $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$ = new D.$DvtRect$$($backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$.$getCtx$(), 0, 0, $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$, 
      $height$$inline_3067_iconHeight$$inline_9969$$);
      $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$.$setSolidFill$($diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$);
      $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$ && ($backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$.$setRx$($backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$), $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$.$setRy$($backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$));
      $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$ && $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$.$setStroke$(new D.$DvtSolidStroke$$($borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$, 1, $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$));
      this.$addChild$($backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$);
      this.$setSelectionShape$($backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$);
      this.$_background$ = $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$
    }
    $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$ = this.$_diagram$;
    if($borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$ = $bbox$$inline_3092_nodeData$$2$$.icon) {
      $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$ = $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.width;
      $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$ = $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.height;
      $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$ = $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.color;
      $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$ = $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.source ? new D.$DvtImageMarker$$($diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$.$getCtx$(), $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$ / 2, $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$ / 
      2, $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$, $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$, $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.source, $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.sourceSelected, $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.sourceHover, $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.sourceHoverSelected) : 
      new D.$DvtSimpleMarker$$($diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$.$getCtx$(), $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.shape, "alta", $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$ / 2, $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$ / 2, $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$, 
      $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$);
      "none" != $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.fillPattern ? $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$.$setFill$(new D.$DvtPatternFill$$($borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.fillPattern, $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$, $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$)) : 
      $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$.$setSolidFill$($backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$);
      $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.borderColor && $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$.$setStroke$(new D.$DvtSolidStroke$$($borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.borderColor, $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.borderWidth));
      this.$addChild$($diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$);
      this.$_shape$ = $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$;
      if(this.$_background$) {
        var $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$ = $bbox$$inline_3092_nodeData$$2$$.icon, $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$ = this.$_background$.getWidth(), $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$ = this.$_background$.getHeight(), $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$ = 
        $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.width, $height$$inline_3067_iconHeight$$inline_9969$$ = $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.height, $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$ = 0.5 * ($backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$ - $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$), 
        $positionY$$inline_9971$$ = 0.5 * ($backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$ - $height$$inline_3067_iconHeight$$inline_9969$$);
        if($borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.positionX !== D.$JSCompiler_alias_VOID$$) {
          $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$ = (0,window.parseFloat)($borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.positionX), (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()) && ($backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$ = $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$ - $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$ - 
          $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$)
        }else {
          var $resolvedHalign$$inline_9972$$ = $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.halign;
          "start" == $resolvedHalign$$inline_9972$$ ? $resolvedHalign$$inline_9972$$ = (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()) ? "right" : "left" : "end" == $resolvedHalign$$inline_9972$$ && ($resolvedHalign$$inline_9972$$ = (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()) ? "left" : "right");
          $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$ = "left" == $resolvedHalign$$inline_9972$$ ? 0 : "right" == $resolvedHalign$$inline_9972$$ ? $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$ - $iconHeight$$inline_3079_iconWidth$$inline_9968_width$$inline_3066$$ : $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$
        }
        $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.positionY !== D.$JSCompiler_alias_VOID$$ ? $positionY$$inline_9971$$ = (0,window.parseFloat)($borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.positionY) : "top" == $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.valign ? $positionY$$inline_9971$$ = 0 : "bottom" == $borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$.valign && 
        ($positionY$$inline_9971$$ = $backgroundHeight$$inline_9967_backgroundRect$$inline_3072_diagram$$inline_3062_iconWidth$$inline_3078$$ - $height$$inline_3067_iconHeight$$inline_9969$$);
        (0,D.$JSCompiler_StaticMethods_setTranslate$$)(this.$_shape$, $backgroundStyle$$inline_3065_borderRadius$$inline_3071_positionX$$inline_9970$$, $positionY$$inline_9971$$)
      }
      this.$_background$ || this.$setSelectionShape$($diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$)
    }
    $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$ = this.$_diagram$;
    $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$ = (0,D.$DvtAgent$isRightToLeft$$)($backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$.$getCtx$()) ? "right" : "left";
    $bbox$$inline_3092_nodeData$$2$$.label && ($borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$ = $bbox$$inline_3092_nodeData$$2$$.labelStyle, $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$ = new D.$DvtOutputText$$($backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$.$getCtx$(), $bbox$$inline_3092_nodeData$$2$$.label, 0, 0), 
    $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$.$setCSSStyle$(new D.$DvtCSSStyle$$($borderColor$$inline_3069_icon$$inline_3077_iconData$$inline_9965_style$$inline_9976$$)), $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$.$setHorizAlignment$($diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$), 
    $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$.$setVertAlignment$("top"), $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$ = (0,D.$DvtCSSStyle$toNumber$$)((new D.$DvtCSSStyle$$($bbox$$inline_3092_nodeData$$2$$.labelStyle)).getWidth()), 0 < $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$ && D.$DvtTextUtils$$.$fitText$($backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$, 
    $diagram$$inline_3074_fillColor$$inline_3068_halign$$inline_3086_iconMarker$$inline_3081_labelWidth$$inline_3088$$, window.Infinity, this) || this.$addChild$($backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$), this.$_labelObj$ = $backgroundWidth$$inline_9966_borderWidth$$inline_3070_diagram$$inline_3083_iconColor$$inline_3080_text$$inline_9978$$);
    (0,D.$DvtDiagramNode$_addHoverSelectionStrokes$$)(this.$getSelectionShape$(), $bbox$$inline_3092_nodeData$$2$$)
  }
  $container$$71_dims$$inline_3091$$.$addChild$(this);
  $container$$71_dims$$inline_3091$$ = D.$JSCompiler_alias_NULL$$;
  this.$_customNodeContent$ ? ($bbox$$inline_3092_nodeData$$2$$ = this.$getDimensions$()) && ($container$$71_dims$$inline_3091$$ = new D.$DvtRectangle$$($bbox$$inline_3092_nodeData$$2$$.x, $bbox$$inline_3092_nodeData$$2$$.y, $bbox$$inline_3092_nodeData$$2$$.$w$ - $bbox$$inline_3092_nodeData$$2$$.x, $bbox$$inline_3092_nodeData$$2$$.$h$ - $bbox$$inline_3092_nodeData$$2$$.y)) : ($container$$71_dims$$inline_3091$$ = this.$_background$ ? this.$_background$.$GetDimensionsWithStroke$(this) : D.$JSCompiler_alias_NULL$$) && 
  this.$_shape$ ? $container$$71_dims$$inline_3091$$ = (0,D.$JSCompiler_StaticMethods_getUnion$$)($container$$71_dims$$inline_3091$$, this.$_shape$.$GetDimensionsWithStroke$(this)) : !$container$$71_dims$$inline_3091$$ && this.$_shape$ && ($container$$71_dims$$inline_3091$$ = this.$_shape$.$GetDimensionsWithStroke$(this));
  this.$_contentDims$ = $container$$71_dims$$inline_3091$$;
  this.$setAriaRole$("img");
  this.$UpdateAriaLabel$();
  this.$_diagram$.$getEventManager$().$associate$(this, this)
};
...
D.$DvtDiagramAutomation$$.prototype.$getDomElementForSubId$ = function $$DvtDiagramAutomation$$$$$getDomElementForSubId$$($component$$1_subId$$6$$) {
  ...
  var $index$$143_parsedSubId$$ = this.$_parseSubId$($component$$1_subId$$6$$);
  $component$$1_subId$$6$$ = $index$$143_parsedSubId$$.component;
  var $index$$143_parsedSubId$$ = $index$$143_parsedSubId$$.index, $displayable$$15$$ = D.$JSCompiler_alias_NULL$$;
  "node" == $component$$1_subId$$6$$ ? $displayable$$15$$ = this.$_getNode$($index$$143_parsedSubId$$) : "link" == $component$$1_subId$$6$$ && ($displayable$$15$$ = (0,D.$JSCompiler_StaticMethods__getLink$$)(this, $index$$143_parsedSubId$$));
...
D.$DvtDiagramAutomation$$.prototype.$_parseSubId$ = function $$DvtDiagramAutomation$$$$$_parseSubId$$($subId$$7$$) {
  var $component$$2$$ = $subId$$7$$, $index$$144$$ = -1, $substring$$ = $subId$$7$$.substring(0, $subId$$7$$.indexOf("["));
  $substring$$ && ($component$$2$$ = "node" == $substring$$ || "link" == $substring$$ ? $substring$$ : D.$JSCompiler_alias_NULL$$, $index$$144$$ = (0,window.parseInt)($subId$$7$$.substring($subId$$7$$.indexOf("[") + 1, $subId$$7$$.indexOf("]"))));
  return{component:$component$$2$$, index:$index$$144$$}
};
