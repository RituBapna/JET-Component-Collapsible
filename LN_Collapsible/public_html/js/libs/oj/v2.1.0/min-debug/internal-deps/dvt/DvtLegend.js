...
D.$DvtLegend$newInstance$$ = function $$DvtLegend$newInstance$$$($context$$452$$, $callback$$116$$, $callbackObj$$69$$) {
  var $legend$$3$$ = new D.$DvtLegend$$;
  $legend$$3$$.Init($context$$452$$, $callback$$116$$, $callbackObj$$69$$);
  return $legend$$3$$
};
...
D.$DvtLegend$$.prototype.Init = function $$DvtLegend$$$$Init$($context$$453$$, $callback$$117$$, $callbackObj$$70$$) {
  D.$DvtLegend$$.$superclass$.Init.call(this, $context$$453$$, $callback$$117$$, $callbackObj$$70$$);
...
D.$DvtLegend$$.prototype.$highlight$ = function $$DvtLegend$$$$$highlight$$($categories$$15$$) {
  this.$getOptions$().highlightedCategories = $categories$$15$$ && 0 < $categories$$15$$.length ? $categories$$15$$.slice() : D.$JSCompiler_alias_NULL$$;
  (0,D.$DvtCategoryRolloverHandler$highlight$$)($categories$$15$$, this.$_peers$, D.$JSCompiler_alias_TRUE$$)
};
D.$DvtLegend$$.prototype.highlight = D.$DvtLegend$$.prototype.$highlight$;
D.$DvtLegend$$.prototype.$processEvent$ = function $$DvtLegend$$$$$processEvent$$($event$$549$$, $source$$31$$) {
  var $type$$230$$ = $event$$549$$.$getType$();
  if(("categoryRollOver" == $type$$230$$ || "categoryRollOut" == $type$$230$$) && "dim" == this.$getOptions$().hoverBehavior) {
    var $peers$$7$$ = this.$_peers$;
    this != $source$$31$$ && this.$highlight$($event$$549$$.categories);
    for(var $i$$691$$ = 0;$i$$691$$ < $peers$$7$$.length;$i$$691$$++) {
      if($peers$$7$$[$i$$691$$].getId() == $event$$549$$.$_category$) {
        this.$container$.scrollIntoView($peers$$7$$[$i$$691$$].$getDisplayables$()[0]);
        break
      }
    }
  }
  (this == $source$$31$$ || "showPopup" == $type$$230$$ || "hidePopup" == $type$$230$$) && this.dispatchEvent($event$$549$$)
};
...
D.$JSCompiler_prototypeAlias$$.$setKeyboardFocus$ = function $$JSCompiler_prototypeAlias$$$$setKeyboardFocus$$($navigable$$15$$, $isShowingFocusEffect$$1$$) {
  if(this.$_eventManager$ != D.$JSCompiler_alias_NULL$$) {
    for(var $focus$$4_peers$$8$$ = this.$_navigablePeers$, $displayable$$64_i$$692$$ = 0;$displayable$$64_i$$692$$ < $focus$$4_peers$$8$$.length;$displayable$$64_i$$692$$++) {
      if($focus$$4_peers$$8$$[$displayable$$64_i$$692$$].getId() == $navigable$$15$$.getId()) {
        (0,D.$JSCompiler_StaticMethods_setFocusObj$$)(this.$_eventManager$, $focus$$4_peers$$8$$[$displayable$$64_i$$692$$]);
        $isShowingFocusEffect$$1$$ && $focus$$4_peers$$8$$[$displayable$$64_i$$692$$].$showKeyboardFocusEffect$();
        break
      }
    }
    if($focus$$4_peers$$8$$ = this.$getKeyboardFocus$()) {
      $displayable$$64_i$$692$$ = $focus$$4_peers$$8$$.$getDisplayables$()[0], $displayable$$64_i$$692$$.$setAriaProperty$("label", $focus$$4_peers$$8$$.$getAriaLabel$()), (0,D.$JSCompiler_StaticMethods_setActiveElement$$)(this.$getCtx$(), $displayable$$64_i$$692$$)
    }
  }
};
...
D.$JSCompiler_StaticMethods__transferVisibilityProperties$$ = function $$JSCompiler_StaticMethods__transferVisibilityProperties$$$($JSCompiler_StaticMethods__transferVisibilityProperties$self$$, $sections$$2$$) {
  if($sections$$2$$ && !(0 >= $sections$$2$$.length)) {
    for(var $hiddenCategories$$7$$ = $JSCompiler_StaticMethods__transferVisibilityProperties$self$$.$getOptions$().hiddenCategories, $i$$693$$ = 0;$i$$693$$ < $sections$$2$$.length;$i$$693$$++) {
      var $items$$26_section$$4$$ = $sections$$2$$[$i$$693$$];
...
D.$DvtLegendAutomation$$.prototype.$GetSubIdForDomElement$ = function $$DvtLegendAutomation$$$$$GetSubIdForDomElement$$($displayable$$65_indexList$$4_item$$27_logicalObj$$15$$) {
  if(($displayable$$65_indexList$$4_item$$27_logicalObj$$15$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this.$_legend$.$getEventManager$(), $displayable$$65_indexList$$4_item$$27_logicalObj$$15$$)) && $displayable$$65_indexList$$4_item$$27_logicalObj$$15$$ instanceof D.$DvtLegendObjPeer$$) {
    if($displayable$$65_indexList$$4_item$$27_logicalObj$$15$$ = $displayable$$65_indexList$$4_item$$27_logicalObj$$15$$.getData(), $displayable$$65_indexList$$4_item$$27_logicalObj$$15$$ = (0,D.$JSCompiler_StaticMethods__getIndicesFromItem$$)(this, $displayable$$65_indexList$$4_item$$27_logicalObj$$15$$, this.$_options$)) {
      return"section" + $displayable$$65_indexList$$4_item$$27_logicalObj$$15$$
    }
  }
  return D.$JSCompiler_alias_NULL$$
};
D.$JSCompiler_StaticMethods__getIndicesFromItem$$ = function $$JSCompiler_StaticMethods__getIndicesFromItem$$$($JSCompiler_StaticMethods__getIndicesFromItem$self_i$$694$$, $item$$28$$, $legendOptions$$4$$) {
  if($legendOptions$$4$$.sections && 0 < $legendOptions$$4$$.sections.length) {
    for(var $s$$149$$ = 0;$s$$149$$ < $legendOptions$$4$$.sections.length;$s$$149$$++) {
      ...
      var $itemIndex$$8$$ = (0,D.$JSCompiler_StaticMethods__getIndicesFromItem$$)($JSCompiler_StaticMethods__getIndicesFromItem$self_i$$694$$, $item$$28$$, $legendOptions$$4$$.sections[$s$$149$$]);
      if($itemIndex$$8$$) {
  ...
  if($legendOptions$$4$$.items && 0 < $legendOptions$$4$$.items.length) {
    for($JSCompiler_StaticMethods__getIndicesFromItem$self_i$$694$$ = 0;$JSCompiler_StaticMethods__getIndicesFromItem$self_i$$694$$ < $legendOptions$$4$$.items.length;$JSCompiler_StaticMethods__getIndicesFromItem$self_i$$694$$++) {
      if($legendOptions$$4$$.items[$JSCompiler_StaticMethods__getIndicesFromItem$self_i$$694$$] == $item$$28$$) {
...
D.$JSCompiler_StaticMethods_getIndicesFromSeries$$ = function $$JSCompiler_StaticMethods_getIndicesFromSeries$$$($JSCompiler_StaticMethods_getIndicesFromSeries$self_i$$695$$, $series$$18$$, $legendOptions$$5$$) {
  if($legendOptions$$5$$.sections && 0 < $legendOptions$$5$$.sections.length) {
    for(var $s$$150$$ = 0;$s$$150$$ < $legendOptions$$5$$.sections.length;$s$$150$$++) {
      var $itemIndex$$9$$ = (0,D.$JSCompiler_StaticMethods_getIndicesFromSeries$$)($JSCompiler_StaticMethods_getIndicesFromSeries$self_i$$695$$, $series$$18$$, $legendOptions$$5$$.sections[$s$$150$$]);
      if($itemIndex$$9$$) {
...
D.$JSCompiler_StaticMethods_getLegendItem$$ = function $$JSCompiler_StaticMethods_getLegendItem$$$($JSCompiler_StaticMethods_getLegendItem$self$$, $options$$180$$, $subId$$24$$) {
  var $index$$214_openParen$$3$$ = $subId$$24$$.indexOf("["), $closeParen$$3_nextCloseParen$$ = $subId$$24$$.indexOf("]");
  if(0 <= $index$$214_openParen$$3$$ && 0 <= $closeParen$$3_nextCloseParen$$) {
    var $index$$214_openParen$$3$$ = $subId$$24$$.substring($index$$214_openParen$$3$$ + 1, $closeParen$$3_nextCloseParen$$), $colonIndex$$2$$ = $subId$$24$$.indexOf(":");
    $subId$$24$$ = $subId$$24$$.substring($closeParen$$3_nextCloseParen$$ + 1);
    $closeParen$$3_nextCloseParen$$ = $subId$$24$$.indexOf("]");
    return 0 <= $subId$$24$$.indexOf("[") && 0 <= $closeParen$$3_nextCloseParen$$ ? (0,D.$JSCompiler_StaticMethods_getLegendItem$$)($JSCompiler_StaticMethods_getLegendItem$self$$, $options$$180$$.sections[$index$$214_openParen$$3$$], $subId$$24$$) : 0 == $colonIndex$$2$$ ? $options$$180$$.items[$index$$214_openParen$$3$$] : $options$$180$$.sections[$index$$214_openParen$$3$$]
  }
};
D.$DvtLegendAutomation$$.prototype.$getDomElementForSubId$ = function $$DvtLegendAutomation$$$$$getDomElementForSubId$$($legendItem$$3_subId$$25$$) {
  ...
  for(var $legendPeers$$ = this.$_legend$.$_peers$, $i$$696$$ = 0;$i$$696$$ < $legendPeers$$.length;$i$$696$$++) {
    var $item$$29$$ = $legendPeers$$[$i$$696$$].getData();
...
D.$DvtLegendAutomation$$.prototype.getItem = function $$DvtLegendAutomation$$$$getItem$($subIdPath$$) {
  for(var $item$$30$$, $index$$215$$ = $subIdPath$$.shift(), $options$$181$$ = this.$_options$;$index$$215$$ != D.$JSCompiler_alias_VOID$$;) {
    0 < $subIdPath$$.length ? $options$$181$$ = $options$$181$$.sections[$index$$215$$] : $item$$30$$ = $options$$181$$.items[$index$$215$$], $index$$215$$ = $subIdPath$$.shift()
  }
...
D.$DvtLegendAutomation$$.prototype.$getSection$ = function $$DvtLegendAutomation$$$$$getSection$$($subIdPath$$1$$) {
  for(var $section$$5$$, $index$$216$$ = $subIdPath$$1$$.shift(), $options$$182$$ = this.$_options$;$index$$216$$ != D.$JSCompiler_alias_VOID$$;) {
    0 < $subIdPath$$1$$.length ? $options$$182$$ = $options$$182$$.sections[$index$$216$$] : $section$$5$$ = $options$$182$$.sections[$index$$216$$], $index$$216$$ = $subIdPath$$1$$.shift()
  }
...
D.$JSCompiler_StaticMethods__generateItemObjects$$ = function $$JSCompiler_StaticMethods__generateItemObjects$$$($items$$27$$) {
  for(var $itemDataArray$$ = [], $i$$697$$ = 0;$i$$697$$ < $items$$27$$.length;$i$$697$$++) {
    $itemDataArray$$.push({text:$items$$27$$[$i$$697$$].text})
  }
...
D.$JSCompiler_prototypeAlias$$.$FireUIEvent$ = function $$JSCompiler_prototypeAlias$$$$FireUIEvent$$($type$$232$$, $logicalObj$$16$$) {
  var $id$$inline_7362_params$$50$$ = D.$JSCompiler_alias_NULL$$;
  $logicalObj$$16$$ instanceof D.$DvtSimpleObjPeer$$ && $logicalObj$$16$$.$_params$ != D.$JSCompiler_alias_NULL$$ ? $id$$inline_7362_params$$50$$ = $logicalObj$$16$$.$_params$ : $logicalObj$$16$$ instanceof D.$DvtLegendObjPeer$$ && ($id$$inline_7362_params$$50$$ = $logicalObj$$16$$.getId(), $id$$inline_7362_params$$50$$ = {type:D.$DvtLegendConstants$$.$LEGEND_ITEM$, id:$id$$inline_7362_params$$50$$});
  this.$FireEvent$(new D.$DvtComponentUIEvent$$($type$$232$$, $id$$inline_7362_params$$50$$), this.$_legend$)
};
...
D.$JSCompiler_prototypeAlias$$.$OnMouseOver$ = function $$JSCompiler_prototypeAlias$$$$OnMouseOver$$($event$$551_obj$$298$$) {
...
D.$JSCompiler_StaticMethods_processHideShowEvent$$ = function $$JSCompiler_StaticMethods_processHideShowEvent$$$($JSCompiler_StaticMethods_processHideShowEvent$self$$, $obj$$301$$) {
  ...
  var $categories$$16_id$$222$$ = $obj$$301$$.$getCategories$ ? $obj$$301$$.$getCategories$() : D.$JSCompiler_alias_NULL$$;
  if(!$categories$$16_id$$222$$ || 0 >= $categories$$16_id$$222$$.length) {
    return D.$JSCompiler_alias_FALSE$$
  }
  for(var $category$$15_event$$553$$ = $obj$$301$$.$getCategories$()[0], $hiddenCategories$$8_hideAndShow$$2$$ = $JSCompiler_StaticMethods_processHideShowEvent$self$$.$_legend$.$getOptions$().hiddenCategories || [], $hiddenCategories$$8_hideAndShow$$2$$ = $hiddenCategories$$8_hideAndShow$$2$$.slice(), $displayables$$18$$ = $obj$$301$$.$getDisplayables$(), $i$$699$$ = 0;$i$$699$$ < $displayables$$18$$.length;$i$$699$$++) {
    var $displayable$$66$$ = $displayables$$18$$[$i$$699$$];
  ...
  $categories$$16_id$$222$$ = $categories$$16_id$$222$$[0];
  D.$DvtLegendRenderer$$.$isCategoryHidden$($category$$15_event$$553$$, $JSCompiler_StaticMethods_processHideShowEvent$self$$.$_legend$) ? ($hiddenCategories$$8_hideAndShow$$2$$.splice(D.$DvtArrayUtils$$.$getIndex$($hiddenCategories$$8_hideAndShow$$2$$, $category$$15_event$$553$$), 1), $category$$15_event$$553$$ = new D.$DvtCategoryHideShowEvent$$(D.$DvtCategoryHideShowEvent$$.$TYPE_SHOW$, $categories$$16_id$$222$$)) : ($hiddenCategories$$8_hideAndShow$$2$$.push($category$$15_event$$553$$), $category$$15_event$$553$$ = 
  new D.$DvtCategoryHideShowEvent$$(D.$DvtCategoryHideShowEvent$$.$TYPE_HIDE$, $categories$$16_id$$222$$));
...
D.$JSCompiler_StaticMethods_handleClick$$ = function $$JSCompiler_StaticMethods_handleClick$$$($JSCompiler_StaticMethods_handleClick$self$$, $obj$$302_params$$51$$, $event$$554_id$$223$$) {
  return $obj$$302_params$$51$$ && $obj$$302_params$$51$$.$getAction$ && $obj$$302_params$$51$$.$getAction$() ? ($JSCompiler_StaticMethods_handleClick$self$$.$FireEvent$(new D.$DvtActionEvent$$("action", $obj$$302_params$$51$$.$getAction$(), $obj$$302_params$$51$$.getId()), $JSCompiler_StaticMethods_handleClick$self$$.$_legend$), D.$JSCompiler_alias_TRUE$$) : $obj$$302_params$$51$$ instanceof D.$DvtLegendObjPeer$$ && $obj$$302_params$$51$$.$isDrillable$() ? ($event$$554_id$$223$$ = $obj$$302_params$$51$$.getId(), 
  $JSCompiler_StaticMethods_handleClick$self$$.$FireEvent$(new D.$DvtDrillEvent$$($event$$554_id$$223$$, $event$$554_id$$223$$, D.$JSCompiler_alias_NULL$$), $JSCompiler_StaticMethods_handleClick$self$$.$_legend$), D.$JSCompiler_alias_TRUE$$) : ($obj$$302_params$$51$$ = $obj$$302_params$$51$$ instanceof D.$DvtSimpleObjPeer$$ ? $obj$$302_params$$51$$.$_params$ : D.$JSCompiler_alias_NULL$$) && "title" == $obj$$302_params$$51$$.type && $obj$$302_params$$51$$.isCollapsible ? ((0,D.$JSCompiler_StaticMethods_toggleSectionCollapse$$)($JSCompiler_StaticMethods_handleClick$self$$, 
  $event$$554_id$$223$$, $obj$$302_params$$51$$.id), D.$JSCompiler_alias_TRUE$$) : D.$JSCompiler_alias_FALSE$$
};
...
D.$JSCompiler_StaticMethods_toggleSectionCollapse$$ = function $$JSCompiler_StaticMethods_toggleSectionCollapse$$$($JSCompiler_StaticMethods_toggleSectionCollapse$self$$, $bounds$$136_event$$557_focus$$5$$, $isShowingFocusEffect$$2_peer$$22_sectionIdArray$$) {
  for(var $section$$6$$ = $JSCompiler_StaticMethods_toggleSectionCollapse$self$$.$_legend$.$getOptions$(), $i$$700$$ = 0;$i$$700$$ < $isShowingFocusEffect$$2_peer$$22_sectionIdArray$$.length;$i$$700$$++) {
    $section$$6$$ = $section$$6$$.sections[$isShowingFocusEffect$$2_peer$$22_sectionIdArray$$[$i$$700$$]]
  }
  $section$$6$$.expanded = "off" == $section$$6$$.expanded ? "on" : "off";
  $bounds$$136_event$$557_focus$$5$$.type == D.$DvtMouseEvent$CLICK$$ && ($isShowingFocusEffect$$2_peer$$22_sectionIdArray$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)($JSCompiler_StaticMethods_toggleSectionCollapse$self$$, (0,D.$JSCompiler_StaticMethods_GetCurrentTargetForEvent$$)($JSCompiler_StaticMethods_toggleSectionCollapse$self$$, $bounds$$136_event$$557_focus$$5$$)), $isShowingFocusEffect$$2_peer$$22_sectionIdArray$$.$getNextNavigable$ && (0,D.$JSCompiler_StaticMethods_setFocusObj$$)($JSCompiler_StaticMethods_toggleSectionCollapse$self$$, 
  $isShowingFocusEffect$$2_peer$$22_sectionIdArray$$.$getNextNavigable$($bounds$$136_event$$557_focus$$5$$)));
  $isShowingFocusEffect$$2_peer$$22_sectionIdArray$$ = ($bounds$$136_event$$557_focus$$5$$ = $JSCompiler_StaticMethods_toggleSectionCollapse$self$$.$_legend$.$getKeyboardFocus$()) ? $bounds$$136_event$$557_focus$$5$$.$isShowingKeyboardFocusEffect$() : D.$JSCompiler_alias_FALSE$$;
  $JSCompiler_StaticMethods_toggleSectionCollapse$self$$.$_legend$.$render$();
  $bounds$$136_event$$557_focus$$5$$ && $JSCompiler_StaticMethods_toggleSectionCollapse$self$$.$_legend$.$setKeyboardFocus$($bounds$$136_event$$557_focus$$5$$, $isShowingFocusEffect$$2_peer$$22_sectionIdArray$$);
  $JSCompiler_StaticMethods_toggleSectionCollapse$self$$.$hideTooltip$();
  $bounds$$136_event$$557_focus$$5$$ = $JSCompiler_StaticMethods_toggleSectionCollapse$self$$.$_legend$.$getContentDimensions$();
  $JSCompiler_StaticMethods_toggleSectionCollapse$self$$.$FireEvent$(new D.$DvtResizeEvent$$($bounds$$136_event$$557_focus$$5$$.$w$, $bounds$$136_event$$557_focus$$5$$.$h$, $bounds$$136_event$$557_focus$$5$$.x, $bounds$$136_event$$557_focus$$5$$.y), $JSCompiler_StaticMethods_toggleSectionCollapse$self$$.$_legend$)
};
...
D.$DvtLegendKeyboardHandler$$.prototype.$processKeyDown$ = function $$DvtLegendKeyboardHandler$$$$$processKeyDown$$($event$$558$$) {
  var $keyCode$$37_navigables$$8$$ = $event$$558$$.keyCode, $currentNavigable$$12$$ = this.$_eventManager$.$getFocus$(), $isButton$$ = $currentNavigable$$12$$ && $currentNavigable$$12$$.$getDisplayables$()[0] instanceof D.$DvtButton$$, $nextNavigable$$5$$ = D.$JSCompiler_alias_NULL$$;
  $currentNavigable$$12$$ == D.$JSCompiler_alias_NULL$$ && 9 == $keyCode$$37_navigables$$8$$ ? ($keyCode$$37_navigables$$8$$ = this.$_legend$.$_navigablePeers$, 0 < $keyCode$$37_navigables$$8$$.length && ((0,D.$DvtEventManager$consumeEvent$$)($event$$558$$), $nextNavigable$$5$$ = this.$getDefaultNavigable$($keyCode$$37_navigables$$8$$))) : $currentNavigable$$12$$ && (9 == $keyCode$$37_navigables$$8$$ ? ((0,D.$DvtEventManager$consumeEvent$$)($event$$558$$), $nextNavigable$$5$$ = $currentNavigable$$12$$) : 
  13 == $keyCode$$37_navigables$$8$$ || 32 == $keyCode$$37_navigables$$8$$ ? (13 == $keyCode$$37_navigables$$8$$ && (0,D.$JSCompiler_StaticMethods_handleClick$$)(this.$_eventManager$, $currentNavigable$$12$$, $event$$558$$), $isButton$$ ? this.$_eventManager$.$onCollapseButtonClick$($event$$558$$, $currentNavigable$$12$$.$getDisplayables$()[0]) : (0,D.$JSCompiler_StaticMethods_processHideShowEvent$$)(this.$_eventManager$, $currentNavigable$$12$$), (0,D.$DvtEventManager$consumeEvent$$)($event$$558$$)) : 
  $isButton$$ && (37 == $keyCode$$37_navigables$$8$$ || 39 == $keyCode$$37_navigables$$8$$) ? (this.$_eventManager$.$onCollapseButtonClick$($event$$558$$, $currentNavigable$$12$$.$getDisplayables$()[0]), (0,D.$DvtEventManager$consumeEvent$$)($event$$558$$)) : $nextNavigable$$5$$ = D.$DvtLegendKeyboardHandler$$.$superclass$.$processKeyDown$.call(this, $event$$558$$));
  $nextNavigable$$5$$ && this.$_legend$.$container$.scrollIntoView($nextNavigable$$5$$.$getDisplayables$()[0]);
  return $nextNavigable$$5$$
};
D.$DvtLegendObjPeer$$ = function $$DvtLegendObjPeer$$$($legend$$8$$, $displayables$$19$$, $id$$224$$, $tooltip$$34$$, $datatip$$16$$, $drillable$$5$$) {
  this.Init($legend$$8$$, $displayables$$19$$, $id$$224$$, $tooltip$$34$$, $datatip$$16$$, $drillable$$5$$)
};
D.$DvtObj$$.$createSubclass$(D.$DvtLegendObjPeer$$, D.$DvtObj$$, "DvtLegendObjPeer");
D.$DvtLegendObjPeer$$.prototype.Init = function $$DvtLegendObjPeer$$$$Init$($i$$701_legend$$9$$, $displayables$$20$$, $item$$31$$, $tooltip$$35$$, $datatip$$17$$, $drillable$$6$$) {
...
D.$DvtLegendObjPeer$associate$$ = function $$DvtLegendObjPeer$associate$$$($displayables$$21$$, $legend$$10$$, $identObj$$1_item$$32$$, $i$$702_tooltip$$36$$, $datatip$$18$$, $drillable$$7$$) {
  if(!$displayables$$21$$ || !$identObj$$1_item$$32$$) {
    return D.$JSCompiler_alias_NULL$$
  }
  $identObj$$1_item$$32$$ = new D.$DvtLegendObjPeer$$($legend$$10$$, $displayables$$21$$, $identObj$$1_item$$32$$, $i$$702_tooltip$$36$$, $datatip$$18$$, $drillable$$7$$);
  $legend$$10$$.$__registerObject$($identObj$$1_item$$32$$);
  for($i$$702_tooltip$$36$$ = 0;$i$$702_tooltip$$36$$ < $displayables$$21$$.length;$i$$702_tooltip$$36$$++) {
    $legend$$10$$.$getEventManager$().$associate$($displayables$$21$$[$i$$702_tooltip$$36$$], $identObj$$1_item$$32$$)
  }
...
D.$DvtLegendRenderer$$.$render$ = function $$DvtLegendRenderer$$$$render$$($legend$$11$$, $availSpace$$88$$) {
  ...
  var $container$$131_translateX$$1$$ = new D.$DvtSimpleScrollableContainer$$($context$$454_totalDim$$, $availSpace$$88$$.$w$, $availSpace$$88$$.$h$), $contentContainer$$3_i$$703$$ = new D.$DvtContainer$$($context$$454_totalDim$$);
  ...
  $context$$454_totalDim$$ = D.$DvtLegendRenderer$$.$_renderContents$($legend$$11$$, $contentContainer$$3_i$$703$$, new D.$DvtRectangle$$($availSpace$$88$$.x, $availSpace$$88$$.y, $availSpace$$88$$.$w$, $availSpace$$88$$.$h$));
  ...
  $context$$454_totalDim$$.$h$ > $availSpace$$88$$.$h$ ? ($context$$454_totalDim$$.$h$ = $availSpace$$88$$.$h$, $options$$185_titles$$._isScrollingLegend = D.$JSCompiler_alias_TRUE$$) : $options$$185_titles$$._isScrollingLegend = D.$JSCompiler_alias_FALSE$$;
  var $translateY$$1$$ = $container$$131_translateX$$1$$ = 0, $halign$$6$$ = $options$$185_titles$$.hAlign != D.$JSCompiler_alias_NULL$$ ? $options$$185_titles$$.hAlign : $options$$185_titles$$.halign;
  ...
  $contentDims_isRTL$$33_valign$$5$$ = $options$$185_titles$$.vAlign != D.$JSCompiler_alias_NULL$$ ? $options$$185_titles$$.vAlign : $options$$185_titles$$.valign;
  ...
  for($contentContainer$$3_i$$703$$ = 0;$contentContainer$$3_i$$703$$ < $options$$185_titles$$.length;$contentContainer$$3_i$$703$$++) {
    (0,D.$DvtLayoutUtils$align$$)($context$$454_totalDim$$, $options$$185_titles$$[$contentContainer$$3_i$$703$$].$halign$, $options$$185_titles$$[$contentContainer$$3_i$$703$$].text, $options$$185_titles$$[$contentContainer$$3_i$$703$$].text.$measureDimensions$().$w$)
  }
  return $contentDims_isRTL$$33_valign$$5$$
};
D.$DvtLegendRenderer$$.$_renderContents$ = function $$DvtLegendRenderer$$$$_renderContents$$($legend$$12_sectionsDim$$, $container$$132$$, $availSpace$$89$$) {
  ...
  var $title$$14$$ = D.$DvtLegendRenderer$$.$_renderTitle$($legend$$12_sectionsDim$$, $container$$132$$, $options$$186$$.title, $availSpace$$89$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_TRUE$$);
  if($title$$14$$) {
...
D.$DvtLegendRenderer$$.$_renderBackground$ = function $$DvtLegendRenderer$$$$_renderBackground$$($legend$$13$$, $availSpace$$90$$) {
  ...
  if($backgroundColor$$23$$ || $borderColor$$51_options$$187$$) {
    ...
    $legend$$13$$.$getEventManager$().$associate$($rect$$33$$, new D.$DvtSimpleObjPeer$$(D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, {type:D.$DvtLegendConstants$$.$BACKGROUND$, id:D.$JSCompiler_alias_VOID$$}));
    $legend$$13$$.$addChild$($rect$$33$$)
  }
};
D.$DvtLegendRenderer$$.$_renderTitle$ = function $$DvtLegendRenderer$$$$_renderTitle$$($legend$$14$$, $container$$133_params$$53$$, $title$$15_titleStr$$, $availSpace$$91$$, $section$$7$$, $isAligned$$, $id$$225$$) {
  var $options$$188$$ = $legend$$14$$.$getOptions$(), $context$$455_titleStyle$$2$$ = $container$$133_params$$53$$.$getCtx$(), $isRTL$$34$$ = (0,D.$DvtAgent$isRightToLeft$$)($context$$455_titleStyle$$2$$);
  ...
  return D.$DvtTextUtils$$.$fitText$($title$$15_titleStr$$, $availSpace$$91$$.$w$, window.Infinity, $container$$133_params$$53$$) ? ($isRTL$$34$$ && $title$$15_titleStr$$.$setX$($availSpace$$91$$.x + $availSpace$$91$$.$w$ - $title$$15_titleStr$$.$measureDimensions$().$w$), $options$$188$$.isLayout ? $container$$133_params$$53$$.removeChild($title$$15_titleStr$$) : ($container$$133_params$$53$$ = {type:D.$DvtLegendConstants$$.$TITLE$, id:$id$$225$$}, $container$$133_params$$53$$.isCollapsible = $section$$7$$ && 
  ("on" == $section$$7$$.collapsible || $section$$7$$.collapsible == D.$JSCompiler_alias_TRUE$$), $legend$$14$$.$getEventManager$().$associate$($title$$15_titleStr$$, new D.$DvtSimpleObjPeer$$($title$$15_titleStr$$.$getUntruncatedTextString$(), D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, $container$$133_params$$53$$)), $isAligned$$ && $legend$$14$$.$_titles$.push({text:$title$$15_titleStr$$, $halign$:$section$$7$$ && $section$$7$$.titleHalign ? $section$$7$$.titleHalign : $options$$188$$.titleHalign})), 
  $title$$15_titleStr$$) : D.$JSCompiler_alias_NULL$$
};
D.$DvtLegendRenderer$$.$_renderSections$ = function $$DvtLegendRenderer$$$$_renderSections$$($legend$$15$$, $container$$134$$, $sections$$4$$, $availSpace$$92$$, $id$$226$$) {
  var $isHoriz$$16_options$$189$$ = $legend$$15$$.$getOptions$();
  $isHoriz$$16_options$$189$$.symbolWidth == D.$JSCompiler_alias_NULL$$ && $isHoriz$$16_options$$189$$.symbolHeight == D.$JSCompiler_alias_NULL$$ ? ($isHoriz$$16_options$$189$$.symbolWidth = D.$DvtLegendRenderer$$.$_DEFAULT_SYMBOL_SIZE$, $isHoriz$$16_options$$189$$.symbolHeight = D.$DvtLegendRenderer$$.$_DEFAULT_SYMBOL_SIZE$) : ($isHoriz$$16_options$$189$$.symbolWidth == D.$JSCompiler_alias_NULL$$ ? $isHoriz$$16_options$$189$$.symbolWidth = $isHoriz$$16_options$$189$$.symbolHeight : $isHoriz$$16_options$$189$$.symbolHeight == 
  D.$JSCompiler_alias_NULL$$ && ($isHoriz$$16_options$$189$$.symbolHeight = $isHoriz$$16_options$$189$$.symbolWidth), $isHoriz$$16_options$$189$$.symbolWidth = (0,window.parseInt)($isHoriz$$16_options$$189$$.symbolWidth), $isHoriz$$16_options$$189$$.symbolHeight = (0,window.parseInt)($isHoriz$$16_options$$189$$.symbolHeight));
  ...
  $isHoriz$$16_options$$189$$.orientation, $totalDim$$1$$ = D.$JSCompiler_alias_NULL$$, $horizAvailSpace$$ = $availSpace$$92$$.$clone$(), $sectionDim$$, $i$$704$$ = 0;$i$$704$$ < $sections$$4$$.length;$i$$704$$++) {
    var $sectionId$$2$$ = $id$$226$$.concat([$i$$704$$]), $gapHeight$$3$$ = "off" == $sections$$4$$[$i$$704$$].expanded || $sections$$4$$[$i$$704$$].expanded == D.$JSCompiler_alias_FALSE$$ ? $titleGapHeight$$ : $sectionGapHeight$$;
    $isHoriz$$16_options$$189$$ ? ($sectionDim$$ = D.$DvtLegendRenderer$$.$_renderHorizontalSection$($legend$$15$$, $container$$134$$, $sections$$4$$[$i$$704$$], $horizAvailSpace$$, $rowHeight$$2$$), $sectionDim$$.$w$ > $horizAvailSpace$$.$w$ ? ($horizAvailSpace$$.$w$ < $availSpace$$92$$.$w$ && ($availSpace$$92$$.y += $sectionDim$$.$h$ + $gapHeight$$3$$, $availSpace$$92$$.$h$ -= $sectionDim$$.$h$ + $gapHeight$$3$$), $sectionDim$$ = $sectionDim$$.$w$ <= $availSpace$$92$$.$w$ ? D.$DvtLegendRenderer$$.$_renderHorizontalSection$($legend$$15$$, 
    $container$$134$$, $sections$$4$$[$i$$704$$], $availSpace$$92$$, $rowHeight$$2$$) : D.$DvtLegendRenderer$$.$_renderVerticalSection$($legend$$15$$, $container$$134$$, $sections$$4$$[$i$$704$$], $availSpace$$92$$, $rowHeight$$2$$, $sectionId$$2$$, D.$JSCompiler_alias_TRUE$$), $availSpace$$92$$.y += $sectionDim$$.$h$ + $gapHeight$$3$$, $availSpace$$92$$.$h$ -= $sectionDim$$.$h$ + $gapHeight$$3$$, $horizAvailSpace$$ = $availSpace$$92$$.$clone$()) : ($horizAvailSpace$$.$w$ -= $sectionDim$$.$w$ + $gapWidth$$3$$, 
    (0,D.$DvtAgent$isRightToLeft$$)($legend$$15$$.$getCtx$()) || ($horizAvailSpace$$.x += $sectionDim$$.$w$ + $gapWidth$$3$$))) : ($sectionDim$$ = D.$DvtLegendRenderer$$.$_renderVerticalSection$($legend$$15$$, $container$$134$$, $sections$$4$$[$i$$704$$], $availSpace$$92$$, $rowHeight$$2$$, $sectionId$$2$$, D.$JSCompiler_alias_FALSE$$), $availSpace$$92$$.y += $sectionDim$$.$h$ + $gapHeight$$3$$, $availSpace$$92$$.$h$ -= $sectionDim$$.$h$ + $gapHeight$$3$$);
    $totalDim$$1$$ = $totalDim$$1$$ ? (0,D.$JSCompiler_StaticMethods_getUnion$$)($totalDim$$1$$, $sectionDim$$) : $sectionDim$$
  }
  return $totalDim$$1$$
};
D.$DvtLegendRenderer$$.$_createButton$ = function $$DvtLegendRenderer$$$$_createButton$$($button$$65_context$$456$$, $legend$$16_peer$$23$$, $item$$33$$, $downState$$14_resources$$5$$, $prefix$$5$$, $x$$237$$, $y$$211$$, $tooltip$$37$$, $id$$227$$, $callback$$118$$, $callbackObj$$71$$) {
  var $upState$$17$$ = D.$DvtLegendRenderer$$.$_createButtonImage$($button$$65_context$$456$$, $downState$$14_resources$$5$$, $prefix$$5$$ + "Enabled", $x$$237$$, $y$$211$$), $overState$$14$$ = D.$DvtLegendRenderer$$.$_createButtonImage$($button$$65_context$$456$$, $downState$$14_resources$$5$$, $prefix$$5$$ + "Over", $x$$237$$, $y$$211$$);
  $downState$$14_resources$$5$$ = D.$DvtLegendRenderer$$.$_createButtonImage$($button$$65_context$$456$$, $downState$$14_resources$$5$$, $prefix$$5$$ + "Down", $x$$237$$, $y$$211$$);
  $button$$65_context$$456$$ = new D.$DvtButton$$($button$$65_context$$456$$, $upState$$17$$, $overState$$14$$, $downState$$14_resources$$5$$, D.$JSCompiler_alias_NULL$$, $id$$227$$, $callback$$118$$, $callbackObj$$71$$);
  $legend$$16_peer$$23$$ = (0,D.$DvtLegendObjPeer$associate$$)([$button$$65_context$$456$$], $legend$$16_peer$$23$$, $item$$33$$, $tooltip$$37$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_FALSE$$);
...
D.$DvtLegendRenderer$$.$_createButtonImage$ = function $$DvtLegendRenderer$$$$_createButtonImage$$($context$$457_image$$13$$, $resources$$6$$, $name$$101$$, $x$$238$$, $y$$212$$) {
  var $suffix$$3$$ = (0,D.$DvtAgent$isRightToLeft$$)($context$$457_image$$13$$) ? "RTL" : "";
  $context$$457_image$$13$$ = new D.$DvtImage$$($context$$457_image$$13$$, $resources$$6$$[$name$$101$$ + $suffix$$3$$] ? $resources$$6$$[$name$$101$$ + $suffix$$3$$] : $resources$$6$$[$name$$101$$], $x$$238$$, $y$$212$$, D.$DvtLegendRenderer$$.$_BUTTON_SIZE$, D.$DvtLegendRenderer$$.$_BUTTON_SIZE$);
  (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($context$$457_image$$13$$);
  return $context$$457_image$$13$$
};
D.$DvtLegendRenderer$$.$_renderVerticalSection$ = function $$DvtLegendRenderer$$$$_renderVerticalSection$$($legend$$17$$, $container$$135$$, $section$$8$$, $availSpace$$93_sectionSpace$$, $rowHeight$$3$$, $id$$228_nestedSectionDim_numRows$$, $minimizeNumRows_numCols$$) {
  if($section$$8$$) {
    ...
    if($isCollapsible_sectionDim$$1_title$$16_titleDim$$1$$) {
      ...
      if(!$options$$190_textSpace$$.isLayout) {
        ...
        $em$$4_i$$705$$ = $legend$$17$$.$getEventManager$(), $button$$66_buttonGap_colInfo_colWidth_context$$458_titleGap$$1$$ = D.$DvtLegendRenderer$$.$_createButton$($button$$66_buttonGap_colInfo_colWidth_context$$458_titleGap$$1$$, $legend$$17$$, $section$$8$$, $options$$190_textSpace$$._resources, $buttonType_contentHeight$$2_currCol$$, $buttonDim_buttonX_colInitY$$, $availSpace$$93_sectionSpace$$.y, $buttonTooltip_contentWidth$$4_isCollapsed_numItems$$2$$, $id$$228_nestedSectionDim_numRows$$, 
        $em$$4_i$$705$$.$onCollapseButtonClick$, $em$$4_i$$705$$);
    ...
    $isCollapsible_sectionDim$$1_title$$16_titleDim$$1$$ = ($isCollapsible_sectionDim$$1_title$$16_titleDim$$1$$ = D.$DvtLegendRenderer$$.$_renderTitle$($legend$$17$$, $container$$135$$, $section$$8$$.title, $availSpace$$93_sectionSpace$$, $section$$8$$, !$isCollapsible_sectionDim$$1_title$$16_titleDim$$1$$ && 1 >= $id$$228_nestedSectionDim_numRows$$.length, $id$$228_nestedSectionDim_numRows$$)) ? $isCollapsible_sectionDim$$1_title$$16_titleDim$$1$$.$measureDimensions$() : new D.$DvtRectangle$$($isRTL$$35$$ ? 
    ...
    $section$$8$$.sections && ($id$$228_nestedSectionDim_numRows$$ = D.$DvtLegendRenderer$$.$_renderSections$($legend$$17$$, $container$$135$$, $section$$8$$.sections, $availSpace$$93_sectionSpace$$, $id$$228_nestedSectionDim_numRows$$), $isCollapsible_sectionDim$$1_title$$16_titleDim$$1$$ = (0,D.$JSCompiler_StaticMethods_getUnion$$)($isCollapsible_sectionDim$$1_title$$16_titleDim$$1$$, $id$$228_nestedSectionDim_numRows$$));
    if(!$section$$8$$.items) {
      return $isCollapsible_sectionDim$$1_title$$16_titleDim$$1$$
    }
    ...
    $id$$228_nestedSectionDim_numRows$$ = $button$$66_buttonGap_colInfo_colWidth_context$$458_titleGap$$1$$.numRows;
...
D.$DvtLegendRenderer$$.$_renderHorizontalSection$ = function $$DvtLegendRenderer$$$$_renderHorizontalSection$$($legend$$18$$, $container$$136$$, $section$$9$$, $availSpace$$94_colWidth$$1$$, $rowHeight$$4$$) {
  if($section$$9$$) {
    ...
    $sectionSpace$$1$$ = $availSpace$$94_colWidth$$1$$.$clone$(), $title$$17$$ = D.$DvtLegendRenderer$$.$_renderTitle$($legend$$18$$, $container$$136$$, $section$$9$$.title, $availSpace$$94_colWidth$$1$$, $section$$9$$, D.$JSCompiler_alias_FALSE$$), $sectionDim$$2_titleDim$$2$$ = $title$$17$$ ? $title$$17$$.$measureDimensions$() : new D.$DvtRectangle$$($isRTL$$36$$ ? $availSpace$$94_colWidth$$1$$.x + $availSpace$$94_colWidth$$1$$.$w$ : $availSpace$$94_colWidth$$1$$.x, $availSpace$$94_colWidth$$1$$.y, 
    0, 0);
    if($section$$9$$.items) {
    ...
    var $textWidths$$1_titleGap$$2$$ = [], $totalWidth$$5$$ = $availSpace$$94_colWidth$$1$$.$w$ - $sectionSpace$$1$$.$w$, $item$$35_textWidth$$3$$, $i$$706$$;
    for($i$$706$$ = 0;$i$$706$$ < $numItems$$3$$;$i$$706$$++) {
      $item$$35_textWidth$$3$$ = $section$$9$$.items[$i$$706$$], $item$$35_textWidth$$3$$ = window.Math.ceil(D.$DvtTextUtils$$.$getTextStringWidth$($legend$$18$$.$getCtx$(), $item$$35_textWidth$$3$$.text, $options$$191$$.textStyle)), $totalWidth$$5$$ += $item$$35_textWidth$$3$$ + $symbolWidth$$ + $symbolGap$$1$$ + $colGap$$1$$, $textWidths$$1_titleGap$$2$$.push($item$$35_textWidth$$3$$)
    }
    0 < $numItems$$3$$ && ($totalWidth$$5$$ -= $colGap$$1$$);
    $sectionDim$$2_titleDim$$2$$ = new D.$DvtRectangle$$($isRTL$$36$$ ? $availSpace$$94_colWidth$$1$$.x + $availSpace$$94_colWidth$$1$$.$w$ - $totalWidth$$5$$ : $availSpace$$94_colWidth$$1$$.x, $availSpace$$94_colWidth$$1$$.y, $totalWidth$$5$$, window.Math.max($rowHeight$$4$$, $sectionDim$$2_titleDim$$2$$.$h$));
    if($options$$191$$.isLayout || $totalWidth$$5$$ > $availSpace$$94_colWidth$$1$$.$w$) {
      return $container$$136$$.removeChild($title$$17$$), $sectionDim$$2_titleDim$$2$$
    }
    for($i$$706$$ = 0;$i$$706$$ < $numItems$$3$$;$i$$706$$++) {
      $item$$35_textWidth$$3$$ = $section$$9$$.items[$i$$706$$], D.$DvtLegendRenderer$$.$_createLegendItem$($legend$$18$$, $container$$136$$, $item$$35_textWidth$$3$$, $sectionSpace$$1$$, $textWidths$$1_titleGap$$2$$[$i$$706$$], $rowHeight$$4$$, $i$$706$$), $availSpace$$94_colWidth$$1$$ = $textWidths$$1_titleGap$$2$$[$i$$706$$] + $symbolWidth$$ + $symbolGap$$1$$, $sectionSpace$$1$$.$w$ -= $availSpace$$94_colWidth$$1$$ + $colGap$$1$$, $isRTL$$36$$ || ($sectionSpace$$1$$.x += $availSpace$$94_colWidth$$1$$ + 
      $colGap$$1$$)
    }
    return $sectionDim$$2_titleDim$$2$$
  }
...
D.$DvtLegendRenderer$$.$_calcColumns$ = function $$DvtLegendRenderer$$$$_calcColumns$$($colGap$$2_legend$$19$$, $availSpace$$95_colWidth$$2$$, $numRows$$1_rowHeight$$5$$, $items$$28$$, $minimizeNumRows$$1_numCols$$1$$) {
  for(var $options$$192$$ = $colGap$$2_legend$$19$$.$getOptions$(), $fullColWidth_textWidth$$4$$ = 0, $i$$707_symbolWidth$$1$$ = 0;$i$$707_symbolWidth$$1$$ < $items$$28$$.length;$i$$707_symbolWidth$$1$$++) {
    var $rowGap$$1_tempWidth$$ = D.$DvtTextUtils$$.$getTextStringWidth$($colGap$$2_legend$$19$$.$getCtx$(), $items$$28$$[$i$$707_symbolWidth$$1$$].text, $options$$192$$.textStyle);
    $rowGap$$1_tempWidth$$ > $fullColWidth_textWidth$$4$$ && ($fullColWidth_textWidth$$4$$ = $rowGap$$1_tempWidth$$)
  }
  var $i$$707_symbolWidth$$1$$ = $options$$192$$.symbolWidth, $symbolGap$$2$$ = (0,D.$DvtLegendDefaults$getGapSize$$)($colGap$$2_legend$$19$$, $options$$192$$.layout.symbolGapWidth), $rowGap$$1_tempWidth$$ = (0,D.$DvtLegendDefaults$getGapSize$$)($colGap$$2_legend$$19$$, $options$$192$$.layout.rowGap);
  $colGap$$2_legend$$19$$ = (0,D.$DvtLegendDefaults$getGapSize$$)($colGap$$2_legend$$19$$, $options$$192$$.layout.columnGap);
  $fullColWidth_textWidth$$4$$ = window.Math.ceil($i$$707_symbolWidth$$1$$ + $symbolGap$$2$$ + $fullColWidth_textWidth$$4$$);
  ...
  return $availSpace$$95_colWidth$$2$$ < $i$$707_symbolWidth$$1$$ ? {width:0, numCols:0, numRows:0} : {width:$availSpace$$95_colWidth$$2$$, numCols:$minimizeNumRows$$1_numCols$$1$$, numRows:$numRows$$1_rowHeight$$5$$}
};
...
D.$DvtLegendRenderer$$.$_createLegendItem$ = function $$DvtLegendRenderer$$$$_createLegendItem$$($legend$$21$$, $container$$137_displayables$$22$$, $item$$37$$, $availSpace$$96_itemRect$$, $textSpace$$1$$, $rowHeight$$6$$) {
  ...
  $textX$$ = $isRTL$$37$$ ? $availSpace$$96_itemRect$$.x + $availSpace$$96_itemRect$$.$w$ - $symbolWidth$$2$$ - $symbolGap$$3$$ : $availSpace$$96_itemRect$$.x + $symbolWidth$$2$$ + $symbolGap$$3$$, $marker$$13$$ = D.$DvtLegendRenderer$$.$_createLegendSymbol$($legend$$21$$, $symbolX$$, $availSpace$$96_itemRect$$.y, $rowHeight$$6$$, $item$$37$$), $label$$59$$ = $item$$37$$.text, $peer$$24_text$$98$$;
  if($label$$59$$ && ($peer$$24_text$$98$$ = D.$DvtLegendRenderer$$.$_createLegendText$($container$$137_displayables$$22$$, $textSpace$$1$$, $label$$59$$, $hideAndShow$$4_options$$194$$.textStyle))) {
  ...
  $peer$$24_text$$98$$ != D.$JSCompiler_alias_NULL$$ && $container$$137_displayables$$22$$.push($peer$$24_text$$98$$);
  $peer$$24_text$$98$$ = (0,D.$DvtLegendObjPeer$associate$$)($container$$137_displayables$$22$$, $legend$$21$$, $item$$37$$, $peer$$24_text$$98$$ != D.$JSCompiler_alias_NULL$$ ? $peer$$24_text$$98$$.$getUntruncatedTextString$() : D.$JSCompiler_alias_NULL$$, $item$$37$$.shortDesc, D.$DvtLegendRenderer$$.$_isItemDrillable$($legend$$21$$, $item$$37$$));
  ...
  if("none" != $hideAndShow$$4_options$$194$$ && "off" != $hideAndShow$$4_options$$194$$ || $item$$37$$.shortDesc != D.$JSCompiler_alias_NULL$$) {
...
D.$DvtLegendRenderer$$.$_createLegendText$ = function $$DvtLegendRenderer$$$$_createLegendText$$($container$$138$$, $textSpace$$2$$, $label$$60_text$$99$$, $style$$99$$) {
  $label$$60_text$$99$$ = new D.$DvtOutputText$$($container$$138$$.$getCtx$(), $label$$60_text$$99$$);
  $label$$60_text$$99$$.$setCSSStyle$($style$$99$$);
  return $label$$60_text$$99$$ = D.$DvtTextUtils$$.$fitText$($label$$60_text$$99$$, $textSpace$$2$$, window.Infinity, $container$$138$$) ? $label$$60_text$$99$$ : D.$JSCompiler_alias_NULL$$
};
D.$DvtLegendRenderer$$.$_createLegendSymbol$ = function $$DvtLegendRenderer$$$$_createLegendSymbol$$($legend$$23$$, $symbol$$1_x$$239$$, $y$$213$$, $rowHeight$$7$$, $item$$39$$) {
  ...
  var $symbolWidth$$3$$ = $legendOptions$$6_symbolHeight$$1$$.symbolWidth, $legendOptions$$6_symbolHeight$$1$$ = $legendOptions$$6_symbolHeight$$1$$.symbolHeight, $cy$$55$$ = $y$$213$$ + $rowHeight$$7$$ / 2, $cx$$54$$ = $symbol$$1_x$$239$$ + $symbolWidth$$3$$ / 2, $symbolType$$ = $item$$39$$.type != D.$JSCompiler_alias_NULL$$ ? $item$$39$$.type : $item$$39$$.symbolType;
  ...
  $symbol$$1_x$$239$$, $y$$213$$, $symbolWidth$$3$$, $rowHeight$$7$$, $item$$39$$), D.$DvtLegendRenderer$$.$isCategoryHidden$(D.$DvtLegendRenderer$$.$getItemCategory$($item$$39$$), $legend$$23$$) || $symbol$$1_x$$239$$.$addChild$(D.$DvtLegendRenderer$$.$_createMarker$($legend$$23$$, $cx$$54$$, $cy$$55$$, $symbolWidth$$3$$ * D.$DvtLegendRenderer$$.$_LINE_MARKER_SIZE_FACTOR$, $legendOptions$$6_symbolHeight$$1$$ * D.$DvtLegendRenderer$$.$_LINE_MARKER_SIZE_FACTOR$, $item$$39$$))) : $symbol$$1_x$$239$$ = 
  "image" == $symbolType$$ ? D.$DvtLegendRenderer$$.$_createImage$($legend$$23$$, $symbol$$1_x$$239$$, $y$$213$$, $symbolWidth$$3$$, $legendOptions$$6_symbolHeight$$1$$, $rowHeight$$7$$, $item$$39$$) : D.$DvtLegendRenderer$$.$_createMarker$($legend$$23$$, $cx$$54$$, $cy$$55$$, $symbolWidth$$3$$, $legendOptions$$6_symbolHeight$$1$$, $item$$39$$);
...
D.$DvtLegendRenderer$$.$_createLine$ = function $$DvtLegendRenderer$$$$_createLine$$($context$$462_line$$11$$, $stroke$$98_x$$241$$, $lineY_y$$215$$, $colWidth$$3$$, $rowHeight$$9$$, $item$$42_style$$100$$) {
  $lineY_y$$215$$ += $rowHeight$$9$$ / 2;
  $context$$462_line$$11$$ = new D.$DvtLine$$($context$$462_line$$11$$, $stroke$$98_x$$241$$, $lineY_y$$215$$, $stroke$$98_x$$241$$ + $colWidth$$3$$, $lineY_y$$215$$);
  ...
  $context$$462_line$$11$$.$setStroke$($stroke$$98_x$$241$$);
...
D.$DvtLegendRenderer$$.$getItemCategory$ = function $$DvtLegendRenderer$$$$getItemCategory$$($item$$43$$) {
  var $category$$17$$ = D.$JSCompiler_alias_NULL$$;
...
D.$DvtLegendRenderer$$.$isCategoryHidden$ = function $$DvtLegendRenderer$$$$isCategoryHidden$$($category$$18$$, $legend$$26$$) {
  ...
  return!$hiddenCategories$$9$$ || 0 >= $hiddenCategories$$9$$.length ? D.$JSCompiler_alias_FALSE$$ : -1 !== D.$DvtArrayUtils$$.$getIndex$($hiddenCategories$$9$$, $category$$18$$)
};
