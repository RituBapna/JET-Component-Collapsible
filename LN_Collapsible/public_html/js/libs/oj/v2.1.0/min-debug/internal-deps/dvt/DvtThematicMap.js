...
D.$DvtAmxThematicMap$$ = function $$DvtAmxThematicMap$$$($context$$589$$, $callback$$154$$, $callbackObj$$104$$) {
  this.Init($context$$589$$, $callback$$154$$, $callbackObj$$104$$)
};
...
D.$DvtAmxThematicMap$$.prototype.Init = function $$DvtAmxThematicMap$$$$Init$($context$$590$$, $callback$$155$$, $callbackObj$$105$$) {
  D.$DvtAmxThematicMap$$.$superclass$.Init.call(this, $context$$590$$);
  this.$_tmap$ = new D.$DvtThematicMap$$($context$$590$$, $callback$$155$$, $callbackObj$$105$$);
...
D.$DvtAmxThematicMap$$.newInstance = function $$DvtAmxThematicMap$$$newInstance$($context$$591$$, $callback$$156$$, $callbackObj$$106$$) {
  return new D.$DvtAmxThematicMap$$($context$$591$$, $callback$$156$$, $callbackObj$$106$$)
};
...
D.$DvtAmxThematicMap$$.prototype.$_renderLegend$ = function $$DvtAmxThematicMap$$$$$_renderLegend$$($container$$190$$, $availSpace$$128$$) {
  this.$_legend$ && ($container$$190$$.removeChild(this.$_legend$), this.$_legend$ = D.$JSCompiler_alias_NULL$$);
...
D.$DvtAmxThematicMap$$.prototype.$_addLegendData$ = function $$DvtAmxThematicMap$$$$$_addLegendData$$($data$$97$$, $legendOptions$$11$$) {
  $legendOptions$$11$$.title = $data$$97$$.legend ? $data$$97$$.legend.title : D.$JSCompiler_alias_NULL$$;
  $legendOptions$$11$$.sections = [];
  if($data$$97$$ && $data$$97$$.legend && $data$$97$$.legend.sections) {
    for(var $i$$791$$ = 0;$i$$791$$ < $data$$97$$.legend.sections.length;$i$$791$$++) {
      var $dataSection$$1$$ = $data$$97$$.legend.sections[$i$$791$$];
...
D.$DvtThematicMap$$ = function $$DvtThematicMap$$$($context$$602$$, $callback$$157$$, $callbackObj$$107$$) {
  this.Init($context$$602$$, $callback$$157$$, $callbackObj$$107$$)
};
...
D.$DvtThematicMap$$.prototype.Init = function $$DvtThematicMap$$$$Init$($context$$603$$, $callback$$158$$, $callbackObj$$108$$) {
  D.$DvtThematicMap$$.$superclass$.Init.call(this, $context$$603$$, $callback$$158$$, $callbackObj$$108$$);
...
D.$DvtThematicMap$$.newInstance = function $$DvtThematicMap$$$newInstance$($context$$604$$, $callback$$159$$, $callbackObj$$109$$) {
  return new D.$DvtThematicMap$$($context$$604$$, $callback$$159$$, $callbackObj$$109$$)
};
...
D.$JSCompiler_StaticMethods_getLayer$$ = function $$JSCompiler_StaticMethods_getLayer$$$($JSCompiler_StaticMethods_getLayer$self$$, $layerName$$21$$) {
  for(var $i$$814$$ = 0;$i$$814$$ < $JSCompiler_StaticMethods_getLayer$self$$.$_layers$.length;$i$$814$$++) {
    if($JSCompiler_StaticMethods_getLayer$self$$.$_layers$[$i$$814$$].$LayerName$ == $layerName$$21$$) {
      return $JSCompiler_StaticMethods_getLayer$self$$.$_layers$[$i$$814$$]
    }
  }
};
...
D.$JSCompiler_prototypeAlias$$ = D.$DvtThematicMap$$.prototype;
D.$JSCompiler_prototypeAlias$$.$HandleLegendResize$ = function $$JSCompiler_prototypeAlias$$$$HandleLegendResize$$($event$$750_x$$278$$) {
  (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()) || ($event$$750_x$$278$$ = this.getWidth() - 5 - $event$$750_x$$278$$.getWidth(), this.$_legendPanel$.$setTranslateX$($event$$750_x$$278$$))
};
D.$JSCompiler_prototypeAlias$$.$_renderLegend$ = function $$JSCompiler_prototypeAlias$$$$_renderLegend$$() {
  if(this.$_legendData$) {
    ...
    var $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$ = "true" == this.$_legendData$.disclosed, $isFixed$$2$$ = "fixed" == this.$_legendData$.display || (0,D.$DvtAgent$isEnvironmentBatik$$)();
    if(!$isFixed$$2$$ || $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$) {
      var $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$ = this.$_legendData$.maxWidth, $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$ = $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$.indexOf("%"), $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$ = 
      -1 != $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$ ? (0,window.parseFloat)($JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$.substring(0, $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$)) / 100 * this.getWidth() : (0,window.parseFloat)($JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$), 
      $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$ = this.getHeight() - 10;
      "alta" == this.$_skinName$ ? (this.$_legendPanel$ = new D.$DvtPanelDrawer$$(this.$getCtx$(), D.$JSCompiler_alias_NULL$$, this, "pd"), this.$_legendPanel$.$addEvtListener$("dvtPanelDrawerEvent", this.$HandleLegendEvent$, D.$JSCompiler_alias_FALSE$$, this), this.$_legendPanel$.$setMaxWidth$($JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$), this.$_legendPanel$.$setMaxHeight$($collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$), 
      this.$_legendPanel$.$_isFixed$ = $isFixed$$2$$, (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()) ? (this.$_legendPanel$.$_discloseDirection$ = "right", this.$_legendPanel$.$setTranslateX$(0)) : this.$_legendPanel$.$setTranslateX$(this.getWidth())) : (this.$_legendPanel$ = new D.$DvtCollapsiblePanel$$(this.$getCtx$(), $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$, $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$, 
      "col_northeast", (0,D.$JSCompiler_StaticMethods_getResourcesMap$$)(this), this.$getSubcomponentStyles$(), $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$, $isFixed$$2$$), this.$_legendPanel$.$addEvtListener$("dvtCollapsiblePanelEvent", this.$HandleLegendEvent$, D.$JSCompiler_alias_FALSE$$, this), this.$_legendPanel$.$addEvtListener$("dvtResizeEvent", this.$HandleLegendResize$, D.$JSCompiler_alias_FALSE$$, this), $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$ = 
      this.$_legendPanel$, $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$ = this.$_legendData$.collapseTooltip, $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$.$_expandTooltip$ = this.$_legendData$.expandTooltip, $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$.$_collapseTooltip$ = $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$);
      $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$ = this.$_legendData$;
      ...
      $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$ = this.$_legend$.$getPreferredSize$($JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$, this.$_legendPanel$.$getMaxContentWidth$(), this.$_legendPanel$.$getMaxContentHeight$());
      this.$_legend$.$render$($JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$, $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$.$w$, $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$.$h$);
      var $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$;
      if("alta" == this.$_skinName$) {
        ...
        var $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$ = new D.$DvtImage$$(this.$getCtx$(), (0,D.$JSCompiler_StaticMethods_getResourcesMap$$)(this).legendEna, 0, 0, 24, 24), $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$ = new D.$DvtImage$$(this.$getCtx$(), (0,D.$JSCompiler_StaticMethods_getResourcesMap$$)(this).legendOvr, 0, 0, 24, 24), $downState$$20$$ = new D.$DvtImage$$(this.$getCtx$(), 
        ...
        (0,D.$JSCompiler_StaticMethods_addPanel$$)(this.$_legendPanel$, this.$_legend$, $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$, $collapse$$inline_8417_maxHeight$$21_overState$$20_percentIndex$$1_preferredSize$$8$$, $downState$$20$$, $tip$$5$$, "legend");
        this.$_legendPanel$.$renderComponent$();
        $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$ && this.$_legendPanel$.$setDisclosed$(D.$JSCompiler_alias_TRUE$$, D.$JSCompiler_alias_TRUE$$)
      }else {
        $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$ = this.$_legendPanel$, $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$ = this.$_legend$, $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_contentContainer$.$addChild$($dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$), $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$.$addEvtListener$("dvtResizeEvent", 
        $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$HandleResize$, D.$JSCompiler_alias_FALSE$$, $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$), $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$ = $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_contentContainer$.$getDimensions$(), $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_width$ = 
        window.Math.min($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_maxWidth$, $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$.$w$ + 10), $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_height$ = window.Math.min($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_maxHeight$, $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$.$h$ + 
        10), $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_background$ ? ($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_background$.$setCmds$((0,D.$JSCompiler_StaticMethods__getOutlinePath$$)($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$, $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_width$, $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_height$)), $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$ = 
        "col_northwest" == $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_collapseDir$ || "col_southwest" == $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_collapseDir$, $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_buttonFrame$ && $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$ && $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_buttonFrame$.$setTranslateX$($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_width$)) : 
        ($dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$ = new D.$DvtPath$$($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$getCtx$(), (0,D.$JSCompiler_StaticMethods__getOutlinePath$$)($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$, $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_width$, $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_height$)), 
        $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$ = $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_styleMap$.borderAlpha, $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$.$setSolidFill$($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_bgColor$, $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_bgAlpha$), 
        $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$.$setSolidStroke$($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_borderColor$, $JSCompiler_StaticMethods_setButtonTooltips$self$$inline_8415_alpha$$inline_11364_legendData$$7_maxWidth$$33_upState$$23$$), $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_background$ = $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$, 
        $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$addChildAt$($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_background$, 0), $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_isFixed$ || ($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_buttonFrame$ = D.$DvtControlPanelLAFUtils$$.$createEmptyViewClosedFrame$($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$getCtx$(), 
        25, $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_styleMap$, D.$JSCompiler_alias_FALSE$$), $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_buttonFrame$.$setAlpha$($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_styleMap$.borderAlpha), $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$addChild$($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_buttonFrame$), $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$ = 
        ...
        $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$_collapse$ && (0,D.$JSCompiler_StaticMethods__collapseExpand$$)($JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$, D.$JSCompiler_alias_FALSE$$), $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$ = this.$_legendPanel$.$getDimensions$(), $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$ = (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()) ? 
        5 : this.getWidth() - 5 - $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$w$ - $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.x, (0,D.$JSCompiler_StaticMethods_setTranslate$$)(this.$_legendPanel$, $dims$$inline_8421_disclosed$$4_object$$inline_8420_rect$$inline_11363_west$$inline_11367_west$$inline_8422_x$$279$$, 5), $JSCompiler_StaticMethods_addContent$self$$inline_8419_legendPanelDim$$.$w$ += 5
      }
...
D.$JSCompiler_prototypeAlias$$.$_render$ = function $$JSCompiler_prototypeAlias$$$$_render$$($pzcContainer$$1$$, $cpContainer$$1$$) {
  ...
  var $isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$ = this.$_pzc$.$_contentPane$.$getMatrix$();
  this.$_topLayerRendered$ = D.$JSCompiler_alias_FALSE$$;
  for(var $i$$815$$ = 0;$i$$815$$ < this.$_layers$.length;$i$$815$$++) {
    var $layer$$11$$ = this.$_layers$[$i$$815$$];
    if(!this.$_topLayerRendered$ && $layer$$11$$ instanceof D.$DvtMapAreaLayer$$ || !($layer$$11$$ instanceof D.$DvtMapAreaLayer$$)) {
      $layer$$11$$.$render$($isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$), !this.$_topLayerRendered$ && $layer$$11$$ instanceof D.$DvtMapAreaLayer$$ && (this.$_topLayerRendered$ = D.$JSCompiler_alias_TRUE$$, this.$_topLayer$ = $layer$$11$$)
    }
  }
  this.$_topLayer$ && ($isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$ = this.$_topLayer$.$_isolatedArea$, this.$_isolatedArea$ != $isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$ && (this.$_isolatedArea$ = $isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$, this.$_initialZoom$ = this.$_initialCenterY$ = this.$_initialCenterX$ = D.$JSCompiler_alias_NULL$$), this.$_keyboardHandler$ && ($isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$ = 
  (0,D.$JSCompiler_StaticMethods_getNavigableAreas$$)(this), 0 == $isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$.length && ($isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$ = (0,D.$JSCompiler_StaticMethods_getNavigableObjects$$)(this)), ($isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$ = $isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$[0]) && D.$DvtThematicMapEventManager$$.$superclass$.$setFocus$.call(this.$_eventHandler$, 
  $isolatedArea$$1_navigable$$inline_8434_navigables$$13_pzcMatrix$$18$$)), this.$_pzc$.$setMinZoom$(D.$JSCompiler_alias_NULL$$), this.$_pzc$.$setMaxZoom$(D.$JSCompiler_alias_NULL$$), this.$_pzc$.$_bZoomingEnabled$ = D.$JSCompiler_alias_TRUE$$, this.$_pzc$.$_bPanningEnabled$ = D.$JSCompiler_alias_TRUE$$, !this.$_bBaseMapChanged$ && !this.$_isResize$ && this.$_initialZoom$ != D.$JSCompiler_alias_NULL$$ ? ((0,D.$JSCompiler_StaticMethods_zoomTo$$)(this.$_pzc$, this.$_initialZoom$), (0,D.$JSCompiler_StaticMethods_panTo$$)(this.$_pzc$, 
  this.$_initialCenterX$, this.$_initialCenterY$)) : this.$_pzc$.$zoomToFit$(D.$JSCompiler_alias_NULL$$, this.$_topLayer$.$getLayerDim$()), (0,D.$JSCompiler_StaticMethods__processInitialDrilled$$)(this), (0,D.$JSCompiler_StaticMethods__updateZoomLimits$$)(this), this.$_pzc$.$_bZoomingEnabled$ = this.$_zooming$, this.$_pzc$.$_bPanningEnabled$ = this.$_panning$)
};
D.$JSCompiler_prototypeAlias$$.$updateLayer$ = function $$JSCompiler_prototypeAlias$$$$updateLayer$$($dataLayerOptions_navigable$$inline_8449_navigables$$14$$, $parentLayer$$2$$, $isAreaDataLayer$$) {
  this.$_bRendered$ = D.$JSCompiler_alias_FALSE$$;
  (0,D.$JSCompiler_StaticMethods__stopAnimation$$)(this);
  (0,D.$JSCompiler_StaticMethods_ParseDataLayers$$)(new D.$DvtThematicMapJsonParser$$(this), [$dataLayerOptions_navigable$$inline_8449_navigables$$14$$], (0,D.$JSCompiler_StaticMethods_getLayer$$)(this, $parentLayer$$2$$), this.$_topLayer$.$LayerName$, $isAreaDataLayer$$);
  this.$_renderLegend$();
  this.$_bRendered$ = D.$JSCompiler_alias_TRUE$$;
  this.$_keyboardHandler$ && ($dataLayerOptions_navigable$$inline_8449_navigables$$14$$ = (0,D.$JSCompiler_StaticMethods_getNavigableAreas$$)(this), 0 == $dataLayerOptions_navigable$$inline_8449_navigables$$14$$.length && ($dataLayerOptions_navigable$$inline_8449_navigables$$14$$ = (0,D.$JSCompiler_StaticMethods_getNavigableObjects$$)(this)), ($dataLayerOptions_navigable$$inline_8449_navigables$$14$$ = $dataLayerOptions_navigable$$inline_8449_navigables$$14$$[0]) && D.$DvtThematicMapEventManager$$.$superclass$.$setFocus$.call(this.$_eventHandler$, 
  $dataLayerOptions_navigable$$inline_8449_navigables$$14$$));
  (0,D.$JSCompiler_StaticMethods_setKeyboardFocusArray$$)(this.$getCtx$(), [this]);
...
D.$JSCompiler_StaticMethods__updateZoomLimits$$ = function $$JSCompiler_StaticMethods__updateZoomLimits$$$($JSCompiler_StaticMethods__updateZoomLimits$self$$) {
  var $fittedZoom_zoomPadding$$inline_8456$$;
  $fittedZoom_zoomPadding$$inline_8456$$ = $JSCompiler_StaticMethods__updateZoomLimits$self$$.$_pzc$.$_zoomToFitPadding$;
  var $mapDim$$inline_8457$$ = $JSCompiler_StaticMethods__updateZoomLimits$self$$.$_topLayer$.$getLayerDim$(), $pzcDim$$inline_8458$$ = $JSCompiler_StaticMethods__updateZoomLimits$self$$.$_pzc$.$getSize$();
  $fittedZoom_zoomPadding$$inline_8456$$ = window.Math.min(($pzcDim$$inline_8458$$.$w$ - 2 * $fittedZoom_zoomPadding$$inline_8456$$) / $mapDim$$inline_8457$$.$w$, ($pzcDim$$inline_8458$$.$h$ - 2 * $fittedZoom_zoomPadding$$inline_8456$$) / $mapDim$$inline_8457$$.$h$);
  $JSCompiler_StaticMethods__updateZoomLimits$self$$.$_pzc$.$setMinZoom$($fittedZoom_zoomPadding$$inline_8456$$);
  $JSCompiler_StaticMethods__updateZoomLimits$self$$.$_pzc$.$setMaxZoom$($fittedZoom_zoomPadding$$inline_8456$$ * ($JSCompiler_StaticMethods__updateZoomLimits$self$$.$_zooming$ ? $JSCompiler_StaticMethods__updateZoomLimits$self$$.$_maxZoomFactor$ : 1))
};
...
D.$JSCompiler_StaticMethods__updateAnimator$$ = function $$JSCompiler_StaticMethods__updateAnimator$$$($JSCompiler_StaticMethods__updateAnimator$self$$, $animator$$132_event$$752$$, $bRecenterObjs_transMat$$) {
  if($animator$$132_event$$752$$ = $animator$$132_event$$752$$.$_animator$) {
    var $contentPane$$2$$ = $JSCompiler_StaticMethods__updateAnimator$self$$.$_pzc$.$_contentPane$, $mat$$51$$ = (0,D.$JSCompiler_StaticMethods_getDestVal$$)($animator$$132_event$$752$$, $contentPane$$2$$, $contentPane$$2$$.$getMatrix$);
    $bRecenterObjs_transMat$$ && ($JSCompiler_StaticMethods__updateAnimator$self$$.$_currentAnimMatrix$ = $contentPane$$2$$.$getMatrix$(), (0,D.$JSCompiler_StaticMethods_addProp$$)($animator$$132_event$$752$$, "typeMatrix", $JSCompiler_StaticMethods__updateAnimator$self$$, $JSCompiler_StaticMethods__updateAnimator$self$$.$_getCenteredObjsMatrix$, $JSCompiler_StaticMethods__updateAnimator$self$$.$_setCenteredObjsMatrix$, $mat$$51$$));
    $bRecenterObjs_transMat$$ = new D.$DvtMatrix$$(1, 0, 0, 1, $mat$$51$$.$_tx$, $mat$$51$$.$_ty$);
    $JSCompiler_StaticMethods__updateAnimator$self$$.$_isMarkerZoomBehaviorFixed$ && (0,D.$JSCompiler_StaticMethods_addProp$$)($animator$$132_event$$752$$, "typeMatrix", $JSCompiler_StaticMethods__updateAnimator$self$$.$_dataPointLayers$, $JSCompiler_StaticMethods__updateAnimator$self$$.$_dataPointLayers$.$getMatrix$, $JSCompiler_StaticMethods__updateAnimator$self$$.$_dataPointLayers$.$setMatrix$, $bRecenterObjs_transMat$$);
    (0,D.$JSCompiler_StaticMethods_addProp$$)($animator$$132_event$$752$$, "typeMatrix", $JSCompiler_StaticMethods__updateAnimator$self$$.$_labelLayers$, $JSCompiler_StaticMethods__updateAnimator$self$$.$_labelLayers$.$getMatrix$, $JSCompiler_StaticMethods__updateAnimator$self$$.$_labelLayers$.$setMatrix$, $bRecenterObjs_transMat$$)
  }
};
D.$DvtThematicMap$$.prototype.$HandleZoomEvent$ = function $$DvtThematicMap$$$$$HandleZoomEvent$$($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$) {
  switch($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.$getSubType$()) {
    case "adjustPanConstraints":
      if(this.$_panning$) {
        var $i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$ = $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.$_newZoom$;
        $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$ = this.$_pzc$.$_zoomToFitPadding$;
        var $pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$ = this.$_pzc$.$getSize$();
        $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$ = new D.$DvtRectangle$$($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$, $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$, $pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$.$w$ - 2 * $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$, $pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$.$h$ - 2 * 
        $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$);
        var $legendAdjust$$inline_8494_mapDim$$inline_8489$$ = this.$_topLayer$.$getLayerDim$(), $minMaxX$$inline_8495_zoomedMapX$$inline_8490$$ = $legendAdjust$$inline_8494_mapDim$$inline_8489$$.x * $i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$, $pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$ = $legendAdjust$$inline_8494_mapDim$$inline_8489$$.y * $i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$, $zoomedMapW$$inline_8492$$ = $legendAdjust$$inline_8494_mapDim$$inline_8489$$.$w$ * 
        $i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$, $i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$ = $legendAdjust$$inline_8494_mapDim$$inline_8489$$.$h$ * $i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$, $legendAdjust$$inline_8494_mapDim$$inline_8489$$ = 0;
        $zoomedMapW$$inline_8492$$ > $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.$w$ ? (this.$_isFixedLegend$ && (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()) && ($legendAdjust$$inline_8494_mapDim$$inline_8489$$ = this.$_legendWidth$), this.$_pzc$.$_minPanX$ = $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.x + $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.$w$ + $legendAdjust$$inline_8494_mapDim$$inline_8489$$ - 
        ($minMaxX$$inline_8495_zoomedMapX$$inline_8490$$ + $zoomedMapW$$inline_8492$$), this.$_pzc$.$_maxPanX$ = $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.x - $minMaxX$$inline_8495_zoomedMapX$$inline_8490$$ + $legendAdjust$$inline_8494_mapDim$$inline_8489$$) : (this.$_isFixedLegend$ && (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()) && ($legendAdjust$$inline_8494_mapDim$$inline_8489$$ = 2 * this.$_legendWidth$), $minMaxX$$inline_8495_zoomedMapX$$inline_8490$$ = 
        ($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.x + $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.$w$ + $legendAdjust$$inline_8494_mapDim$$inline_8489$$) / 2 - ($minMaxX$$inline_8495_zoomedMapX$$inline_8490$$ + $zoomedMapW$$inline_8492$$ / 2), this.$_pzc$.$_minPanX$ = $minMaxX$$inline_8495_zoomedMapX$$inline_8490$$, this.$_pzc$.$_maxPanX$ = $minMaxX$$inline_8495_zoomedMapX$$inline_8490$$);
        $i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$ > $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.$h$ ? (this.$_pzc$.$_minPanY$ = $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.y + $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.$h$ - ($pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$ + $i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$), this.$_pzc$.$_maxPanY$ = $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.y - 
        $pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$) : ($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$ = ($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.y + $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.$h$) / 2 - ($pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$ + $i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$ / 2), this.$_pzc$.$_minPanY$ = $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$, 
        this.$_pzc$.$_maxPanY$ = $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$)
      }
      break;
    case "zooming":
    ;
    case "elasticAnimBegin":
      (0,D.$JSCompiler_StaticMethods__updateAnimator$$)(this, $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$, D.$JSCompiler_alias_TRUE$$);
      break;
    case "zoomed":
      if($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.$_newZoom$ != D.$JSCompiler_alias_NULL$$) {
        $pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$ = this.$_pzc$.$_contentPane$.$getMatrix$();
        (0,D.$JSCompiler_StaticMethods_addParam$$)($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$, "panX", $pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$.$_tx$);
        (0,D.$JSCompiler_StaticMethods_addParam$$)($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$, "panY", $pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$.$_ty$);
        $event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$.$_animator$ = D.$JSCompiler_alias_NULL$$;
        this.dispatchEvent($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$);
        (0,D.$JSCompiler_StaticMethods__transformContainers$$)(this, $pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$);
        for($i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$ = 0;$i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$ < this.$_layers$.length;$i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$++) {
          this.$_layers$[$i$$816_zoom$$inline_8485_zoomedMapH$$inline_8493$$].$HandleZoomEvent$($event$$753_minMaxY$$inline_8496_padding$$inline_8486_viewportDim$$inline_8488$$, $pzcDim$$inline_8487_pzcMatrix$$20_zoomedMapY$$inline_8491$$)
        }
      }
      break;
    case "zoomAndCenter":
...
D.$DvtThematicMap$$.prototype.$HandlePanEvent$ = function $$DvtThematicMap$$$$$HandlePanEvent$$($event$$754_i$$817_stroke$$114$$) {
  var $subType$$9$$ = $event$$754_i$$817_stroke$$114$$.$getSubType$();
  if("elasticAnimBegin" == $subType$$9$$) {
    (0,D.$JSCompiler_StaticMethods__updateAnimator$$)(this, $event$$754_i$$817_stroke$$114$$, D.$JSCompiler_alias_FALSE$$)
  }else {
    if("panned" == $subType$$9$$ && $event$$754_i$$817_stroke$$114$$.$_newX$ != D.$JSCompiler_alias_NULL$$) {
      var $pzcMatrix$$21_styleMap$$93$$ = this.$_pzc$.$_contentPane$.$getMatrix$();
      (0,D.$JSCompiler_StaticMethods_addParam$$)($event$$754_i$$817_stroke$$114$$, "zoom", this.$_pzc$.$getZoom$());
      (0,D.$JSCompiler_StaticMethods_addParam$$)($event$$754_i$$817_stroke$$114$$, "panX", $pzcMatrix$$21_styleMap$$93$$.$_tx$);
      (0,D.$JSCompiler_StaticMethods_addParam$$)($event$$754_i$$817_stroke$$114$$, "panY", $pzcMatrix$$21_styleMap$$93$$.$_ty$);
      $event$$754_i$$817_stroke$$114$$.$_animator$ = D.$JSCompiler_alias_NULL$$;
      this.dispatchEvent($event$$754_i$$817_stroke$$114$$);
      (0,D.$JSCompiler_StaticMethods__transformContainers$$)(this, $pzcMatrix$$21_styleMap$$93$$);
      for($event$$754_i$$817_stroke$$114$$ = 0;$event$$754_i$$817_stroke$$114$$ < this.$_layers$.length;$event$$754_i$$817_stroke$$114$$++) {
        this.$_layers$[$event$$754_i$$817_stroke$$114$$].$HandlePanEvent$($pzcMatrix$$21_styleMap$$93$$)
      }
    }
  }
  this.$_legendPanel$ && ("alta" == this.$_skinName$ ? "dragPanBegin" === $subType$$9$$ ? this.$_legendPanel$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$) : "dragPanEnd" === $subType$$9$$ && this.$_legendPanel$.$setMouseEnabled$(D.$JSCompiler_alias_TRUE$$) : ($pzcMatrix$$21_styleMap$$93$$ = this.$getSubcomponentStyles$(), $event$$754_i$$817_stroke$$114$$ = this.$_legendPanel$.$_background$.$getStroke$().$clone$(), "dragPanBegin" === $subType$$9$$ ? (this.$_legend$.$setAlpha$($pzcMatrix$$21_styleMap$$93$$.backgroundDragAlpha), 
  $event$$754_i$$817_stroke$$114$$.$setAlpha$($pzcMatrix$$21_styleMap$$93$$.borderDragAlpha), this.$_legendPanel$.$_background$.$setStroke$($event$$754_i$$817_stroke$$114$$), this.$_legendPanel$.$_buttonFrame$ && this.$_legendPanel$.$_buttonFrame$.$setAlpha$($pzcMatrix$$21_styleMap$$93$$.borderDragAlpha), this.$_legendPanel$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$)) : "dragPanEnd" === $subType$$9$$ && (this.$_legend$.$setAlpha$(1), $event$$754_i$$817_stroke$$114$$.$setAlpha$($pzcMatrix$$21_styleMap$$93$$.borderAlpha), 
  this.$_legendPanel$.$_background$.$setStroke$($event$$754_i$$817_stroke$$114$$), this.$_legendPanel$.$_buttonFrame$ && this.$_legendPanel$.$_buttonFrame$.$setAlpha$($pzcMatrix$$21_styleMap$$93$$.borderAlpha), this.$_legendPanel$.$setMouseEnabled$(D.$JSCompiler_alias_TRUE$$))))
};
...
D.$JSCompiler_StaticMethods__processInitialDrilled$$ = function $$JSCompiler_StaticMethods__processInitialDrilled$$$($JSCompiler_StaticMethods__processInitialDrilled$self$$) {
  ...
  for(var $i$$818$$ = 0;$i$$818$$ < $JSCompiler_StaticMethods__processInitialDrilled$self$$.$_layers$.length;$i$$818$$++) {
    var $layerName$$23$$ = $JSCompiler_StaticMethods__processInitialDrilled$self$$.$_layers$[$i$$818$$].$LayerName$;
...
D.$DvtThematicMap$$.prototype.$resetMap$ = function $$DvtThematicMap$$$$$resetMap$$() {
  (0,D.$JSCompiler_StaticMethods__stopAnimation$$)(this);
  for(var $animator$$inline_8499_removeObjs$$ = [], $addObjs$$ = [], $i$$819_j$$113$$ = this.$_layers$.length - 1;-1 < $i$$819_j$$113$$;$i$$819_j$$113$$--) {
    this.$_layers$[$i$$819_j$$113$$].$LayerName$ == this.$_topLayer$.$LayerName$ ? this.$_layers$[$i$$819_j$$113$$].reset($addObjs$$) : this.$_layers$[$i$$819_j$$113$$].reset($animator$$inline_8499_removeObjs$$)
  }
  for($i$$819_j$$113$$ = 0;$i$$819_j$$113$$ < $animator$$inline_8499_removeObjs$$.length;$i$$819_j$$113$$++) {
    if($animator$$inline_8499_removeObjs$$[$i$$819_j$$113$$]) {
      var $parent$$88$$ = $animator$$inline_8499_removeObjs$$[$i$$819_j$$113$$].getParent();
      $parent$$88$$ && $parent$$88$$.removeChild($animator$$inline_8499_removeObjs$$[$i$$819_j$$113$$])
    }
  }
  for($i$$819_j$$113$$ = 0;$i$$819_j$$113$$ < $addObjs$$.length;$i$$819_j$$113$$++) {
    $addObjs$$[$i$$819_j$$113$$] && $addObjs$$[$i$$819_j$$113$$].$setAlpha$(1)
  }
  this.$_drilledRowKeys$ = [];
  $animator$$inline_8499_removeObjs$$ = new D.$DvtAnimator$$(this.$getCtx$(), 0.3);
  this.$_pzc$.$zoomToFit$($animator$$inline_8499_removeObjs$$);
  $animator$$inline_8499_removeObjs$$.play();
  this.$_drilled$ = [];
...
D.$JSCompiler_StaticMethods_fitSelectedRegions$$ = function $$JSCompiler_StaticMethods_fitSelectedRegions$$$($JSCompiler_StaticMethods_fitSelectedRegions$self$$) {
  if($JSCompiler_StaticMethods_fitSelectedRegions$self$$.$_clickedDataLayerId$) {
    ...
    if($dataLayer$$8_selection$$38_selectionHandler$$13$$ && ($dataLayer$$8_selection$$38_selectionHandler$$13$$ = $dataLayer$$8_selection$$38_selectionHandler$$13$$.$_selectionHandler$)) {
      for(var $dataLayer$$8_selection$$38_selectionHandler$$13$$ = $dataLayer$$8_selection$$38_selectionHandler$$13$$.getSelection(), $i$$820$$ = 0;$i$$820$$ < $dataLayer$$8_selection$$38_selectionHandler$$13$$.length;$i$$820$$++) {
        $dataLayer$$8_selection$$38_selectionHandler$$13$$[$i$$820$$] = $dataLayer$$8_selection$$38_selectionHandler$$13$$[$i$$820$$].$getDisplayable$()
      }
      if(0 < $dataLayer$$8_selection$$38_selectionHandler$$13$$.length) {
        for(var $bounds$$158$$ = $dataLayer$$8_selection$$38_selectionHandler$$13$$[0].$getDimensions$(), $i$$820$$ = 1;$i$$820$$ < $dataLayer$$8_selection$$38_selectionHandler$$13$$.length;$i$$820$$++) {
          $bounds$$158$$ = (0,D.$JSCompiler_StaticMethods_getUnion$$)($bounds$$158$$, $dataLayer$$8_selection$$38_selectionHandler$$13$$[$i$$820$$].$getDimensions$())
        }
...
D.$JSCompiler_StaticMethods_getNavigableAreas$$ = function $$JSCompiler_StaticMethods_getNavigableAreas$$$($JSCompiler_StaticMethods_getNavigableAreas$self$$) {
  ...
  if($JSCompiler_StaticMethods_getNavigableAreas$self$$.$_topLayer$) {
    for(var $i$$821$$ = 0;$i$$821$$ < $JSCompiler_StaticMethods_getNavigableAreas$self$$.$_layers$.length;$i$$821$$++) {
      var $dataLayers$$ = $JSCompiler_StaticMethods_getNavigableAreas$self$$.$_layers$[$i$$821$$].$DataLayers$, $id$$296$$;
      for($id$$296$$ in $dataLayers$$) {
        $disclosed$$5$$ = $JSCompiler_StaticMethods_getNavigableAreas$self$$.$_topLayer$.$LayerName$ == $JSCompiler_StaticMethods_getNavigableAreas$self$$.$_layers$[$i$$821$$].$LayerName$ ? $disclosed$$5$$.concat((0,D.$JSCompiler_StaticMethods_getNavigableAreaObjects$$)($dataLayers$$[$id$$296$$])) : $disclosed$$5$$.concat((0,D.$JSCompiler_StaticMethods_getNavigableDisclosedAreaObjects$$)($dataLayers$$[$id$$296$$]))
      }
    }
  }
  return $disclosed$$5$$
...
D.$JSCompiler_StaticMethods_getNavigableObjects$$ = function $$JSCompiler_StaticMethods_getNavigableObjects$$$($JSCompiler_StaticMethods_getNavigableObjects$self$$) {
  ...
  if($JSCompiler_StaticMethods_getNavigableObjects$self$$.$_topLayer$) {
    for(var $i$$822$$ = 0;$i$$822$$ < $JSCompiler_StaticMethods_getNavigableObjects$self$$.$_layers$.length;$i$$822$$++) {
      var $dataLayers$$1$$ = $JSCompiler_StaticMethods_getNavigableObjects$self$$.$_layers$[$i$$822$$].$DataLayers$;
      if($JSCompiler_StaticMethods_getNavigableObjects$self$$.$_topLayer$.$LayerName$ == $JSCompiler_StaticMethods_getNavigableObjects$self$$.$_layers$[$i$$822$$].$LayerName$ || !($JSCompiler_StaticMethods_getNavigableObjects$self$$.$_layers$[$i$$822$$] instanceof D.$DvtMapAreaLayer$$)) {
        for(var $id$$297$$ in $dataLayers$$1$$) {
          $navigable$$20$$ = $navigable$$20$$.concat($dataLayers$$1$$[$id$$297$$].$_dataObjs$)
        }
      }
    }
  }
...
D.$DvtThematicMap$$.prototype.$_setCenteredObjsMatrix$ = function $$DvtThematicMap$$$$$_setCenteredObjsMatrix$$($matrix$$22$$) {
  ...
  if(this.$_isMarkerZoomBehaviorFixed$) {
    for(var $numLabelLayers_objs$$63$$ = (0,D.$JSCompiler_StaticMethods_getNavigableObjects$$)(this), $i$$823_j$$114$$ = 0;$i$$823_j$$114$$ < $numLabelLayers_objs$$63$$.length;$i$$823_j$$114$$++) {
      $numLabelLayers_objs$$63$$[$i$$823_j$$114$$].$HandleZoomEvent$($matrix$$22$$)
    }
    $numLabelLayers_objs$$63$$ = this.$_labelLayers$.$getNumChildren$();
    for($i$$823_j$$114$$ = 0;$i$$823_j$$114$$ < $numLabelLayers_objs$$63$$;$i$$823_j$$114$$++) {
      for(var $labelLayer$$ = this.$_labelLayers$.$getChildAt$($i$$823_j$$114$$), $numLabels$$1$$ = $labelLayer$$.$getNumChildren$(), $k$$10$$ = 0;$k$$10$$ < $numLabels$$1$$;$k$$10$$++) {
        var $label$$100$$ = $labelLayer$$.$getChildAt$($k$$10$$);
        $label$$100$$ instanceof D.$DvtMapLabel$$ && $label$$100$$.update($matrix$$22$$)
      }
    }
  }
};
...
D.$DvtThematicMap$$.prototype.$drillDown$ = function $$DvtThematicMap$$$$$drillDown$$() {
  ...
  if($childLayer$$) {
    ...
    for(var $newSelectedAreas_selectedAreas$$1$$ = this.$_selectedAreas$[this.$_clickedLayerName$], $areasToDrill$$ = [], $i$$824$$ = 0;$i$$824$$ < $newSelectedAreas_selectedAreas$$1$$.length;$i$$824$$++) {
      var $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$;
      a: {
        $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$ = $parentLayer$$3$$.$getDataLayer$(this.$_clickedDataLayerId$).$_areaObjs$;
        for(var $JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$ = 0;$JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$ < $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$.length;$JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$++) {
          if($JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$[$JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$].$getLocation$() === $newSelectedAreas_selectedAreas$$1$$[$i$$824$$]) {
            $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$ = $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$[$JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$];
            break a
          }
        }
        $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$ = D.$JSCompiler_alias_NULL$$
      }
      $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$.$isDrilled$() || $areasToDrill$$.push($newSelectedAreas_selectedAreas$$1$$[$i$$824$$])
    }
    ...
    for($i$$824$$ = 0;$i$$824$$ < $areasToDrill$$.length;$i$$824$$++) {
      $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$ = $areasToDrill$$[$i$$824$$];
      $JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$ = (0,D.$JSCompiler_StaticMethods_getChildrenForArea$$)($parentLayer$$3$$, $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$);
      $newSelectedAreas_selectedAreas$$1$$.push($JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$[0]);
      for(var $areaName$$inline_8507_j$$115$$ = 0;$areaName$$inline_8507_j$$115$$ < $JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$.length;$areaName$$inline_8507_j$$115$$++) {
        this.$_childToParent$[$JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$[$areaName$$inline_8507_j$$115$$]] = $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$
      }
      $childLayer$$.$discloseAreas$($JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$, $fadeInObjs$$5$$);
      if($JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$ = $parentLayer$$3$$.$getDataLayer$(this.$_clickedDataLayerId$)) {
        for(var $areaName$$inline_8507_j$$115$$ = $JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$, $fadeOutObjs$$inline_8508$$ = this.$_drillAnimFadeOutObjs$, $i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$ = 0;$i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$ < $JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$.$_areaObjs$.length;$i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$++) {
          if($JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$.$_areaObjs$[$i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$].$getLocation$() == $areaName$$inline_8507_j$$115$$) {
            $JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$.$_areaObjs$[$i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$].$setDrilled$(D.$JSCompiler_alias_TRUE$$);
            $JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$.$_drilled$.push($areaName$$inline_8507_j$$115$$);
            $fadeOutObjs$$inline_8508$$.push($JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$.$_areaObjs$[$i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$].$getDisplayable$());
            if($i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$ = $JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$.$_areaObjs$[$i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$].$getLabel$()) {
              $fadeOutObjs$$inline_8508$$.push($i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$), ($i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$ = $i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$.$_leaderLine$) && $fadeOutObjs$$inline_8508$$.push($i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$)
            }
            break
          }
        }
        for($i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$ = 0;$i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$ < $JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$.$_dataObjs$.length;$i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$++) {
          if($JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$.$_dataObjs$[$i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$].$getLocation$() == $areaName$$inline_8507_j$$115$$) {
            $fadeOutObjs$$inline_8508$$.push($JSCompiler_StaticMethods_drill$self$$inline_8506_childrenToDisclose_drillLayer_j$$inline_8504$$.$_dataObjs$[$i$$inline_8509_label$$inline_8510_leaderLine$$inline_8511$$].$getDisplayable$());
            break
          }
        }
      }
      this.$_drilled$.push($JSCompiler_inline_result$$179_dataObjs$$inline_8503_parentArea$$)
    }
    ...
    (0,D.$JSCompiler_StaticMethods__updateDrillButton$$)(this, $childLayer$$.$LayerName$, D.$JSCompiler_alias_TRUE$$);
...
D.$DvtThematicMap$$.prototype.$drillUp$ = function $$DvtThematicMap$$$$$drillUp$$() {
  (0,D.$JSCompiler_StaticMethods__stopAnimation$$)(this);
  for(var $childLayer$$1$$ = (0,D.$JSCompiler_StaticMethods_getLayer$$)(this, this.$_clickedLayerName$), $parentLayer$$4$$ = (0,D.$JSCompiler_StaticMethods_getDrillParentLayer$$)(this, this.$_clickedLayerName$), $fadeInObjs$$6$$ = [], $newSelectedAreas$$1$$ = [], $selectedAreas$$2$$ = this.$_selectedAreas$[this.$_clickedLayerName$], $i$$825$$ = 0;$i$$825$$ < $selectedAreas$$2$$.length;$i$$825$$++) {
    var $index$$245_parentArea$$1$$ = this.$_childToParent$[$selectedAreas$$2$$[$i$$825$$]];
    $newSelectedAreas$$1$$.push($index$$245_parentArea$$1$$);
    if(-1 != D.$DvtArrayUtils$$.$getIndex$(this.$_drilled$, $index$$245_parentArea$$1$$)) {
      $childLayer$$1$$.$undiscloseAreas$((0,D.$JSCompiler_StaticMethods_getChildrenForArea$$)($parentLayer$$4$$, $index$$245_parentArea$$1$$), this.$_drillAnimFadeOutObjs$);
      for(var $JSCompiler_StaticMethods_undrill$self$$inline_8513$$ = $parentLayer$$4$$.$getDataLayer$(this.$_drillDataLayer$[$parentLayer$$4$$.$LayerName$]), $areaName$$inline_8514$$ = $index$$245_parentArea$$1$$, $fadeInObjs$$inline_8515$$ = $fadeInObjs$$6$$, $i$$inline_8516_label$$inline_8519$$ = 0;$i$$inline_8516_label$$inline_8519$$ < $JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_areaObjs$.length;$i$$inline_8516_label$$inline_8519$$++) {
        if($JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_areaObjs$[$i$$inline_8516_label$$inline_8519$$].$getLocation$() == $areaName$$inline_8514$$) {
          var $displayable$$inline_8518_idx$$inline_8517$$ = D.$DvtArrayUtils$$.$getIndex$($JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_drilled$, $areaName$$inline_8514$$);
          $JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_drilled$.splice($displayable$$inline_8518_idx$$inline_8517$$, 1);
          $JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_areaObjs$[$i$$inline_8516_label$$inline_8519$$].$setDrilled$(D.$JSCompiler_alias_FALSE$$);
          $displayable$$inline_8518_idx$$inline_8517$$ = $JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_areaObjs$[$i$$inline_8516_label$$inline_8519$$].$getDisplayable$();
          $JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_dataAreaLayer$.$addChild$($displayable$$inline_8518_idx$$inline_8517$$);
          $fadeInObjs$$inline_8515$$.push($displayable$$inline_8518_idx$$inline_8517$$);
          if($i$$inline_8516_label$$inline_8519$$ = $JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_areaObjs$[$i$$inline_8516_label$$inline_8519$$].$getLabel$()) {
            $i$$inline_8516_label$$inline_8519$$.update($JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_pzcMatrix$), $fadeInObjs$$inline_8515$$.push($i$$inline_8516_label$$inline_8519$$), $fadeInObjs$$inline_8515$$.push($i$$inline_8516_label$$inline_8519$$.$_leaderLine$)
          }
          break
        }
      }
      for($i$$inline_8516_label$$inline_8519$$ = 0;$i$$inline_8516_label$$inline_8519$$ < $JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_dataObjs$.length;$i$$inline_8516_label$$inline_8519$$++) {
        if($JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_dataObjs$[$i$$inline_8516_label$$inline_8519$$].$getLocation$() == $areaName$$inline_8514$$) {
          $displayable$$inline_8518_idx$$inline_8517$$ = $JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_dataObjs$[$i$$inline_8516_label$$inline_8519$$].$getDisplayable$();
          $JSCompiler_StaticMethods_undrill$self$$inline_8513$$.$_dataPointLayer$.$addChild$($displayable$$inline_8518_idx$$inline_8517$$);
          $fadeInObjs$$inline_8515$$.push($displayable$$inline_8518_idx$$inline_8517$$);
          break
        }
      }
      $index$$245_parentArea$$1$$ = D.$DvtArrayUtils$$.$getIndex$(this.$_drilled$, $index$$245_parentArea$$1$$);
      -1 != $index$$245_parentArea$$1$$ && this.$_drilled$.splice($index$$245_parentArea$$1$$, 1)
    }
  }
...
D.$JSCompiler_StaticMethods__handleDrillAnimations$$ = function $$JSCompiler_StaticMethods__handleDrillAnimations$$$($JSCompiler_StaticMethods__handleDrillAnimations$self$$, $oldObjs$$3$$, $newObjs$$3$$, $isDrillUp$$) {
  ...
  if("zoomToFit" == $JSCompiler_StaticMethods__handleDrillAnimations$self$$.$_animationOnDrill$ && !$JSCompiler_StaticMethods__handleDrillAnimations$self$$.$_processingInitDrilled$) {
    ...
    (0,D.$DvtAgent$isEnvironmentBrowser$$)() || ($animator$$135$$ = D.$JSCompiler_alias_NULL$$);
...
D.$DvtThematicMap$$.prototype.dispatchEvent = function $$DvtThematicMap$$$$dispatchEvent$($event$$755$$) {
  var $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$ = $event$$755$$.$getType$();
  if("selection" == $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$) {
    if(this.$_clickedDataLayerId$) {
      this.$_selectedRowKeys$ = $event$$755$$.getSelection();
      for(var $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$ = this.$_selectedAreas$, $JSCompiler_temp_const$$9351$$ = this.$_clickedLayerName$, $selectedObjs$$inline_11394$$ = this.$_selectedRowKeys$, $selectedAreas$$inline_11395$$ = [], $areaObjs$$inline_11396$$ = (0,D.$JSCompiler_StaticMethods_getLayer$$)(this, this.$_clickedLayerName$).$getDataLayer$(this.$_clickedDataLayerId$).$_areaObjs$, $i$$inline_11397$$ = 0;$i$$inline_11397$$ < $selectedObjs$$inline_11394$$.length;$i$$inline_11397$$++) {
        for(var $j$$inline_11398$$ = 0;$j$$inline_11398$$ < $areaObjs$$inline_11396$$.length;$j$$inline_11398$$++) {
          if($areaObjs$$inline_11396$$[$j$$inline_11398$$].getId() == $selectedObjs$$inline_11394$$[$i$$inline_11397$$]) {
            $selectedAreas$$inline_11395$$.push($areaObjs$$inline_11396$$[$j$$inline_11398$$].$getLocation$());
            break
          }
        }
      }
      $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$[$JSCompiler_temp_const$$9351$$] = $selectedAreas$$inline_11395$$;
      (0,D.$JSCompiler_StaticMethods__updateDrillButton$$)(this, this.$_clickedLayerName$);
    ...
    $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$ == D.$DvtMapDrillEvent$$.$TYPE$ ? ((0,D.$JSCompiler_StaticMethods_addParam$$)($event$$755$$, "clientId", this.$_eventClientId$), this.$_drilledRowKeys$ = "multiple" == this.$_drillMode$ ? this.$_drilledRowKeys$.concat(this.$_selectedRowKeys$) : this.$_selectedRowKeys$, $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$ = $event$$755$$.$_drillType$, $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$ == D.$DvtMapDrillEvent$$.$DRILL_UP$ && 
    this.$drillUp$(), $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$ == D.$DvtMapDrillEvent$$.$DRILL_DOWN$ ? this.$drillDown$() : $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$ == D.$DvtMapDrillEvent$$.$RESET$ && this.$resetMap$(), $event$$755$$.$setDisclosed$(this.$_drilledRowKeys$)) : ("showPopup" == $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$ || "hidePopup" == $JSCompiler_temp_const$$9352_drillType$$inline_8526_type$$246$$) && (0,D.$JSCompiler_StaticMethods_addParam$$)($event$$755$$, 
    "clientId", this.$_eventClientId$)
  }
  D.$DvtThematicMap$$.$superclass$.dispatchEvent.call(this, $event$$755$$)
};
D.$JSCompiler_StaticMethods__updateDrillButton$$ = function $$JSCompiler_StaticMethods__updateDrillButton$$$($JSCompiler_StaticMethods__updateDrillButton$self$$, $layerName$$27_parentLayer$$5$$, $isDrillDown$$) {
  if($JSCompiler_StaticMethods__updateDrillButton$self$$.$_controlPanel$ && $JSCompiler_StaticMethods__updateDrillButton$self$$.$_drillMode$ && "none" != $JSCompiler_StaticMethods__updateDrillButton$self$$.$_drillMode$) {
    ...
    $childLayer$$2$$ && !$isDrillDown$$ ? (0,D.$JSCompiler_StaticMethods_setEnabledDrillDownButton$$)($JSCompiler_StaticMethods__updateDrillButton$self$$.$_controlPanel$, D.$JSCompiler_alias_TRUE$$) : (0,D.$JSCompiler_StaticMethods_setEnabledDrillDownButton$$)($JSCompiler_StaticMethods__updateDrillButton$self$$.$_controlPanel$, D.$JSCompiler_alias_FALSE$$);
    $layerName$$27_parentLayer$$5$$ ? (0,D.$JSCompiler_StaticMethods_setEnabledDrillUpButton$$)($JSCompiler_StaticMethods__updateDrillButton$self$$.$_controlPanel$, D.$JSCompiler_alias_TRUE$$) : (0,D.$JSCompiler_StaticMethods_setEnabledDrillUpButton$$)($JSCompiler_StaticMethods__updateDrillButton$self$$.$_controlPanel$, D.$JSCompiler_alias_FALSE$$)
  }
};
...
D.$JSCompiler_StaticMethods__cleanUpDrilledObjects$$ = function $$JSCompiler_StaticMethods__cleanUpDrilledObjects$$$($JSCompiler_StaticMethods__cleanUpDrilledObjects$self$$) {
  if(0 < $JSCompiler_StaticMethods__cleanUpDrilledObjects$self$$.$_drillAnimFadeOutObjs$.length) {
    for(var $i$$826$$ = 0;$i$$826$$ < $JSCompiler_StaticMethods__cleanUpDrilledObjects$self$$.$_drillAnimFadeOutObjs$.length;$i$$826$$++) {
      var $obj$$355$$ = $JSCompiler_StaticMethods__cleanUpDrilledObjects$self$$.$_drillAnimFadeOutObjs$[$i$$826$$];
      if($obj$$355$$) {
...
D.$DvtThematicMap$$.prototype.$_fireRolloverEvent$ = function $$DvtThematicMap$$$$$_fireRolloverEvent$$($type$$247$$, $category$$22$$) {
  var $rolloverEvent$$7$$ = new D.$DvtCategoryRolloverEvent$$($type$$247$$, $category$$22$$), $objects$$5$$ = [], $layerId_legendItems$$;
...
D.$DvtThematicMap$$.prototype.$processDefaultHoverEffect$ = function $$DvtThematicMap$$$$$processDefaultHoverEffect$$($id$$299$$, $hovered$$3$$) {
...
D.$DvtThematicMap$$.prototype.$processDefaultSelectionEffect$ = function $$DvtThematicMap$$$$$processDefaultSelectionEffect$$($id$$300$$, $selected$$45$$) {
...
D.$DvtThematicMap$$.prototype.$processDefaultFocusEffect$ = function $$DvtThematicMap$$$$$processDefaultFocusEffect$$($id$$301$$, $focused$$4$$) {
  var $dataItem$$46$$ = (0,D.$JSCompiler_StaticMethods__getDataItemById$$)(this, $id$$301$$);
...
D.$JSCompiler_StaticMethods__getDataItemById$$ = function $$JSCompiler_StaticMethods__getDataItemById$$$($JSCompiler_StaticMethods__getDataItemById$self$$, $id$$302$$) {
  for(var $i$$828$$ = 0;$i$$828$$ < $JSCompiler_StaticMethods__getDataItemById$self$$.$_layers$.length;$i$$828$$++) {
    var $dataLayers$$3$$ = $JSCompiler_StaticMethods__getDataItemById$self$$.$_layers$[$i$$828$$].$DataLayers$, $dlId$$;
    for($dlId$$ in $dataLayers$$3$$) {
      for(var $dataObjs$$2$$ = $dataLayers$$3$$[$dlId$$].$_dataObjs$, $j$$116$$ = 0;$j$$116$$ < $dataObjs$$2$$.length;$j$$116$$++) {
        if($dataObjs$$2$$[$j$$116$$].getId() === $id$$302$$) {
...
D.$JSCompiler_StaticMethods__getCurrentDragSource$$ = function $$JSCompiler_StaticMethods__getCurrentDragSource$$$($JSCompiler_StaticMethods__getCurrentDragSource$self$$) {
  for(var $i$$839$$ = 0;$i$$839$$ < $JSCompiler_StaticMethods__getCurrentDragSource$self$$.$_layers$.length;$i$$839$$++) {
    var $dataLayers$$7$$ = $JSCompiler_StaticMethods__getCurrentDragSource$self$$.$_layers$[$i$$839$$].$DataLayers$, $id$$305$$;
    for($id$$305$$ in $dataLayers$$7$$) {
      var $dragSource$$3$$ = $dataLayers$$7$$[$id$$305$$].$_dragSource$;
...
D.$DvtThematicMap$$.prototype.$acceptDrag$ = function $$DvtThematicMap$$$$$acceptDrag$$($mouseX$$59$$, $mouseY$$59$$, $clientIds$$24$$) {
  var $JSCompiler_inline_result$$122_mouseX$$inline_8769_zoom$$16$$ = this.$_pzc$.$getZoom$();
  $mouseX$$59$$ = ($mouseX$$59$$ - (0,D.$JSCompiler_StaticMethods_getPanX$$)(this.$_pzc$)) / $JSCompiler_inline_result$$122_mouseX$$inline_8769_zoom$$16$$;
  $mouseY$$59$$ = ($mouseY$$59$$ - (0,D.$JSCompiler_StaticMethods_getPanY$$)(this.$_pzc$)) / $JSCompiler_inline_result$$122_mouseX$$inline_8769_zoom$$16$$;
  a: {
    for(var $JSCompiler_inline_result$$122_mouseX$$inline_8769_zoom$$16$$ = $mouseX$$59$$, $mouseY$$inline_8770$$ = $mouseY$$59$$, $i$$inline_8771$$ = 0;$i$$inline_8771$$ < this.$_layers$.length;$i$$inline_8771$$++) {
      if(this.$_layers$[$i$$inline_8771$$].$getDropTarget$) {
        var $dropTarget$$inline_8772$$ = this.$_layers$[$i$$inline_8771$$].$_dropTarget$;
        if($dropTarget$$inline_8772$$ && $dropTarget$$inline_8772$$.$getDropSite$($JSCompiler_inline_result$$122_mouseX$$inline_8769_zoom$$16$$, $mouseY$$inline_8770$$)) {
          $JSCompiler_inline_result$$122_mouseX$$inline_8769_zoom$$16$$ = $dropTarget$$inline_8772$$;
          break a
        }
      }
    }
    $JSCompiler_inline_result$$122_mouseX$$inline_8769_zoom$$16$$ = D.$JSCompiler_alias_NULL$$
  }
  return(this.$_dropTarget$ = $JSCompiler_inline_result$$122_mouseX$$inline_8769_zoom$$16$$) ? this.$_dropTarget$.$acceptDrag$($mouseX$$59$$, $mouseY$$59$$, $clientIds$$24$$) : D.$JSCompiler_alias_NULL$$
};
...
D.$DvtThematicMapAutomation$$.prototype.$GetSubIdForDomElement$ = function $$DvtThematicMapAutomation$$$$$GetSubIdForDomElement$$($actions$$1_displayable$$102_displayable$$inline_8554$$) {
  var $dataObject$$inline_8553_logicalObj$$19$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this.$_tmap$.$getEventManager$(), $actions$$1_displayable$$102_displayable$$inline_8554$$);
  if($dataObject$$inline_8553_logicalObj$$19$$ && ($dataObject$$inline_8553_logicalObj$$19$$ instanceof D.$DvtMapAreaPeer$$ || $dataObject$$inline_8553_logicalObj$$19$$ instanceof D.$DvtMapObjPeer$$)) {
    var $JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$;
    a: {
      $actions$$1_displayable$$102_displayable$$inline_8554$$ = $dataObject$$inline_8553_logicalObj$$19$$.$getDisplayable$();
      for(var $idx$$39_layers$$inline_8555$$ = this.$_tmap$.$_layers$, $i$$inline_8556$$ = 0;$i$$inline_8556$$ < $idx$$39_layers$$inline_8555$$.length;$i$$inline_8556$$++) {
        var $dataLayers$$inline_8557$$ = $idx$$39_layers$$inline_8555$$[$i$$inline_8556$$].$DataLayers$;
        for($JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$ in $dataLayers$$inline_8557$$) {
          if($actions$$1_displayable$$102_displayable$$inline_8554$$ instanceof D.$DvtPath$$) {
            for(var $areas$$inline_8559_markers$$inline_8561$$ = $dataLayers$$inline_8557$$[$JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$].$_areaObjs$, $k$$inline_8560$$ = 0;$k$$inline_8560$$ < $areas$$inline_8559_markers$$inline_8561$$.length;$k$$inline_8560$$++) {
              if($areas$$inline_8559_markers$$inline_8561$$[$k$$inline_8560$$] === $dataObject$$inline_8553_logicalObj$$19$$) {
                $JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$ = (0,D.$JSCompiler_StaticMethods__getDataLayerId$$)($JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$) + ":area[" + $k$$inline_8560$$ + "]";
                break a
              }
            }
          }else {
            if($actions$$1_displayable$$102_displayable$$inline_8554$$ instanceof D.$DvtSimpleMarker$$ || $actions$$1_displayable$$102_displayable$$inline_8554$$ instanceof D.$DvtImageMarker$$) {
              $areas$$inline_8559_markers$$inline_8561$$ = $dataLayers$$inline_8557$$[$JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$].$_dataObjs$;
              for($k$$inline_8560$$ = 0;$k$$inline_8560$$ < $areas$$inline_8559_markers$$inline_8561$$.length;$k$$inline_8560$$++) {
                if($areas$$inline_8559_markers$$inline_8561$$[$k$$inline_8560$$] === $dataObject$$inline_8553_logicalObj$$19$$) {
                  $JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$ = (0,D.$JSCompiler_StaticMethods__getDataLayerId$$)($JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$) + ":marker[" + $k$$inline_8560$$ + "]";
                  break a
                }
              }
            }
      ...
      $JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$ = D.$JSCompiler_alias_NULL$$
    }
    return $JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$
  }
  if($JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$ = this.$_tmap$.$_panZoomCanvas$.$_controlPanel$) {
    if(($dataObject$$inline_8553_logicalObj$$19$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)($JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$.$getEventManager$(), $actions$$1_displayable$$102_displayable$$inline_8554$$)) && $dataObject$$inline_8553_logicalObj$$19$$ instanceof D.$DvtButton$$) {
      $actions$$1_displayable$$102_displayable$$inline_8554$$ = "disclosure zoomIn zoomOut zoomToFit drillDown drillUp reset".split(" ");
      for($idx$$39_layers$$inline_8555$$ = 0;$idx$$39_layers$$inline_8555$$ < $actions$$1_displayable$$102_displayable$$inline_8554$$.length;$idx$$39_layers$$inline_8555$$++) {
        if($JSCompiler_inline_result$$457_controlPanel$$10_id$$inline_8558$$.$getActionDisplayable$($actions$$1_displayable$$102_displayable$$inline_8554$$[$idx$$39_layers$$inline_8555$$]) === $dataObject$$inline_8553_logicalObj$$19$$) {
          return"controlPanel#" + $actions$$1_displayable$$102_displayable$$inline_8554$$[$idx$$39_layers$$inline_8555$$]
        }
      }
    }
  }
...
D.$DvtThematicMapAutomation$$.prototype.$getDomElementForSubId$ = function $$DvtThematicMapAutomation$$$$$getDomElementForSubId$$($action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$) {
  if("tooltip" == $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$) {
    return(0,D.$JSCompiler_StaticMethods_GetTooltipElement$$)(this.$_tmap$)
  }
  var $actionIdx_colonIdx$$1_controlPanel$$11$$ = $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.indexOf(":"), $parenIdx$$2$$ = $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.indexOf("[");
  return 0 < $actionIdx_colonIdx$$1_controlPanel$$11$$ && 0 < $parenIdx$$2$$ ? ($action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$ = (0,D.$JSCompiler_StaticMethods__getDataObject$$)(this, $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.substring(0, $actionIdx_colonIdx$$1_controlPanel$$11$$), $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.substring($actionIdx_colonIdx$$1_controlPanel$$11$$ + 1, $parenIdx$$2$$), (0,window.parseInt)($action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.substring($parenIdx$$2$$ + 
  1, $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.length - 1)))) ? $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.$getDisplayable$().$getElem$() : D.$JSCompiler_alias_NULL$$ : 0 === $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.lastIndexOf("controlPanel") && ($actionIdx_colonIdx$$1_controlPanel$$11$$ = $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.indexOf("#"), 0 < $actionIdx_colonIdx$$1_controlPanel$$11$$ && ($action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$ = 
  $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.substring($actionIdx_colonIdx$$1_controlPanel$$11$$ + 1), ($actionIdx_colonIdx$$1_controlPanel$$11$$ = this.$_tmap$.$_panZoomCanvas$.$_controlPanel$) && $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$)) ? ($action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$ = $actionIdx_colonIdx$$1_controlPanel$$11$$.$getActionDisplayable$($action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$)) ? $action$$28_dataObj$$inline_8567_displayable$$103_subId$$31$$.$getElem$() : 
...
D.$DvtThematicMapAutomation$$.prototype.getData = function $$DvtThematicMapAutomation$$$$getData$($dataLayerId$$1_dataObj$$2$$, $data$$103_dataObjType$$1$$, $index$$247_label$$101$$) {
  return($dataLayerId$$1_dataObj$$2$$ = (0,D.$JSCompiler_StaticMethods__getDataObject$$)(this, $dataLayerId$$1_dataObj$$2$$, $data$$103_dataObjType$$1$$, $index$$247_label$$101$$)) ? ($data$$103_dataObjType$$1$$ = {}, $data$$103_dataObjType$$1$$.color = $dataLayerId$$1_dataObj$$2$$.$getDatatipColor$(), $data$$103_dataObjType$$1$$.tooltip = $dataLayerId$$1_dataObj$$2$$.$getShortDesc$(), $index$$247_label$$101$$ = $dataLayerId$$1_dataObj$$2$$.$getLabel$(), $data$$103_dataObjType$$1$$.label = $index$$247_label$$101$$ ? 
  $index$$247_label$$101$$.$getTextString$() : D.$JSCompiler_alias_NULL$$, $data$$103_dataObjType$$1$$.selected = $dataLayerId$$1_dataObj$$2$$.$isSelected$(), $data$$103_dataObjType$$1$$) : D.$JSCompiler_alias_NULL$$
};
D.$DvtThematicMapAutomation$$.prototype.getData = D.$DvtThematicMapAutomation$$.prototype.getData;
D.$JSCompiler_StaticMethods__getDataObject$$ = function $$JSCompiler_StaticMethods__getDataObject$$$($JSCompiler_StaticMethods__getDataObject$self_layers$$1$$, $dataLayerId$$3$$, $dataObjType$$3$$, $index$$249$$) {
  ...
  for(var $i$$830$$ = 0;$i$$830$$ < $JSCompiler_StaticMethods__getDataObject$self_layers$$1$$.length;$i$$830$$++) {
    var $dataLayers$$5$$ = $JSCompiler_StaticMethods__getDataObject$self_layers$$1$$[$i$$830$$].$DataLayers$, $id$$304$$;
    for($id$$304$$ in $dataLayers$$5$$) {
      if((0,D.$JSCompiler_StaticMethods__getDataLayerId$$)($id$$304$$) == $dataLayerId$$3$$) {
        if("area" == $dataObjType$$3$$) {
          return $dataLayers$$5$$[$id$$304$$].$_dataAreaCollection$[$index$$249$$]
        }
        if("marker" == $dataObjType$$3$$) {
          return $dataLayers$$5$$[$id$$304$$].$_dataMarkerCollection$[$index$$249$$]
        }
      }
    }
  }
...
D.$JSCompiler_prototypeAlias$$.$setDrilled$ = function $$JSCompiler_prototypeAlias$$$$setDrilled$$($drilled_parent$$85$$) {
  this.$_isDrilled$ != $drilled_parent$$85$$ && (this.$_isDrilled$ = $drilled_parent$$85$$, this.$isDrilled$() ? (this.$_disclosedInnerShape$ = this.$copyShape$(), this.$_disclosedInnerShape$.$setFill$(D.$JSCompiler_alias_NULL$$), this.$_disclosedInnerShape$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), this.$_disclosedOuterShape$ = this.$copyShape$(), this.$_disclosedOuterShape$.$setFill$(D.$JSCompiler_alias_NULL$$), this.$_disclosedOuterShape$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), $drilled_parent$$85$$ = 
  this.getParent(), $drilled_parent$$85$$.$addChild$(this.$_disclosedOuterShape$), $drilled_parent$$85$$.$addChild$(this.$_disclosedInnerShape$), this.$_disclosedInnerShape$.$setStroke$((0,D.$JSCompiler_StaticMethods__adjustStrokeZoomWidth$$)(this, this.$_disclosedInnerStroke$, 2)), this.$_disclosedOuterShape$.$setStroke$((0,D.$JSCompiler_StaticMethods__adjustStrokeZoomWidth$$)(this, this.$_disclosedOuterStroke$, 4)), this.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), this.$IsShowingHoverEffect$ = 
...
D.$JSCompiler_prototypeAlias$$.$fireKeyboardListener$ = function $$JSCompiler_prototypeAlias$$$$fireKeyboardListener$$($event$$744$$) {
  this.$_dataItem$ instanceof D.$DvtBaseComponent$$ && this.$_dataItem$.$fireKeyboardListener$($event$$744$$)
};
...
D.$DvtBaseMapManager$$.$getMapLayerName$ = function $$DvtBaseMapManager$$$$getMapLayerName$$($baseMapName$$12$$, $index$$242$$) {
  D.$DvtBaseMapManager$$.$_processUnprocessedMaps$();
  return D.$DvtBaseMapManager$$.$_GLOBAL_MAPS$[$baseMapName$$12$$][D.$DvtBaseMapManager$$.$_INDEX$][$index$$242$$]
};
D.$DvtBaseMapManager$$.$registerBaseMapLayer$ = function $$DvtBaseMapManager$$$$registerBaseMapLayer$$($baseMapName$$13_layerMetadata$$, $layerName$$10$$, $labelMetadata$$, $pathMetadata$$, $parentsRegionMetadata$$, $labelInfoMetadata$$, $index$$243$$, $dim$$82$$) {
  ...
  $baseMapName$$13_layerMetadata$$ || ($baseMapName$$13_layerMetadata$$ = {}, $basemapMetadata$$[$layerName$$10$$] = $baseMapName$$13_layerMetadata$$, $index$$243$$ != D.$JSCompiler_alias_NULL$$ && ($basemapMetadata$$[D.$DvtBaseMapManager$$.$_INDEX$][$index$$243$$] = $layerName$$10$$));
  ...
  $baseMapName$$13_layerMetadata$$[D.$DvtBaseMapManager$$.$_INDEX$] = $index$$243$$
};
...
D.$DvtBaseMapManager$$.$_processUnprocessedMaps$ = function $$DvtBaseMapManager$$$$_processUnprocessedMaps$$() {
  var $i$$792_index$$244$$, $args$$6$$, $unprocessedMaps_unprocessedParentUpdates$$ = D.$DvtBaseMapManager$$._UNPROCESSED_MAPS;
  if($unprocessedMaps_unprocessedParentUpdates$$) {
    for($i$$792_index$$244$$ = 0;$i$$792_index$$244$$ < $unprocessedMaps_unprocessedParentUpdates$$[0].length;$i$$792_index$$244$$++) {
      $args$$6$$ = $unprocessedMaps_unprocessedParentUpdates$$[0][$i$$792_index$$244$$], D.$DvtBaseMapManager$$.$registerBaseMapLayer$($args$$6$$[0], $args$$6$$[1], $args$$6$$[2], $args$$6$$[3], $args$$6$$[4], $args$$6$$[5], $args$$6$$[6], $args$$6$$[7])
    }
    for($i$$792_index$$244$$ = 0;$i$$792_index$$244$$ < $unprocessedMaps_unprocessedParentUpdates$$[1].length;$i$$792_index$$244$$++) {
      $args$$6$$ = $unprocessedMaps_unprocessedParentUpdates$$[1][$i$$792_index$$244$$], D.$DvtBaseMapManager$$.$registerResourceBundle$($args$$6$$[0], $args$$6$$[1], $args$$6$$[2])
    }
    for($i$$792_index$$244$$ = 0;$i$$792_index$$244$$ < $unprocessedMaps_unprocessedParentUpdates$$[2].length;$i$$792_index$$244$$++) {
      $args$$6$$ = $unprocessedMaps_unprocessedParentUpdates$$[2][$i$$792_index$$244$$], D.$DvtBaseMapManager$$.$updateResourceBundle$($args$$6$$[0], $args$$6$$[1], $args$$6$$[2])
    }
  ...
  if($unprocessedMaps_unprocessedParentUpdates$$ = D.$DvtBaseMapManager$$._UNPROCESSED_PARENT_UPDATES) {
    for($i$$792_index$$244$$ = 0;$i$$792_index$$244$$ < $unprocessedMaps_unprocessedParentUpdates$$[0].length;$i$$792_index$$244$$++) {
      $args$$6$$ = $unprocessedMaps_unprocessedParentUpdates$$[0][$i$$792_index$$244$$];
      ...
      if($basemapMetadata$$3$$) {
        if($extendedLayer_indicies_layerMetadata$$3$$ = $basemapMetadata$$3$$[$extendedLayer_indicies_layerMetadata$$3$$]) {
          ...
          $i$$792_index$$244$$ = $extendedLayer_indicies_layerMetadata$$3$$[D.$DvtBaseMapManager$$.$_INDEX$];
          $extendedLayer_indicies_layerMetadata$$3$$ = $basemapMetadata$$3$$[D.$DvtBaseMapManager$$.$_INDEX$];
          $extendedLayer_indicies_layerMetadata$$3$$.splice($i$$792_index$$244$$, 0, $layerName$$13_lowerLayer$$);
          $basemapMetadata$$3$$[$layerName$$13_lowerLayer$$][D.$DvtBaseMapManager$$.$_INDEX$] = $i$$792_index$$244$$;
          for($i$$792_index$$244$$ += 1;$i$$792_index$$244$$ < $extendedLayer_indicies_layerMetadata$$3$$.length;$i$$792_index$$244$$++) {
            ($layerName$$13_lowerLayer$$ = $basemapMetadata$$3$$[$extendedLayer_indicies_layerMetadata$$3$$[$i$$792_index$$244$$]]) && $layerName$$13_lowerLayer$$[D.$DvtBaseMapManager$$.$_INDEX$]++
          }
        }
...
D.$DvtBaseMapManager$$.$getLayerIds$ = function $$DvtBaseMapManager$$$$getLayerIds$$($baseMapName$$16$$, $layerName$$14$$) {
  ...
  if($ids$$1_layer$$7$$) {
    var $ids$$1_layer$$7$$ = $ids$$1_layer$$7$$[D.$DvtBaseMapManager$$.$TYPE_LABELS$], $id$$286$$;
    for($id$$286$$ in $ids$$1_layer$$7$$) {
      $map$$13$$[$id$$286$$] = $ids$$1_layer$$7$$[$id$$286$$][1]
    }
  }
  return $map$$13$$
};
...
D.$DvtMapActionEvent$$ = function $$DvtMapActionEvent$$$($clientId$$3$$, $rowKey$$18$$, $action$$27$$) {
  this.Init("action");
...
D.$DvtMapLabel$$ = function $$DvtMapLabel$$$($context$$599$$, $label$$93$$, $labelInfo$$9$$, $labelDisplay$$5$$, $parentContainer$$, $bSupportsVectorEffects$$4$$) {
  this.Init($context$$599$$, $label$$93$$, $labelInfo$$9$$, $labelDisplay$$5$$, $parentContainer$$, $bSupportsVectorEffects$$4$$)
};
D.$DvtObj$$.$createSubclass$(D.$DvtMapLabel$$, D.$DvtOutputText$$, "DvtMapLabel");
D.$JSCompiler_prototypeAlias$$ = D.$DvtMapLabel$$.prototype;
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($context$$600$$, $i$$809_label$$94$$, $labelInfo$$10$$, $labelDisplay$$6_line$$16_polyline$$, $parentContainer$$1_stroke$$112$$, $bSupportsVectorEffects$$5$$) {
  D.$DvtMapLabel$$.$superclass$.Init.call(this, $context$$600$$, $i$$809_label$$94$$, 0, 0);
...
D.$JSCompiler_prototypeAlias$$.update = function $$JSCompiler_prototypeAlias$$$update$($pzcMatrix$$12_zoom$$13$$) {
  ...
  for(var $mat$$49_state$$96_stroke$$113$$ = -1, $center$$9_estimatedDims$$3$$ = D.$DvtTextUtils$$.$guessTextDimensions$(this), $labelBox_remove_style$$117$$ = D.$JSCompiler_alias_FALSE$$, $i$$810_leaderLinePoints$$ = 0;$i$$810_leaderLinePoints$$ < this.$_boundRectangle$.length;$i$$810_leaderLinePoints$$++) {
    var $numPoints$$2_zoomW$$ = this.$_boundRectangle$[$i$$810_leaderLinePoints$$].$w$ * $pzcMatrix$$12_zoom$$13$$;
    if($center$$9_estimatedDims$$3$$.$h$ <= this.$_boundRectangle$[$i$$810_leaderLinePoints$$].$h$ * $pzcMatrix$$12_zoom$$13$$) {
      if($center$$9_estimatedDims$$3$$.$w$ <= $numPoints$$2_zoomW$$) {
        $mat$$49_state$$96_stroke$$113$$ = $i$$810_leaderLinePoints$$;
        break
      }else {
  ...
  (this.$_leaderLine$ = this.$_leaderLines$[$mat$$49_state$$96_stroke$$113$$ - 1], this.$_parentContainer$.$addChild$(this.$_leaderLine$), $labelBox_remove_style$$117$$ = this.$getCSSStyle$(), $labelBox_remove_style$$117$$.$setStyle$("color", "#000000"), this.$setCSSStyle$($labelBox_remove_style$$117$$), $labelBox_remove_style$$117$$ = this.$_boundRectangle$[$mat$$49_state$$96_stroke$$113$$], $i$$810_leaderLinePoints$$ = this.$_leaderLine$.$getPoints$(), $numPoints$$2_zoomW$$ = $i$$810_leaderLinePoints$$.length, 
  $labelBox_remove_style$$117$$.x > $i$$810_leaderLinePoints$$[$numPoints$$2_zoomW$$ - 2] ? (this.$alignLeft$(), this.$alignMiddle$(), this.$setCenter$(new D.$DvtPoint$$($labelBox_remove_style$$117$$.x, $center$$9_estimatedDims$$3$$.y))) : $labelBox_remove_style$$117$$.y > $i$$810_leaderLinePoints$$[$numPoints$$2_zoomW$$ - 1] ? (this.$alignTop$(), this.$alignCenter$(), this.$setCenter$(new D.$DvtPoint$$($center$$9_estimatedDims$$3$$.x, $labelBox_remove_style$$117$$.y))) : $labelBox_remove_style$$117$$.x + 
  $labelBox_remove_style$$117$$.$w$ < $i$$810_leaderLinePoints$$[$numPoints$$2_zoomW$$ - 2] ? (this.$alignRight$(), this.$alignMiddle$(), this.$setCenter$(new D.$DvtPoint$$($labelBox_remove_style$$117$$.x + $labelBox_remove_style$$117$$.$w$, $center$$9_estimatedDims$$3$$.y))) : $labelBox_remove_style$$117$$.y + $labelBox_remove_style$$117$$.$h$ < $i$$810_leaderLinePoints$$[$numPoints$$2_zoomW$$ - 1] && (this.$alignBottom$(), this.$alignCenter$(), this.$setCenter$(new D.$DvtPoint$$($center$$9_estimatedDims$$3$$.x, 
...
D.$DvtMapObjPeer$$ = function $$DvtMapObjPeer$$$($data$$100$$, $dataLayer$$6$$, $displayable$$100$$, $label$$95$$, $center$$10$$) {
  this.Init($data$$100$$, $dataLayer$$6$$, $displayable$$100$$, $label$$95$$, $center$$10$$)
};
D.$DvtObj$$.$createSubclass$(D.$DvtMapObjPeer$$, D.$DvtObj$$, "DvtMapObjPeer");
D.$JSCompiler_prototypeAlias$$ = D.$DvtMapObjPeer$$.prototype;
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($data$$101$$, $dataLayer$$7_mapLayer_preDatatip$$, $displayable$$101_location$$24$$, $label$$96$$, $center$$11$$) {
  this.$_data$ = $data$$101$$;
...
D.$JSCompiler_prototypeAlias$$.$setSelectable$ = function $$JSCompiler_prototypeAlias$$$$setSelectable$$($bSelectable$$3$$) {
  ...
  this.$Displayable$.$setSelectable$ && (this.$Displayable$.$setSelectable$($bSelectable$$3$$), $label$$97$$ && $bSelectable$$3$$ && $label$$97$$.setCursor("pointer"));
  this.$_data$.destination && (this.$Displayable$.setCursor("pointer"), $label$$97$$ && $label$$97$$.setCursor("pointer"))
};
D.$JSCompiler_prototypeAlias$$.$isSelectable$ = function $$JSCompiler_prototypeAlias$$$$isSelectable$$() {
...
D.$JSCompiler_prototypeAlias$$.$isDragAvailable$ = function $$JSCompiler_prototypeAlias$$$$isDragAvailable$$($clientIds$$21$$) {
  for(var $parentId$$30$$ = this.$_dataLayer$.$getClientId$(), $i$$813$$ = 0;$i$$813$$ < $clientIds$$21$$.length && $clientIds$$21$$[$i$$813$$] != $parentId$$30$$;$i$$813$$++) {
  }
  return $parentId$$30$$
};
...
D.$JSCompiler_prototypeAlias$$.$__recenter$ = function $$JSCompiler_prototypeAlias$$$$__recenter$$() {
  ...
  if($width$$160$$ != D.$JSCompiler_alias_NULL$$ && $height$$144$$ != D.$JSCompiler_alias_NULL$$ && this.$Displayable$.getParent()) {
...
D.$JSCompiler_prototypeAlias$$.$animateDelete$ = function $$JSCompiler_prototypeAlias$$$$animateDelete$$($handler$$63$$) {
  var $anim$$41_fadeObjs$$ = [this.$Displayable$], $label$$98$$ = this.$getLabel$();
  $label$$98$$ && $anim$$41_fadeObjs$$.push($label$$98$$);
...
D.$JSCompiler_prototypeAlias$$.$animateInsert$ = function $$JSCompiler_prototypeAlias$$$$animateInsert$$($handler$$64$$) {
  ...
  var $label$$99$$ = this.$getLabel$();
  $label$$99$$ && ($label$$99$$.$setAlpha$(0), $anim$$42_fadeObjs$$1$$.push($label$$99$$));
...
D.$JSCompiler_StaticMethods__callCustomRenderer$$ = function $$JSCompiler_StaticMethods__callCustomRenderer$$$($JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$, $newRootElem_renderer$$11$$, $context$$601_state$$97$$, $prevState$$12$$) {
  if($JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$Displayable$ instanceof D.$DvtCustomDataItem$$) {
    var $contextHandler$$1$$ = $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$_view$.$getOptions$()._contextHandler;
    $contextHandler$$1$$ && ($context$$601_state$$97$$ = $contextHandler$$1$$($JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$Displayable$.$getElem$(), $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$Displayable$.$getRootElement$(), $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$_data$, $context$$601_state$$97$$, 
    $prevState$$12$$), $newRootElem_renderer$$11$$ = $newRootElem_renderer$$11$$($context$$601_state$$97$$), $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$ = $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$Displayable$, $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$_dataItem$ !== $newRootElem_renderer$$11$$ && 
    ($JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$_dataItem$ && ($JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$_dataItem$ instanceof D.$DvtBaseComponent$$ ? $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.removeChild($JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$_dataItem$) : 
    $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$getElem$().removeChild($JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$_dataItem$)), $newRootElem_renderer$$11$$ instanceof D.$DvtBaseComponent$$ ? $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$addChild$($newRootElem_renderer$$11$$) : $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$getElem$().appendChild($newRootElem_renderer$$11$$), 
    $JSCompiler_StaticMethods__callCustomRenderer$self_JSCompiler_StaticMethods_updateRootElement$self$$inline_8390$$.$_dataItem$ = $newRootElem_renderer$$11$$))
  }
};
...
D.$DvtMapAreaPeer$$ = function $$DvtMapAreaPeer$$$($data$$98$$, $dataLayer$$1$$, $displayable$$91$$, $label$$83$$) {
  this.Init($data$$98$$, $dataLayer$$1$$, $displayable$$91$$, $label$$83$$)
};
...
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($data$$99$$, $dataLayer$$2$$, $displayable$$92$$, $label$$84$$) {
  D.$DvtMapAreaPeer$$.$superclass$.Init.call(this, $data$$99$$, $dataLayer$$2$$, $displayable$$92$$, $label$$84$$)
};
...
D.$JSCompiler_prototypeAlias$$.contains = function $$JSCompiler_prototypeAlias$$$contains$($x$$275$$, $y$$247$$) {
  ...
  return $x$$275$$ >= $dims$$70$$.x && $x$$275$$ <= $dims$$70$$.x + $dims$$70$$.$w$ && $y$$247$$ >= $dims$$70$$.y && $y$$247$$ <= $dims$$70$$.y + $dims$$70$$.$h$
};
...
D.$JSCompiler_prototypeAlias$$.$updateDataLayer$ = function $$JSCompiler_prototypeAlias$$$$updateDataLayer$$($dataLayer$$4$$, $pzcMatrix$$13$$) {
  ...
  if(this.$_oldDataLayer$) {
    ...
    if("auto" == $anim$$39_oldContainers$$) {
      var $anim2_animHandler$$1_i$$811$$ = new D.$DvtDataAnimationHandler$$(this.$_tmap$.$getCtx$());
      (0,D.$JSCompiler_StaticMethods_constructAnimation$$)($anim2_animHandler$$1_i$$811$$, this.$_oldDataLayer$.$_dataObjs$.concat(this.$_oldDataLayer$.$_areaObjs$), $dataLayer$$4$$.$_dataObjs$.concat($dataLayer$$4$$.$_areaObjs$));
      this.$_animation$ = $anim2_animHandler$$1_i$$811$$.$getAnimation$()
    }else {
      if(D.$DvtBlackBoxAnimationHandler$$.isSupported($anim$$39_oldContainers$$)) {
        this.$_removeAnimRect$ = D.$JSCompiler_alias_TRUE$$;
        for(var $anim1_bounds1$$ = new D.$DvtRectangle$$(0, 0, this.$_tmap$.getWidth(), this.$_tmap$.getHeight()), $bounds2_oldNonScaledContainers$$ = (0,D.$JSCompiler_StaticMethods_getNonScaledContainers$$)(this.$_oldDataLayer$), $anim2_animHandler$$1_i$$811$$ = 0;$anim2_animHandler$$1_i$$811$$ < $bounds2_oldNonScaledContainers$$.length;$anim2_animHandler$$1_i$$811$$++) {
          var $rect$$50$$ = new D.$DvtRect$$(this.$_tmap$.$getCtx$(), 0, 0, this.$_tmap$.getWidth(), this.$_tmap$.getHeight());
          $rect$$50$$.$setFill$(D.$JSCompiler_alias_NULL$$);
          $bounds2_oldNonScaledContainers$$[$anim2_animHandler$$1_i$$811$$].$addChild$($rect$$50$$)
        }
        for(var $newNonScaledContainers_oldScaledContainers$$ = (0,D.$JSCompiler_StaticMethods_getNonScaledContainers$$)($dataLayer$$4$$), $anim2_animHandler$$1_i$$811$$ = 0;$anim2_animHandler$$1_i$$811$$ < $newNonScaledContainers_oldScaledContainers$$.length;$anim2_animHandler$$1_i$$811$$++) {
          $rect$$50$$ = new D.$DvtRect$$(this.$_tmap$.$getCtx$(), 0, 0, this.$_tmap$.getWidth(), this.$_tmap$.getHeight()), $rect$$50$$.$setFill$(D.$JSCompiler_alias_NULL$$), $newNonScaledContainers_oldScaledContainers$$[$anim2_animHandler$$1_i$$811$$].$addChild$($rect$$50$$)
        }
        ...
        for($anim2_animHandler$$1_i$$811$$ = 0;$anim2_animHandler$$1_i$$811$$ < $newNonScaledContainers_oldScaledContainers$$.length;$anim2_animHandler$$1_i$$811$$++) {
          $rect$$50$$ = new D.$DvtRect$$(this.$_tmap$.$getCtx$(), 0, 0, this.$_tmap$.getWidth() / this.$PzcMatrix$.$_a$, this.$_tmap$.getHeight() / this.$PzcMatrix$.$_a$), $rect$$50$$.$setFill$(D.$JSCompiler_alias_NULL$$), $newNonScaledContainers_oldScaledContainers$$[$anim2_animHandler$$1_i$$811$$].$addChild$($rect$$50$$)
        }
        for(var $newScaledContainers$$ = [$dataLayer$$4$$.$_dataAreaLayer$], $anim2_animHandler$$1_i$$811$$ = 0;$anim2_animHandler$$1_i$$811$$ < $newScaledContainers$$.length;$anim2_animHandler$$1_i$$811$$++) {
          $rect$$50$$ = new D.$DvtRect$$(this.$_tmap$.$getCtx$(), 0, 0, this.$_tmap$.getWidth() / this.$PzcMatrix$.$_a$, this.$_tmap$.getHeight() / this.$PzcMatrix$.$_a$), $rect$$50$$.$setFill$(D.$JSCompiler_alias_NULL$$), $newScaledContainers$$[$anim2_animHandler$$1_i$$811$$].$addChild$($rect$$50$$)
        }
        $anim2_animHandler$$1_i$$811$$ = D.$DvtBlackBoxAnimationHandler$$.$getCombinedAnimation$(this.$_tmap$.$getCtx$(), $anim$$39_oldContainers$$, $newNonScaledContainers_oldScaledContainers$$, $newScaledContainers$$, $bounds2_oldNonScaledContainers$$, $animDur$$2$$);
        this.$_animation$ = new D.$DvtParallelPlayable$$(this.$_tmap$.$getCtx$(), [$anim1_bounds1$$, $anim2_animHandler$$1_i$$811$$])
      }else {
        ...
        for($anim2_animHandler$$1_i$$811$$ = 0;$anim2_animHandler$$1_i$$811$$ < $anim$$39_oldContainers$$.length;$anim2_animHandler$$1_i$$811$$++) {
          $anim$$39_oldContainers$$[$anim2_animHandler$$1_i$$811$$].getParent().removeChild($anim$$39_oldContainers$$[$anim2_animHandler$$1_i$$811$$])
        }
      }
    }
...
D.$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($pzcMatrix$$14$$) {
  ...
  for(var $id$$292$$ in this.$DataLayers$) {
    this.$DataLayers$[$id$$292$$].$render$($pzcMatrix$$14$$)
  }
};
D.$JSCompiler_prototypeAlias$$.reset = function $$JSCompiler_prototypeAlias$$$reset$($fadeOutContainer$$, $doNotResetAreas$$2$$) {
  for(var $id$$293$$ in this.$DataLayers$) {
    this.$DataLayers$[$id$$293$$].reset($fadeOutContainer$$, $doNotResetAreas$$2$$)
  }
};
D.$JSCompiler_prototypeAlias$$.$HandleZoomEvent$ = function $$JSCompiler_prototypeAlias$$$$HandleZoomEvent$$($event$$748$$, $pzcMatrix$$15$$) {
  ...
  for(var $id$$294$$ in this.$DataLayers$) {
    this.$DataLayers$[$id$$294$$].$HandleZoomEvent$($event$$748$$, $pzcMatrix$$15$$)
  }
};
D.$JSCompiler_prototypeAlias$$.$HandlePanEvent$ = function $$JSCompiler_prototypeAlias$$$$HandlePanEvent$$($pzcMatrix$$16$$) {
  ...
  for(var $id$$295$$ in this.$DataLayers$) {
    this.$DataLayers$[$id$$295$$].$HandlePanEvent$($pzcMatrix$$16$$)
  }
};
D.$JSCompiler_prototypeAlias$$.$OnAnimationEnd$ = function $$JSCompiler_prototypeAlias$$$$OnAnimationEnd$$($dataLayer$$5_newScaledContainers$$1$$) {
  if(this.$_oldDataLayer$) {
    for(var $newNonScaledContainers$$1_oldContainers$$1$$ = [this.$_oldDataLayer$.$_dataAreaLayer$, this.$_oldDataLayer$.$_dataPointLayer$, this.$_oldDataLayer$.$_dataLabelLayer$], $i$$812$$ = 0;$i$$812$$ < $newNonScaledContainers$$1_oldContainers$$1$$.length;$i$$812$$++) {
      var $parent$$87$$ = $newNonScaledContainers$$1_oldContainers$$1$$[$i$$812$$].getParent();
      $parent$$87$$ && $parent$$87$$.removeChild($newNonScaledContainers$$1_oldContainers$$1$$[$i$$812$$])
    }
  }
  if(this.$_removeAnimRect$) {
    ...
    for($i$$812$$ = 0;$i$$812$$ < $newNonScaledContainers$$1_oldContainers$$1$$.length;$i$$812$$++) {
      $newNonScaledContainers$$1_oldContainers$$1$$[$i$$812$$].$removeChildAt$($newNonScaledContainers$$1_oldContainers$$1$$[$i$$812$$].$getNumChildren$() - 1)
    }
    $dataLayer$$5_newScaledContainers$$1$$ = [$dataLayer$$5_newScaledContainers$$1$$.$_dataAreaLayer$];
    for($i$$812$$ = 0;$i$$812$$ < $dataLayer$$5_newScaledContainers$$1$$.length;$i$$812$$++) {
      $dataLayer$$5_newScaledContainers$$1$$[$i$$812$$].$removeChildAt$($dataLayer$$5_newScaledContainers$$1$$[$i$$812$$].$getNumChildren$() - 1)
    }
  }
...
D.$JSCompiler_prototypeAlias$$.$discloseAreas$ = function $$JSCompiler_prototypeAlias$$$$discloseAreas$$($areas$$1$$, $fadeInObjs$$2$$) {
  for(var $i$$inline_8359$$ = 0;$i$$inline_8359$$ < $areas$$1$$.length;$i$$inline_8359$$++) {
    (0,D.$JSCompiler_StaticMethods__createAreaAndLabel$$)(this, $areas$$1$$[$i$$inline_8359$$], D.$JSCompiler_alias_FALSE$$), this.$_renderArea$[$areas$$1$$[$i$$inline_8359$$]] && (0,D.$JSCompiler_StaticMethods__addAreaAndLabel$$)(this, $areas$$1$$[$i$$inline_8359$$], $fadeInObjs$$2$$)
  }
  for(var $id$$289$$ in this.$DataLayers$) {
    this.$DataLayers$[$id$$289$$].$discloseAreas$($areas$$1$$, $fadeInObjs$$2$$, this.$PzcMatrix$)
  }
...
D.$JSCompiler_prototypeAlias$$.$undiscloseAreas$ = function $$JSCompiler_prototypeAlias$$$$undiscloseAreas$$($areas$$2$$, $fadeOutObjs$$) {
  for(var $childAreaLayer_id$$290$$ in this.$DataLayers$) {
    this.$DataLayers$[$childAreaLayer_id$$290$$].$undiscloseAreas$($areas$$2$$, $fadeOutObjs$$)
  }
  $childAreaLayer_id$$290$$ = (0,D.$JSCompiler_StaticMethods_getDrillChildLayer$$)(this.$_tmap$, this.$LayerName$);
  for(var $i$$794$$ = 0;$i$$794$$ < $areas$$2$$.length;$i$$794$$++) {
    var $areaName$$2$$ = $areas$$2$$[$i$$794$$];
    ...
    $childAreaLayer_id$$290$$ && $childAreaLayer_id$$290$$.$undiscloseAreas$((0,D.$JSCompiler_StaticMethods_getChildrenForArea$$)(this, $areaName$$2$$), $fadeOutObjs$$)
  }
};
...
D.$JSCompiler_StaticMethods___getObjectUnderPoint$$ = function $$JSCompiler_StaticMethods___getObjectUnderPoint$$$($JSCompiler_StaticMethods___getObjectUnderPoint$self$$, $x$$276$$, $y$$248$$) {
  for(var $id$$291$$ in $JSCompiler_StaticMethods___getObjectUnderPoint$self$$.$Areas$) {
    if($JSCompiler_StaticMethods___getObjectUnderPoint$self$$.$Areas$[$id$$291$$].contains($x$$276$$, $y$$248$$)) {
      return $JSCompiler_StaticMethods___getObjectUnderPoint$self$$.$Areas$[$id$$291$$]
    }
  }
  return D.$JSCompiler_alias_NULL$$
};
...
D.$DvtMapAreaLayer$$.prototype.$HandleZoomEvent$ = function $$DvtMapAreaLayer$$$$$HandleZoomEvent$$($event$$745$$, $pzcMatrix$$4$$) {
...
D.$JSCompiler_StaticMethods__selectImageBasedOnResolution$$ = function $$JSCompiler_StaticMethods__selectImageBasedOnResolution$$$($JSCompiler_StaticMethods__selectImageBasedOnResolution$self_images$$20$$) {
  ...
  for(var $i$$795$$ = 0;$i$$795$$ < $JSCompiler_StaticMethods__selectImageBasedOnResolution$self_images$$20$$.length;$i$$795$$++) {
    var $height$$143_image$$21$$ = $JSCompiler_StaticMethods__selectImageBasedOnResolution$self_images$$20$$[$i$$795$$], $source$$36$$ = $height$$143_image$$21$$.source, $width$$159$$ = $height$$143_image$$21$$.width, $height$$143_image$$21$$ = $height$$143_image$$21$$.height;
    if($source$$36$$ && -1 < $source$$36$$.search(".svg") || $width$$159$$ >= $widthRes$$1$$ && $height$$143_image$$21$$ >= $heightRes$$2$$ || $i$$795$$ == $JSCompiler_StaticMethods__selectImageBasedOnResolution$self_images$$20$$.length - 1) {
      return $source$$36$$
    }
  }
};
...
D.$JSCompiler_StaticMethods_getNavigableAreaObjects$$ = function $$JSCompiler_StaticMethods_getNavigableAreaObjects$$$($JSCompiler_StaticMethods_getNavigableAreaObjects$self$$) {
  for(var $navigables$$11$$ = [], $i$$797$$ = 0;$i$$797$$ < $JSCompiler_StaticMethods_getNavigableAreaObjects$self$$.$_areaObjs$.length;$i$$797$$++) {
    $JSCompiler_StaticMethods_getNavigableAreaObjects$self$$.$_areaObjs$[$i$$797$$].$isDrilled$() || $navigables$$11$$.push($JSCompiler_StaticMethods_getNavigableAreaObjects$self$$.$_areaObjs$[$i$$797$$])
  }
...
D.$JSCompiler_StaticMethods_getNavigableDisclosedAreaObjects$$ = function $$JSCompiler_StaticMethods_getNavigableDisclosedAreaObjects$$$($JSCompiler_StaticMethods_getNavigableDisclosedAreaObjects$self$$) {
  for(var $navigables$$12$$ = [], $i$$798$$ = 0;$i$$798$$ < $JSCompiler_StaticMethods_getNavigableDisclosedAreaObjects$self$$.$_areaObjs$.length;$i$$798$$++) {
    for(var $j$$107$$ = 0;$j$$107$$ < $JSCompiler_StaticMethods_getNavigableDisclosedAreaObjects$self$$.$_disclosed$.length;$j$$107$$++) {
      $JSCompiler_StaticMethods_getNavigableDisclosedAreaObjects$self$$.$_areaObjs$[$i$$798$$].$getLocation$() == $JSCompiler_StaticMethods_getNavigableDisclosedAreaObjects$self$$.$_disclosed$[$j$$107$$] && ($JSCompiler_StaticMethods_getNavigableDisclosedAreaObjects$self$$.$_areaObjs$[$i$$798$$].$isDrilled$() || $navigables$$12$$.push($JSCompiler_StaticMethods_getNavigableDisclosedAreaObjects$self$$.$_areaObjs$[$i$$798$$]))
    }
  }
...
D.$JSCompiler_StaticMethods_addDataObject$$ = function $$JSCompiler_StaticMethods_addDataObject$$$($JSCompiler_StaticMethods_addDataObject$self$$, $obj$$350$$) {
  ...
  if($obj$$350$$) {
    ...
    var $label$$85$$ = $obj$$350$$.$getLabel$();
    $label$$85$$ && $JSCompiler_StaticMethods_addDataObject$self$$.$_eventHandler$.$associate$($label$$85$$, $obj$$350$$)
  }
};
...
D.$JSCompiler_StaticMethods__renderAreaAndLabel$$ = function $$JSCompiler_StaticMethods__renderAreaAndLabel$$$($JSCompiler_StaticMethods__renderAreaAndLabel$self$$, $areaIndex$$1$$) {
  var $JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$;
  $JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$ = $JSCompiler_StaticMethods__renderAreaAndLabel$self$$.$_areaObjs$[$areaIndex$$1$$];
  var $areaDim$$1_displayable$$94_displayable$$inline_8376$$ = $JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$.$getDisplayable$(), $pathToCopy$$inline_8377$$ = $JSCompiler_StaticMethods__renderAreaAndLabel$self$$.$_parentLayer$.$AreaShapes$[$JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$.$getLocation$()];
  $pathToCopy$$inline_8377$$ ? ($areaDim$$1_displayable$$94_displayable$$inline_8376$$.$setCmds$($pathToCopy$$inline_8377$$.$getCmds$()), $JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$ = D.$JSCompiler_alias_TRUE$$) : ($JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$ = $JSCompiler_StaticMethods__renderAreaAndLabel$self$$.$_areaObjs$.indexOf($JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$), -1 !== 
  $JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$ && $JSCompiler_StaticMethods__renderAreaAndLabel$self$$.$_areaObjs$.splice($JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$, 1), $JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$ = D.$JSCompiler_alias_FALSE$$);
  if($JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$) {
    $areaDim$$1_displayable$$94_displayable$$inline_8376$$ = $JSCompiler_StaticMethods__renderAreaAndLabel$self$$.$_areaObjs$[$areaIndex$$1$$].$getDisplayable$();
    $JSCompiler_StaticMethods__renderAreaAndLabel$self$$.$_dataAreaLayer$.$addChild$($areaDim$$1_displayable$$94_displayable$$inline_8376$$);
    if($JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$ = $JSCompiler_StaticMethods__renderAreaAndLabel$self$$.$_areaObjs$[$areaIndex$$1$$].$getLabel$()) {
      0 < $JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$.$_boundRectangle$.length || ($areaDim$$1_displayable$$94_displayable$$inline_8376$$ = $areaDim$$1_displayable$$94_displayable$$inline_8376$$.$getDimensions$(), $JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$.$_boundRectangle$.push($areaDim$$1_displayable$$94_displayable$$inline_8376$$)), $JSCompiler_inline_result$$403_areaObj$$inline_8375_idx$$inline_11355_label$$86$$.update($JSCompiler_StaticMethods__renderAreaAndLabel$self$$.$_pzcMatrix$)
    }
...
D.$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($areaLabelsToRemove_pzcMatrix$$8$$) {
  ...
  for(var $i$$799$$ = 0;$i$$799$$ < $dataObjs$$.length;$i$$799$$++) {
    var $dataObj$$1_regionId$$ = $dataObjs$$[$i$$799$$], $displayable$$95$$ = $dataObj$$1_regionId$$.$getDisplayable$(), $label$$87$$ = $dataObj$$1_regionId$$.$getLabel$();
    if($label$$87$$) {
      ...
      $container$$191$$.$addChild$($label$$87$$);
  ...
  for($i$$799$$ = 0;$i$$799$$ < this.$_areaObjs$.length;$i$$799$$++) {
    $areaLabelsToRemove_pzcMatrix$$8$$[this.$_areaObjs$[$i$$799$$].$getLocation$()] && (this.$_areaObjs$[$i$$799$$].$_label$ = D.$JSCompiler_alias_NULL$$), (0,D.$JSCompiler_StaticMethods__renderAreaAndLabel$$)(this, $i$$799$$) || $i$$799$$--
  }
...
D.$JSCompiler_prototypeAlias$$.$discloseAreas$ = function $$JSCompiler_prototypeAlias$$$$discloseAreas$$($areas$$3$$, $fadeInObjs$$3$$, $pzcMatrix$$9_regionId$$1$$) {
  ...
  for(var $drilledAreas$$ = [], $j$$108$$ = 0;$j$$108$$ < $areas$$3$$.length;$j$$108$$++) {
    for(var $i$$800_label$$88_leaderLine$$1$$ = 0;$i$$800_label$$88_leaderLine$$1$$ < this.$_areaObjs$.length;$i$$800_label$$88_leaderLine$$1$$++) {
      if(this.$_areaObjs$[$i$$800_label$$88_leaderLine$$1$$].$getLocation$() == $areas$$3$$[$j$$108$$]) {
        $drilledAreas$$.push(this.$_areaObjs$[$i$$800_label$$88_leaderLine$$1$$].$getLocation$());
        (0,D.$JSCompiler_StaticMethods__renderAreaAndLabel$$)(this, $i$$800_label$$88_leaderLine$$1$$);
        var $displayable$$96$$ = this.$_areaObjs$[$i$$800_label$$88_leaderLine$$1$$].$getDisplayable$();
        $fadeInObjs$$3$$.push($displayable$$96$$);
        (0,D.$JSCompiler_StaticMethods_handleZoomEvent$$)($displayable$$96$$, $pzcMatrix$$9_regionId$$1$$);
        if($i$$800_label$$88_leaderLine$$1$$ = this.$_areaObjs$[$i$$800_label$$88_leaderLine$$1$$].$getLabel$()) {
          $fadeInObjs$$3$$.push($i$$800_label$$88_leaderLine$$1$$), ($i$$800_label$$88_leaderLine$$1$$ = $i$$800_label$$88_leaderLine$$1$$.$_leaderLine$) && $fadeInObjs$$3$$.push($i$$800_label$$88_leaderLine$$1$$)
        }
        break
      }
    }
  }
  for($i$$800_label$$88_leaderLine$$1$$ = 0;$i$$800_label$$88_leaderLine$$1$$ < this.$_dataObjs$.length;$i$$800_label$$88_leaderLine$$1$$++) {
    for($j$$108$$ = 0;$j$$108$$ < $areas$$3$$.length;$j$$108$$++) {
      $pzcMatrix$$9_regionId$$1$$ = this.$_dataObjs$[$i$$800_label$$88_leaderLine$$1$$].$getLocation$(), $displayable$$96$$ = this.$_dataObjs$[$i$$800_label$$88_leaderLine$$1$$].$getDisplayable$(), $pzcMatrix$$9_regionId$$1$$ != D.$JSCompiler_alias_NULL$$ ? $pzcMatrix$$9_regionId$$1$$ == $areas$$3$$[$j$$108$$] && (this.$_dataPointLayer$.$addChild$($displayable$$96$$), $fadeInObjs$$3$$.push($displayable$$96$$)) : (this.$_dataPointLayer$.$addChild$($displayable$$96$$), $fadeInObjs$$3$$.push($displayable$$96$$))
    }
  }
...
D.$JSCompiler_prototypeAlias$$.$undiscloseAreas$ = function $$JSCompiler_prototypeAlias$$$$undiscloseAreas$$($areas$$4$$, $fadeOutObjs$$2$$) {
  for(var $j$$109$$ = 0;$j$$109$$ < $areas$$4$$.length;$j$$109$$++) {
    for(var $i$$801_label$$89$$ = 0;$i$$801_label$$89$$ < this.$_areaObjs$.length;$i$$801_label$$89$$++) {
      if(this.$_areaObjs$[$i$$801_label$$89$$].$getLocation$() == $areas$$4$$[$j$$109$$]) {
        this.$_areaObjs$[$i$$801_label$$89$$].$isDrilled$() && this.$_areaObjs$[$i$$801_label$$89$$].$setDrilled$(D.$JSCompiler_alias_FALSE$$);
        this.$_areaObjs$[$i$$801_label$$89$$].$isSelected$() && this.$_selectionHandler$.$removeFromSelection$(this.$_areaObjs$[$i$$801_label$$89$$]);
        var $idx$$37$$ = D.$DvtArrayUtils$$.$getIndex$(this.$_disclosed$, $areas$$4$$[$j$$109$$]);
        if(-1 < $idx$$37$$ && (this.$_disclosed$.splice($idx$$37$$, 1), $fadeOutObjs$$2$$.push(this.$_areaObjs$[$i$$801_label$$89$$].$getDisplayable$()), $i$$801_label$$89$$ = this.$_areaObjs$[$i$$801_label$$89$$].$getLabel$())) {
          $fadeOutObjs$$2$$.push($i$$801_label$$89$$), $fadeOutObjs$$2$$.push($i$$801_label$$89$$.$_leaderLine$)
        }
        break
      }
    }
...
D.$JSCompiler_prototypeAlias$$.reset = function $$JSCompiler_prototypeAlias$$$reset$($fadeOutObjs$$4$$, $doNotResetAreas$$1$$) {
  if(this.$_selectionHandler$) {
    for(var $j$$110_selectedObjs$$ = this.$_selectionHandler$.getSelection(), $i$$804_label$$92$$ = 0;$i$$804_label$$92$$ < $j$$110_selectedObjs$$.length;$i$$804_label$$92$$++) {
      (!$doNotResetAreas$$1$$ || $doNotResetAreas$$1$$ && -1 == D.$DvtArrayUtils$$.$getIndex$($doNotResetAreas$$1$$, $j$$110_selectedObjs$$[$i$$804_label$$92$$].$getLocation$())) && this.$_selectionHandler$.$removeFromSelection$($j$$110_selectedObjs$$[$i$$804_label$$92$$])
    }
  }
  if("none" != this.$_tmap$.$_drillMode$) {
    for($j$$110_selectedObjs$$ = 0;$j$$110_selectedObjs$$ < this.$_drilled$.length;$j$$110_selectedObjs$$++) {
      for($i$$804_label$$92$$ = 0;$i$$804_label$$92$$ < this.$_areaObjs$.length;$i$$804_label$$92$$++) {
        if(this.$_areaObjs$[$i$$804_label$$92$$].$getLocation$() == this.$_drilled$[$j$$110_selectedObjs$$]) {
          this.$_areaObjs$[$i$$804_label$$92$$].$setDrilled$(D.$JSCompiler_alias_FALSE$$);
          var $displayable$$98$$ = this.$_areaObjs$[$i$$804_label$$92$$].$getDisplayable$();
          this.$_dataAreaLayer$.$addChild$($displayable$$98$$);
          $fadeOutObjs$$4$$.push($displayable$$98$$);
          if($i$$804_label$$92$$ = this.$_areaObjs$[$i$$804_label$$92$$].$getLabel$()) {
            $i$$804_label$$92$$.update(this.$_pzcMatrix$), $fadeOutObjs$$4$$.push($i$$804_label$$92$$), $fadeOutObjs$$4$$.push($i$$804_label$$92$$.$_leaderLine$)
          }
          break
        }
      }
      for($i$$804_label$$92$$ = 0;$i$$804_label$$92$$ < this.$_dataObjs$.length;$i$$804_label$$92$$++) {
        if(this.$_dataObjs$[$i$$804_label$$92$$].$getLocation$() == this.$_drilled$[$j$$110_selectedObjs$$]) {
          $displayable$$98$$ = this.$_dataObjs$[$i$$804_label$$92$$].$getDisplayable$();
...
D.$JSCompiler_prototypeAlias$$.$HandleZoomEvent$ = function $$JSCompiler_prototypeAlias$$$$HandleZoomEvent$$($event$$747$$, $pzcMatrix$$10$$) {
  ...
  var $i$$805_zoom$$12$$ = $pzcMatrix$$10$$.$_a$, $areaObjs_dataObjs$$1_j$$111_type$$244$$ = $event$$747$$.$getSubType$();
  if(this.$_bFixPatterns$ && "zoomed" == $areaObjs_dataObjs$$1_j$$111_type$$244$$) {
    this.$_bFixPatterns$ = D.$JSCompiler_alias_FALSE$$;
    for($areaObjs_dataObjs$$1_j$$111_type$$244$$ = 0;$areaObjs_dataObjs$$1_j$$111_type$$244$$ < this.$_areaObjs$.length;$areaObjs_dataObjs$$1_j$$111_type$$244$$++) {
      var $displayable$$99$$ = this.$_areaObjs$[$areaObjs_dataObjs$$1_j$$111_type$$244$$].$getDisplayable$(), $fill$$75$$ = $displayable$$99$$.$_ptFill$;
      if($fill$$75$$) {
        var $scaledFill$$ = new D.$DvtPatternFill$$;
        $fill$$75$$.$mergeProps$($scaledFill$$);
        $scaledFill$$.$setMatrix$(new D.$DvtMatrix$$(1 / $i$$805_zoom$$12$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, 1 / $i$$805_zoom$$12$$));
        $displayable$$99$$.$setFill$($scaledFill$$)
      }
    }
  }
  $areaObjs_dataObjs$$1_j$$111_type$$244$$ = this.$_areaObjs$;
  for($i$$805_zoom$$12$$ = 0;$i$$805_zoom$$12$$ < $areaObjs_dataObjs$$1_j$$111_type$$244$$.length;$i$$805_zoom$$12$$++) {
    $areaObjs_dataObjs$$1_j$$111_type$$244$$[$i$$805_zoom$$12$$].$HandleZoomEvent$($pzcMatrix$$10$$)
  }
  if(this.$_tmap$.$_isMarkerZoomBehaviorFixed$) {
    $areaObjs_dataObjs$$1_j$$111_type$$244$$ = this.$_dataObjs$;
    for($i$$805_zoom$$12$$ = 0;$i$$805_zoom$$12$$ < $areaObjs_dataObjs$$1_j$$111_type$$244$$.length;$i$$805_zoom$$12$$++) {
      $areaObjs_dataObjs$$1_j$$111_type$$244$$[$i$$805_zoom$$12$$].$HandleZoomEvent$($pzcMatrix$$10$$)
    }
  }
...
D.$JSCompiler_prototypeAlias$$.$__getDragTransferable$ = function $$JSCompiler_prototypeAlias$$$$__getDragTransferable$$($obj$$353_rowKeys$$3$$) {
  if(this.$_selectionHandler$) {
    ...
    $obj$$353_rowKeys$$3$$ = [];
    for(var $selection$$36$$ = this.$_selectionHandler$.getSelection(), $i$$806$$ = 0;$i$$806$$ < $selection$$36$$.length;$i$$806$$++) {
      $obj$$353_rowKeys$$3$$.push($selection$$36$$[$i$$806$$].getId())
    }
...
D.$JSCompiler_prototypeAlias$$.$__getDragFeedback$ = function $$JSCompiler_prototypeAlias$$$$__getDragFeedback$$() {
  for(var $displayables$$29$$ = [], $selection$$37$$ = this.$_selectionHandler$.getSelection(), $i$$807$$ = 0;$i$$807$$ < $selection$$37$$.length;$i$$807$$++) {
    $displayables$$29$$.push($selection$$37$$[$i$$807$$].$getDisplayable$())
  }
...
D.$JSCompiler_prototypeAlias$$.$isSelectionEvent$ = function $$JSCompiler_prototypeAlias$$$$isSelectionEvent$$($event$$770$$) {
  return this.$isNavigationEvent$($event$$770$$) && !$event$$770$$.ctrlKey
};
D.$JSCompiler_prototypeAlias$$.$processKeyDown$ = function $$JSCompiler_prototypeAlias$$$$processKeyDown$$($event$$771$$) {
  var $focusObj$$3_keyCode$$50$$ = $event$$771$$.keyCode;
  if(221 == $focusObj$$3_keyCode$$50$$) {
    ...
    $focusObj$$3_keyCode$$50$$ instanceof D.$DvtMapAreaPeer$$ && 0 < $navigables$$15$$.length && ($focusObj$$3_keyCode$$50$$ = (0,D.$DvtKeyboardHandler$getNextAdjacentNavigable$$)($focusObj$$3_keyCode$$50$$, $event$$771$$, $navigables$$15$$));
    (0,D.$JSCompiler_StaticMethods_SetClickInfo$$)(this.$_eventManager$, $focusObj$$3_keyCode$$50$$)
  }else {
    219 == $focusObj$$3_keyCode$$50$$ ? ($focusObj$$3_keyCode$$50$$ = this.$_eventManager$.$getFocus$(), $navigables$$15$$ = (0,D.$JSCompiler_StaticMethods_getNavigableAreas$$)(this.$_tmap$), !($focusObj$$3_keyCode$$50$$ instanceof D.$DvtMapAreaPeer$$) && 0 < $navigables$$15$$.length && ($focusObj$$3_keyCode$$50$$ = (0,D.$DvtKeyboardHandler$getNextAdjacentNavigable$$)($focusObj$$3_keyCode$$50$$, $event$$771$$, $navigables$$15$$)), (0,D.$JSCompiler_StaticMethods_SetClickInfo$$)(this.$_eventManager$, 
    $focusObj$$3_keyCode$$50$$)) : ($focusObj$$3_keyCode$$50$$ = D.$DvtThematicMapKeyboardHandler$$.$superclass$.$processKeyDown$.call(this, $event$$771$$), this.$isNavigationEvent$($event$$771$$) && !$event$$771$$.ctrlKey && (0,D.$JSCompiler_StaticMethods_SetClickInfo$$)(this.$_eventManager$, $focusObj$$3_keyCode$$50$$))
  }
  return $focusObj$$3_keyCode$$50$$
};
D.$JSCompiler_prototypeAlias$$.$isMultiSelectEvent$ = function $$JSCompiler_prototypeAlias$$$$isMultiSelectEvent$$($event$$772$$) {
  return 32 == $event$$772$$.keyCode && $event$$772$$.ctrlKey
};
D.$JSCompiler_prototypeAlias$$.$isNavigationEvent$ = function $$JSCompiler_prototypeAlias$$$$isNavigationEvent$$($event$$773_keyCode$$51$$) {
  var $isNavigable$$ = D.$DvtThematicMapKeyboardHandler$$.$superclass$.$isNavigationEvent$.call(this, $event$$773_keyCode$$51$$);
  if(!$isNavigable$$ && ($event$$773_keyCode$$51$$ = $event$$773_keyCode$$51$$.keyCode, 219 == $event$$773_keyCode$$51$$ || 221 == $event$$773_keyCode$$51$$)) {
    $isNavigable$$ = D.$JSCompiler_alias_TRUE$$
  }
  return $isNavigable$$
};
D.$DvtThematicMapEventManager$$ = function $$DvtThematicMapEventManager$$$($context$$605$$, $callback$$160$$, $callbackObj$$110$$) {
  this.Init($context$$605$$, $callback$$160$$, $callbackObj$$110$$)
};
...
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($context$$606$$, $callback$$161$$, $callbackObj$$111$$) {
  D.$DvtThematicMapEventManager$$.$superclass$.Init.call(this, $context$$606$$, $callback$$161$$, $callbackObj$$111$$);
  this.$_selectionHandlers$ = {};
  this.$_tmap$ = $callbackObj$$111$$;
  this.$_bPassOnEvent$ = D.$JSCompiler_alias_FALSE$$
};
D.$JSCompiler_prototypeAlias$$.$getSelectionHandler$ = function $$JSCompiler_prototypeAlias$$$$getSelectionHandler$$($logicalObj$$20$$) {
  if($logicalObj$$20$$ && $logicalObj$$20$$.$getDataLayer$) {
    return this.$_selectionHandlers$[$logicalObj$$20$$.$getDataLayer$().$getClientId$()]
  }
};
...
D.$JSCompiler_prototypeAlias$$.$OnMouseOver$ = function $$JSCompiler_prototypeAlias$$$$OnMouseOver$$($event$$759$$) {
  var $obj$$359$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $event$$759$$.target);
...
D.$JSCompiler_prototypeAlias$$.$OnClick$ = function $$JSCompiler_prototypeAlias$$$$OnClick$$($event$$761$$) {
  var $obj$$360$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $event$$761$$.target);
  ...
  if(!$obj$$360$$ || !$obj$$360$$.$isSelectable$ || !$obj$$360$$.$isSelectable$()) {
    for(var $clientId$$12$$ in this.$_selectionHandlers$) {
      if(this.$_selectionHandlers$[$clientId$$12$$].$processClick$(D.$JSCompiler_alias_NULL$$, $event$$761$$.ctrlKey)) {
  ...
  this.$_handleClick$($obj$$360$$, $event$$761$$.pageX, $event$$761$$.pageY)
};
D.$JSCompiler_prototypeAlias$$.$_handleClick$ = function $$JSCompiler_prototypeAlias$$$$_handleClick$$($obj$$361$$, $pageX$$11$$, $pageY$$11$$) {
  if($obj$$361$$ instanceof D.$DvtMapObjPeer$$) {
    var $callback$$162$$ = $obj$$361$$.$getLinkCallback$();
    $callback$$162$$ ? $callback$$162$$.call() : $obj$$361$$.$getAction$() != D.$JSCompiler_alias_NULL$$ ? (0,D.$JSCompiler_StaticMethods_HandleAction$$)(this, $obj$$361$$, $pageX$$11$$, $pageY$$11$$) : $obj$$361$$.$getShowPopupBehaviors$() && (this.$_tmap$.$_eventClientId$ = $obj$$361$$.$getDataLayer$().$getClientId$())
  }
};
D.$JSCompiler_StaticMethods_HandleAction$$ = function $$JSCompiler_StaticMethods_HandleAction$$$($JSCompiler_StaticMethods_HandleAction$self$$, $obj$$362_offset$$34$$, $pageX$$12$$, $pageY$$12$$) {
  ...
  $pageX$$12$$ != D.$JSCompiler_alias_NULL$$ && $pageY$$12$$ != D.$JSCompiler_alias_NULL$$ && ($obj$$362_offset$$34$$ = (0,D.$JSCompiler_StaticMethods_pageToStageCoords$$)($JSCompiler_StaticMethods_HandleAction$self$$.$_tmap$.$getCtx$(), $pageX$$12$$, $pageY$$12$$), (0,D.$JSCompiler_StaticMethods_addParam$$)($actionEvent$$, "pointXY", {x:$obj$$362_offset$$34$$.x, y:$obj$$362_offset$$34$$.y}));
...
D.$JSCompiler_StaticMethods_SetClickInfo$$ = function $$JSCompiler_StaticMethods_SetClickInfo$$$($JSCompiler_StaticMethods_SetClickInfo$self$$, $obj$$363$$) {
  var $clientId$$13$$ = D.$JSCompiler_alias_NULL$$, $dataLayer$$11_mapLayer$$1$$ = D.$JSCompiler_alias_NULL$$, $clickedObj$$ = D.$JSCompiler_alias_NULL$$;
  ...
  var $JSCompiler_StaticMethods_setClickInfo$self$$inline_8586$$ = $JSCompiler_StaticMethods_SetClickInfo$self$$.$_tmap$;
  $JSCompiler_StaticMethods_setClickInfo$self$$inline_8586$$.$_clickedLayerName$ = $dataLayer$$11_mapLayer$$1$$;
  $JSCompiler_StaticMethods_setClickInfo$self$$inline_8586$$.$_clickedDataLayerId$ = $clientId$$13$$;
  $JSCompiler_StaticMethods_setClickInfo$self$$inline_8586$$.$_clickedObject$ = $clickedObj$$
};
D.$JSCompiler_prototypeAlias$$ = D.$DvtThematicMapEventManager$$.prototype;
D.$JSCompiler_prototypeAlias$$.$OnDblClickInternal$ = function $$JSCompiler_prototypeAlias$$$$OnDblClickInternal$$($drillEvent_event$$762_obj$$364$$) {
  $drillEvent_event$$762_obj$$364$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $drillEvent_event$$762_obj$$364$$.target);
  this.$getSelectionHandler$($drillEvent_event$$762_obj$$364$$) && (this.$_drillMode$ && "none" != this.$_drillMode$) && ($drillEvent_event$$762_obj$$364$$ = new D.$DvtMapDrillEvent$$(D.$DvtMapDrillEvent$$.$DRILL_DOWN$), this.$_callback$.call(this.$_callbackObj$, $drillEvent_event$$762_obj$$364$$))
};
D.$JSCompiler_prototypeAlias$$.$ProcessKeyboardEvent$ = function $$JSCompiler_prototypeAlias$$$$ProcessKeyboardEvent$$($event$$763$$) {
  var $eventConsumed$$7$$ = D.$JSCompiler_alias_TRUE$$, $keyCode$$49$$ = $event$$763$$.keyCode, $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$ = this.$getFocus$(), $callback$$163_focusDisp$$1_toFit$$inline_8592$$ = $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$getDisplayable$();
  9 != $keyCode$$49$$ && this.$_bPassOnEvent$ ? ($callback$$163_focusDisp$$1_toFit$$inline_8592$$.$fireKeyboardListener$($event$$763$$), $event$$763$$.preventDefault()) : (48 == $keyCode$$49$$ || 96 == $keyCode$$49$$) && $event$$763$$.ctrlKey && $event$$763$$.shiftKey ? (this.$_tmap$.$resetMap$(), $event$$763$$.preventDefault()) : 220 == $keyCode$$49$$ ? (($JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$ = this.$_tmap$.$_legendPanel$) && ($JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$ instanceof 
  D.$DvtCollapsiblePanel$$ ? (0,D.$JSCompiler_StaticMethods_setCollapsed$$)($JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$, !$JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.isCollapsed()) : $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$ instanceof D.$DvtPanelDrawer$$ && $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$setDisclosed$(!$JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$isDisclosed$())), 
  $event$$763$$.preventDefault()) : 13 == $keyCode$$49$$ ? $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$ instanceof D.$DvtMapObjPeer$$ && (($callback$$163_focusDisp$$1_toFit$$inline_8592$$ = $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$getLinkCallback$()) ? $callback$$163_focusDisp$$1_toFit$$inline_8592$$.call() : $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$getAction$() != D.$JSCompiler_alias_NULL$$ ? 
  (0,D.$JSCompiler_StaticMethods_HandleAction$$)(this, $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$) : $event$$763$$.shiftKey ? this.$_tmap$.$drillUp$() : this.$_tmap$.$drillDown$(), $event$$763$$.preventDefault()) : 32 == $keyCode$$49$$ && $event$$763$$.ctrlKey ? ((0,D.$JSCompiler_StaticMethods_SetClickInfo$$)(this, $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$), (0,D.$JSCompiler_StaticMethods_ProcessSelectionEventHelper$$)(this, 
  $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$, D.$JSCompiler_alias_TRUE$$), $event$$763$$.preventDefault()) : (48 == $keyCode$$49$$ || 96 == $keyCode$$49$$) && $event$$763$$.ctrlKey ? ($event$$763$$.altKey ? ($JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$ = this.$_tmap$, $callback$$163_focusDisp$$1_toFit$$inline_8592$$ || ($callback$$163_focusDisp$$1_toFit$$inline_8592$$ = $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$_zoomToFitObject$), 
  $callback$$163_focusDisp$$1_toFit$$inline_8592$$ || ($callback$$163_focusDisp$$1_toFit$$inline_8592$$ = $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$_clickedObject$), $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$_zoomToFitBounds$($callback$$163_focusDisp$$1_toFit$$inline_8592$$.$getDimensions$())) : (0,D.$JSCompiler_StaticMethods_fitSelectedRegions$$)(this.$_tmap$), $event$$763$$.preventDefault()) : 9 == $keyCode$$49$$ && $callback$$163_focusDisp$$1_toFit$$inline_8592$$ instanceof 
  D.$DvtCustomDataItem$$ ? !$event$$763$$.shiftKey && $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$isShowingKeyboardFocusEffect$() ? ($JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$hideKeyboardFocusEffect$(), $callback$$163_focusDisp$$1_toFit$$inline_8592$$.$fireKeyboardListener$($event$$763$$), $event$$763$$.preventDefault(), this.$_bPassOnEvent$ = D.$JSCompiler_alias_TRUE$$) : ($event$$763$$.shiftKey && this.$_bPassOnEvent$ ? 
  (this.$ShowFocusEffect$($event$$763$$, $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$), $event$$763$$.preventDefault()) : (this.$_bPassOnEvent$ && $JSCompiler_StaticMethods_fitRegion$self$$inline_8591_focusObj$$2_legendPanel$$.$showKeyboardFocusEffect$(), $eventConsumed$$7$$ = D.$DvtThematicMapEventManager$$.$superclass$.$ProcessKeyboardEvent$.call(this, $event$$763$$)), this.$_bPassOnEvent$ = D.$JSCompiler_alias_FALSE$$) : $eventConsumed$$7$$ = D.$DvtThematicMapEventManager$$.$superclass$.$ProcessKeyboardEvent$.call(this, 
  $event$$763$$);
...
D.$JSCompiler_prototypeAlias$$.$OnComponentTouchClick$ = function $$JSCompiler_prototypeAlias$$$$OnComponentTouchClick$$($event$$764$$) {
  if(!(0,D.$JSCompiler_StaticMethods_GetEventInfo$$)(this, $event$$764$$, "panned")) {
    var $obj$$365$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $event$$764$$.target);
    ...
    if($obj$$365$$ instanceof D.$DvtThematicMap$$) {
      for(var $clientId$$14$$ in this.$_selectionHandlers$) {
        if(this.$_selectionHandlers$[$clientId$$14$$].$processClick$(D.$JSCompiler_alias_NULL$$, $event$$764$$.ctrlKey)) {
          for(var $selectedObjs$$2_selectionEvent$$3$$ = this.$_selectionHandlers$[$clientId$$14$$].getSelection(), $selectedIds$$10$$ = [], $i$$831$$ = 0;$i$$831$$ < $selectedObjs$$2_selectionEvent$$3$$.length;$i$$831$$++) {
            $selectedIds$$10$$.push($selectedObjs$$2_selectionEvent$$3$$[$i$$831$$].getId())
          }
    ...
    this.$_handleClick$($obj$$365$$, $event$$764$$.$touch$.pageX, $event$$764$$.$touch$.pageY)
  }
};
D.$JSCompiler_prototypeAlias$$.$HandleTouchHoverStartInternal$ = function $$JSCompiler_prototypeAlias$$$$HandleTouchHoverStartInternal$$($event$$765_obj$$366$$) {
  $event$$765_obj$$366$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $event$$765_obj$$366$$.target);
  this.$_tmap$.$_eventClientId$ = $event$$765_obj$$366$$ && $event$$765_obj$$366$$.$getShowPopupBehaviors$ && $event$$765_obj$$366$$.$getDataLayer$ ? $event$$765_obj$$366$$.$getDataLayer$().$getClientId$() : D.$JSCompiler_alias_NULL$$
};
D.$JSCompiler_prototypeAlias$$.$HandleTouchHoverOverInternal$ = function $$JSCompiler_prototypeAlias$$$$HandleTouchHoverOverInternal$$($event$$766_obj$$367$$) {
  $event$$766_obj$$367$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $event$$766_obj$$367$$.target);
  this.$_tmap$.$_eventClientId$ = $event$$766_obj$$367$$ && $event$$766_obj$$367$$.$getShowPopupBehaviors$ && $event$$766_obj$$367$$.$getDataLayer$ ? $event$$766_obj$$367$$.$getDataLayer$().$getClientId$() : D.$JSCompiler_alias_NULL$$
};
D.$JSCompiler_prototypeAlias$$.$HandleTouchDblClickInternal$ = function $$JSCompiler_prototypeAlias$$$$HandleTouchDblClickInternal$$($drillEvent$$1_event$$767$$) {
  var $obj$$368$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $drillEvent$$1_event$$767$$.target);
  $obj$$368$$ && (this.$getSelectionHandler$($obj$$368$$) && this.$_drillMode$ && "none" != this.$_drillMode$) && ((0,D.$JSCompiler_StaticMethods_ProcessSelectionEventHelper$$)(this, $obj$$368$$, $drillEvent$$1_event$$767$$.ctrlKey), $drillEvent$$1_event$$767$$ = new D.$DvtMapDrillEvent$$(D.$DvtMapDrillEvent$$.$DRILL_DOWN$), this.$_callback$.call(this.$_callbackObj$, $drillEvent$$1_event$$767$$))
};
D.$JSCompiler_prototypeAlias$$.$HandleTouchActionsEnd$ = function $$JSCompiler_prototypeAlias$$$$HandleTouchActionsEnd$$($event$$768$$, $touch$$53$$) {
  var $obj$$369$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $event$$768$$.target);
  (0,D.$JSCompiler_StaticMethods_SetClickInfo$$)(this, $obj$$369$$);
  D.$DvtThematicMapEventManager$$.$superclass$.$HandleTouchActionsEnd$.call(this, $event$$768$$, $touch$$53$$)
};
D.$JSCompiler_prototypeAlias$$.$ProcessRolloverEvent$ = function $$JSCompiler_prototypeAlias$$$$ProcessRolloverEvent$$($event$$769_options$$273$$, $categories$$30_hoverBehaviorDelay$$6_obj$$370$$, $bOver$$13_rolloverEvent$$8$$) {
  $event$$769_options$$273$$ = this.$_tmap$.$getOptions$();
  "dim" == $event$$769_options$$273$$.hoverBehavior && ($categories$$30_hoverBehaviorDelay$$6_obj$$370$$ = $categories$$30_hoverBehaviorDelay$$6_obj$$370$$.$getCategories$ ? $categories$$30_hoverBehaviorDelay$$6_obj$$370$$.$getCategories$() : [], $event$$769_options$$273$$.highlightedCategories = $bOver$$13_rolloverEvent$$8$$ ? $categories$$30_hoverBehaviorDelay$$6_obj$$370$$.slice() : D.$JSCompiler_alias_NULL$$, $bOver$$13_rolloverEvent$$8$$ = new D.$DvtCategoryRolloverEvent$$($bOver$$13_rolloverEvent$$8$$ ? 
  "categoryRollOver" : "categoryRollOut", $event$$769_options$$273$$.highlightedCategories), $categories$$30_hoverBehaviorDelay$$6_obj$$370$$ = (0,D.$DvtStyleUtils$getTimeMilliseconds$$)($event$$769_options$$273$$.styleDefaults.hoverBehaviorDelay), this.$RolloverHandler$.$processEvent$($bOver$$13_rolloverEvent$$8$$, (0,D.$JSCompiler_StaticMethods_getNavigableAreas$$)(this.$_tmap$).concat((0,D.$JSCompiler_StaticMethods_getNavigableObjects$$)(this.$_tmap$)), $categories$$30_hoverBehaviorDelay$$6_obj$$370$$, 
  "any" == $event$$769_options$$273$$.highlightMatch))
};
...
D.$DvtThematicMapJsonParser$$.prototype.parse = function $$DvtThematicMapJsonParser$$$$parse$($options$$275$$) {
  var $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = $options$$275$$.animationDuration;
  "string" == typeof $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ ? "ms" == $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.slice(-2) ? $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = 
  (0,window.parseInt)($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.slice(0, -2)) / 1E3 : "s" == $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.slice(-1) && 
  ($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = (0,window.parseFloat)($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.slice(0, -1))) : $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ /= 
  1E3;
  this.$_tmap$.$setAnimationDuration$($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$);
  ...
  this.$_isCustomBasemap$ = $options$$275$$.source != D.$JSCompiler_alias_NULL$$;
  var $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = this.$_tmap$, $attr$$inline_11410_basemap$$inline_8627_i$$inline_8623$$ = this.$_isCustomBasemap$ ? "$" + $options$$275$$.basemap : $options$$275$$.basemap;
  $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.$_bBaseMapChanged$ = $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.$_mapName$ && $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.$_mapName$ != 
  $attr$$inline_11410_basemap$$inline_8627_i$$inline_8623$$;
  $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.$_mapName$ = $attr$$inline_11410_basemap$$inline_8627_i$$inline_8623$$;
  this.$_tmap$.$setFeaturesOff$($options$$275$$.featuresOff);
  this.$_tmap$.$_controlPanelBehavior$ = $options$$275$$.controlPanelBehavior;
  $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = $options$$275$$.tooltipDisplay;
  "shortDesc" == $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ ? $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = "shortDescOnly" : "labelAndShortDesc" == 
  $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ && ($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = "auto");
  this.$_tmap$.$_displayTooltips$ = $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$;
  ($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = $options$$275$$.popups) && this.$_tmap$.$setShowPopupBehaviors$(this.$_getShowPopupBehaviors$($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$));
  ...
  (0,window.isNaN)($options$$275$$.maxZoom) || ($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = window.Math.max($options$$275$$.maxZoom, 1), this.$_tmap$.$_maxZoomFactor$ = $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$);
  $options$$275$$._legend && (this.$_tmap$.$_legendData$ = $options$$275$$._legend);
  $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = $options$$275$$.styleDefaults;
  (0,D.$JSCompiler_StaticMethods_parseComponentJson$$)(this.$_tmap$, $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$);
  this.$_areaLayerStyle$ = new D.$DvtCSSStyle$$($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.areaStyle);
  (0,D.$JSCompiler_StaticMethods_parseInlineStyle$$)(this.$_areaLayerStyle$, $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.labelStyle);
  this.$_areaDropSiteStyle$ = new D.$DvtCSSStyle$$($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.dropTargetStyle);
  this.$_tmap$.$_styleDefaults$ = $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$;
  if(this.$_isCustomBasemap$ && $options$$275$$.sourceXml) {
    for(var $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = (new D.$DvtXmlParser$$).parse($options$$275$$.sourceXml).$getChildNodes$(), $childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$, $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$, 
    $attr$$inline_11410_basemap$$inline_8627_i$$inline_8623$$ = 0;$attr$$inline_11410_basemap$$inline_8627_i$$inline_8623$$ < $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.length;$attr$$inline_11410_basemap$$inline_8627_i$$inline_8623$$++) {
      if($childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$ = $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$[$attr$$inline_11410_basemap$$inline_8627_i$$inline_8623$$], $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$ = $childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$.getName(), 
      "layer" == $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$) {
        $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$ = $childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$;
        $childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$ = $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.$getChildNodes$();
        $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$ = $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.$getAttr$("id");
        for(var $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$ = D.$JSCompiler_alias_VOID$$, $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$ = D.$JSCompiler_alias_VOID$$, $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$ = [], $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$ = 
        0;$children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$ < $childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$.length;$children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$++) {
          if($JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$ = $childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$[$children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$], $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$ = $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.getName(), 
          "image" == $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$) {
            $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$ = {};
            $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$.source = $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$getAttr$("source");
            $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$.width = $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$getAttr$("width");
            $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$.height = $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$getAttr$("height");
            var $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$ = $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$getAttr$("bidi"), $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$ = $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$getAttr$("dir");
            $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$.dir = "true" == $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$ || "rtl" == $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$ ? "rtl" : "ltr";
            $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$.push($JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$)
          }
        }
        this.$_customAreaLayerImages$[$areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$] = $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$
      }else {
        if("points" == $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$) {
          $childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$ = $childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$.$getChildNodes$();
          $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$ = $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$ = D.$JSCompiler_alias_VOID$$;
          $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$ = {};
          $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$ = {};
          for($JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$ = 0;$JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$ < $childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$.length;$JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$++) {
            $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$ = $childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$[$JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$], $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$ = $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.getName(), 
            "point" == $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$ && ($children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$[$areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.$getAttr$("name")] = [$areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.$getAttr$("x"), $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.$getAttr$("y")], 
            $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$[$areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.$getAttr$("name")] = [D.$JSCompiler_alias_NULL$$, $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.$getAttr$("longLabel")])
          }
          D.$DvtBaseMapManager$$.$registerBaseMapLayer$(this.$_tmap$.$_mapName$, "cities", $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$, $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, 1)
        }
      }
    }
  }
  $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$ = $options$$275$$.areaLayers;
  $attr$$inline_11410_basemap$$inline_8627_i$$inline_8623$$ = this.$_tmap$.$_mapName$;
  for($childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$ = 0;$childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$ < $JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$.length;$childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$++) {
    if($areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$ = D.$DvtJSONUtils$$.$merge$($JSCompiler_StaticMethods_setMapName$self$$inline_11409_animDur$$inline_8608_areaLayers$$inline_8626_childNodes$$inline_8620_maxZoomFactor$$inline_11443_popups$$inline_8610_styles$$inline_8616_tooltipDisplay$$inline_8609$$[$childNodes$$inline_11450_childNodes$$inline_11462_i$$inline_8628_node$$inline_8621$$], D.$DvtThematicMapDefaults$DEFAULT_AREA_LAYER$$), 
    $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$ = $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.layer) {
      $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.areaStyle && (0,D.$JSCompiler_StaticMethods_parseInlineStyle$$)(this.$_areaLayerStyle$, $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.areaStyle);
      $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.labelStyle && (0,D.$JSCompiler_StaticMethods_parseInlineStyle$$)(this.$_areaLayerStyle$, $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.labelStyle);
      if(this.$_isCustomBasemap$) {
        $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$ = $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$ = new D.$DvtMapCustomAreaLayer$$(this.$_tmap$, $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$, $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.labelDisplay, 
        $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.labelType, this.$_tmap$.$getEventManager$());
        $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$ = this.$_customAreaLayerImages$[$children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$];
        $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$ = D.$JSCompiler_alias_NULL$$;
        $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$ = (0,D.$DvtAgent$isRightToLeft$$)($JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$_tmap$.$getCtx$());
        if($children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$ && 0 < $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$.length) {
          var $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$ = $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$[0].width, $context$$inline_11481_refHeight$$inline_11474$$ = $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$[0].height;
          $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$_layerWidth$ = $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$;
          $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$_layerHeight$ = $context$$inline_11481_refHeight$$inline_11474$$;
          for(var $area$$inline_11482_locImages$$inline_11475$$ = [], $areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$ = 0;$areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$ < $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$.length;$areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$++) {
            $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$ && "rtl" == $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$[$areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$].dir ? $area$$inline_11482_locImages$$inline_11475$$.push($children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$[$areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$]) : 
            !$JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$ && "ltr" == $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$[$areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$].dir && $area$$inline_11482_locImages$$inline_11475$$.push($children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$[$areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$])
          }
          $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$_areaLayerImages$ = 0 < $area$$inline_11482_locImages$$inline_11475$$.length ? $area$$inline_11482_locImages$$inline_11475$$ : $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$;
          $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$_imageSrc$ = (0,D.$JSCompiler_StaticMethods__selectImageBasedOnResolution$$)($JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$);
          $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$ = new D.$DvtImage$$($JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$_tmap$.$getCtx$(), $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$_imageSrc$, 0, 0, $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$, 
          $context$$inline_11481_refHeight$$inline_11474$$)
        }
        $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$ && ((0,D.$JSCompiler_StaticMethods_setAreaNames$$)($JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$, {image:[D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$]}), $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$.$AreaShapes$ = 
        {image:$bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$})
      }else {
        $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$ = new D.$DvtMapAreaLayer$$(this.$_tmap$, $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$, $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.labelDisplay, $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.labelType, this.$_tmap$.$getEventManager$());
        $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$ = D.$DvtBaseMapManager$$.$getAreaNames$($attr$$inline_11410_basemap$$inline_8627_i$$inline_8623$$, $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$);
        $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$ = $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$;
        $areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$ = $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$;
        $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$ = {};
        $context$$inline_11481_refHeight$$inline_11474$$ = this.$_tmap$.$getCtx$();
        $area$$inline_11482_locImages$$inline_11475$$ = D.$JSCompiler_alias_VOID$$;
        for($area$$inline_11482_locImages$$inline_11475$$ in $areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$) {
          $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$[$area$$inline_11482_locImages$$inline_11475$$] = new D.$DvtPath$$($context$$inline_11481_refHeight$$inline_11474$$);
          if(($areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$ = this.$_areaLayerStyle$.$getStyle$("border-color")) && "transparent" != $areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$) {
            $areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$ = new D.$DvtSolidStroke$$($areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$), this.$_tmap$.$_bSupportsVectorEffects$ && ($areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$.$_bFixedWidth$ = D.$JSCompiler_alias_TRUE$$), $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$[$area$$inline_11482_locImages$$inline_11475$$].$setStroke$($areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$)
          }
          $areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$ = this.$_areaLayerStyle$.$getStyle$("background-color");
          "transparent" != $areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$ ? $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$[$area$$inline_11482_locImages$$inline_11475$$].$setSolidFill$($areaNames$$inline_11479_backgroundColor$$inline_11485_borderColor$$inline_11483_i$$inline_11476_stroke$$inline_11484$$) : $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$[$area$$inline_11482_locImages$$inline_11475$$].$setFill$(D.$JSCompiler_alias_NULL$$)
        }
        $JSCompiler_temp_const$$9380_i$$inline_11467_image$$inline_11456_isRTL$$inline_11472_nodeName$$inline_11453$$.$AreaShapes$ = $bidi$$inline_11457_refWidth$$inline_11473_shape$$inline_11471_shapes$$inline_11480$$;
        (0,D.$JSCompiler_StaticMethods_setAreaNames$$)($images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$, $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$);
        $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$ = D.$DvtBaseMapManager$$.$getAreaLabelInfo$($attr$$inline_11410_basemap$$inline_8627_i$$inline_8623$$, $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$);
        $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$.$_labelInfo$ = $JSCompiler_StaticMethods_setAreaLayerImage$self$$inline_11469_areaNames$$inline_8632_dir$$inline_11458_labels$$inline_11466_node$$inline_11452_values$$inline_11491$$;
        $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$ = D.$DvtBaseMapManager$$.$getChildrenForLayerAreas$(this.$_tmap$.$_mapName$, $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$);
        $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$.$_children$ = $children$$inline_11494_i$$inline_11455_images$$inline_11470_layer$$inline_8630_points$$inline_11465$$
      }
      $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$.$_layerCSSStyle$ = this.$_areaLayerStyle$;
      $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$.$_dropSiteCSSStyle$ = this.$_areaDropSiteStyle$;
      $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$.$setAnimation$("auto" == $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.animationOnLayerChange ? "alphaFade" : $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.animationOnLayerChange);
      $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$.$setAnimationDuration$(this.$_tmap$.$getAnimationDuration$());
      this.$_tmap$.$_layers$.push($images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$);
      $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.areaDataLayer && (0,D.$JSCompiler_StaticMethods_ParseDataLayers$$)(this, [$areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.areaDataLayer], $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_TRUE$$);
      $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.pointDataLayers && (0,D.$JSCompiler_StaticMethods_ParseDataLayers$$)(this, $areaLayer$$inline_8629_layerName$$inline_11451_node$$inline_11463_nodeName$$inline_8622_xmlNode$$inline_11449$$.pointDataLayers, $images$$inline_11454_mapLayer$$inline_8631_nodeName$$inline_11464$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_FALSE$$)
    }
  }
  (0,D.$JSCompiler_StaticMethods_ParseDataLayers$$)(this, $options$$275$$.pointDataLayers, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_FALSE$$)
};
D.$JSCompiler_StaticMethods_ParseDataLayers$$ = function $$JSCompiler_StaticMethods_ParseDataLayers$$$($JSCompiler_StaticMethods_ParseDataLayers$self$$, $dataLayers$$6$$, $parentLayer$$6$$, $topLayerName$$2$$, $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$) {
  if($dataLayers$$6$$) {
    for(var $i$$833$$ = 0;$i$$833$$ < $dataLayers$$6$$.length;$i$$833$$++) {
      var $dataLayerOptions$$1_initSelections$$ = D.$DvtJSONUtils$$.$merge$($dataLayers$$6$$[$i$$833$$], D.$DvtThematicMapDefaults$DEFAULT_DATA_LAYER$$);
      if($dataLayerOptions$$1_initSelections$$.markerDefs) {
        var $area$$inline_8689_dataLayer$$12_markerDefs$$ = $dataLayerOptions$$1_initSelections$$.markerDefs, $markerDef$$16$$;
        for($markerDef$$16$$ in $area$$inline_8689_dataLayer$$12_markerDefs$$) {
          if(!$JSCompiler_StaticMethods_ParseDataLayers$self$$.$_customMarkerDefs$[$markerDef$$16$$]) {
            var $initDisclosed_xmlNode$$67$$ = (new D.$DvtXmlParser$$).parse($area$$inline_8689_dataLayer$$12_markerDefs$$[$markerDef$$16$$]);
      ...
      if($parentLayer$$6$$) {
        if($parentLayer$$6$$ instanceof D.$DvtMapAreaLayer$$ && $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$) {
          for($area$$inline_8689_dataLayer$$12_markerDefs$$ in $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$ = $parentLayer$$6$$, $area$$inline_8689_dataLayer$$12_markerDefs$$ = D.$JSCompiler_alias_VOID$$, $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$.$AreaNames$) {
            $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$.$_renderArea$[$area$$inline_8689_dataLayer$$12_markerDefs$$] = D.$JSCompiler_alias_TRUE$$, $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$.$_renderLabel$[$area$$inline_8689_dataLayer$$12_markerDefs$$] = D.$JSCompiler_alias_TRUE$$
          }
        }
      }else {
      ...
      $area$$inline_8689_dataLayer$$12_markerDefs$$ = new D.$DvtMapDataLayer$$($JSCompiler_StaticMethods_ParseDataLayers$self$$.$_tmap$, $parentLayer$$6$$, $dataLayerOptions$$1_initSelections$$.id, $JSCompiler_StaticMethods_ParseDataLayers$self$$.$_tmap$.$getEventManager$(), $dataLayerOptions$$1_initSelections$$);
      $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$ = $dataLayerOptions$$1_initSelections$$.selectionMode;
      "single" == $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$ ? $area$$inline_8689_dataLayer$$12_markerDefs$$.$setSelectionMode$("s") : "multiple" == $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$ && $area$$inline_8689_dataLayer$$12_markerDefs$$.$setSelectionMode$("m");
      $area$$inline_8689_dataLayer$$12_markerDefs$$.$setAnimation$($dataLayerOptions$$1_initSelections$$.animationOnDataChange);
      $area$$inline_8689_dataLayer$$12_markerDefs$$.$setAnimationDuration$($JSCompiler_StaticMethods_ParseDataLayers$self$$.$_tmap$.$getAnimationDuration$());
      var $JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$ = D.$JSCompiler_alias_NULL$$;
      $parentLayer$$6$$ instanceof D.$DvtMapAreaLayer$$ && ($JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$ = $dataLayerOptions$$1_initSelections$$.isolatedItem);
      var $disclosedItems_isolatedArea$$inline_8720$$ = $dataLayerOptions$$1_initSelections$$.disclosedItems, $initDisclosed_xmlNode$$67$$ = [], $isolatedAreaId$$;
      $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$ = $parentLayer$$6$$ instanceof D.$DvtMapAreaLayer$$;
      var $popups$$1$$;
      ...
      var $context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$ = $JSCompiler_StaticMethods_ParseDataLayers$self$$.$_tmap$.$getOptions$().hiddenCategories, $areas$$6_renderer$$12$$ = $dataLayerOptions$$1_initSelections$$.areas;
      if($areas$$6_renderer$$12$$) {
        for(var $area$$inline_8721_j$$118$$ = 0;$area$$inline_8721_j$$118$$ < $areas$$6_renderer$$12$$.length;$area$$inline_8721_j$$118$$++) {
          if($context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$ && D.$DvtArrayUtils$$.$hasAnyItem$($context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$, $areas$$6_renderer$$12$$[$area$$inline_8721_j$$118$$].categories)) {
            (0,D.$JSCompiler_StaticMethods_addAreaObject$$)($area$$inline_8689_dataLayer$$12_markerDefs$$, D.$JSCompiler_alias_NULL$$)
          }else {
            var $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = $areas$$6_renderer$$12$$[$area$$inline_8721_j$$118$$].location;
            if($JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$) {
              if($JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$ != $areas$$6_renderer$$12$$[$area$$inline_8721_j$$118$$].id) {
                continue
              }else {
                $isolatedAreaId$$ = $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$
              }
            }
            $disclosedItems_isolatedArea$$inline_8720$$ && -1 != D.$DvtArrayUtils$$.$getIndex$($disclosedItems_isolatedArea$$inline_8720$$, $areas$$6_renderer$$12$$[$area$$inline_8721_j$$118$$].id) && $initDisclosed_xmlNode$$67$$.push($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$);
            var $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$ = $JSCompiler_StaticMethods_ParseDataLayers$self$$, $layer$$inline_8695_layer$$inline_8708$$ = $parentLayer$$6$$, $dataLayer$$inline_8696_markers$$10$$ = $area$$inline_8689_dataLayer$$12_markerDefs$$, $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = $areas$$6_renderer$$12$$[$area$$inline_8721_j$$118$$], $areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$ = 
            $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.location;
            if($layer$$inline_8695_layer$$inline_8708$$.$AreaShapes$[$areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$] && $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.color) {
              $layer$$inline_8695_layer$$inline_8708$$.$_renderArea$[$areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$] = D.$JSCompiler_alias_FALSE$$;
              $areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$ = new D.$DvtDrillablePath$$($JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$.$_tmap$.$getCtx$(), $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$.$_tmap$.$_bSupportsVectorEffects$);
              $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = D.$DvtJSONUtils$$.$merge$($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$, $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$.$_tmap$.$_styleDefaults$.dataAreaDefaults);
              $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.labelStyle || ($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.labelStyle = $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$.$_tmap$.$_styleDefaults$.labelStyle);
              var $dis$$inline_8703_hs$$inline_8700_svgElem$$inline_8711$$ = new D.$DvtSolidStroke$$($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.hoverColor, 1, 2), $JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$ = new D.$DvtSolidStroke$$($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.selectedInnerColor, 1, 1), $dos$$inline_8704_outerStroke$$inline_11519_sos$$inline_8702$$ = new D.$DvtSolidStroke$$($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.selectedOuterColor, 
              1, 4);
              $areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$.$setHoverStroke$($dis$$inline_8703_hs$$inline_8700_svgElem$$inline_8711$$, D.$JSCompiler_alias_NULL$$).$setSelectedStroke$($JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$, $dos$$inline_8704_outerStroke$$inline_11519_sos$$inline_8702$$);
              $dis$$inline_8703_hs$$inline_8700_svgElem$$inline_8711$$ = new D.$DvtSolidStroke$$($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.drilledInnerColor, 1, 2);
              $dos$$inline_8704_outerStroke$$inline_11519_sos$$inline_8702$$ = new D.$DvtSolidStroke$$($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.drilledOuterColor, 1, 4);
              $JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$ = $areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$;
              $JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$.$_disclosedInnerStroke$ = $dis$$inline_8703_hs$$inline_8700_svgElem$$inline_8711$$;
              $JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$.$_disclosedInnerStroke$ && $JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$.$_bSupportsVectorEffects$ && ($JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$.$_disclosedInnerStroke$.$_bFixedWidth$ = D.$JSCompiler_alias_TRUE$$);
              $JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$.$_disclosedOuterStroke$ = $dos$$inline_8704_outerStroke$$inline_11519_sos$$inline_8702$$;
              $JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$.$_disclosedOuterStroke$ && $JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$.$_bSupportsVectorEffects$ && ($JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$.$_disclosedOuterStroke$.$_bFixedWidth$ = D.$JSCompiler_alias_TRUE$$);
              $layer$$inline_8695_layer$$inline_8708$$.$_renderLabel$[$areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.location] = D.$JSCompiler_alias_FALSE$$;
              (0,D.$JSCompiler_StaticMethods__styleDisplayable$$)($JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$, $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$, $areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$);
              $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$ = $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$.$_createLabel$($layer$$inline_8695_layer$$inline_8708$$, $dataLayer$$inline_8696_markers$$10$$, $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$, 
              $areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$, D.$JSCompiler_alias_TRUE$$);
              $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = new D.$DvtMapAreaPeer$$($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$, $dataLayer$$inline_8696_markers$$10$$, $areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$, $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$)
            }else {
              $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = D.$JSCompiler_alias_NULL$$
            }
            $popups$$1$$ && $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.$setShowPopupBehaviors$($popups$$1$$);
            $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ && ($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.$setSelectable$($area$$inline_8689_dataLayer$$12_markerDefs$$.$isSelectable$()), (0,D.$JSCompiler_StaticMethods_addAreaObject$$)($area$$inline_8689_dataLayer$$12_markerDefs$$, $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$))
          }
        }
      }
      $areas$$6_renderer$$12$$ = $dataLayerOptions$$1_initSelections$$.renderer;
      if(($dataLayer$$inline_8696_markers$$10$$ = $dataLayerOptions$$1_initSelections$$.markers) && !$areas$$6_renderer$$12$$) {
        for($area$$inline_8721_j$$118$$ = 0;$area$$inline_8721_j$$118$$ < $dataLayer$$inline_8696_markers$$10$$.length;$area$$inline_8721_j$$118$$++) {
          if($context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$ && D.$DvtArrayUtils$$.$hasAnyItem$($context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$, $dataLayer$$inline_8696_markers$$10$$[$area$$inline_8721_j$$118$$].categories)) {
            (0,D.$JSCompiler_StaticMethods_addDataObject$$)($area$$inline_8689_dataLayer$$12_markerDefs$$, D.$JSCompiler_alias_NULL$$)
          }else {
            $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = $dataLayer$$inline_8696_markers$$10$$[$area$$inline_8721_j$$118$$].location;
            if($JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$) {
              if($JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$ != $dataLayer$$inline_8696_markers$$10$$[$area$$inline_8721_j$$118$$].id) {
                continue
              }else {
                $isolatedAreaId$$ = $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$
              }
            }
            $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = $JSCompiler_StaticMethods_ParseDataLayers$self$$.$_createMarker$($parentLayer$$6$$, $area$$inline_8689_dataLayer$$12_markerDefs$$, $dataLayer$$inline_8696_markers$$10$$[$area$$inline_8721_j$$118$$], $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$);
            $popups$$1$$ && $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.$setShowPopupBehaviors$($popups$$1$$);
            $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ && ($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.$setSelectable$($area$$inline_8689_dataLayer$$12_markerDefs$$.$isSelectable$()), (0,D.$JSCompiler_StaticMethods_addDataObject$$)($area$$inline_8689_dataLayer$$12_markerDefs$$, $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$))
          }
        }
      }
      if($context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$ = $dataLayerOptions$$1_initSelections$$.images) {
        for($area$$inline_8721_j$$118$$ = 0;$area$$inline_8721_j$$118$$ < $context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$.length;$area$$inline_8721_j$$118$$++) {
          $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = $context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$[$area$$inline_8721_j$$118$$].location;
          if($JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$) {
            if($JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$ != $context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$[$area$$inline_8721_j$$118$$].id) {
              continue
            }else {
              $isolatedAreaId$$ = $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$
            }
          }
          $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = $JSCompiler_StaticMethods_ParseDataLayers$self$$.$_createImage$($parentLayer$$6$$, $area$$inline_8689_dataLayer$$12_markerDefs$$, $context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$[$area$$inline_8721_j$$118$$], $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$);
          $popups$$1$$ && $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.$setShowPopupBehaviors$($popups$$1$$);
          $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ && (0,D.$JSCompiler_StaticMethods_addDataObject$$)($area$$inline_8689_dataLayer$$12_markerDefs$$, $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$)
        }
      }
      if($areas$$6_renderer$$12$$) {
        for($area$$inline_8721_j$$118$$ = 0;$area$$inline_8721_j$$118$$ < $dataLayer$$inline_8696_markers$$10$$.length;$area$$inline_8721_j$$118$$++) {
          ...
          $disclosedItems_isolatedArea$$inline_8720$$ && -1 != D.$DvtArrayUtils$$.$getIndex$($disclosedItems_isolatedArea$$inline_8720$$, $dataLayer$$inline_8696_markers$$10$$[$area$$inline_8721_j$$118$$].id) && $initDisclosed_xmlNode$$67$$.push($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$);
          $context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$ = $JSCompiler_StaticMethods_ParseDataLayers$self$$.$_tmap$.$getOptions$()._contextHandler($JSCompiler_StaticMethods_ParseDataLayers$self$$.$_tmap$.$getElem$(), D.$JSCompiler_alias_NULL$$, $dataLayer$$inline_8696_markers$$10$$[$area$$inline_8721_j$$118$$], {hovered:D.$JSCompiler_alias_FALSE$$, selected:D.$JSCompiler_alias_FALSE$$, focused:D.$JSCompiler_alias_FALSE$$}, D.$JSCompiler_alias_NULL$$);
          $areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$ = $areas$$6_renderer$$12$$($context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$);
          $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$ = $JSCompiler_StaticMethods_ParseDataLayers$self$$;
          $layer$$inline_8695_layer$$inline_8708$$ = $parentLayer$$6$$;
          $context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$ = $area$$inline_8689_dataLayer$$12_markerDefs$$;
          $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = $dataLayer$$inline_8696_markers$$10$$[$area$$inline_8721_j$$118$$];
          $dis$$inline_8703_hs$$inline_8700_svgElem$$inline_8711$$ = $areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$;
          $JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$ = $JSCompiler_StaticMethods_resetRenderedAreas$self$$inline_8688_isAreaDataLayer$$1_selectionMode$$14$$;
          ($areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$ = (0,D.$DvtThematicMapJsonParser$getCenter$$)($context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$, $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$)) ? ($JSCompiler_StaticMethods_setDisclosedStroke$self$$inline_11517_isParentAreaDataLayer$$inline_8712_sis$$inline_8701$$ && ($layer$$inline_8695_layer$$inline_8708$$.$_renderLabel$[$areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$.location] = 
          D.$JSCompiler_alias_FALSE$$), $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$ = new D.$DvtCustomDataItem$$($JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$.$_tmap$.$getCtx$(), $dis$$inline_8703_hs$$inline_8700_svgElem$$inline_8711$$, $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$.$_tmap$.$_styleDefaults$.dataAreaDefaults), 
          $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = new D.$DvtMapObjPeer$$($areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$, $context$$607_dataLayer$$inline_8709_hiddenCategories$$12_images$$22$$, $JSCompiler_StaticMethods__createArea$self$$inline_8694_JSCompiler_StaticMethods__createCustomDataItem$self$$inline_8707_dataItem$$inline_8714_label$$inline_8705$$, D.$JSCompiler_alias_NULL$$, $areaId$$inline_8698_center$$inline_8713_path$$inline_8699_svgElem$$2$$)) : $areaId$$2_data$$inline_8697_data$$inline_8710_dataObj$$4$$ = 
      ...
      if($isolatedAreaId$$) {
        for($area$$inline_8721_j$$118$$ in $area$$inline_8689_dataLayer$$12_markerDefs$$.$_isolatedAreaRowKey$ = $JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$, $JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$ = $parentLayer$$6$$, $disclosedItems_isolatedArea$$inline_8720$$ = $isolatedAreaId$$, $JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$.$_isolatedArea$ = $disclosedItems_isolatedArea$$inline_8720$$, $JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$.$_layerDim$ = 
        D.$JSCompiler_alias_NULL$$, $area$$inline_8721_j$$118$$ = D.$JSCompiler_alias_VOID$$, $JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$.$AreaShapes$) {
          $area$$inline_8721_j$$118$$ != $disclosedItems_isolatedArea$$inline_8720$$ && ($JSCompiler_StaticMethods_setIsolatedArea$self$$inline_8719_isolatedRowKey$$.$_renderArea$[$area$$inline_8721_j$$118$$] = D.$JSCompiler_alias_FALSE$$)
        }
      }
      if(($dataLayerOptions$$1_initSelections$$ = $dataLayerOptions$$1_initSelections$$.selection) && 0 < $dataLayerOptions$$1_initSelections$$.length) {
        $area$$inline_8689_dataLayer$$12_markerDefs$$.$_initSelections$ = $dataLayerOptions$$1_initSelections$$
      }
      $initDisclosed_xmlNode$$67$$ && 0 < $initDisclosed_xmlNode$$67$$.length && ($JSCompiler_StaticMethods_ParseDataLayers$self$$.$_tmap$.$_initDrilled$[$parentLayer$$6$$.$LayerName$] = [$area$$inline_8689_dataLayer$$12_markerDefs$$.$getClientId$(), $initDisclosed_xmlNode$$67$$]);
      $topLayerName$$2$$ ? $parentLayer$$6$$.$updateDataLayer$($area$$inline_8689_dataLayer$$12_markerDefs$$, $JSCompiler_StaticMethods_ParseDataLayers$self$$.$_tmap$.$_panZoomCanvas$.$_contentPane$.$getMatrix$(), $topLayerName$$2$$) : $parentLayer$$6$$.$DataLayers$[$area$$inline_8689_dataLayer$$12_markerDefs$$.$getClientId$()] = $area$$inline_8689_dataLayer$$12_markerDefs$$
    }
  }
};
D.$DvtThematicMapJsonParser$$.prototype.$_createMarker$ = function $$DvtThematicMapJsonParser$$$$$_createMarker$$($label$$103_layer$$14$$, $dataLayer$$14$$, $data$$105$$, $isParentAreaDataLayer$$) {
  ...
  $isParentAreaDataLayer$$ && ($label$$103_layer$$14$$.$_renderLabel$[$data$$105$$.location] = D.$JSCompiler_alias_FALSE$$);
  (0,D.$JSCompiler_StaticMethods__styleDisplayable$$)(this, $data$$105$$, $marker$$18_markerDefaults_sx$$18$$);
  $label$$103_layer$$14$$ = this.$_createLabel$($label$$103_layer$$14$$, $dataLayer$$14$$, $data$$105$$, $marker$$18_markerDefaults_sx$$18$$, $isParentAreaDataLayer$$);
  return new D.$DvtMapObjPeer$$($data$$105$$, $dataLayer$$14$$, $marker$$18_markerDefaults_sx$$18$$, $label$$103_layer$$14$$, $center$$13$$)
};
D.$DvtThematicMapJsonParser$$.prototype.$_createImage$ = function $$DvtThematicMapJsonParser$$$$$_createImage$$($layer$$15$$, $dataLayer$$15$$, $data$$106$$, $isParentAreaDataLayer$$1$$) {
  ...
  $width$$161$$ != D.$JSCompiler_alias_NULL$$ && $height$$145$$ != D.$JSCompiler_alias_NULL$$ && ($image$$23$$.$setX$($center$$14$$.x - $width$$161$$ / 2), $image$$23$$.$setY$($center$$14$$.y - $height$$145$$ / 2), $image$$23$$.$setWidth$($width$$161$$), $image$$23$$.$setHeight$($height$$145$$));
  $isParentAreaDataLayer$$1$$ && ($layer$$15$$.$_renderLabel$[$data$$106$$.location] = D.$JSCompiler_alias_FALSE$$);
  var $peer$$33$$ = new D.$DvtMapObjPeer$$($data$$106$$, $dataLayer$$15$$, $image$$23$$, D.$JSCompiler_alias_NULL$$, $center$$14$$);
...
D.$DvtThematicMapJsonParser$$.prototype.$_createLabel$ = function $$DvtThematicMapJsonParser$$$$$_createLabel$$($fillColor$$10_layer$$17$$, $dataLayer$$17_labelStyle$$21$$, $data$$108$$, $displayable$$107_isArea$$1$$, $isParentAreaDataLayer$$3$$) {
  ...
  if($labelText$$2$$) {
    var $context$$610_label$$104$$ = this.$_tmap$.$getCtx$(), $context$$610_label$$104$$ = $displayable$$107_isArea$$1$$ ? new D.$DvtMapLabel$$($context$$610_label$$104$$, $labelText$$2$$, $fillColor$$10_layer$$17$$.$getLabelInfoForArea$ ? $fillColor$$10_layer$$17$$.$getLabelInfoForArea$($areaId$$4$$) : D.$JSCompiler_alias_NULL$$, $labelDisplay$$7$$, $dataLayer$$17_labelStyle$$21$$.$_dataLabelLayer$, this.$_tmap$.$_bSupportsVectorEffects$) : new D.$DvtOutputText$$($context$$610_label$$104$$, $labelText$$2$$, 
    0, 0);
    ...
    $dataLayer$$17_labelStyle$$21$$.$setStyle$("color", D.$JSCompiler_alias_NULL$$);
    $context$$610_label$$104$$.$setCSSStyle$($dataLayer$$17_labelStyle$$21$$);
    if($context$$610_label$$104$$ instanceof D.$DvtMapLabel$$ && (D.$DvtAgent$_highContrast$$ === D.$JSCompiler_alias_TRUE$$ || !$fillColor$$10_layer$$17$$)) {
      $fillColor$$10_layer$$17$$ = D.$DvtColorUtils$$.$getContrastingTextColor$($data$$108$$.color)
    }
    $fillColor$$10_layer$$17$$ && $context$$610_label$$104$$.$setSolidFill$($fillColor$$10_layer$$17$$)
  }
  return $context$$610_label$$104$$
};
D.$JSCompiler_StaticMethods__styleDisplayable$$ = function $$JSCompiler_StaticMethods__styleDisplayable$$$($JSCompiler_StaticMethods__styleDisplayable$self_fill$$inline_8766$$, $borderColor$$61_style$$118$$, $displayable$$108$$) {
  var $pattern$$14$$ = $borderColor$$61_style$$118$$.pattern, $backgroundColor$$26$$ = $borderColor$$61_style$$118$$.color, $gradient$$15$$ = $JSCompiler_StaticMethods__styleDisplayable$self_fill$$inline_8766$$.$_isMobile$ || "alta" == $JSCompiler_StaticMethods__styleDisplayable$self_fill$$inline_8766$$.$_tmap$.$_skinName$ ? "none" : $borderColor$$61_style$$118$$.visualEffects;
  if($displayable$$108$$ instanceof D.$DvtSimpleMarker$$) {
    if("none" != $borderColor$$61_style$$118$$.borderStyle) {
      ...
      $JSCompiler_StaticMethods__styleDisplayable$self_fill$$inline_8766$$.$_tmap$.$_isMarkerZoomBehaviorFixed$ || ($stroke$$116$$.$_bFixedWidth$ = D.$JSCompiler_alias_TRUE$$);
    ...
    if($displayable$$108$$ instanceof D.$DvtPath$$) {
      if($borderColor$$61_style$$118$$ = $borderColor$$61_style$$118$$.borderColor) {
        $stroke$$116$$ = new D.$DvtSolidStroke$$($borderColor$$61_style$$118$$), $JSCompiler_StaticMethods__styleDisplayable$self_fill$$inline_8766$$.$_tmap$.$_bSupportsVectorEffects$ && ($stroke$$116$$.$_bFixedWidth$ = D.$JSCompiler_alias_TRUE$$), $displayable$$108$$.$setStroke$($stroke$$116$$)
      }
      $pattern$$14$$ ? ($JSCompiler_StaticMethods__styleDisplayable$self_fill$$inline_8766$$ = new D.$DvtPatternFill$$($pattern$$14$$, $backgroundColor$$26$$, "#FFFFFF"), $displayable$$108$$.$_ptFill$ = $JSCompiler_StaticMethods__styleDisplayable$self_fill$$inline_8766$$) : $displayable$$108$$.$setSolidFill$($backgroundColor$$26$$, $borderWidth$$16_opacity$$5$$)
    }
  }
};
...
D.$DvtThematicMapJsonParser$$.prototype.$_getShowPopupBehaviors$ = function $$DvtThematicMapJsonParser$$$$$_getShowPopupBehaviors$$($popups$$2$$) {
  for(var $spbs$$6$$ = [], $i$$837$$ = 0;$i$$837$$ < $popups$$2$$.length;$i$$837$$++) {
    $spbs$$6$$.push(new D.$DvtShowPopupBehavior$$($popups$$2$$[$i$$837$$].popupId, $popups$$2$$[$i$$837$$].triggerType, D.$JSCompiler_alias_NULL$$, $popups$$2$$[$i$$837$$].align))
  }
  return $spbs$$6$$
};
...
D.$DvtThematicMapProjections$$.$project$ = function $$DvtThematicMapProjections$$$$project$$($x$$280$$, $y$$250$$, $basemap$$5$$) {
  ...
  switch($basemap$$5$$) {
    case "africa":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getAffineProjection$(D.$DvtThematicMapProjections$$.$_AFRICA_BOUNDS$, D.$DvtThematicMapProjections$$.$_getMercatorProjection$($x$$280$$, $y$$250$$));
      break;
    case "asia":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getAffineProjection$(D.$DvtThematicMapProjections$$.$_ASIA_BOUNDS$, D.$DvtThematicMapProjections$$.$_getAlbersEqualAreaConicProjection$(40, 95, 20, 60, $x$$280$$, $y$$250$$), D.$DvtThematicMapProjections$$.$toRadians$(5));
      break;
    case "australia":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getAustraliaProjection$($x$$280$$, $y$$250$$);
      break;
    case "europe":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getAffineProjection$(D.$DvtThematicMapProjections$$.$_EUROPE_BOUNDS$, D.$DvtThematicMapProjections$$.$_getAlbersEqualAreaConicProjection$(35, 25, 40, 65, $x$$280$$, $y$$250$$), D.$DvtThematicMapProjections$$.$toRadians$(10));
      break;
    case "northAmerica":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getAffineProjection$(D.$DvtThematicMapProjections$$.$_N_AMERICA_BOUNDS$, D.$DvtThematicMapProjections$$.$_getAlbersEqualAreaConicProjection$(23, -96, 20, 60, $x$$280$$, $y$$250$$));
      break;
    case "southAmerica":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getAffineProjection$(D.$DvtThematicMapProjections$$.$_S_AMERICA_BOUNDS$, new D.$DvtPoint$$($x$$280$$, $y$$250$$), D.$DvtThematicMapProjections$$.$toRadians$(5));
      break;
    case "apac":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getAffineProjection$(D.$DvtThematicMapProjections$$.$_APAC_BOUNDS$, D.$DvtThematicMapProjections$$.$_getMercatorProjection$($x$$280$$, $y$$250$$));
      break;
    case "emea":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getAffineProjection$(D.$DvtThematicMapProjections$$.$_EMEA_BOUNDS$, D.$DvtThematicMapProjections$$.$_getMercatorProjection$($x$$280$$, $y$$250$$));
      break;
    case "latinAmerica":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getAffineProjection$(D.$DvtThematicMapProjections$$.$_L_AMERICA_BOUNDS$, new D.$DvtPoint$$($x$$280$$, $y$$250$$));
      break;
    case "usaAndCanada":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getAffineProjection$(D.$DvtThematicMapProjections$$.$_USA_CANADA_BOUNDS$, D.$DvtThematicMapProjections$$.$_getAlbersEqualAreaConicProjection$(23, -96, 20, 60, $x$$280$$, $y$$250$$));
      break;
    case "worldRegions":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getWorldProjection$($x$$280$$, $y$$250$$);
      break;
    case "usa":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getUSAProjection$($x$$280$$, $y$$250$$);
      break;
    case "world":
      $point$$49$$ = D.$DvtThematicMapProjections$$.$_getWorldProjection$($x$$280$$, $y$$250$$)
  }
  return $point$$49$$ ? new D.$DvtPoint$$(10 * $point$$49$$.x, 10 * $point$$49$$.y) : D.$JSCompiler_alias_NULL$$
};
...
D.$DvtThematicMapProjections$$.$_getBoundedTransformedPoint$ = function $$DvtThematicMapProjections$$$$_getBoundedTransformedPoint$$($point$$51$$) {
  ...
  return!$point$$51$$ || !(0,D.$JSCompiler_StaticMethods_containsPoint$$)($bounds$$159$$, $point$$51$$.x, $point$$51$$.y) ? D.$JSCompiler_alias_NULL$$ : $point$$51$$
};
D.$DvtThematicMapProjections$$.$_getAlbersEqualAreaConicProjection$ = function $$DvtThematicMapProjections$$$$_getAlbersEqualAreaConicProjection$$($latOfOrigin_phi0_rho0$$, $lambda0_lonOfOrigin$$, $c$$48_sP1$$, $n$$38_sP2$$, $theta$$4_x$$284$$, $rho_y$$254$$) {
  ...
  $theta$$4_x$$284$$ = $n$$38_sP2$$ * (D.$DvtThematicMapProjections$$.$toRadians$($theta$$4_x$$284$$) - $lambda0_lonOfOrigin$$);
  $rho_y$$254$$ = $c$$48_sP1$$ - 2 * $n$$38_sP2$$ * window.Math.sin(D.$DvtThematicMapProjections$$.$toRadians$($rho_y$$254$$));
  $rho_y$$254$$ = window.Math.sqrt($rho_y$$254$$) / $n$$38_sP2$$;
...
D.$DvtThematicMapProjections$$.$_getViewPortTransformation$ = function $$DvtThematicMapProjections$$$$_getViewPortTransformation$$($mapBound$$, $deviceView$$) {
  var $d5_i$$838$$ = $deviceView$$.x, $d6_j$$119$$ = $deviceView$$.y, $d$$13$$ = $mapBound$$.$w$, $d1$$1$$ = $mapBound$$.$h$, $d2$$1_d3$$1$$ = 0, $d2$$1_d3$$1$$ = $deviceView$$.$w$ / $d$$13$$, $d4$$ = $deviceView$$.$h$ / $d1$$1$$, $d2$$1_d3$$1$$ = $d2$$1_d3$$1$$ <= $d4$$ ? $d2$$1_d3$$1$$ : $d4$$, $d5_i$$838$$ = $d5_i$$838$$ - $mapBound$$.x * $d2$$1_d3$$1$$, $d6_j$$119$$ = $d6_j$$119$$ + $mapBound$$.y * $d2$$1_d3$$1$$, $d5_i$$838$$ = $d5_i$$838$$ + ($deviceView$$.$w$ - $d$$13$$ * $d2$$1_d3$$1$$) / 
  2, $d6_j$$119$$ = $d6_j$$119$$ + ($deviceView$$.$h$ - ($deviceView$$.$h$ - $d1$$1$$ * $d2$$1_d3$$1$$) / 2);
  return new D.$DvtMatrix$$($d2$$1_d3$$1$$, 0, 0, -$d2$$1_d3$$1$$, $d5_i$$838$$, $d6_j$$119$$)
};
...
D.$DvtThematicMapProjections$$.$inverseProject$ = function $$DvtThematicMapProjections$$$$inverseProject$$($x$$290$$, $y$$258$$, $basemap$$6$$) {
  ...
  switch($basemap$$6$$) {
    case "africa":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAffineProjection$(D.$DvtThematicMapProjections$$.$_AFRICA_BOUNDS$, new D.$DvtPoint$$($x$$290$$, $y$$258$$));
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseMercatorProjection$($point$$53$$.x, $point$$53$$.y);
      break;
    case "asia":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAffineProjection$(D.$DvtThematicMapProjections$$.$_ASIA_BOUNDS$, new D.$DvtPoint$$($x$$290$$, $y$$258$$), D.$DvtThematicMapProjections$$.$toRadians$(5));
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAlbersEqualAreaConicProjection$(40, 95, 20, 60, $point$$53$$.x, $point$$53$$.y);
      break;
    case "australia":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAustraliaProjection$($x$$290$$, $y$$258$$);
      break;
    case "europe":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAffineProjection$(D.$DvtThematicMapProjections$$.$_EUROPE_BOUNDS$, new D.$DvtPoint$$($x$$290$$, $y$$258$$), D.$DvtThematicMapProjections$$.$toRadians$(10));
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAlbersEqualAreaConicProjection$(35, 25, 40, 65, $point$$53$$.x, $point$$53$$.y);
      break;
    case "northAmerica":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAffineProjection$(D.$DvtThematicMapProjections$$.$_N_AMERICA_BOUNDS$, new D.$DvtPoint$$($x$$290$$, $y$$258$$));
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAlbersEqualAreaConicProjection$(23, -96, 20, 60, $point$$53$$.x, $point$$53$$.y);
      break;
    case "southAmerica":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAffineProjection$(D.$DvtThematicMapProjections$$.$_S_AMERICA_BOUNDS$, new D.$DvtPoint$$($x$$290$$, $y$$258$$), D.$DvtThematicMapProjections$$.$toRadians$(5));
      break;
    case "apac":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAffineProjection$(D.$DvtThematicMapProjections$$.$_APAC_BOUNDS$, new D.$DvtPoint$$($x$$290$$, $y$$258$$));
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseMercatorProjection$($point$$53$$.x, $point$$53$$.y);
      break;
    case "emea":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAffineProjection$(D.$DvtThematicMapProjections$$.$_EMEA_BOUNDS$, new D.$DvtPoint$$($x$$290$$, $y$$258$$));
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseMercatorProjection$($point$$53$$.x, $point$$53$$.y);
      break;
    case "latinAmerica":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAffineProjection$(D.$DvtThematicMapProjections$$.$_L_AMERICA_BOUNDS$, new D.$DvtPoint$$($x$$290$$, $y$$258$$));
      break;
    case "usaAndCanada":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAffineProjection$(D.$DvtThematicMapProjections$$.$_USA_CANADA_BOUNDS$, new D.$DvtPoint$$($x$$290$$, $y$$258$$));
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseAlbersEqualAreaConicProjection$(23, -96, 20, 60, $point$$53$$.x, $point$$53$$.y);
      break;
    case "worldRegions":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseWorldProjection$($x$$290$$, $y$$258$$);
      break;
    case "usa":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseUSAProjection$($x$$290$$, $y$$258$$);
      break;
    case "world":
      $point$$53$$ = D.$DvtThematicMapProjections$$.$_getInverseWorldProjection$($x$$290$$, $y$$258$$)
  }
  return $point$$53$$ ? $point$$53$$ : new D.$DvtPoint$$($x$$290$$, $y$$258$$)
};
...
D.$DvtThematicMapProjections$$.$_getInverseWorldProjection$ = function $$DvtThematicMapProjections$$$$_getInverseWorldProjection$$($x$$292$$, $y$$260$$) {
  ...
  $point$$55_viewPortTransform$$5$$ = (0,D.$JSCompiler_StaticMethods_transformPoint$$)($point$$55_viewPortTransform$$5$$, new D.$DvtPoint$$($x$$292$$, $y$$260$$));
...
D.$DvtThematicMapProjections$$.$_getInverseAustraliaProjection$ = function $$DvtThematicMapProjections$$$$_getInverseAustraliaProjection$$($x$$293$$, $y$$261$$) {
  ...
  $point$$56_viewPortTransform$$6$$ = (0,D.$JSCompiler_StaticMethods_containsPoint$$)(D.$DvtThematicMapProjections$$.$_NEW_ZEALAND_RECT$, $x$$293$$, $y$$261$$) ? D.$DvtThematicMapProjections$$.$_getViewPortTransformation$(D.$DvtThematicMapProjections$$.$_NEW_ZEALAND_BOUNDS$, D.$DvtThematicMapProjections$$.$_NEW_ZEALAND_RECT$) : D.$DvtThematicMapProjections$$.$_getViewPortTransformation$(D.$DvtThematicMapProjections$$.$_AUSTRALIA_BOUNDS$, D.$DvtThematicMapProjections$$.$_VIEWPORT_BOUNDS$);
  $point$$56_viewPortTransform$$6$$.$invert$();
  $point$$56_viewPortTransform$$6$$ = (0,D.$JSCompiler_StaticMethods_transformPoint$$)($point$$56_viewPortTransform$$6$$, new D.$DvtPoint$$($x$$293$$, $y$$261$$));
...
D.$DvtThematicMapProjections$$.$_getInverseAlbersEqualAreaConicProjection$ = function $$DvtThematicMapProjections$$$$_getInverseAlbersEqualAreaConicProjection$$($latOfOrigin$$1_p0$$4_phi0$$1$$, $lambda0$$1_lonOfOrigin$$1$$, $c$$50_sP1$$1$$, $n$$39_sP2$$1$$, $x$$294$$, $y$$262$$) {
  ...
  return new D.$DvtPoint$$(D.$DvtThematicMapProjections$$.$toDegrees$($lambda0$$1_lonOfOrigin$$1$$ + window.Math.atan($x$$294$$ / ($latOfOrigin$$1_p0$$4_phi0$$1$$ - $y$$262$$)) / $n$$39_sP2$$1$$), D.$DvtThematicMapProjections$$.$toDegrees$(window.Math.asin(($c$$50_sP1$$1$$ - $p$$30$$ * $p$$30$$ * $n$$39_sP2$$1$$ * $n$$39_sP2$$1$$) / (2 * $n$$39_sP2$$1$$))))
};
...
D.$DvtThematicMapControlPanel$$.prototype.$getActionDisplayable$ = function $$DvtThematicMapControlPanel$$$$$getActionDisplayable$$($type$$249$$, $stampId$$21$$) {
  var $displayable$$109$$ = D.$DvtThematicMapControlPanel$$.$superclass$.$getActionDisplayable$.call(this, $type$$249$$, $stampId$$21$$);
  !$displayable$$109$$ && this.$isDisclosed$() && ("drillDown" == $type$$249$$ && this.$_drillDownButton$ && this.$_drillDownButton$.isEnabled() ? $displayable$$109$$ = this.$_drillDownButton$ : "drillUp" == $type$$249$$ && this.$_drillUpButton$ && this.$_drillUpButton$.isEnabled() ? $displayable$$109$$ = this.$_drillUpButton$ : "reset" == $type$$249$$ && (this.$_resetButton$ && this.$_resetButton$.isEnabled()) && ($displayable$$109$$ = this.$_resetButton$));
