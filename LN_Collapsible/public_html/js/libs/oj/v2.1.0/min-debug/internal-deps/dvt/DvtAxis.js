...
D.$JSCompiler_prototypeAlias$$.$processEvent$ = function $$JSCompiler_prototypeAlias$$$$processEvent$$($event$$98$$, $source$$8$$) {
  this === $source$$8$$ && this.dispatchEvent($event$$98$$)
};
...
D.$DvtAxisAutomation$$.prototype.$GetSubIdForDomElement$ = function $$DvtAxisAutomation$$$$$GetSubIdForDomElement$$($displayable$$2_level$$36$$) {
  var $labelIndex_logicalObj$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this.$_axis$.$getEventManager$(), $displayable$$2_level$$36$$);
    ...
    if(this.$_options$.groups) {
      ...
      for(var $labelIndex_logicalObj$$ = (0,D.$JSCompiler_StaticMethods_getStartIndex$$)(this.$_axisInfo$, $labelIndex_logicalObj$$.$_params$.index, $displayable$$2_level$$36$$), $indexList$$ = "", $levelIdx$$ = 0;$levelIdx$$ <= $displayable$$2_level$$36$$;$levelIdx$$++) {
        for(var $labels$$1$$ = this.$_axisInfo$.$getLabels$(this.$_axis$.$getCtx$(), $levelIdx$$), $i$$97$$ = 0;$i$$97$$ < $labels$$1$$.length;$i$$97$$++) {
          var $index$$105$$ = (0,D.$JSCompiler_StaticMethods_getLabelIndex$$)($labels$$1$$[$i$$97$$]);
          (0,D.$JSCompiler_StaticMethods_getStartIndex$$)(this.$_axisInfo$, $index$$105$$, $levelIdx$$) <= $labelIndex_logicalObj$$ && this.$_axisInfo$.$getEndIndex$($index$$105$$, $levelIdx$$) >= $labelIndex_logicalObj$$ && ($indexList$$ += "[" + this.$_axisInfo$.$getPosition$($index$$105$$, $levelIdx$$) + "]")
        }
      }
  ...
  if("title" == $subId$$1_title$$8$$) {
    ...
    if(this.$_axisInfo$ instanceof D.$DvtGroupAxisInfo$$) {
      for(var $labelLevel$$ = $subId$$1_title$$8$$.split("[").length - 1 - 1, $labelIndex$$1$$ = 0, $startIndex$$11$$ = 0, $levelIdx$$1$$ = 0;$levelIdx$$1$$ <= $labelLevel$$;$levelIdx$$1$$++) {
        ...
        for(var $closeParen_labels$$2$$ = this.$_axisInfo$.$getLabels$(this.$_axis$.$getCtx$(), $levelIdx$$1$$), $index$$106$$, $i$$98_j$$16$$ = 0;$i$$98_j$$16$$ < $closeParen_labels$$2$$.length;$i$$98_j$$16$$++) {
          if($index$$106$$ = (0,D.$JSCompiler_StaticMethods_getLabelIndex$$)($closeParen_labels$$2$$[$i$$98_j$$16$$]), (0,D.$JSCompiler_StaticMethods_getStartIndex$$)(this.$_axisInfo$, $index$$106$$, $levelIdx$$1$$) == $startIndex$$11$$) {
            $labelIndex$$1$$ = $index$$106$$;
            break
          }
        }
        for($i$$98_j$$16$$ = $labelIndex$$1$$;$i$$98_j$$16$$ < $closeParen_labels$$2$$.length;$i$$98_j$$16$$++) {
          if($index$$106$$ = (0,D.$JSCompiler_StaticMethods_getLabelIndex$$)($closeParen_labels$$2$$[$i$$98_j$$16$$]), this.$_axisInfo$.$getPosition$($index$$106$$, $levelIdx$$1$$) == $groupIndex$$) {
            if(0 == $subId$$1_title$$8$$.length) {
              return $closeParen_labels$$2$$[$i$$98_j$$16$$].$getElem$()
            }
            $startIndex$$11$$ = (0,D.$JSCompiler_StaticMethods_getStartIndex$$)(this.$_axisInfo$, $index$$106$$, $levelIdx$$1$$);
            break
          }
        }
      }
...
D.$DvtAxisEventManager$getUIEventParams$$ = function $$DvtAxisEventManager$getUIEventParams$$$($type$$59$$, $id$$22$$, $index$$107$$, $level$$37$$) {
  return{type:$type$$59$$, id:$id$$22$$, index:$index$$107$$, level:$level$$37$$}
};
...
D.$DvtAxisRenderer$$.$getPreferredSize$ = function $$DvtAxisRenderer$$$$getPreferredSize$$($axis$$53_innerLabelWidth_innerLabels$$, $availWidth$$4$$, $availHeight$$4$$) {
  ...
  $labelHeight$$1_options$$13$$.title && ($size$$14$$ = D.$DvtTextUtils$$.$getTextStringHeight$($context$$12$$, $labelHeight$$1_options$$13$$.titleStyle) + D.$DvtAxisRenderer$$.$_getTitleGap$($axis$$53_innerLabelWidth_innerLabels$$));
...
D.$DvtAxisRenderer$$.$_renderTitle$ = function $$DvtAxisRenderer$$$$_renderTitle$$($axis$$57_isRTL$$1$$, $axisInfo$$4$$, $availSpace$$5$$) {
  ...
  if($options$$16_title$$10$$.title) {
    ...
    if(!("radial" == $position$$2$$ || "tangential" == $position$$2$$)) {
      ...
      if($options$$16_title$$10$$ = D.$DvtAxisRenderer$$.$_createText$($axis$$57_isRTL$$1$$.$getEventManager$(), $axis$$57_isRTL$$1$$, $options$$16_title$$10$$.title, $options$$16_title$$10$$.titleStyle, $bHoriz$$1_gap$$1$$ ? $availSpace$$5$$.$w$ : $availSpace$$5$$.$h$, $bHoriz$$1_gap$$1$$ ? $availSpace$$5$$.$h$ : $availSpace$$5$$.$w$)) {
...
D.$DvtAxisRenderer$$.$_renderLabelsHoriz$ = function $$DvtAxisRenderer$$$$_renderLabelsHoriz$$($axis$$59$$, $axisInfo$$6$$, $availSpace$$7$$) {
  ...
  $levelIdx$$3$$ = $isHierarchical_overflow2$$ ? 0 : D.$JSCompiler_alias_NULL$$, $labels$$7$$ = $axisInfo$$6$$.$getLabels$($context$$13_lv2Labels$$, $levelIdx$$3$$), $gap$$2$$ = $isHierarchical_overflow2$$ ? (0,D.$DvtAxisDefaults$getGapSize$$)($context$$13_lv2Labels$$, $offset$$15_options$$18$$, $offset$$15_options$$18$$.layout.hierarchicalLabelGapHeight) : 0;$labels$$7$$;) {
    for(var $height$$35_index$$112_isMultiline_isRotated$$ = 0, $maxLvlHeight$$ = 0, $i$$101$$ = 0;$i$$101$$ < $labels$$7$$.length;$i$$101$$++) {
      var $label$$13$$ = $labels$$7$$[$i$$101$$];
      if($label$$13$$ != D.$JSCompiler_alias_NULL$$) {
        $height$$35_index$$112_isMultiline_isRotated$$ = $label$$13$$ instanceof D.$DvtMultilineText$$ || $label$$13$$ instanceof D.$DvtBackgroundMultilineText$$;
        if($axisInfo$$6$$.$isLabelRotated$($levelIdx$$3$$)) {
          if((!$height$$35_index$$112_isMultiline_isRotated$$ || $height$$35_index$$112_isMultiline_isRotated$$ && !$label$$13$$.$isWrapEnabled$()) && !D.$DvtTextUtils$$.$fitText$($label$$13$$, $availSpace$$7$$.$h$, $availSpace$$7$$.$w$, $axis$$59$$)) {
            continue
          }
          $isRTL$$2$$ ? $label$$13$$.$alignLeft$() : $label$$13$$.$alignRight$();
          $isHierarchical_overflow2$$ ? ($height$$35_index$$112_isMultiline_isRotated$$ = D.$DvtTextUtils$$.$getTextWidth$($label$$13$$), $label$$13$$.$setTranslateY$($availSpace$$7$$.$h$ - $height$$35_index$$112_isMultiline_isRotated$$), $maxLvlHeight$$ = window.Math.max($maxLvlHeight$$, $height$$35_index$$112_isMultiline_isRotated$$)) : $label$$13$$.$setTranslateY$($availSpace$$7$$.y)
        }else {
        ...
        var $height$$35_index$$112_isMultiline_isRotated$$ = $isGroupAxis_overflow1_x$$68$$ ? (0,D.$JSCompiler_StaticMethods_getLabelIndex$$)($label$$13$$) : $i$$101$$, $datatip$$2_isOuterLevel$$ = $axisInfo$$6$$.$getDatatip$($height$$35_index$$112_isMultiline_isRotated$$, $levelIdx$$3$$), $tooltip$$2$$ = $label$$13$$.$getUntruncatedTextString$(), $action$$5$$ = $axisInfo$$6$$.$getAction$($height$$35_index$$112_isMultiline_isRotated$$, $levelIdx$$3$$), $drillable$$2$$ = $axisInfo$$6$$.$isDrillable$($height$$35_index$$112_isMultiline_isRotated$$, 
        $levelIdx$$3$$), $group$$6$$ = $axisInfo$$6$$.$getGroup$($height$$35_index$$112_isMultiline_isRotated$$, $levelIdx$$3$$);
        $axis$$59$$.$getEventManager$().$associate$($label$$13$$, new D.$DvtAxisObjPeer$$($axis$$59$$, $label$$13$$, $group$$6$$, $action$$5$$, $drillable$$2$$, $tooltip$$2$$, $datatip$$2_isOuterLevel$$, (0,D.$DvtAxisEventManager$getUIEventParams$$)(D.$DvtAxisConstants$$.$TICK_LABEL$, $label$$13$$.$getTextString$(), $height$$35_index$$112_isMultiline_isRotated$$, $levelIdx$$3$$)));
    ...
    if($isHierarchical_overflow2$$) {
      for($i$$101$$ = 0;$i$$101$$ < $labels$$7$$.length;$i$$101$$++) {
        $label$$13$$ = $labels$$7$$[$i$$101$$], $label$$13$$ != D.$JSCompiler_alias_NULL$$ && ($height$$35_index$$112_isMultiline_isRotated$$ = $axisInfo$$6$$.$isLabelRotated$($levelIdx$$3$$), $datatip$$2_isOuterLevel$$ = $levelIdx$$3$$ < $axisInfo$$6$$.$getNumLevels$() - 1, !$height$$35_index$$112_isMultiline_isRotated$$ && $datatip$$2_isOuterLevel$$ ? ($label$$13$$.$setY$($availSpace$$7$$.$h$ - $maxLvlHeight$$ / 2), $label$$13$$.$alignMiddle$()) : $label$$13$$.$setTranslateY$($availSpace$$7$$.$h$ - 
        $maxLvlHeight$$))
      }
  ...
  if($axisInfo$$6$$ instanceof D.$DvtTimeAxisInfo$$ && ($labels$$7$$ = $axisInfo$$6$$.$getLabels$($axis$$59$$.$getCtx$()), $context$$13_lv2Labels$$ = $axisInfo$$6$$.$getLabels$($axis$$59$$.$getCtx$(), 1), $offset$$15_options$$18$$ = 0, $context$$13_lv2Labels$$ != D.$JSCompiler_alias_NULL$$)) {
    for($i$$101$$ = 0;$i$$101$$ < $context$$13_lv2Labels$$.length;$i$$101$$++) {
      $label$$13$$ = $context$$13_lv2Labels$$[$i$$101$$], $label$$13$$ != D.$JSCompiler_alias_NULL$$ && !(D.$DvtTextUtils$$.$guessTextDimensions$($label$$13$$).$h$ - 1 > $availSpace$$7$$.$h$) && ($axis$$59$$.$getEventManager$().$associate$($label$$13$$, new D.$DvtSimpleObjPeer$$(D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, (0,D.$DvtAxisEventManager$getUIEventParams$$)(D.$DvtAxisConstants$$.$TICK_LABEL$, $label$$13$$.$getTextString$()))), $isHierarchical_overflow2$$ = 
...
D.$DvtAxisRenderer$$.$_renderLabelsVert$ = function $$DvtAxisRenderer$$$$_renderLabelsVert$$($axis$$60$$, $axisInfo$$7$$, $availSpace$$8$$) {
  ...
  for(var $formatLabelVert$$ = function $$formatLabelVert$$$($gap$$3_lv2Labels$$1$$, $formatLabelVert$$) {
    ...
    if(!($isHierarchical$$1$$ && D.$DvtTextUtils$$.$getMaxTextDimensions$($labels$$8$$).$w$ - 1 > $availSpace$$8$$.$w$) && ($isHierarchical$$1$$ || $isTickInside$$1$$ || !$i$$102$$ || D.$DvtTextUtils$$.$fitText$($gap$$3_lv2Labels$$1$$, $availSpace$$8$$.$w$, $availSpace$$8$$.$h$, $axis$$60$$))) {
      ...
      $axis$$60$$.$getEventManager$().$associate$($gap$$3_lv2Labels$$1$$, new D.$DvtAxisObjPeer$$($axis$$60$$, $gap$$3_lv2Labels$$1$$, $group$$7$$, $action$$6_bbox$$2_cmd_padding$$4$$, $bgColor$$5_drillable$$3$$, $label$$14$$, $i$$102$$, (0,D.$DvtAxisEventManager$getUIEventParams$$)(D.$DvtAxisConstants$$.$TICK_LABEL$, $gap$$3_lv2Labels$$1$$.$getTextString$(), $formatLabelVert$$, $levelIdx$$4$$)));
...
D.$DvtAxisRenderer$$.$_renderLabelsTangent$ = function $$DvtAxisRenderer$$$$_renderLabelsTangent$$($axis$$61$$, $axisInfo$$8$$, $availSpace$$9$$) {
  for(var $labels$$9$$ = $axisInfo$$8$$.$getLabels$($axis$$61$$.$getCtx$()), $i$$103$$ = 0;$i$$103$$ < $labels$$9$$.length;$i$$103$$++) {
    ...
    if($label$$16$$ != D.$JSCompiler_alias_NULL$$) {
      var $index$$114_maxWidth$$2$$ = $availSpace$$9$$.$w$ / 2 - window.Math.abs($label$$16$$.$getX$()), $datatip$$4_maxHeight$$1$$ = $availSpace$$9$$.$h$ / 2 - window.Math.abs($label$$16$$.$getY$());
      if(D.$DvtTextUtils$$.$fitText$($label$$16$$, $index$$114_maxWidth$$2$$, $datatip$$4_maxHeight$$1$$, $axis$$61$$)) {
        var $index$$114_maxWidth$$2$$ = $axisInfo$$8$$ instanceof D.$DvtGroupAxisInfo$$ ? (0,D.$JSCompiler_StaticMethods_getLabelIndex$$)($label$$16$$) : $i$$103$$, $datatip$$4_maxHeight$$1$$ = $axisInfo$$8$$.$getDatatip$($index$$114_maxWidth$$2$$), $tooltip$$4$$ = $label$$16$$.$getUntruncatedTextString$(), $action$$7$$ = $axisInfo$$8$$.$getAction$($index$$114_maxWidth$$2$$), $drillable$$4$$ = $axisInfo$$8$$.$isDrillable$($index$$114_maxWidth$$2$$), $group$$8$$ = $axisInfo$$8$$.$getGroup$($index$$114_maxWidth$$2$$);
        $axis$$61$$.$getEventManager$().$associate$($label$$16$$, new D.$DvtAxisObjPeer$$($axis$$61$$, $label$$16$$, $group$$8$$, $action$$7$$, $drillable$$4$$, $tooltip$$4$$, $datatip$$4_maxHeight$$1$$, (0,D.$DvtAxisEventManager$getUIEventParams$$)(D.$DvtAxisConstants$$.$TICK_LABEL$, $label$$16$$.$getTextString$(), $index$$114_maxWidth$$2$$)));
...
D.$DvtAxisRenderer$$.$_createText$ = function $$DvtAxisRenderer$$$$_createText$$($eventManager$$4$$, $container$$9$$, $text$$38_textString$$5$$, $cssStyle$$22$$, $width$$32$$, $height$$36$$) {
  ...
  return D.$DvtTextUtils$$.$fitText$($text$$38_textString$$5$$, $width$$32$$, $height$$36$$, $container$$9$$) ? ($eventManager$$4$$.$associate$($text$$38_textString$$5$$, new D.$DvtSimpleObjPeer$$($text$$38_textString$$5$$.$getUntruncatedTextString$(), D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, $params$$6$$)), $text$$38_textString$$5$$) : D.$JSCompiler_alias_NULL$$
};
        ...
        if($level$$41$$ < $axisInfo$$9$$.$_lastRenderedLevel$) {
          for(var $i$$104$$ = 0;$i$$104$$ < $labels$$10$$.length;$i$$104$$++) {
            ...
            if($label$$17$$ != D.$JSCompiler_alias_NULL$$) {
              var $index$$115$$ = (0,D.$JSCompiler_StaticMethods_getLabelIndex$$)($label$$17$$), $isEmptyLabel$$ = 0 == (0,D.$JSCompiler_StaticMethods_getLabelAt$$)($axisInfo$$9$$, $index$$115$$, $level$$41$$).length;
              if(!$isEmptyLabel$$) {
                var $eraseCornerEdge$$ = $isEmptyLabel$$ && 0 == $level$$41$$ && (0 == $index$$115$$ || $index$$115$$ == $labels$$10$$.length - 1), $isFirstLabel$$ = $label$$17$$ && $labels$$10$$[$index$$115$$ - 1] == D.$JSCompiler_alias_NULL$$, $isLastLabel_spacing$$ = $label$$17$$ && $labels$$10$$[$index$$115$$ + 1] == D.$JSCompiler_alias_NULL$$;
                $start$$20_x4$$ = (0,D.$JSCompiler_StaticMethods_getStartIndex$$)($axisInfo$$9$$, $index$$115$$, $level$$41$$);
                var $drawLeftLine_end$$5$$ = $axisInfo$$9$$.$getEndIndex$($index$$115$$, $level$$41$$);
                if($isHoriz_position$$6$$) {
                  ...
                  !$eraseCornerEdge$$ && D.$DvtAxisRenderer$$.$_addSeparatorLine$($axis$$62$$, $lineStroke$$, $x2$$2$$, $y2$$1_yCoord$$, $x2$$2$$, $x3_y1$$3$$)), !$isEmptyLabel$$) {
                    ...
                    $nextLabel_prevLabelRendered$$ = (0,D.$JSCompiler_StaticMethods_getLabelAt$$)($axisInfo$$9$$, $index$$115$$ + 1, $level$$41$$);
                  ...
                  (!$isEmptyLabel$$ && $nextLabel_prevLabelRendered$$ == D.$JSCompiler_alias_FALSE$$ || 0 == $index$$115$$ && $isEmptyLabel$$ && 0 != $level$$41$$) && $x3_y1$$3$$ != D.$JSCompiler_alias_NULL$$ && D.$DvtAxisRenderer$$.$_addSeparatorLine$($axis$$62$$, $lineStroke$$, $maxDims_x1$$4$$, $x3_y1$$3$$, $x2$$2$$, $x3_y1$$3$$), $y2$$1_yCoord$$ != D.$JSCompiler_alias_NULL$$ && !$eraseCornerEdge$$ && D.$DvtAxisRenderer$$.$_addSeparatorLine$($axis$$62$$, $lineStroke$$, $x2$$2$$, $y2$$1_yCoord$$, 
                  $maxDims_x1$$4$$, $y2$$1_yCoord$$)), $isEmptyLabel$$ || ($x3_y1$$3$$ = $isFirstLabel$$ && $prevLabelEmpty$$ == D.$JSCompiler_alias_FALSE$$ ? 0 : $axisInfo$$9$$.$getBoundedCoordAt$($start$$20_x4$$ - $startOffset$$), $nextLabel_prevLabelRendered$$ = (0,D.$JSCompiler_StaticMethods_getLabelAt$$)($axisInfo$$9$$, $index$$115$$ + 1, $level$$41$$), $y2$$1_yCoord$$ = $isLastLabel_spacing$$ && $nextLabel_prevLabelRendered$$ && 0 < $nextLabel_prevLabelRendered$$.length ? $axisInfo$$9$$.$getEndCoord$() : 
...
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($context$$18_continuousExtent$$inline_1658$$, $options$$23_scaleUnit$$inline_1659$$, $availSpace$$12$$) {
  D.$DvtDataAxisInfo$$.$superclass$.Init.call(this, $context$$18_continuousExtent$$inline_1658$$, $options$$23_scaleUnit$$inline_1659$$, $availSpace$$12$$);
  "top" == this.$Position$ || "bottom" == this.$Position$ ? ("off" != $options$$23_scaleUnit$$inline_1659$$.tickLabel.rendered && "off" != $options$$23_scaleUnit$$inline_1659$$.rendered && (this.$StartOverflow$ = window.Math.max(10 - $options$$23_scaleUnit$$inline_1659$$.leftBuffer, 0), this.$EndOverflow$ = window.Math.max(10 - $options$$23_scaleUnit$$inline_1659$$.rightBuffer, 0)), (0,D.$DvtAgent$isRightToLeft$$)($context$$18_continuousExtent$$inline_1658$$) ? (this.$_minCoord$ = this.$EndCoord$ - 
  ...
  this.$DataMin$ = $options$$23_scaleUnit$$inline_1659$$.dataMin;
  this.$DataMax$ = $options$$23_scaleUnit$$inline_1659$$.dataMax;
  this.$_isLog$ = "log" == $options$$23_scaleUnit$$inline_1659$$.scale && 0 < this.$DataMin$ && 0 < this.$DataMax$;
  this.$_globalMin$ = this.$actualToLinear$($options$$23_scaleUnit$$inline_1659$$.min);
  this.$_globalMax$ = this.$actualToLinear$($options$$23_scaleUnit$$inline_1659$$.max);
  this.$_minValue$ = $options$$23_scaleUnit$$inline_1659$$.viewportMin == D.$JSCompiler_alias_NULL$$ ? this.$_globalMin$ : this.$actualToLinear$($options$$23_scaleUnit$$inline_1659$$.viewportMin);
  this.$_maxValue$ = $options$$23_scaleUnit$$inline_1659$$.viewportMax == D.$JSCompiler_alias_NULL$$ ? this.$_globalMax$ : this.$actualToLinear$($options$$23_scaleUnit$$inline_1659$$.viewportMax);
  this.$_dataMin$ = this.$actualToLinear$(this.$DataMin$);
  this.$_dataMax$ = this.$actualToLinear$(this.$DataMax$);
  this.$_majorIncrement$ = this.$actualToLinear$($options$$23_scaleUnit$$inline_1659$$.step);
  this.$_minorIncrement$ = this.$actualToLinear$($options$$23_scaleUnit$$inline_1659$$.minorStep);
  this.$_minMajorIncrement$ = this.$actualToLinear$($options$$23_scaleUnit$$inline_1659$$.minStep);
  this.$_majorTickCount$ = $options$$23_scaleUnit$$inline_1659$$._majorTickCount;
  this.$_minorTickCount$ = $options$$23_scaleUnit$$inline_1659$$._minorTickCount;
  this.$_zeroBaseline$ = !this.$_isLog$ && "zero" == $options$$23_scaleUnit$$inline_1659$$.baselineScaling;
  this.$_converter$ = D.$JSCompiler_alias_NULL$$;
  $options$$23_scaleUnit$$inline_1659$$.tickLabel != D.$JSCompiler_alias_NULL$$ && (this.$_converter$ = $options$$23_scaleUnit$$inline_1659$$.tickLabel.converter);
  $context$$18_continuousExtent$$inline_1658$$ = "on" == this.$Options$._continuousExtent;
  this.$_zeroBaseline$ && (this.$_dataMin$ = window.Math.min(0, this.$_dataMin$), this.$_dataMax$ = window.Math.max(0, this.$_dataMax$));
  $options$$23_scaleUnit$$inline_1659$$ = (0,D.$JSCompiler_StaticMethods__calcAxisScale$$)(this, this.$_globalMin$ != D.$JSCompiler_alias_NULL$$ ? this.$_globalMin$ : this.$_dataMin$, this.$_globalMax$ != D.$JSCompiler_alias_NULL$$ ? this.$_globalMax$ : this.$_dataMax$);
  this.$_dataMin$ == this.$_dataMax$ && (0 == this.$_dataMin$ ? this.$_dataMax$ += 5 * $options$$23_scaleUnit$$inline_1659$$ : (this.$_dataMin$ -= 2 * $options$$23_scaleUnit$$inline_1659$$, this.$_dataMax$ += 2 * $options$$23_scaleUnit$$inline_1659$$));
  if(this.$_globalMin$ == D.$JSCompiler_alias_NULL$$) {
    if(this.$_zeroBaseline$ && 0 <= this.$_dataMin$) {
      this.$_globalMin$ = 0
    }else {
      if($context$$18_continuousExtent$$inline_1658$$) {
        ...
        if(!this.$_zeroBaseline$ && this.$_globalMax$ != D.$JSCompiler_alias_NULL$$) {
          for(this.$_globalMin$ = this.$_globalMax$;this.$_globalMin$ >= this.$_dataMin$;) {
            this.$_globalMin$ -= $options$$23_scaleUnit$$inline_1659$$
          }
        }else {
          this.$_globalMin$ = (window.Math.ceil(this.$_dataMin$ / $options$$23_scaleUnit$$inline_1659$$) - 1) * $options$$23_scaleUnit$$inline_1659$$
        }
      }
    }
  ...
  if(this.$_globalMax$ == D.$JSCompiler_alias_NULL$$) {
    if(this.$_majorTickCount$) {
      this.$_globalMax$ = this.$_globalMin$ + this.$_majorTickCount$ * $options$$23_scaleUnit$$inline_1659$$
    }else {
      if(this.$_zeroBaseline$ && 0 >= this.$_dataMax$) {
        ...
        if($context$$18_continuousExtent$$inline_1658$$) {
          ...
          if(this.$_zeroBaseline$) {
            this.$_globalMax$ = (window.Math.floor(this.$_dataMax$ / $options$$23_scaleUnit$$inline_1659$$) + 1) * $options$$23_scaleUnit$$inline_1659$$
          }else {
            for(this.$_globalMax$ = this.$_globalMin$;this.$_globalMax$ <= this.$_dataMax$;) {
              this.$_globalMax$ += $options$$23_scaleUnit$$inline_1659$$
            }
          }
        }
      }
  ...
  this.$_globalMax$ == this.$_globalMin$ && (this.$_globalMax$ = 100, this.$_globalMin$ = 0, $options$$23_scaleUnit$$inline_1659$$ = (this.$_globalMax$ - this.$_globalMin$) / 10);
  ...
  if(this.$_minValue$ != this.$_globalMin$ || this.$_maxValue$ != this.$_globalMax$) {
    $options$$23_scaleUnit$$inline_1659$$ = (0,D.$JSCompiler_StaticMethods__calcAxisScale$$)(this, this.$_minValue$, this.$_maxValue$)
  }
  ...
  this.$_majorIncrement$ || (this.$_majorIncrement$ = this.$_majorTickCount$ ? (this.$_maxValue$ - this.$_minValue$) / this.$_majorTickCount$ : window.Math.max($options$$23_scaleUnit$$inline_1659$$, this.$_minMajorIncrement$));
...
D.$JSCompiler_StaticMethods__sanitizeWrappedText$$ = function $$JSCompiler_StaticMethods__sanitizeWrappedText$$$($JSCompiler_StaticMethods__sanitizeWrappedText$self$$, $context$$23$$, $labelDims$$7_updateLabelDims$$1$$, $labels$$14$$, $isRotated$$2$$, $isHierarchical$$3$$) {
  for(var $totalSpace_updateLabelDims$$inline_1665$$ = D.$JSCompiler_alias_FALSE$$;(0,D.$JSCompiler_StaticMethods_IsOverlapping$$)($JSCompiler_StaticMethods__sanitizeWrappedText$self$$, $labelDims$$7_updateLabelDims$$1$$, 0) && 1 < $JSCompiler_StaticMethods__sanitizeWrappedText$self$$.$_maxLineWrap$;) {
    for(var $totalSpace_updateLabelDims$$inline_1665$$ = D.$JSCompiler_alias_TRUE$$, $i$$110_i$$inline_1666$$ = 0;$i$$110_i$$inline_1666$$ < $labels$$14$$.length;$i$$110_i$$inline_1666$$++) {
      var $lineHeight$$inline_1668_text$$41_text$$inline_1667$$ = $labels$$14$$[$i$$110_i$$inline_1666$$];
      if(($lineHeight$$inline_1668_text$$41_text$$inline_1667$$ instanceof D.$DvtMultilineText$$ || $lineHeight$$inline_1668_text$$41_text$$inline_1667$$ instanceof D.$DvtBackgroundMultilineText$$) && $lineHeight$$inline_1668_text$$41_text$$inline_1667$$.$getLineCount$() == $JSCompiler_StaticMethods__sanitizeWrappedText$self$$.$_maxLineWrap$) {
        $lineHeight$$inline_1668_text$$41_text$$inline_1667$$ = $lineHeight$$inline_1668_text$$41_text$$inline_1667$$.$getLineHeight$(), $isRotated$$2$$ ? $labelDims$$7_updateLabelDims$$1$$[$i$$110_i$$inline_1666$$].$w$ -= $lineHeight$$inline_1668_text$$41_text$$inline_1667$$ : ($labelDims$$7_updateLabelDims$$1$$[$i$$110_i$$inline_1666$$].y += 0.5 * $lineHeight$$inline_1668_text$$41_text$$inline_1667$$, $labelDims$$7_updateLabelDims$$1$$[$i$$110_i$$inline_1666$$].$h$ -= $lineHeight$$inline_1668_text$$41_text$$inline_1667$$)
      }
    }
    $JSCompiler_StaticMethods__sanitizeWrappedText$self$$.$_maxLineWrap$--
  }
  $labelDims$$7_updateLabelDims$$1$$ = $totalSpace_updateLabelDims$$inline_1665$$;
  for($i$$110_i$$inline_1666$$ = $totalSpace_updateLabelDims$$inline_1665$$ = 0;$i$$110_i$$inline_1666$$ < $labels$$14$$.length;$i$$110_i$$inline_1666$$++) {
    if($lineHeight$$inline_1668_text$$41_text$$inline_1667$$ = $labels$$14$$[$i$$110_i$$inline_1666$$]) {
      var $isMultiline$$3$$ = $lineHeight$$inline_1668_text$$41_text$$inline_1667$$ instanceof D.$DvtMultilineText$$ || $lineHeight$$inline_1668_text$$41_text$$inline_1667$$ instanceof D.$DvtBackgroundMultilineText$$;
      $labelDims$$7_updateLabelDims$$1$$ && ($isMultiline$$3$$ && $lineHeight$$inline_1668_text$$41_text$$inline_1667$$.$isWrapEnabled$()) && $lineHeight$$inline_1668_text$$41_text$$inline_1667$$.$wrapText$($JSCompiler_StaticMethods__sanitizeWrappedText$self$$.$_maxSpace$, $lineHeight$$inline_1668_text$$41_text$$inline_1667$$.$getLineHeight$() * $JSCompiler_StaticMethods__sanitizeWrappedText$self$$.$_maxLineWrap$, 1);
      $isHierarchical$$3$$ && ($totalSpace_updateLabelDims$$inline_1665$$ = window.Math.max($totalSpace_updateLabelDims$$inline_1665$$, D.$DvtTextUtils$$.$getTextWidth$($lineHeight$$inline_1668_text$$41_text$$inline_1667$$)));
      $lineHeight$$inline_1668_text$$41_text$$inline_1667$$.$alignMiddle$()
    }
  }
  $isHierarchical$$3$$ && ($JSCompiler_StaticMethods__sanitizeWrappedText$self$$.$_maxSpace$ -= $totalSpace_updateLabelDims$$inline_1665$$ + (0,D.$DvtAxisDefaults$getGapSize$$)($context$$23$$, $JSCompiler_StaticMethods__sanitizeWrappedText$self$$.$Options$, $isRotated$$2$$ ? $JSCompiler_StaticMethods__sanitizeWrappedText$self$$.$Options$.layout.hierarchicalLabelGapHeight : $JSCompiler_StaticMethods__sanitizeWrappedText$self$$.$Options$.layout.hierarchicalLabelGapWidth));
...
D.$JSCompiler_StaticMethods__getLabelCoord$$ = function $$JSCompiler_StaticMethods__getLabelCoord$$$($JSCompiler_StaticMethods__getLabelCoord$self$$, $endValue_level$$46$$, $index$$116$$) {
  var $startValue$$ = (0,D.$JSCompiler_StaticMethods_getStartIndex$$)($JSCompiler_StaticMethods__getLabelCoord$self$$, $index$$116$$, $endValue_level$$46$$);
  $endValue_level$$46$$ = $JSCompiler_StaticMethods__getLabelCoord$self$$.$getEndIndex$($index$$116$$, $endValue_level$$46$$);
...
D.$JSCompiler_prototypeAlias$$.$_generateLabels$ = function $$JSCompiler_prototypeAlias$$$$_generateLabels$$($JSCompiler_temp_const$$295_context$$25$$) {
  var $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$ = [];
  this.$_labels$ = [];
  for(var $container$$12_labelDims$$inline_1686$$ = $JSCompiler_temp_const$$295_context$$25$$.$_stage$, $isHoriz$$2_renderedLabels$$inline_1687$$ = "top" == this.$Position$ || "bottom" == this.$Position$, $endOverflow$$1_isRTL$$8_minLabelDims$$ = (0,D.$DvtAgent$isRightToLeft$$)($JSCompiler_temp_const$$295_context$$25$$), $isHierarchical$$4_numLabels$$inline_1688$$ = 1 < this.$_numLevels$, $groupWidth_labelDims$$9$$ = this.$getGroupWidth$(), $availSize$$1$$ = this.$_maxSpace$, $firstLabelDims$$inline_1689_wrapping$$ = 
  "normal" == this.$Options$.tickLabel.style.$getStyle$("white-space") && "tangential" != this.$Position$, $gap$$7_j$$inline_1691$$ = $isHierarchical$$4_numLabels$$inline_1688$$ ? (0,D.$DvtAxisDefaults$getGapSize$$)($JSCompiler_temp_const$$295_context$$25$$, this.$Options$, this.$Options$.layout[$isHoriz$$2_renderedLabels$$inline_1687$$ ? "hierarchicalLabelGapHeight" : "hierarchicalLabelGapWidth"]) : 0, $rotationEnabled$$ = "auto" == this.$Options$.tickLabel.rotation && $isHoriz$$2_renderedLabels$$inline_1687$$, 
  $dims$$4_label$$19_textWidth$$inline_1682$$, $firstLabel$$, $lastLabel_lastLabelDim_maxLabelDims$$, $cssStyle$$23$$, $coord$$9_text$$44$$, $level$$47_startOverflow$$1$$ = 0;$level$$47_startOverflow$$1$$ < this.$_numLevels$;$level$$47_startOverflow$$1$$++) {
    for(var $j$$22_levels$$ = this.$_levelsArray$[$level$$47_startOverflow$$1$$], $i$$113_totalSpace$$1$$ = 0;$i$$113_totalSpace$$1$$ < $j$$22_levels$$.length;$i$$113_totalSpace$$1$$++) {
      if($j$$22_levels$$[$i$$113_totalSpace$$1$$]) {
        if($dims$$4_label$$19_textWidth$$inline_1682$$ = (0,D.$JSCompiler_StaticMethods_getLabelAt$$)(this, $i$$113_totalSpace$$1$$, $level$$47_startOverflow$$1$$), "" == $dims$$4_label$$19_textWidth$$inline_1682$$ || !$dims$$4_label$$19_textWidth$$inline_1682$$ && 0 != $dims$$4_label$$19_textWidth$$inline_1682$$) {
          $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$.push(D.$JSCompiler_alias_NULL$$)
        }else {
          if($coord$$9_text$$44$$ = (0,D.$JSCompiler_StaticMethods__getLabelCoord$$)(this, $level$$47_startOverflow$$1$$, $i$$113_totalSpace$$1$$), $coord$$9_text$$44$$ != D.$JSCompiler_alias_NULL$$) {
            var $bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$ = (0,D.$JSCompiler_StaticMethods__getGroupAttribute$$)(this, $i$$113_totalSpace$$1$$, $level$$47_startOverflow$$1$$, "labelStyle");
            $bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$ ? ($bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$ = new D.$DvtCSSStyle$$($bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$), $bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$.$getStyle$("font-size") || $bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$.$setStyle$("font-size", this.$Options$.tickLabel.style.$getStyle$("font-size")), $cssStyle$$23$$ = $bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$) : 
            $cssStyle$$23$$ = D.$JSCompiler_alias_NULL$$;
            $bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$ = $firstLabelDims$$inline_1689_wrapping$$ && (0,window.isNaN)($dims$$4_label$$19_textWidth$$inline_1682$$) && 0 <= $dims$$4_label$$19_textWidth$$inline_1682$$.indexOf(" ");
            $coord$$9_text$$44$$ = this.$CreateLabel$($JSCompiler_temp_const$$295_context$$25$$, $dims$$4_label$$19_textWidth$$inline_1682$$, $coord$$9_text$$44$$, $cssStyle$$23$$, $bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$);
            var $groupSpan$$1$$ = $groupWidth_labelDims$$9$$ * (this.$getEndIndex$($i$$113_totalSpace$$1$$, $level$$47_startOverflow$$1$$) - (0,D.$JSCompiler_StaticMethods_getStartIndex$$)(this, $i$$113_totalSpace$$1$$, $level$$47_startOverflow$$1$$) + 1), $JSCompiler_temp$$12_rotationEnabled$$inline_1680$$;
            if($JSCompiler_temp$$12_rotationEnabled$$inline_1680$$ = $bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$) {
              $JSCompiler_temp$$12_rotationEnabled$$inline_1680$$ = $rotationEnabled$$;
              var $maxWidth$$inline_1681$$ = $isHoriz$$2_renderedLabels$$inline_1687$$ ? $groupSpan$$1$$ : $availSize$$1$$;
              $dims$$4_label$$19_textWidth$$inline_1682$$ = D.$DvtTextUtils$$.$getTextStringWidth$($JSCompiler_temp_const$$295_context$$25$$, $dims$$4_label$$19_textWidth$$inline_1682$$, $cssStyle$$23$$);
              $JSCompiler_temp$$12_rotationEnabled$$inline_1680$$ = $dims$$4_label$$19_textWidth$$inline_1682$$ >= $maxWidth$$inline_1681$$ && ($dims$$4_label$$19_textWidth$$inline_1682$$ / this.$_maxLineWrap$ < $maxWidth$$inline_1681$$ || !$JSCompiler_temp$$12_rotationEnabled$$inline_1680$$) ? D.$JSCompiler_alias_TRUE$$ : D.$JSCompiler_alias_FALSE$$
            }
            $JSCompiler_temp$$12_rotationEnabled$$inline_1680$$ ? $isHoriz$$2_renderedLabels$$inline_1687$$ ? $coord$$9_text$$44$$.$wrapText$($groupSpan$$1$$, $availSize$$1$$, 1, D.$JSCompiler_alias_TRUE$$) : $coord$$9_text$$44$$.$wrapText$($availSize$$1$$, $coord$$9_text$$44$$.$getLineHeight$() * this.$_maxLineWrap$, 1, D.$JSCompiler_alias_FALSE$$) : $bMultiline$$1_cssStyle$$inline_1674_labelStyle$$inline_1673$$ && !$isHoriz$$2_renderedLabels$$inline_1687$$ && $coord$$9_text$$44$$.$setWrapEnabled$(D.$JSCompiler_alias_FALSE$$);
            $coord$$9_text$$44$$.$_index$ = $i$$113_totalSpace$$1$$;
            $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$.push($coord$$9_text$$44$$);
    ...
    if($firstLabelDims$$inline_1689_wrapping$$ && $isHierarchical$$4_numLabels$$inline_1688$$) {
      for($j$$22_levels$$ = $i$$113_totalSpace$$1$$ = 0;$j$$22_levels$$ < $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$.length;$j$$22_levels$$++) {
        $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$[$j$$22_levels$$] && ($dims$$4_label$$19_textWidth$$inline_1682$$ = $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$[$j$$22_levels$$].$measureDimensions$(), $i$$113_totalSpace$$1$$ = window.Math.max($i$$113_totalSpace$$1$$, $isHoriz$$2_renderedLabels$$inline_1687$$ ? $dims$$4_label$$19_textWidth$$inline_1682$$.$h$ : $dims$$4_label$$19_textWidth$$inline_1682$$.$w$))
      }
      $availSize$$1$$ -= $i$$113_totalSpace$$1$$ + $gap$$7_j$$inline_1691$$
    }
    this.$_labels$.push($JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$);
    $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$ = []
  }
  $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$ = this.$_labels$[this.$_numLevels$ - 1];
  $groupWidth_labelDims$$9$$ = [];
  if($firstLabel$$) {
    if("tangential" == this.$Position$) {
      $groupWidth_labelDims$$9$$ = (0,D.$JSCompiler_StaticMethods_GetLabelDims$$)($JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, $container$$12_labelDims$$inline_1686$$);
      $JSCompiler_temp_const$$295_context$$25$$ = this.$_labels$;
      $container$$12_labelDims$$inline_1686$$ = $groupWidth_labelDims$$9$$;
      $isHoriz$$2_renderedLabels$$inline_1687$$ = [];
      $isHierarchical$$4_numLabels$$inline_1688$$ = $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$.length;
      $firstLabelDims$$inline_1689_wrapping$$ = D.$JSCompiler_alias_NULL$$;
      if(1 < $isHierarchical$$4_numLabels$$inline_1688$$) {
        for(var $firstLabelDim_prevLabelDims$$inline_1690$$, $gap$$7_j$$inline_1691$$ = 0;$gap$$7_j$$inline_1691$$ < $isHierarchical$$4_numLabels$$inline_1688$$;$gap$$7_j$$inline_1691$$++) {
          if($container$$12_labelDims$$inline_1686$$[$gap$$7_j$$inline_1691$$] && (!$firstLabelDim_prevLabelDims$$inline_1690$$ || $firstLabelDim_prevLabelDims$$inline_1690$$ && !(0,D.$JSCompiler_StaticMethods_IsOverlappingDims$$)($firstLabelDim_prevLabelDims$$inline_1690$$, $container$$12_labelDims$$inline_1686$$[$gap$$7_j$$inline_1691$$]))) {
            $firstLabelDims$$inline_1689_wrapping$$ || ($firstLabelDims$$inline_1689_wrapping$$ = $container$$12_labelDims$$inline_1686$$[$gap$$7_j$$inline_1691$$]), $isHoriz$$2_renderedLabels$$inline_1687$$.push($JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$[$gap$$7_j$$inline_1691$$]), $firstLabelDim_prevLabelDims$$inline_1690$$ = $container$$12_labelDims$$inline_1686$$[$gap$$7_j$$inline_1691$$]
          }
        }
        (0,D.$JSCompiler_StaticMethods_IsOverlappingDims$$)($firstLabelDim_prevLabelDims$$inline_1690$$, $firstLabelDims$$inline_1689_wrapping$$) && $isHoriz$$2_renderedLabels$$inline_1687$$.pop();
        $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$ = $isHoriz$$2_renderedLabels$$inline_1687$$
      }
      $JSCompiler_temp_const$$295_context$$25$$[0] = $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$
    }else {
      $firstLabelDim_prevLabelDims$$inline_1690$$ = $firstLabel$$.$measureDimensions$();
      $isHoriz$$2_renderedLabels$$inline_1687$$ && (this.$Options$._startOverflow != D.$JSCompiler_alias_NULL$$ && this.$Options$._endOverflow != D.$JSCompiler_alias_NULL$$ ? ($level$$47_startOverflow$$1$$ = this.$Options$._startOverflow, $endOverflow$$1_isRTL$$8_minLabelDims$$ = this.$Options$._endOverflow) : ($lastLabel_lastLabelDim_maxLabelDims$$ = $lastLabel_lastLabelDim_maxLabelDims$$.$measureDimensions$(), $level$$47_startOverflow$$1$$ = $endOverflow$$1_isRTL$$8_minLabelDims$$ ? $firstLabelDim_prevLabelDims$$inline_1690$$.$w$ + 
      $firstLabelDim_prevLabelDims$$inline_1690$$.x - this.$StartCoord$ : this.$StartCoord$ - $firstLabelDim_prevLabelDims$$inline_1690$$.x, $endOverflow$$1_isRTL$$8_minLabelDims$$ = $endOverflow$$1_isRTL$$8_minLabelDims$$ ? this.$EndCoord$ - $lastLabel_lastLabelDim_maxLabelDims$$.x : $lastLabel_lastLabelDim_maxLabelDims$$.$w$ + $lastLabel_lastLabelDim_maxLabelDims$$.x - this.$EndCoord$), ($level$$47_startOverflow$$1$$ > this.$_startBuffer$ || $endOverflow$$1_isRTL$$8_minLabelDims$$ > this.$_endBuffer$) && 
      this.$_setOverflow$($level$$47_startOverflow$$1$$, $endOverflow$$1_isRTL$$8_minLabelDims$$, $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$));
      for($level$$47_startOverflow$$1$$ = 0;$level$$47_startOverflow$$1$$ < this.$_numLevels$;$level$$47_startOverflow$$1$$++) {
        if($JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$ = this.$_labels$[$level$$47_startOverflow$$1$$], $endOverflow$$1_isRTL$$8_minLabelDims$$ = (0,D.$JSCompiler_StaticMethods_GuessLabelDims$$)(this, $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, $container$$12_labelDims$$inline_1686$$, 0.3, $level$$47_startOverflow$$1$$), $lastLabel_lastLabelDim_maxLabelDims$$ = (0,D.$JSCompiler_StaticMethods_GuessLabelDims$$)(this, $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, 
        $container$$12_labelDims$$inline_1686$$, D.$JSCompiler_alias_NULL$$, $level$$47_startOverflow$$1$$), (0,D.$JSCompiler_StaticMethods_IsOverlapping$$)(this, $lastLabel_lastLabelDim_maxLabelDims$$, 0) || (this.$_labels$[$level$$47_startOverflow$$1$$] = $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$), $isHoriz$$2_renderedLabels$$inline_1687$$) {
          if($rotationEnabled$$) {
            if((0,D.$JSCompiler_StaticMethods_IsOverlapping$$)(this, $endOverflow$$1_isRTL$$8_minLabelDims$$, 0)) {
              this.$_labels$[$level$$47_startOverflow$$1$$] = (0,D.$JSCompiler_StaticMethods__rotateLabels$$)(this, $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, $container$$12_labelDims$$inline_1686$$, $firstLabelDim_prevLabelDims$$inline_1690$$.$h$ / 2, $level$$47_startOverflow$$1$$)
            }else {
              if($groupWidth_labelDims$$9$$ = (0,D.$JSCompiler_StaticMethods_GetLabelDims$$)($JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, $container$$12_labelDims$$inline_1686$$), (0,D.$JSCompiler_StaticMethods_IsOverlapping$$)(this, $groupWidth_labelDims$$9$$, 0)) {
                this.$_labels$[$level$$47_startOverflow$$1$$] = (0,D.$JSCompiler_StaticMethods__rotateLabels$$)(this, $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, $container$$12_labelDims$$inline_1686$$, $firstLabelDim_prevLabelDims$$inline_1690$$.$h$ / 2, $level$$47_startOverflow$$1$$)
              }else {
                if(this.$_labels$[$level$$47_startOverflow$$1$$] = $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, $isHierarchical$$4_numLabels$$inline_1688$$) {
                  for($j$$22_levels$$ = $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$ = 0;$j$$22_levels$$ < $groupWidth_labelDims$$9$$.length;$j$$22_levels$$++) {
                    $groupWidth_labelDims$$9$$[$j$$22_levels$$] && ($JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$ = window.Math.max($JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, $groupWidth_labelDims$$9$$[$j$$22_levels$$].$h$))
                  }
                  this.$_maxSpace$ -= $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$ + $gap$$7_j$$inline_1691$$
                }
              }
            }
          }else {
            $groupWidth_labelDims$$9$$ = (0,D.$JSCompiler_StaticMethods_GetLabelDims$$)($JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, $container$$12_labelDims$$inline_1686$$), this.$_labels$[$level$$47_startOverflow$$1$$] = (0,D.$JSCompiler_StaticMethods_SkipLabels$$)(this, $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, $groupWidth_labelDims$$9$$)
          }
        }else {
          $firstLabelDims$$inline_1689_wrapping$$ && (0,D.$JSCompiler_StaticMethods__sanitizeWrappedText$$)(this, $JSCompiler_temp_const$$295_context$$25$$, $lastLabel_lastLabelDim_maxLabelDims$$, $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, D.$JSCompiler_alias_FALSE$$, $isHierarchical$$4_numLabels$$inline_1688$$) && ($lastLabel_lastLabelDim_maxLabelDims$$ = (0,D.$JSCompiler_StaticMethods_GuessLabelDims$$)(this, $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, 
          $container$$12_labelDims$$inline_1686$$, D.$JSCompiler_alias_NULL$$, $level$$47_startOverflow$$1$$)), this.$_labels$[$level$$47_startOverflow$$1$$] = (0,D.$JSCompiler_StaticMethods_SkipLabels$$)(this, $JSCompiler_inline_result$$296_labels$$17_labels$$inline_1685_totalHeight$$2$$, $lastLabel_lastLabelDim_maxLabelDims$$)
        }
      }
    }
  }
...
D.$JSCompiler_StaticMethods_getLabelAt$$ = function $$JSCompiler_StaticMethods_getLabelAt$$$($JSCompiler_StaticMethods_getLabelAt$self_label$$20$$, $index$$117$$, $level$$48$$) {
  $level$$48$$ == D.$JSCompiler_alias_NULL$$ && ($level$$48$$ = $JSCompiler_StaticMethods_getLabelAt$self_label$$20$$.$_numLevels$ - 1);
  $index$$117$$ = window.Math.round($index$$117$$);
  if(0 > $index$$117$$) {
    return D.$JSCompiler_alias_NULL$$
  }
  ($JSCompiler_StaticMethods_getLabelAt$self_label$$20$$ = $JSCompiler_StaticMethods_getLabelAt$self_label$$20$$.$_levelsArray$[$level$$48$$] && $JSCompiler_StaticMethods_getLabelAt$self_label$$20$$.$_levelsArray$[$level$$48$$][$index$$117$$] ? $JSCompiler_StaticMethods_getLabelAt$self_label$$20$$.$_levelsArray$[$level$$48$$][$index$$117$$].item : D.$JSCompiler_alias_NULL$$) && ($JSCompiler_StaticMethods_getLabelAt$self_label$$20$$.name ? $JSCompiler_StaticMethods_getLabelAt$self_label$$20$$ = $JSCompiler_StaticMethods_getLabelAt$self_label$$20$$.name : 
...
D.$JSCompiler_StaticMethods_getGroupAt$$ = function $$JSCompiler_StaticMethods_getGroupAt$$$($JSCompiler_StaticMethods_getGroupAt$self_label$$21$$, $index$$118$$, $level$$49$$) {
...
D.$JSCompiler_prototypeAlias$$ = D.$DvtGroupAxisInfo$$.prototype;
D.$JSCompiler_prototypeAlias$$.$getDatatip$ = function $$JSCompiler_prototypeAlias$$$$getDatatip$$($index$$120$$, $level$$51$$) {
  return(0,D.$JSCompiler_StaticMethods__getGroupAttribute$$)(this, $index$$120$$, $level$$51$$, "shortDesc")
};
D.$JSCompiler_prototypeAlias$$.$getAction$ = function $$JSCompiler_prototypeAlias$$$$getAction$$($index$$121$$, $level$$52$$) {
  return(0,D.$JSCompiler_StaticMethods__getGroupAttribute$$)(this, $index$$121$$, $level$$52$$, "action")
};
D.$JSCompiler_prototypeAlias$$.$isDrillable$ = function $$JSCompiler_prototypeAlias$$$$isDrillable$$($index$$122$$, $level$$53$$) {
  var $drilling$$ = (0,D.$JSCompiler_StaticMethods__getGroupAttribute$$)(this, $index$$122$$, $level$$53$$, "drilling");
...
D.$JSCompiler_prototypeAlias$$.$getGroup$ = function $$JSCompiler_prototypeAlias$$$$getGroup$$($index$$123$$, $level$$54$$) {
  if(0 > $index$$123$$ || $index$$123$$ > this.$getGroupCount$() - 1) {
    return D.$JSCompiler_alias_NULL$$
  }
  var $groupLabels$$ = [];
  $level$$54$$ == D.$JSCompiler_alias_NULL$$ && ($level$$54$$ = this.$_numLevels$ - 1);
  for(var $startIndex$$13$$ = (0,D.$JSCompiler_StaticMethods_getStartIndex$$)(this, $index$$123$$, $level$$54$$), $levelIndex$$ = 0;$levelIndex$$ <= $level$$54$$;$levelIndex$$++) {
...
D.$JSCompiler_prototypeAlias$$.$getGroupIndex$ = function $$JSCompiler_prototypeAlias$$$$getGroupIndex$$($group$$9$$) {
  ...
  for(var $index$$124$$ = -1, $i$$117$$ = 0;$i$$117$$ < this.$_groupCount$;$i$$117$$++) {
...
D.$JSCompiler_StaticMethods__getGroupAttribute$$ = function $$JSCompiler_StaticMethods__getGroupAttribute$$$($JSCompiler_StaticMethods__getGroupAttribute$self_groupItem$$, $index$$125$$, $level$$57$$, $attribute$$1$$) {
  $level$$57$$ == D.$JSCompiler_alias_NULL$$ && ($level$$57$$ = $JSCompiler_StaticMethods__getGroupAttribute$self_groupItem$$.$_numLevels$ - 1);
  return($JSCompiler_StaticMethods__getGroupAttribute$self_groupItem$$ = $JSCompiler_StaticMethods__getGroupAttribute$self_groupItem$$.$_levelsArray$[$level$$57$$] && $JSCompiler_StaticMethods__getGroupAttribute$self_groupItem$$.$_levelsArray$[$level$$57$$][$index$$125$$] ? $JSCompiler_StaticMethods__getGroupAttribute$self_groupItem$$.$_levelsArray$[$level$$57$$][$index$$125$$].item : D.$JSCompiler_alias_NULL$$) ? $JSCompiler_StaticMethods__getGroupAttribute$self_groupItem$$[$attribute$$1$$] : D.$JSCompiler_alias_NULL$$
};
D.$JSCompiler_StaticMethods_getStartIndex$$ = function $$JSCompiler_StaticMethods_getStartIndex$$$($JSCompiler_StaticMethods_getStartIndex$self$$, $index$$126$$, $level$$58$$) {
  $level$$58$$ == D.$JSCompiler_alias_NULL$$ && ($level$$58$$ = $JSCompiler_StaticMethods_getStartIndex$self$$.$_numLevels$ - 1);
  return $JSCompiler_StaticMethods_getStartIndex$self$$.$_levelsArray$[$level$$58$$] && $JSCompiler_StaticMethods_getStartIndex$self$$.$_levelsArray$[$level$$58$$][$index$$126$$] ? $JSCompiler_StaticMethods_getStartIndex$self$$.$_levelsArray$[$level$$58$$][$index$$126$$].start : D.$JSCompiler_alias_NULL$$
};
D.$DvtGroupAxisInfo$$.prototype.$getEndIndex$ = function $$DvtGroupAxisInfo$$$$$getEndIndex$$($index$$127$$, $level$$59$$) {
  $level$$59$$ == D.$JSCompiler_alias_NULL$$ && ($level$$59$$ = this.$_numLevels$ - 1);
  return this.$_levelsArray$[$level$$59$$] && this.$_levelsArray$[$level$$59$$][$index$$127$$] ? this.$_levelsArray$[$level$$59$$][$index$$127$$].end : D.$JSCompiler_alias_NULL$$
};
D.$DvtGroupAxisInfo$$.prototype.$getPosition$ = function $$DvtGroupAxisInfo$$$$$getPosition$$($index$$128$$, $level$$60$$) {
  $level$$60$$ == D.$JSCompiler_alias_NULL$$ && ($level$$60$$ = this.$_numLevels$ - 1);
  return this.$_levelsArray$[$level$$60$$] && this.$_levelsArray$[$level$$60$$][$index$$128$$] ? this.$_levelsArray$[$level$$60$$][$index$$128$$].position : D.$JSCompiler_alias_NULL$$
};
...
D.$DvtLinearScaleAxisValueFormatter$$.prototype.Init = function $$DvtLinearScaleAxisValueFormatter$$$$Init$($context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$, $minValue$$2_scaleFactorDiff$$inline_1714$$, $maxValue$$1$$, $tickStep$$1$$, $i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$, $autoPrecision$$2$$) {
  this.$_context$ = $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$;
  this.$_scales$ = {};
  this.$_scalesOrder$ = [];
  this.$_factorToScaleMapping$ = {};
  $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$ = function $$context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$$($context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$, $minValue$$2_scaleFactorDiff$$inline_1714$$, $maxValue$$1$$) {
    var $tickStep$$1$$;
    $maxValue$$1$$ && ($tickStep$$1$$ = (0,D.$DvtBundle$getTranslatedString$$)("DvtUtilBundle", $maxValue$$1$$));
    $maxValue$$1$$ = {$scaleFactor$:$minValue$$2_scaleFactorDiff$$inline_1714$$, $localizedSuffix$:$tickStep$$1$$};
    this.$_scales$[$context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$] = $maxValue$$1$$;
    this.$_scalesOrder$.push($maxValue$$1$$);
    this.$_factorToScaleMapping$[$minValue$$2_scaleFactorDiff$$inline_1714$$] = $maxValue$$1$$
  };
  $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$.call(this, "none", 0);
  $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$.call(this, "thousand", 3, "SCALING_SUFFIX_THOUSAND");
  $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$.call(this, "million", 6, "SCALING_SUFFIX_MILLION");
  $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$.call(this, "billion", 9, "SCALING_SUFFIX_BILLION");
  $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$.call(this, "trillion", 12, "SCALING_SUFFIX_TRILLION");
  $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$.call(this, "quadrillion", 15, "SCALING_SUFFIX_QUADRILLION");
  this.$_scalesOrder$.sort(function($context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$, $minValue$$2_scaleFactorDiff$$inline_1714$$) {
    return $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$.$scaleFactor$ < $minValue$$2_scaleFactorDiff$$inline_1714$$.$scaleFactor$ ? -1 : $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$.$scaleFactor$ > $minValue$$2_scaleFactorDiff$$inline_1714$$.$scaleFactor$ ? 1 : 0
  });
  var $findScale$$inline_1709_scaleFactor$$inline_9762$$ = D.$JSCompiler_alias_FALSE$$, $decimalPlaces$$inline_1710$$, $absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$;
  $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$ = D.$JSCompiler_alias_FALSE$$;
  "off" !== $autoPrecision$$2$$ && ($context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$ = D.$JSCompiler_alias_TRUE$$);
  $i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$ || ($i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$ = "auto");
  if($i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$ = this.$_scales$[$i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$]) {
    $absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$ = $i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$.$scaleFactor$
  }
  "number" !== typeof $absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$ && ($findScale$$inline_1709_scaleFactor$$inline_9762$$ = D.$JSCompiler_alias_TRUE$$);
  if($findScale$$inline_1709_scaleFactor$$inline_9762$$) {
    $absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$ = window.Math.max(window.Math.abs($minValue$$2_scaleFactorDiff$$inline_1714$$), window.Math.abs($maxValue$$1$$));
    $absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$ = (0,D.$JSCompiler_StaticMethods__getPowerOfTen$$)($absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$);
    $findScale$$inline_1709_scaleFactor$$inline_9762$$ = 0;
    if($absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$ <= this.$_scalesOrder$[0].$scaleFactor$) {
      $findScale$$inline_1709_scaleFactor$$inline_9762$$ = this.$_scalesOrder$[0].$scaleFactor$
    }else {
      if($absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$ >= this.$_scalesOrder$[this.$_scalesOrder$.length - 1].$scaleFactor$) {
        $findScale$$inline_1709_scaleFactor$$inline_9762$$ = this.$_scalesOrder$[this.$_scalesOrder$.length - 1].$scaleFactor$
      }else {
        for($i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$ = this.$_scalesOrder$.length - 1;0 <= $i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$;$i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$--) {
          if(this.$_scalesOrder$[$i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$].$scaleFactor$ <= $absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$) {
            $findScale$$inline_1709_scaleFactor$$inline_9762$$ = this.$_scalesOrder$[$i$$inline_9763_scale$$3_scale$$inline_9758_scaleName$$inline_9756$$].$scaleFactor$;
            break
          }
        }
      }
    }
    $absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$ = $findScale$$inline_1709_scaleFactor$$inline_9762$$
  }
  $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$ === D.$JSCompiler_alias_TRUE$$ && (0 == $tickStep$$1$$ && $minValue$$2_scaleFactorDiff$$inline_1714$$ == $maxValue$$1$$ ? ($minValue$$2_scaleFactorDiff$$inline_1714$$ = $absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$ - (0,D.$JSCompiler_StaticMethods__getPowerOfTen$$)($maxValue$$1$$), $decimalPlaces$$inline_1710$$ = 0 >= $minValue$$2_scaleFactorDiff$$inline_1714$$ ? window.Math.max($minValue$$2_scaleFactorDiff$$inline_1714$$ + 
  3, 0) : window.Math.max($minValue$$2_scaleFactorDiff$$inline_1714$$, 4)) : $decimalPlaces$$inline_1710$$ = window.Math.max($absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$ - (0,D.$JSCompiler_StaticMethods__getPowerOfTen$$)($tickStep$$1$$), 0));
  this.$_useAutoPrecision$ = $context$$29_createScale$$inline_1694_useAutoPrecision$$inline_1712$$;
  this.$_scaleFactor$ = $absMax$$inline_1713_scaleFactor$$inline_1711_scaleFactor$$inline_9757_value$$inline_9761$$;
  this.$_decimalPlaces$ = $decimalPlaces$$inline_1710$$
};
D.$DvtLinearScaleAxisValueFormatter$$.prototype.$format$ = function $$DvtLinearScaleAxisValueFormatter$$$$$format$$($value$$78$$, $converter$$) {
  var $formatted$$inline_1718_parsed$$ = (0,window.parseFloat)($value$$78$$);
  if((0,window.isNaN)($formatted$$inline_1718_parsed$$)) {
    return $value$$78$$
  }
  var $i$$120_suffix$$1$$;
  if(0 < this.$_scaleFactor$) {
    for($i$$120_suffix$$1$$ = 0;$i$$120_suffix$$1$$ < this.$_scaleFactor$;$i$$120_suffix$$1$$++) {
      $formatted$$inline_1718_parsed$$ /= 10
    }
    $i$$120_suffix$$1$$ = this.$_factorToScaleMapping$[this.$_scaleFactor$].$localizedSuffix$
  }
  if($converter$$ && $converter$$.getAsString) {
    $formatted$$inline_1718_parsed$$ = $converter$$.getAsString($formatted$$inline_1718_parsed$$)
  }else {
    if($converter$$ && $converter$$.format) {
      $formatted$$inline_1718_parsed$$ = $converter$$.format($formatted$$inline_1718_parsed$$)
    }else {
      var $decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$ = (0,D.$JSCompiler_StaticMethods_getNumberConverter$$)(this.$_context$, {minimumFractionDigits:this.$_decimalPlaces$, maximumFractionDigits:this.$_decimalPlaces$});
      if($decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$ && $decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$.format) {
        $formatted$$inline_1718_parsed$$ = $decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$.format($formatted$$inline_1718_parsed$$)
      }else {
        if(this.$_useAutoPrecision$ && !(0,window.isNaN)((0,window.parseFloat)($formatted$$inline_1718_parsed$$)) && ($formatted$$inline_1718_parsed$$ = (0,window.parseFloat)((new window.Number($formatted$$inline_1718_parsed$$)).toFixed(this.$_decimalPlaces$)), $formatted$$inline_1718_parsed$$ = $formatted$$inline_1718_parsed$$.toString(), -1 == $formatted$$inline_1718_parsed$$.indexOf("e") && ($decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$ = ".", $decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$ = 
        (0,D.$DvtBundle$getTranslatedString$$)("DvtUtilBundle", "NUMBER_FORMAT_DECIMAL_SEPARATOR"), 0 < this.$_decimalPlaces$))) {
          $formatted$$inline_1718_parsed$$ = -1 == $formatted$$inline_1718_parsed$$.indexOf(".") ? $formatted$$inline_1718_parsed$$ + $decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$ : $formatted$$inline_1718_parsed$$.replace(".", $decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$);
          for($decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$ = $formatted$$inline_1718_parsed$$.substring($formatted$$inline_1718_parsed$$.indexOf($decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$) + 1).length;$decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$ < this.$_decimalPlaces$;) {
            $formatted$$inline_1718_parsed$$ += "0", $decimalSep$$inline_1719_defaultConverter_existingPlacesCount$$inline_1720$$++
          }
        }
      }
    }
  }
  "string" === typeof $i$$120_suffix$$1$$ && 0 != $value$$78$$ && ($formatted$$inline_1718_parsed$$ += $i$$120_suffix$$1$$);
  return $formatted$$inline_1718_parsed$$
};
...
D.$JSCompiler_StaticMethods__formatTime$$ = function $$JSCompiler_StaticMethods__formatTime$$$($JSCompiler_StaticMethods__formatTime$self$$, $date$$5_secs$$, $showMinute$$, $showSecond$$) {
  ...
  var $am$$ = (0,D.$DvtTimeAxisInfo$_getAMString$$)($JSCompiler_StaticMethods__formatTime$self$$.$_locale$), $pm$$ = (0,D.$DvtTimeAxisInfo$_getPMString$$)($JSCompiler_StaticMethods__formatTime$self$$.$_locale$), $ampmBefore_language$$inline_1723$$;
  $ampmBefore_language$$inline_1723$$ = $JSCompiler_StaticMethods__formatTime$self$$.$_locale$.substring(0, 2);
  $ampmBefore_language$$inline_1723$$ = "ko" == $ampmBefore_language$$inline_1723$$ || "zh" == $ampmBefore_language$$inline_1723$$ ? D.$JSCompiler_alias_TRUE$$ : D.$JSCompiler_alias_FALSE$$;
  ...
  return $b12HFormat$$ ? $ampmBefore_language$$inline_1723$$ ? $ampm$$ + " " + $timeLabel$$ : $timeLabel$$ + " " + $ampm$$ : $timeLabel$$
};
...
D.$DvtTimeAxisInfo$$.prototype.$_generateLabels$ = function $$DvtTimeAxisInfo$$$$$_generateLabels$$($context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$) {
  var $labels1$$ = [], $labels2$$ = [], $isOverlapping$$inline_1748_j$$23_labelInfos1$$ = [], $coords1$$ = [], $coords2$$ = [], $label1$$1_prevDate$$2_text$$45$$ = D.$JSCompiler_alias_NULL$$, $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$ = 0, $c2_i$$inline_1751$$ = 0, $container$$13$$ = $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$.$_stage$, $isRTL$$9_labels1$$inline_1745$$ = (0,D.$DvtAgent$isRightToLeft$$)($context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$), 
  $isVert$$3_labels2$$inline_1746$$ = "left" == this.$Position$ || "right" == this.$Position$, $lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$ = "off" != this.$Options$.zoomAndScroll, $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ = D.$JSCompiler_alias_TRUE$$, $levelsGap_skip$$inline_1738$$ = 0;
  $isVert$$3_labels2$$inline_1746$$ && (0,D.$DvtAgent$isBrowserChrome$$)() && ($levelsGap_skip$$inline_1738$$ = 0.16 * this.$getTickLabelHeight$());
  var $times$$1$$ = [];
  if(this.$_step$ != D.$JSCompiler_alias_NULL$$) {
    ...
    if(this.$_mixedFrequency$) {
      ...
      if(!this.$_skipGaps$ && ($firstLabel$$1_i$$122$$ = new D.$DvtOutputText$$($context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$, (0,D.$JSCompiler_StaticMethods__formatAxisLabel$$)(this, new window.Date($times$$1$$[0]))[0], 0, 0), (($isVert$$3_labels2$$inline_1746$$ ? D.$DvtTextUtils$$.$guessTextDimensions$($firstLabel$$1_i$$122$$).$h$ : $firstLabel$$1_i$$122$$.$measureDimensions$().$w$) + (0,D.$JSCompiler_StaticMethods_GetTickLabelGapSize$$)(this)) * ($times$$1$$.length - 
  ...
  for($firstLabel$$1_i$$122$$ = 0;$firstLabel$$1_i$$122$$ < $times$$1$$.length;$firstLabel$$1_i$$122$$++) {
    ...
    if($coord$$13$$ != D.$JSCompiler_alias_NULL$$) {
      ...
      $label1$$1_prevDate$$2_text$$45$$ != D.$JSCompiler_alias_NULL$$ ? ($isOverlapping$$inline_1748_j$$23_labelInfos1$$.push({text:$label1$$1_prevDate$$2_text$$45$$, $coord$:$label2$$1_twoLabels$$1$$ != D.$JSCompiler_alias_NULL$$ ? $coord$$13$$ + $levelsGap_skip$$inline_1738$$ : $coord$$13$$}), $coords1$$.push($coord$$13$$), $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$++) : ($isOverlapping$$inline_1748_j$$23_labelInfos1$$.push(D.$JSCompiler_alias_NULL$$), 
      $coords1$$.push(D.$JSCompiler_alias_NULL$$));
      $labels1$$.push(D.$JSCompiler_alias_NULL$$);
      $lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$ && $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ && ($coord$$13$$ = this.$MinValue$ ? this.$getCoordAt$(this.$MinValue$) : $coord$$13$$);
      $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ = D.$JSCompiler_alias_FALSE$$;
      $label2$$1_twoLabels$$1$$ != D.$JSCompiler_alias_NULL$$ ? ($label1$$1_prevDate$$2_text$$45$$ = this.$CreateLabel$($context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$, $label2$$1_twoLabels$$1$$, $label2$$1_twoLabels$$1$$ != D.$JSCompiler_alias_NULL$$ ? $coord$$13$$ - $levelsGap_skip$$inline_1738$$ : $coord$$13$$), $coords2$$.push($coord$$13$$), $isVert$$3_labels2$$inline_1746$$ || ($isRTL$$9_labels1$$inline_1745$$ ? $label1$$1_prevDate$$2_text$$45$$.$alignRight$() : 
      $label1$$1_prevDate$$2_text$$45$$.$alignLeft$()), $labels2$$.push($label1$$1_prevDate$$2_text$$45$$), this.$_isOneLevel$ = D.$JSCompiler_alias_FALSE$$, $c2_i$$inline_1751$$++) : ($labels2$$.push(D.$JSCompiler_alias_NULL$$), $coords2$$.push(D.$JSCompiler_alias_NULL$$));
      $label1$$1_prevDate$$2_text$$45$$ = $date$$8_time$$5$$
    }
  }
  $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$ = $labels1$$;
  for(var $rLabelInfos$$inline_1730$$ = [], $rLabelDims$$inline_1731$$ = [], $availWidth$$inline_1732$$ = window.Math.abs(this.$_endCoord$ - this.$_startCoord$), $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ = 0;$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ < $isOverlapping$$inline_1748_j$$23_labelInfos1$$.length;$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$++) {
    $isOverlapping$$inline_1748_j$$23_labelInfos1$$[$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$] != D.$JSCompiler_alias_NULL$$ && ($rLabelInfos$$inline_1730$$.push($isOverlapping$$inline_1748_j$$23_labelInfos1$$[$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$]), $rLabelDims$$inline_1731$$.push(D.$JSCompiler_alias_NULL$$), this.$_level1Overflow$.push(0))
  }
  for(var $isVert$$inline_1734$$ = "left" == this.$Position$ || "right" == this.$Position$, $_this$$inline_1735$$ = this, $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$ = function $$c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$$($context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$) {
    if($rLabelDims$$inline_1731$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$] == D.$JSCompiler_alias_NULL$$) {
      if($rLabelInfos$$inline_1730$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].label = $_this$$inline_1735$$.$CreateLabel$($container$$13$$.$getCtx$(), $rLabelInfos$$inline_1730$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].text, $rLabelInfos$$inline_1730$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].$coord$), $rLabelDims$$inline_1731$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$] = 
      $rLabelInfos$$inline_1730$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].label.$measureDimensions$($container$$13$$), $rLabelDims$$inline_1731$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].$w$ > $availWidth$$inline_1732$$) {
        $rLabelInfos$$inline_1730$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].label = D.$JSCompiler_alias_NULL$$, $rLabelDims$$inline_1731$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].$w$ = 0, $rLabelDims$$inline_1731$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].$h$ = 0
      }else {
        var $labels1$$ = (0,D.$JSCompiler_StaticMethods__getLabelOverflow$$)($_this$$inline_1735$$, $rLabelInfos$$inline_1730$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].$coord$, $rLabelDims$$inline_1731$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].$w$, D.$JSCompiler_alias_FALSE$$, D.$JSCompiler_alias_FALSE$$);
        0 != $labels1$$ && ($rLabelInfos$$inline_1730$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].$coord$ -= $labels1$$, $rLabelDims$$inline_1731$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].x -= $labels1$$, $rLabelInfos$$inline_1730$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].label.$setX$($rLabelInfos$$inline_1730$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].label.$getX$() - 
        $labels1$$), $_this$$inline_1735$$.$_level1Overflow$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$] = $labels1$$)
      }
    }
    return $isVert$$inline_1734$$ ? $rLabelDims$$inline_1731$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].$h$ : $rLabelDims$$inline_1731$$[$context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$].$w$
  }, $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ = ($c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$(0) + (0,D.$JSCompiler_StaticMethods_GetTickLabelGapSize$$)(this)) * ($rLabelInfos$$inline_1730$$.length - 1), $levelsGap_skip$$inline_1738$$ = 0 < $availWidth$$inline_1732$$ ? window.Math.ceil($bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ / $availWidth$$inline_1732$$) - 
  1 : 0, $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ = D.$JSCompiler_alias_TRUE$$;$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$;) {
    for($bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ = 0;$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ < $rLabelInfos$$inline_1730$$.length;$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$++) {
      0 == $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ % ($levelsGap_skip$$inline_1738$$ + 1) ? ($c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$($bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$), $rLabelInfos$$inline_1730$$[$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$].$skipped$ = D.$JSCompiler_alias_FALSE$$) : $rLabelInfos$$inline_1730$$[$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$].$skipped$ = 
      D.$JSCompiler_alias_TRUE$$
    }
    $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ = (0,D.$JSCompiler_StaticMethods_IsOverlapping$$)(this, $rLabelDims$$inline_1731$$, $levelsGap_skip$$inline_1738$$);
    $levelsGap_skip$$inline_1738$$++
  }
  for($bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ = $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$ = 0;$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ < $isOverlapping$$inline_1748_j$$23_labelInfos1$$.length;$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$++) {
    $isOverlapping$$inline_1748_j$$23_labelInfos1$$[$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$] != D.$JSCompiler_alias_NULL$$ && !$isOverlapping$$inline_1748_j$$23_labelInfos1$$[$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$].$skipped$ && ($context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$[$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$] = 
    $isOverlapping$$inline_1748_j$$23_labelInfos1$$[$bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$].label, $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$++)
  }
  if(!$lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$ && 1 < $c2_i$$inline_1751$$ && $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$ < 1.5 * $c2_i$$inline_1751$$) {
    $labels1$$ = $labels2$$;
    $labels2$$ = D.$JSCompiler_alias_NULL$$;
    for($isOverlapping$$inline_1748_j$$23_labelInfos1$$ = 0;$isOverlapping$$inline_1748_j$$23_labelInfos1$$ < $labels1$$.length;$isOverlapping$$inline_1748_j$$23_labelInfos1$$++) {
      $labels1$$[$isOverlapping$$inline_1748_j$$23_labelInfos1$$] != D.$JSCompiler_alias_NULL$$ && $labels1$$[$isOverlapping$$inline_1748_j$$23_labelInfos1$$].$alignCenter$()
    }
    (0,D.$JSCompiler_StaticMethods__skipLabelsGreedy$$)(this, $labels1$$, (0,D.$JSCompiler_StaticMethods_GetLabelDims$$)($labels1$$, $container$$13$$), D.$JSCompiler_alias_FALSE$$, $isRTL$$9_labels1$$inline_1745$$)
  }else {
    $c2_i$$inline_1751$$ = (0,D.$JSCompiler_StaticMethods__skipLabelsGreedy$$)(this, $labels2$$, (0,D.$JSCompiler_StaticMethods_GetLabelDims$$)($labels2$$, $container$$13$$), D.$JSCompiler_alias_TRUE$$, $isRTL$$9_labels1$$inline_1745$$), 0 == $c2_i$$inline_1751$$ && ($labels2$$ = D.$JSCompiler_alias_NULL$$)
  }
  if($isVert$$3_labels2$$inline_1746$$ && $labels2$$ != D.$JSCompiler_alias_NULL$$) {
    var $isRTL$$9_labels1$$inline_1745$$ = $labels1$$, $isVert$$3_labels2$$inline_1746$$ = $labels2$$, $gap$$inline_1747$$ = 0.08 * this.$getTickLabelHeight$(), $isOverlapping$$inline_1748_j$$23_labelInfos1$$ = function $$isOverlapping$$inline_1748_j$$23_labelInfos1$$$($context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$, $labels1$$) {
      return $labels1$$.y >= $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$.y && $labels1$$.y - $gap$$inline_1747$$ < $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$.y + $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$.$h$ || $labels1$$.y < $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$.y && $labels1$$.y + $labels1$$.$h$ + $gap$$inline_1747$$ > $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$.y ? 
      D.$JSCompiler_alias_TRUE$$ : D.$JSCompiler_alias_FALSE$$
    }, $lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$ = D.$JSCompiler_alias_NULL$$;
    $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$ = D.$JSCompiler_alias_FALSE$$;
    for($c2_i$$inline_1751$$ = 0;$c2_i$$inline_1751$$ < $isRTL$$9_labels1$$inline_1745$$.length;$c2_i$$inline_1751$$++) {
      if($isRTL$$9_labels1$$inline_1745$$[$c2_i$$inline_1751$$] && $isVert$$3_labels2$$inline_1746$$[$c2_i$$inline_1751$$]) {
        $isRTL$$9_labels1$$inline_1745$$[$c2_i$$inline_1751$$].$alignTop$();
        $isVert$$3_labels2$$inline_1746$$[$c2_i$$inline_1751$$].$alignBottom$();
        if($lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$ && $isOverlapping$$inline_1748_j$$23_labelInfos1$$($lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$, $isVert$$3_labels2$$inline_1746$$[$c2_i$$inline_1751$$].$measureDimensions$())) {
          $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$ = D.$JSCompiler_alias_TRUE$$;
          break
        }
        $lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$ = $isRTL$$9_labels1$$inline_1745$$[$c2_i$$inline_1751$$].$measureDimensions$()
      }else {
        if($isRTL$$9_labels1$$inline_1745$$[$c2_i$$inline_1751$$] || $isVert$$3_labels2$$inline_1746$$[$c2_i$$inline_1751$$]) {
          $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$ = $isRTL$$9_labels1$$inline_1745$$[$c2_i$$inline_1751$$] ? $isRTL$$9_labels1$$inline_1745$$[$c2_i$$inline_1751$$] : $isVert$$3_labels2$$inline_1746$$[$c2_i$$inline_1751$$];
          if($lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$ && $isOverlapping$$inline_1748_j$$23_labelInfos1$$($lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$, $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$.$measureDimensions$())) {
            $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$ = D.$JSCompiler_alias_TRUE$$;
            break
          }
          $lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$ = $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$.$measureDimensions$()
        }
      }
    }
    if($context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$) {
      $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$ = $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$ = $lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$ = D.$JSCompiler_alias_NULL$$;
      for($c2_i$$inline_1751$$ = 0;$c2_i$$inline_1751$$ < $isRTL$$9_labels1$$inline_1745$$.length;$c2_i$$inline_1751$$++) {
        $isVert$$3_labels2$$inline_1746$$[$c2_i$$inline_1751$$] ? ($isRTL$$9_labels1$$inline_1745$$[$c2_i$$inline_1751$$] = D.$JSCompiler_alias_NULL$$, $isVert$$3_labels2$$inline_1746$$[$c2_i$$inline_1751$$].$alignMiddle$(), $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ = $isVert$$3_labels2$$inline_1746$$[$c2_i$$inline_1751$$].$measureDimensions$(), $context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$ && $isOverlapping$$inline_1748_j$$23_labelInfos1$$($context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$, 
        $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$) && ($isRTL$$9_labels1$$inline_1745$$[$lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$] = D.$JSCompiler_alias_NULL$$), $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$ = $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$) : $isRTL$$9_labels1$$inline_1745$$[$c2_i$$inline_1751$$] && ($bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$ = 
        $isRTL$$9_labels1$$inline_1745$$[$c2_i$$inline_1751$$].$measureDimensions$(), $c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$ && $isOverlapping$$inline_1748_j$$23_labelInfos1$$($c1_count$$inline_1740_getDim$$inline_1736_label$$inline_1752_lastLv2Dims$$inline_1755$$, $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$) ? $isRTL$$9_labels1$$inline_1745$$[$c2_i$$inline_1751$$] = D.$JSCompiler_alias_NULL$$ : ($context$$32_labels$$inline_1727_lastLv1Dims$$inline_1754_overlapping$$inline_1750$$ = 
        $bOverlaps$$inline_1739_dims$$inline_1756_first$$2_j$$inline_1733_totalWidth$$inline_1737$$, $lastDims$$inline_1749_lastLv1Idx$$inline_1753_scrollable$$ = $c2_i$$inline_1751$$))
      }
    }
  }
...
D.$JSCompiler_StaticMethods__skipLabelsGreedy$$ = function $$JSCompiler_StaticMethods__skipLabelsGreedy$$$($JSCompiler_StaticMethods__skipLabelsGreedy$self_pointB1$$3$$, $labels$$18$$, $labelDims$$10$$, $isStartAligned$$1_pointB2$$3$$, $isRTL$$11$$) {
  ...
  for(var $isVert$$4$$ = "left" == $JSCompiler_StaticMethods__skipLabelsGreedy$self_pointB1$$3$$.$Position$ || "right" == $JSCompiler_StaticMethods__skipLabelsGreedy$self_pointB1$$3$$.$Position$, $gap$$9_labelHeight$$2$$ = $JSCompiler_StaticMethods__skipLabelsGreedy$self_pointB1$$3$$.$getTickLabelHeight$(), $gap$$9_labelHeight$$2$$ = $isVert$$4$$ ? 0.08 * $gap$$9_labelHeight$$2$$ : 0.24 * $gap$$9_labelHeight$$2$$, $count$$9$$ = 0, $pointA1$$3$$, $pointA2$$3$$, $label$$26$$, $availWidth$$6$$ = window.Math.abs($JSCompiler_StaticMethods__skipLabelsGreedy$self_pointB1$$3$$.$_endCoord$ - 
...
D.$JSCompiler_StaticMethods__indexToTime$$ = function $$JSCompiler_StaticMethods__indexToTime$$$($JSCompiler_StaticMethods__indexToTime$self$$, $index$$129$$) {
  var $endIndex$$16$$ = window.Math.min(window.Math.max(window.Math.ceil($index$$129$$), 0), $JSCompiler_StaticMethods__indexToTime$self$$.$_groups$.length), $startIndex$$16$$ = $endIndex$$16$$ - 1, $startTime$$1$$ = $JSCompiler_StaticMethods__indexToTime$self$$.$_groups$[$startIndex$$16$$] !== D.$JSCompiler_alias_VOID$$ ? $JSCompiler_StaticMethods__indexToTime$self$$.$_groups$[$startIndex$$16$$] : $JSCompiler_StaticMethods__indexToTime$self$$.$_groups$[0] - $JSCompiler_StaticMethods__indexToTime$self$$.$_averageInterval$;
  return $startTime$$1$$ + ($index$$129$$ - $startIndex$$16$$) * (($JSCompiler_StaticMethods__indexToTime$self$$.$_groups$[$endIndex$$16$$] !== D.$JSCompiler_alias_VOID$$ ? $JSCompiler_StaticMethods__indexToTime$self$$.$_groups$[$endIndex$$16$$] : $JSCompiler_StaticMethods__indexToTime$self$$.$_groups$[$JSCompiler_StaticMethods__indexToTime$self$$.$_groups$.length - 1] + $JSCompiler_StaticMethods__indexToTime$self$$.$_averageInterval$) - $startTime$$1$$)
};
