...
D.$DvtPictoChart$$ = function $$DvtPictoChart$$$($context$$545$$, $callback$$133$$, $callbackObj$$84$$) {
  this.Init($context$$545$$, $callback$$133$$, $callbackObj$$84$$)
};
...
D.$DvtPictoChart$$.newInstance = function $$DvtPictoChart$$$newInstance$($context$$546$$, $callback$$134$$, $callbackObj$$85$$) {
  return new D.$DvtPictoChart$$($context$$546$$, $callback$$134$$, $callbackObj$$85$$)
};
D.$DvtPictoChart$$.prototype.Init = function $$DvtPictoChart$$$$Init$($context$$547$$, $callback$$135$$, $callbackObj$$86$$) {
  D.$DvtPictoChart$$.$superclass$.Init.call(this, $context$$547$$, $callback$$135$$, $callbackObj$$86$$);
...
D.$DvtPictoChart$$.prototype.$render$ = function $$DvtPictoChart$$$$$render$$($animHandler_context$$inline_7924_options$$234$$, $bounds$$inline_7925_preferredSize$$6_width$$145$$, $height$$132_outerDivSize_playables$$inline_7926$$) {
  this.$_oldContainer$ = this.$_container$;
  var $JSCompiler_inline_result$$208_duration$$inline_7923_oldMarkers$$ = this.$_markers$, $oldWidth$$1$$ = this.$Width$ ? this.$Width$ : 0, $oldHeight$$1$$ = this.$Height$ ? this.$Height$ : 0;
  ...
  this.$SetOptions$($animHandler_context$$inline_7924_options$$234$$);
  var $context$$548$$ = this.$getCtx$();
  if(!$bounds$$inline_7925_preferredSize$$6_width$$145$$ && !$height$$132_outerDivSize_playables$$inline_7926$$) {
    if($context$$548$$.$_root$.style.display = "block", $bounds$$inline_7925_preferredSize$$6_width$$145$$ = this.$_getPreferredSize$(), D.$DvtToolkitUtils$$.$setSvgSize$($context$$548$$, $bounds$$inline_7925_preferredSize$$6_width$$145$$.$w$, $bounds$$inline_7925_preferredSize$$6_width$$145$$.$h$), $height$$132_outerDivSize_playables$$inline_7926$$ = D.$DvtToolkitUtils$$.$getOuterDivSize$($context$$548$$), $bounds$$inline_7925_preferredSize$$6_width$$145$$.$w$ == $height$$132_outerDivSize_playables$$inline_7926$$.$w$ && 
    $bounds$$inline_7925_preferredSize$$6_width$$145$$.$h$ != $height$$132_outerDivSize_playables$$inline_7926$$.$h$ ? (this.$Height$ = $height$$132_outerDivSize_playables$$inline_7926$$.$h$, $bounds$$inline_7925_preferredSize$$6_width$$145$$ = this.$_getPreferredSize$(D.$JSCompiler_alias_NULL$$, this.$Height$), D.$DvtToolkitUtils$$.$setSvgSize$($context$$548$$, $bounds$$inline_7925_preferredSize$$6_width$$145$$.$w$, this.$Height$), this.$Width$ = D.$DvtToolkitUtils$$.$getOuterDivSize$($context$$548$$).$w$) : 
    $bounds$$inline_7925_preferredSize$$6_width$$145$$.$w$ != $height$$132_outerDivSize_playables$$inline_7926$$.$w$ && $bounds$$inline_7925_preferredSize$$6_width$$145$$.$h$ == $height$$132_outerDivSize_playables$$inline_7926$$.$h$ ? (this.$Width$ = $height$$132_outerDivSize_playables$$inline_7926$$.$w$, $bounds$$inline_7925_preferredSize$$6_width$$145$$ = this.$_getPreferredSize$(this.$Width$, D.$JSCompiler_alias_NULL$$), D.$DvtToolkitUtils$$.$setSvgSize$($context$$548$$, this.$Width$, $bounds$$inline_7925_preferredSize$$6_width$$145$$.$h$), 
    this.$Height$ = D.$DvtToolkitUtils$$.$getOuterDivSize$($context$$548$$).$h$) : (this.$Width$ = $height$$132_outerDivSize_playables$$inline_7926$$.$w$, this.$Height$ = $height$$132_outerDivSize_playables$$inline_7926$$.$h$), this.$Width$ != $bounds$$inline_7925_preferredSize$$6_width$$145$$.$w$ || this.$Height$ != $bounds$$inline_7925_preferredSize$$6_width$$145$$.$h$) {
      this.$_info$ = D.$JSCompiler_alias_NULL$$
    }
  }else {
    this.$Width$ = $bounds$$inline_7925_preferredSize$$6_width$$145$$, this.$Height$ = $height$$132_outerDivSize_playables$$inline_7926$$
  }
  ...
  if(this.$_oldContainer$) {
    "none" != this.$Options$.animationOnDataChange && $animHandler_context$$inline_7924_options$$234$$ && ($animHandler_context$$inline_7924_options$$234$$ = new D.$DvtDataAnimationHandler$$($context$$548$$, D.$JSCompiler_alias_NULL$$), (0,D.$JSCompiler_StaticMethods_constructAnimation$$)($animHandler_context$$inline_7924_options$$234$$, $JSCompiler_inline_result$$208_duration$$inline_7923_oldMarkers$$, this.$_markers$), this.$_animation$ = $animHandler_context$$inline_7924_options$$234$$.$getAnimation$())
  }else {
    var $animOnDisplay$$inline_7922_i$$inline_7927$$ = this.$Options$.animationOnDisplay, $JSCompiler_inline_result$$208_duration$$inline_7923_oldMarkers$$ = this.$getAnimationDuration$();
    $animHandler_context$$inline_7924_options$$234$$ = this.$getCtx$();
    $bounds$$inline_7925_preferredSize$$6_width$$145$$ = new D.$DvtRectangle$$(0, 0, this.$Width$, this.$Height$);
    if(D.$DvtBlackBoxAnimationHandler$$.isSupported($animOnDisplay$$inline_7922_i$$inline_7927$$)) {
      $JSCompiler_inline_result$$208_duration$$inline_7923_oldMarkers$$ = D.$DvtBlackBoxAnimationHandler$$.$getInAnimation$($animHandler_context$$inline_7924_options$$234$$, $animOnDisplay$$inline_7922_i$$inline_7927$$, this.$_container$, $bounds$$inline_7925_preferredSize$$6_width$$145$$, $JSCompiler_inline_result$$208_duration$$inline_7923_oldMarkers$$)
    }else {
      $height$$132_outerDivSize_playables$$inline_7926$$ = [];
      if("popIn" == $animOnDisplay$$inline_7922_i$$inline_7927$$) {
        for($animOnDisplay$$inline_7922_i$$inline_7927$$ = 0;$animOnDisplay$$inline_7922_i$$inline_7927$$ < this.$_markers$.length;$animOnDisplay$$inline_7922_i$$inline_7927$$++) {
          var $marker$$inline_7928$$ = this.$_markers$[$animOnDisplay$$inline_7922_i$$inline_7927$$];
          $height$$132_outerDivSize_playables$$inline_7926$$.push(new D.$DvtAnimPopIn$$($animHandler_context$$inline_7924_options$$234$$, $marker$$inline_7928$$, D.$JSCompiler_alias_TRUE$$, $JSCompiler_inline_result$$208_duration$$inline_7923_oldMarkers$$))
        }
      }else {
        if("none" != $animOnDisplay$$inline_7922_i$$inline_7927$$) {
          for($animOnDisplay$$inline_7922_i$$inline_7927$$ = 0;$animOnDisplay$$inline_7922_i$$inline_7927$$ < this.$_markers$.length;$animOnDisplay$$inline_7922_i$$inline_7927$$++) {
            var $marker$$inline_7928$$ = this.$_markers$[$animOnDisplay$$inline_7922_i$$inline_7927$$], $playable$$inline_7929$$ = new D.$DvtCustomAnimation$$($animHandler_context$$inline_7924_options$$234$$, $marker$$inline_7928$$, $JSCompiler_inline_result$$208_duration$$inline_7923_oldMarkers$$), $startState$$inline_7930$$, $endState$$inline_7931$$;
            D.$DvtPictoChartRenderer$$.$isVertical$(this) ? ($startState$$inline_7930$$ = D.$DvtPictoChartRenderer$$.$isOriginRight$(this) ? this.$Width$ : 0, $endState$$inline_7931$$ = $marker$$inline_7928$$.$getCx$(), $marker$$inline_7928$$.$setCx$($startState$$inline_7930$$), (0,D.$JSCompiler_StaticMethods_addProp$$)($playable$$inline_7929$$.$_animator$, "typeNumber", $marker$$inline_7928$$, $marker$$inline_7928$$.$getCx$, $marker$$inline_7928$$.$setCx$, $endState$$inline_7931$$)) : ($startState$$inline_7930$$ = 
            D.$DvtPictoChartRenderer$$.$isOriginBottom$(this) ? this.$Height$ : 0, $endState$$inline_7931$$ = $marker$$inline_7928$$.$getCy$(), $marker$$inline_7928$$.$setCy$($startState$$inline_7930$$), (0,D.$JSCompiler_StaticMethods_addProp$$)($playable$$inline_7929$$.$_animator$, "typeNumber", $marker$$inline_7928$$, $marker$$inline_7928$$.$getCy$, $marker$$inline_7928$$.$setCy$, $endState$$inline_7931$$));
            $height$$132_outerDivSize_playables$$inline_7926$$.push($playable$$inline_7929$$)
          }
          $height$$132_outerDivSize_playables$$inline_7926$$.push(D.$DvtBlackBoxAnimationHandler$$.$getInAnimation$($animHandler_context$$inline_7924_options$$234$$, D.$DvtBlackBoxAnimationHandler$$.$ALPHA_FADE$, this.$_container$, $bounds$$inline_7925_preferredSize$$6_width$$145$$, $JSCompiler_inline_result$$208_duration$$inline_7923_oldMarkers$$))
        }
      }
      $JSCompiler_inline_result$$208_duration$$inline_7923_oldMarkers$$ = 0 < $height$$132_outerDivSize_playables$$inline_7926$$.length ? new D.$DvtParallelPlayable$$($animHandler_context$$inline_7924_options$$234$$, $height$$132_outerDivSize_playables$$inline_7926$$) : D.$JSCompiler_alias_NULL$$
    }
    this.$_animation$ = $JSCompiler_inline_result$$208_duration$$inline_7923_oldMarkers$$
  }
...
D.$JSCompiler_prototypeAlias$$.$SetOptions$ = function $$JSCompiler_prototypeAlias$$$$SetOptions$$($options$$235_selectionMode$$12$$) {
  ...
  this.$_selectionHandler$ = "single" == $options$$235_selectionMode$$12$$ ? new D.$DvtSelectionHandler$$("s") : "multiple" == $options$$235_selectionMode$$12$$ ? new D.$DvtSelectionHandler$$("m") : D.$JSCompiler_alias_NULL$$;
...
D.$DvtPictoChartAutomation$$.prototype.$GetSubIdForDomElement$ = function $$DvtPictoChartAutomation$$$$$GetSubIdForDomElement$$($displayable$$84_logicalObj$$17$$) {
  return($displayable$$84_logicalObj$$17$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this.$_picto$.$getEventManager$(), $displayable$$84_logicalObj$$17$$)) && $displayable$$84_logicalObj$$17$$ instanceof D.$DvtPictoChartItem$$ ? "item[" + this.$_picto$.$getItems$().indexOf($displayable$$84_logicalObj$$17$$) + "]" : D.$JSCompiler_alias_NULL$$
};
D.$DvtPictoChartAutomation$$.prototype.$getDomElementForSubId$ = function $$DvtPictoChartAutomation$$$$$getDomElementForSubId$$($index$$230_item$$47_subId$$29$$) {
  if("tooltip" == $index$$230_item$$47_subId$$29$$) {
    return(0,D.$JSCompiler_StaticMethods_GetTooltipElement$$)(this.$_picto$)
  }
  var $parenIdx$$ = $index$$230_item$$47_subId$$29$$.indexOf("[");
  return 0 < $parenIdx$$ && "item" === $index$$230_item$$47_subId$$29$$.substring(0, $parenIdx$$) && ($index$$230_item$$47_subId$$29$$ = (0,window.parseInt)($index$$230_item$$47_subId$$29$$.substring($parenIdx$$ + 1, $index$$230_item$$47_subId$$29$$.length - 1)), $index$$230_item$$47_subId$$29$$ = this.$_picto$.$getItems$()[$index$$230_item$$47_subId$$29$$]) ? $index$$230_item$$47_subId$$29$$.$getElem$() : D.$JSCompiler_alias_NULL$$
};
D.$DvtPictoChartAutomation$$.prototype.getDomElementForSubId = D.$DvtPictoChartAutomation$$.prototype.$getDomElementForSubId$;
D.$DvtPictoChartAutomation$$.prototype.getItem = function $$DvtPictoChartAutomation$$$$getItem$($index$$231_item$$48$$) {
  if($index$$231_item$$48$$ = this.$_picto$.$getItems$()[$index$$231_item$$48$$]) {
    var $data$$91$$ = {};
    $data$$91$$.color = $index$$231_item$$48$$.$getDatatipColor$();
    $data$$91$$.tooltip = $index$$231_item$$48$$.$getShortDesc$();
    $data$$91$$.id = $index$$231_item$$48$$.getId();
    $data$$91$$.name = $index$$231_item$$48$$.getName();
    $data$$91$$.count = $index$$231_item$$48$$.getCount();
    $data$$91$$.selected = $index$$231_item$$48$$.$isSelected$();
    return $data$$91$$
  }
...
D.$DvtPictoChartImageMarker$$ = function $$DvtPictoChartImageMarker$$$($picto$$2$$, $cx$$58$$, $cy$$59$$, $width$$146$$, $height$$133$$, $source$$34$$, $sourceSelected$$3$$, $sourceHover$$3$$, $sourceHoverSelected$$3$$, $id$$257$$) {
  D.$DvtPictoChartImageMarker$$.$superclass$.Init.call(this, $picto$$2$$.$getCtx$(), $cx$$58$$, $cy$$59$$, $width$$146$$, $height$$133$$, $source$$34$$, $sourceSelected$$3$$, $sourceHover$$3$$, $sourceHoverSelected$$3$$, $id$$257$$);
  this.$_picto$ = $picto$$2$$
};
...
D.$JSCompiler_StaticMethods__getCountString$$ = function $$JSCompiler_StaticMethods__getCountString$$$($JSCompiler_StaticMethods__getCountString$self_JSCompiler_StaticMethods_getTotalCount$self$$inline_7965$$) {
  var $JSCompiler_temp_const$$428$$ = $JSCompiler_StaticMethods__getCountString$self_JSCompiler_StaticMethods_getTotalCount$self$$inline_7965$$.$_picto$.$getOptions$(), $JSCompiler_temp_const$$427$$ = $JSCompiler_StaticMethods__getCountString$self_JSCompiler_StaticMethods_getTotalCount$self$$inline_7965$$.getCount();
  $JSCompiler_StaticMethods__getCountString$self_JSCompiler_StaticMethods_getTotalCount$self$$inline_7965$$ = $JSCompiler_StaticMethods__getCountString$self_JSCompiler_StaticMethods_getTotalCount$self$$inline_7965$$.$_picto$;
  for(var $count$$inline_7966$$ = 0, $i$$inline_7967$$ = 0;$i$$inline_7967$$ < $JSCompiler_StaticMethods__getCountString$self_JSCompiler_StaticMethods_getTotalCount$self$$inline_7965$$.$_items$.length;$i$$inline_7967$$++) {
    $count$$inline_7966$$ += $JSCompiler_StaticMethods__getCountString$self_JSCompiler_StaticMethods_getTotalCount$self$$inline_7965$$.$_items$[$i$$inline_7967$$].getCount()
  }
  return(0,D.$DvtBundle$getTranslation$$)($JSCompiler_temp_const$$428$$, "labelCountWithTotal", "DvtUtilBundle", "COUNT_WITH_TOTAL", [$JSCompiler_temp_const$$427$$, $count$$inline_7966$$])
};
D.$JSCompiler_prototypeAlias$$ = D.$DvtPictoChartItem$$.prototype;
...
D.$JSCompiler_prototypeAlias$$.$setSelected$ = function $$JSCompiler_prototypeAlias$$$$setSelected$$($bSelected$$3$$) {
  ...
  for(var $i$$755$$ = 0;$i$$755$$ < this.$getNumChildren$();$i$$755$$++) {
    var $child$$74$$ = this.$getChildAt$($i$$755$$);
...
D.$JSCompiler_prototypeAlias$$.$showHoverEffect$ = function $$JSCompiler_prototypeAlias$$$$showHoverEffect$$() {
  for(var $i$$756$$ = 0;$i$$756$$ < this.$getNumChildren$();$i$$756$$++) {
    var $child$$75$$ = this.$getChildAt$($i$$756$$);
...
D.$JSCompiler_prototypeAlias$$.$hideHoverEffect$ = function $$JSCompiler_prototypeAlias$$$$hideHoverEffect$$() {
  for(var $i$$757$$ = 0;$i$$757$$ < this.$getNumChildren$();$i$$757$$++) {
    var $child$$76$$ = this.$getChildAt$($i$$757$$);
...
D.$JSCompiler_prototypeAlias$$.$getAriaLabel$ = function $$JSCompiler_prototypeAlias$$$$getAriaLabel$$() {
  ...
  $name$$103_options$$240_shortDesc$$9$$ = this.$getShortDesc$() != D.$JSCompiler_alias_NULL$$ ? this.$getShortDesc$() : $name$$103_options$$240_shortDesc$$9$$ == D.$JSCompiler_alias_NULL$$ ? (0,D.$JSCompiler_StaticMethods__getCountString$$)(this) : (0,D.$DvtBundle$getTranslatedString$$)("DvtUtilBundle", "COLON_SEP_LIST", [$name$$103_options$$240_shortDesc$$9$$, (0,D.$JSCompiler_StaticMethods__getCountString$$)(this)]);
...
D.$JSCompiler_prototypeAlias$$.$getNextNavigable$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigable$$($JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$) {
  var $keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$ = this.$_picto$.$getEventManager$().$KeyboardHandler$;
  if($JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$.type == D.$DvtMouseEvent$CLICK$$ || $keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$.$isMultiSelectEvent$($JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$)) {
    $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$ = this
  }else {
    if($keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$.$isNavigationEvent$($JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$)) {
      var $keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$ = this.$_picto$, $isOriginRight$$inline_7972$$ = D.$DvtPictoChartRenderer$$.$isOriginRight$($keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$), $isOriginBottom$$inline_7973$$ = D.$DvtPictoChartRenderer$$.$isOriginBottom$($keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$);
      $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$ = 37 == $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$.keyCode && $isOriginRight$$inline_7972$$ || 39 == $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$.keyCode && !$isOriginRight$$inline_7972$$ || 38 == $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$.keyCode && 
      $isOriginBottom$$inline_7973$$ || 40 == $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$.keyCode && !$isOriginBottom$$inline_7973$$;
      $keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$ = $keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$.$getItems$();
      $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$ = D.$DvtArrayUtils$$.$getIndex$($keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$, this) + ($JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$ ? 1 : -1);
      $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$ = $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$ < $keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$.length && 0 <= $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$ ? $keyboardHandler$$5_navigableItems$$inline_7975_picto$$inline_7969$$[$JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$] : 
      this
    }else {
      $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$ = D.$JSCompiler_alias_NULL$$
    }
  }
  return $JSCompiler_temp$$281_JSCompiler_temp$$282_event$$694_isForward$$inline_7974_nextIdx$$inline_7976$$
};
...
D.$DvtPictoChartShapeMarker$$ = function $$DvtPictoChartShapeMarker$$$($picto$$12$$, $shape$$85$$, $cx$$59$$, $cy$$60$$, $width$$148$$, $height$$135$$, $id$$258$$) {
  D.$DvtPictoChartShapeMarker$$.$superclass$.Init.call(this, $picto$$12$$.$getCtx$(), $shape$$85$$, "alta", $cx$$59$$, $cy$$60$$, $width$$148$$, $height$$135$$, D.$JSCompiler_alias_TRUE$$, $id$$258$$);
...
D.$JSCompiler_prototypeAlias$$.$_setAnimationParams$ = function $$JSCompiler_prototypeAlias$$$$_setAnimationParams$$($params$$56$$) {
  this.$setCx$($params$$56$$[0]);
  this.$setCy$($params$$56$$[1]);
  this.$setWidth$($params$$56$$[2]);
  this.$setHeight$($params$$56$$[3])
};
    ...
    for(var $background$$15_gapRatio$$1$$ = $picto$$6$$.$getOptions$()._gapRatio, $isVert$$12$$ = D.$DvtPictoChartRenderer$$.$isVertical$($picto$$6$$), $isOriginBottom$$1$$ = D.$DvtPictoChartRenderer$$.$isOriginBottom$($picto$$6$$), $isOriginRight$$1$$ = D.$DvtPictoChartRenderer$$.$isOriginRight$($picto$$6$$), $cellMap$$1$$ = new D.$DvtMap2D$$, $JSCompiler_StaticMethods_updateAriaAttributes$self$$inline_7984_prevColSpan$$ = 0, $prevRowSpan$$ = 0, $remainder$$ = 0, $i$$758$$ = 0;$i$$758$$ < $info$$19$$.$items$.length;$i$$758$$++) {
      for(var $item$$51$$ = $info$$19$$.$items$[$i$$758$$], $colSpan$$1$$ = (0,D.$JSCompiler_StaticMethods_getColSpan$$)($item$$51$$), $rowSpan$$1$$ = (0,D.$JSCompiler_StaticMethods_getRowSpan$$)($item$$51$$), $w$$63$$ = $colSpan$$1$$ * $info$$19$$.$colWidth$, $h$$61$$ = $rowSpan$$1$$ * $info$$19$$.$rowHeight$, $count$$25$$ = $item$$51$$.getCount(), $index$$232$$ = 0, $isFirstMarker_location$$inline_7979$$ = D.$JSCompiler_alias_TRUE$$, $cell$$56$$;0 < $count$$25$$;) {
        ...
        if($item$$51$$.$getSource$()) {
          ...
          $marker$$17_markerId$$11$$ = new D.$DvtPictoChartShapeMarker$$($picto$$6$$, $item$$51$$.$getShape$(), $x$$258_xOffset$$5$$, $y$$233$$, $w$$63$$ - $info$$19$$.$colWidth$ * $background$$15_gapRatio$$1$$, $h$$61$$ - $info$$19$$.$rowHeight$ * $background$$15_gapRatio$$1$$, $marker$$17_markerId$$11$$ + "_S");
        ...
        $isFirstMarker_location$$inline_7979$$ && ($isFirstMarker_location$$inline_7979$$ = new D.$DvtPoint$$($x$$258_xOffset$$5$$, $y$$233$$), $item$$51$$.$_keyboardTooltipLocation$ = $isFirstMarker_location$$inline_7979$$, $isFirstMarker_location$$inline_7979$$ = D.$JSCompiler_alias_FALSE$$);
      ...
      $JSCompiler_StaticMethods_updateAriaAttributes$self$$inline_7984_prevColSpan$$ = $item$$51$$;
      $JSCompiler_StaticMethods_updateAriaAttributes$self$$inline_7984_prevColSpan$$.$setAriaRole$("img");
      $JSCompiler_StaticMethods_updateAriaAttributes$self$$inline_7984_prevColSpan$$.$_updateAriaLabel$();
      $JSCompiler_StaticMethods_updateAriaAttributes$self$$inline_7984_prevColSpan$$ = $colSpan$$1$$;
...
D.$DvtPictoChartRenderer$$.$getInfo$ = function $$DvtPictoChartRenderer$$$$getInfo$$($isVert$$13_picto$$7$$, $width$$147$$, $height$$134$$) {
  ...
  for(var $categoryMap$$1_rowHeight$$11$$ = D.$DvtArrayUtils$$.$createBooleanMap$($options$$242_rowCount$$21$$.hiddenCategories), $items$$31$$ = [], $numCells$$ = 0, $maxColSpan$$ = 1, $maxRowSpan$$ = 1, $colCount$$3_i$$759$$ = 0;$colCount$$3_i$$759$$ < $colWidth$$4_itemObjs$$.length;$colCount$$3_i$$759$$++) {
    if($colWidth$$4_itemObjs$$[$colCount$$3_i$$759$$] != D.$JSCompiler_alias_NULL$$) {
      var $item$$52$$ = new D.$DvtPictoChartItem$$($isVert$$13_picto$$7$$, $colWidth$$4_itemObjs$$[$colCount$$3_i$$759$$]);
  ...
  $colCount$$3_i$$759$$ = $options$$242_rowCount$$21$$.columnCount;
  $options$$242_rowCount$$21$$ = $options$$242_rowCount$$21$$.rowCount;
  !$colCount$$3_i$$759$$ && !$options$$242_rowCount$$21$$ && ($width$$147$$ && $height$$134$$ ? $isVert$$13_picto$$7$$ ? $options$$242_rowCount$$21$$ = D.$DvtPictoChartRenderer$$.$_ceil$(window.Math.sqrt($numCells$$ * $height$$134$$ / $width$$147$$), $maxRowSpan$$) : $colCount$$3_i$$759$$ = D.$DvtPictoChartRenderer$$.$_ceil$(window.Math.sqrt($numCells$$ * $width$$147$$ / $height$$134$$), $maxColSpan$$) : $width$$147$$ ? $colCount$$3_i$$759$$ = window.Math.max(window.Math.floor($width$$147$$ / $colWidth$$4_itemObjs$$), 
  1) : $height$$134$$ ? $options$$242_rowCount$$21$$ = window.Math.max(window.Math.floor($height$$134$$ / $categoryMap$$1_rowHeight$$11$$), 1) : $isVert$$13_picto$$7$$ ? $options$$242_rowCount$$21$$ = D.$DvtPictoChartRenderer$$.$_ceil$(window.Math.sqrt($numCells$$), $maxRowSpan$$) : $colCount$$3_i$$759$$ = D.$DvtPictoChartRenderer$$.$_ceil$(window.Math.sqrt($numCells$$), $maxColSpan$$));
  $colCount$$3_i$$759$$ ? $options$$242_rowCount$$21$$ || ($options$$242_rowCount$$21$$ = D.$DvtPictoChartRenderer$$.$_ceil$($numCells$$ / $colCount$$3_i$$759$$, $maxRowSpan$$)) : $colCount$$3_i$$759$$ = D.$DvtPictoChartRenderer$$.$_ceil$($numCells$$ / $options$$242_rowCount$$21$$, $maxColSpan$$);
  $width$$147$$ && $height$$134$$ && ($colWidth$$4_itemObjs$$ || ($colWidth$$4_itemObjs$$ = $categoryMap$$1_rowHeight$$11$$ ? $categoryMap$$1_rowHeight$$11$$ : window.Math.min($width$$147$$ / $colCount$$3_i$$759$$, $height$$134$$ / $options$$242_rowCount$$21$$)), $categoryMap$$1_rowHeight$$11$$ || ($categoryMap$$1_rowHeight$$11$$ = $colWidth$$4_itemObjs$$));
  return 0 >= $colCount$$3_i$$759$$ || 0 >= $options$$242_rowCount$$21$$ || 0 >= $colWidth$$4_itemObjs$$ || 0 >= $categoryMap$$1_rowHeight$$11$$ ? {} : {$items$:$items$$31$$, $colCount$:$colCount$$3_i$$759$$, $rowCount$:$options$$242_rowCount$$21$$, $colWidth$:$colWidth$$4_itemObjs$$, $rowHeight$:$categoryMap$$1_rowHeight$$11$$}
};
D.$DvtPictoChartRenderer$$.$_ceil$ = function $$DvtPictoChartRenderer$$$$_ceil$$($a$$77$$, $b$$57$$) {
  return window.Math.ceil($a$$77$$ / $b$$57$$) * $b$$57$$
};
D.$DvtPictoChartRenderer$$.$_findNextAvailableCell$ = function $$DvtPictoChartRenderer$$$$_findNextAvailableCell$$($cell$$57_cellMap$$2$$, $colSpan$$3$$, $rowSpan$$3$$, $colCount$$4$$, $rowCount$$22$$, $isVert$$14_r$$87$$) {
  if($isVert$$14_r$$87$$) {
  ...
  for($isVert$$14_r$$87$$ = 0;$isVert$$14_r$$87$$ < $rowCount$$22$$ - $rowSpan$$3$$ + 1;$isVert$$14_r$$87$$++) {
    for(var $c$$45$$ = 0;$c$$45$$ < $colCount$$4$$ - $colSpan$$3$$ + 1;$c$$45$$++) {
      if(D.$DvtPictoChartRenderer$$.$_areCellsAvailable$($cell$$57_cellMap$$2$$, $c$$45$$, $isVert$$14_r$$87$$, $colSpan$$3$$, $rowSpan$$3$$)) {
        return D.$DvtPictoChartRenderer$$.$_occupyCells$($cell$$57_cellMap$$2$$, $c$$45$$, $isVert$$14_r$$87$$, $colSpan$$3$$, $rowSpan$$3$$), {$col$:$c$$45$$, $row$:$isVert$$14_r$$87$$}
      }
    }
  }
  return D.$JSCompiler_alias_NULL$$
