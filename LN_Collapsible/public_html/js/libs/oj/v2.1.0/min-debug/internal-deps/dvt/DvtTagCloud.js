...
D.$DvtTagCloud$$ = function $$DvtTagCloud$$$($context$$583$$, $callback$$149$$, $callbackObj$$100$$) {
  this.Init($context$$583$$, $callback$$149$$, $callbackObj$$100$$)
};
(0,D.$goog$exportPath_$$)("DvtTagCloud", D.$DvtTagCloud$$);
D.$DvtObj$$.$createSubclass$(D.$DvtTagCloud$$, D.$DvtBaseComponent$$, "DvtTagCloud");
D.$DvtTagCloud$$.newInstance = function $$DvtTagCloud$$$newInstance$($context$$584$$, $callback$$150$$, $callbackObj$$101$$) {
  return new D.$DvtTagCloud$$($context$$584$$, $callback$$150$$, $callbackObj$$101$$)
};
D.$DvtTagCloud$$.prototype.Init = function $$DvtTagCloud$$$$Init$($context$$585$$, $callback$$151$$, $callbackObj$$102$$) {
  D.$DvtTagCloud$$.$superclass$.Init.call(this, $context$$585$$, $callback$$151$$, $callbackObj$$102$$);
...
D.$DvtTagCloud$$.prototype.$registerObject$ = function $$DvtTagCloud$$$$$registerObject$$($peer$$28$$, $index$$237$$) {
  this.$_peers$.push($peer$$28$$);
  this.$_itemCollection$[$index$$237$$] = $peer$$28$$
};
...
D.$JSCompiler_prototypeAlias$$.$SetOptions$ = function $$JSCompiler_prototypeAlias$$$$SetOptions$$($options$$262_selectionMode$$13$$) {
  ...
  this.$SelectionHandler$ = "single" === $options$$262_selectionMode$$13$$ ? new D.$DvtSelectionHandler$$("s") : "multiple" === $options$$262_selectionMode$$13$$ ? new D.$DvtSelectionHandler$$("m") : D.$JSCompiler_alias_NULL$$;
...
D.$JSCompiler_prototypeAlias$$.$processEvent$ = function $$JSCompiler_prototypeAlias$$$$processEvent$$($event$$734$$, $source$$35$$) {
  var $type$$242$$ = $event$$734$$.$getType$();
  if($type$$242$$ == D.$DvtCategoryHideShowEvent$$.$TYPE_HIDE$ || $type$$242$$ == D.$DvtCategoryHideShowEvent$$.$TYPE_SHOW$) {
    var $category$$21$$ = $event$$734$$.$_category$, $index$$238$$ = D.$DvtArrayUtils$$.$getIndex$(this.$Options$.hiddenCategories, $category$$21$$);
    $type$$242$$ == D.$DvtCategoryHideShowEvent$$.$TYPE_HIDE$ && 0 > $index$$238$$ && this.$Options$.hiddenCategories.push($category$$21$$);
    $type$$242$$ == D.$DvtCategoryHideShowEvent$$.$TYPE_SHOW$ && 0 <= $index$$238$$ && this.$Options$.hiddenCategories.splice($index$$238$$, 1);
    this.$render$(this.$Options$, this.$Width$, this.$Height$)
  }else {
    if("categoryRollOver" == $type$$242$$ || "categoryRollOut" == $type$$242$$) {
      this != $source$$35$$ ? this.$highlight$($event$$734$$.categories) : this.$legend$ && this.$legend$ != $source$$35$$ && this.$legend$.$processEvent$($event$$734$$, $source$$35$$)
    }
  }
  $event$$734$$ && this.dispatchEvent($event$$734$$)
};
D.$JSCompiler_prototypeAlias$$.$getDragFeedback$ = function $$JSCompiler_prototypeAlias$$$$getDragFeedback$$() {
  for(var $displayables$$28$$ = [], $selection$$35$$ = this.$SelectionHandler$.getSelection(), $i$$786$$ = 0;$i$$786$$ < $selection$$35$$.length;$i$$786$$++) {
    $displayables$$28$$ = $displayables$$28$$.concat($selection$$35$$[$i$$786$$].$getDisplayables$())
  }
...
D.$DvtTagCloudAutomation$$.prototype.$GetSubIdForDomElement$ = function $$DvtTagCloudAutomation$$$$$GetSubIdForDomElement$$($displayable$$88_logicalObj$$18$$) {
  return($displayable$$88_logicalObj$$18$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this.$_tagCloud$.$EventManager$, $displayable$$88_logicalObj$$18$$)) && $displayable$$88_logicalObj$$18$$ instanceof D.$DvtTagCloudObjPeer$$ ? "item[" + this.$_tagCloud$.$getItems$().indexOf($displayable$$88_logicalObj$$18$$) + "]" : D.$JSCompiler_alias_NULL$$
};
D.$DvtTagCloudAutomation$$.prototype.$getDomElementForSubId$ = function $$DvtTagCloudAutomation$$$$$getDomElementForSubId$$($index$$240_peer$$30_subId$$30$$) {
  if("tooltip" == $index$$240_peer$$30_subId$$30$$) {
    return(0,D.$JSCompiler_StaticMethods_GetTooltipElement$$)(this.$_tagCloud$)
  }
  var $parenIdx$$1$$ = $index$$240_peer$$30_subId$$30$$.indexOf("[");
  return 0 < $parenIdx$$1$$ && "item" === $index$$240_peer$$30_subId$$30$$.substring(0, $parenIdx$$1$$) && ($index$$240_peer$$30_subId$$30$$ = (0,window.parseInt)($index$$240_peer$$30_subId$$30$$.substring($parenIdx$$1$$ + 1, $index$$240_peer$$30_subId$$30$$.length - 1)), $index$$240_peer$$30_subId$$30$$ = this.$_tagCloud$.$getItems$()[$index$$240_peer$$30_subId$$30$$]) ? $index$$240_peer$$30_subId$$30$$.$getDisplayables$()[0].$getElem$() : D.$JSCompiler_alias_NULL$$
};
D.$DvtTagCloudAutomation$$.prototype.getDomElementForSubId = D.$DvtTagCloudAutomation$$.prototype.$getDomElementForSubId$;
D.$DvtTagCloudAutomation$$.prototype.getItem = function $$DvtTagCloudAutomation$$$$getItem$($index$$241_peer$$31$$) {
  if($index$$241_peer$$31$$ = this.$_tagCloud$.$getItems$()[$index$$241_peer$$31$$]) {
    var $data$$93$$ = {};
    $data$$93$$.color = $index$$241_peer$$31$$.$getDatatipColor$();
    $data$$93$$.tooltip = $index$$241_peer$$31$$.$getShortDesc$();
    $data$$93$$.label = $index$$241_peer$$31$$.$getLabel$();
    $data$$93$$.value = $index$$241_peer$$31$$.getValue();
    $data$$93$$.selected = $index$$241_peer$$31$$.$isSelected$();
    return $data$$93$$
  }
...
D.$DvtTagCloudItem$$ = function $$DvtTagCloudItem$$$($tagCloud$$, $context$$587$$, $textStr$$16$$, $x$$271$$, $y$$244$$, $style$$110$$, $id$$284$$) {
  this.Init($tagCloud$$, $context$$587$$, $textStr$$16$$, $x$$271$$, $y$$244$$, $style$$110$$, $id$$284$$)
};
...
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($tagCloud$$1$$, $context$$588$$, $textStr$$17$$, $x$$272$$, $y$$245$$, $style$$111$$, $id$$285$$) {
  D.$DvtTagCloudItem$$.$superclass$.Init.call(this, $context$$588$$, $textStr$$17$$, $x$$272$$, $y$$245$$, $style$$111$$, $id$$285$$);
...
D.$JSCompiler_prototypeAlias$$.$animateUpdate$ = function $$JSCompiler_prototypeAlias$$$$animateUpdate$$($handler$$58$$, $oldObj$$2$$) {
  var $anim$$38$$ = new D.$DvtCustomAnimation$$(this.$getCtx$(), this, D.$DvtTagCloudStyleUtils$$.$getAnimationDuration$(this.$_tagCloud$)), $endSize_endX$$1_endY$$1_style$$112$$ = this.$getCSSStyle$(), $oldStyle_startAlign_startSize$$ = $oldObj$$2$$.$getCSSStyle$(), $bSizeChange_startY$$6_x$$inline_8233$$ = D.$JSCompiler_alias_FALSE$$, $dims$$inline_8235_startColor$$14_startX$$5$$ = $oldStyle_startAlign_startSize$$.$getStyle$("color"), $endAlign_endColor$$17$$ = $endSize_endX$$1_endY$$1_style$$112$$.$getStyle$("color");
  if($dims$$inline_8235_startColor$$14_startX$$5$$ != $endAlign_endColor$$17$$) {
    var $tag$$2$$ = this;
    this.$setCSSStyle$($endSize_endX$$1_endY$$1_style$$112$$.$setStyle$("color", $dims$$inline_8235_startColor$$14_startX$$5$$));
  ...
  $oldStyle_startAlign_startSize$$ != $endSize_endX$$1_endY$$1_style$$112$$ && ($bSizeChange_startY$$6_x$$inline_8233$$ = D.$JSCompiler_alias_TRUE$$, $tag$$2$$ = this, this.$setFontSize$($oldStyle_startAlign_startSize$$), (0,D.$JSCompiler_StaticMethods_addProp$$)($anim$$38$$.$_animator$, "typeNumber", this, function() {
    return(0,window.parseFloat)($tag$$2$$.$getCSSStyle$().$getStyle$("font-size"))
  }, this.$setFontSize$, $endSize_endX$$1_endY$$1_style$$112$$));
  $dims$$inline_8235_startColor$$14_startX$$5$$ = $oldObj$$2$$.$getX$();
  ...
  if($endSize_endX$$1_endY$$1_style$$112$$ != $dims$$inline_8235_startColor$$14_startX$$5$$ || $bSizeChange_startY$$6_x$$inline_8233$$ && $endAlign_endColor$$17$$ != $oldStyle_startAlign_startSize$$) {
    $endAlign_endColor$$17$$ != $oldStyle_startAlign_startSize$$ && ($bSizeChange_startY$$6_x$$inline_8233$$ = $dims$$inline_8235_startColor$$14_startX$$5$$, $dims$$inline_8235_startColor$$14_startX$$5$$ = $oldObj$$2$$.$TextInstance$.$getDimensions$(D.$JSCompiler_alias_VOID$$), $dims$$inline_8235_startColor$$14_startX$$5$$ = "left" == $oldStyle_startAlign_startSize$$ ? $bSizeChange_startY$$6_x$$inline_8233$$ + $dims$$inline_8235_startColor$$14_startX$$5$$.$w$ : "right" == $oldStyle_startAlign_startSize$$ ? 
    $bSizeChange_startY$$6_x$$inline_8233$$ - $dims$$inline_8235_startColor$$14_startX$$5$$.$w$ : $bSizeChange_startY$$6_x$$inline_8233$$), this.$setX$($dims$$inline_8235_startColor$$14_startX$$5$$), (0,D.$JSCompiler_StaticMethods_addProp$$)($anim$$38$$.$_animator$, "typeNumber", this, this.$getX$, this.$setX$, $endSize_endX$$1_endY$$1_style$$112$$)
  }
  $bSizeChange_startY$$6_x$$inline_8233$$ = $oldObj$$2$$.$getY$();
  $endSize_endX$$1_endY$$1_style$$112$$ = this.$getY$();
  $endSize_endX$$1_endY$$1_style$$112$$ != $bSizeChange_startY$$6_x$$inline_8233$$ && (this.$setY$($bSizeChange_startY$$6_x$$inline_8233$$), (0,D.$JSCompiler_StaticMethods_addProp$$)($anim$$38$$.$_animator$, "typeNumber", this, this.$getY$, this.$setY$, $endSize_endX$$1_endY$$1_style$$112$$));
  $oldObj$$2$$.$setAlpha$(0);
...
D.$JSCompiler_prototypeAlias$$.$getNextNavigable$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigable$$($bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$) {
  var $JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$ = this.$_view$.$EventManager$.$KeyboardHandler$;
  $bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$.type == D.$DvtMouseEvent$CLICK$$ || $JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$.$isMultiSelectEvent$($bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$) ? $JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$ = this : $JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$.$isNavigationEvent$($bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$) ? 
  ($JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$ = this.$_view$.$getObjects$(), $bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$ = 39 == $bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$.keyCode || 40 == $bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$.keyCode ? D.$JSCompiler_alias_TRUE$$ : D.$JSCompiler_alias_FALSE$$, $bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$ = D.$DvtArrayUtils$$.$getIndex$($JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$, 
  this) + ($bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$ ? 1 : -1), $JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$ = $bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$ < $JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$.length && 0 <= $bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$ ? $JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$[$bNext$$inline_8240_event$$743_nextIdx$$inline_8241$$] : 
  D.$JSCompiler_alias_NULL$$) : $JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$ = D.$JSCompiler_alias_NULL$$;
  return $JSCompiler_temp$$229_JSCompiler_temp$$230_keyboardHandler$$8_navigableItems$$inline_8239$$
};
...
D.$JSCompiler_prototypeAlias$$.$getDragTransferable$ = function $$JSCompiler_prototypeAlias$$$$getDragTransferable$$() {
  var $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_8243_selection$$inline_8246$$ = this.$_view$;
  this.$isSelected$() || ($JSCompiler_StaticMethods_getDragRowKeys$self$$inline_8243_selection$$inline_8246$$.$SelectionHandler$.$processClick$(this, D.$JSCompiler_alias_FALSE$$), $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_8243_selection$$inline_8246$$.$EventManager$.$fireSelectionEvent$());
  for(var $rowKeys$$inline_8245$$ = [], $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_8243_selection$$inline_8246$$ = $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_8243_selection$$inline_8246$$.$SelectionHandler$.getSelection(), $i$$inline_8247$$ = 0;$i$$inline_8247$$ < $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_8243_selection$$inline_8246$$.length;$i$$inline_8247$$++) {
    var $item$$inline_8248$$ = $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_8243_selection$$inline_8246$$[$i$$inline_8247$$];
    $item$$inline_8248$$ instanceof D.$DvtTagCloudObjPeer$$ && $rowKeys$$inline_8245$$.push($item$$inline_8248$$.getId())
  }
  return $rowKeys$$inline_8245$$
};
D.$JSCompiler_prototypeAlias$$.$getDragFeedback$ = function $$JSCompiler_prototypeAlias$$$$getDragFeedback$$() {
...
D.$DvtTagCloudRenderer$$.$_renderEmptyText$ = function $$DvtTagCloudRenderer$$$$_renderEmptyText$$($tagCloud$$5$$, $container$$186$$, $availSpace$$122$$) {
  ...
  $emptyTextStr$$3$$ || ($emptyTextStr$$3$$ = (0,D.$DvtBundle$getTranslation$$)($options$$265$$, "labelNoData", "DvtUtilBundle", "NO_DATA", D.$JSCompiler_alias_NULL$$));
...
D.$DvtTagCloudRenderer$$.$_renderItems$ = function $$DvtTagCloudRenderer$$$$_renderItems$$($tagCloud$$7$$, $container$$188$$, $availSpace$$124$$) {
  for(var $options$$266$$ = $tagCloud$$7$$.$getOptions$(), $items$$39$$ = [], $dataItems$$2$$ = $options$$266$$.items, $fontSizeFunction_minValue$$17$$ = window.Number.MAX_VALUE, $categoryMap$$2_maxValue$$17$$ = -window.Number.MAX_VALUE, $i$$790$$ = 0;$i$$790$$ < $dataItems$$2$$.length;$i$$790$$++) {
    $fontSizeFunction_minValue$$17$$ = window.Math.min($fontSizeFunction_minValue$$17$$, $dataItems$$2$$[$i$$790$$].value), $categoryMap$$2_maxValue$$17$$ = window.Math.max($categoryMap$$2_maxValue$$17$$, $dataItems$$2$$[$i$$790$$].value)
  }
  ...
  for($i$$790$$ = 0;$i$$790$$ < $dataItems$$2$$.length;$i$$790$$++) {
    var $data$$96$$ = $dataItems$$2$$[$i$$790$$];
    ...
    if(!$categoryMap$$2_maxValue$$17$$ || !D.$DvtArrayUtils$$.$hasAnyMapItem$($categoryMap$$2_maxValue$$17$$, $data$$96$$.categories)) {
      var $item$$55_style$$114$$ = $options$$266$$.styleDefaults.style.$clone$();
      (0,D.$JSCompiler_StaticMethods_parseInlineStyle$$)($item$$55_style$$114$$, $data$$96$$.style);
      $item$$55_style$$114$$.$setStyle$("font-size", $fontSizeFunction_minValue$$17$$.call(D.$JSCompiler_alias_NULL$$, $data$$96$$.value).toString());
      var $item$$55_style$$114$$ = new D.$DvtTagCloudItem$$($tagCloud$$7$$, $tagCloud$$7$$.$getCtx$(), $data$$96$$.label, 0, 0, $item$$55_style$$114$$, $data$$96$$.id), $peer$$32$$ = new D.$DvtTagCloudObjPeer$$($tagCloud$$7$$, $item$$55_style$$114$$, $data$$96$$);
      $tagCloud$$7$$.$EventManager$.$associate$($item$$55_style$$114$$, $peer$$32$$);
      $tagCloud$$7$$.$registerObject$($peer$$32$$, $i$$790$$);
      "none" !== $options$$266$$.selectionMode && $peer$$32$$.$setSelectable$(D.$JSCompiler_alias_TRUE$$);
      ($peer$$32$$.$isSelectable$() || $data$$96$$.url || $peer$$32$$.$getAction$()) && $item$$55_style$$114$$.setCursor("pointer");
      $items$$39$$.push($item$$55_style$$114$$);
      $container$$188$$.$addChild$($item$$55_style$$114$$)
    }
  }
...
D.$DvtTagCloudLayoutUtils$$.$cloudLayout$ = function $$DvtTagCloudLayoutUtils$$$$cloudLayout$$($availSpace$$119$$, $items$$36$$) {
  ...
  for(var $thetaStep$$1$$ = 2 * window.Math.PI / 180, $bounds$$153_cy$$63$$ = D.$JSCompiler_alias_NULL$$, $maxFontSize$$ = 0, $cosCache$$ = [], $sinCache$$ = [], $i$$787$$ = 0;$i$$787$$ < $items$$36$$.length;$i$$787$$++) {
    for(var $placed$$ = D.$JSCompiler_alias_FALSE$$, $step$$4$$ = 0, $stepIncrement$$ = 4, $tag$$4$$ = $items$$36$$[$i$$787$$], $dims$$68$$ = $tag$$4$$.$getDimensions$(), $maxFontSize$$ = window.Math.max($maxFontSize$$, (0,window.parseFloat)($tag$$4$$.$getCSSStyle$().$getStyle$("font-size"))), $lastCollisionIndex$$ = -1;!$placed$$;) {
      var $j$$105_lookup$$ = $step$$4$$ % 180;
      $cosCache$$[$j$$105_lookup$$] === D.$JSCompiler_alias_VOID$$ && ($cosCache$$[$j$$105_lookup$$] = window.Math.cos($step$$4$$ * $thetaStep$$1$$));
      $sinCache$$[$j$$105_lookup$$] === D.$JSCompiler_alias_VOID$$ && ($sinCache$$[$j$$105_lookup$$] = window.Math.sin($step$$4$$ * $thetaStep$$1$$));
      var $x$$274$$ = $cx$$62_xrStep$$ * $step$$4$$ * $cosCache$$[$j$$105_lookup$$], $y$$246$$ = $fontSize$$12_yrStep$$ * $step$$4$$ * $sinCache$$[$j$$105_lookup$$], $rect$$48$$ = new D.$DvtRectangle$$($x$$274$$, $y$$246$$, $dims$$68$$.$w$, $dims$$68$$.$h$), $placed$$ = D.$JSCompiler_alias_TRUE$$;
      -1 != $lastCollisionIndex$$ && $positions$$2_scale$$62$$[$lastCollisionIndex$$].$intersects$($rect$$48$$) && ($placed$$ = D.$JSCompiler_alias_FALSE$$);
      if($placed$$) {
        for($j$$105_lookup$$ = 0;$j$$105_lookup$$ < $i$$787$$;$j$$105_lookup$$++) {
      ...
      $placed$$ && ($bounds$$153_cy$$63$$ = $bounds$$153_cy$$63$$ ? (0,D.$JSCompiler_StaticMethods_getUnion$$)($bounds$$153_cy$$63$$, $rect$$48$$) : $rect$$48$$, $lastCollisionIndex$$ = -1, $positions$$2_scale$$62$$[$i$$787$$] = $rect$$48$$, $tag$$4$$.$setX$($x$$274$$), $tag$$4$$.$setY$(-$dims$$68$$.y + $y$$246$$));
...
D.$DvtTagCloudLayoutUtils$$.$rectangleLayout$ = function $$DvtTagCloudLayoutUtils$$$$rectangleLayout$$($availSpace$$120$$, $items$$37$$, $isBidi$$) {
  for(var $arDims$$1$$ = [], $maxWidth$$31_scale$$63$$ = 0, $maxHeight$$19$$ = 0, $arLines_maxFontSize$$1$$ = 0, $i$$788_minScale$$9$$ = 0;$i$$788_minScale$$9$$ < $items$$37$$.length;$i$$788_minScale$$9$$++) {
    var $lineWidth$$9_maxScale_tag$$5$$ = $items$$37$$[$i$$788_minScale$$9$$], $dims$$69_lineStart$$ = $lineWidth$$9_maxScale_tag$$5$$.$getDimensions$(), $maxWidth$$31_scale$$63$$ = window.Math.max($maxWidth$$31_scale$$63$$, $dims$$69_lineStart$$.$w$), $maxHeight$$19$$ = window.Math.max($maxHeight$$19$$, $dims$$69_lineStart$$.$h$), $arLines_maxFontSize$$1$$ = window.Math.max($arLines_maxFontSize$$1$$, (0,window.parseFloat)($lineWidth$$9_maxScale_tag$$5$$.$getCSSStyle$().$getStyle$("font-size")));
    $arDims$$1$$.push(new D.$DvtDimension$$($dims$$69_lineStart$$.$w$, $dims$$69_lineStart$$.$h$))
  }
  $i$$788_minScale$$9$$ = 0;
  for($lineWidth$$9_maxScale_tag$$5$$ = ($availSpace$$120$$.$w$ - 10) / $maxWidth$$31_scale$$63$$;0.001 < $lineWidth$$9_maxScale_tag$$5$$ - $i$$788_minScale$$9$$;) {
    $maxWidth$$31_scale$$63$$ = ($i$$788_minScale$$9$$ + $lineWidth$$9_maxScale_tag$$5$$) / 2, $arLines_maxFontSize$$1$$ = D.$DvtTagCloudLayoutUtils$$.$_calculateLineBreaks$($arDims$$1$$, ($availSpace$$120$$.$w$ - 10) / $maxWidth$$31_scale$$63$$), $arLines_maxFontSize$$1$$.length * ($maxWidth$$31_scale$$63$$ * $maxHeight$$19$$ + 2) - 2 > $availSpace$$120$$.$h$ - 10 ? $lineWidth$$9_maxScale_tag$$5$$ = $maxWidth$$31_scale$$63$$ : $i$$788_minScale$$9$$ = $maxWidth$$31_scale$$63$$
  }
  $maxWidth$$31_scale$$63$$ = $i$$788_minScale$$9$$;
  ...
  for($i$$788_minScale$$9$$ = 0;$i$$788_minScale$$9$$ < $arLines_maxFontSize$$1$$.length - 1;$i$$788_minScale$$9$$++) {
    var $dims$$69_lineStart$$ = $arLines_maxFontSize$$1$$[$i$$788_minScale$$9$$], $lineEnd$$ = $arLines_maxFontSize$$1$$[$i$$788_minScale$$9$$ + 1], $hPadding$$1$$ = 0, $bottomY$$2_maxLineHeight$$ = 0, $justified$$ = D.$JSCompiler_alias_TRUE$$;
    if(1 < $lineEnd$$ - $dims$$69_lineStart$$) {
      ...
      $i$$788_minScale$$9$$ == $arLines_maxFontSize$$1$$.length - 2 && ($flowPadding_j$$106$$ = 0.5 * $bottomY$$2_maxLineHeight$$, $flowPadding_j$$106$$ < $hPadding$$1$$ && $lineWidth$$9_maxScale_tag$$5$$ + ($lineEnd$$ - $dims$$69_lineStart$$) * $flowPadding_j$$106$$ < 0.9 * ($availSpace$$120$$.$w$ - 10) && ($hPadding$$1$$ = $flowPadding_j$$106$$, $justified$$ = D.$JSCompiler_alias_FALSE$$))
    }
    for(var $bottomY$$2_maxLineHeight$$ = 5 + ($i$$788_minScale$$9$$ + 1) * ($maxHeight$$19$$ * $maxWidth$$31_scale$$63$$ + 2) - 2, $curX$$2$$ = $isBidi$$ ? $availSpace$$120$$.$w$ - 5 : 5, $flowPadding_j$$106$$ = $dims$$69_lineStart$$;$flowPadding_j$$106$$ < $lineEnd$$;$flowPadding_j$$106$$++) {
...
D.$DvtTagCloudLayoutUtils$$.$_calculateLineBreaks$ = function $$DvtTagCloudLayoutUtils$$$$_calculateLineBreaks$$($arDims$$2$$, $width$$157$$) {
  ...
  if(1 < $arDims$$2$$.length) {
    for(var $i$$789$$ = 1;$i$$789$$ < $arDims$$2$$.length;$i$$789$$++) {
      $curWidth$$ + $arDims$$2$$[$i$$789$$].$w$ > $width$$157$$ && ($lines$$1$$.push($i$$789$$), $curWidth$$ = 0), $curWidth$$ += $arDims$$2$$[$i$$789$$].$w$ + 2
    }
  }
  return $lines$$1$$
};
...
D.$DvtTagCloudEventManager$$ = function $$DvtTagCloudEventManager$$$($view$$57$$, $context$$586$$, $callback$$152$$, $callbackObj$$103$$) {
  this.Init($context$$586$$, $callback$$152$$, $callbackObj$$103$$);
  this.$_view$ = $view$$57$$
};
D.$DvtObj$$.$createSubclass$(D.$DvtTagCloudEventManager$$, D.$DvtEventManager$$, "DvtTagCloudEventManager");
D.$DvtTagCloudEventManager$$.prototype.$OnClickInternal$ = function $$DvtTagCloudEventManager$$$$$OnClickInternal$$($event$$735_obj$$343$$) {
  $event$$735_obj$$343$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $event$$735_obj$$343$$.target);
  (0,D.$JSCompiler_StaticMethods__handleLinkCallback$$)($event$$735_obj$$343$$);
  this.$_processActionEvent$($event$$735_obj$$343$$)
};
D.$DvtTagCloudEventManager$$.prototype.$HandleTouchHoverEndInternal$ = function $$DvtTagCloudEventManager$$$$$HandleTouchHoverEndInternal$$($event$$736_obj$$344$$) {
  $event$$736_obj$$344$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $event$$736_obj$$344$$.target);
  this.$_processActionEvent$($event$$736_obj$$344$$)
};
D.$DvtTagCloudEventManager$$.prototype.$HandleTouchClickInternal$ = function $$DvtTagCloudEventManager$$$$$HandleTouchClickInternal$$($event$$737_obj$$345$$) {
  $event$$737_obj$$345$$ = (0,D.$JSCompiler_StaticMethods_GetLogicalObject$$)(this, $event$$737_obj$$345$$.target);
  (0,D.$JSCompiler_StaticMethods__handleLinkCallback$$)($event$$737_obj$$345$$);
  this.$_processActionEvent$($event$$737_obj$$345$$)
};
D.$JSCompiler_StaticMethods__handleLinkCallback$$ = function $$JSCompiler_StaticMethods__handleLinkCallback$$$($callback$$153_obj$$346$$) {
  $callback$$153_obj$$346$$ instanceof D.$DvtTagCloudObjPeer$$ && ($callback$$153_obj$$346$$ = $callback$$153_obj$$346$$.$getLinkCallback$()) && $callback$$153_obj$$346$$.call()
};
D.$DvtTagCloudEventManager$$.prototype.$ProcessKeyboardEvent$ = function $$DvtTagCloudEventManager$$$$$ProcessKeyboardEvent$$($event$$738$$) {
  var $eventConsumed$$6$$ = D.$JSCompiler_alias_TRUE$$, $focusObj$$1$$ = this.$getFocus$();
  13 == $event$$738$$.keyCode ? (0,D.$JSCompiler_StaticMethods__handleLinkCallback$$)($focusObj$$1$$) : $eventConsumed$$6$$ = D.$DvtTagCloudEventManager$$.$superclass$.$ProcessKeyboardEvent$.call(this, $event$$738$$);
  return $eventConsumed$$6$$
};
D.$DvtTagCloudEventManager$$.prototype.$ProcessRolloverEvent$ = function $$DvtTagCloudEventManager$$$$$ProcessRolloverEvent$$($event$$739_options$$263$$, $categories$$28_hoverBehaviorDelay$$5_obj$$347$$, $bOver$$12_rolloverEvent$$6$$) {
  $event$$739_options$$263$$ = this.$_view$.$getOptions$();
  "dim" == $event$$739_options$$263$$.hoverBehavior && ($categories$$28_hoverBehaviorDelay$$5_obj$$347$$ = $categories$$28_hoverBehaviorDelay$$5_obj$$347$$.$getCategories$ ? $categories$$28_hoverBehaviorDelay$$5_obj$$347$$.$getCategories$() : [], $event$$739_options$$263$$.highlightedCategories = $bOver$$12_rolloverEvent$$6$$ ? $categories$$28_hoverBehaviorDelay$$5_obj$$347$$.slice() : D.$JSCompiler_alias_NULL$$, $bOver$$12_rolloverEvent$$6$$ = new D.$DvtCategoryRolloverEvent$$($bOver$$12_rolloverEvent$$6$$ ? 
  "categoryRollOver" : "categoryRollOut", $event$$739_options$$263$$.highlightedCategories), $categories$$28_hoverBehaviorDelay$$5_obj$$347$$ = (0,D.$DvtStyleUtils$getTimeMilliseconds$$)($event$$739_options$$263$$.styleDefaults.hoverBehaviorDelay), this.$RolloverHandler$.$processEvent$($bOver$$12_rolloverEvent$$6$$, this.$_view$.$getObjects$(), $categories$$28_hoverBehaviorDelay$$5_obj$$347$$, "any" == $event$$739_options$$263$$.highlightMatch))
};
...
D.$DvtTagCloudKeyboardHandler$$.prototype.$isSelectionEvent$ = function $$DvtTagCloudKeyboardHandler$$$$$isSelectionEvent$$($event$$740$$) {
  return this.$isNavigationEvent$($event$$740$$) && !$event$$740$$.ctrlKey
};
D.$DvtTagCloudKeyboardHandler$$.prototype.$isMultiSelectEvent$ = function $$DvtTagCloudKeyboardHandler$$$$$isMultiSelectEvent$$($event$$741$$) {
  return 32 == $event$$741$$.keyCode && $event$$741$$.ctrlKey
};
