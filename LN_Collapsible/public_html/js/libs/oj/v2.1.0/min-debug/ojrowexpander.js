...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdatasource-common"], function($oj$$21$$, $$$$20$$) {
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.handleEvent = function $$oj$$21$$$$FlattenedTreeDataSource$$$handleEvent$($eventType$$38$$, $event$$334$$) {
    return $oj$$21$$.$FlattenedTreeDataSource$.$superclass$.handleEvent.call(this, $eventType$$38$$, $event$$334$$);
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_fetchRowsFromChildren$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_fetchRowsFromChildren$$($range$$10$$, $callbacks$$9$$) {
    ...
    if ($range$$10$$.start > this.$_getLastIndex$()) {
      ...
      if (0 < $maxFetchSize_nodeSet$$8_processed$$5$$) {
        ...
        -1 === $count$$41$$ || $index$$160$$ < $count$$41$$ - 1 ? ($fetchSize$$2_lastEntry$$ = this.$_getFetchSizeToUse$($count$$41$$), $range$$10$$.start = $index$$160$$ + 1, $range$$10$$.count = -1 === $count$$41$$ ? Math.min($fetchSize$$2_lastEntry$$, $range$$10$$.count) : Math.min($maxFetchSize_nodeSet$$8_processed$$5$$, Math.min(Math.min($fetchSize$$2_lastEntry$$, $range$$10$$.count), $count$$41$$ - $range$$10$$.start)), this.$m_wrapped$.$fetchChildren$($parent$$20$$, $range$$10$$, {success:function($nodeSet$$10$$) {
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$moveOK$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$moveOK$$($rowToMove$$2$$, $referenceRow$$2$$, $position$$14$$) {
    return this.$m_wrapped$.$moveOK$($rowToMove$$2$$, $referenceRow$$2$$, $position$$14$$);
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.move = function $$oj$$21$$$$FlattenedTreeDataSource$$$move$($rowToMove$$3$$, $referenceRow$$3$$, $position$$15$$, $callbacks$$10$$) {
    this.$m_wrapped$.move($rowToMove$$3$$, $referenceRow$$3$$, $position$$15$$, $callbacks$$10$$);
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_processNodeSet$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_processNodeSet$$($nodeSet$$14$$, $parent$$24$$, $depth$$16$$, $toExpand$$1$$) {
    var $nodeStart$$1$$, $nodeCount$$1$$, $i$$294$$, $key$$120_metadata$$7$$;
    $nodeStart$$1$$ = $nodeSet$$14$$.$getStart$();
    $nodeCount$$1$$ = $nodeSet$$14$$.$getCount$();
    for ($i$$294$$ = 0;$i$$294$$ < $nodeCount$$1$$;$i$$294$$++) {
      $key$$120_metadata$$7$$ = $nodeSet$$14$$.getMetadata($nodeStart$$1$$ + $i$$294$$), $key$$120_metadata$$7$$ = $key$$120_metadata$$7$$.key, this.$_addEntry$($key$$120_metadata$$7$$, $depth$$16$$, $nodeStart$$1$$ + $i$$294$$, $parent$$24$$), this.$_isExpanded$($key$$120_metadata$$7$$) && $toExpand$$1$$.push($key$$120_metadata$$7$$);
    }
  };
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$insertMetadata$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$insertMetadata$$($key$$121$$, $metadata$$8$$) {
    this.$_isExpanded$($key$$121$$) && !$metadata$$8$$.leaf ? $metadata$$8$$.state = "expanded" : $metadata$$8$$.state = $metadata$$8$$.leaf ? "leaf" : "collapsed";
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_processDescendantsNodeSet$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_processDescendantsNodeSet$$($nodeSet$$17$$, $parent$$25$$, $depth$$17$$, $lastEntry$$2$$, $maxCount$$1$$, $options$$270$$) {
    var $nodeStart$$2$$, $nodeCount$$2$$, $i$$295$$, $childNodeSet_metadata$$9$$, $key$$122$$;
    ...
    for ($i$$295$$ = 0;$i$$295$$ < $nodeCount$$2$$ && $options$$270$$.count != $maxCount$$1$$;$i$$295$$++) {
      ...
      $key$$122$$ = $childNodeSet_metadata$$9$$.key;
      ...
      if (null == $lastEntry$$2$$ || $options$$270$$.found) {
        this.$_addEntry$($key$$122$$, $depth$$17$$, $nodeStart$$2$$ + $i$$295$$, $parent$$25$$), $options$$270$$.count += 1, $childNodeSet_metadata$$9$$.state = $childNodeSet_metadata$$9$$.leaf ? "leaf" : "expanded";
      }
      null == $lastEntry$$2$$ || $options$$270$$.found || ($key$$122$$ === $lastEntry$$2$$.key ? $childNodeSet_metadata$$9$$.leaf || this.$_isExpanded$($key$$122$$) ? $options$$270$$.found = !0 : $options$$270$$.checkDepth = !0 : $options$$270$$.index += 1);
      $nodeSet$$17$$.$getChildNodeSet$ && this.$_isExpanded$($key$$122$$) && ($childNodeSet_metadata$$9$$ = $nodeSet$$17$$.$getChildNodeSet$($i$$295$$), null != $childNodeSet_metadata$$9$$ && this.$_processDescendantsNodeSet$($childNodeSet_metadata$$9$$, $key$$122$$, $depth$$17$$ + 1, $lastEntry$$2$$, $maxCount$$1$$, $options$$270$$));
    }
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$handleExpandSuccess$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$handleExpandSuccess$$($rowKey$$23$$, $maxCount$$3_nodeSet$$19$$, $childCount_j$$38$$, $callbacks$$16_options$$272$$) {
    var $refIndex$$1$$, $rangeStart$$, $metadata$$10_rowStart$$, $rowCount$$5$$, $parent$$27$$, $depth$$19$$, $key$$123$$, $toExpand$$2$$, $i$$298$$, $queue$$4$$, $prevNodeSetInfo$$2$$;
    ...
    for ($i$$298$$ = $metadata$$10_rowStart$$;$i$$298$$ < $rowCount$$5$$;$i$$298$$++) {
      $metadata$$10_rowStart$$ = $maxCount$$3_nodeSet$$19$$.getMetadata($i$$298$$), $key$$123$$ = $metadata$$10_rowStart$$.key, this.$_isExpanded$($key$$123$$) && $toExpand$$2$$.push($key$$123$$), this.$_insertRow$($refIndex$$1$$, $metadata$$10_rowStart$$, $parent$$27$$.key, $i$$298$$, $depth$$19$$), $refIndex$$1$$++;
    }
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_insertRow$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_insertRow$$($index$$165$$, $key$$125_metadata$$11$$, $parentKey$$1$$, $childIndex$$, $depth$$20$$) {
    $key$$125_metadata$$11$$ = $key$$125_metadata$$11$$.key;
    $index$$165$$ <= this.$_getLastIndex$() ? this.$_addEntry$($key$$125_metadata$$11$$, $depth$$20$$, $childIndex$$, $parentKey$$1$$, $index$$165$$) : this.$_addEntry$($key$$125_metadata$$11$$, $depth$$20$$, $childIndex$$, $parentKey$$1$$);
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_handleModelEvent$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_handleModelEvent$$($event$$336$$) {
    var $operation$$3$$, $ancestors_parentKey$$2$$, $index$$167$$;
    $operation$$3$$ = $event$$336$$.operation;
    $ancestors_parentKey$$2$$ = $event$$336$$.parent;
    ...
    $index$$167$$ = $event$$336$$.index;
    "insert" === $operation$$3$$ ? this.$_handleInsertEvent$($ancestors_parentKey$$2$$, $index$$167$$, $event$$336$$.data) : "delete" === $operation$$3$$ ? this.$_handleDeleteEvent$($ancestors_parentKey$$2$$, $index$$167$$) : "refresh" === $operation$$3$$ && this.$_handleRefreshEvent$($ancestors_parentKey$$2$$);
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_addEntry$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_addEntry$$($key$$126$$, $depth$$22$$, $index$$174$$, $parent$$31$$, $insertAt$$) {
    var $rowData$$3$$ = {};
  ...
  depth0:"oj-rowexpander-depth-0", depth1:"oj-rowexpander-depth-1", depth2:"oj-rowexpander-depth-2", depth3:"oj-rowexpander-depth-3", depth4:"oj-rowexpander-depth-4", depth5:"oj-rowexpander-depth-5", depth6:"oj-rowexpander-depth-6", depth7:"oj-rowexpander-depth-7"}, $constants$:{$MAX_STYLE_DEPTH$:7, $NUM5_KEY$:53}, _ComponentCreate:function() {
    ...
    "expanded" === this.$iconState$ || "collapsed" === this.$iconState$ ? ($$$$20$$(this.$toucharea$).on("touchend", function($event$$337$$) {
      $event$$337$$.preventDefault();
      $self$$137$$.$_fireExpandCollapse$();
    }), $$$$20$$(this.$toucharea$).on("click", function($event$$338$$) {
      $event$$338$$.preventDefault();
      $self$$137$$.$_fireExpandCollapse$();
    }), $$$$20$$(this.element).on("keypress", function($event$$339$$) {
      var $code$$7$$ = $event$$339$$.keyCode || $event$$339$$.which;
      if ($code$$7$$ === $$$$20$$.ui.keyCode.ENTER || $code$$7$$ === $$$$20$$.ui.keyCode.SPACE) {
        $self$$137$$.$_fireExpandCollapse$(), $event$$339$$.preventDefault(), $event$$339$$.target.focus();
      }
  ...
  }, $_handleActiveKeyChangeEvent$:function($event$$340$$, $ui$$18$$) {
  ...
  }, $_handleKeyDownEvent$:function($event$$341$$, $ui$$19$$) {
    var $ancestors$$2_code$$8_context$$104$$, $ancestorInfo$$, $i$$303$$;
    if (this.$rowKey$ === $ui$$19$$.rowKey && ($event$$341$$ = $event$$341$$.originalEvent, $ancestors$$2_code$$8_context$$104$$ = $event$$341$$.keyCode || $event$$341$$.which, $oj$$21$$.$DomUtils$.$isMetaKeyPressed$($event$$341$$))) {
      if ($ancestors$$2_code$$8_context$$104$$ == $$$$20$$.ui.keyCode.RIGHT && "collapsed" === this.$iconState$) {
        this.$_loading$(), this.$datasource$.expand(this.$rowKey$), $event$$341$$.preventDefault();
      } else {
        if ($ancestors$$2_code$$8_context$$104$$ == $$$$20$$.ui.keyCode.LEFT && "expanded" === this.$iconState$) {
          this.$_loading$(), this.$datasource$.collapse(this.$rowKey$), $event$$341$$.preventDefault();
        } else {
          if ($event$$341$$.altKey && $ancestors$$2_code$$8_context$$104$$ == this.$constants$.$NUM5_KEY$ && this.$component$.$_setAccessibleContext$) {
    ...
    this.$_setIconStateClass$();
  }, $_handleExpandEvent$:function($event$$342_rowKey$$28$$) {
    $event$$342_rowKey$$28$$ = $event$$342_rowKey$$28$$.rowKey;
    $event$$342_rowKey$$28$$ === this.$rowKey$ && (this.$_removeIconStateClass$(), this.$iconState$ = "expanded", this.$_setIconStateClass$(), this.$_ariaExpanded$(!0), this._trigger("expand", null, {rowKey:$event$$342_rowKey$$28$$}));
  }, $_handleCollapseEvent$:function($event$$343_rowKey$$29$$) {
    $event$$343_rowKey$$29$$ = $event$$343_rowKey$$29$$.rowKey;
    $event$$343_rowKey$$29$$ === this.$rowKey$ && (this.$_removeIconStateClass$(), this.$iconState$ = "collapsed", this.$_setIconStateClass$(), this.$_ariaExpanded$(!1), this._trigger("collapse", null, {rowKey:$event$$343_rowKey$$29$$}));
