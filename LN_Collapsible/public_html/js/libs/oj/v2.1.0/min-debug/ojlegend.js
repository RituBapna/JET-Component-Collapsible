...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtLegend"], function($oj$$62$$, $$$$57$$, $comp$$15$$, $base$$14$$, $dvt$$11$$) {
  $oj$$62$$.$__registerWidget$("oj.ojLegend", $$$$57$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{categoryFilter:null, categoryHighlight:null, drill:null}, $_CreateDvtComponent$:function($context$$161$$, $callback$$121$$, $callbackObj$$14$$) {
    ...
    var $filterType$$1_highlightType$$1_type$$100$$ = $event$$551$$ && $event$$551$$.getType ? $event$$551$$.getType() : null;
    $filterType$$1_highlightType$$1_type$$100$$ === $dvt$$11$$.DvtCategoryHideShowEvent.TYPE_HIDE || $filterType$$1_highlightType$$1_type$$100$$ === $dvt$$11$$.DvtCategoryHideShowEvent.TYPE_SHOW ? ($filterType$$1_highlightType$$1_type$$100$$ = $filterType$$1_highlightType$$1_type$$100$$ === $dvt$$11$$.DvtCategoryHideShowEvent.TYPE_HIDE ? "out" : "in", this._trigger("categoryFilter", null, {category:$event$$551$$.getCategory(), type:$filterType$$1_highlightType$$1_type$$100$$}), this.$_UserOptionChange$("hiddenCategories", 
    $event$$551$$.hiddenCategories)) : $filterType$$1_highlightType$$1_type$$100$$ === $dvt$$11$$.DvtCategoryRolloverEvent.TYPE_OVER || $filterType$$1_highlightType$$1_type$$100$$ === $dvt$$11$$.DvtCategoryRolloverEvent.TYPE_OUT ? ($filterType$$1_highlightType$$1_type$$100$$ = $filterType$$1_highlightType$$1_type$$100$$ === $dvt$$11$$.DvtCategoryRolloverEvent.TYPE_OVER ? "on" : "off", this._trigger("categoryHighlight", null, {categories:$event$$551$$.categories, type:$filterType$$1_highlightType$$1_type$$100$$}), 
    this.$_UserOptionChange$("highlightedCategories", $event$$551$$.categories)) : $filterType$$1_highlightType$$1_type$$100$$ === $dvt$$11$$.DvtDrillEvent.TYPE ? this._trigger("drill", null, {id:$event$$551$$.getId()}) : this._super($event$$551$$);
    ...
    if ($ret$$60$$) {
      ...
      $ret$$60$$.getItem = function $$ret$$60$$$getItem$($item$$119_itemIndex$$1$$) {
        ($item$$119_itemIndex$$1$$ = $ret$$60$$.items ? $ret$$60$$.items[$item$$119_itemIndex$$1$$] : null) && $ojComponent$$.$_AddAutomationGetters$($item$$119_itemIndex$$1$$);
        return $item$$119_itemIndex$$1$$;
      };
    }
    return $ret$$60$$;
