...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$75$$) {
  ...
  $oj$$75$$.$_JsonTreeNodeDataSource$.prototype.$_ascending$ = function $$oj$$75$$$$_JsonTreeNodeDataSource$$$$_ascending$$($key$$183$$) {
    return function($a$$127$$, $b$$79$$) {
      return $a$$127$$.attr && $b$$79$$.attr && $a$$127$$.attr[$key$$183$$] && $b$$79$$.attr[$key$$183$$] ? $a$$127$$.attr[$key$$183$$] < $b$$79$$.attr[$key$$183$$] ? -1 : $a$$127$$.attr[$key$$183$$] === $b$$79$$.attr[$key$$183$$] ? 0 : 1 : $a$$127$$[$key$$183$$] < $b$$79$$[$key$$183$$] ? -1 : $a$$127$$[$key$$183$$] === $b$$79$$[$key$$183$$] ? 0 : 1;
    };
  };
  $oj$$75$$.$_JsonTreeNodeDataSource$.prototype.$_descending$ = function $$oj$$75$$$$_JsonTreeNodeDataSource$$$$_descending$$($key$$184$$) {
    return function($a$$128$$, $b$$80$$) {
      return $a$$128$$.attr && $b$$80$$.attr && $a$$128$$.attr[$key$$184$$] && $b$$80$$.attr[$key$$184$$] ? $a$$128$$.attr[$key$$184$$] < $b$$80$$.attr[$key$$184$$] ? 1 : $a$$128$$.attr[$key$$184$$] === $b$$80$$.attr[$key$$184$$] ? 0 : -1 : $a$$128$$[$key$$184$$] < $b$$80$$[$key$$184$$] ? 1 : $a$$128$$[$key$$184$$] === $b$$80$$[$key$$184$$] ? 0 : -1;
    };
  };
  ...
  $oj$$75$$.$JsonTreeDataSource$ = function $$oj$$75$$$$JsonTreeDataSource$$($data$$178$$) {
    var $tree$$1$$;
    $tree$$1$$ = new $oj$$75$$.$_JsonTreeNodeDataSource$;
    $data$$178$$.id || ($tree$$1$$.id = "root");
    this.data = this.$_createTreeDataSource$({count:0}, $tree$$1$$, $data$$178$$);
  ...
  $oj$$75$$.$JsonTreeDataSource$.prototype.move = function $$oj$$75$$$$JsonTreeDataSource$$$move$($moveNode_nodeToMove$$, $refNode$$8_referenceNode$$1$$, $index$$291_position$$45$$, $callbacks$$58$$) {
    ...
    if (!$parent$$54_refNodeKey$$ || $parent$$54_refNodeKey$$ == this.data.id) {
      if ("inside" != $index$$291_position$$45$$) {
        $oj$$75$$.$Logger$.log("Error: root can not be the reference node if position equals to " + $index$$291_position$$45$$);
        return;
      }
      $parent$$54_refNodeKey$$ || ($parent$$54_refNodeKey$$ = this.data.id);
    }
    $moveNode_nodeToMove$$ = this.$_searchTreeById$(null, $moveNode_nodeToMove$$);
    this.$_searchTreeById$($moveNode_nodeToMove$$, $parent$$54_refNodeKey$$) ? $oj$$75$$.$Logger$.log("Error: the node to move contains the reference node as its sub-tree.") : ($refNode$$8_referenceNode$$1$$ = this.$_searchTreeById$(null, $parent$$54_refNodeKey$$), $parent$$54_refNodeKey$$ = this.$_getParentById$($parent$$54_refNodeKey$$), this.$_removeFromTree$($moveNode_nodeToMove$$), "inside" == $index$$291_position$$45$$ ? (this.$_updateDepth$($moveNode_nodeToMove$$, $moveNode_nodeToMove$$.depth - 
    ($refNode$$8_referenceNode$$1$$.depth + 1)), $refNode$$8_referenceNode$$1$$.children.push($moveNode_nodeToMove$$)) : "before" == $index$$291_position$$45$$ ? (this.$_updateDepth$($moveNode_nodeToMove$$, $moveNode_nodeToMove$$.depth - $refNode$$8_referenceNode$$1$$.depth), $index$$291_position$$45$$ = $parent$$54_refNodeKey$$.children.indexOf($refNode$$8_referenceNode$$1$$), -1 < $index$$291_position$$45$$ && (0 != $index$$291_position$$45$$ ? $parent$$54_refNodeKey$$.children.splice($index$$291_position$$45$$ - 
    1, 0, $moveNode_nodeToMove$$) : $parent$$54_refNodeKey$$.children.unshift($moveNode_nodeToMove$$))) : "after" == $index$$291_position$$45$$ ? (this.$_updateDepth$($moveNode_nodeToMove$$, $moveNode_nodeToMove$$.depth - $refNode$$8_referenceNode$$1$$.depth), $index$$291_position$$45$$ = $parent$$54_refNodeKey$$.children.indexOf($refNode$$8_referenceNode$$1$$), -1 < $index$$291_position$$45$$ && $parent$$54_refNodeKey$$.children.splice($index$$291_position$$45$$, 0, $moveNode_nodeToMove$$)) : "first" == 
    $index$$291_position$$45$$ ? (this.$_updateDepth$($moveNode_nodeToMove$$, $moveNode_nodeToMove$$.depth - $refNode$$8_referenceNode$$1$$.depth), $parent$$54_refNodeKey$$.children.unshift($moveNode_nodeToMove$$)) : "last" == $index$$291_position$$45$$ && (this.$_updateDepth$($moveNode_nodeToMove$$, $moveNode_nodeToMove$$.depth - $refNode$$8_referenceNode$$1$$.depth), $parent$$54_refNodeKey$$.children.push($moveNode_nodeToMove$$)), null != $callbacks$$58$$ && null != $callbacks$$58$$.success && 
  ...
  $oj$$75$$.$JsonTreeDataSource$.prototype.$_searchTreeById$ = function $$oj$$75$$$$JsonTreeDataSource$$$$_searchTreeById$$($currChild$$2$$, $parentKey$$14$$) {
    ...
    if (null != $currChild$$2$$.children) {
      for ($i$$468$$ = 0;$i$$468$$ < $currChild$$2$$.children.length && !$result$$79$$;$i$$468$$++) {
        $result$$79$$ = $currChild$$2$$.children[$i$$468$$].id && $currChild$$2$$.children[$i$$468$$].id == $parentKey$$14$$ || $currChild$$2$$.children[$i$$468$$].attr && $currChild$$2$$.children[$i$$468$$].attr.id == $parentKey$$14$$ ? $currChild$$2$$.children[$i$$468$$] : this.$_searchTreeById$($currChild$$2$$.children[$i$$468$$], $parentKey$$14$$);
      }
    }
    return $result$$79$$;
  };
  $oj$$75$$.$JsonTreeDataSource$.prototype.$_updateDepth$ = function $$oj$$75$$$$JsonTreeDataSource$$$$_updateDepth$$($currChild$$3$$, $offset$$29$$) {
    var $i$$469$$;
    ...
    if ($currChild$$3$$.children && 0 != $currChild$$3$$.children.length) {
      for ($i$$469$$ = 0;$i$$469$$ < $currChild$$3$$.children.length;$i$$469$$++) {
        this.$_updateDepth$($currChild$$3$$.children[$i$$469$$], $offset$$29$$);
      }
    }
  };
  $oj$$75$$.$JsonTreeDataSource$.prototype.$_removeFromTree$ = function $$oj$$75$$$$JsonTreeDataSource$$$$_removeFromTree$$($currChild$$4_index$$292$$) {
    var $key$$186_parent$$57$$;
    $currChild$$4_index$$292$$.id ? $key$$186_parent$$57$$ = $currChild$$4_index$$292$$.id : $currChild$$4_index$$292$$.attr && ($key$$186_parent$$57$$ = $currChild$$4_index$$292$$.attr.id);
    ($key$$186_parent$$57$$ = this.$_getParentById$($key$$186_parent$$57$$)) || ($key$$186_parent$$57$$ = this.data);
    $currChild$$4_index$$292$$ = $key$$186_parent$$57$$.children.indexOf($currChild$$4_index$$292$$);
    -1 < $currChild$$4_index$$292$$ && $key$$186_parent$$57$$.children.splice($currChild$$4_index$$292$$, 1);
  };
  ...
  $oj$$75$$.$JsonNodeSet$ = function $$oj$$75$$$$JsonNodeSet$$($startNode$$, $endNode$$, $data$$179$$, $currKey$$1$$) {
  ...
  $oj$$75$$.$JsonNodeSet$.prototype.getData = function $$oj$$75$$$$JsonNodeSet$$$getData$($index$$293$$) {
    $oj$$75$$.$Assert$.assert($index$$293$$ <= this.$m_endNode$ && $index$$293$$ >= this.$m_startNode$);
    $index$$293$$ -= this.$m_startNode$;
    return this.$m_nodes$[$index$$293$$] ? this.$m_nodes$[$index$$293$$].attr : null;
  };
  $oj$$75$$.$Object$.$exportPrototypeSymbol$("JsonNodeSet.prototype.getData", {getData:$oj$$75$$.$JsonNodeSet$.prototype.getData});
  $oj$$75$$.$JsonNodeSet$.prototype.getMetadata = function $$oj$$75$$$$JsonNodeSet$$$getMetadata$($index$$294$$) {
    var $metadata$$16$$ = [];
    $oj$$75$$.$Assert$.assert($index$$294$$ <= this.$m_endNode$ && $index$$294$$ >= this.$m_startNode$);
    $index$$294$$ -= this.$m_startNode$;
    $metadata$$16$$.key = this.$m_nodes$[$index$$294$$].id ? this.$m_nodes$[$index$$294$$].id : this.$m_nodes$[$index$$294$$].attr.id;
    $metadata$$16$$.leaf = this.$m_nodes$[$index$$294$$].$leaf$;
    $metadata$$16$$.depth = this.$m_nodes$[$index$$294$$].depth;
    null == $metadata$$16$$.leaf && ($metadata$$16$$.leaf = this.$m_nodes$[$index$$294$$].children && 0 < this.$m_nodes$[$index$$294$$].children.length ? !1 : !0);
    return $metadata$$16$$;
  };
  $oj$$75$$.$Object$.$exportPrototypeSymbol$("JsonNodeSet.prototype.getMetadata", {getMetadata:$oj$$75$$.$JsonNodeSet$.prototype.getMetadata});
  $oj$$75$$.$JsonNodeSet$.prototype.$_updateDepth$ = function $$oj$$75$$$$JsonNodeSet$$$$_updateDepth$$($currChild$$5$$, $offset$$30$$) {
    var $i$$470$$;
    $offset$$30$$++;
    ...
    if ($currChild$$5$$.children && 0 != $currChild$$5$$.children.length) {
      for ($i$$470$$ = 0;$i$$470$$ < $currChild$$5$$.children.length;$i$$470$$++) {
        this.$_updateDepth$($currChild$$5$$.children[$i$$470$$], $offset$$30$$);
      }
    }
  };
  $oj$$75$$.$JsonNodeSet$.prototype.$getChildNodeSet$ = function $$oj$$75$$$$JsonNodeSet$$$$getChildNodeSet$$($index$$295_key$$187$$) {
    var $results$$14$$, $depth$$28$$, $i$$471$$;
    $oj$$75$$.$Assert$.assert($index$$295_key$$187$$ <= this.$m_endNode$ && $index$$295_key$$187$$ >= this.$m_startNode$);
    $index$$295_key$$187$$ -= this.$m_startNode$;
    $depth$$28$$ = this.$m_nodes$[$index$$295_key$$187$$].depth;
    $results$$14$$ = this.$m_nodes$[$index$$295_key$$187$$].children;
    if (0 == $results$$14$$.length) {
      return null;
    }
    $index$$295_key$$187$$ = this.$m_nodes$[$index$$295_key$$187$$].id ? this.$m_nodes$[$index$$295_key$$187$$].id : this.$m_nodes$[$index$$295_key$$187$$].attr.id;
    for ($i$$471$$ = 0;$i$$471$$ < $results$$14$$.length;$i$$471$$++) {
      this.$_updateDepth$($results$$14$$[$i$$471$$], $depth$$28$$);
    }
    return new $oj$$75$$.$JsonNodeSet$(0, $results$$14$$.length, $results$$14$$, $index$$295_key$$187$$);
  };
