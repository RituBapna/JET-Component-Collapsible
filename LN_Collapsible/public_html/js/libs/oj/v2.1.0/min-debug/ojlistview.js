...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdomscroller"], function($oj$$19$$, $$$$18$$) {
  $oj$$19$$.$DataSourceContentHandler$ = function $$oj$$19$$$$DataSourceContentHandler$$($widget$$5$$, $root$$3$$, $data$$121$$) {
    this.$m_root$ = $root$$3$$;
    this.$m_widget$ = $widget$$5$$;
    this.$m_fetching$ = !1;
    this.$setDataSource$($data$$121$$);
    this.Init();
  };
  ...
  $oj$$19$$.$DataSourceContentHandler$.prototype.$addItem$ = function $$oj$$19$$$$DataSourceContentHandler$$$$addItem$$($parentElement$$5$$, $index$$125$$, $data$$122$$, $metadata$$1$$, $callback$$98$$) {
    var $item$$15$$, $childElements_position$$11$$;
    $item$$15$$ = document.createElement("li");
    $$$$18$$($item$$15$$).uniqueId();
    $childElements_position$$11$$ = $$$$18$$($parentElement$$5$$).children("." + this.$m_widget$.$getItemElementStyleClass$() + ", .oj-listview-empty-text");
    $parentElement$$5$$.insertBefore($item$$15$$, $index$$125$$ === $childElements_position$$11$$.length ? null : $childElements_position$$11$$[$index$$125$$]);
    $childElements_position$$11$$ = $$$$18$$($parentElement$$5$$).children().index($item$$15$$);
    this.$_addOrReplaceItem$($item$$15$$, $childElements_position$$11$$, $parentElement$$5$$, $index$$125$$, $data$$122$$, $metadata$$1$$, $callback$$98$$);
  };
  $oj$$19$$.$DataSourceContentHandler$.prototype.$_handleBeforeReplaceTransitionEnd$ = function $$oj$$19$$$$DataSourceContentHandler$$$$_handleBeforeReplaceTransitionEnd$$($event$$249_item$$16$$) {
    ...
    $ctx$$2$$ = $$$$18$$.data($event$$249_item$$16$$, "ctx");
    $$$$18$$.removeData($event$$249_item$$16$$, "ctx");
    $parentElement$$6$$ = $event$$249_item$$16$$.parentNode;
    $position$$12$$ = $$$$18$$($parentElement$$6$$).children().index($event$$249_item$$16$$);
    this.$_addOrReplaceItem$($event$$249_item$$16$$, $position$$12$$, $parentElement$$6$$, $ctx$$2$$.index, $ctx$$2$$.data, $ctx$$2$$.$metadata$, $ctx$$2$$.$callback$);
  };
  $oj$$19$$.$DataSourceContentHandler$.prototype.$replaceItem$ = function $$oj$$19$$$$DataSourceContentHandler$$$$replaceItem$$($item$$17$$, $index$$126$$, $data$$123$$, $metadata$$2$$, $callback$$99$$) {
    ...
    $$$$18$$.data($item$$17$$, "ctx", {index:$index$$126$$, data:$data$$123$$, $metadata$:$metadata$$2$$, $callback$:$callback$$99$$});
    this.$signalTaskStart$();
  ...
  $oj$$19$$.$DataSourceContentHandler$.prototype.$_addOrReplaceItem$ = function $$oj$$19$$$$DataSourceContentHandler$$$$_addOrReplaceItem$$($item$$18$$, $position$$13$$, $parentElement$$7$$, $context$$76_index$$127$$, $content$$16_data$$124$$, $metadata$$3_renderer_textWrapper$$, $callback$$100$$) {
    void 0 == $callback$$100$$ && ($callback$$100$$ = this.$afterRenderItem$.bind(this));
    $context$$76_index$$127$$ = this.$createContext$($context$$76_index$$127$$, $content$$16_data$$124$$, $metadata$$3_renderer_textWrapper$$, $item$$18$$);
    $metadata$$3_renderer_textWrapper$$ = this.$m_widget$.$_getItemRenderer$();
    null != $metadata$$3_renderer_textWrapper$$ ? ($content$$16_data$$124$$ = $metadata$$3_renderer_textWrapper$$.call(this, $context$$76_index$$127$$), null != $content$$16_data$$124$$ && (null === $content$$16_data$$124$$.parentNode || $content$$16_data$$124$$.parentNode instanceof DocumentFragment ? $item$$18$$.appendChild($content$$16_data$$124$$) : null == $content$$16_data$$124$$.parentNode && $content$$16_data$$124$$.toString && ($metadata$$3_renderer_textWrapper$$ = document.createElement("span"), 
    $metadata$$3_renderer_textWrapper$$.appendChild(document.createTextNode($content$$16_data$$124$$.toString())), $item$$18$$.appendChild($metadata$$3_renderer_textWrapper$$)))) : ($metadata$$3_renderer_textWrapper$$ = document.createElement("span"), $metadata$$3_renderer_textWrapper$$.appendChild(document.createTextNode(null == $content$$16_data$$124$$ ? "" : $content$$16_data$$124$$.toString())), $item$$18$$.appendChild($metadata$$3_renderer_textWrapper$$));
  ...
  $oj$$19$$.$DataSourceContentHandler$.prototype.$createContext$ = function $$oj$$19$$$$DataSourceContentHandler$$$$createContext$$($index$$128$$, $data$$125$$, $metadata$$4$$, $elem$$22$$) {
    var $context$$78$$, $prop$$62$$;
    $context$$78$$ = {};
    $context$$78$$.parentElement = $elem$$22$$;
    $context$$78$$.index = $index$$128$$;
    $context$$78$$.data = $data$$125$$;
  ...
  $oj$$19$$.$TableDataSourceContentHandler$ = function $$oj$$19$$$$TableDataSourceContentHandler$$($widget$$6$$, $root$$4$$, $data$$126$$) {
    $oj$$19$$.$TableDataSourceContentHandler$.$superclass$.constructor.call(this, $widget$$6$$, $root$$4$$, $data$$126$$);
  };
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$setDataSource$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$setDataSource$$($dataSource$$2$$) {
    ...
    if (null != $dataSource$$2$$) {
      this.$_isLoadMoreOnScroll$() && ($self$$114$$ = this, this.$m_domScrollerMaxCountFunc$ = function $this$$m_domScrollerMaxCountFunc$$($result$$47$$) {
        null != $result$$47$$ ? ($self$$114$$.$signalTaskStart$(), $self$$114$$.$_removeLoadingIndicator$(), $self$$114$$.$IsReady$() && $self$$114$$.$signalTaskStart$(), $self$$114$$.$_handleFetchedData$($result$$47$$), $result$$47$$.maxCountLimit ? $self$$114$$.$_handleScrollerMaxRowCount$() : $self$$114$$.$_appendLoadingIndicator$(), $self$$114$$.$signalTaskEnd$(), $self$$114$$.$signalTaskEnd$()) : void 0 === $result$$47$$ && ($self$$114$$.$_removeLoadingIndicator$(), $self$$114$$.$signalTaskEnd$());
        ...
        1 >= $maxScrollTop$$1$$ - $scrollTop$$3$$ && $self$$114$$.$signalTaskStart$();
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$fetchRows$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$fetchRows$$($forceFetch$$1_options$$257_promise$$4$$) {
    var $initFetch$$2$$ = !0, $self$$115$$;
    this.$signalTaskStart$();
    if (this.$IsReady$() && (this.$m_fetching$ = !0, $oj$$19$$.$TableDataSourceContentHandler$.$superclass$.$fetchRows$.call(this, $forceFetch$$1_options$$257_promise$$4$$), $oj$$19$$.$PagingTableDataSource$ && this.$m_dataSource$ instanceof $oj$$19$$.$PagingTableDataSource$ && ($initFetch$$2$$ = !1, this.$signalTaskStart$()), $initFetch$$2$$ || $forceFetch$$1_options$$257_promise$$4$$)) {
      ...
      $forceFetch$$1_options$$257_promise$$4$$.then(function($value$$238$$) {
        null != $self$$115$$.$m_widget$ && $initFetch$$2$$ && ($$$$18$$($self$$115$$.$m_root$).empty(), $self$$115$$.$_handleFetchedData$($value$$238$$), $self$$115$$.$_isLoadMoreOnScroll$() && $self$$115$$.$_appendLoadingIndicator$());
      }, function($reason$$5$$) {
        $self$$115$$.$_handleFetchError$($reason$$5$$);
        $self$$115$$.$signalTaskEnd$();
      });
      this.$signalTaskEnd$();
      return;
    }
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$_handleFetchSuccess$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$_handleFetchSuccess$$($data$$127$$, $keys$$26$$) {
    var $index$$129$$, $i$$272$$, $row$$29$$;
    $index$$129$$ = this.$m_root$.childElementCount;
    for ($i$$272$$ = 0;$i$$272$$ < $data$$127$$.length;$i$$272$$++) {
      $row$$29$$ = $data$$127$$[$i$$272$$], this.$addItem$(this.$m_root$, $index$$129$$, $row$$29$$, this.getMetadata($index$$129$$, $keys$$26$$[$i$$272$$], $row$$29$$)), $index$$129$$ += 1;
    }
  };
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$handleModelAddEvent$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$handleModelAddEvent$$($event$$250_indexes$$6$$) {
    var $data$$128$$, $keys$$27$$, $i$$273$$;
    if (null != this.$m_root$) {
      this.$signalTaskStart$();
      $data$$128$$ = $event$$250_indexes$$6$$.data;
      $keys$$27$$ = $event$$250_indexes$$6$$.keys;
      $event$$250_indexes$$6$$ = $event$$250_indexes$$6$$.indexes;
      if (null != $data$$128$$ && null != $keys$$27$$ && 0 < $keys$$27$$.length && 0 < $data$$128$$.length && $keys$$27$$.length == $data$$128$$.length && null != $event$$250_indexes$$6$$ && $keys$$27$$.length == $event$$250_indexes$$6$$.length) {
        for ($i$$273$$ = 0;$i$$273$$ < $data$$128$$.length;$i$$273$$++) {
          this.$signalTaskStart$(), this.$addItem$(this.$m_root$, $event$$250_indexes$$6$$[$i$$273$$], $data$$128$$[$i$$273$$], this.getMetadata($event$$250_indexes$$6$$[$i$$273$$], $keys$$27$$[$i$$273$$], $data$$128$$[$i$$273$$]), this.$afterRenderItemForInsertEvent$.bind(this)), this.$signalTaskEnd$();
        }
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$_handleAddTransitionEnd$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$_handleAddTransitionEnd$$($elem$$24_event$$251$$) {
    var $context$$83$$;
    $elem$$24_event$$251$$ = $elem$$24_event$$251$$.target;
    $context$$83$$ = $$$$18$$.data($elem$$24_event$$251$$, "ctx");
    $$$$18$$.removeData($elem$$24_event$$251$$, "ctx");
    $$$$18$$($elem$$24_event$$251$$).removeClass("oj-listview-item-add-remove-transition").addClass(this.$m_widget$.$getItemStyleClass$()).off("transitionend", this.$m_addTransitionEndListener$).children().children().unwrap();
    this.$m_widget$.$itemInsertComplete$($elem$$24_event$$251$$, $context$$83$$);
    this.$signalTaskEnd$();
  };
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$handleModelRemoveEvent$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$handleModelRemoveEvent$$($event$$252_keys$$28$$) {
    ...
    if (null != this.$m_root$ && null != $event$$252_keys$$28$$ && 0 != $event$$252_keys$$28$$.length) {
      ...
      for ($i$$274$$ = 0;$i$$274$$ < $event$$252_keys$$28$$.length;$i$$274$$++) {
        $elem$$25$$ = this.$FindElementByKey$($event$$252_keys$$28$$[$i$$274$$]), null != $elem$$25$$ && (this.$signalTaskStart$(), this.$_removeItem$($elem$$25$$), this.$signalTaskEnd$());
      }
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$_removeItem$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$_removeItem$$($elem$$26$$) {
    var $itemStyleClass$$2$$, $self$$116$$ = this;
    this.$signalTaskStart$();
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$handleModelChangeEvent$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$handleModelChangeEvent$$($event$$254_indexes$$7$$) {
    var $keys$$29$$, $data$$129$$, $i$$275$$, $elem$$28$$;
    $keys$$29$$ = $event$$254_indexes$$7$$.keys;
    if (null != this.$m_root$ && null != $keys$$29$$ && 0 != $keys$$29$$.length) {
      this.$signalTaskStart$();
      $data$$129$$ = $event$$254_indexes$$7$$.data;
      $event$$254_indexes$$7$$ = $event$$254_indexes$$7$$.indexes;
      for ($i$$275$$ = 0;$i$$275$$ < $keys$$29$$.length;$i$$275$$++) {
        $elem$$28$$ = this.$FindElementByKey$($keys$$29$$[$i$$275$$]), null != $elem$$28$$ && (this.$signalTaskStart$(), this.$replaceItem$($elem$$28$$, $event$$254_indexes$$7$$[$i$$275$$], $data$$129$$[$i$$275$$], this.getMetadata($event$$254_indexes$$7$$[$i$$275$$], $keys$$29$$[$i$$275$$], $data$$129$$[$i$$275$$]), this.$afterRenderItemForChangeEvent$.bind(this)), this.$signalTaskEnd$());
      }
      this.$m_widget$.$ClearCache$();
      this.$signalTaskEnd$();
    }
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$_handleAfterReplaceTransitionEnd$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$_handleAfterReplaceTransitionEnd$$($event$$255$$) {
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$_handleFetchedData$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$_handleFetchedData$$($dataObj_keys$$30$$) {
    var $data$$130$$;
    null != this.$m_root$ && ($data$$130$$ = $dataObj_keys$$30$$.data, $dataObj_keys$$30$$ = $dataObj_keys$$30$$.keys, Array.isArray($data$$130$$) && Array.isArray($dataObj_keys$$30$$) && $data$$130$$.length == $dataObj_keys$$30$$.length && (this.$_handleFetchSuccess$($data$$130$$, $dataObj_keys$$30$$), this.$fetchEnd$()));
  };
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$handleModelSyncEvent$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$handleModelSyncEvent$$($event$$257$$) {
    null != this.$m_root$ && (this.$signalTaskStart$(), 0 === $event$$257$$.startIndex && $$$$18$$(this.$m_root$).empty(), this.$m_widget$.$ClearCache$(), this.$_handleFetchedData$($event$$257$$), this.$signalTaskEnd$());
  };
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.checkViewport = function $$oj$$19$$$$TableDataSourceContentHandler$$$checkViewport$() {
    var $self$$118$$ = this, $fetchPromise$$1$$;
    this.$signalTaskStart$();
    null != this.$m_domScroller$ && 0 < this.$m_dataSource$.totalSize() && this.$IsReady$() && ($fetchPromise$$1$$ = this.$m_domScroller$.checkViewport(), null != $fetchPromise$$1$$ && (this.$signalTaskStart$(), $fetchPromise$$1$$.then(function($result$$48$$) {
      $self$$118$$.$m_domScrollerMaxCountFunc$($result$$48$$);
      $self$$118$$.$signalTaskEnd$();
    }, null)));
    this.$signalTaskEnd$();
  };
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.getMetadata = function $$oj$$19$$$$TableDataSourceContentHandler$$$getMetadata$($index$$130$$, $key$$84$$, $context$$85_data$$131$$) {
    $context$$85_data$$131$$ = $context$$85_data$$131$$.context;
    null == $context$$85_data$$131$$ && ($context$$85_data$$131$$ = {});
    null == $context$$85_data$$131$$.index && ($context$$85_data$$131$$.index = $index$$130$$);
    null == $context$$85_data$$131$$.key && ($context$$85_data$$131$$.key = $key$$84$$);
    return $context$$85_data$$131$$;
  };
  $oj$$19$$.$TreeDataSourceContentHandler$ = function $$oj$$19$$$$TreeDataSourceContentHandler$$($widget$$7$$, $root$$5$$, $data$$132$$) {
    $oj$$19$$.$TreeDataSourceContentHandler$.$superclass$.constructor.call(this, $widget$$7$$, $root$$5$$, $data$$132$$);
  };
  ...
  $oj$$19$$.$TreeDataSourceContentHandler$.prototype.$_handleFetchSuccess$ = function $$oj$$19$$$$TreeDataSourceContentHandler$$$$_handleFetchSuccess$$($nodeSet$$1$$, $parent$$16_start$$38$$, $parentElem$$1$$, $successCallback$$26$$) {
    var $count$$36$$, $i$$276$$, $data$$133$$, $metadata$$5$$;
    this.$signalTaskStart$();
    $parent$$16_start$$38$$ = $nodeSet$$1$$.$getStart$();
    $count$$36$$ = $nodeSet$$1$$.$getCount$();
    for ($i$$276$$ = 0;$i$$276$$ < $count$$36$$;$i$$276$$++) {
      $data$$133$$ = $nodeSet$$1$$.getData($parent$$16_start$$38$$ + $i$$276$$), $metadata$$5$$ = $nodeSet$$1$$.getMetadata($parent$$16_start$$38$$ + $i$$276$$), this.$addItem$($parentElem$$1$$, $parent$$16_start$$38$$ + $i$$276$$, $data$$133$$, $metadata$$5$$);
    }
    this.$m_fetching$ = !1;
  ...
  $oj$$19$$.$_ojListView$ = function($SuperClass$$1$$, $methods$$2$$) {
    ...
    this.$ojContext$._on(this.element, {click:function($event$$259$$) {
      $self$$119$$.$HandleMouseClick$($event$$259$$);
    }, touchstart:function($event$$260$$) {
      $self$$119$$.$HandleMouseDownOrTouchStart$($event$$260$$);
    }, touchend:function($event$$261$$) {
      $self$$119$$.$HandleTouchEndOrCancel$($event$$261$$);
    }, touchcancel:function($event$$262$$) {
      $self$$119$$.$HandleTouchEndOrCancel$($event$$262$$);
    }, mousedown:function($event$$263$$) {
      0 !== $event$$263$$.button || $self$$119$$.$_recentTouch$() || $self$$119$$.$HandleMouseDownOrTouchStart$($event$$263$$);
    }, mouseup:function($event$$264$$) {
      $self$$119$$.$_handleMouseUpOrPanMove$($event$$264$$);
      $self$$119$$.$m_preActive$ = !1;
    }, mouseout:function($event$$265$$) {
      $self$$119$$.$_handleMouseOut$($event$$265$$);
    }, mouseover:function($event$$266$$) {
      $self$$119$$.$_handleMouseOver$($event$$266$$);
    }, keydown:function($event$$267$$) {
      $self$$119$$.$HandleKeyDown$($event$$267$$);
    }, focus:function($event$$268$$) {
      $self$$119$$.$HandleFocus$($event$$268$$);
    }, blur:function($event$$269$$) {
      $self$$119$$.$HandleBlur$($event$$269$$);
    }, ojpanmove:function($event$$270$$) {
      $self$$119$$.$_handleMouseUpOrPanMove$($event$$270$$);
    }});
    $oj$$19$$.$AgentUtils$.$getAgentInfo$().browser === $oj$$19$$.$AgentUtils$.$BROWSER$.$FIREFOX$ && this.$ojContext$._on(this.$_getListContainer$(), {focus:function() {
      $self$$119$$.element.focus();
    }});
    this.$FOCUS_MODE_ITEM$ === this.$FOCUS_MODE_ITEM$ ? this.$ojContext$._on(this.element, {focusin:function($event$$272$$) {
      $self$$119$$.$HandleFocus$($event$$272$$);
    }, focusout:function($event$$273$$) {
      $self$$119$$.$HandleFocusOut$($event$$273$$);
    }}) : this.$ojContext$._on(this.element, {focus:function($event$$274$$) {
      $self$$119$$.$HandleFocus$($event$$274$$);
    }, blur:function($event$$275$$) {
      $self$$119$$.$HandleBlur$($event$$275$$);
    }});
    ...
    this.$m_active$ = null;
    this.$readinessStack$ = [];
    this.$readyPromise$ = new Promise(function($resolve$$29$$) {
      $self$$120$$.$readyResolve$ = $resolve$$29$$;
    });
    this.$ClearCache$();
    ...
    var $self$$121$$, $elem$$33_expanded$$1$$, $selection$$6$$, $i$$279$$;
    ...
    null != $options$$259$$.expanded && this.$m_contentHandler$.$IsHierarchical$() && ($elem$$33_expanded$$1$$ = $options$$259$$.expanded, Array.isArray($elem$$33_expanded$$1$$) && (this.$signalTaskStart$(), this.$_collapseAll$(), $self$$121$$ = this, $$$$18$$.each($elem$$33_expanded$$1$$, function($index$$132$$, $value$$239$$) {
      $self$$121$$.$expandKey$($value$$239$$, !0, !0, !0);
    }), this.$signalTaskEnd$()));
    ...
    return!1;
  }, $Trigger$:function($type$$83$$, $event$$276$$, $ui$$9$$) {
    return this.$ojContext$._trigger($type$$83$$, $event$$276$$, $ui$$9$$);
    ...
    var $self$$122$$ = this;
    this.$readinessStack$ && (0 == this.$readinessStack$.length && (this.$readyPromise$ = new Promise(function($resolve$$30$$) {
      $self$$122$$.$readyResolve$ = $resolve$$30$$;
    ...
    if (null != $data$$134$$) {
      ...
      if ($data$$134$$ instanceof $oj$$19$$.$TableDataSource$) {
        this.$m_contentHandler$ = new $oj$$19$$.$TableDataSourceContentHandler$(this, this.element[0], $data$$134$$);
      } else {
        if ($data$$134$$ instanceof $oj$$19$$.$TreeDataSource$) {
          this.$m_contentHandler$ = new $oj$$19$$.$TreeDataSourceContentHandler$(this, this.element[0], $data$$134$$);
        } else {
          throw "Invalid data";
        }
      }
    ...
    this.$m_status$.text($msg$$23$$).css("left", this.element.outerWidth() / 2 - this.$m_status$.outerWidth() / 2).show();
  ...
  }, $_getItemOption$:function($name$$109_value$$241$$, $context$$93$$, $resolve$$31$$) {
    $name$$109_value$$241$$ = this.options.item[$name$$109_value$$241$$];
    return "function" == typeof $name$$109_value$$241$$ && $resolve$$31$$ ? $name$$109_value$$241$$.call(this, $context$$93$$) : $name$$109_value$$241$$;
    ...
    var $clone$$2_selection$$7$$, $selectedItems$$2$$, $expanded$$3_i$$280_index$$133$$, $self$$124$$;
    ...
    this.$m_contentHandler$.$IsHierarchical$() && this.$GetState$($$$$18$$($elem$$37$$)) == this.$STATE_COLLAPSED$ && ($expanded$$3_i$$280_index$$133$$ = this.$GetOption$("expanded"), this.$_isExpandAll$() ? this.$ExpandItem$($$$$18$$($elem$$37$$), null, !1, null, !1, !1, !1) : Array.isArray($expanded$$3_i$$280_index$$133$$) && ($self$$124$$ = this, $$$$18$$.each($expanded$$3_i$$280_index$$133$$, function($index$$134$$, $value$$242$$) {
      $value$$242$$ == $context$$95$$.key && $self$$124$$.$ExpandItem$($$$$18$$($elem$$37$$), null, !1, null, !1, !1, !1);
    })));
  ...
  }, $notifyContextMenuGesture$:function($menu$$6_openOptions$$4_parent$$18$$, $event$$277$$, $eventType$$35$$) {
    if (this.$IsNodeEditableOrClickable$($$$$18$$($event$$277$$.target))) {
      return!1;
    }
    $menu$$6_openOptions$$4_parent$$18$$ = $$$$18$$($event$$277$$.target).closest("." + this.$getItemElementStyleClass$());
    ...
    this.$ojContext$.$_OpenContextMenu$($event$$277$$, $eventType$$35$$, $menu$$6_openOptions$$4_parent$$18$$);
  ...
  }, $HandleFocus$:function($event$$278$$) {
    this.$_getListContainer$().addClass("oj-focus-ancestor");
    null == this.$m_active$ ? this.$_isTouchSupport$() || this.$m_preActive$ || this.$_initFocus$($event$$278$$) : this.$m_preActive$ || this.$HighlightActive$();
  }, $_initFocus$:function($event$$279$$) {
    ...
    for ($i$$281$$ = 0;$i$$281$$ < $items$$2$$.length;$i$$281$$++) {
      if ($item$$44$$ = $$$$18$$($items$$2$$[$i$$281$$]), !this.$SkipFocus$($item$$44$$)) {
        this.$_activeAndFocus$($item$$44$$, $event$$279$$);
        break;
      }
    }
  }, $HandleFocusOut$:function($event$$280$$) {
    this.$HandleBlur$($event$$280$$);
  }, $HandleBlur$:function($event$$281$$) {
    null != $event$$281$$.relatedTarget && $$$$18$$.contains(this.element.get(0), $event$$281$$.relatedTarget) || (this.$_getListContainer$().removeClass("oj-focus-ancestor"), this.$UnhighlightActive$());
  }, $_handleMouseOut$:function($event$$282_item$$45$$) {
    $event$$282_item$$45$$ = this.$FindItem$($event$$282_item$$45$$.target);
    null != $event$$282_item$$45$$ && (this.$m_hoverItem$ = null, this.$_unhighlightElem$($event$$282_item$$45$$, "oj-hover"));
  }, $_handleMouseOver$:function($event$$283_item$$46$$) {
    this.$_recentTouch$() || ($event$$283_item$$46$$ = this.$FindItem$($event$$283_item$$46$$.target), null == $event$$283_item$$46$$ || this.$SkipFocus$($event$$283_item$$46$$) || (this.$m_hoverItem$ = $event$$283_item$$46$$, this.$_highlightElem$($event$$283_item$$46$$, "oj-hover")));
  }, $_recentTouch$:function() {
    return 500 > Date.now() - this.$_lastTouch$;
  }, $HandleKeyDown$:function($event$$284$$) {
    var $keyCode$$4$$, $current$$7$$;
    if (this.$isExpandable$() && ($keyCode$$4$$ = $event$$284$$.keyCode, $keyCode$$4$$ === this.$LEFT_KEY$ || $keyCode$$4$$ === this.$RIGHT_KEY$)) {
      if ($current$$7$$ = this.$m_active$.elem, $keyCode$$4$$ === this.$LEFT_KEY$) {
        if (this.$GetState$($current$$7$$) == this.$STATE_EXPANDED$) {
          this.$CollapseItem$($current$$7$$, $event$$284$$, !0, this.$m_active$.key, !0, !0);
          return;
        }
      } else {
        if (this.$GetState$($current$$7$$) == this.$STATE_COLLAPSED$) {
          this.$ExpandItem$($current$$7$$, $event$$284$$, !0, this.$m_active$.key, !0, !0, !0);
          return;
        }
      }
    }
    !0 === this.$HandleSelectionOrActiveKeyDown$($event$$284$$) && $event$$284$$.preventDefault();
  }, $_handleMouseUpOrPanMove$:function() {
    this.$m_preActiveItem$ && this.$_unhighlightElem$(this.$m_preActiveItem$, "oj-focus");
  }, $HandleMouseDownOrTouchStart$:function($event$$286_item$$47$$) {
    this.$m_preActive$ = !0;
    $event$$286_item$$47$$ = this.$_findItem$($$$$18$$($event$$286_item$$47$$.target));
    null == $event$$286_item$$47$$ || 0 == $event$$286_item$$47$$.length || this.$SkipFocus$($event$$286_item$$47$$) || (this.$_getListContainer$().hasClass("oj-focus-ancestor") || this.$_getListContainer$().addClass("oj-focus-ancestor"), this.$m_preActiveItem$ = $event$$286_item$$47$$, this.$_highlightElem$($event$$286_item$$47$$, "oj-focus"));
  }, $HandleTouchEndOrCancel$:function($event$$287$$) {
    null != this.$m_preActiveItem$ && this.$_unhighlightElem$(this.$m_preActiveItem$, "oj-focus");
    this.$_lastTouch$ = Date.now();
    this.$_handleMouseOut$($event$$287$$);
  }, $HandleMouseClick$:function($event$$288$$) {
    var $collapseIconClass_item$$48$$, $expandIconClass$$, $groupItemClass$$, $target$$81$$;
    0 === $event$$288$$.button && ($collapseIconClass_item$$48$$ = this.$getCollapseIconStyleClass$(), $expandIconClass$$ = this.$getExpandIconStyleClass$(), $groupItemClass$$ = this.$getGroupItemStyleClass$(), $target$$81$$ = $$$$18$$($event$$288$$.target), $target$$81$$.hasClass($expandIconClass$$) ? (this.$_collapse$($event$$288$$), $event$$288$$.preventDefault()) : $target$$81$$.hasClass($collapseIconClass_item$$48$$) ? (this.$_expand$($event$$288$$), $event$$288$$.preventDefault()) : (this.$_isActionableMode$() && 
    ...
    this.$_isTouchSupport$() ? this.$_handleTouchSelection$($collapseIconClass_item$$48$$, $event$$288$$) : this.$HandleClickSelection$($collapseIconClass_item$$48$$, $event$$288$$) : this.$HandleClickActive$($collapseIconClass_item$$48$$, $event$$288$$), this.$isExpandable$() && $target$$81$$.closest("." + $groupItemClass$$) && (this.$GetState$($collapseIconClass_item$$48$$) == this.$STATE_COLLAPSED$ ? this.$_expand$($event$$288$$) : this.$GetState$($collapseIconClass_item$$48$$) == this.$STATE_EXPANDED$ && 
    this.$_collapse$($event$$288$$)))));
  }, $_isTouchSupport$:function() {
    return $oj$$19$$.$DomUtils$.$isTouchSupported$();
  }, $_ctrlEquivalent$:function($event$$289$$) {
    return $oj$$19$$.$DomUtils$.$isMetaKeyPressed$($event$$289$$);
    ...
    var $scrollTop$$4_top$$2$$, $height$$23$$, $containerScrollTop$$, $containerHeight$$, $headerTop$$, $headerHeight$$, $offset$$22$$ = 0;
    ...
    null != this.$m_groupItemToPin$ && ($headerTop$$ = parseInt(this.$m_groupItemToPin$.style.top, 10), $headerHeight$$ = $$$$18$$(this.$m_groupItemToPin$).outerHeight(), $scrollTop$$4_top$$2$$ <= $headerTop$$ && $headerTop$$ < $scrollTop$$4_top$$2$$ + $height$$23$$ ? $offset$$22$$ = ($height$$23$$ + $scrollTop$$4_top$$2$$ - $headerTop$$) / 2 : $scrollTop$$4_top$$2$$ >= $headerTop$$ && $scrollTop$$4_top$$2$$ < $headerTop$$ + $headerHeight$$ && ($offset$$22$$ = ($headerTop$$ + $headerHeight$$ - $scrollTop$$4_top$$2$$) / 
    2));
    $scrollTop$$4_top$$2$$ >= $containerScrollTop$$ && $scrollTop$$4_top$$2$$ + $height$$23$$ <= $containerScrollTop$$ + $containerHeight$$ ? 0 < $offset$$22$$ && ($container$$22_elem$$44$$.scrollTop = $containerScrollTop$$ - $offset$$22$$) : ($scrollTop$$4_top$$2$$ = Math.max(0, Math.min($scrollTop$$4_top$$2$$ - $offset$$22$$, Math.abs($scrollTop$$4_top$$2$$ + $height$$23$$ - $containerHeight$$))), $scrollTop$$4_top$$2$$ > $containerScrollTop$$ && ($scrollTop$$4_top$$2$$ += this.$_getListContainerBorderWidth$()), 
    ...
    return this.$m_items$;
  }, $HandleArrowKeys$:function($keyCode$$6_next$$3$$, $isExtend$$, $event$$290$$) {
    ...
    switch($keyCode$$6_next$$3$$) {
      case this.$UP_KEY$:
        ...
        if (0 <= $current$$9_currentIndex$$1$$) {
          ...
          $isExtend$$ ? (this.$_extendSelection$($keyCode$$6_next$$3$$, $event$$290$$), this.$m_isNavigate$ = !1) : (this.$_activeAndFocus$($keyCode$$6_next$$3$$, $event$$290$$), this.$m_isNavigate$ = !0);
        }
        $processed$$1$$ = !0;
        break;
      case this.$DOWN_KEY$:
    ...
    var $childElements$$1$$;
    $childElements$$1$$ = $item$$53$$.children("a, input, select, textarea, button");
    return 1 === $childElements$$1$$.length && 0 === $childElements$$1$$.first().find("a, input, select, textarea, button").length ? $childElements$$1$$.first() : $item$$53$$;
  }, $_setActive$:function($item$$54$$, $event$$291$$) {
    var $elem$$46_key$$92$$, $ui$$11$$, $active_cancelled$$;
    null != $item$$54$$ ? ($elem$$46_key$$92$$ = $item$$54$$[0], $elem$$46_key$$92$$ = this.$GetKey$($elem$$46_key$$92$$), null == this.$m_active$ || $elem$$46_key$$92$$ != this.$m_active$.key ? ($ui$$11$$ = {key:$elem$$46_key$$92$$, item:$item$$54$$}, null != this.$m_active$ && ($ui$$11$$.previousKey = this.$m_active$.key, $ui$$11$$.previousItem = this.$m_active$.elem), $active_cancelled$$ = !this.$Trigger$("beforeCurrentItem", $event$$291$$, $ui$$11$$), $active_cancelled$$ || (this.$m_active$ = 
    $active_cancelled$$ = {key:$elem$$46_key$$92$$, elem:$item$$54$$}, this.$_focusItem$($ui$$11$$.previousItem, $item$$54$$), this.$SetOption$("currentItem", $elem$$46_key$$92$$, {_context:{originalEvent:$event$$291$$, $internalSet$:!0, $extraData$:{item:$item$$54$$}}, changed:!0}))) : $elem$$46_key$$92$$ == this.$m_active$.key && (this.$m_active$ = $active_cancelled$$ = {key:$elem$$46_key$$92$$, elem:$item$$54$$}, this.$_focusItem$(null, $item$$54$$))) : this.$m_active$ = null;
  ...
  }, $HandleClickActive$:function($item$$56$$, $event$$292$$) {
    this.$_activeAndFocus$($item$$56$$, $event$$292$$);
  }, $_activeAndFocus$:function($item$$57$$, $event$$293$$) {
    this.$_scrollToVisible$($item$$57$$[0]);
    this.$UnhighlightActive$();
    this.$_setActive$($item$$57$$, $event$$293$$);
    ...
    var $self$$125$$, $elem$$48$$;
    null != this.$m_keyElemMap$ && ($self$$125$$ = this, $$$$18$$.each(this.$GetOption$("selection"), function($index$$138$$, $value$$243$$) {
      $elem$$48$$ = $self$$125$$.$FindElementByKey$($value$$243$$);
      null != $elem$$48$$ && $self$$125$$.$_unhighlightElem$($elem$$48$$, "oj-selected");
    }));
  ...
  }, $HandleClickSelection$:function($item$$59$$, $event$$294$$) {
    var $ctrlKey$$2$$, $shiftKey$$2$$;
    this.$_scrollToVisible$($item$$59$$[0]);
    $ctrlKey$$2$$ = this.$_ctrlEquivalent$($event$$294$$);
    $shiftKey$$2$$ = $event$$294$$.shiftKey;
    this.$_isMultipleSelection$() ? $ctrlKey$$2$$ || $shiftKey$$2$$ ? !$ctrlKey$$2$$ && $shiftKey$$2$$ ? this.$_extendSelection$($item$$59$$, $event$$294$$) : this.$_augmentSelectionAndFocus$($item$$59$$, $event$$294$$) : this.$SelectAndFocus$($item$$59$$, $event$$294$$) : this.$SelectAndFocus$($item$$59$$, $event$$294$$);
  }, $_handleTouchSelection$:function($item$$60$$, $event$$295$$) {
    this.$_isMultipleSelection$() ? this.$_augmentSelectionAndFocus$($item$$60$$, $event$$295$$) : this.$SelectAndFocus$($item$$60$$, $event$$295$$);
  ...
  }, $SelectAndFocus$:function($item$$61$$, $event$$296$$) {
    this.$_clearSelection$(!1);
    this.$_augmentSelectionAndFocus$($item$$61$$, $event$$296$$, []);
  }, $_extendSelection$:function($item$$62$$, $event$$297$$) {
    var $current$$10$$;
    null != this.$m_active$ && ($current$$10$$ = this.$m_selectionFrontier$, $current$$10$$ != $item$$62$$ && (this.$_unhighlightElem$($item$$62$$, "oj-focus"), this.$_extendSelectionRange$(this.$m_active$.elem, $item$$62$$, $event$$297$$)));
  }, $_extendSelectionRange$:function($from$$1$$, $to$$1$$, $event$$298$$) {
    this.$_clearSelection$(!1);
    this.$m_selectionFrontier$ = $to$$1$$;
    this.$_highlightRange$($from$$1$$, $to$$1$$, $event$$298$$);
    this.$HighlightActive$();
  }, $_highlightRange$:function($start$$39_startIndex$$26_to$$2$$, $end$$12_from$$2_i$$283$$, $event$$299$$) {
    ...
    this.$SetOption$("selection", $selection$$9$$, {_context:{originalEvent:$event$$299$$, $internalSet$:!0, $extraData$:{items:$$$$18$$($selectedItems$$3$$)}}, changed:!0});
  ...
  }, $_augmentSelectionAndFocus$:function($item$$64$$, $event$$300$$, $selection$$10$$) {
    ...
    this.$_setActive$($item$$64$$, $event$$300$$);
    this.$HighlightActive$();
    this.$SetOption$("selection", $selection$$10$$, {_context:{originalEvent:$event$$300$$, $internalSet$:!0, $extraData$:{items:$$$$18$$($key$$95_selectedItems$$4$$)}}, changed:!0});
  }, $ToggleSelection$:function($event$$301$$, $keepCurrentSelection_selectedItems$$5$$, $i$$285_skipIfNotSelected$$) {
    ...
    this.$SetOption$("selection", $selection$$11$$, {_context:{originalEvent:$event$$301$$, $internalSet$:!0, $extraData$:{items:$$$$18$$($keepCurrentSelection_selectedItems$$5$$)}}, changed:!0});
  }, $HandleSelectionOrActiveKeyDown$:function($event$$302$$) {
    var $first$$5_keyCode$$7$$, $ctrlKey$$3_current$$11_last$$, $shiftKey$$3$$, $processed$$2$$ = !1;
    if (null == this.$m_active$) {
      return!1;
    }
    $first$$5_keyCode$$7$$ = $event$$302$$.keyCode;
    $ctrlKey$$3_current$$11_last$$ = this.$m_active$.elem;
    this.$_isActionableMode$() ? $first$$5_keyCode$$7$$ == this.$ESC_KEY$ ? (this.$_setActionableMode$(!1), this.$_disableAllTabbableElements$($ctrlKey$$3_current$$11_last$$), this.$HighlightActive$(!0), $processed$$2$$ = !0) : $first$$5_keyCode$$7$$ === this.$TAB_KEY$ && ($first$$5_keyCode$$7$$ = $ctrlKey$$3_current$$11_last$$.find("[data-first]"), $ctrlKey$$3_current$$11_last$$ = $ctrlKey$$3_current$$11_last$$.find("[data-last]"), $event$$302$$.shiftKey ? 0 < $first$$5_keyCode$$7$$.length && 0 < 
    $ctrlKey$$3_current$$11_last$$.length && $first$$5_keyCode$$7$$ != $ctrlKey$$3_current$$11_last$$ && $event$$302$$.target == $first$$5_keyCode$$7$$[0] && ($ctrlKey$$3_current$$11_last$$[0].focus(), $processed$$2$$ = !0) : 0 < $first$$5_keyCode$$7$$.length && 0 < $ctrlKey$$3_current$$11_last$$.length && $first$$5_keyCode$$7$$ != $ctrlKey$$3_current$$11_last$$ && $event$$302$$.target == $ctrlKey$$3_current$$11_last$$[0] && ($first$$5_keyCode$$7$$[0].focus(), $processed$$2$$ = !0)) : $first$$5_keyCode$$7$$ == 
    this.$F2_KEY$ ? (this.$_enableAllTabbableElements$($ctrlKey$$3_current$$11_last$$), $first$$5_keyCode$$7$$ = $ctrlKey$$3_current$$11_last$$.find("[data-first]"), 0 < $first$$5_keyCode$$7$$.length && ($first$$5_keyCode$$7$$[0].focus(), this.$_setActionableMode$(!0))) : $first$$5_keyCode$$7$$ == this.$SPACE_KEY$ && this.$_isSelectionEnabled$() ? ($ctrlKey$$3_current$$11_last$$ = this.$_ctrlEquivalent$($event$$302$$), ($shiftKey$$3$$ = $event$$302$$.shiftKey) && !$ctrlKey$$3_current$$11_last$$ && 
    null != this.$m_selectionFrontier$ && this.$_isMultipleSelection$() ? this.$_extendSelectionRange$(this.$m_selectionFrontier$, this.$m_active$.elem, $event$$302$$) : this.$ToggleSelection$($event$$302$$, $ctrlKey$$3_current$$11_last$$ && !$shiftKey$$3$$ && this.$_isMultipleSelection$(), !1), $processed$$2$$ = !0) : $first$$5_keyCode$$7$$ == this.$ENTER_KEY$ && this.$_isSelectionEnabled$() ? this.$ToggleSelection$($event$$302$$, !1, !0) : this.$IsArrowKey$($first$$5_keyCode$$7$$) && ($ctrlKey$$3_current$$11_last$$ = 
    this.$_ctrlEquivalent$($event$$302$$), $shiftKey$$3$$ = $event$$302$$.shiftKey, $ctrlKey$$3_current$$11_last$$ || ($processed$$2$$ = this.$HandleArrowKeys$($first$$5_keyCode$$7$$, $shiftKey$$3$$ && this.$_isSelectionEnabled$() && this.$_isMultipleSelection$(), $event$$302$$)));
    return $processed$$2$$;
  ...
  }, $_expand$:function($event$$303$$) {
    var $item$$67$$ = this.$FindItem$($event$$303$$.target);
    null != $item$$67$$ && 0 < $item$$67$$.length && this.$ExpandItem$($item$$67$$, $event$$303$$, !0, null, !0, !0, !0);
  }, $ExpandItem$:function($item$$68$$, $event$$304$$, $animate$$, $cancelled$$1_key$$98$$, $beforeVetoable$$1$$, $fireEvent$$1$$, $fireBeforeEvent$$) {
    var $ui$$13$$;
    if (this.$GetState$($item$$68$$) == this.$STATE_COLLAPSED$) {
      ...
      if ($fireBeforeEvent$$ && ($cancelled$$1_key$$98$$ = !this.$Trigger$("beforeExpand", $event$$304$$, $ui$$13$$)) && $beforeVetoable$$1$$) {
        return;
      }
      this.$signalTaskStart$();
      this.$m_contentHandler$.$Expand$($item$$68$$, function($groupItem$$4$$) {
        this.$_expandSuccess$($groupItem$$4$$, $animate$$, $event$$304$$, $ui$$13$$, $fireEvent$$1$$);
      }.bind(this));
      this.$m_items$ = null;
      null != $event$$304$$ && $event$$304$$.stopPropagation();
      this.$signalTaskEnd$();
    }
  }, $_expandSuccess$:function($groupItem$$5_item$$69$$, $animate$$1_collapseClass$$2$$, $event$$305$$, $ui$$14$$, $fireEvent$$2$$) {
    var $expandClass$$;
    this.$signalTaskStart$();
    ...
    $fireEvent$$2$$ && this.$Trigger$("expand", $event$$305$$, $ui$$14$$);
    this.$signalTaskEnd$();
  ...
  }, $_handleExpandTransitionEnd$:function($event$$306_groupItem$$8$$) {
    $event$$306_groupItem$$8$$ = $$$$18$$($event$$306_groupItem$$8$$.target);
    $event$$306_groupItem$$8$$.off("transitionend", this.$m_expandTransitionEndListener$);
    this.$_isTouchSupport$() || $event$$306_groupItem$$8$$.css("maxHeight", "");
    this.$AnimateExpandComplete$($event$$306_groupItem$$8$$);
    this.$signalTaskEnd$();
  ...
  }, $_collapse$:function($event$$307$$) {
    var $item$$72$$ = this.$FindItem$($event$$307$$.target);
    null != $item$$72$$ && 0 < $item$$72$$.length && this.$CollapseItem$($item$$72$$, $event$$307$$, !0, null, !0, !0);
  }, $CollapseItem$:function($item$$73$$, $event$$308$$, $animate$$3_collapseClass$$3$$, $key$$101_ui$$15$$, $beforeVetoable$$2_expandClass$$1$$, $fireEvent$$3$$) {
    var $cancelled$$2$$;
    this.$GetState$($item$$73$$) == this.$STATE_EXPANDED$ && (null == $key$$101_ui$$15$$ && ($key$$101_ui$$15$$ = this.$GetKey$($item$$73$$[0])), $key$$101_ui$$15$$ = {item:$item$$73$$, key:$key$$101_ui$$15$$}, $cancelled$$2$$ = !this.$Trigger$("beforeCollapse", $event$$308$$, $key$$101_ui$$15$$), $cancelled$$2$$ && $beforeVetoable$$2_expandClass$$1$$ || (this.$signalTaskStart$(), this.$AnimateCollapse$($item$$73$$, $animate$$3_collapseClass$$3$$), this.$SetState$($item$$73$$, this.$STATE_COLLAPSED$), 
    $animate$$3_collapseClass$$3$$ = this.$getCollapseIconStyleClass$(), $beforeVetoable$$2_expandClass$$1$$ = this.$getExpandIconStyleClass$(), $item$$73$$.find("." + $beforeVetoable$$2_expandClass$$1$$).first().removeClass($beforeVetoable$$2_expandClass$$1$$).addClass($animate$$3_collapseClass$$3$$), this.$m_items$ = null, null != $event$$308$$ && $event$$308$$.stopPropagation(), $fireEvent$$3$$ && this.$Trigger$("collapse", $event$$308$$, $key$$101_ui$$15$$), this.$signalTaskEnd$()));
  }, $AnimateCollapse$:function($item$$74$$, $animate$$4$$) {
    var $totalHeight$$1$$ = 0, $groupItem$$10$$, $self$$126$$ = this;
  ...
  }, $_handleCollapseTransitionEnd$:function($event$$309_groupItem$$11$$) {
    $event$$309_groupItem$$11$$ = $$$$18$$($event$$309_groupItem$$11$$.target);
    $event$$309_groupItem$$11$$.off("transitionend", this.$m_collapseTransitionEndListener$);
    this.$AnimateCollapseComplete$($event$$309_groupItem$$11$$);
    this.$signalTaskEnd$();
    ...
    this.$_getItemsCache$().each(function() {
      $self$$127$$.$CollapseItem$($$$$18$$(this), null, !1, null, !1, !1);
    });
    this.$signalTaskEnd$();
  }, getExpanded:function() {
    var $expanded$$7$$, $self$$128$$, $item$$76$$;
    $expanded$$7$$ = [];
    $self$$128$$ = this;
    this.$_getItemsCache$().each(function() {
      $item$$76$$ = $$$$18$$(this);
      $self$$128$$.$GetState$($item$$76$$) == $self$$128$$.$STATE_EXPANDED$ && $expanded$$7$$.push($self$$128$$.$GetKey$($item$$76$$[0]));
    });
    return $expanded$$7$$;
    ...
    this.$_isPinGroupHeader$() && this.$ojContext$._on(this.$_getListContainer$(), {scroll:function() {
      $self$$129$$.$_handlePinGroupHeader$();
    }});
    ...
    var $self$$130$$ = this, $item$$77$$;
    $$$$18$$($groupHeader$$1$$).next().children().each(function() {
      $item$$77$$ = $$$$18$$(this);
      if (!$self$$130$$.$SkipFocus$($item$$77$$)) {
        return $self$$130$$.$SetOption$("currentItem", this.key), !1;
      }
    });
  }});
  ...
  $oj$$19$$.$__registerWidget$("oj.ojListView", $$$$18$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{currentItem:null, data:null, drillMode:"collapsible", expanded:"auto", groupHeaderPosition:"sticky", item:{focusable:!0, renderer:null, selectable:!0}, scrollPolicy:"auto", scrollPolicyOptions:{fetchSize:25, maxCount:500}, selection:[], selectionMode:"none", beforeCurrentItem:null, beforeExpand:null, beforeCollapse:null, collapse:null, expand:null, optionChange:null, ready:null}, _ComponentCreate:function() {
    ...
    this._super();
  }, $_NotifyContextMenuGesture$:function($menu$$7$$, $event$$311$$, $eventType$$36$$) {
    this.$listview$.$notifyContextMenuGesture$($menu$$7$$, $event$$311$$, $eventType$$36$$);
