...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtNBox"], function($oj$$36$$, $$$$33$$, $comp$$9$$, $base$$8$$, $dvt$$5$$) {
  $oj$$36$$.$__registerWidget$("oj.ojNBox", $$$$33$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null}, $_CreateDvtComponent$:function($context$$123$$, $callback$$110$$, $callbackObj$$7$$) {
    ...
    var $keys$$35_type$$90$$ = $event$$425$$ && $event$$425$$.getType ? $event$$425$$.getType() : null;
    if ($keys$$35_type$$90$$ === $dvt$$5$$.DvtSelectionEvent.TYPE) {
      ...
      if ($keys$$35_type$$90$$ === $dvt$$5$$.DvtSetPropertyEvent.TYPE) {
        for (var $keys$$35_type$$90$$ = $event$$425$$.getParamKeys(), $i$$341$$ = 0;$i$$341$$ < $keys$$35_type$$90$$.length;$i$$341$$++) {
          var $key$$143$$ = $keys$$35_type$$90$$[$i$$341$$], $value$$258$$ = $event$$425$$.getParamValue($key$$143$$);
