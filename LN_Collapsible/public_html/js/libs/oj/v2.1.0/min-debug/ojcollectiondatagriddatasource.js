...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$42$$) {
  ...
  $oj$$42$$.$CollectionHeaderSet$.prototype.getMetadata = function $$oj$$42$$$$CollectionHeaderSet$$$getMetadata$($index$$203$$, $level$$31$$) {
    ...
    if (null != this.$m_rowHeader$) {
      ...
      $data$$150_model$$68$$ = this.$m_models$[$index$$203$$ - this.$m_start$];
      return{key:$oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($data$$150_model$$68$$)};
    }
    $data$$150_model$$68$$ = this.getData($index$$203$$, $level$$31$$);
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.keys = function $$oj$$42$$$$CollectionDataGridDataSource$$$keys$($indexes$$11$$) {
    var $rowIndex$$6$$, $columnIndex$$2$$, $rowKey$$30$$, $columnKey$$1$$, $self$$159$$;
    $rowIndex$$6$$ = $indexes$$11$$.row;
    $columnIndex$$2$$ = $indexes$$11$$.column;
    $self$$159$$ = this;
    return new Promise(function($resolve$$42$$) {
      $self$$159$$.$collection$.at($rowIndex$$6$$, {deferred:!0}).then(function($rowModel$$) {
        null == $rowModel$$ ? $resolve$$42$$({row:null, column:null}) : ($rowKey$$30$$ = $oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($rowModel$$), null == $self$$159$$.columns && $self$$159$$.$_setupColumns$($rowModel$$), $columnKey$$1$$ = $self$$159$$.columns[$columnIndex$$2$$], $resolve$$42$$({row:$rowKey$$30$$, column:$columnKey$$1$$}));
      }.bind($self$$159$$));
    });
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$indexes$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$indexes$$($keys$$37$$) {
    var $rowKey$$31$$, $columnKey$$2$$, $columnIndex$$3$$, $self$$160$$;
    $rowKey$$31$$ = $keys$$37$$.row;
    $columnKey$$2$$ = $keys$$37$$.column;
    $self$$160$$ = this;
    return new Promise(function($resolve$$43$$) {
      $self$$160$$.$collection$.indexOf($rowKey$$31$$, {deferred:!0}).then(function($rowIndex$$7$$) {
        -1 === $rowIndex$$7$$ ? $resolve$$43$$({row:-1, column:-1}) : null == $self$$160$$.columns ? $self$$160$$.$collection$.at($rowIndex$$7$$, {deferred:!0}).then(function($model$$74$$) {
          $self$$160$$.$_setupColumns$($model$$74$$);
          $columnIndex$$3$$ = $self$$160$$.columns.indexOf($columnKey$$2$$);
          -1 === $columnIndex$$3$$ && ($rowIndex$$7$$ = -1);
          $resolve$$43$$({row:$rowIndex$$7$$, column:$columnIndex$$3$$});
        }.bind($self$$160$$)) : ($columnIndex$$3$$ = $self$$160$$.columns.indexOf($columnKey$$2$$), -1 === $columnIndex$$3$$ && ($rowIndex$$7$$ = -1), $resolve$$43$$({row:$rowIndex$$7$$, column:$columnIndex$$3$$}));
      }.bind($self$$160$$));
    });
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.sort = function $$oj$$42$$$$CollectionDataGridDataSource$$$sort$($axis$$36_criteria$$2$$, $callbacks$$27$$, $callbackObjects$$13$$) {
    ...
    null == $axis$$36_criteria$$2$$ ? this.$_resetSortOrder$($callbacks$$27$$, $callbackObjects$$13$$) : ($direction$$8$$ = $axis$$36_criteria$$2$$.direction, $key$$146$$ = $axis$$36_criteria$$2$$.key, $axis$$36_criteria$$2$$ = $axis$$36_criteria$$2$$.axis, "column" === $axis$$36_criteria$$2$$ ? (this.$collection$.$IsVirtual$() ? (this.$collection$.comparator = $key$$146$$, this.$collection$.sortDirection = "ascending" === $direction$$8$$ ? 1 : -1) : ("ascending" === $direction$$8$$ && ($comparator$$13$$ = 
    function $$comparator$$13$$$($a$$113$$, $b$$69$$) {
      var $as$$, $bs$$;
      $a$$113$$ = $a$$113$$.get($key$$146$$);
      $b$$69$$ = $b$$69$$.get($key$$146$$);
      $as$$ = isNaN($a$$113$$);
      $bs$$ = isNaN($b$$69$$);
      $a$$113$$ instanceof Date && ($a$$113$$ = $a$$113$$.toISOString(), $as$$ = !0);
      $b$$69$$ instanceof Date && ($b$$69$$ = $b$$69$$.toISOString(), $bs$$ = !0);
      return $as$$ && $bs$$ ? $a$$113$$ < $b$$69$$ ? -1 : $a$$113$$ === $b$$69$$ ? 0 : 1 : $as$$ ? 1 : $bs$$ ? -1 : $a$$113$$ - $b$$69$$;
    }), "descending" === $direction$$8$$ && ($comparator$$13$$ = function $$comparator$$13$$$($a$$114$$, $b$$70$$) {
      var $as$$1$$, $bs$$1$$;
      $a$$114$$ = $a$$114$$.get($key$$146$$);
      $b$$70$$ = $b$$70$$.get($key$$146$$);
      $as$$1$$ = isNaN($a$$114$$);
      $bs$$1$$ = isNaN($b$$70$$);
      $a$$114$$ instanceof Date && ($a$$114$$ = $a$$114$$.toISOString());
      $b$$70$$ instanceof Date && ($b$$70$$ = $b$$70$$.toISOString());
      return $as$$1$$ && $bs$$1$$ ? $a$$114$$ > $b$$70$$ ? -1 : $a$$114$$ === $b$$70$$ ? 0 : 1 : $as$$1$$ ? -1 : $bs$$1$$ ? 1 : $b$$70$$ - $a$$114$$;
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.move = function $$oj$$42$$$$CollectionDataGridDataSource$$$move$($moveKey$$, $atKey$$, $position$$26$$, $callbacks$$29$$, $callbackObjects$$15$$) {
    var $indexPromise$$;
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_handleModelAdded$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_handleModelAdded$$($model$$75$$) {
    var $event$$468$$, $rowKey$$33$$;
    this.$collection$.indexOf($model$$75$$, {deferred:!0}).then(function($index$$206$$) {
      $rowKey$$33$$ = $oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($model$$75$$);
      $event$$468$$ = this.$_getModelEvent$("insert", $rowKey$$33$$, null, $index$$206$$, -1);
      this.handleEvent("change", $event$$468$$);
    }.bind(this));
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_handleModelChanged$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_handleModelChanged$$($model$$77$$) {
    var $event$$470$$, $rowKey$$35$$;
    this.$collection$.indexOf($model$$77$$, {deferred:!0}).then(function($index$$207$$) {
      $rowKey$$35$$ = $oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($model$$77$$);
      $event$$470$$ = this.$_getModelEvent$("update", $rowKey$$35$$, null, $index$$207$$, -1);
      this.handleEvent("change", $event$$470$$);
    }.bind(this));
  };
