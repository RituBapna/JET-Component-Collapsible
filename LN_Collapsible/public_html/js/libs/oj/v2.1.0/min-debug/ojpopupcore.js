...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "jqueryui-amd/position"], function($oj$$28$$, $$$$25$$) {
  ...
  $oj$$28$$.$PositionUtils$.$normalizeHorizontalAlignment$ = function $$oj$$28$$$$PositionUtils$$$normalizeHorizontalAlignment$$($position$$16$$, $isRtl$$2$$) {
    for (var $target$$88$$ = $$$$25$$.extend({}, $position$$16$$), $i$$326$$ = 0;$i$$326$$ < $oj$$28$$.$PositionUtils$.$_ALIGN_RULE_PROPERTIES$.length;$i$$326$$++) {
  ...
  $oj$$28$$.$PositionUtils$.$_normalizeEventForPosition$ = function $$oj$$28$$$$PositionUtils$$$_normalizeEventForPosition$$($event$$375$$) {
    $$$$25$$.each(["pageX", "pageY"], function($index$$190$$, $pagePos$$) {
      if ($event$$375$$ && void 0 === $event$$375$$[$pagePos$$] && $event$$375$$.originalEvent) {
        var $firstTouch$$2_originalEvent$$2$$ = $event$$375$$.originalEvent, $touchList_type$$87$$ = $firstTouch$$2_originalEvent$$2$$.type;
        ($touchList_type$$87$$ = "touchstart" === $touchList_type$$87$$ || "touchmove" === $touchList_type$$87$$ ? "touches" : "touchend" === $touchList_type$$87$$ ? "changedTouches" : null) && ($firstTouch$$2_originalEvent$$2$$ = $firstTouch$$2_originalEvent$$2$$[$touchList_type$$87$$][0]) && ($event$$375$$[$pagePos$$] = $firstTouch$$2_originalEvent$$2$$[$pagePos$$]);
      }
    });
  };
  ...
  $$$$25$$.ui.position.flipcenter = {left:function $$$$$25$$$ui$position$flipcenter$left$($position$$17$$, $data$$139$$) {
    var $posLeft$$ = $position$$17$$.left;
    $$$$25$$.ui.position.flip.left.call(this, $position$$17$$, $data$$139$$);
    var $overRight_within$$ = $data$$139$$.within, $dirFactor_withinOffset$$ = $overRight_within$$.isWindow ? $overRight_within$$.scrollLeft : $overRight_within$$.offset.left, $collisionPosLeft$$ = $position$$17$$.left - $data$$139$$.collisionPosition.marginLeft, $overRight_within$$ = $collisionPosLeft$$ + $data$$139$$.collisionWidth - $overRight_within$$.width - $dirFactor_withinOffset$$;
    if (0 < $dirFactor_withinOffset$$ - $collisionPosLeft$$ || 0 < $overRight_within$$) {
      "right" === $data$$139$$.at[0] ? $posLeft$$ -= $data$$139$$.targetWidth / 2 : "left" === $data$$139$$.at[0] && ($posLeft$$ += $data$$139$$.targetWidth / 2), $dirFactor_withinOffset$$ = "rtl" === $oj$$28$$.$DomUtils$.$getReadingDirection$() ? -1 : 1, $posLeft$$ -= $data$$139$$.elemWidth / 2 * $dirFactor_withinOffset$$, $position$$17$$.left = $posLeft$$;
    }
  }, top:function $$$$$25$$$ui$position$flipcenter$top$($position$$18$$, $data$$140$$) {
    var $posTop$$ = $position$$18$$.top;
    $$$$25$$.ui.position.flip.top.call(this, $position$$18$$, $data$$140$$);
    var $within$$1_withinOffset$$1$$ = $data$$140$$.within, $within$$1_withinOffset$$1$$ = $within$$1_withinOffset$$1$$.isWindow ? $within$$1_withinOffset$$1$$.scrollTop : $within$$1_withinOffset$$1$$.offset.top, $collisionPosTop$$ = $position$$18$$.top - $data$$140$$.collisionPosition.marginTop, $overBottom$$ = $collisionPosTop$$ + $data$$140$$.collisionHeight - $data$$140$$.within.height - $within$$1_withinOffset$$1$$;
    if (0 < $within$$1_withinOffset$$1$$ - $collisionPosTop$$ || 0 < $overBottom$$) {
      "top" === $data$$140$$.at[1] ? $posTop$$ += $data$$140$$.targetHeight / 2 : "bottom" === $data$$140$$.at[1] && ($posTop$$ -= $data$$140$$.targetHeight / 2), $posTop$$ += $data$$140$$.elemHeight / 2, $position$$18$$.top = $posTop$$;
    }
  }};
  $$$$25$$.ui.position.flip = {left:function $$$$$25$$$ui$position$flip$left$($position$$19$$, $data$$141$$) {
    var $offsetLeft_within$$2$$ = $data$$141$$.within, $withinOffset$$2$$ = $offsetLeft_within$$2$$.offset.left + $offsetLeft_within$$2$$.scrollLeft, $outerWidth$$1$$ = $offsetLeft_within$$2$$.width, $offsetLeft_within$$2$$ = $offsetLeft_within$$2$$.isWindow ? $offsetLeft_within$$2$$.scrollLeft : $offsetLeft_within$$2$$.offset.left, $collisionPosLeft$$1_overRight$$1$$ = $position$$19$$.left - $data$$141$$.collisionPosition.marginLeft, $overLeft$$1$$ = $collisionPosLeft$$1_overRight$$1$$ - $offsetLeft_within$$2$$, 
    $collisionPosLeft$$1_overRight$$1$$ = $collisionPosLeft$$1_overRight$$1$$ + $data$$141$$.collisionWidth - $outerWidth$$1$$ - $offsetLeft_within$$2$$, $myOffset$$ = "left" === $data$$141$$.my[0] ? -$data$$141$$.elemWidth : "right" === $data$$141$$.my[0] ? $data$$141$$.elemWidth : 0, $atOffset$$ = "left" === $data$$141$$.at[0] ? $data$$141$$.targetWidth : "right" === $data$$141$$.at[0] ? -$data$$141$$.targetWidth : 0, $offset$$23$$ = -2 * $data$$141$$.offset[0], $newOverRight$$, $newOverLeft$$;
    if (0 > $overLeft$$1$$ && Math.abs($newOverRight$$) < Math.abs($newOverLeft$$)) {
      if ($newOverRight$$ = $position$$19$$.left + $myOffset$$ + $atOffset$$ + $offset$$23$$ + $data$$141$$.collisionWidth - $outerWidth$$1$$ - $withinOffset$$2$$, 0 > $newOverRight$$ || $newOverRight$$ < Math.abs($overLeft$$1$$)) {
        $position$$19$$.left += $myOffset$$ + $atOffset$$ + $offset$$23$$;
      }
    } else {
      0 < $collisionPosLeft$$1_overRight$$1$$ && ($newOverLeft$$ = $position$$19$$.left - $data$$141$$.collisionPosition.marginLeft + $myOffset$$ + $atOffset$$ + $offset$$23$$ - $offsetLeft_within$$2$$, 0 < $newOverLeft$$ || Math.abs($newOverLeft$$) < $collisionPosLeft$$1_overRight$$1$$) && ($position$$19$$.left += $myOffset$$ + $atOffset$$ + $offset$$23$$);
    }
  }, top:function $$$$$25$$$ui$position$flip$top$($position$$20$$, $data$$142$$) {
    var $overTop$$1_within$$3$$ = $data$$142$$.within, $newOverBottom_newOverTop_withinOffset$$3$$ = $overTop$$1_within$$3$$.offset.top + $overTop$$1_within$$3$$.scrollTop, $outerHeight$$1$$ = $overTop$$1_within$$3$$.height, $offsetTop$$ = $overTop$$1_within$$3$$.isWindow ? $overTop$$1_within$$3$$.scrollTop : $overTop$$1_within$$3$$.offset.top, $collisionPosTop$$1_overBottom$$1$$ = $position$$20$$.top - $data$$142$$.collisionPosition.marginTop, $overTop$$1_within$$3$$ = $collisionPosTop$$1_overBottom$$1$$ - 
    $offsetTop$$, $collisionPosTop$$1_overBottom$$1$$ = $collisionPosTop$$1_overBottom$$1$$ + $data$$142$$.collisionHeight - $outerHeight$$1$$ - $offsetTop$$, $myOffset$$1$$ = "top" === $data$$142$$.my[1] ? -$data$$142$$.elemHeight : "bottom" === $data$$142$$.my[1] ? $data$$142$$.elemHeight : 0, $atOffset$$1$$ = "top" === $data$$142$$.at[1] ? $data$$142$$.targetHeight : "bottom" === $data$$142$$.at[1] ? -$data$$142$$.targetHeight : 0, $offset$$24$$ = -2 * $data$$142$$.offset[1];
    0 > $overTop$$1_within$$3$$ ? ($newOverBottom_newOverTop_withinOffset$$3$$ = $position$$20$$.top + $myOffset$$1$$ + $atOffset$$1$$ + $offset$$24$$ + $data$$142$$.collisionHeight - $outerHeight$$1$$ - $newOverBottom_newOverTop_withinOffset$$3$$, (0 > $newOverBottom_newOverTop_withinOffset$$3$$ || $newOverBottom_newOverTop_withinOffset$$3$$ < Math.abs($overTop$$1_within$$3$$)) && 0 > $collisionPosTop$$1_overBottom$$1$$ && $overTop$$1_within$$3$$ > $collisionPosTop$$1_overBottom$$1$$ && ($position$$20$$.top += 
    $myOffset$$1$$ + $atOffset$$1$$ + $offset$$24$$)) : 0 < $collisionPosTop$$1_overBottom$$1$$ && ($newOverBottom_newOverTop_withinOffset$$3$$ = $position$$20$$.top - $data$$142$$.collisionPosition.marginTop + $myOffset$$1$$ + $atOffset$$1$$ + $offset$$24$$ - $offsetTop$$, 0 < $newOverBottom_newOverTop_withinOffset$$3$$ || Math.abs($newOverBottom_newOverTop_withinOffset$$3$$) < $collisionPosTop$$1_overBottom$$1$$) && ($position$$20$$.top += $myOffset$$1$$ + $atOffset$$1$$ + $offset$$24$$);
  }};
  ...
  $oj$$28$$.$PopupServiceImpl$.prototype.open = function $$oj$$28$$$$PopupServiceImpl$$$open$($layerLevel_options$$297$$) {
    ...
    var $position$$21$$ = $layerLevel_options$$297$$[$oj$$28$$.$PopupService$.$OPTION$.$POSITION$];
      ...
      if (!$oj$$28$$.$DomUtils$.$isChromeEvent$($event$$380$$) && ("focus" !== $event$$380$$.type || $context$$109_target$$89$$.is(":focusable"))) {
        ...
        if ("keydown" === $event$$380$$.type && $oj$$28$$.$ZOrderUtils$.$hasModalDialogOpen$() && !$oj$$28$$.$DomUtils$.$isAncestor$($defaultLayer$$[0], $context$$109_target$$89$$[0])) {
          ...
          if ("focus" !== $event$$380$$.type || "-1" !== $context$$109_target$$89$$.attr("tabindex")) {
            var $context$$109_target$$89$$ = {}, $props$$16_targetWitinLayer$$ = {}, $key$$138$$;
            for ($key$$138$$ in $event$$380$$) {
              $oj$$28$$.$PopupServiceImpl$.$_COPY_SAFE_EVENT_PROPERTIES$[$key$$138$$] && !$$$$25$$.isFunction($event$$380$$[$key$$138$$]) && ($props$$16_targetWitinLayer$$[$key$$138$$] = $event$$380$$[$key$$138$$]);
            }
  ...
  $oj$$28$$.$ZOrderUtils$.$compareStackingContexts$ = function $$oj$$28$$$$ZOrderUtils$$$compareStackingContexts$$($el1$$1$$, $el2$$1$$) {
    function $describeStackingContext$$($element$$120$$, $allLevels$$) {
      ...
      for (var $stack_tmp$$2$$ = [], $level$$29$$ = 0, $i$$331$$ = 0;$i$$331$$ < $parents$$4$$.length;$i$$331$$++) {
        var $order_parent$$33$$ = $parents$$4$$[$i$$331$$], $position$$22$$ = $order_parent$$33$$.css("position"), $opacity$$1$$ = $oj$$28$$.$DomUtils$.$getCSSLengthAsFloat$($order_parent$$33$$.css("opacity")), $zindex$$ = $oj$$28$$.$DomUtils$.$getCSSLengthAsInt$($order_parent$$33$$.css("z-index")), $order_parent$$33$$ = $$$$25$$.inArray($order_parent$$33$$[0], $order_parent$$33$$.parent().children());
        -1 < $$$$25$$.inArray($position$$22$$, $positions$$) ? $stack_tmp$$2$$.push({weight:[$level$$29$$++, $zindex$$, $order_parent$$33$$], order:[$order_parent$$33$$]}) : 1 > $opacity$$1$$ ? $stack_tmp$$2$$.push({weight:[$level$$29$$++, 1, $order_parent$$33$$], order:[$order_parent$$33$$]}) : $allLevels$$ && $stack_tmp$$2$$.push({weight:[0, 0, $order_parent$$33$$], order:[$order_parent$$33$$]});
      }
      return $stack_tmp$$2$$;
    }
