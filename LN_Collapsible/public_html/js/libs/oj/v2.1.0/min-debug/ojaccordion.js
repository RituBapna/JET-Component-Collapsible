...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojcollapsible"], function($oj$$59$$, $$$$54$$) {
  (function() {
    $oj$$59$$.$__registerWidget$("oj.ojAccordion", $$$$54$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{multiple:!1, expanded:null, beforeExpand:null, expand:null, beforeCollapse:null, collapse:null}, _ComponentCreate:function() {
      ...
      var $result$$64$$, $self$$180$$ = this, $newData$$1$$;
      this.$_findTargetSiblings$($event$$536$$).each(function() {
        var $beforeCollapsedData_collapsible$$ = this.element;
        $newData$$1$$ = $self$$180$$.$_initEventData$($beforeCollapsedData_collapsible$$, $$$$54$$($event$$536$$.target));
        ...
        return $result$$64$$ = this._trigger("beforeCollapse", $event$$536$$, $beforeCollapsedData_collapsible$$);
      });
      $newData$$1$$ || ($newData$$1$$ = $self$$180$$.$_initEventData$(null, $$$$54$$($event$$536$$.target)));
      ...
      if (this.$_isTargetMyCollapsible$($event$$537$$) && !this.$_duringSetExpandedOption$) {
        var $newData$$2$$, $self$$181$$ = this;
        this.$_findTargetSiblings$($event$$537$$).each(function() {
          this.collapse(!1, $event$$537$$, $eventData$$16$$);
          $newData$$2$$ = $self$$181$$.$_initEventData$(this.element, $$$$54$$($event$$537$$.target));
        });
        $newData$$2$$ || ($newData$$2$$ = $self$$181$$.$_initEventData$(null, $$$$54$$($event$$537$$.target)));
      ...
      this.$collapsibles$.each(function($index$$252$$) {
        $$$$54$$(this).ojCollapsible("option", "expanded") && ($cid$$8$$ = $$$$54$$(this).attr("id"), $result$$65$$.push($cid$$8$$ ? $cid$$8$$ : $index$$252$$));
      });
      $oj$$59$$.$Object$.$_compareSet$(this.options.expanded, $result$$65$$) || this.option("expanded", $result$$65$$, {_context:{$internalSet$:!0, $writeback$:!0}});
    }, $_expandedIndexToId$:function($expanded$$11$$) {
      if (Array.isArray($expanded$$11$$)) {
        var $id$$54$$, $newExp$$ = [];
        this.element.children().each(function($index$$253$$) {
          ($id$$54$$ = $$$$54$$(this).attr("id")) ? -1 != $expanded$$11$$.indexOf($id$$54$$) ? $newExp$$.push($id$$54$$) : -1 != $expanded$$11$$.indexOf($index$$253$$) && $newExp$$.push($id$$54$$) : -1 != $expanded$$11$$.indexOf($index$$253$$) && $newExp$$.push($index$$253$$);
        });
      ...
      if ($expanded$$12$$) {
        var $self$$182$$ = this, $child$$11$$, $childId$$, $parentExp$$, $iexp$$ = 0;
        this.$collapsibles$.each(function($index$$254$$) {
          $child$$11$$ = $$$$54$$(this);
          $childId$$ = $child$$11$$.attr("id");
          $parentExp$$ = !1;
          $childId$$ ? $childId$$ == $expanded$$12$$[$iexp$$] && ($parentExp$$ = !0) : $index$$254$$ == $expanded$$12$$[$iexp$$] && ($parentExp$$ = !0);
          $parentExp$$ && $iexp$$++;
          $child$$11$$.ojCollapsible("option", "expanded") !== $parentExp$$ && ($oj$$59$$.$Logger$.warn("JET Accordion: override collapsible " + $index$$254$$ + " expanded setting"), $self$$182$$.$_duringSetExpandedOption$ = !0, $child$$11$$.ojCollapsible("option", "expanded", $parentExp$$), $self$$182$$.$_duringSetExpandedOption$ = !1);
        });
      }
      this.$_updateExpanded$();
    }, getNodeBySubId:function($collapsible$$2_index$$255_locator$$58$$) {
      if (null == $collapsible$$2_index$$255_locator$$58$$) {
        return this.element ? this.element[0] : null;
      }
      var $subId$$62$$ = $collapsible$$2_index$$255_locator$$58$$.subId;
      $collapsible$$2_index$$255_locator$$58$$ = $collapsible$$2_index$$255_locator$$58$$.index;
      if ("number" !== typeof $collapsible$$2_index$$255_locator$$58$$ || 0 > $collapsible$$2_index$$255_locator$$58$$ || $collapsible$$2_index$$255_locator$$58$$ >= this.$collapsibles$.length) {
        return null;
      }
      $collapsible$$2_index$$255_locator$$58$$ = this.$collapsibles$[$collapsible$$2_index$$255_locator$$58$$];
      switch($subId$$62$$) {
        ...
        case "oj-accordion-collapsible":
          return $collapsible$$2_index$$255_locator$$58$$;
        default:
          return null;
      }
      return $$$$54$$($collapsible$$2_index$$255_locator$$58$$).ojCollapsible("getNodeBySubId", {subId:$subId$$62$$});
    }, getSubIdByNode:function($collapsibleSubId_node$$110$$) {
      for (var $collapsibleIndex$$ = -1, $currentNode$$3_subId$$63$$ = $collapsibleSubId_node$$110$$;$currentNode$$3_subId$$63$$;) {
      ...
      if (-1 != $collapsibleIndex$$) {
        switch($collapsibleSubId_node$$110$$ = ($collapsibleSubId_node$$110$$ = $$$$54$$(this.$collapsibles$[$collapsibleIndex$$]).ojCollapsible("getSubIdByNode", $collapsibleSubId_node$$110$$)) ? $collapsibleSubId_node$$110$$ : {}, $collapsibleSubId_node$$110$$.subId) {
