...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtTimeline"], function($oj$$30$$, $$$$27$$, $comp$$7$$, $base$$6$$, $dvt$$3$$) {
  $oj$$30$$.$__registerWidget$("oj.ojTimeline", $$$$27$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{viewportChange:null}, $_CreateDvtComponent$:function($context$$120$$, $callback$$108$$, $callbackObj$$5$$) {
    ...
    var $type$$88_viewportStart$$ = $event$$385_minorAxisScale$$ && $event$$385_minorAxisScale$$.getType ? $event$$385_minorAxisScale$$.getType() : null;
    if ($type$$88_viewportStart$$ === $dvt$$3$$.DvtSelectionEvent.TYPE) {
      ...
      if ($type$$88_viewportStart$$ === $dvt$$3$$.DvtTimelineViewportChangeEvent.TYPE) {
        var $type$$88_viewportStart$$ = (new Date($event$$385_minorAxisScale$$.getViewportStart())).toISOString(), $viewportEnd$$ = (new Date($event$$385_minorAxisScale$$.getViewportEnd())).toISOString();
        $event$$385_minorAxisScale$$ = $event$$385_minorAxisScale$$.getMinorAxisScale();
        var $viewportChangePayload$$ = {viewportStart:$type$$88_viewportStart$$, viewportEnd:$viewportEnd$$, minorAxisScale:$event$$385_minorAxisScale$$};
