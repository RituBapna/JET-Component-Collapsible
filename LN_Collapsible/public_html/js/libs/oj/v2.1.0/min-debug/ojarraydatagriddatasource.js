...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$57$$) {
  $oj$$57$$.$ArrayDataGridDataSource$ = function $$oj$$57$$$$ArrayDataGridDataSource$$($data$$154$$, $options$$327$$) {
    if (!($data$$154$$ instanceof Array) && "function" != typeof $data$$154$$ && "function" != typeof $data$$154$$.$subscribe$) {
    ...
    $oj$$57$$.$ArrayDataGridDataSource$.$superclass$.constructor.call(this, $data$$154$$);
  };
  ...
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.$_initializeRowKeys$ = function $$oj$$57$$$$ArrayDataGridDataSource$$$$_initializeRowKeys$$() {
    var $data$$155$$;
    $data$$155$$ = this.$getDataArray$();
    for (this.$lastKey$ = 0;this.$lastKey$ < $data$$155$$.length;this.$lastKey$ += 1) {
      $data$$155$$[this.$lastKey$].ojKey = this.$lastKey$.toString();
    }
  };
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.$_getColumnsForScaffolding$ = function $$oj$$57$$$$ArrayDataGridDataSource$$$$_getColumnsForScaffolding$$($data$$156$$) {
    var $propertyName$$8$$, $columns$$23$$;
    if ("number" !== typeof $data$$156$$.length || 0 === $data$$156$$.length) {
      return[];
    }
    $columns$$23$$ = [];
    for ($propertyName$$8$$ in $data$$156$$[0]) {
      $data$$156$$[0].hasOwnProperty($propertyName$$8$$) && (void 0 != this.$rowHeaderKey$ && $propertyName$$8$$ == this.$rowHeaderKey$ || $columns$$23$$.push($propertyName$$8$$));
    }
    return $columns$$23$$;
  };
  ...
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.$_getHeaderData$ = function $$oj$$57$$$$ArrayDataGridDataSource$$$$_getHeaderData$$($axis$$39$$, $index$$245$$) {
    var $data$$157$$;
    if ("row" === $axis$$39$$) {
      ...
      if ("m_defaultIndex" == this.$rowHeaderKey$) {
        return this.$_getRowKeyByIndex$($index$$245$$);
      }
      $data$$157$$ = this.$getDataArray$();
      return $data$$157$$[$index$$245$$][this.$rowHeaderKey$];
    }
    if ("column" === $axis$$39$$) {
      return this.columns[$index$$245$$];
    }
  };
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.$_getHeaderMetadata$ = function $$oj$$57$$$$ArrayDataGridDataSource$$$$_getHeaderMetadata$$($axis$$40$$, $index$$246$$) {
    var $key$$156$$;
    if ("row" === $axis$$40$$) {
      return{key:this.$_getRowKeyByIndex$($index$$246$$)};
    }
    if ("column" === $axis$$40$$) {
      return $key$$156$$ = this.$_getHeaderData$($axis$$40$$, $index$$246$$), null != this.$_sortInfo$ && this.$_sortInfo$.key === $key$$156$$ ? {key:this.$_getHeaderData$($axis$$40$$, $index$$246$$), sortDirection:this.$_sortInfo$.direction} : {key:$key$$156$$};
    }
  };
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.$fetchHeaders$ = function $$oj$$57$$$$ArrayDataGridDataSource$$$$fetchHeaders$$($headerRange$$5$$, $callbacks$$30$$, $callbackObjects$$16$$) {
    var $axis$$41_headerSet$$1$$, $start$$51$$, $count$$52_end$$17$$, $data$$158$$;
    ...
    "column" === $axis$$41_headerSet$$1$$ ? $count$$52_end$$17$$ = Math.min(this.columns.length, $start$$51$$ + $count$$52_end$$17$$) : ($data$$158$$ = this.$getDataArray$(), $count$$52_end$$17$$ = void 0 === this.$rowHeaderKey$ ? $start$$51$$ : Math.min($data$$158$$.length, $start$$51$$ + $count$$52_end$$17$$));
  ...
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.keys = function $$oj$$57$$$$ArrayDataGridDataSource$$$keys$($indexes$$12$$) {
    ...
    return new Promise(function($resolve$$45$$) {
      $resolve$$45$$({row:this.$_getRowKeyByIndex$($rowIndex$$9$$), column:this.columns[$columnIndex$$5$$]});
    }.bind(this));
  };
  ...
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.$indexes$ = function $$oj$$57$$$$ArrayDataGridDataSource$$$$indexes$$($keys$$39$$) {
    ...
    return new Promise(function($resolve$$46$$) {
      $resolve$$46$$({row:this.$_getRowIndexByKey$($rowKey$$36$$), column:this.columns.indexOf($columnKey$$4$$)});
    }.bind(this));
  };
  ...
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.$_naturalSort$ = function $$oj$$57$$$$ArrayDataGridDataSource$$$$_naturalSort$$($direction$$12$$, $key$$157$$) {
    if ("ascending" === $direction$$12$$) {
      return function($a$$115$$, $b$$71$$) {
        var $as$$2$$, $bs$$2$$;
        void 0 != $key$$157$$ && ($a$$115$$ instanceof Array ? ($a$$115$$ = $a$$115$$[parseInt($key$$157$$, 10)], $b$$71$$ = $b$$71$$[parseInt($key$$157$$, 10)]) : ($a$$115$$ = $a$$115$$[$key$$157$$], $b$$71$$ = $b$$71$$[$key$$157$$]));
        $as$$2$$ = isNaN($a$$115$$);
        $bs$$2$$ = isNaN($b$$71$$);
        $a$$115$$ instanceof Date && ($a$$115$$ = $a$$115$$.toISOString(), $as$$2$$ = !0);
        $b$$71$$ instanceof Date && ($b$$71$$ = $b$$71$$.toISOString(), $bs$$2$$ = !0);
        return $as$$2$$ && $bs$$2$$ ? $a$$115$$ < $b$$71$$ ? -1 : $a$$115$$ === $b$$71$$ ? 0 : 1 : $as$$2$$ ? 1 : $bs$$2$$ ? -1 : $a$$115$$ - $b$$71$$;
      };
    }
    if ("descending" === $direction$$12$$) {
      return function($a$$116$$, $b$$72$$) {
        var $as$$3$$, $bs$$3$$;
        void 0 != $key$$157$$ && ($a$$116$$ instanceof Array ? ($a$$116$$ = $a$$116$$[parseInt($key$$157$$, 10)], $b$$72$$ = $b$$72$$[parseInt($key$$157$$, 10)]) : ($a$$116$$ = $a$$116$$[$key$$157$$], $b$$72$$ = $b$$72$$[$key$$157$$]));
        $as$$3$$ = isNaN($a$$116$$);
        $bs$$3$$ = isNaN($b$$72$$);
        $a$$116$$ instanceof Date && ($a$$116$$ = $a$$116$$.toISOString(), $as$$3$$ = !0);
        $b$$72$$ instanceof Date && ($b$$72$$ = $b$$72$$.toISOString(), $bs$$3$$ = !0);
        return $as$$3$$ && $bs$$3$$ ? $a$$116$$ > $b$$72$$ ? -1 : $a$$116$$ === $b$$72$$ ? 0 : 1 : $as$$3$$ ? -1 : $bs$$3$$ ? 1 : $b$$72$$ - $a$$116$$;
      };
    }
  };
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.move = function $$oj$$57$$$$ArrayDataGridDataSource$$$move$($moveKey$$1$$, $atKey$$1$$) {
    ...
    null === $atKey$$1$$ ? (this.data.push($moveData$$), $atKeyIndex_event$$530_moveKeyIndex$$ = this.data.length) : ($atKeyIndex_event$$530_moveKeyIndex$$ = this.$_getRowIndexByKey$($atKey$$1$$), this.data.splice($atKeyIndex_event$$530_moveKeyIndex$$, 0, $moveData$$));
  ...
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.$_getRowIndexByKey$ = function $$oj$$57$$$$ArrayDataGridDataSource$$$$_getRowIndexByKey$$($key$$158$$) {
    var $i$$377$$, $data$$160$$ = this.$getDataArray$();
    for ($i$$377$$ = 0;$i$$377$$ < $data$$160$$.length;$i$$377$$++) {
      if ($data$$160$$[$i$$377$$].ojKey === $key$$158$$) {
        return $i$$377$$;
      }
    }
    return-1;
  };
  $oj$$57$$.$ArrayDataGridDataSource$.prototype.$_getRowKeyByIndex$ = function $$oj$$57$$$$ArrayDataGridDataSource$$$$_getRowKeyByIndex$$($index$$247$$) {
    var $data$$161$$ = this.$getDataArray$();
    return $data$$161$$[$index$$247$$] ? $data$$161$$[$index$$247$$].ojKey : null;
  };
  ...
  $oj$$57$$.$ArrayHeaderSet$.prototype.getData = function $$oj$$57$$$$ArrayHeaderSet$$$getData$($index$$248$$, $level$$34$$) {
    ...
    return this.$m_callback$.$_getHeaderData$(this.$m_axis$, $index$$248$$);
  };
  $oj$$57$$.$Object$.$exportPrototypeSymbol$("ArrayHeaderSet.prototype.getData", {getData:$oj$$57$$.$ArrayHeaderSet$.prototype.getData});
  $oj$$57$$.$ArrayHeaderSet$.prototype.getMetadata = function $$oj$$57$$$$ArrayHeaderSet$$$getMetadata$($index$$249$$, $level$$35$$) {
    if (null == this.$m_callback$) {
      return null;
    }
    ...
    return this.$m_callback$.$_getHeaderMetadata$(this.$m_axis$, $index$$249$$);
  };
  ...
  $oj$$57$$.$ArrayHeaderSet$.prototype.$getExtent$ = function $$oj$$57$$$$ArrayHeaderSet$$$$getExtent$$($index$$250$$, $level$$36$$) {
    $oj$$57$$.$Assert$.assert($index$$250$$ <= this.$m_end$ && $index$$250$$ >= this.$m_start$, "index out of bounds");
  ...
  $oj$$57$$.$ArrayHeaderSet$.prototype.$getDepth$ = function $$oj$$57$$$$ArrayHeaderSet$$$$getDepth$$($index$$251$$, $level$$37$$) {
    $oj$$57$$.$Assert$.assert($index$$251$$ <= this.$m_end$ && $index$$251$$ >= this.$m_start$, "index out of bounds");
