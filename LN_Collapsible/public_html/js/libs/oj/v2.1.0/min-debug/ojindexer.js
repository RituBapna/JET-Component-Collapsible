...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$34$$, $$$$31$$, $Hammer$$4$$) {
  (function() {
    $oj$$34$$.$__registerWidget$("oj.ojIndexer", $$$$31$$.oj.baseComponent, {defaultElement:"\x3cul\x3e", version:"1.2", widgetEventPrefix:"oj", options:{data:null}, _ComponentCreate:function() {
      ...
      var $model$$64_prefixOthers$$, $root$$13$$, $last$$4_others_prefixes$$1$$, $availablePrefixes$$, $height$$27_max$$7_skip$$2$$, $first$$7_i$$336_itemHeight$$, $item$$111_prefix$$20$$;
      ...
      if (null != $model$$64_prefixOthers$$) {
        ...
        for ($first$$7_i$$336_itemHeight$$ = 1 + $height$$27_max$$7_skip$$2$$;$first$$7_i$$336_itemHeight$$ < $last$$4_others_prefixes$$1$$.length;$first$$7_i$$336_itemHeight$$ = $first$$7_i$$336_itemHeight$$ + $height$$27_max$$7_skip$$2$$ + 1) {
          1 < $height$$27_max$$7_skip$$2$$ ? ($item$$111_prefix$$20$$ = this.$_createSeparator$($last$$4_others_prefixes$$1$$, $first$$7_i$$336_itemHeight$$ - $height$$27_max$$7_skip$$2$$, $first$$7_i$$336_itemHeight$$ - 1), $root$$13$$.append($item$$111_prefix$$20$$)) : $first$$7_i$$336_itemHeight$$--, $item$$111_prefix$$20$$ = $last$$4_others_prefixes$$1$$[$first$$7_i$$336_itemHeight$$], $item$$111_prefix$$20$$ = this.$_createItem$($item$$111_prefix$$20$$, $availablePrefixes$$), $root$$13$$.append($item$$111_prefix$$20$$)
          ;
        }
      ...
      var $item$$112$$ = $$$$31$$(document.createElement("li"));
      $item$$112$$.attr("data-range", $prefix$$21$$).text($prefix$$21$$);
      null != $availablePrefixes$$1$$ && -1 == $availablePrefixes$$1$$.indexOf($prefix$$21$$) && $item$$112$$.addClass("oj-disabled");
      return $item$$112$$;
    }, $_createSeparator$:function($indexString$$, $from$$3_i$$337$$, $to$$3$$) {
      var $item$$113$$, $includes$$1$$ = "";
      $item$$113$$ = $$$$31$$(document.createElement("li"));
      for ($item$$113$$.addClass("oj-indexer-ellipsis").attr("data-range", $indexString$$[$from$$3_i$$337$$ + Math.round(($to$$3$$ - $from$$3_i$$337$$) / 2)]);$from$$3_i$$337$$ < $to$$3$$;$from$$3_i$$337$$++) {
        $includes$$1$$ = $includes$$1$$ + $indexString$$[$from$$3_i$$337$$] + "|";
      }
      $includes$$1$$ += $indexString$$[$to$$3$$];
      $item$$113$$.attr("data-includes", $includes$$1$$);
      return $item$$113$$;
    }, $_setup$:function() {
      var $self$$151$$ = this, $model$$65$$;
      this.element.uniqueId().addClass("oj-component-initnode").attr("tabIndex", 0);
      this._on(this.element, {click:function($event$$405$$) {
        $self$$151$$.$_handleClick$($event$$405$$);
      }, keydown:function($event$$406$$) {
        $self$$151$$.$_handleKeyDown$($event$$406$$);
      }, focus:function($event$$407$$) {
        $self$$151$$.$_handleFocus$($event$$407$$);
      }, blur:function($event$$408$$) {
        $self$$151$$.$_handleBlur$($event$$408$$);
      }});
    ...
    }, $_setFocus$:function($item$$114$$) {
      null != this.$m_current$ && this.$m_current$.removeClass("oj-focus");
      $item$$114$$.addClass("oj-focus");
      this.$_updateAriaProperties$($item$$114$$);
      this.$m_current$ = $item$$114$$;
      ...
      return $model$$66$$;
    }, $_setCurrent$:function($item$$115$$) {
      var $prefix$$22$$ = $item$$115$$.attr("data-range");
      $item$$115$$.attr("data-others") && ($prefix$$22$$ = $oj$$34$$.$IndexerModel$.PREFIX_OTHERS);
      this.$_setCurrentPrefix$($prefix$$22$$);
    }, $_setCurrentPrefix$:function($prefix$$23$$) {
      var $self$$152$$ = this, $item$$116$$;
      this.$_getIndexerModel$().setPrefix($prefix$$23$$).then(function($val$$51$$) {
        null != $val$$51$$ && ($item$$116$$ = $self$$152$$.$_findItem$($val$$51$$), null != $item$$116$$ && $self$$152$$.$_setFocus$($item$$116$$));
      });
    }, $_updateAriaProperties$:function($item$$117$$) {
      var $includes$$2_val$$52$$, $valueText$$ = "";
      $includes$$2_val$$52$$ = $item$$117$$.attr("data-includes");
      null != $includes$$2_val$$52$$ ? ($includes$$2_val$$52$$ = $includes$$2_val$$52$$.split("|"), 0 < $includes$$2_val$$52$$.length && ($valueText$$ = this.$getTranslatedString$("ariaInBetweenText", {first:$includes$$2_val$$52$$[0], second:$includes$$2_val$$52$$[$includes$$2_val$$52$$.length - 1]}))) : ($includes$$2_val$$52$$ = $item$$117$$.attr("data-range"), $valueText$$ = $includes$$2_val$$52$$ === $oj$$34$$.$IndexerModel$.PREFIX_OTHERS ? this.$getTranslatedString$("ariaOthersLabel") : $includes$$2_val$$52$$);
      $item$$117$$.hasClass("oj-disabled") && ($valueText$$ = $valueText$$ + ". " + this.$getTranslatedString$("ariaDisabledLabel"));
      this.element.attr("aria-valuetext", $valueText$$);
      this.element.attr("aria-valuenow", $item$$117$$.index());
    }, $_findItem$:function($prefix$$24$$) {
      var $children$$10$$, $i$$338$$, $item$$118$$, $value$$257$$, $includes$$3$$;
      $children$$10$$ = this.element.children();
      for ($i$$338$$ = 0;$i$$338$$ < $children$$10$$.length;$i$$338$$++) {
        if ($item$$118$$ = $children$$10$$.get($i$$338$$), $value$$257$$ = $$$$31$$($item$$118$$).attr("data-range"), $includes$$3$$ = $$$$31$$($item$$118$$).attr("data-includes"), null != $value$$257$$ && $value$$257$$ == $prefix$$24$$ || null != $includes$$3$$ && -1 < $includes$$3$$.indexOf($prefix$$24$$)) {
          return $$$$31$$($item$$118$$);
        }
      }
      return null;
      ...
      var $self$$153$$ = this, $options$$306$$, $target$$91$$, $x$$54$$, $y$$38$$, $currentTarget$$, $currentPrefix$$, $currentY$$, $previousY$$, $delta$$5$$, $range$$16$$, $index$$192$$, $prefix$$25$$;
      ...
      $$$$31$$($element$$127$$).$ojHammer$($options$$306$$).on("panstart", function($event$$413$$) {
        ...
        $x$$54$$ = $self$$153$$.element[0].getBoundingClientRect().left + 5;
        $y$$38$$ = $target$$91$$.getBoundingClientRect().top;
        $self$$153$$.$_setCurrent$($$$$31$$($target$$91$$));
  ...
  $oj$$34$$.$ListViewIndexerModel$.prototype.$_setOtherPrefix$ = function $$oj$$34$$$$ListViewIndexerModel$$$$_setOtherPrefix$$() {
    var $prefixes$$4$$, $self$$154$$ = this, $match$$22$$, $groupItems$$6$$, $content$$34$$, $i$$340$$, $prefix$$28$$;
    $prefixes$$4$$ = this.getIndexablePrefixes();
    return new Promise(function($resolve$$36$$) {
      $match$$22$$ = null;
      $groupItems$$6$$ = $self$$154$$.$listview$.$_getGroupItemsCache$();
      ...
      $match$$22$$ ? ($self$$154$$.$listview$.$_scrollToGroupHeader$($match$$22$$), $resolve$$36$$($oj$$34$$.$IndexerModel$.PREFIX_OTHERS)) : $resolve$$36$$(null);
    });
  };
  $oj$$34$$.$ListViewIndexerModel$.prototype.$_setPrefix$ = function $$oj$$34$$$$ListViewIndexerModel$$$$_setPrefix$$($prefix$$29$$) {
    var $prefixes$$5$$, $index$$195$$, $self$$155$$ = this, $match$$23$$ = null, $groupHeader$$2$$;
    ...
    return new Promise(function($resolve$$37$$) {
      if (-1 == $index$$195$$) {
        ...
        for (;$index$$195$$ < $prefixes$$5$$.length;) {
          ...
          $groupHeader$$2$$ = $self$$155$$.$_findGroupHeader$($prefix$$29$$);
          if (null != $groupHeader$$2$$) {
            $self$$155$$.$listview$.$_scrollToGroupHeader$($groupHeader$$2$$);
            $match$$23$$ = $prefix$$29$$;
            break;
          }
          $index$$195$$++;
