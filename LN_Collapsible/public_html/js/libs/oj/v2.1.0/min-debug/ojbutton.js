...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$24$$, $$$$22$$) {
  (function() {
    function $_getChromingDefault$$($componentName$$8$$, $element$$118_element$$inline_848$$, $actualContainers$$1_containerConstructor$$) {
      a: {
        for (var $interestingContainers$$inline_850$$ = $_interestingContainers$$[$componentName$$8$$], $i$$inline_851$$ = 0;$i$$inline_851$$ < $interestingContainers$$inline_850$$.length;++$i$$inline_851$$) {
          var $containerName$$inline_852$$ = $interestingContainers$$inline_850$$[$i$$inline_851$$];
          if (0 <= $actualContainers$$1_containerConstructor$$.indexOf($containerName$$inline_852$$)) {
            for (;;$element$$118_element$$inline_848$$ = $element$$118_element$$inline_848$$.parentNode) {
              var $func$$inline_853$$ = $oj$$24$$.Components.$getWidgetConstructor$($element$$118_element$$inline_848$$, $containerName$$inline_852$$);
              if ($func$$inline_853$$) {
                $actualContainers$$1_containerConstructor$$ = $func$$inline_853$$;
                break a;
              }
            }
          }
    ...
    $oj$$24$$.$__registerWidget$("oj.ojButton", $$$$22$$.oj.baseComponent, {defaultElement:"\x3cbutton\x3e", widgetEventPrefix:"oj", options:{chroming:"full", disabled:!1, display:"all", label:null, icons:{start:null, end:null}, menu:null}, $_InitOptions$:function($originalDefaults$$10$$, $constructorOptions$$12$$) {
      ...
      function $endHandler$$() {
        $self$$138$$.$_lastTouch$ = Date.now();
        $self$$138$$.$rootElement$.removeClass($activeClass$$);
        $self$$138$$.$rootElement$.removeClass("oj-hover");
        $self$$138$$.$_toggleDefaultClasses$();
      }
      this._super();
      ...
      var $self$$138$$ = this, $tabIndex$$4_toggleButton$$ = this.$_isToggle$, $activeClass$$ = $tabIndex$$4_toggleButton$$ ? "" : "oj-active";
      ...
      this.$buttonElement$.bind("touchstart" + this.eventNamespace, function() {
        $self$$138$$.$_IsEffectivelyDisabled$() || ($$$$22$$(this).addClass($activeClass$$), $self$$138$$.$_toggleDefaultClasses$());
        ...
        $self$$138$$.$_IsEffectivelyDisabled$() || $self$$138$$.$_recentTouch$() || (this === $_lastActive$$ && $self$$138$$.$rootElement$.addClass("oj-active"), $self$$138$$.$rootElement$.addClass("oj-hover").removeClass("oj-default oj-focus-only"));
      }).bind("mouseleave" + this.eventNamespace, function() {
        $self$$138$$.$rootElement$.removeClass("oj-hover");
        $self$$138$$.$_IsEffectivelyDisabled$() || ($self$$138$$.$rootElement$.removeClass($activeClass$$), $self$$138$$.$_toggleDefaultClasses$());
      }).bind("click" + this.eventNamespace, function($event$$348$$) {
        $self$$138$$.$_IsEffectivelyDisabled$() && ($event$$348$$.preventDefault(), $event$$348$$.stopImmediatePropagation());
      });
      this.element.bind("focus" + this.eventNamespace, function() {
        $self$$138$$.$rootElement$.addClass("oj-focus");
        $self$$138$$.$_toggleDefaultClasses$();
      }).bind("blur" + this.eventNamespace, function() {
        $self$$138$$.$rootElement$.removeClass("oj-focus");
        $self$$138$$.$_toggleDefaultClasses$();
      });
      $tabIndex$$4_toggleButton$$ && (this.element.bind("change" + this.eventNamespace, function($event$$349$$) {
        $self$$138$$.$_applyCheckedStateFromDom$(!0);
        ...
        $buttonset$$ && void 0 !== $checkedState$$ && $buttonset$$.option("checked", $checkedState$$, {_context:{$writeback$:!0, originalEvent:$event$$349$$, $internalSet$:!0}});
      }), this.$buttonElement$.bind("mousedown" + this.eventNamespace, function() {
        $self$$138$$.$_IsEffectivelyDisabled$() || ($_lastToggleActive$$ = this, $self$$138$$.document.one("mouseup", function() {
          $_lastToggleActive$$ = null;
        }));
      }).bind("mouseup" + this.eventNamespace, function() {
        $self$$138$$.$_IsEffectivelyDisabled$() || this !== $_lastToggleActive$$ || $self$$138$$.element.focus();
      }));
      "checkbox" === this.type ? (this.$buttonElement$.bind("click" + this.eventNamespace, function() {
        if ($self$$138$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
      }), this.element.bind("keyup" + this.eventNamespace, function($event$$353$$) {
        $event$$353$$.keyCode === $$$$22$$.ui.keyCode.ENTER && ($self$$138$$.$_IsEffectivelyDisabled$() || $self$$138$$.element.click());
      })) : "radio" === this.type ? (this.$buttonElement$.bind("click" + this.eventNamespace, function() {
        if ($self$$138$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
      }), this.element.bind("keyup" + this.eventNamespace, function($event$$354$$) {
        $event$$354$$.keyCode !== $$$$22$$.ui.keyCode.ENTER || $self$$138$$.element[0].checked || $self$$138$$.$_IsEffectivelyDisabled$() || ($self$$138$$.element[0].checked = !0, $self$$138$$.element.change(), $self$$138$$.element.click());
      })) : (this.$buttonElement$.bind("mousedown" + this.eventNamespace, function($event$$355$$) {
        if ($self$$138$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
        1 !== $event$$355$$.which || $self$$138$$.$_recentTouch$() || ($$$$22$$(this).addClass("oj-active").removeClass("oj-default oj-focus-only"), $_lastActive$$ = this, $self$$138$$.document.one("mouseup", function() {
          $_lastActive$$ = null;
        }));
      }).bind("mouseup" + this.eventNamespace, function() {
        if ($self$$138$$.$_IsEffectivelyDisabled$()) {
        ...
        $self$$138$$.$_toggleDefaultClasses$();
      }).bind("keydown" + this.eventNamespace, function($event$$356$$) {
        if ($self$$138$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
        var $isSpace$$ = $event$$356$$.keyCode === $$$$22$$.ui.keyCode.SPACE, $isAnchor$$ = "anchor" === $self$$138$$.type;
        $isAnchor$$ && $isSpace$$ && $event$$356$$.preventDefault();
        ($isSpace$$ && !$isAnchor$$ || $event$$356$$.keyCode === $$$$22$$.ui.keyCode.ENTER) && $$$$22$$(this).addClass("oj-active").removeClass("oj-default oj-focus-only");
    ...
    }, $_NotifyContextMenuGesture$:function($menu$$9$$, $event$$357$$, $eventType$$39$$) {
      this.$_OpenContextMenu$($event$$357$$, $eventType$$39$$, {position:{of:"keyboard" === $eventType$$39$$ ? this.$rootElement$ : $event$$357$$}});
      ...
      if (this.options.menu) {
        var $self$$139$$ = this;
        this.element.attr("aria-haspopup", !0).on("keydown" + this.$menuEventNamespace$, function($event$$358$$) {
          if ($event$$358$$.which === $$$$22$$.ui.keyCode.DOWN) {
            $self$$139$$.$_showMenu$($event$$358$$, "firstItem"), $event$$358$$.preventDefault();
          } else {
            if ($event$$358$$.which === $$$$22$$.ui.keyCode.ESCAPE) {
              var $bubbleEscUp$$ = $self$$139$$.$_checkMenuParent$($self$$139$$.$rootElement$);
              $self$$139$$.$_dismissMenu$($event$$358$$);
              return $bubbleEscUp$$;
            }
          }
          return!0;
        }).on("click" + this.$menuEventNamespace$, function($event$$359$$) {
          var $menu$$10$$ = $self$$139$$.$_getMenu$();
          $menu$$10$$.$__spaceEnterDownInMenu$ || $self$$139$$.$_showMenu$($event$$359$$, "firstItem");
          $menu$$10$$.$__spaceEnterDownInMenu$ = !1;
          $event$$359$$.preventDefault();
          return!0;
        });
      }
      ...
      if (!this.$_menu$) {
        ...
        var $self$$140$$ = this;
        this.$_menu$.widget().on("oj__dismiss" + this.$menuEventNamespace$, function($event$$360$$) {
          $self$$140$$.$_menuDismissHandler$($event$$360$$);
        }).on("ojbeforeopen" + this.$menuEventNamespace$, function($event$$361$$) {
          $self$$140$$.$_launchingMenu$ || $self$$140$$.$_menuDismissHandler$($event$$361$$);
          $self$$140$$.$_launchingMenu$ = !1;
        });
      }
      return this.$_menu$;
    ...
    $oj$$24$$.$__registerWidget$("oj.ojButtonset", $$$$22$$.oj.baseComponent, {$_items$:"button, input[type\x3dbutton], input[type\x3dsubmit], input[type\x3dreset], input[type\x3dcheckbox], input[type\x3dradio], a", widgetEventPrefix:"oj", options:{checked:null, chroming:"full", focusManagement:"oneTabstop"}, $_setCheckedOnDom$:function($checked$$1$$, $$buttons$$1$$) {
      ...
      "oneTabstop" === this.options.focusManagement && (this.$$buttons$.unbind("keydown" + this.eventNamespace).bind("keydown" + this.eventNamespace, function($event$$366$$) {
        $self$$141$$.$_handleKeyDown$($event$$366$$, $$$$22$$(this));
      }).unbind("click" + this.eventNamespace).bind("click" + this.eventNamespace, function() {
        $$$$22$$(this).data("oj-ojButton").$_IsEffectivelyDisabled$() || $self$$141$$.$_setTabStop$($$$$22$$(this));
      }).unbind("focus" + this.eventNamespace).bind("focus" + this.eventNamespace, function() {
        $self$$141$$.$_setTabStop$($$$$22$$(this));
