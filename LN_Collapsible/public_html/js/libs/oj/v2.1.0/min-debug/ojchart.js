...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtChart"], function($oj$$51$$, $$$$46$$, $comp$$13$$, $base$$12$$, $dvt$$9$$) {
  ...
  $oj$$51$$.$SparkChartDataItem$ = function $$oj$$51$$$$SparkChartDataItem$$($data$$151$$) {
    this.$_data$ = $data$$151$$;
  };
  ...
  $oj$$51$$.$__registerWidget$("oj.ojChart", $$$$46$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{categoryFilter:null, categoryHighlight:null, optionChange:null, selectInput:null, viewportChange:null, viewportChangeInput:null, drill:null}, $_CreateDvtComponent$:function($context$$151$$, $callback$$117$$, $callbackObj$$12$$) {
    ...
    if ($filterType_type$$96$$ === $dvt$$9$$.DvtSelectionEvent.TYPE || $filterType_type$$96$$ === $dvt$$9$$.DvtSelectionEvent.TYPE_INPUT) {
      ...
      if ($selection$$14$$) {
        ...
        $filterType_type$$96$$ === $dvt$$9$$.DvtSelectionEvent.TYPE ? this.$_UserOptionChange$("selection", $selectedItems$$6_viewportChangePayload$$1$$, $event$$516_selectPayload$$) : ($event$$516_selectPayload$$.items = $selectedItems$$6_viewportChangePayload$$1$$, this._trigger("selectInput", null, $event$$516_selectPayload$$));
      }
    } else {
      ...
      $event$$516_selectPayload$$.getYMin(), this.options.yAxis.viewportMax = $event$$516_selectPayload$$.getYMax())), this._trigger($filterType_type$$96$$ === $dvt$$9$$.DvtChartViewportChangeEvent.TYPE ? "viewportChange" : "viewportChangeInput", null, $selectedItems$$6_viewportChangePayload$$1$$)) : $filterType_type$$96$$ === $dvt$$9$$.DvtDrillEvent.TYPE ? this._trigger("drill", null, {id:$event$$516_selectPayload$$.getId(), series:$event$$516_selectPayload$$.getSeries(), group:$event$$516_selectPayload$$.getGroup()}) : 
