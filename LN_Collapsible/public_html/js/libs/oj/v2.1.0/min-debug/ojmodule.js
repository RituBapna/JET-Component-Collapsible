  ...
  (function() {
    ...
    function $_invokeLifecycleListener$$($listener$$36$$, $method$$7$$, $params$$23$$) {
      if ($listener$$36$$ && $listener$$36$$[$method$$7$$]) {
        var $data$$135$$ = {element:$params$$23$$[0], valueAccessor:$params$$23$$[1]};
        2 < $params$$23$$.length && ($data$$135$$.viewModel = $params$$23$$[2], 3 < $params$$23$$.length && ($data$$135$$["boolean" === typeof $params$$23$$[3] ? "fromCache" : "cachedNodes"] = $params$$23$$[3]));
        return $ko$$4$$.ignoreDependencies($listener$$36$$[$method$$7$$], $listener$$36$$, [$data$$135$$]);
      }
    }
    function $_invokeViewModelMethod$$($model$$58$$, $handler$$49_key$$128_name$$110$$, $params$$24$$) {
      if (null != $model$$58$$ && ($handler$$49_key$$128_name$$110$$ = $oj$$23$$.$ModuleBinding$.$defaults$[$handler$$49_key$$128_name$$110$$], null != $handler$$49_key$$128_name$$110$$ && $model$$58$$ && ($handler$$49_key$$128_name$$110$$ = $model$$58$$[$handler$$49_key$$128_name$$110$$], "function" === typeof $handler$$49_key$$128_name$$110$$))) {
        var $data$$136$$ = void 0;
        $params$$24$$ && ($data$$136$$ = {element:$params$$24$$[0], valueAccessor:$params$$24$$[1]}, 2 < $params$$24$$.length && ($data$$136$$["boolean" === typeof $params$$24$$[2] ? "fromCache" : "cachedNodes"] = $params$$24$$[2]));
        return $ko$$4$$.ignoreDependencies($handler$$49_key$$128_name$$110$$, $model$$58$$, [$data$$136$$]);
      }
    }
    ...
    function $_koNodesForEach$$($first$$6_node$$81$$, $cacheHolder$$3$$, $callback$$101$$) {
      for (;null != $first$$6_node$$81$$;) {
        var $next$$6$$ = $ko$$4$$.virtualElements.nextSibling($first$$6_node$$81$$), $type$$85$$ = $first$$6_node$$81$$.nodeType;
        $first$$6_node$$81$$ === $cacheHolder$$3$$ || 1 !== $type$$85$$ && 8 !== $type$$85$$ || $callback$$101$$($first$$6_node$$81$$);
    ...
    function $_createNoFailPromise$$($promise$$5$$) {
      return $promise$$5$$ ? new Promise(function($resolve$$33$$) {
        $promise$$5$$.then($resolve$$33$$, $resolve$$33$$);
      }) : $promise$$5$$;
    }
