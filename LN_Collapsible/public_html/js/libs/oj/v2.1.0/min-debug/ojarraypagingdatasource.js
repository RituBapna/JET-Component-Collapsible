...
define(["ojs/ojcore", "jquery", "knockout", "ojs/ojdatasource-common"], function($oj$$71$$, $$$$66$$, $ko$$7$$) {
  $oj$$71$$.$ArrayPagingDataSource$ = function $$oj$$71$$$$ArrayPagingDataSource$$($data$$176$$) {
    this.data = $data$$176$$;
    this.current = 0;
    this.Init();
  ...
  $oj$$71$$.$ArrayPagingDataSource$.prototype.setPage = function $$oj$$71$$$$ArrayPagingDataSource$$$setPage$($value$$293$$, $options$$370$$) {
    ...
    return new Promise(function($resolve$$62$$, $reject$$59$$) {
      $self$$211$$.$_fetchInternal$($options$$370$$).then(function() {
        $oj$$71$$.$ArrayPagingDataSource$.$superclass$.handleEvent.call($self$$211$$, $oj$$71$$.$PagingModel$.$EventType$.PAGE, {page:$self$$211$$.$_page$, previousPage:$previousPage$$4$$});
        $resolve$$62$$(null);
      }, function() {
        $self$$211$$.$_page$ = $previousPage$$4$$;
        $self$$211$$.$_startIndex$ = $self$$211$$.$_page$ * $self$$211$$.pageSize;
        $reject$$59$$(null);
      });
    });
  };
