...
define(["ojs/ojcore", "jquery", "jqueryui-amd/core", "jqueryui-amd/widget", "ojs/ojmessaging"], function($oj$$3$$, $$$$3$$) {
  ...
  $$$$3$$.widget("oj.baseComponent", {options:{contextMenu:null, rootAttributes:null, optionChange:void 0, destroy:void 0}, refresh:function() {
    ...
    if (!this.$_propertyContext$) {
      ...
      for (var $element$$23$$ = this.element[0], $elem$$inline_480$$ = $element$$23$$, $containers$$inline_481$$ = [];$elem$$inline_480$$;) {
      ...
      $c$$31$$.containers = $containers$$inline_481$$;
  ...
  $oj$$3$$.$DomUtils$.$isChromeEvent$ = function $$oj$$3$$$$DomUtils$$$isChromeEvent$$($JSCompiler_temp$$12_event$$33$$) {
    ...
    if (!("clientX" in $JSCompiler_temp$$12_event$$33$$ && "clientY" in $JSCompiler_temp$$12_event$$33$$)) {
      return!1;
    }
    ...
    if ($oj$$3$$.$AgentUtils$.$OS$.$ANDROID$ === $agentInfo$$1$$.os || $oj$$3$$.$AgentUtils$.$OS$.$IOS$ === $agentInfo$$1$$.os) {
      $JSCompiler_temp$$12_event$$33$$ = !1;
    } else {
      var $JSCompiler_temp$$13$$;
      if ($oj$$3$$.$AgentUtils$.$ENGINE$.$GECKO$ === $agentInfo$$1$$.engine) {
        try {
          $JSCompiler_temp$$13$$ = $JSCompiler_temp$$12_event$$33$$.originalTarget.localName ? !1 : !0;
        } catch ($e$$inline_489$$) {
          $JSCompiler_temp$$13$$ = !0;
        }
      } else {
        $JSCompiler_temp$$13$$ = $oj$$3$$.$AgentUtils$.$ENGINE$.$WEBKIT$ === $agentInfo$$1$$.engine ? $_isChromeEventWebkit$$($JSCompiler_temp$$12_event$$33$$) : $oj$$3$$.$AgentUtils$.$BROWSER$.$IE$ === $agentInfo$$1$$.browser ? $_isChromeEventWebkit$$($JSCompiler_temp$$12_event$$33$$) : !1;
      }
      $JSCompiler_temp$$12_event$$33$$ = $JSCompiler_temp$$13$$;
    }
    return $JSCompiler_temp$$12_event$$33$$;
  };
