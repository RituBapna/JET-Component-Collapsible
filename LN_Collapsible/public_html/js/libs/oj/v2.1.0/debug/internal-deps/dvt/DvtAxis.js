  ...
  if (axisInfo instanceof DvtTimeAxisInfo) {
    ...
    if (lv2Labels != null) {
      for (i = 0; i < lv2Labels.length; i++) {
        ...
        // Associate with logical object to support DvtComponentUIEvent and tooltips
        axis.getEventManager().associate(label, new DvtSimpleObjPeer(null, null, null, DvtAxisEventManager.getUIEventParams(DvtAxisConstants.TICK_LABEL, label.getTextString())));
