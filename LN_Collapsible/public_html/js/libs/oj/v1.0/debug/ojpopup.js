 ...
 */(function ()
{
   ...
   * </h3>
   *
   *   <p id="future-compatibility"><b>Future Compatibility</b> - to maintain future compatability developers 
   *   should not assume that the DOM associated with the popup will remain inline.  Going forward, all JET popups,
   *   including JET menu, will be re-parented to better manage the stacking context across the component suite.  
   *   More specifically, developers should not assume that events raised within a paticular popup instance will bubble
   *   up to its immediate parent from where it was defined.  Developers should also not assume any CSS
   *   inheritance from where it was defined as it will be moved in the document when open.  Event
   *   listeners should be established on the DOM element that the popup is bound to and there should be
   *   no assumptions of CSS styling based on the location in the document the popup is defined.</p>
   *
  ...
  oj.__registerWidget("oj.ojPopup", $['oj']['baseComponent'], 
  {
    ...
    */
     ...
     * 
     * Please note <a href="#future-compatibility">future compatibility</a> in the reparenting section.
     *
     * @expose
     * @method
