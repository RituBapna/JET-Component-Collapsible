 ...
 * </h3>
 * 
 * <p>To maintain future compatability, developers should not assume that the DOM associated 
 * with the menu will remain inline.  In a future release, all JET popups, including JET Menu, will
 * be re-parented to better manage the stacking context across the component suite.  
 * 
 * <p>Thus, developers should not assume that events raised within the menu will bubble up to the 
 * menu's ancestors.  Instead, event listeners should be established on the menu's root element.
 * 
 * <p>Likewise, developers should not use CSS descendant selectors, or similar logic, that assumes 
 * that the menu will remain a child of its original parent.  
 * 
 * 
 * <h3 id="rtl-section">
 *   Reading direction
