 ...
 * </h3>
 * 
 * <p>The <code class="prettyprint">oj-button-half-chrome</code> CSS class can be used to give the button a "half-chrome" look.  
 * In typical themes, half-chrome buttons have no chrome (background or border) normally, but acquire chrome in their 
 * hover, active, and selected states.
 * 
 * <p>Half-chroming is recommended for buttons in a toolbar, and anytime the half-chrome look is desired.
 * 
 ...
 *   <li>As long as those requirements are met, it is fine for the class to appear multiple times in the button's ancestry, inclusive.  
 ...
 *       under that ancestor that are not in the buttonset.</li>
 * </ul>
 * 
 * 
