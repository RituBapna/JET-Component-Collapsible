...
ko.bindingHandlers['ojContextMenu'] = 
{
  'update': function (element, valueAccessor, allBindings, viewModel, bindingContext) 
  {
    ...
    // selector like "#myMenuId", or null, or some malformed thing.
...
/**
 * Since this function needs to exist in ojInputDate's code as well
 * $("selector").ojInputDate("option", "dayMetaData" {}) as well, exposing
 * 
 * @expose
 * @since 0.7
 */
oj.DayMetaDataBinding = 
{
  /**
   * @expose
   */
  getMetaData: function getMetaData(dayMetaData, position, params) {
