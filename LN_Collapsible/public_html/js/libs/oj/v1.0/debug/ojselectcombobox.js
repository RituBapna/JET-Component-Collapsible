 ...
 */
  ...
  oj.__registerWidget("oj.ojCombobox", $['oj']['editableValue'],
  {
    ...
    options :
    {
       ...
       * 
       * Note:  <code class="prettyprint">value</code> option can only be bound to a knockout observableArray. The type of the
       * value returned from the component is always array.
       * 
