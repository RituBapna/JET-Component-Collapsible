...
(function ()
{
  oj.__registerWidget("oj.ojAccordion", $['oj']['baseComponent'], 
  {
    ...
    options : 
    {
      ...
      /** 
       * Array contains either ids or zero-based indexes of the collapsibles that should be expanded.
       * Setter value: array of either IDs or indexes.
       * Getter value: array of either ids or indexes. If an expanded collapsible that has 
       *               a page author provided id, then id is returned other its index.
       *
       * @expose 
       * @memberof! oj.ojAccordion
       * @instance
       ...
       *
       * Note: expanded is default to null
...
//          $(event.currentTarget).children()[0])
    ...
    _setExpandedOption: function(expanded)
    {
      ...
      //expandedList contains indexes of expanded collapsibles
      var expandedList = [];
