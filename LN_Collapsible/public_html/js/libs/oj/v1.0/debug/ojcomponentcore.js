...
$.widget('oj.baseComponent', 
{
  ...
  /**
   * Overridden to change the way the component events are treating original events:
  ...
  _setupContextMenu: function()
  {
    ...
    var menuSelector = this.options.contextMenu;
    
    // TODO: move this part to _InitOptions, in the trxn that handles that refactoring
    if (!menuSelector)
    {
        menuSelector = this.element.attr("contextmenu");
        if (menuSelector)
