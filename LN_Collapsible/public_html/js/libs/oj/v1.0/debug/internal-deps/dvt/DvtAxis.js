...
DvtTimeAxisInfo.prototype.Init = function(context, options, availSpace) {
  ...
  this._converter = options['tickLabel'] != null ? options['tickLabel']['converter'] : null;
  this._isoConverter = options['_isoConverter'];
...
DvtTimeAxisInfo.prototype._formatAxisLabel = function(date, prevDate) {
  ...
  if (this._converter && this._converter['getAsString']) {
    ...
    label1 = this._converter['format'](this._isoConverter ? this._isoConverter(date) : date);
  }
