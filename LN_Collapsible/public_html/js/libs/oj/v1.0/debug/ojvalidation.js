...
{
  return date.getFullYear() + "-" + OraI18nUtils.padZeros((date.getMonth() + 1), 2) + "-" + OraI18nUtils.padZeros(date.getDate(), 2) + "T" +
 ...
 *    <ul>     
 *      <li>'max': Hint message to be used, to give a hint about the allowed maximum.<p>
 *        Parameters:
 *        <ul>
 ...
 *      </li>
 *      <li>'min': Hint message to be used, to give a hint about the allowed minimum.<p>
 *        Parameters:
 *        <ul>
 ...
 *      </li>
 *      <li>'inRange': Hint message to be used, to give a hint about the allowed range.<p>
 *        Parameters:<p>
 *        <ul>
 *          <li>{min} the minimum</li>
 *          <li>{max} the maximum</li>
 ...
 *     </ul>
 *   </li>
 *   <li><b>messageDetail</b>: an optional object literal of custom error messages to be used:<p>
 *    <ul>
 *      <li>'rangeUnderflow': The detail error message to be used 
         when input value is less than the set minimum value.<p>
 *        Parameters:<p>
 *        <ul>
 ...
 *      </li>
 *      <li>'rangeOverflow': The detail error message to be used 
          when input value exceeds the maximum value set.<p>
 *        Parameters:<p>
 *        <ul>
 *          <li>{value} value entered by the user</li>
 ...
 *    </ul>
 *  </li>
 *     <li><strong>messageSummary</strong>: optional object literal of custom error summary message to be used:<p>
 *      <ul>
 *        <li>'rangeUnderflow': The summary of the error message when 
           input value is less than the set minimum value.
 *        </li>
 *        <li>'rangeOverflow': The summary of the error message when 
 *        input value exceeds the maximum value set.</li>     
 *      </ul>       
 *     </li>
 * </ul>
 * @export
 ...
 * resource defined with the key <code class="prettyprint">oj-validator.required.detail</code>.<p>
 * Tokens: {label} - this token can be used to substitute the label of the component at runtime. 
 * Example:<br/>
 ...
 *      <ul>     
 *        <li>'max': Hint message to be used, to indicate the allowed maximum.<p>
 *          Parameters:
 *          <ul>
 *            <li>{max} the maximum</li>
 *          </ul>
 ...
 *        </li>
 *        <li>'min': Hint message to be used, to indicate the allowed minimum.<p>
 *        Parameters:
 *          <ul>
 *            <li>{min} the minimum</li>
 *          </ul>
 *          Usage: Enter {min} or more characters</li>
 *        <li>'inRange': Hint message to be used, to indicate the allowed range.<p>
 *        Parameters:
 *          <ul>
 *            <li>{min} the minimum</li>
 *            <li>{max} the maximum</li>
 ...
 *        </li>
 *        <li>'exact': Hint message to be used, to indicate the exact length.<p>
 *        Parameters:
 *          <ul>
 *            <li>{length} the length</li>
 *          </ul>
 *          Usage: Enter {length} characters
 *        </li>
 *      </ul>
 *    </li>
 *    <li><strong>messageDetail</strong>: optional object literal of custom error message to be used:<p>
 *      <ul>
 *        <li>'tooLong': The detail error message to be used as the error message, when 
 ...
 *        </li>
 *        <li>'tooShort': The detail error message to be used as the error message, when 
 ...
 *      </ul>
 *    </li>
 *    <li><strong>messageSummary</strong>: optional object literal of custom summary error message to be used:<p>
 *      <ul>
 *        <li>'tooLong': The message to be used as the summary error message, when 
 *        the length of the input value exceeds the maximum value set.<p>
 *          Usage: Too long.
 *        </li>
 *        <li>'tooShort': The message to be used as the summary error message, when 
 *        input value is less than the set minimum value.<p>
 *          Usage: Too short.
 *        </li>
 *      </ul>
 ...
 *    <li><strong>messageDetail</strong>: optional object literal of custom error message to be used:<p>
 *      <ul>
 *        <li>'rangeUnderflow': The detail error message to be used as the error message, when 
 *        input value is less than the set minimum value.<p>
 *        Parameters:
 *          <ul>
 *            <li>{value} value entered by the user</li>
 ...
 *        
 *        </li>
 *        <li>'rangeOverflow': The detail error message to be used as the error message, when 
