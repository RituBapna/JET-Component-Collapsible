...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$43$$, $$$$41$$) {
  (function() {
    ...
    $oj$$43$$.$__registerWidget$("oj.ojToolbar", $$$$41$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{disabled:null}, _create:function() {
      ...
      this.$_setup$(!0);
      this._super();
    }, _OpenContextMenu:function($menu$$20$$, $event$$402$$) {
      $menu$$20$$.open($event$$402$$, {launcher:this.element.find(":oj-button[tabindex\x3d0]"), initialFocus:"menu"});
    }, _setOption:function($key$$130$$, $value$$233$$) {
      "disabled" === $key$$130$$ ? $oj$$43$$.$Logger$.warn("Caller attempted to set the 'disabled' option on Toolbar, but Toolbar does not support the 'disabled' option.  See API doc.  Ignoring the call.") : this._superApply(arguments);
    }, refresh:function() {
      this._super();
      this.$_setup$(!1);
      ...
      this.$$buttons$ = this.element.find(":oj-button").unbind("keydown" + this.eventNamespace).bind("keydown" + this.eventNamespace, function($event$$403$$) {
        $self$$146$$.$_handleKeyDown$($event$$403$$, $$$$41$$(this));
      ...
      return $$button$$3$$.map(function($index$$208$$, $elem$$47$$) {
    ...
    }, $_handleKeyDown$:function($event$$406$$, $$button$$5$$) {
      switch($event$$406$$.which) {
        ...
        case $$$$41$$.ui.keyCode.RIGHT:
          ...
          $$enabledButtons$$3$$.eq(($oldIndex$$1$$ + ($event$$406$$.which == $$$$41$$.ui.keyCode.RIGHT ^ this.$isRtl$ ? 1 : -1) + $length$$17$$) % $length$$17$$).focus();
          break;
        case $$$$41$$.ui.keyCode.UP:
        ;
        case $$$$41$$.ui.keyCode.DOWN:
          "radio" == $$button$$5$$.attr("type") && $event$$406$$.preventDefault();
      }
    }, _destroy:function() {
