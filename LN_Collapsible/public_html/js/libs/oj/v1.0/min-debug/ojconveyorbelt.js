...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$22$$, $$$$22$$) {
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$setup$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$setup$$($bInit$$) {
    var $self$$115$$ = this, $cbcClass$$ = $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$;
    if ($bInit$$) {
      ...
      this.$_mouseWheelListener$ = function $this$$_mouseWheelListener$$($event$$253$$) {
        $self$$115$$.$_handleMouseWheel$($event$$253$$);
      };
      ...
      this.$_touchStartListener$ = function $this$$_touchStartListener$$($event$$254$$) {
        $self$$115$$.$_handleTouchStart$($event$$254$$);
      };
      $cbcClass$$.$_addBubbleEventListener$(this.$_overflowContainer$, "touchstart", this.$_touchStartListener$);
      this.$_touchMoveListener$ = function $this$$_touchMoveListener$$($event$$255$$) {
        $self$$115$$.$_handleTouchMove$($event$$255$$);
      };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_addBubbleEventListener$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$_addBubbleEventListener$$($node$$32$$, $type$$83$$, $listener$$36$$) {
    $node$$32$$.addEventListener ? $node$$32$$.addEventListener($type$$83$$, $listener$$36$$, !1) : $node$$32$$.attachEvent && $node$$32$$.attachEvent("on" + $type$$83$$, $listener$$36$$);
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_removeBubbleEventListener$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$_removeBubbleEventListener$$($node$$33$$, $type$$84$$, $listener$$37$$) {
    $node$$33$$.removeEventListener ? $node$$33$$.removeEventListener($type$$84$$, $listener$$37$$, !1) : $node$$33$$.detachEvent && $node$$33$$.detachEvent("on" + $type$$84$$, $listener$$37$$);
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_getWheelDelta$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$_getWheelDelta$$($event$$257$$) {
    var $wheelDelta$$ = 0;
    return $wheelDelta$$ = null != $event$$257$$.wheelDelta ? $event$$257$$.wheelDelta : null != $event$$257$$.deltaY ? -$event$$257$$.deltaY : -$event$$257$$.detail;
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_createInnerContainers$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_createInnerContainers$$() {
    var $self$$116$$ = this, $bHoriz$$3_overflowHeight$$ = this.$_isHorizontal$(), $overflowContainer$$ = document.createElement("div");
    ...
    if ($bHoriz$$3_overflowHeight$$) {
      ...
      var $i$$242_tableCellDivNextButtonStyle$$ = $numContentChildren_tableCellDivNextButton$$1$$.style;
      $arContentElements_tableCellDivPrevButton$$.style.verticalAlign = "top";
      $i$$242_tableCellDivNextButtonStyle$$.verticalAlign = "top";
    ...
    if (this.$_contentParent$) {
      for ($arContentElements_tableCellDivPrevButton$$ = [], $contentChildren_tableCellDivOverflow$$ = this.$_contentParent$.children, $numContentChildren_tableCellDivNextButton$$1$$ = $contentChildren_tableCellDivOverflow$$.length, $i$$242_tableCellDivNextButtonStyle$$ = 0;$i$$242_tableCellDivNextButtonStyle$$ < $numContentChildren_tableCellDivNextButton$$1$$;$i$$242_tableCellDivNextButtonStyle$$++) {
        var $child$$7$$ = $contentChildren_tableCellDivOverflow$$[$i$$242_tableCellDivNextButtonStyle$$];
    ...
    $cbcClass$$6$$.$_addBubbleEventListener$($overflowContainer$$, "scroll", function($event$$258$$) {
      $self$$116$$.$_handleScroll$($event$$258$$);
    });
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_createPrevButton$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_createPrevButton$$($bHoriz$$4_buttonId$$, $buttonStyleClass_cbcClass$$7_prevButtonStyle$$1$$, $icon$$) {
    var $self$$117$$ = this, $prevButton$$1$$ = document.createElement("div");
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_createNextButton$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_createNextButton$$($bHoriz$$5_buttonId$$1$$, $buttonStyleClass$$1_cbcClass$$8_nextButtonStyle$$1$$, $icon$$1$$) {
    var $self$$118$$ = this, $nextButton$$2$$ = document.createElement("div");
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_measureContents$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_measureContents$$() {
    ...
    if (this.$_getContentParent$().hasChildNodes() && $bHoriz$$6_contentTableDiv$$1$$ && $arContentElements$$1$$ && 0 < $arContentElements$$1$$.length) {
      for (var $bHoriz$$6_contentTableDiv$$1$$ = this.$_isHorizontal$(), $contentWidth$$ = 0, $contentWidth$$ = this.$_contentContainer$.offsetWidth, $startOffset$$ = 0, $prevSizeObj$$ = null, $i$$243$$ = 0;$i$$243$$ < $arContentElements$$1$$.length;$i$$243$$++) {
        var $child$$8_childParent$$ = $arContentElements$$1$$[$i$$243$$];
        if (1 === $child$$8_childParent$$.nodeType) {
          ...
          if ($bHoriz$$6_contentTableDiv$$1$$) {
            ...
            0 === $i$$243$$ && ($startOffset$$ = $sizeObj$$1$$.start);
    ...
    if (!this.$_isEmpty$()) {
      ...
      if ($bImmediate$$1$$ || !$scrollFunc$$ || $scroll$$5$$ === this.$_getCurrScroll$()) {
        ...
        $scrollFunc$$.call(this.$_callbackObj$, this.$_overflowContainer$, this.$_convertScrollLogicalToBrowser$($scroll$$5$$), Math.abs(this.$_getCurrScroll$() - $scroll$$5$$) / $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_SCROLL_SPEED$, function() {
          $self$$119$$.$_onScrollAnimEnd$($scroll$$5$$);
        });
      }
    }
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_handleMouseWheel$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_handleMouseWheel$$($event$$261$$) {
    var $bConsumeEvent$$ = this.$_bScrolling$;
    if (this.$_needsScroll$() && !this.$_bScrolling$) {
      var $wheelDelta$$1$$ = $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_getWheelDelta$($event$$261$$);
    ...
    $bConsumeEvent$$ && ($event$$261$$.preventDefault(), $event$$261$$.stopPropagation());
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_handleTouchStart$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_handleTouchStart$$($event$$262_eventTouches_firstTouch$$) {
    $event$$262_eventTouches_firstTouch$$ = $event$$262_eventTouches_firstTouch$$.touches;
    this.$_needsScroll$() && !this.$_bScrolling$ && 1 === $event$$262_eventTouches_firstTouch$$.length && (this.$_bTouch$ = !0, $event$$262_eventTouches_firstTouch$$ = $event$$262_eventTouches_firstTouch$$[0], this.$_touchStartCoord$ = this.$_isHorizontal$() ? $event$$262_eventTouches_firstTouch$$.pageX : $event$$262_eventTouches_firstTouch$$.pageY, this.$_touchStartScroll$ = this.$_getCurrScroll$(), this.$_touchStartNextScroll$ = this.$_calcNextScroll$(), this.$_touchStartPrevScroll$ = this.$_calcPrevScroll$());
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_handleTouchMove$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_handleTouchMove$$($diff_event$$263_firstTouch$$1$$) {
    if (this.$_bTouch$) {
      var $bHoriz$$7$$ = this.$_isHorizontal$();
      $diff_event$$263_firstTouch$$1$$ = $diff_event$$263_firstTouch$$1$$.touches[0];
      $diff_event$$263_firstTouch$$1$$ = ($bHoriz$$7$$ ? $diff_event$$263_firstTouch$$1$$.pageX : $diff_event$$263_firstTouch$$1$$.pageY) - this.$_touchStartCoord$;
      var $overflowContainer$$7$$ = this.$_overflowContainer$;
      Math.abs($diff_event$$263_firstTouch$$1$$) < $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_SWIPE_THRESHOLD$ * ($bHoriz$$7$$ ? $overflowContainer$$7$$.offsetWidth : $overflowContainer$$7$$.offsetHeight) ? this.$_setCurrScroll$(this.$_touchStartScroll$ - $diff_event$$263_firstTouch$$1$$, !0) : (this.$_setCurrScroll$(($bHoriz$$7$$ && this.$_bRtl$ ? 0 < $diff_event$$263_firstTouch$$1$$ : 0 > $diff_event$$263_firstTouch$$1$$) ? this.$_touchStartNextScroll$ : this.$_touchStartPrevScroll$), 
      this.$_bTouch$ = !1);
    }
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_setExternalScrollTimeout$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_setExternalScrollTimeout$$() {
    ...
    window.setTimeout(function() {
      $self$$120$$ && ($self$$120$$.$_bExternalScroll$ = !0);
    }, 0);
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcStartScroll$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcStartScroll$$($index$$162$$) {
    return this.$_getSizes$()[$index$$162$$].start;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcEndScroll$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcEndScroll$$($index$$163$$) {
    return this.$_getSizes$()[$index$$163$$].end - this.$_getCurrViewportSize$() + 1;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcFirstVisibleItemIndex$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcFirstVisibleItemIndex$$() {
    var $i$$244$$ = this.$_calcItemIndex$(this.$_getCurrScroll$());
    return 0 > $i$$244$$ ? 0 : $i$$244$$;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcLastVisibleItemIndex$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcLastVisibleItemIndex$$() {
    var $i$$245$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() + this.$_getCurrViewportSize$() - 1), $sizes$$5$$ = this.$_getSizes$();
    return 0 > $i$$245$$ ? $sizes$$5$$.length - 1 : $i$$245$$;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcPrevVisibleItemIndex$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcPrevVisibleItemIndex$$() {
    var $i$$246$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() - 1);
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcNextVisibleItemIndex$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcNextVisibleItemIndex$$() {
    var $i$$247$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() + this.$_getCurrViewportSize$()), $sizes$$6$$ = this.$_getSizes$();
    return 0 > $i$$247$$ ? $sizes$$6$$.length - 1 : $i$$247$$;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcItemIndex$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcItemIndex$$($scroll$$10$$) {
    for (var $sizes$$7$$ = this.$_getSizes$(), $i$$248$$ = 0;$i$$248$$ < $sizes$$7$$.length;$i$$248$$++) {
      if ($scroll$$10$$ <= $sizes$$7$$[$i$$248$$].end) {
        return $i$$248$$;
      }
    }
    return-1;
  ...
  (function() {
    $oj$$22$$.$__registerWidget$("oj.ojConveyorBelt", $$$$22$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{orientation:"horizontal", contentParent:null}, _ComponentCreate:function() {
      ...
      var $elem$$39_numChildren$$ = this.element, $i$$249_options$$300$$ = this.options;
      if ($children$$7_isInit$$ && !this.$_cbCommon$) {
        var $child$$9_orientation$$1$$ = $i$$249_options$$300$$.orientation, $callbackInfo$$1_prevStyleClass$$ = null, $nextStyleClass$$ = null, $prevIcon$$ = null, $nextIcon$$ = null, $animateScrollFunc_contentParentElem$$ = null;
        ...
        $i$$249_options$$300$$.contentParent && ($animateScrollFunc_contentParentElem$$ = $$$$22$$($i$$249_options$$300$$.contentParent)[0]);
      ...
      if ($children$$7_isInit$$) {
        for ($children$$7_isInit$$ = $elem$$39_numChildren$$.find(".oj-conveyorbelt-overflow-indicator"), $elem$$39_numChildren$$ = $children$$7_isInit$$.size(), $i$$249_options$$300$$ = 0;$i$$249_options$$300$$ < $elem$$39_numChildren$$;$i$$249_options$$300$$++) {
          $child$$9_orientation$$1$$ = $children$$7_isInit$$.get($i$$249_options$$300$$), this.$_setupButtonMouseStyles$($child$$9_orientation$$1$$);
        }
      }
    }, _destroy:function() {
      ...
      this._super();
    }, _setOption:function($key$$95$$, $value$$199$$, $flags$$33$$) {
      var $bRecreate$$1$$ = !1;
      switch($key$$95$$) {
      ...
      this._super($key$$95$$, $value$$199$$, $flags$$33$$);
      $bRecreate$$1$$ && this.$_setup$(!0);
    }, $_destroyCBCommon$:function() {
      var $cbCommon$$1$$ = this.$_cbCommon$;
      $cbCommon$$1$$ && $cbCommon$$1$$.destroy();
      this.$_cbCommon$ = null;
    }, $_setupButtonMouseStyles$:function($element$$69$$) {
      this._on($element$$69$$, {mousedown:function($event$$266$$) {
        $$$$22$$($event$$266$$.currentTarget).addClass("oj-active");
      }, mouseup:function($event$$267$$) {
        $$$$22$$($event$$267$$.currentTarget).removeClass("oj-active");
      }, mouseenter:function($currTarget$$2_event$$268$$) {
        $currTarget$$2_event$$268$$ = $currTarget$$2_event$$268$$.currentTarget;
        $$$$22$$($currTarget$$2_event$$268$$).addClass("oj-hover");
        $$$$22$$($currTarget$$2_event$$268$$).removeClass("oj-default");
      }, mouseleave:function($currTarget$$3_event$$269$$) {
        $currTarget$$3_event$$269$$ = $currTarget$$3_event$$269$$.currentTarget;
        $$$$22$$($currTarget$$3_event$$269$$).removeClass("oj-hover");
        $$$$22$$($currTarget$$3_event$$269$$).removeClass("oj-active");
        $$$$22$$($currTarget$$3_event$$269$$).addClass("oj-default");
      }});
    ...
    }, getNodeBySubId:function($locator$$15_subId$$9$$) {
      if (null == $locator$$15_subId$$9$$) {
        return this.element ? this.element[0] : null;
      }
      $locator$$15_subId$$9$$ = $locator$$15_subId$$9$$.subId;
      return "oj-conveyorbelt-start-overflow-indicator" === $locator$$15_subId$$9$$ ? this.widget().find(".oj-conveyorbelt-overflow-indicator.oj-start")[0] : "oj-conveyorbelt-end-overflow-indicator" === $locator$$15_subId$$9$$ ? this.widget().find(".oj-conveyorbelt-overflow-indicator.oj-end")[0] : "oj-conveyorbelt-top-overflow-indicator" === $locator$$15_subId$$9$$ ? this.widget().find(".oj-conveyorbelt-overflow-indicator.oj-top")[0] : "oj-conveyorbelt-bottom-overflow-indicator" === $locator$$15_subId$$9$$ ? 
