...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtGauge"], function($oj$$17$$, $$$$17$$) {
  $oj$$17$$.$__registerWidget$("oj.dvtBaseGauge", $$$$17$$.oj.dvtBaseComponent, {$_GetChildStyleClasses$:function() {
    ...
    var $ret$$33$$ = this._super();
    $ret$$33$$["DvtGaugeBundle.EMPTY_TEXT"] = this.$_GetTranslatedResource$("msgNoData");
    return $ret$$33$$;
  }, $_HandleEvent$:function($event$$198$$) {
    var $type$$80$$ = $event$$198$$ && $event$$198$$.getType ? $event$$198$$.getType() : null;
    $type$$80$$ === DvtValueChangeEvent.TYPE ? this.$_UserOptionChange$("value", $event$$198$$.getNewValue()) : $type$$80$$ === DvtValueChangeEvent.TYPE_INPUT ? this._trigger("input", null, {value:$event$$198$$.getNewValue()}) : this._super($event$$198$$);
  }, $_SupportsOptionChangeEvent$:function($key$$87$$) {
    return "value" == $key$$87$$;
  }});
  $oj$$17$$.$__registerWidget$("oj.ojStatusMeterGauge", $$$$17$$.oj.dvtBaseGauge, {version:"1.0.0", widgetEventPrefix:"oj", options:{input:null, optionChange:null}, $_CreateDvtComponent$:function($context$$45$$, $callback$$91$$, $callbackObj$$1$$) {
    return DvtStatusMeterGauge.newInstance($context$$45$$, $callback$$91$$, $callbackObj$$1$$);
  ...
  $oj$$17$$.$__registerWidget$("oj.ojLedGauge", $$$$17$$.oj.dvtBaseGauge, {version:"1.0.0", widgetEventPrefix:"oj", options:{}, $_CreateDvtComponent$:function($context$$46$$, $callback$$92$$, $callbackObj$$2$$) {
    return DvtLedGauge.newInstance($context$$46$$, $callback$$92$$, $callbackObj$$2$$);
  }, $_GetComponentStyleClasses$:function() {
  ...
  $oj$$17$$.$__registerWidget$("oj.ojRatingGauge", $$$$17$$.oj.dvtBaseGauge, {version:"1.0.0", widgetEventPrefix:"oj", options:{input:null, optionChange:null}, $_CreateDvtComponent$:function($context$$47$$, $callback$$93$$, $callbackObj$$3$$) {
    return DvtRatingGauge.newInstance($context$$47$$, $callback$$93$$, $callbackObj$$3$$);
  }, $_GetComponentStyleClasses$:function() {
    ...
    return "value" == $key$$88$$ || "changed" == $key$$88$$;
  }, $_UserOptionChange$:function($key$$89$$, $value$$193$$) {
    this._superApply(arguments);
    "value" == $key$$89$$ && this.$_UserOptionChange$("changed", !0);
  }});
  $oj$$17$$.$__registerWidget$("oj.ojDialGauge", $$$$17$$.oj.dvtBaseGauge, {version:"1.0.0", widgetEventPrefix:"oj", options:{input:null, optionChange:null}, $_CreateDvtComponent$:function($context$$48$$, $callback$$94$$, $callbackObj$$4$$) {
    return DvtDialGauge.newInstance($context$$48$$, $callback$$94$$, $callbackObj$$4$$);
  }, $_GetComponentStyleClasses$:function() {
