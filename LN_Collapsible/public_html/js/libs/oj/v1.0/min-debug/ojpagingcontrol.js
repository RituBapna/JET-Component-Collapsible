...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdatacollection-common", "ojs/ojinputtext"], function($oj$$10$$, $$$$10$$) {
  ...
  (function() {
    ...
    $_NAV$:"nav"}, firstPage:function() {
      ...
      return null != $data$$56$$ ? (this.$_startIndex$ = 0, $data$$56$$.fetch({startIndex:0})) : $oj$$10$$.$Object$.$__getPromise$(function($resolve$$30$$, $reject$$30$$) {
        $reject$$30$$();
      });
    }, previousPage:function() {
      var $data$$57$$ = this.$_getData$();
      return null != $data$$57$$ ? (this.$_startIndex$ = this.$_getStartIndexForPage$(this.$_getCurrentPage$() - 1), 0 > this.$_startIndex$ && (this.$_startIndex$ = 0), $data$$57$$.fetch({startIndex:this.$_startIndex$})) : $oj$$10$$.$Object$.$__getPromise$(function($resolve$$31$$, $reject$$31$$) {
        $reject$$31$$();
      });
    }, nextPage:function() {
      var $data$$58$$ = this.$_getData$();
      if (null != $data$$58$$ && 0 < this.$_getTotalPages$()) {
        var $page$$1$$ = this.$_getCurrentPage$();
        $page$$1$$ + 1 > this.$_getTotalPages$() && ($page$$1$$ = this.$_getTotalPages$() - 1);
        this.$_startIndex$ = this.$_getStartIndexForPage$($page$$1$$ + 1);
        return $data$$58$$.fetch({startIndex:this.$_startIndex$});
      }
      ...
      return null != $data$$59$$ && 0 < this.$_getTotalPages$() ? (this.$_startIndex$ = this.$_getStartIndexForPage$(this.$_getTotalPages$()), $data$$59$$.fetch({startIndex:this.$_startIndex$})) : $oj$$10$$.$Object$.$__getPromise$(function($resolve$$33$$, $reject$$33$$) {
        $reject$$33$$();
      });
    }, page:function($page$$2$$) {
      var $data$$60$$ = this.$_getData$();
      return null != $data$$60$$ && ($page$$2$$ <= this.$_getTotalPages$() || 0 > this.$_getTotalPages$()) ? (this.$_startIndex$ = this.$_getStartIndexForPage$($page$$2$$), $data$$60$$.fetch({startIndex:this.$_startIndex$})) : $oj$$10$$.$Object$.$__getPromise$(function($resolve$$34$$, $reject$$34$$) {
        $reject$$34$$();
      });
    }, loadNext:function() {
      var $data$$61$$ = this.$_getData$();
      return null != $data$$61$$ ? $data$$61$$.next() : $oj$$10$$.$Object$.$__getPromise$(function($resolve$$35$$, $reject$$35$$) {
        $reject$$35$$();
      });
    }, refresh:function() {
      this._super();
      if (null != this.$_fetchTimer$) {
        ...
        var $data$$62$$ = this.$_getData$();
        null != $data$$62$$ && ($data$$62$$.setPageSize(this.options.pageSize), $data$$62$$.fetch({startIndex:this.$_startIndex$}));
      }
      this.$_refresh$(!0);
    }, getNodeBySubId:function($index$$128_locator$$5$$) {
      if (null == $index$$128_locator$$5$$) {
        return this.element ? this.element[0] : null;
      }
      var $subId$$1$$ = $index$$128_locator$$5$$.subId;
      return "oj-pagingcontrol-nav-input" === $subId$$1$$ ? this.$_getPagingControlNavInput$() : "oj-pagingcontrol-nav-input-max" === $subId$$1$$ ? this.$_getPagingControlContainer$().find("." + this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_INPUT_MAX_CLASS$) : "oj-pagingcontrol-nav-input-summary" === $subId$$1$$ ? this.$_getPagingControlContainer$().find("." + this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_INPUT_SUMMARY_CLASS$) : "oj-pagingcontrol-nav-first" === $subId$$1$$ ? this.$_getPagingControlContainer$().find("." + 
      this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_FIRST_CLASS$) : "oj-pagingcontrol-nav-next" === $subId$$1$$ ? this.$_getPagingControlContainer$().find("." + this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_NEXT_CLASS$) : "oj-pagingcontrol-nav-previous" === $subId$$1$$ ? this.$_getPagingControlContainer$().find("." + this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_PREVIOUS_CLASS$) : "oj-pagingcontrol-nav-last" === $subId$$1$$ ? this.$_getPagingControlContainer$().find("." + this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_LAST_CLASS$) : 
      "oj-pagingcontrol-nav-page" === $subId$$1$$ ? ($index$$128_locator$$5$$ = $index$$128_locator$$5$$.index, this.$_getPagingControlContainer$().find("[" + this.$_DATA_ATTR_PAGE_NUM$ + "\x3d" + $index$$128_locator$$5$$ + "]")) : null;
      ...
      setInterval(function() {
        null != $self$$49$$.$_refreshTimer$ && ($self$$49$$.$_refreshInternal$(), $self$$49$$.$_refreshTimer$ = null);
      }, 50);
      setInterval(function() {
        if (null != $self$$49$$.$_fetchTimer$) {
          var $data$$63$$ = $self$$49$$.$_getData$();
          null != $data$$63$$ && ($data$$63$$.setPageSize($self$$49$$.options.pageSize), $data$$63$$.fetch({startIndex:$self$$49$$.$_startIndex$}), $self$$49$$.$_fetchTimer$ = null);
        }
      }, 100);
    }, _destroy:function() {
      this.$_unregisterDataSourceEventListeners$();
    }, $_draw$:function() {
      var $options$$231$$ = this.options;
      ...
      $options$$231$$.mode == this.$_MODE$.$_LOAD_MORE$ ? (this.$_createPagingControlLoadMore$(), this.$_createPagingControlLoadMoreLink$(), this.$_createPagingControlLoadMoreRange$()) : this.$_createPagingControlNav$();
      var $self$$50$$ = this;
      setTimeout(function() {
        null != $self$$50$$.$_getData$() && $self$$50$$.$_getData$().size() < $options$$231$$.pageSize && (0 > $self$$50$$.$_getData$().totalSize() || $self$$50$$.$_getData$().totalSize() >= $self$$50$$.$_getData$().size()) && ($self$$50$$.$_getData$().setPageSize($options$$231$$.pageSize), $self$$50$$.$_getData$().fetch({startIndex:$self$$50$$.$_startIndex$, fetchType:"init"}));
      }, 0);
    }, $_events$:{"click .oj-pagingcontrol-loadmore-link":function($event$$50$$) {
      this.loadNext();
      $event$$50$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-page":function($event$$51$$) {
      var $pageNum$$ = $$$$10$$($event$$51$$.target).attr("data-oj-pagenum");
      this.page($pageNum$$);
      $event$$51$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-first":function($event$$52$$) {
      $$$$10$$($event$$52$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || this.firstPage();
      $event$$52$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-previous":function($event$$53$$) {
      $$$$10$$($event$$53$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || this.previousPage();
      $event$$53$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-next":function($event$$54$$) {
      $$$$10$$($event$$54$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || this.nextPage();
      $event$$54$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-last":function($event$$55$$) {
      $$$$10$$($event$$55$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || this.lastPage();
      $event$$55$$.preventDefault();
    }, "keypress .oj-pagingcontrol-nav-input":function($event$$56$$) {
      13 == $event$$56$$.which && $event$$56$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-first":function($event$$57$$) {
      $$$$10$$($event$$57$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$57$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-previous":function($event$$58$$) {
      $$$$10$$($event$$58$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$58$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-next":function($event$$59$$) {
      $$$$10$$($event$$59$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$59$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-last":function($event$$60$$) {
      $$$$10$$($event$$60$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$60$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-first":function($event$$61$$) {
      $$$$10$$($event$$61$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$61$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-previous":function($event$$62$$) {
      $$$$10$$($event$$62$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$62$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-next":function($event$$63$$) {
      $$$$10$$($event$$63$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$63$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-last":function($event$$64$$) {
      $$$$10$$($event$$64$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$64$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-first":function($event$$65$$) {
      $$$$10$$($event$$65$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$65$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-previous":function($event$$66$$) {
      $$$$10$$($event$$66$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$66$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-next":function($event$$67$$) {
      $$$$10$$($event$$67$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$67$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-last":function($event$$68$$) {
      $$$$10$$($event$$68$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$68$$.preventDefault();
      ...
      if (this.options.mode == this.$_MODE$.$_LOAD_MORE$) {
        ...
        null != $data$$64$$ && $data$$64$$.size() == $data$$64$$.totalSize() ? $pagingControlLoadMore$$.css("display", "none") : ($pagingControlLoadMore$$.css("display", ""), this.$_refreshPagingControlLoadMoreRange$());
      } else {
        this.$_refreshPagingControlNav$();
      }
    }, _setOption:function($key$$54$$, $value$$158$$) {
      ...
      if (!this.$_data$ && null != this.options.data) {
        var $data$$65_errSummary$$ = this.options.data;
        if ($data$$65_errSummary$$ instanceof $oj$$10$$.$PagingDataSource$) {
          this.$_data$ = $data$$65_errSummary$$;
        } else {
          var $data$$65_errSummary$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_ERR_DATA_INVALID_TYPE_SUMMARY$), $errDetail$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_ERR_DATA_INVALID_TYPE_DETAIL$);
          throw Error($data$$65_errSummary$$ + "\n" + $errDetail$$);
        }
      ...
      var $data$$66$$ = this.$_getData$(), $itemRangeText_pageTo$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE$, {pageFrom:this.$_startIndex$, pageTo:0, pageTotal:0});
      null != $data$$66$$ && ($itemRangeText_pageTo$$ = parseInt(this.$_startIndex$, 10) + parseInt($data$$66$$.size(), 10), -1 != $data$$66$$.totalSize() ? ($itemRangeText_pageTo$$ = $itemRangeText_pageTo$$ > $data$$66$$.totalSize() ? $data$$66$$.totalSize() : $itemRangeText_pageTo$$, $itemRangeText_pageTo$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE$, {pageFrom:this.$_startIndex$ + 1, pageTo:$itemRangeText_pageTo$$, pageTotal:$data$$66$$.totalSize()})) : $itemRangeText_pageTo$$ = 
      this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE_UNKNOWN$, {pageFrom:this.$_startIndex$ + 1, pageTo:$itemRangeText_pageTo$$}));
      ...
      var $data$$67$$ = this.$_getData$(), $totalSize$$ = 0;
      null != $data$$67$$ && ($totalSize$$ = $data$$67$$.totalSize());
    ...
    }, $_handleDataSort$:function($event$$72$$) {
      this.options.mode == this.$_MODE$.$_LOAD_MORE$ ? this.$_handleDataReset$($event$$72$$) : this.$_handleDataRefresh$($event$$72$$);
    }, $_handleDataRowAdd$:function($event$$73_rowIdx$$) {
      if (this.options.mode == this.$_MODE$.$_PAGE$) {
        var $data$$68_pageSize$$2$$ = this.$_getData$(), $totalSize$$1$$ = 0;
        null != $data$$68_pageSize$$2$$ && ($totalSize$$1$$ = $data$$68_pageSize$$2$$.totalSize());
        $data$$68_pageSize$$2$$ = this.options.pageSize;
        $event$$73_rowIdx$$ = $event$$73_rowIdx$$.index;
        var $startIndex$$4$$ = this.$_getStartIndexForPage$(this.$_getCurrentPage$());
        if ($startIndex$$4$$ != this.$_startIndex$ || $event$$73_rowIdx$$ >= $startIndex$$4$$ && $event$$73_rowIdx$$ < $startIndex$$4$$ + $data$$68_pageSize$$2$$ && $totalSize$$1$$ > $data$$68_pageSize$$2$$) {
      ...
      this.$_refresh$();
    }, $_handlePageChange$:function($event$$75$$, $data$$69$$) {
      try {
        $data$$69$$.value != this.$_getCurrentPage$() && !isNaN($data$$69$$.value) && 0 < $data$$69$$.value && this.page($data$$69$$.value);
      } catch ($err$$4$$) {
      ...
      if (null != $data$$70$$) {
        ...
        var $i$$154$$, $ev$$;
        for ($i$$154$$ = 0;$i$$154$$ < this.$_dataSourceEventHandlers$.length;$i$$154$$++) {
          ($ev$$ = $data$$70$$.on(this.$_dataSourceEventHandlers$[$i$$154$$].eventType, this.$_dataSourceEventHandlers$[$i$$154$$].eventHandler)) && (this.$_dataSourceEventHandlers$[$i$$154$$].eventHandler = $ev$$);
        }
      }
    }, $_registerResizeListener$:function($element$$39$$) {
      if (!this.$_isResizeListenerAdded$) {
        var $self$$51$$ = this;
        $oj$$10$$.$DomUtils$.$addResizeListener$($element$$39$$[0], function() {
          $self$$51$$.$_refresh$();
        });
      ...
      if (null != this.$_dataSourceEventHandlers$ && null != $data$$71$$) {
        var $i$$155$$;
        for ($i$$155$$ = 0;$i$$155$$ < this.$_dataSourceEventHandlers$.length;$i$$155$$++) {
          $data$$71$$.off(this.$_dataSourceEventHandlers$[$i$$155$$].eventType, this.$_dataSourceEventHandlers$[$i$$155$$].eventHandler);
        }
      }
      ...
      if (-1 != $$$$10$$.inArray(this.$_PAGE_OPTION_LAYOUT$.$_AUTO$, $pageOptionLayout_pagingControlNavLast$$1_pagingControlNavNext$$1$$) || -1 != $$$$10$$.inArray(this.$_PAGE_OPTION_LAYOUT$.$_ALL$, $pageOptionLayout_pagingControlNavLast$$1_pagingControlNavNext$$1$$) || -1 != $$$$10$$.inArray(this.$_PAGE_OPTION_LAYOUT$.$_INPUT$, $pageOptionLayout_pagingControlNavLast$$1_pagingControlNavNext$$1$$)) {
        ...
        if (0 < this.$_getTotalPages$()) {
          ...
          $itemRangeText$$1_maxPageVal_navFirstPageTip_navInputPageSummaryLabel_navPreviousPageTip_pagingControlNavFirstAccLabel_pagingControlNavLabel_pagingControlNavPreviousAccLabel$$ = null != this.$_getData$() && 0 < this.$_getData$().size() ? this.$_getCurrentPage$() + 1 : this.$_getCurrentPage$();
        }
      ...
      var $errDetail$$2_totalPages$$1$$ = this.$_getTotalPages$(), $currentPage$$1_pageAfterCurrent_pageNum$$1$$ = this.$_getCurrentPage$(), $i$$156_numPagesToAdd$$ = $numLinks$$, $pageList$$ = [];
      if (1 <= $currentPage$$1_pageAfterCurrent_pageNum$$1$$) {
        if (-1 != $errDetail$$2_totalPages$$1$$ && $errDetail$$2_totalPages$$1$$ <= $i$$156_numPagesToAdd$$) {
          for ($i$$156_numPagesToAdd$$ = $pageList$$[0] = 1;$i$$156_numPagesToAdd$$ < $errDetail$$2_totalPages$$1$$;$i$$156_numPagesToAdd$$++) {
            $pageList$$[$i$$156_numPagesToAdd$$] = $i$$156_numPagesToAdd$$ + 1;
          }
        } else {
          $pageList$$.push(1);
          ...
          var $i$$156_numPagesToAdd$$ = $i$$156_numPagesToAdd$$ - $pageList$$.length, $pageBeforeCurrent$$ = $currentPage$$1_pageAfterCurrent_pageNum$$1$$ - 1, $numPagesAfterCurrent$$ = 1;
          ...
          for (;$i$$156_numPagesToAdd$$ > $numPagesAfterCurrent$$ && 1 < $pageBeforeCurrent$$;) {
            $pageList$$.push($pageBeforeCurrent$$), $pageBeforeCurrent$$--, $i$$156_numPagesToAdd$$--;
          }
          $currentPage$$1_pageAfterCurrent_pageNum$$1$$ += 1;
          for (-1 == $errDetail$$2_totalPages$$1$$ && ($i$$156_numPagesToAdd$$ = null != this.$_getData$() && 0 < this.$_getData$().size() ? 1 : 0);0 < $i$$156_numPagesToAdd$$ && ($currentPage$$1_pageAfterCurrent_pageNum$$1$$ <= $errDetail$$2_totalPages$$1$$ || -1 == $errDetail$$2_totalPages$$1$$);) {
            $pageList$$.push($currentPage$$1_pageAfterCurrent_pageNum$$1$$), $currentPage$$1_pageAfterCurrent_pageNum$$1$$++, $i$$156_numPagesToAdd$$--;
          }
        }
        $pageList$$.sort(function($a$$71$$, $b$$44$$) {
          return $a$$71$$ - $b$$44$$;
        });
        for ($i$$156_numPagesToAdd$$ = 0;$i$$156_numPagesToAdd$$ < $pageList$$.length;$i$$156_numPagesToAdd$$++) {
          $currentPage$$1_pageAfterCurrent_pageNum$$1$$ = $pageList$$[$i$$156_numPagesToAdd$$], this.$_createPagingControlNavPage$($errSummary$$2_pagingControlNavPagesLinks$$, $currentPage$$1_pageAfterCurrent_pageNum$$1$$), $i$$156_numPagesToAdd$$ != $pageList$$.length - 1 && $currentPage$$1_pageAfterCurrent_pageNum$$1$$ != $pageList$$[$i$$156_numPagesToAdd$$ + 1] - 1 && this.$_createPagingControlNavPage$($errSummary$$2_pagingControlNavPagesLinks$$, -1);
        }
