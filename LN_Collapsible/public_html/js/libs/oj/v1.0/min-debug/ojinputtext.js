...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$5$$, $$$$5$$) {
  $oj$$5$$.$__registerWidget$("oj.inputBase", $$$$5$$.oj.editableValue, {version:"1.0.0", widgetEventPrefix:"oj", _ATTR_CHECK:[], _CLASS_NAMES:"", _WIDGET_CLASS_NAMES:"", _INPUT_HELPER_KEY:"", options:{converter:void 0, placeholder:void 0, readOnly:void 0}, $_SaveAttributes$:function($element$$23$$) {
    ...
    "pattern" === $key$$36$$ && (this.$_defaultRegExpValidator$[$oj$$5$$.$ValidatorFactory$.VALIDATOR_TYPE_REGEXP] = this.$_getImplicitRegExpValidator$(), this.$_AfterSetOptionValidators$());
    return $retVal$$5$$;
  ...
  }, $_onBlurHandler$:function __onBlurHandler($event$$39$$) {
    this.$_SetValue$(this.$_GetDisplayValue$(), $event$$39$$);
  }, $_onKeyDownHandler$:function __onKeyDownHandler($event$$40$$) {
    $event$$40$$.keyCode === $$$$5$$.ui.keyCode.ENTER && this.$_SetValue$(this.$_GetDisplayValue$(), $event$$40$$);
    ...
    return $$$$5$$.extend(this.$_defaultRegExpValidator$, $ret$$6$$);
