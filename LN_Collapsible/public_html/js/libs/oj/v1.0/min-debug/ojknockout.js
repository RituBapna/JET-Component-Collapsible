...
define(["ojs/ojcore", "jquery", "knockout"], function($oj$$7$$, $$$$7$$, $ko$$1$$) {
  function $_processDayMetaData$$($name$$85$$, $value$$152$$, $element$$35$$, $widgetConstructor$$4$$) {
    "dayMetaData" === $name$$85$$ && $widgetConstructor$$4$$({dayFormatter:$value$$152$$ ? function($dateInfo$$) {
      return $oj$$7$$.DayMetaDataBinding.getMetaData($value$$152$$, 0, [$dateInfo$$.fullYear, $dateInfo$$.month, $dateInfo$$.date]);
    } : null});
  }
  function $_extractValueFromChangeEvent$$($event$$41$$, $eventData$$2$$) {
    var $nameVal$$ = {};
    $nameVal$$.value = $eventData$$2$$.value;
    return $nameVal$$;
  }
  function $_extractOptionChange$$($event$$42$$, $eventData$$3$$) {
  ...
  function $_getTableColumnTemplateRenderer$$($bindingContext$$2$$, $type$$76$$, $template$$2$$) {
    var $rendererOption$$ = {};
    (function($template$$3$$, $type$$77$$) {
      $rendererOption$$ = function $$rendererOption$$$($params$$12$$) {
        var $childContext$$2$$ = null, $parentElement$$ = null;
        "header" == $type$$77$$ ? ($childContext$$2$$ = $bindingContext$$2$$.extend({$column:$params$$12$$.column, $headerContext:$params$$12$$.headerContext}), $parentElement$$ = $params$$12$$.headerContext.parentElement) : "cell" == $type$$77$$ && ($childContext$$2$$ = $bindingContext$$2$$.createChildContext($params$$12$$.row, null, function($binding$$2$$) {
        ...
        "footer" == $type$$77$$ && ($childContext$$2$$ = $bindingContext$$2$$.extend({$column:$params$$12$$.column, $footerContext:$params$$12$$.footerContext}), $parentElement$$ = $params$$12$$.footerContext.parentElement);
  ...
  $oj$$7$$.$ComponentBinding$ = function $$oj$$7$$$$ComponentBinding$$($name$$76$$, $options$$187$$) {
    this.Init($name$$76$$, $options$$187$$);
  };
  ...
  $oj$$7$$.$ComponentBinding$.create = function $$oj$$7$$$$ComponentBinding$$create$($name$$77$$, $options$$188$$) {
    if (null == $name$$77$$) {
      throw "Binding name is required!";
    }
    var $instance$$14$$ = new $oj$$7$$.$ComponentBinding$($name$$77$$, $options$$188$$), $handlers$$5$$ = $ko$$1$$.bindingHandlers, $i$$107$$, $names$$1$$ = Array.isArray($name$$77$$) ? $name$$77$$ : [$name$$77$$];
    for ($i$$107$$ = 0;$i$$107$$ < $names$$1$$.length;$i$$107$$++) {
      $handlers$$5$$[$names$$1$$[$i$$107$$]] = $instance$$14$$;
    }
    return $instance$$14$$;
  };
  ...
  $oj$$7$$.$ComponentBinding$.prototype.Init = function $$oj$$7$$$$ComponentBinding$$$Init$($names$$2$$, $options$$189$$) {
    $oj$$7$$.$ComponentBinding$.$superclass$.Init.call(this);
    "string" === typeof $options$$189$$ && ($options$$189$$ = {componentName:$options$$189$$});
    this.$_bindingOptions$ = $options$$189$$ || {};
  ...
  $oj$$7$$.$ComponentBinding$.prototype.$_initComponent$ = function $$oj$$7$$$$ComponentBinding$$$$_initComponent$$($element$$27$$, $jelem$$5$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$6$$) {
    var $options$$190$$ = $valueAccessor$$2$$(), $roleAttrName$$ = null, $disposed$$ = !1, $registeredListers$$ = [], $tracker$$3$$ = null, $comp$$2$$ = null, $bindingMap$$ = $oj$$7$$.$ComponentBinding$.$_getBindingValueMap$(this.$_bindingNames$, $element$$27$$, $bindingContext$$6$$), $stage$$ = 0, $attributeEvaluatorCache$$ = {}, $componentName$$1$$ = this.$_bindingOptions$.componentName;
    if (null == $componentName$$1$$) {
      ...
      var $role$$ = $options$$190$$[$roleAttrName$$];
      if (null == $role$$) {
    ...
    if (null != $componentName$$1$$) {
      if ($comp$$2$$ = $jelem$$5$$[$componentName$$1$$], "function" === typeof $comp$$2$$) {
        ...
        for (var $propertyMap$$ = {}, $tracker$$3$$ = new $ComponentChangeTracker$$($comp$$2$$, $element$$27$$, $oj$$7$$.$ComponentBinding$.$_changeQueue$), $defaultInstance_defaultManagedMap_mutationOptions_writablePropMap$$ = {"^slider$":[{event:"slidechange", getter:$_extractValueFromChangeEvent$$}], "^oj*":[{event:"ojoptionchange", getter:$_extractOptionChange$$}]}, $handler$$45$$ = function $$handler$$45$$$() {
          var $initProps_prop$$52_updateProps$$ = this.$_property$, $currentVal_exp$$1_updateKeys_v_value$$143$$ = $bindingMap$$[$initProps_prop$$52_updateProps$$];
          if (!$currentVal_exp$$1_updateKeys_v_value$$143$$) {
            throw "Binding expression for property " + $initProps_prop$$52_updateProps$$ + " is not found";
          }
          $currentVal_exp$$1_updateKeys_v_value$$143$$ = $oj$$7$$.$ComponentBinding$.$_evaluatePropertyExpression$($currentVal_exp$$1_updateKeys_v_value$$143$$, $initProps_prop$$52_updateProps$$, $attributeEvaluatorCache$$, $bindingContext$$6$$, 0 !== $stage$$ && !$disposed$$);
          if (0 === $stage$$) {
            var $currentVal_exp$$1_updateKeys_v_value$$143$$ = $oj$$7$$.$ComponentBinding$.$_toJS$($options$$190$$[$initProps_prop$$52_updateProps$$]), $initFunc_k$$4_managedPropEntry_updateFunc$$ = $managedAttrMap$$[$initProps_prop$$52_updateProps$$];
            null != $initFunc_k$$4_managedPropEntry_updateFunc$$ ? ($specifiedManagedAttrs$$[$initProps_prop$$52_updateProps$$] = $initFunc_k$$4_managedPropEntry_updateFunc$$, $initFunc_k$$4_managedPropEntry_updateFunc$$ = $initFunc_k$$4_managedPropEntry_updateFunc$$.$init$, null != $initFunc_k$$4_managedPropEntry_updateFunc$$ && ($initProps_prop$$52_updateProps$$ = $initFunc_k$$4_managedPropEntry_updateFunc$$($initProps_prop$$52_updateProps$$, $currentVal_exp$$1_updateKeys_v_value$$143$$, $element$$27$$, 
            $comp$$2$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$6$$) || {}, $oj$$7$$.$CollectionUtils$.$copyInto$($propertyMap$$, $initProps_prop$$52_updateProps$$))) : $propertyMap$$[$initProps_prop$$52_updateProps$$] = $currentVal_exp$$1_updateKeys_v_value$$143$$;
          } else {
            if (!$disposed$$) {
              if ($currentVal_exp$$1_updateKeys_v_value$$143$$ = $oj$$7$$.$ComponentBinding$.$_toJS$($currentVal_exp$$1_updateKeys_v_value$$143$$), null != $managedAttrMap$$[$initProps_prop$$52_updateProps$$]) {
                if ($initFunc_k$$4_managedPropEntry_updateFunc$$ = $managedAttrMap$$[$initProps_prop$$52_updateProps$$].update, null != $initFunc_k$$4_managedPropEntry_updateFunc$$) {
                  for ($initProps_prop$$52_updateProps$$ = $initFunc_k$$4_managedPropEntry_updateFunc$$($initProps_prop$$52_updateProps$$, $currentVal_exp$$1_updateKeys_v_value$$143$$, $element$$27$$, $comp$$2$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$6$$) || {}, $currentVal_exp$$1_updateKeys_v_value$$143$$ = Object.keys($initProps_prop$$52_updateProps$$), $initFunc_k$$4_managedPropEntry_updateFunc$$ = 0;$initFunc_k$$4_managedPropEntry_updateFunc$$ < $currentVal_exp$$1_updateKeys_v_value$$143$$.length;$initFunc_k$$4_managedPropEntry_updateFunc$$++) {
                    var $p$$4$$ = $currentVal_exp$$1_updateKeys_v_value$$143$$[$initFunc_k$$4_managedPropEntry_updateFunc$$];
                    $tracker$$3$$.$addChange$($p$$4$$, $initProps_prop$$52_updateProps$$[$p$$4$$]);
                  }
                }
              } else {
                $tracker$$3$$.$addChange$($initProps_prop$$52_updateProps$$, $currentVal_exp$$1_updateKeys_v_value$$143$$);
              }
            }
          }
          return null;
        }, $p$$3$$, $optionKeys$$ = Object.keys($options$$190$$), $k$$3$$ = 0;$k$$3$$ < $optionKeys$$.length;$k$$3$$++) {
  ...
  $oj$$7$$.$ComponentBinding$.$_getBindingValueMap$ = function $$oj$$7$$$$ComponentBinding$$$_getBindingValueMap$$($n$$17_names$$3$$, $elem$$18_keyValueArray$$, $bindingContext$$7_stringTrimRegex$$) {
    var $map$$ = {}, $bindingValue_i$$108_provider$$ = null, $bindingValue_i$$108_provider$$ = $ko$$1$$.bindingProvider.instance, $e$$47_selfVal$$;
    $e$$47_selfVal$$ = null;
    var $keyValueEntry$$, $bindingValue_i$$108_provider$$ = $bindingValue_i$$108_provider$$.$getBindingsString$ ? $bindingValue_i$$108_provider$$.$getBindingsString$($elem$$18_keyValueArray$$, $bindingContext$$7_stringTrimRegex$$) : $elem$$18_keyValueArray$$.getAttribute("data-bind");
    if (!$bindingValue_i$$108_provider$$) {
      return $map$$;
    }
    $elem$$18_keyValueArray$$ = $ko$$1$$.jsonExpressionRewriting.parseObjectLiteral($bindingValue_i$$108_provider$$);
    $bindingContext$$7_stringTrimRegex$$ = /^(\s|\u00A0)+|(\s|\u00A0)+$/g;
    for ($bindingValue_i$$108_provider$$ = 0;$bindingValue_i$$108_provider$$ < $elem$$18_keyValueArray$$.length;$bindingValue_i$$108_provider$$ += 1) {
      $keyValueEntry$$ = $elem$$18_keyValueArray$$[$bindingValue_i$$108_provider$$];
      var $bindingKey$$ = $keyValueEntry$$.key.replace($bindingContext$$7_stringTrimRegex$$, "");
      if (0 <= $n$$17_names$$3$$.indexOf($bindingKey$$)) {
        $e$$47_selfVal$$ = $keyValueEntry$$.value;
        break;
      }
    }
    if (!$e$$47_selfVal$$) {
    ...
    $elem$$18_keyValueArray$$ = $ko$$1$$.jsonExpressionRewriting.parseObjectLiteral($e$$47_selfVal$$);
    for ($n$$17_names$$3$$ = 0;$n$$17_names$$3$$ < $elem$$18_keyValueArray$$.length;$n$$17_names$$3$$ += 1) {
      $e$$47_selfVal$$ = $elem$$18_keyValueArray$$[$n$$17_names$$3$$], $map$$[$e$$47_selfVal$$.key.replace($bindingContext$$7_stringTrimRegex$$, "")] = $e$$47_selfVal$$.value.replace($bindingContext$$7_stringTrimRegex$$, "");
    }
    return $map$$;
  };
  $oj$$7$$.$ComponentBinding$.$_evaluatePropertyExpression$ = function $$oj$$7$$$$ComponentBinding$$$_evaluatePropertyExpression$$($expOrCallback$$1_expOrCallback$$inline_564$$, $key$$39$$, $cache$$, $bindingContext$$8$$, $evalSimpleExpr$$1$$) {
    var $evaluator$$inline_567_info$$ = $cache$$[$key$$39$$], $first$$inline_569_isNew$$1$$ = void 0 === $evaluator$$inline_567_info$$;
    if ($first$$inline_569_isNew$$1$$ || null === $evaluator$$inline_567_info$$.$evaluator$ && $evaluator$$inline_567_info$$.$simple$ && $evalSimpleExpr$$1$$) {
      "string" !== typeof $expOrCallback$$1_expOrCallback$$inline_564$$ && ($expOrCallback$$1_expOrCallback$$inline_564$$ = $expOrCallback$$1_expOrCallback$$inline_564$$());
      var $evaluator$$inline_567_info$$ = null, $isSimple$$inline_568$$ = !1;
      if (null !== $expOrCallback$$1_expOrCallback$$inline_564$$) {
        if ($first$$inline_569_isNew$$1$$) {
          if ($first$$inline_569_isNew$$1$$ = $expOrCallback$$1_expOrCallback$$inline_564$$.charAt(0), "'" === $first$$inline_569_isNew$$1$$ || '"' === $first$$inline_569_isNew$$1$$ || 0 >= $expOrCallback$$1_expOrCallback$$inline_564$$.indexOf("(")) {
            $isSimple$$inline_568$$ = !0;
          }
        } else {
          $isSimple$$inline_568$$ = !0;
        }
        if (!$isSimple$$inline_568$$ || $evalSimpleExpr$$1$$) {
          $evaluator$$inline_567_info$$ = new Function("$context", "with($context){with($data||{}){return " + $expOrCallback$$1_expOrCallback$$inline_564$$ + ";}}");
        }
      }
      $evaluator$$inline_567_info$$ = {$evaluator$:$evaluator$$inline_567_info$$, $simple$:$isSimple$$inline_568$$};
      $cache$$[$key$$39$$] = $evaluator$$inline_567_info$$;
    }
    return!$evaluator$$inline_567_info$$.$evaluator$ || !$evalSimpleExpr$$1$$ && $evaluator$$inline_567_info$$.$simple$ ? null : $evaluator$$inline_567_info$$.$evaluator$($bindingContext$$8$$);
  };
      ...
      if (null != $managers$$1$$) {
        for (var $n$$18$$ = $managers$$1$$.length - 1;0 <= $n$$18$$;$n$$18$$--) {
          ...
          if ($followLinks$$ && ($opt$$16_parents$$ = $opt$$16_parents$$.use, null != $opt$$16_parents$$)) {
            for (var $opt$$16_parents$$ = Array.isArray($opt$$16_parents$$) ? $opt$$16_parents$$ : [$opt$$16_parents$$], $i$$109$$ = 0;$i$$109$$ < $opt$$16_parents$$.length;$i$$109$$++) {
              $traverseOptions$$($opt$$16_parents$$[$i$$109$$], !0);
            }
          }
        }
      }
  ...
  $oj$$7$$.$ComponentBinding$.$_registerWritebacks$ = function $$oj$$7$$$$ComponentBinding$$$_registerWritebacks$$($jelem$$7$$, $componentName$$4_eventInfos$$, $i$$110_writablePropMap$$1$$, $bindingMap$$3$$, $tracker$$4$$, $bindingContext$$9$$, $attributeEvaluatorCache$$1$$) {
    var $cachedPropertyExpressionWriters$$ = {}, $info$$1_pattern$$11$$;
    for ($info$$1_pattern$$11$$ in $i$$110_writablePropMap$$1$$) {
      if ($componentName$$4_eventInfos$$.match($info$$1_pattern$$11$$)) {
        $componentName$$4_eventInfos$$ = $i$$110_writablePropMap$$1$$[$info$$1_pattern$$11$$];
        for ($i$$110_writablePropMap$$1$$ = 0;$i$$110_writablePropMap$$1$$ < $componentName$$4_eventInfos$$.length;$i$$110_writablePropMap$$1$$++) {
          $info$$1_pattern$$11$$ = $componentName$$4_eventInfos$$[$i$$110_writablePropMap$$1$$], $jelem$$7$$.on($info$$1_pattern$$11$$.event + $oj$$7$$.$ComponentBinding$.$_HANDLER_NAMESPACE$, {$getter$:$info$$1_pattern$$11$$.getter}, function($evt$$18$$, $data$$49$$) {
            $evt$$18$$.stopPropagation();
            var $nameValues$$ = $evt$$18$$.data.$getter$($evt$$18$$, $data$$49$$);
            $tracker$$4$$.$suspend$();
            try {
  ...
  $oj$$7$$.$ComponentBinding$.$_writeValueToProperty$ = function $$oj$$7$$$$ComponentBinding$$$_writeValueToProperty$$($func$$9_name$$80$$, $property$$16$$, $value$$144$$, $propertyExpression$$, $bindingContext$$10$$, $cachedPropertyExpressionWriters$$1$$) {
    null != $property$$16$$ && $ko$$1$$.isObservable($property$$16$$) ? $ko$$1$$.isWriteableObservable($property$$16$$) && $property$$16$$($value$$144$$) : ($func$$9_name$$80$$ = $oj$$7$$.$ComponentBinding$.$_evaluatePropertyExpression$(function() {
      return $oj$$7$$.$ComponentBinding$.$_getPropertyWriterExpression$($propertyExpression$$);
    }, $func$$9_name$$80$$, $cachedPropertyExpressionWriters$$1$$, $bindingContext$$10$$, !0)) && $func$$9_name$$80$$($value$$144$$);
  };
  $oj$$7$$.$ComponentBinding$.$_toJS$ = function $$oj$$7$$$$ComponentBinding$$$_toJS$$($prop$$53$$) {
    $prop$$53$$ = $ko$$1$$.utils.unwrapObservable($prop$$53$$);
    (Array.isArray($prop$$53$$) || $oj$$7$$.$CollectionUtils$.isPlainObject($prop$$53$$)) && $prop$$53$$.ojConvertToJS && ($prop$$53$$ = $ko$$1$$.toJS($prop$$53$$));
    return $prop$$53$$;
  };
  $oj$$7$$.$ComponentBinding$.$_extractDotNotationOptions$ = function $$oj$$7$$$$ComponentBinding$$$_extractDotNotationOptions$$($options$$191$$) {
    var $mutationOptions$$1$$ = {}, $opt$$17$$;
    for ($opt$$17$$ in $options$$191$$) {
      0 <= $opt$$17$$.indexOf(".") && ($mutationOptions$$1$$[$opt$$17$$] = $options$$191$$[$opt$$17$$]);
    }
    for (var $mo$$1$$ in $mutationOptions$$1$$) {
      delete $options$$191$$[$mo$$1$$];
    }
  ...
  $oj$$7$$.$ComponentBinding$.$_deliverCreateToManagedProps$ = function $$oj$$7$$$$ComponentBinding$$$_deliverCreateToManagedProps$$($managedAttrMap$$2$$, $element$$28$$, $comp$$3$$, $valueAccessor$$3$$, $allBindingsAccessor$$3$$, $bindingContext$$11$$) {
    for (var $props$$7$$ = Object.keys($managedAttrMap$$2$$), $i$$111$$ = 0;$i$$111$$ < $props$$7$$.length;$i$$111$$++) {
      var $prop$$54$$ = $props$$7$$[$i$$111$$], $callback$$83$$ = $managedAttrMap$$2$$[$prop$$54$$].$afterCreate$;
      $callback$$83$$ && $callback$$83$$($prop$$54$$, $element$$28$$, $comp$$3$$, $valueAccessor$$3$$, $allBindingsAccessor$$3$$, $bindingContext$$11$$);
    }
  };
  ...
  $GlobalChangeQueue$$.prototype.$removeComponentChanges$ = function $$GlobalChangeQueue$$$$$removeComponentChanges$$($index$$87_tracker$$6$$) {
    $index$$87_tracker$$6$$ = this.$_trackers$.indexOf($index$$87_tracker$$6$$);
    0 <= $index$$87_tracker$$6$$ && this.$_trackers$.splice($index$$87_tracker$$6$$, 1);
  };
  ...
  $GlobalChangeQueue$$.prototype.$_deliverChangesImpl$ = function $$GlobalChangeQueue$$$$$_deliverChangesImpl$$() {
    ...
    this.$_trackers$ = [];
    for ($i$$112_record$$2$$ = 0;$i$$112_record$$2$$ < $trackers$$.length;$i$$112_record$$2$$++) {
      var $tracker$$7$$ = $trackers$$[$i$$112_record$$2$$];
      this.$_queue$.push({$tracker$:$tracker$$7$$, $changes$:$tracker$$7$$.$flushChanges$()});
    }
    for (;0 < this.$_queue$.length;) {
      $i$$112_record$$2$$ = this.$_queue$.shift(), $i$$112_record$$2$$.$tracker$.$applyChanges$($i$$112_record$$2$$.$changes$);
    }
  };
  ...
  $ComponentChangeTracker$$.prototype.$addChange$ = function $$ComponentChangeTracker$$$$$addChange$$($property$$17$$, $value$$145$$) {
    this.$_isSuspended$() || this.$_disposed$ || (this.$_changes$[$property$$17$$] = $value$$145$$, this.$_queue$.$registerComponentChanges$(this));
  };
  ...
  $oj$$7$$.$koStringTemplateEngine$.$install$ = function $$oj$$7$$$$koStringTemplateEngine$$$install$$() {
    function $StringTemplate$$($template$$5$$) {
      ...
      this.text = function $this$text$($value$$146$$) {
        if (!$value$$146$$) {
          return $_templateText$$[this.$_templateName$];
        }
        $_templateText$$[this.$_templateName$] = $value$$146$$;
      };
      this.data = function $this$data$($key$$40$$, $value$$147$$) {
        $_templateData$$[this.$_templateName$] || ($_templateData$$[this.$_templateName$] = {});
        if (1 === arguments.length) {
          return $_templateData$$[this.$_templateName$][$key$$40$$];
        }
        $_templateData$$[this.$_templateName$][$key$$40$$] = $value$$147$$;
      };
    }
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["header", "cell"], init:function($cellTemplate_column_name$$81_row$$, $value$$148$$, $columnTemplate_element$$30_rowTemplate$$, $widgetConstructor$$, $valueAccessor$$4$$, $allBindingsAccessor$$4$$, $bindingContext$$12$$) {
    "header" === $cellTemplate_column_name$$81_row$$ ? ($cellTemplate_column_name$$81_row$$ = $value$$148$$.row, null != $cellTemplate_column_name$$81_row$$ && ($columnTemplate_element$$30_rowTemplate$$ = $cellTemplate_column_name$$81_row$$.template, null != $columnTemplate_element$$30_rowTemplate$$ && ($cellTemplate_column_name$$81_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$12$$, $columnTemplate_element$$30_rowTemplate$$))), $cellTemplate_column_name$$81_row$$ = $value$$148$$.column, 
    null != $cellTemplate_column_name$$81_row$$ && ($columnTemplate_element$$30_rowTemplate$$ = $cellTemplate_column_name$$81_row$$.template, null != $columnTemplate_element$$30_rowTemplate$$ && ($cellTemplate_column_name$$81_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$12$$, $columnTemplate_element$$30_rowTemplate$$))), $widgetConstructor$$({header:$value$$148$$})) : "cell" === $cellTemplate_column_name$$81_row$$ && ($cellTemplate_column_name$$81_row$$ = $value$$148$$.template, 
    null != $cellTemplate_column_name$$81_row$$ && ($value$$148$$.renderer = $_getDataGridCellRenderer$$($bindingContext$$12$$, $cellTemplate_column_name$$81_row$$)), $widgetConstructor$$({cell:$value$$148$$}));
  }, update:function($cellTemplate$$1_column$$1_name$$82_row$$1$$, $value$$149$$, $columnTemplate$$1_element$$31_rowTemplate$$1$$, $widgetConstructor$$1$$, $valueAccessor$$5$$, $allBindingsAccessor$$5$$, $bindingContext$$13$$) {
    return "header" === $cellTemplate$$1_column$$1_name$$82_row$$1$$ ? ($cellTemplate$$1_column$$1_name$$82_row$$1$$ = $value$$149$$.row, null != $cellTemplate$$1_column$$1_name$$82_row$$1$$ && ($columnTemplate$$1_element$$31_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$82_row$$1$$.template, null != $columnTemplate$$1_element$$31_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$82_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$13$$, $columnTemplate$$1_element$$31_rowTemplate$$1$$))), 
    $cellTemplate$$1_column$$1_name$$82_row$$1$$ = $value$$149$$.column, null != $cellTemplate$$1_column$$1_name$$82_row$$1$$ && ($columnTemplate$$1_element$$31_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$82_row$$1$$.template, null != $columnTemplate$$1_element$$31_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$82_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$13$$, $columnTemplate$$1_element$$31_rowTemplate$$1$$))), {header:$value$$149$$}) : "cell" === $cellTemplate$$1_column$$1_name$$82_row$$1$$ ? 
    ($cellTemplate$$1_column$$1_name$$82_row$$1$$ = $value$$149$$.template, null != $cellTemplate$$1_column$$1_name$$82_row$$1$$ && ($value$$149$$.renderer = $_getDataGridCellRenderer$$($bindingContext$$13$$, $cellTemplate$$1_column$$1_name$$82_row$$1$$)), {cell:$value$$149$$}) : null;
  }, "for":"ojDataGrid"});
  $ko$$1$$.bindingHandlers.ojContextMenu = {update:function $$ko$$1$$$bindingHandlers$ojContextMenu$update$($element$$32$$, $valueAccessor$$6$$) {
    ...
    var $menuSelector$$1$$ = $ko$$1$$.utils.unwrapObservable($valueAccessor$$6$$());
    "string" !== $$$$7$$.type($menuSelector$$1$$) && ($menuSelector$$1$$ = $element$$32$$.getAttribute("contextmenu")) && ($menuSelector$$1$$ = "#" + $menuSelector$$1$$);
    var $$menu$$1$$, $menu$$2$$;
    $menuSelector$$1$$ && ($$menu$$1$$ = $$$$7$$($menuSelector$$1$$), $menu$$2$$ = $$menu$$1$$.data("oj-ojMenu"));
    if ($menu$$2$$) {
      var $$element$$ = $$$$7$$($element$$32$$);
      $$element$$.on("keydown.ojContextMenu contextmenu.ojContextMenu", function($event$$43$$) {
        if ("contextmenu" === $event$$43$$.type || 121 == $event$$43$$.which && $event$$43$$.shiftKey) {
          $menu$$2$$.open($event$$43$$, {launcher:$$element$$, initialFocus:"menu"}), $$menu$$1$$.is(":visible") && $event$$43$$.preventDefault();
        }
        return!0;
      });
    }
  }};
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["columns", "columnsDefault", "rowTemplate"], init:function($name$$83$$, $value$$150$$, $element$$33_i$$113$$, $widgetConstructor$$2$$, $template$$7_valueAccessor$$7$$, $allBindingsAccessor$$6_footerTemplate$$, $bindingContext$$15$$) {
    if ("columns" == $name$$83$$ || "columnsDefault" == $name$$83$$) {
      var $headerTemplate$$;
      for ($element$$33_i$$113$$ = 0;$element$$33_i$$113$$ < $value$$150$$.length;$element$$33_i$$113$$++) {
        var $column$$2$$ = $value$$150$$[$element$$33_i$$113$$];
      ...
      "columns" == $name$$83$$ ? $widgetConstructor$$2$$({columns:$value$$150$$}) : $widgetConstructor$$2$$({columnsDefault:$value$$150$$});
    } else {
      "rowTemplate" == $name$$83$$ && $widgetConstructor$$2$$({rowRenderer:$_getTableRowTemplateRenderer$$($bindingContext$$15$$, $value$$150$$)});
    }
  }, update:function($name$$84$$, $value$$151$$, $element$$34_i$$114$$, $widgetConstructor$$3$$, $template$$8_valueAccessor$$8$$, $allBindingsAccessor$$7_footerTemplate$$1$$, $bindingContext$$16$$) {
    if ("columns" == $name$$84$$ || "columnsDefault" == $name$$84$$) {
      var $headerTemplate$$1$$;
      for ($element$$34_i$$114$$ = 0;$element$$34_i$$114$$ < $value$$151$$.length;$element$$34_i$$114$$++) {
        var $column$$3$$ = $value$$151$$[$element$$34_i$$114$$];
      ...
      "columns" == $name$$84$$ ? $widgetConstructor$$3$$({columns:$value$$151$$}) : $widgetConstructor$$3$$({columnsDefault:$value$$151$$});
    } else {
      if ("rowTemplate" == $name$$84$$) {
        return{rowRenderer:$_getTableRowTemplateRenderer$$($bindingContext$$16$$, $value$$151$$)};
      }
    }
    return null;
  }, "for":"ojTable"});
  $oj$$7$$.DayMetaDataBinding = {getMetaData:function getMetaData($dayMetaData$$, $position$$1$$, $params$$14$$) {
