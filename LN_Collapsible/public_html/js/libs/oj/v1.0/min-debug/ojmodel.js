...
define(["ojs/ojcore", "jquery", "promise"], function($oj$$1$$, $$$$1$$) {
  ...
  $oj$$1$$.$Collection$._init = function $$oj$$1$$$$Collection$$_init$($collection$$3$$, $models$$2$$, $options$$38$$, $properties$$6$$) {
    ...
    for ($i$$27_prop$$37$$ = 0;$i$$27_prop$$37$$ < $modelList_optionlist$$.length;$i$$27_prop$$37$$++) {
      $options$$38$$.hasOwnProperty($modelList_optionlist$$[$i$$27_prop$$37$$]) && void 0 !== $options$$38$$[$modelList_optionlist$$[$i$$27_prop$$37$$]] && ($collection$$3$$[$modelList_optionlist$$[$i$$27_prop$$37$$]] = $options$$38$$[$modelList_optionlist$$[$i$$27_prop$$37$$]]);
    }
    ...
    if (null != $models$$2$$ && void 0 !== $models$$2$$) {
      for ($modelList_optionlist$$ = $models$$2$$ instanceof Array ? $models$$2$$ : [$models$$2$$], $i$$27_prop$$37$$ = 0;$i$$27_prop$$37$$ < $modelList_optionlist$$.length;$i$$27_prop$$37$$ += 1) {
        $collection$$3$$.add($modelList_optionlist$$[$i$$27_prop$$37$$], $options$$38$$);
      }
    }
  ...
  $oj$$1$$.$Collection$.prototype.$_realignModelIndices$ = function $$oj$$1$$$$Collection$$$$_realignModelIndices$$($start$$7$$) {
    this.$_getModels$().forEach(function($model$$11$$, $i$$30$$) {
      $i$$30$$ >= $start$$7$$ && $model$$11$$ && $model$$11$$.$SetIndex$($i$$30$$);
    });
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_clearOutModels$ = function $$oj$$1$$$$Collection$$$$_clearOutModels$$($n$$2$$) {
    var $current$$ = this.tail, $index$$53$$, $model$$15$$, $i$$31$$ = 0;
    for (this.tail = null;$current$$ && $i$$31$$ < $n$$2$$;) {
      $index$$53$$ = $current$$.index, ($model$$15$$ = this.$_getModels$()[$index$$53$$]) && $model$$15$$.$hasChanged$() ? (this.tail || (this.tail = $current$$), $current$$ = $current$$.$previousModel$) : (this.$lruCount$--, -1 < $index$$53$$ && (this.$_getModels$()[$index$$53$$] = void 0), $current$$.$SetNext$(null), $current$$ = $current$$.$SetPrevious$(null), $i$$31$$++);
    }
  ...
  $oj$$1$$.$Collection$.prototype.$_cloneInternal$ = function $$oj$$1$$$$Collection$$$$_cloneInternal$$($i$$32_withProperties$$) {
    var $c$$17$$ = new this.constructor, $model$$16$$;
    ...
    if ($i$$32_withProperties$$) {
      for ($i$$32_withProperties$$ = 0;$i$$32_withProperties$$ < this.$_getLength$();$i$$32_withProperties$$ += 1) {
        ($model$$16$$ = this.$_atInternal$($i$$32_withProperties$$, null, !0, !1)) && $c$$17$$.$_addInternal$($model$$16$$.clone(), {at:$i$$32_withProperties$$}, !0, !1);
      }
    }
    return $c$$17$$;
  };
  $oj$$1$$.$Collection$.prototype.$_copyProperties$ = function $$oj$$1$$$$Collection$$$$_copyProperties$$($collection$$4$$) {
    ...
    for ($i$$33$$ = 0;$i$$33$$ < $props$$2$$.length;$i$$33$$++) {
      $prop$$38$$ = $props$$2$$[$i$$33$$], $collection$$4$$[$prop$$38$$] = this[$prop$$38$$];
    }
    return $collection$$4$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_addInternal$ = function $$oj$$1$$$$Collection$$$$_addInternal$$($m$$2$$, $options$$42$$, $fillIn$$, $deferred$$2$$) {
    function $mergeAttrs$$($collection$$7$$, $modelToTryAndMerge_sortOpt$$inline_320$$, $modelFoundInCollection$$1$$, $newModel$$3$$, $deferred$$4$$) {
      var $existingModel$$1$$, $modelAdded$$ = null;
      !$force$$ && $merge$$ && $modelFoundInCollection$$1$$ ? ($needSort$$1$$ = $modelFoundInCollection$$1$$.$Merge$($modelToTryAndMerge_sortOpt$$inline_320$$, $collection$$7$$.comparator, $silent$$11$$), $modelAdded$$ = $modelFoundInCollection$$1$$) : ($force$$ || ($existingModel$$1$$ = $collection$$7$$.$_getLocal$($newModel$$3$$)) && $fillIn$$ && $at$$ !== $existingModel$$1$$.index && $oj$$1$$.$Logger$.warn("Duplicate ID fetched or added without merging, the id \x3d " + $existingModel$$1$$.$GetId$()), 
      void 0 === $existingModel$$1$$ ? (void 0 === $at$$ ? ($collection$$7$$.$_pushModels$($newModel$$3$$), $index$$54$$ = $collection$$7$$.$_getModelsLength$() - 1, $collection$$7$$.$_getModel$($index$$54$$).$SetCid$()) : ($index$$54$$ = $at$$, $collection$$7$$.$__isVirtual$() && $fillIn$$ ? $collection$$7$$.$_setModel$($index$$54$$, $newModel$$3$$) : $collection$$7$$.$_spliceModels$($index$$54$$, 0, $newModel$$3$$), $collection$$7$$.$_getModel$($index$$54$$).$SetCid$(), $at$$ += 1), void 0 === 
      $newModel$$3$$.$GetCollection$() && $newModel$$3$$.$SetCollection$($collection$$7$$), $collection$$7$$.$_setLength$(), $collection$$7$$.$_listenToModel$($newModel$$3$$), $added$$ = !0, $modelAdded$$ = $newModel$$3$$) : $modelAdded$$ = $existingModel$$1$$);
      $fillIn$$ && ($options$$42$$ = $options$$42$$ || {}, $options$$42$$.fillIn = !0);
      $needSort$$1$$ && void 0 === $existingModel$$1$$ && !$sort$$ && void 0 === $at$$ && 1 < $collection$$7$$.$_getLength$() && (-1 < $index$$54$$ && ($cid$$1$$ = $collection$$7$$.$_getModel$($index$$54$$).cid), $modelToTryAndMerge_sortOpt$$inline_320$$ = {}, $oj$$1$$.$CollectionUtils$.$copyInto$($modelToTryAndMerge_sortOpt$$inline_320$$, $options$$42$$), $modelToTryAndMerge_sortOpt$$inline_320$$.add = !0, $collection$$7$$.sort($modelToTryAndMerge_sortOpt$$inline_320$$), -1 < $index$$54$$ && ($index$$54$$ = 
      ...
      if (null != $newModel$$4$$) {
        ...
        if ($deferred$$5$$) {
          return $force$$ ? $oj$$1$$.$Object$.$__getPromise$(function($resolve$$) {
            $mergeAttrs$$($collection$$8$$, $modelToTryAndMerge$$1$$, void 0, $newModel$$4$$, $deferred$$5$$);
            $resolve$$();
          }) : $collection$$8$$.$_getInternal$($modelToTryAndMerge$$1$$, null, $deferred$$5$$, !0).then(function($mod_modInfo$$) {
    ...
    var $modelArray$$ = [], $at$$ = $options$$42$$.at, $silent$$11$$ = $options$$42$$.silent, $force$$ = $options$$42$$.force, $i$$34$$, $index$$54$$, $cid$$1$$, $merge$$ = $options$$42$$.merge || !1, $sort$$ = $options$$42$$.sort, $needSort$$1$$ = !0, $added$$ = !1, $modelReturnList$$ = [];
  ...
  $oj$$1$$.$Collection$.prototype.sort = function $$oj$$1$$$$Collection$$$sort$($eventOpts_options$$43$$) {
    $eventOpts_options$$43$$ = $eventOpts_options$$43$$ || {};
    var $silent$$12$$ = $eventOpts_options$$43$$.silent, $comparator$$3$$ = this.comparator, $self$$5$$;
    if (this.$_hasComparator$()) {
      ...
      $eventOpts_options$$43$$ = $eventOpts_options$$43$$.add ? {add:!0} : null;
      this.$TriggerInternal$($silent$$12$$, $oj$$1$$.$Events$.$EventType$.SORT, this, $eventOpts_options$$43$$, null);
    }
  };
  ...
  $oj$$1$$.$Collection$.$SortFunc$ = function $$oj$$1$$$$Collection$$$SortFunc$$($a$$60$$, $b$$30$$, $attrs$$9_comparator$$4$$, $collection$$9$$, $self$$6$$) {
    ...
    if ($oj$$1$$.$Model$.$IsFunction$($attrs$$9_comparator$$4$$)) {
      if (1 === $attrs$$9_comparator$$4$$.length) {
        ...
        for ($i$$35$$ = 0;$i$$35$$ < $attrs1_keyA$$.length;$i$$35$$++) {
          if ($keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_compareKeys$($attrs1_keyA$$[$i$$35$$], $attrs2$$[$i$$35$$], $collection$$9$$.sortDirection), 0 !== $keyB_retVal$$2$$) {
    ...
    if ($oj$$1$$.$StringUtils$.$isString$($attrs$$9_comparator$$4$$)) {
      for ($attrs$$9_comparator$$4$$ = $attrs$$9_comparator$$4$$.split(","), $i$$35$$ = 0;$i$$35$$ < $attrs$$9_comparator$$4$$.length;$i$$35$$++) {
        if ($attrs1_keyA$$ = $oj$$1$$.$Collection$.$_getKey$($a$$60$$, $attrs$$9_comparator$$4$$[$i$$35$$]), $keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_getKey$($b$$30$$, $attrs$$9_comparator$$4$$[$i$$35$$]), $keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_compareKeys$($attrs1_keyA$$, $keyB_retVal$$2$$, $collection$$9$$.sortDirection), 0 !== $keyB_retVal$$2$$) {
          return $keyB_retVal$$2$$;
        }
      }
    }
  ...
  $oj$$1$$.$Collection$.prototype.$sortedIndex$ = function $$oj$$1$$$$Collection$$$$sortedIndex$$($model$$18$$, $comparator$$5$$) {
    ...
    $self$$7$$ = this;
    return $oj$$1$$.$Collection$.$_find$(this.$_getModels$(), $model$$18$$, function($a$$61$$, $b$$31$$) {
  ...
  $oj$$1$$.$Collection$.prototype.last = function $$oj$$1$$$$Collection$$$last$($n$$4$$, $options$$47$$) {
    var $deferred$$7_i$$38$$ = this.$_getDeferred$($options$$47$$);
    void 0 === $n$$4$$ && ($n$$4$$ = 1);
    if (1 === $n$$4$$) {
    ...
    return $oj$$1$$.$Object$.$__getPromise$(function($allResolve$$1$$) {
      ...
      function $doTask$$1$$($index$$56$$) {
        return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$2$$) {
          $self$$9$$.$_deferredAt$($index$$56$$, null).then(function($model$$21$$) {
  ...
  $oj$$1$$.$Collection$.prototype.$rest$ = function $$oj$$1$$$$Collection$$$$rest$$($n$$11$$, $options$$50$$) {
    var $deferred$$8_i$$40$$ = this.$_getDeferred$($options$$50$$);
    void 0 === $n$$11$$ && ($n$$11$$ = 1);
    var $array$$12$$ = [];
  ...
  $oj$$1$$.$Collection$.prototype.remove = function $$oj$$1$$$$Collection$$$remove$($m$$4$$, $options$$51$$) {
    ...
    this.$TriggerInternal$($options$$51$$.silent, $oj$$1$$.$Events$.$EventType$.ALLREMOVED, this, $modArray$$, $options$$51$$);
  };
  ...
  $oj$$1$$.$Collection$.prototype.refresh = function $$oj$$1$$$$Collection$$$refresh$($options$$54$$) {
    ...
    return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$3$$, $reject$$3$$) {
      if ($self$$12$$.$__isVirtual$()) {
        ...
        $self$$12$$.$TriggerInternal$(void 0 !== $options$$54$$.silent && $options$$54$$.silent, $oj$$1$$.$Events$.$EventType$.REFRESH, $self$$12$$, $options$$54$$, null);
        $resolve$$3$$();
      } else {
        $self$$12$$.reset(null, {silent:!0}), $self$$12$$.fetch({success:function($collection$$11$$, $response$$2$$, $options$$55$$) {
          $self$$12$$.$TriggerInternal$(void 0 !== $options$$55$$.silent && $options$$55$$.silent, $oj$$1$$.$Events$.$EventType$.REFRESH, $self$$12$$, $options$$55$$, null);
          $resolve$$3$$({collection:$collection$$11$$, response:$response$$2$$, options:$options$$55$$});
        }, error:function($xhr$$6$$, $status$$5$$, $error$$4$$) {
          $reject$$3$$({collection:$self$$12$$, xhr:$xhr$$6$$, status:$status$$5$$, error:$error$$4$$});
        }});
      }
    });
  };
    ...
    if ($data$$34$$) {
      if ($options$$56$$.parse && ($data$$34$$ = this.parse($data$$34$$)), $data$$34$$ instanceof Array) {
        ...
        for (var $i$$41$$ = 0;$i$$41$$ < $data$$34$$.length;$i$$41$$ += 1) {
          this.$_addInternal$($data$$34$$[$i$$41$$], $options$$56$$, !0, !1);
        }
      } else {
  ...
  $oj$$1$$.$Collection$.prototype.$_atInternal$ = function $$oj$$1$$$$Collection$$$$_atInternal$$($index$$59$$, $options$$58$$, $local$$, $deferred$$10$$) {
    return 0 > $index$$59$$ || this.$_overUpperLimit$($index$$59$$) ? null : $local$$ || !this.$__isVirtual$() && !$deferred$$10$$ ? this.$_getModel$($index$$59$$) : this.$_deferredAt$($index$$59$$, $options$$58$$);
  };
  $oj$$1$$.$Collection$.prototype.$_deferredAt$ = function $$oj$$1$$$$Collection$$$$_deferredAt$$($index$$60$$, $options$$59$$) {
    var $self$$13$$ = this, $model$$25$$ = $self$$13$$.$_getModel$($index$$60$$);
    return void 0 === $model$$25$$ ? $oj$$1$$.$Object$.$__getPromise$(function($resolve$$4$$, $reject$$4$$) {
      var $opts$$5$$ = {};
      $oj$$1$$.$CollectionUtils$.$copyInto$($opts$$5$$, $options$$59$$ || {});
      $opts$$5$$.context = $self$$13$$;
      $opts$$5$$.startIndex = $index$$60$$;
      $opts$$5$$.error = function $$opts$$5$$$error$($collection$$12$$, $error$$5$$) {
        $reject$$4$$($error$$5$$);
      };
  ...
  $oj$$1$$.$Collection$.prototype.$_getLocalInternal$ = function $$oj$$1$$$$Collection$$$$_getLocalInternal$$($id$$7$$) {
    ...
    var $foundObj$$ = null;
    this.$_getModels$().some(function($model$$27$$, $i$$42$$) {
      return void 0 !== $model$$27$$ && $model$$27$$.$Match$($id$$7$$, $cid$$3$$) ? ($foundObj$$ = $oj$$1$$.$Collection$.$_getModinfo$($i$$42$$, $model$$27$$), !0) : !1;
    });
    return $foundObj$$ ? $foundObj$$ : $oj$$1$$.$Collection$.$_getModinfo$(-1, void 0);
  };
  $oj$$1$$.$Collection$.prototype.$_getInternal$ = function $$oj$$1$$$$Collection$$$$_getInternal$$($id$$8$$, $options$$62$$, $deferred$$12$$, $fillIn$$1$$) {
    var $cid$$4$$ = $id$$8$$;
    ...
    var $foundObj$$1$$ = null;
    this.$_getModels$().some(function($model$$28$$, $i$$43$$) {
      return void 0 !== $model$$28$$ && $model$$28$$.$Match$($id$$8$$, $cid$$4$$) ? ($foundObj$$1$$ = $oj$$1$$.$Collection$.$_getModinfo$($i$$43$$, $model$$28$$), !0) : !1;
    });
    if ($foundObj$$1$$) {
    ...
    if (this.$__isVirtual$()) {
      ...
      return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$10$$, $reject$$10$$) {
        var $opts$$6$$ = {};
        $oj$$1$$.$CollectionUtils$.$copyInto$($opts$$6$$, $options$$62$$ || {});
        ...
        $self$$14$$.$_fetchInternal$($opts$$6$$, -1, $fillIn$$1$$).then(function($index$$61_resp$$4$$) {
          if (null != $index$$61_resp$$4$$) {
            ...
            var $model$$29$$ = $self$$14$$.$_getModel$($index$$61_resp$$4$$);
            void 0 !== $model$$29$$ && $model$$29$$.$Match$($id$$8$$, $cid$$4$$) ? $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$($index$$61_resp$$4$$, $model$$29$$)) : $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$(-1, void 0));
          } else {
  ...
  $oj$$1$$.$Collection$.prototype.$_fetchInternal$ = function $$oj$$1$$$$Collection$$$$_fetchInternal$$($options$$66$$, $placement$$1$$, $fillIn$$2$$) {
    function $doReset$$($collection$$15$$, $opt$$7$$, $fillIn$$3$$) {
      $collection$$15$$.$__isVirtual$() ? $fillIn$$3$$ || $collection$$15$$.$_resetModelsToFullLength$() : $opt$$7$$.add || $opt$$7$$.$useset$ || $collection$$15$$.reset();
    }
    var $opt$$6$$ = $options$$66$$ || {}, $success$$11$$ = $opt$$6$$.success, $self$$17$$;
    $opt$$6$$.set && ($opt$$6$$.$useset$ = $opt$$6$$.set ? !0 : !1);
    void 0 === $opt$$6$$.parse && ($opt$$6$$.parse = !0);
    $self$$17$$ = this;
    $opt$$6$$.success = function $$opt$$6$$$success$($response$$4$$) {
      $self$$17$$.$_setPagingReturnValues$($response$$4$$, $options$$66$$);
      var $data$$35$$ = $self$$17$$.parse($response$$4$$, $options$$66$$), $dataList$$ = null;
      if ($opt$$6$$.add || $self$$17$$.model) {
        ...
        try {
          ...
          $opt$$6$$.error && $opt$$6$$.error.call($oj$$1$$.$Model$.$GetContext$($options$$66$$, $self$$17$$), $self$$17$$, $e$$23$$, $options$$66$$);
          return;
        }
      } else {
        if (!$fillIn$$2$$) {
      ...
      $success$$11$$ && $success$$11$$.call($oj$$1$$.$Model$.$GetContext$($options$$66$$, $self$$17$$), $self$$17$$, $response$$4$$, $opt$$6$$);
    };
  ...
  $oj$$1$$.$Collection$.prototype.$_fetchOnly$ = function $$oj$$1$$$$Collection$$$$_fetchOnly$$($options$$67$$) {
    var $opt$$9$$ = $options$$67$$ || {}, $success$$12$$ = $opt$$9$$.success, $parsedModel$$1$$, $self$$18$$;
    void 0 === $opt$$9$$.parse && ($opt$$9$$.parse = !0);
    $self$$18$$ = this;
    $opt$$9$$.success = function $$opt$$9$$$success$($response$$5$$) {
      var $data$$38_i$$47$$, $modelInstance$$1$$;
      $data$$38_i$$47$$ = $self$$18$$.parse($response$$5$$, $options$$67$$);
      ...
      $success$$12$$ && $success$$12$$.call($oj$$1$$.$Model$.$GetContext$($options$$67$$, $self$$18$$), $self$$18$$, $fetchedModels$$, $opt$$9$$);
    };
  ...
  $oj$$1$$.$Collection$.prototype.create = function $$oj$$1$$$$Collection$$$create$($attributes$$7$$, $options$$70$$) {
    ...
    var $newModel$$5$$ = this.$_newModel$($attributes$$7$$, !0, $options$$70$$), $callback$$73$$ = $options$$70$$.success, $context$$15$$ = $options$$70$$.context;
    $options$$70$$.context = this;
    $options$$70$$.success = function $$options$$70$$$success$($model$$31$$, $resp$$6$$, $options$$71$$) {
      $callback$$73$$ && $callback$$73$$.call(null != $context$$15$$ ? $context$$15$$ : this, $model$$31$$, $resp$$6$$, $options$$71$$);
    };
    if (null == $newModel$$5$$) {
      return!1;
    }
    ...
    if ($deferred$$13$$ || this.$__isVirtual$()) {
      return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$15$$) {
        $self$$19$$.add($newModel$$5$$, {merge:!0, deferred:!0}).then(function() {
          $options$$70$$.success = function $$options$$70$$$success$($model$$33$$, $resp$$7$$, $options$$72$$) {
            $callback$$73$$ && $callback$$73$$.call(null != $context$$15$$ ? $context$$15$$ : $self$$19$$, $model$$33$$, $resp$$7$$, $options$$72$$);
            $resolve$$15$$($model$$33$$);
          };
          var $model$$32$$ = $doSave$$($newModel$$5$$, $options$$70$$);
          $model$$32$$ || $resolve$$15$$($model$$32$$);
        });
      });
    }
    this.add($newModel$$5$$, {merge:!0});
    return $doSave$$($newModel$$5$$, $options$$70$$);
  };
  ...
  $oj$$1$$.$Collection$.prototype.$where$ = function $$oj$$1$$$$Collection$$$$where$$($attrs$$10$$, $options$$73$$) {
    ...
    var $deferred$$14$$ = this.$_getDeferred$($options$$73$$), $self$$20$$ = this;
    if (this.$__isVirtual$()) {
      return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$16$$, $reject$$16$$) {
        $self$$20$$.$_fetchOnly$({query:$attrs$$10$$, all:!0, success:function($collection$$18$$, $fetchedModels$$1$$) {
          $resolve$$16$$($fetchedModels$$1$$);
        }, error:function($collection$$19$$, $xhr$$9$$, $error$$8$$) {
          $reject$$16$$({collection:$collection$$19$$, xhr:$xhr$$9$$, error:$error$$8$$});
        }});
      });
    }
    var $arr$$18$$ = [], $i$$49$$, $m$$7$$;
  ...
  $oj$$1$$.$Collection$.prototype.$whereToCollection$ = function $$oj$$1$$$$Collection$$$$whereToCollection$$($attrs$$11$$, $options$$75$$) {
    ...
    var $deferred$$15_models$$4_newCollection$$ = this.$_getDeferred$($options$$75$$), $self$$21$$ = this;
    if (this.$__isVirtual$() || $deferred$$15_models$$4_newCollection$$) {
      return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$18$$) {
        return $self$$21$$.$where$($attrs$$11$$, $options$$75$$).then(function($collection$$20_models$$5$$) {
          $collection$$20_models$$5$$ = $self$$21$$.$_makeNewCollection$($collection$$20_models$$5$$);
          $resolve$$18$$($collection$$20_models$$5$$);
        });
      });
    }
  ...
  $oj$$1$$.$Collection$.prototype.$_makeNewCollection$ = function $$oj$$1$$$$Collection$$$$_makeNewCollection$$($models$$6$$) {
    var $collection$$21$$ = this.$_cloneInternal$(!1);
    $collection$$21$$.$_setModels$($models$$6$$);
    $collection$$21$$.$_resetLRU$();
    $collection$$21$$.$_setLength$();
    return $collection$$21$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.min = function $$oj$$1$$$$Collection$$$min$($iterator$$4$$, $context$$20$$) {
    ...
    this.$_getModels$().forEach(function($model$$37$$, $i$$50$$) {
      1 <= $i$$50$$ && ($currValue$$ = $iterator$$4$$.call($context$$20$$ || this, $model$$37$$), $currValue$$ < $minModelValue$$ && ($minModel$$ = $model$$37$$, $minModelValue$$ = $currValue$$));
    }, this);
    return $minModel$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.max = function $$oj$$1$$$$Collection$$$max$($iterator$$5$$, $context$$21$$) {
    ...
    this.$_getModels$().forEach(function($model$$38$$, $i$$51$$) {
      1 <= $i$$51$$ && ($currValue$$1$$ = $iterator$$5$$.call($context$$21$$ || this, $model$$38$$), $currValue$$1$$ > $maxModelValue$$ && ($maxModel$$ = $model$$38$$, $maxModelValue$$ = $currValue$$1$$));
    }, this);
    return $maxModel$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$without$ = function $$oj$$1$$$$Collection$$$$without$$($var_args$$46$$) {
    ...
    for (var $model$$40$$, $i$$52$$ = 0;$i$$52$$ < this.$_getModels$().length;$i$$52$$++) {
      $add$$ = !0;
      $model$$40$$ = this.$_getModels$()[$i$$52$$];
      for ($j$$4$$ = 0;$j$$4$$ < arguments.length;$j$$4$$ += 1) {
        if ($cid$$5$$ = arguments[$j$$4$$].$GetCid$(), $id$$9$$ = arguments[$j$$4$$].$GetId$(), $model$$40$$.$Match$($id$$9$$, $cid$$5$$)) {
          $add$$ = !1;
          break;
        }
      }
  ...
  $oj$$1$$.$Collection$.prototype.$any$ = function $$oj$$1$$$$Collection$$$$any$$($iterator$$7$$, $context$$23$$) {
    ...
    for (var $model$$41$$, $i$$53$$ = 0;$i$$53$$ < this.$_getModelsLength$();$i$$53$$ += 1) {
      if ($model$$41$$ = this.$_getModel$($i$$53$$), $iterator$$7$$.call($context$$23$$ || this, $model$$41$$)) {
        return!0;
      }
    }
    return!1;
  ...
  $oj$$1$$.$Collection$.prototype.$findWhere$ = function $$oj$$1$$$$Collection$$$$findWhere$$($attrs$$12$$, $options$$76$$) {
    var $arr$$19_deferred$$16$$ = this.$_getDeferred$($options$$76$$), $self$$23$$ = this;
    if (this.$__isVirtual$() || $arr$$19_deferred$$16$$) {
      return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$19$$) {
        $self$$23$$.$where$($attrs$$12$$, $options$$76$$).then(function($modelList$$1$$) {
  ...
  $oj$$1$$.$Collection$.prototype.slice = function $$oj$$1$$$$Collection$$$slice$($i$$54_start$$18$$, $end$$4$$, $options$$77_ret$$1$$) {
    ...
    for (;$i$$54_start$$18$$ < $end$$4$$;$i$$54_start$$18$$ += 1) {
      $options$$77_ret$$1$$.push(this.$_getModel$($i$$54_start$$18$$));
    }
  ...
  $oj$$1$$.$Collection$.prototype.set = function $$oj$$1$$$$Collection$$$set$($models$$7$$, $options$$78$$) {
    return this.$_setInternal$($models$$7$$, !0, $options$$78$$, this.$_getDeferred$($options$$78$$) || this.$__isVirtual$());
  };
  $oj$$1$$.$Object$.$exportPrototypeSymbol$("Collection.prototype.set", {set:$oj$$1$$.$Collection$.prototype.set});
  $oj$$1$$.$Collection$.$_removeAfterSet$ = function $$oj$$1$$$$Collection$$$_removeAfterSet$$($collection$$22$$, $i$$55_remove$$, $foundModels$$, $options$$79$$) {
    if ($i$$55_remove$$) {
      for ($i$$55_remove$$ = $collection$$22$$.$_getModelsLength$() - 1;0 <= $i$$55_remove$$;$i$$55_remove$$ -= 1) {
        -1 == $foundModels$$.indexOf($i$$55_remove$$) && $collection$$22$$.$_removeInternal$($collection$$22$$.$_getModel$($i$$55_remove$$), $i$$55_remove$$, $options$$79$$);
      }
    }
  };
  $oj$$1$$.$Collection$.prototype.$_setInternal$ = function $$oj$$1$$$$Collection$$$$_setInternal$$($i$$56_models$$8$$, $parse$$3$$, $options$$80$$, $deferred$$19$$) {
    ...
    for ($i$$56_models$$8$$ = 0;$i$$56_models$$8$$ < $modelList$$2$$.length;$i$$56_models$$8$$ += 1) {
      $currModel$$ = this.$_updateModel$(this.$_newModel$($modelList$$2$$[$i$$56_models$$8$$], $parse$$3$$, $options$$80$$), $add$$1$$, $merge$$1$$, $deferred$$19$$), -1 !== $currModel$$ && $foundModels$$1$$.push($currModel$$);
    }
    ...
    return $oj$$1$$.$Object$.$__getPromise$(function($allResolve$$2$$) {
      ...
      function $doTask$$2$$($index$$63$$) {
        return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$20$$) {
          $self$$24$$.$_updateModel$($self$$24$$.$_newModel$($modelList$$3$$[$index$$63$$], $parse$$4$$, $options$$81$$), $add$$2$$, $merge$$2$$, !0).then(function($currModel$$1$$) {
      ...
      $currentStep$$2$$.then(function() {
        $oj$$1$$.$Collection$.$_removeAfterSet$($self$$24$$, $remove$$2$$, $foundModels$$2$$, $options$$81$$);
        $allResolve$$2$$();
      });
    });
  };
  $oj$$1$$.$Collection$.prototype.$_updateModel$ = function $$oj$$1$$$$Collection$$$$_updateModel$$($model$$42$$, $add$$3$$, $merge$$3$$, $deferred$$20$$) {
    function $update$$($collection$$23$$, $found$$1$$, $deferred$$21$$) {
        ...
        if ($merge$$3$$) {
          ...
          if ($deferred$$21$$) {
            return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$21$$) {
              $collection$$23$$.$_addInternal$($model$$42$$, $opt$$13$$, !1, !0).then(function() {
                $resolve$$21$$($index$$64$$);
              });
            });
          }
          $collection$$23$$.add($model$$42$$, $opt$$13$$);
        }
      } else {
        if ($add$$3$$) {
          if ($deferred$$21$$) {
            return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$22$$) {
              $collection$$23$$.add($model$$42$$, {deferred:!0}).then(function() {
                $resolve$$22$$($collection$$23$$.$_getLength$() - 1);
              });
            });
          }
          $collection$$23$$.add($model$$42$$);
          $index$$64$$ = $collection$$23$$.$_getLength$() - 1;
        }
      }
      return $index$$64$$;
    }
    if ($deferred$$20$$ || this.$__isVirtual$()) {
      ...
      return $oj$$1$$.$Object$.$__getPromise$(function($resolve$$23$$) {
        $self$$25$$.$_getInternal$($model$$42$$, null, $deferred$$20$$).then(function($found$$2$$) {
    ...
    var $found$$ = this.$_getInternal$($model$$42$$);
  ...
  $oj$$1$$.$Collection$.prototype.first = function $$oj$$1$$$$Collection$$$first$($n$$12$$, $options$$82$$) {
    var $deferred$$22_i$$58_virtual$$2$$ = this.$_getDeferred$($options$$82$$), $elementCount$$ = this.$_getLength$(), $retArray$$2$$ = [];
  ...
  $oj$$1$$.$Collection$.prototype.indexOf = function $$oj$$1$$$$Collection$$$indexOf$($model$$44$$, $options$$83$$) {
    ...
    return this.$__isVirtual$() || $deferred$$23$$ ? this.$_getInternal$($model$$44$$, null, !0).then(function($loc$$1$$) {
      return $loc$$1$$.index;
  ...
  $oj$$1$$.$Collection$.prototype.pop = function $$oj$$1$$$$Collection$$$pop$($options$$84$$) {
    ...
    if (this.$__isVirtual$() || $deferred$$24_m$$8$$) {
      ...
      return this.at(this.$_getLength$() - 1, {deferred:$deferred$$24_m$$8$$}).then(function($model$$46$$) {
        $self$$26$$.remove($model$$46$$, $options$$84$$);
        return $model$$46$$;
      });
    }
  ...
  $oj$$1$$.$Collection$.prototype.lastIndexOf = function $$oj$$1$$$$Collection$$$lastIndexOf$($model$$47$$, $fromIndex$$2$$) {
    ...
    for ($i$$59$$ = this.$_getLength$() - 1;$i$$59$$ >= $fromIndex$$2$$;$i$$59$$ -= 1) {
      if ($oj$$1$$.$Object$.$__innerEquals$($model$$47$$, this.at($i$$59$$))) {
        return $i$$59$$;
      }
    }
    return-1;
  ...
  $oj$$1$$.$Collection$.prototype.$ModifyOptionsForCustomURL$ = function $$oj$$1$$$$Collection$$$$ModifyOptionsForCustomURL$$($attrs$$13_comparator$$8_options$$86$$) {
    ...
    for ($i$$61_prop$$42$$ in $attrs$$13_comparator$$8_options$$86$$) {
      $attrs$$13_comparator$$8_options$$86$$.hasOwnProperty($i$$61_prop$$42$$) && ($opt$$14$$[$i$$61_prop$$42$$] = $attrs$$13_comparator$$8_options$$86$$[$i$$61_prop$$42$$]);
    }
    if (($attrs$$13_comparator$$8_options$$86$$ = this.comparator) && $oj$$1$$.$StringUtils$.$isString$($attrs$$13_comparator$$8_options$$86$$)) {
      ...
      for ($i$$61_prop$$42$$ = 0;$i$$61_prop$$42$$ < $attrs$$13_comparator$$8_options$$86$$.length;$i$$61_prop$$42$$++) {
        $opt$$14$$.sort = 0 === $i$$61_prop$$42$$ ? $attrs$$13_comparator$$8_options$$86$$[$i$$61_prop$$42$$] : $opt$$14$$.sort + ("," + $attrs$$13_comparator$$8_options$$86$$[$i$$61_prop$$42$$]);
      }
  ...
  $oj$$1$$.$Collection$.prototype.$GetCollectionFetchUrl$ = function $$oj$$1$$$$Collection$$$$GetCollectionFetchUrl$$($attrs$$14_comparator$$9_options$$87_queryString$$) {
    ...
    if (this.$__isVirtual$()) {
      var $all_sortDirStr$$ = $attrs$$14_comparator$$9_options$$87_queryString$$.all, $i$$62_limit$$4_totalResults$$4$$ = null;
      $i$$62_limit$$4_totalResults$$4$$ = $all_sortDirStr$$ ? ($i$$62_limit$$4_totalResults$$4$$ = this.totalResults) ? $i$$62_limit$$4_totalResults$$4$$ : this.$_getFetchSize$($attrs$$14_comparator$$9_options$$87_queryString$$) : this.$_getFetchSize$($attrs$$14_comparator$$9_options$$87_queryString$$);
      ...
      if ($attrs$$14_comparator$$9_options$$87_queryString$$ = this.comparator) {
        for ($attrs$$14_comparator$$9_options$$87_queryString$$ = this.$_getSortAttrs$($attrs$$14_comparator$$9_options$$87_queryString$$), $all_sortDirStr$$ = this.$_getSortDirStr$(), $i$$62_limit$$4_totalResults$$4$$ = 0;$i$$62_limit$$4_totalResults$$4$$ < $attrs$$14_comparator$$9_options$$87_queryString$$.length;$i$$62_limit$$4_totalResults$$4$$++) {
          $url$$17$$ = 0 === $i$$62_limit$$4_totalResults$$4$$ ? $url$$17$$ + ("\x26orderBy\x3d" + $attrs$$14_comparator$$9_options$$87_queryString$$[$i$$62_limit$$4_totalResults$$4$$] + ":" + $all_sortDirStr$$) : $url$$17$$ + ("," + $attrs$$14_comparator$$9_options$$87_queryString$$[$i$$62_limit$$4_totalResults$$4$$] + ":" + $all_sortDirStr$$);
        }
      }
  ...
  $oj$$1$$.$Collection$.prototype.sync = function $$oj$$1$$$$Collection$$$sync$($method$$5$$, $collection$$24$$, $options$$88$$) {
    return window.oj.sync($method$$5$$, $collection$$24$$, $options$$88$$);
  };
  ...
  $oj$$1$$.$RestImpl$.prototype.$getRecord$ = function $$oj$$1$$$$RestImpl$$$$getRecord$$($ajaxOptions$$2_success$$14$$, $error$$9$$, $recordID_urlInfo$$1$$, $options$$92$$, $context$$25$$) {
    ...
    $ajaxOptions$$2_success$$14$$ = {crossDomain:$options$$92$$.crossDomain || !$isJsonp$$1$$, dataType:$options$$92$$.dataType || "json", jsonpCallback:$options$$92$$.jsonpCallback, context:null !== $context$$25$$ ? $context$$25$$ : this, success:$ajaxOptions$$2_success$$14$$, error:$error$$9$$};
  ...
  $oj$$1$$.$RestImpl$.prototype.$updateRecord$ = function $$oj$$1$$$$RestImpl$$$$updateRecord$$($ajaxOptions$$3_callback$$75$$, $recordID$$1_urlInfo$$2$$, $record$$, $error$$10$$, $options$$93$$, $context$$26$$, $patch$$1$$) {
    ...
    $ajaxOptions$$3_callback$$75$$ = {crossDomain:$options$$93$$.crossDomain || !$isJsonp$$2$$, contentType:$options$$93$$.contentType || "application/json", dataType:$options$$93$$.dataType || "json", jsonpCallback:$options$$93$$.jsonpCallback, data:JSON.stringify($record$$), success:$ajaxOptions$$3_callback$$75$$, error:$error$$10$$, context:null !== $context$$26$$ ? $context$$26$$ : this};
  ...
  $oj$$1$$.$RestImpl$.prototype.$deleteRecord$ = function $$oj$$1$$$$RestImpl$$$$deleteRecord$$($recordID$$4_urlInfo$$3$$, $ajaxOptions$$4_error$$11$$, $options$$97$$, $context$$29$$) {
    ...
    $ajaxOptions$$4_error$$11$$ = {crossDomain:$options$$97$$.crossDomain || !$isJsonp$$3$$, success:$options$$97$$.success, error:$ajaxOptions$$4_error$$11$$, context:null !== $context$$29$$ ? $context$$29$$ : this};
    $ajaxOptions$$4_error$$11$$ = $oj$$1$$.$RestImpl$.$addOptions$($ajaxOptions$$4_error$$11$$, $options$$97$$, $recordID$$4_urlInfo$$3$$);
    $options$$97$$.xhr = this.ajax($ajaxOptions$$4_error$$11$$);
    return $options$$97$$.xhr;
  };
  $oj$$1$$.$RestImpl$.prototype.$addRecord$ = function $$oj$$1$$$$RestImpl$$$$addRecord$$($record$$1_urlInfo$$4$$, $ajaxOptions$$5_error$$12$$, $options$$98$$, $context$$30$$) {
    ...
    $ajaxOptions$$5_error$$12$$ = {crossDomain:$options$$98$$.crossDomain || !$isJsonp$$4$$, contentType:$options$$98$$.contentType || "application/json", dataType:$options$$98$$.dataType || "json", jsonpCallback:$options$$98$$.jsonpCallback, data:$recordStr$$, success:$options$$98$$.success, error:$ajaxOptions$$5_error$$12$$, context:null !== $context$$30$$ ? $context$$30$$ : this};
    $ajaxOptions$$5_error$$12$$ = this.$_addHeaderProp$($ajaxOptions$$5_error$$12$$);
    $ajaxOptions$$5_error$$12$$ = $oj$$1$$.$RestImpl$.$addOptions$($ajaxOptions$$5_error$$12$$, $options$$98$$, $record$$1_urlInfo$$4$$);
    $options$$98$$.xhr = this.ajax($ajaxOptions$$5_error$$12$$);
