...
define(["ojs/ojcore", "jquery", "jqueryui", "ojs/ojmessaging"], function($oj$$3$$, $$$$3$$) {
  ...
  function $_defineDynamicProperty$$($self$$28$$, $originalDefaultValue$$, $constructorValue$$, $options$$101$$, $prop$$45$$, $getter$$, $contextCallback$$) {
  ...
  $$$$3$$.widget("oj.baseComponent", {options:{contextMenu:null, rootAttributes:void 0}, refresh:function() {
    ...
    var $i$$71_key$$28$$ = arguments[0], $options$$104$$ = $i$$71_key$$28$$, $subkey$$1$$ = null, $flags$$3$$ = {};
    if ("string" === typeof $i$$71_key$$28$$) {
      var $options$$104$$ = {}, $parts$$3$$ = $i$$71_key$$28$$.split("."), $i$$71_key$$28$$ = $parts$$3$$.shift();
      if ($parts$$3$$.length) {
        var $subkey$$1$$ = $parts$$3$$.join("."), $curOption$$;
        try {
          1 < arguments.length && (this.$_settingNestedKey$ = $subkey$$1$$), $curOption$$ = $options$$104$$[$i$$71_key$$28$$] = $$$$3$$.widget.extend({}, this.options[$i$$71_key$$28$$]);
        } finally {
        ...
        $options$$104$$[$i$$71_key$$28$$] = $value$$70$$;
      }
    ...
    return this;
  }, _trigger:function($type$$63$$, $event$$14$$, $data$$46$$) {
    var $callback$$79$$ = this.options[$type$$63$$];
    $data$$46$$ = $data$$46$$ || {};
    $event$$14$$ = $$$$3$$.Event($event$$14$$, $_OJ_COMPONENT_EVENT_OVERRIDES$$);
    $event$$14$$.type = (this.widgetEventPrefix + $type$$63$$).toLowerCase();
    $event$$14$$.target = this.element[0];
    this.element.trigger($event$$14$$, $data$$46$$);
    return!($$$$3$$.isFunction($callback$$79$$) && !1 === $callback$$79$$.apply(this.element[0], [$event$$14$$].concat($data$$46$$)) || $event$$14$$.isDefaultPrevented());
  }, $_setupContextMenu$:function() {
    this.$_unbindContextMenu$();
    var $menuSelector_widget$$1$$ = this.options.contextMenu;
    $menuSelector_widget$$1$$ || ($menuSelector_widget$$1$$ = this.element.attr("contextmenu")) && ($menuSelector_widget$$1$$ = "#" + $menuSelector_widget$$1$$);
    var $$menu$$, $menu$$;
    $menuSelector_widget$$1$$ && ($$menu$$ = $$$$3$$($menuSelector_widget$$1$$), $menu$$ = $$menu$$.data("oj-ojMenu"));
    if ($menu$$) {
      var $self$$30$$ = this;
      ($menuSelector_widget$$1$$ = this.widget()) && $menuSelector_widget$$1$$.on("keydown" + this.$contextMenuEventNamespace$ + " contextmenu" + this.$contextMenuEventNamespace$, function($event$$15$$) {
        if ("contextmenu" === $event$$15$$.type || 121 == $event$$15$$.which && $event$$15$$.shiftKey) {
          $self$$30$$._OpenContextMenu($menu$$, $event$$15$$), $$menu$$.is(":visible") && $event$$15$$.preventDefault();
        }
        return!0;
      });
    }
  ...
  }, _OpenContextMenu:function($menu$$1$$, $event$$16$$) {
    $menu$$1$$.open($event$$16$$, {launcher:this.element, initialFocus:"menu"});
  }, _hoverable:function($element$$17$$) {
    this.hoverable = this.hoverable.add($element$$17$$);
    this._on($element$$17$$, {mouseenter:function($event$$17$$) {
      $$$$3$$($event$$17$$.currentTarget).addClass("oj-hover");
    }, mouseleave:function($event$$18$$) {
      $$$$3$$($event$$18$$.currentTarget).removeClass("oj-hover");
    }});
  }, _focusable:function($element$$18$$) {
    this.focusable = this.focusable.add($element$$18$$);
    this._on($element$$18$$, {focusin:function($event$$19$$) {
      $$$$3$$($event$$19$$.currentTarget).addClass("oj-focus");
    }, focusout:function($event$$20$$) {
      $$$$3$$($event$$20$$.currentTarget).removeClass("oj-focus");
    }});
  }, $_activeable$:function($element$$19$$) {
    this.activeable = this.activeable.add($element$$19$$);
    this._on($element$$19$$, {mousedown:function($event$$21$$) {
      $$$$3$$($event$$21$$.currentTarget).addClass("oj-active");
    }, mouseup:function($event$$22$$) {
      $$$$3$$($event$$22$$.currentTarget).removeClass("oj-active");
    }});
    ...
    for (var $i$$73_val$$19$$ = $widgetHierNames$$.length - 1;0 <= $i$$73_val$$19$$;$i$$73_val$$19$$--) {
      var $callback$$80_defaultVal$$1_props$$3$$ = $allProperties_contextCallback$$1$$[$widgetHierNames$$[$i$$73_val$$19$$]];
      void 0 !== $callback$$80_defaultVal$$1_props$$3$$ && ($defaults$$ = $$$$3$$.widget.extend($defaults$$, $callback$$80_defaultVal$$1_props$$3$$));
    }
    if (!$$$$3$$.isEmptyObject($defaults$$)) {
      ...
      for ($prop$$47$$ in $defaults$$) {
        if ($i$$73_val$$19$$ = $constructorOptions$$2$$[$prop$$47$$], void 0 === $i$$73_val$$19$$ || $$$$3$$.isPlainObject($i$$73_val$$19$$)) {
          $callback$$80_defaultVal$$1_props$$3$$ = $defaults$$[$prop$$47$$], null != $callback$$80_defaultVal$$1_props$$3$$ && $callback$$80_defaultVal$$1_props$$3$$ instanceof $__ojDynamicGetter$$ ? ($callback$$80_defaultVal$$1_props$$3$$ = $callback$$80_defaultVal$$1_props$$3$$.$getCallback$(), $$$$3$$.isFunction($callback$$80_defaultVal$$1_props$$3$$) ? $_defineDynamicProperty$$(this, $originalDefaults$$2$$[$prop$$47$$], $i$$73_val$$19$$, $options$$107$$, $prop$$47$$, $callback$$80_defaultVal$$1_props$$3$$, 
          $allProperties_contextCallback$$1$$) : $oj$$3$$.$Logger$.error("Dynamic getter for property %s is not a function", $prop$$47$$)) : $options$$107$$[$prop$$47$$] = $_mergeOptionLayers$$([$originalDefaults$$2$$[$prop$$47$$], $callback$$80_defaultVal$$1_props$$3$$, $i$$73_val$$19$$]);
        }
      }
    }
    ...
    for (var $children$$ = $node$$10$$.childNodes, $child$$1$$, $attrs$$15$$, $attr$$11$$, $childHasAttr$$, $i$$74$$, $count$$15$$ = $children$$.length - 1;0 <= $count$$15$$;) {
      if ($child$$1$$ = $children$$.item($count$$15$$), 1 === $child$$1$$.nodeType) {
        if ($oj$$3$$.$DomUtils$.$_LEGAL_ELEMENTS$[$child$$1$$.nodeName]) {
          for ($attrs$$15$$ = $child$$1$$.attributes, $i$$74$$ = $attrs$$15$$.length - 1;0 <= $i$$74$$;$i$$74$$--) {
            $attr$$11$$ = $attrs$$15$$[$i$$74$$], ($childHasAttr$$ = void 0 !== $$$$3$$($child$$1$$).attr($attr$$11$$)) && ($oj$$3$$.$DomUtils$.$_LEGAL_ATTRIBUTES$[$attr$$11$$.name] || $child$$1$$.removeAttribute($attr$$11$$.nodeName));
          }
        }
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.$_createMessagingStrategy$ = function $$oj$$3$$$$ComponentMessaging$$$$_createMessagingStrategy$$($type$$65$$, $options$$108$$) {
    return new ($oj$$3$$.$ComponentMessaging$.$_DISPLAY_TYPE_TO_CALLBACK$[$type$$65$$] || $oj$$3$$.$ComponentMessaging$.$_DISPLAY_TYPE_TO_CALLBACK$[$oj$$3$$.$ComponentMessaging$.$_DISPLAY_TYPE$.NONE])($options$$108$$);
  };
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.$_getResolvedMessagingDisplayOptions$ = function $$oj$$3$$$$ComponentMessaging$$$$_getResolvedMessagingDisplayOptions$$() {
    var $artifactsByDisplayType$$ = {}, $artifactDisplayTypeResolved$$ = !1, $compPH$$ = this.$_component$.options.placeholder, $artifact$$, $$messagingPreferences$$ = {}, $self$$33$$ = this;
    $$$$3$$.each(this.$_component$.options.displayOptions || {}, function($key$$33$$, $displayTypes$$) {
      $artifactDisplayTypeResolved$$ = !1;
      $artifact$$ = $key$$33$$ + "";
      Array.isArray($displayTypes$$) ? $$$$3$$.each($displayTypes$$, function($index$$76$$, $displayType$$) {
        $artifactDisplayTypeResolved$$ || ($artifactDisplayTypeResolved$$ = $self$$33$$.$_resolveDisplayTypeForArtifact$($artifact$$, $displayType$$, $compPH$$, $$messagingPreferences$$));
      }) : "string" === typeof $displayTypes$$ && ($artifactDisplayTypeResolved$$ || ($artifactDisplayTypeResolved$$ = $self$$33$$.$_resolveDisplayTypeForArtifact$($artifact$$, $displayTypes$$, $compPH$$, $$messagingPreferences$$)));
      $artifactDisplayTypeResolved$$ || ($$messagingPreferences$$[$artifact$$] = $oj$$3$$.$ComponentMessaging$.$_DISPLAY_TYPE$.NONE);
    });
    $$$$3$$.each($oj$$3$$.$ComponentMessaging$.$_DISPLAY_TYPE$, function($type$$66$$, $name$$66$$) {
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.$_reactivate$ = function $$oj$$3$$$$ComponentMessaging$$$$_reactivate$$() {
    ...
    $$$$3$$.each($artifactsByDisplayType$$2$$, function($type$$67$$, $artifactsForType$$) {
      $type$$67$$ += "";
      $strategy$$3$$ = $cm$$.$_strategies$[$type$$67$$];
      $artifactsForType$$ && 0 < $artifactsForType$$.length ? $strategy$$3$$ ? $strategy$$3$$ && $strategy$$3$$.$reactivate$($artifactsForType$$) : ($strategy$$3$$ = $cm$$.$_createMessagingStrategy$($type$$67$$, $artifactsForType$$), $cm$$.$_strategies$[$type$$67$$] = $strategy$$3$$, $strategy$$3$$.$activate$($cm$$)) : $strategy$$3$$ && $oj$$3$$.$ComponentMessaging$.$_DISPLAY_TYPE$.NONE !== $type$$67$$ && ($strategy$$3$$.$deactivate$(), delete $cm$$.$_strategies$[$type$$67$$]);
    });
  };
  ...
  $oj$$3$$.$MessagingStrategy$.prototype.$GetValidatorHints$ = function $$oj$$3$$$$MessagingStrategy$$$$GetValidatorHints$$() {
    ...
    $$$$3$$.each($vHints$$, function($index$$77$$, $hint$$1$$) {
      $hints$$1$$.push($hint$$1$$);
    });
    return $hints$$1$$;
  };
  ...
  $oj$$3$$.$ComponentValidity$.prototype.$_getImmediateMessages$ = function $$oj$$3$$$$ComponentValidity$$$$_getImmediateMessages$$() {
    var $messages$$8$$ = this.$_compMessages$ || [], $immediateMsgs$$ = [], $msg$$3$$, $index$$78$$;
    for ($index$$78$$ in $messages$$8$$) {
      $msg$$3$$ = $messages$$8$$[$index$$78$$], $msg$$3$$ instanceof $oj$$3$$.$ComponentMessage$ && !$msg$$3$$.$canDisplay$() || $immediateMsgs$$.push($msg$$3$$);
    }
  ...
  $oj$$3$$.$PositionUtils$.$normalizeHorizontalAlignment$ = function $$oj$$3$$$$PositionUtils$$$normalizeHorizontalAlignment$$($position$$, $isRtl$$) {
    ...
    for (var $target$$74$$ = $$$$3$$.extend({}, $position$$), $i$$78$$ = 0;$i$$78$$ < $oj$$3$$.$PositionUtils$.$_ALIGN_RULE_PROPERTIES$.length;$i$$78$$++) {
      var $propName$$ = $oj$$3$$.$PositionUtils$.$_ALIGN_RULE_PROPERTIES$[$i$$78$$], $align$$ = $target$$74$$[$propName$$];
