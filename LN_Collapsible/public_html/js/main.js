...
//    'jqueryui': 'libs/jquery/jquery-ui-1.10.4.custom.min',
    ...
    'collapsibleVM' : 'collapsibleOption_test'
  },
 ...
 */
require(['ojs/ojcore', 'knockout','collapsibleVM' , 'ojs/ojtoolbar','ojs/ojselectcombobox','ojs/ojmenu'], // add additional JET component modules as needed
  function(oj, ko, collapsibleVM) // this callback gets executed when all required modules are loaded
  {
