...
oj.__registerWidget("oj.ojCheckboxset", $['oj']['editableValue'],
{
  ...
  options : 
  {
     ...
     * Disabled false enables the component, and leaves the inputs disabled state as it is in the 
     * dom.
     * <p>
 ...
 _SetDisplayValue : function (checkedBoxes) 
  {
    ...
    if (checkedBoxes != null)
    {
      ...
      for(var i = 0; i < checkedBoxes.length; i++) {
        ...
        var checkboxWithMatchingValue = this.$checkboxes.filter(valueFilter);
