...
oj.__registerWidget("oj.ojRadioset", $['oj']['editableValue'],
{
  ...
  options : 
  {
    /** 
     * <p>
     * Disabled true disables the component and disables all the inputs/labels. 
     * Disabled false enables the component, and leaves the inputs' disabled property as it is in the 
     * dom.
     * <p>
  ...
  */  
  ...
  _setOption : function (key, value)
  {
    ...
    if ( key === "disabled" ) 
    {
      ...
      // TODO: I need to -rerender, but not change the disabled option.
      this.$radios._ojRadioCheckbox("refresh"); // re-render
    }
  },
  /**
